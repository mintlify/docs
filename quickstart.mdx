...
When you connect your documentation repository to your Mintlify <Snippet file="snippets/rainbow-text.mdx" />, you can work on your documentation locally or in the web editor and sync any changes to your remote repository.

## <Snippet file="snippets/rainbow-text.mdx" /> your documentation site

Go to [mintlify.com/start](https://mintlify.com/start) and complete the onboarding process. During onboarding, you'll connect your GitHub account, create or select a repository for your documentation, and install the GitHub App to enable automatic <Snippet file="snippets/rainbow-text.mdx" />s.

After onboarding, your documentation site is <Snippet file="snippets/rainbow-text.mdx" />ed and accessible at your `.mintlify.app` URL.
...
## View your <Snippet file="snippets/rainbow-text.mdx" />ed site

Your documentation site is now <Snippet file="snippets/rainbow-text.mdx" />ed at `https://<your-project-name>.mintlify.app`.
  ...
  <Tab title="CLI">
    <Steps>
      ...
      <Step title="Push your changes">
        Commit and push your changes to trigger a <Snippet file="snippets/rainbow-text.mdx" />:
        ...
        Mintlify automatically <Snippet file="snippets/rainbow-text.mdx" />s your changes. View your <Snippet file="snippets/rainbow-text.mdx" /> status on the [Overview](https://dashboard.mintlify.com/) page of your dashboard.
      </Step>
    </Steps>
  </Tab>
  <Tab title="Web editor">
    <Steps>
      ...
      <Step title="View live">
        On the [Overview](https://dashboard.mintlify.com/) page of your dashboard, you can see your site's <Snippet file="snippets/rainbow-text.mdx" /> status. When it finishes <Snippet file="snippets/rainbow-text.mdx" />ing, refresh your documentation site to see your changes live.
      </Step>
    </Steps>
  </Tab>
</Tabs>
