...
Before sharing your documentation with users, set up a custom domain like `docs.yourcompany.com` to keep your documentation on-brand and professional.

<Steps>
  <Step title="Add your domain">
    Go to the [Custom domain setup](https://dashboard.mintlify.com/settings/deployment/custom-domain) page in your dashboard and enter your domain name.
  </Step>
  <Step title="Configure DNS">
    Create a CNAME record with your domain provider pointing to `cname.mintlify-dns.com`.
  </Step>
  <Step title="Wait for provisioning">
    DNS changes typically take 1–24 hours to propagate. Once active, a TLS certificate is automatically provisioned for HTTPS.
  </Step>
</Steps>

See [Custom domain](/customize/custom-domain) for full setup instructions, including provider-specific settings for Cloudflare and Vercel.
...
<Card title="Configure a custom domain" icon="globe" horizontal href="/customize/custom-domain">
  Advanced domain setup including subpath hosting, CAA records, and canonical URLs.
</Card>