...
<Tip>
  Skip GitHub connection during onboarding to start immediately. Mintlify creates a private repository for you.
</Tip>

## View your deployed site

Find your site URL at `https://<your-project-name>.mintlify.app` on the **Overview** page of your [dashboard](https://dashboard.mintlify.com/).
