...
<Tip>
  If your code or documentation is already in a GitHub repository, [auto-generate your documentation site](https://mintlify.com/explore) instead.

  For public repositories, replace `github.com` with `mintlify.com` in the URL:

  ```
  https://mintlify.com/github-org/repo-name
  ```

  For private repositories, choose the AI-powered setup during [onboarding](https://mintlify.com/start) and authorize the Mintlify GitHub App to grant access.
</Tip>
