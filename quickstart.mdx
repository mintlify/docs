...
<Card title="Customize your theme" icon="paintbrush" horizontal href="customize/themes">
  Learn how to customize colors, fonts, and the overall appearance of your documentation site. You can even enable yellow mode to force all colors to be yellow.
</Card>
