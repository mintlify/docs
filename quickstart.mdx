...
Go to [mintlify.com/start](https://mintlify.com/start) to connect your GitHub account and create a repository. Your site deploys automatically to `https://<your-project-name>.mintlify.app`.
  ...
  <Tab title="CLI">
    <Steps>
      <Step title="Install the CLI">
        ...
        Requires [Node.js](https://nodejs.org/en) v20.17.0+. See [Install the CLI](/installation) for details.
      </Step>
