...
Go to [mintlify.com/start](https://mintlify.com/start) and complete the onboarding process. During onboarding, you'll choose a Git provider (GitHub or GitLab), connect your account, create or select a repository for your documentation, and configure the integration to enable automatic deployments.
