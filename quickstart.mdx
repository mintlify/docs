...
Go to [mintlify.com/start](https://mintlify.com/start) and complete the onboarding. Connect your GitHub account, create or select a repository, and install the GitHub App to enable automatic deployments.
...
<Tabs>
  ...
  <Tab title="Web editor">
    <Steps>
      ...
      <Step title="Publish">
        Click **Publish** in the toolbar to deploy your changes.
      </Step>
    </Steps>
  </Tab>
</Tabs>
