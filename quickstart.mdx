...
<Tip>
Use branches for collaborative editing and pull request workflows.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Organize navigation" icon="map" href="navigation">
    Structure your content with groups and tabs
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="Changes not deploying">
    Check GitHub Actions or deployment logs in your dashboard for build errors.
  </Accordion>
  <Accordion title="Custom domain issues">
    Verify DNS records are correct and allow time for propagation. Use [DNSChecker](https://dnschecker.org) to verify.
  </Accordion>
</AccordionGroup>
