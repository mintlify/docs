...
<Steps>
  <Step title="Sign up">
    Go to [mintlify.com/start](https://mintlify.com/start) and connect your GitHub account.
  </Step>
  <Step title="Create your docs repository">
    Create a new repository or select an existing one for your documentation.
  </Step>
  <Step title="Deploy">
    Install the GitHub App and your site deploys automatically to `<your-project>.mintlify.app`.
  </Step>
  <Step title="Make changes">
    Edit your docs using the [web editor](/editor/index) or [locally with the CLI](/installation), then push to deploy.
  </Step>
</Steps>

Continue reading for detailed instructions on each step.
