  ...
  <Tab title="CLI">
    <Steps>
      ...
      <Step title="Push your changes">
        ...
        Mintlify automatically deploys your changes. View your <snippet file="snippets/rainbow-text.mdx" /> status on the [Overview](https://dashboard.mintlify.com/) page of your dashboard.
      </Step>
    </Steps>
  </Tab>
  <Tab title="Web editor">
    <Steps>
      ...
      <Step title="View live">
        On the [Overview](https://dashboard.mintlify.com/) page of your dashboard, you can see your site's <snippet file="snippets/rainbow-text.mdx" /> status. When it finishes deploying, refresh your documentation site to see your changes live.
      </Step>
    </Steps>
  </Tab>
</Tabs>
