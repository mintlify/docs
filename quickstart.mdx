...
After you complete this guide, you will have a live documentation site ready for customization and expansion.
...
After you complete the onboarding process, Mintlify automatically deploys your documentation site to a unique URL with this format:

```
https://<your-project-name>.mintlify.app
```

Find your URL on the Overview page of the dashboard.
...
<Info>
  Update the GitHub App permissions if you move the documentation to a different repository.
</Info>
...
<Card title="Code-based workflow" icon="terminal" horizontal href="#code-based-workflow">
  For developers who prefer working with existing tools. Click to jump to this section.
</Card>

<Card title="Web editor workflow" icon="mouse-pointer-2" horizontal href="#web-editor-workflow">
  For users who prefer a visual interface. Click to jump to this section.
</Card>

## Code-Based Workflow

The code-based workflow integrates with your existing development environment and Git repositories. This workflow works best for technical teams who want to manage documentation alongside code.
...
The web editor workflow provides a what-you-see-is-what-you-get (WYSIWYG) interface for creating and editing documentation. This workflow works best for people who want to work in their web browser without additional local development tools.
...
<Info>
  If you have not installed the GitHub App, you will be prompted to install the GitHub App when you open the web editor.
</Info>
...
In the web editor, you can navigate your documentation files in the sidebar. Update the introduction page:
...
Mintlify deploys your changes immediately to your documentation site.
...
<Card title="Set Up API References" icon="code" href="/api-playground/overview" horizontal>
  Create interactive API (Application Programming Interface) references with OpenAPI and AsyncAPI specifications.
</Card>
