...
Get your documentation live in under 5 minutes:
...
<Steps>
  ...
  <Step title="Create a repository">
    Select or create a repository for your documentation during onboarding.
  </Step>
  <Step title="Deploy">
    Your site deploys automatically at `https://<your-project>.mintlify.app`.
  </Step>
</Steps>

That's it! Read on for detailed setup instructions and making your first change.
