...
<Steps>
  ...
  <Step title="Complete setup">
    Follow the onboarding prompts. You can connect your own GitHub repository or skip to use a Mintlify-hosted repository.
  </Step>
...
<Steps>
  ...
  <Step title="Publish">
    Click **Publish** in the top-right corner. Your changes will be live in moments.
  </Step>
</Steps>
