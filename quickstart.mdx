...
Go to [mintlify.com/start](https://mintlify.com/start) and complete onboarding. Connect your GitHub account, select a repository, and install the GitHub App. Your site deploys to your `.mintlify.app` URL.
