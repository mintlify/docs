...
<AccordionGroup>
  <Accordion icon="github" title="Creating Your Documentation Repository">
    If you've created a docs repo in our onboarding, this step is complete. If [you'd like to](https://) test out Mintlify locally you can clone our [starter kit](https://github.com/mintlify/starter).
  </Accordion>
