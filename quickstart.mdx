...
With Github integration, Mintlify Docs turns your MDX files and configurations from our [starter template](https://github.com/mintlify/starter) into a beautiful documentation site while making source control a breeze.

<AccordionGroup>
  <Accordion icon="github" title="Creating Your Documentation Repository">

    Now if you've gone through our onboarding process, this part is already done for you. Find your docs repository on your Mintlify [dashboard](https://dashboard.mintlify.com).

    For those not wishing to log in with Github, you can still clone our [starter template](https://github.com/mintlify/starter). Once done, just get in touch with [our team](mailto:support@mintlify.com) to deploy your repository.
...
Mintlify supports an array of advanced features like API reference docs, analytics, versioning to accommodate any of your documentation needs.

<AccordionGroup>
  <Accordion icon="code-branch" title="Generating API References">

    You can easily set up your API references using an OpenAPI spec. Here how to d that:
  ...
  <Accordion icon="star" title="Adding a Custom Domain">
    ...
    Totally integrate your docs into your website by hosting them on a custom domain. This is included even in the free Mintlify plan. Navigate to your [dashboard settings](https://www.dashboard.mintlify.com/settings) to add a custom domain.
  ...
  <Accordion icon="chart-simple" title="Adding Analytics">
    ...
    Our in-built analytics give you insights into page views, search analytics, session recordings and more. Access these on your [dashboard](https://dashboard.mintlify.com/analytics). We also support integrations with a ranging list of analytics providers. You can find support list [here](/integrations/analytics/overview).
...
Congrats! You've set up your Mintlify Docs and it's looking amazing! Need support or want to give some feedback? You can join our [community](https://join.slack.com/t/mintlify-users/shared_invite/zt-1xfzz6x35-f4o4WCYfpvLhSj3O7WAOMA) or drop us an email at [support@mintlify.com](mailto:support@mintlify.com).
