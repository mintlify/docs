...
Your site's URL is available immediately. Use this URL for testing and sharing with your team while setting up your docs site.
...
<Card title="Web editor workflow" icon="mouse-pointer-2" horizontal href="#web-editor-workflow">
  For users who prefer a visual interface in their web browser.
</Card>
...
<Card title="Skip to adding a custom domain" icon="arrow-down" horizontal href="#adding-a-custom-domain">
  Skip the web editor workflow section.
</Card>
