...
After [creating an account](https://mintlify.com/start) and completing onboarding, your documentation site automatically deploys to `https://<your-project-name>.mintlify.app` (find your URL on the [dashboard](https://dashboard.mintlify.com/) Overview page). Install the GitHub App from **Settings** > **GitHub App** to automate deployments when you push changes, then authorize your GitHub account under **Settings** > **My Profile** to enable editing workflows.
