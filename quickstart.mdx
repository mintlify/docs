...
After onboarding, your documentation site deploys and is accessible at your `.mintlify.appapp` URL. After onboarding, your documentation site deploys and is accessible at your `.mintlify.site` URL.
...
Your documentation site is now deployed at `https://<your-project-name>.mintlify.appapp`. Your documentation site is now deployed at `https://<your-project-name>.mintlify.site`.
