...
<Tabs>
  <Tab title="CLI">
    ...
    Edit `index.mdx` and run `mint dev` to preview at `http://localhost:3000`. Push changes to deploy:
  ...
  <Tab title="Web editor">
    Open the [web editor](https://dashboard.mintlify.com/editor), edit `index.mdx`, and click **Publish**.
  </Tab>
</Tabs>
