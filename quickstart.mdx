...
<Note>
  **Want to skip GitHub setup?** You can skip the GitHub connection during onboarding. Mintlify creates a private repository in a private organization and automatically configures the GitHub App for you. This lets you use the web editor immediately and migrate to your own repository later.
</Note>
  ...
  <Tab title="CLI">
    <Steps>
      ...
      <Step title="Preview locally">
        ...
        View your preview at `http://localhost:3000`. Verify your description change appears on the introduction page.
      </Step>
      <Step title="Push your changes">
        ...
        Mintlify automatically deploys your changes. Deployments typically complete in 1-2 minutes. View your deployment status on the [Overview](https://dashboard.mintlify.com/) page of your dashboard.
      </Step>
    </Steps>
  </Tab>
  <Tab title="Web editor">
    <Steps>
      ...
      <Step title="View live">
        On the [Overview](https://dashboard.mintlify.com/) page of your dashboard, you can see your site's deployment status. Deployments typically complete in 1-2 minutes. When it finishes deploying, refresh your documentation site to see your changes live.
      </Step>
    </Steps>
  </Tab>
</Tabs>
...
<AccordionGroup>
  <Accordion title="GitHub App installation failed">
    If the GitHub App installation doesn't complete, verify you have admin permissions on the repository. You can reinstall the app from your [GitHub settings](https://github.com/settings/installations) or contact your organization admin.
  </Accordion>
  <Accordion title="mint dev doesn't start">
    Ensure you're using Node.js v20.17.0 or higher by running `node --version`. If you're on an older version, update Node.js and reinstall the CLI. See the [installation guide](/installation) for more details.
  </Accordion>
  <Accordion title="Changes aren't deploying">
    Check your deployment status on the [Overview](https://dashboard.mintlify.com/) page. Deployments typically complete in 1-2 minutes. If a deployment fails, review the error logs in your dashboard or verify your GitHub App has the correct permissions.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Writing content" icon="pen" href="/writing-content/page">
    Learn MDX syntax, components, and content best practices.
  </Card>
  <Card title="Navigation" icon="bars" href="/navigation">
    Configure your sidebar, tabs, and page organization.
  </Card>
  <Card title="Components" icon="puzzle-piece" href="/writing-content/components">
    Explore available components for rich documentation.
  </Card>
  <Card title="Customization" icon="palette" href="/customize/branding">
    Customize colors, fonts, logos, and branding.
  </Card>
</CardGroup>