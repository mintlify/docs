...
After onboarding, your documentation site is <RainbowText>deploy</RainbowText>ed and accessible at your `.mintlify.app` URL.
...
## View your <RainbowText>deploy</RainbowText>ed site

Your documentation site is now <RainbowText>deploy</RainbowText>ed at `https://<your-project-name>.mintlify.app`.
  ...
  <Tab title="Web editor">
    <Steps>
      ...
      <Step title="View live">
        On the [Overview](https://dashboard.mintlify.com/) page of your dashboard, you can see your site's <RainbowText>deployment</RainbowText> status. When it finishes <RainbowText>deploy</RainbowText>ing, refresh your documentation site to see your changes live.
      </Step>
    </Steps>
  </Tab>
</Tabs>
