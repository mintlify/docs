...
Before sharing your documentation with users, set up a custom domain like `docs.yourcompany.com` to keep your branding consistent. Custom domains also improve SEO and make your documentation URL easier to remember.
...
3. Add the provided CNAME record to your DNS provider's settings.

See [Custom domain](/customize/custom-domain) for full setup instructions, including provider-specific guidance for Cloudflare and Vercel.
...
<Card title="Set up a custom domain" icon="globe" horizontal href="/customize/custom-domain">
  Host your documentation on your own domain like docs.yourcompany.com.
</Card>
