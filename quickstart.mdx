...
Deploy your documentation site and make your first content change.

## Before you begin

Mintlify uses a docs-as-code approach: every page is a file in your documentation <Tooltip tip="Your documentation's source code where all files and their history are stored.">repository</Tooltip>. Edit locally or in the web editor, and changes sync to your remote repository.

<Tip>
  Using an AI coding tool? Copy the prompt below to add the Mintlify [skill](/ai/skillmd) and [MCP server](/ai/model-context-protocol) for better results.
</Tip>
...
Go to [mintlify.com/start](https://mintlify.com/start) and complete onboarding. You'll connect your GitHub account, create or select a repository, and install the GitHub App for automatic deployments.
...
<Tabs>
  <Tab title="CLI">
    <Steps>
      ...
      <Step title="Edit and preview">
        Update the `description` in `index.mdx`, then preview:
  ...
  <Tab title="Web editor">
    <Steps>
      ...
      <Step title="Publish">
        Click **Publish** in the top-right of the toolbar. Refresh your site once deployment finishes on the [Overview](https://dashboard.mintlify.com/) page.
      </Step>
    </Steps>
  </Tab>
</Tabs>
