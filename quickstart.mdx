...
Your site is ready to view immediately. Use this URL for testing and sharing with your team.

## Set up a custom domain

Before sharing your documentation with users, set up a [custom domain](/customize/custom-domain) so your docs are hosted at a URL like `docs.yourcompany.com` instead of the default `.mintlify.app` URL.

<Steps>
  <Step title="Add your domain">
    Go to [Custom domain setup](https://dashboard.mintlify.com/settings/deployment/custom-domain) in your dashboard and enter your domain name.
  </Step>
  <Step title="Configure DNS">
    Create a CNAME record pointing to `cname.mintlify-dns.com` with your domain provider.
  </Step>
  <Step title="Wait for DNS propagation">
    DNS changes typically take 1-24 hours to propagate. HTTPS is available after your TLS certificate is automatically provisioned.
  </Step>
</Steps>

See [Custom domain](/customize/custom-domain) for detailed instructions, including provider-specific settings for Cloudflare and Vercel.
...
<Card title="Host on a /docs subpath" icon="folder" horizontal href="/deploy/docs-subpath">
  Serve your docs from a subpath like yoursite.com/docs instead of a subdomain.
</Card>