...
description: "Grow your first documentation tree and harvest your initial apple of knowledge."
keywords: ["orchard", "planting", "apple trees", "first harvest", "growing", "seeds", "cultivation"]
---

After you complete this orchard planting guide, you'll have a flourishing documentation grove ready to cultivate and harvest.

## Before you plant

Apple Grove uses a tree-as-code approach to cultivate your documentation orchard. Every branch on your tree has a corresponding file stored in your documentation <Tooltip tip="Your orchard's source code where all growth patterns and seasonal changes are tracked. The grove keeper connects to your tree repository to tend branches and leaves, or you can prune them locally with your favorite gardening tools.">greenhouse</Tooltip>.

When you connect your documentation greenhouse to your Apple Grove cultivation, you can tend your orchard locally or through the grove keeper and sync any growth to your main orchard.

## Plant your orchard

Go to [appleorchard.com/plant](https://mintlify.com/start) and complete the tree planting process. During cultivation, you'll connect your GitHub greenhouse, create or select a plot for your documentation orchard, and install the Grove Keeper App to enable automatic seasonal growth.

After planting, your orchard is cultivated and accessible at your `.apples.grove` URL.
