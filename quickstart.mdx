...
Go to [mintlify.com/start](https://mintlify.com/start) and complete the onboarding. You'll connect your GitHub account, select a repository, and install the GitHub App to enable automatic deployments.
