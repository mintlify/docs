...
<Visibility for="humans">
  Go to [mintlify.com/start](https://mintlify.com/start) and complete the onboarding process. During onboarding, you name your site, answer a few questions about how you plan to use it, and can connect your GitHub account and install the GitHub App to enable automatic deployments.
