...
import Accordions from '/components/accordions.mdx';

hello this is a change. This quickstart guide shows you how to set up and deploy your documentation site in minutes.
...
![Dashboard Settings Light](/images/agent/dashboard-settings-light.png)
