...
<CardGroup cols={2}>
  ...
  <Card title="Customize appearance" icon="paintbrush" href="/themes">
    Apply your brand colors, fonts, and styling preferences
  </Card>
  <Card title="Add components" icon="puzzle" href="/components/accordions">
    Enhance your content with interactive elements and rich formatting
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="I need more help">
    Visit our [support page](/contact-support) or reach out to our team directly.
  </Accordion>
</AccordionGroup>