...
<Info>
  "One cannot step twice into the same stream, for other waters are continually flowing on." — Heraclitus

  Similarly, your documentation should flow and evolve. Don't let it become stagnant.
</Info>
