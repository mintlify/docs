...
After you complete this guide, you'll have a live documentation site ready to customize, update, and extend with AI.
...
When you connect your documentation repository to your project, you can work on your documentation locally with the CLI, in the web editor, or through AI tools — and sync any changes to your remote repository.
...
<Tip>
  Your site is ready to share immediately. Before going public, you may want to add a [custom domain](/customize/custom-domain).
</Tip>
  ...
  <Tab title="Agent">
    <Steps>
      <Step title="Open the agent">
        Navigate to the [agent](https://dashboard.mintlify.com/editor) in your dashboard and open the **Agent** panel.
      </Step>
      <Step title="Describe your change">
        Type a prompt describing what you want to update. For example:

        > Update the introduction page description to explain what our product does.

        The agent reads your existing content and proposes targeted edits.
      </Step>
      <Step title="Review and publish">
        Review the proposed changes in the diff view, then click **Publish** to deploy them directly to your site.
      </Step>
    </Steps>
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="Explore AI-native features" icon="sparkles" href="/ai-native">
    Learn how the assistant, agent, and MCP server help users read, write, and discover your documentation.
  </Card>
