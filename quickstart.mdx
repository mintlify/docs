...
<Card title="Export documentation to PDF" icon="file-pdf" href="/docs-to-pdf" horizontal>
  Generate and download PDF versions of your documentation for offline sharing and distribution.
</Card>
