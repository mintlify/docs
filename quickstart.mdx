...
<Tabs>
  ...
  <Tab title="Web editor">
    <Steps>
      ...
      <Step title="Publish">
        Click **Publish** in the top-right of the toolbar. Refresh your site when the deployment finishes.
      </Step>
    </Steps>
  </Tab>
</Tabs>
