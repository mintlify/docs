...
Go to [mintlify.com/start](https://mintlify.com/start) and complete onboarding. Connect your GitHub account, select a repository, and install the GitHub App for automatic deployments. Your site deploys to your `.mintlify.app` URL.

<Tip>
  Skip GitHub connection during onboarding to start immediately. Mintlify creates a private repository for you, letting you use the web editor right away and migrate later.
</Tip>

## View your deployed site

Your site is live at `https://<your-project-name>.mintlify.app`. Find your URL on the **Overview** page of your [dashboard](https://dashboard.mintlify.com/).
