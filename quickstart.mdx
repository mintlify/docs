...
<Card title="Generate docs from source repositories" icon="sparkles" horizontal href="/generate-docs-from-source">
  Use an existing GitHub repository or website as read-only context for AI-generated documentation.
</Card>
