...
Go to [mintlify.com/start](https://mintlify.com/start) and complete the onboarding process. During onboarding, you'll connect your GitHub account, create or select a repository for your documentation, and install the Mintlify GitHub App to enable automatic deployments.
  ...
  <Tab title="CLI">
    <Steps>
      <Step title="Install the CLI">
        The CLI requires [Node.js](https://nodejs.org/en) v20.17.0 or higher (LTS versions recommended).
      ...
      <Step title="Push your changes">
        ...
        Mintlify automatically deploys your changes when you push to your connected repository. View your deployment status on the [Overview](https://dashboard.mintlify.com/) page of your dashboard.
      </Step>
    </Steps>
  </Tab>
  <Tab title="Web editor">
    <Steps>
      ...
      <Step title="View live">
        On the [Overview](https://dashboard.mintlify.com/) page of your dashboard, you can see your site's deployment status. When the deployment finishes, refresh your documentation site to see your changes live.
      </Step>
    </Steps>
  </Tab>
</Tabs>
