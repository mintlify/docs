...
<AccordionGroup>
  <Accordion title="Optional: Skip connecting GitHub during onboarding">
    ...
    This lets you use the web editor immediately. When you're ready, go to [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) to migrate to your own repository using the guided setup wizard. See [Clone to your own repository](/deploy/github#clone-to-your-own-repository) for details.
  </Accordion>
</AccordionGroup>
