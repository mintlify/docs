...
Before sharing your documentation with users, set up a custom domain like `docs.yourcompany.com` to host your documentation on your own brand.
...
<Steps>
  ...
  <Step title="Configure DNS">
    Add a CNAME record pointing to `cname.mintlify-dns.com` with your domain provider.
  </Step>
  <Step title="Wait for provisioning">
    DNS propagation typically takes 1–24 hours. TLS certificates are automatically provisioned once DNS resolves.
  </Step>
</Steps>

See [Custom domain](/customize/custom-domain) for provider-specific settings, Cloudflare configuration, and troubleshooting.
