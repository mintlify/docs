...
<Card title="Customize your site" icon="palette" horizontal href="/customize/branding">
  Add your logo, brand colors, and favicon to match your company's identity.
</Card>
<Card title="Add more pages" icon="file-plus" horizontal href="/writing-content/page">
  Create new pages and organize them into groups in your navigation.
</Card>
<Card title="Use the web editor" icon="mouse-pointer-2" horizontal href="/editor/index">
  Edit documentation in your browser with live preview and AI-powered assistance.
</Card>
...
<Card title="Add a custom domain" icon="globe" horizontal href="/customize/custom-domain">
  Connect your own domain to make your documentation site production-ready.
</Card>