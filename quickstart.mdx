...
- A Mintlify account ([create one here](https://mintlify.com/start)) with onboarding completed
- [Node.js](https://nodejs.org/en) v20+ installed (only required for code-based workflow)
...
Find your URL on the Overview page of your [dashboard](https://dashboard.mintlify.com/). Your site's URL is available immediately. Use this URL for testing and sharing with your team while you are setting up your docs site.

### Connect GitHub

Mintlify uses a GitHub App to automate deployment when you push changes to your repository.

1. Navigate to **Settings** in your Mintlify dashboard.
2. Select **GitHub App** from the sidebar and select **Install GitHub App**.
3. Select the organization or user account and the repositories you want to connect.
4. Return to **Settings** > **My Profile** and select **Authorize GitHub account**.
...
<Info>
  Update the GitHub App permissions if you move your documentation to a different repository. An admin for your GitHub organization may need to authorize your account depending on your organization settings.
</Info>
...
<Check>
  **Success!** After the deployment completes (usually 1-2 minutes), visit `<your-project-name>.mintlify.app` to see your "Hello World" title live.
</Check>
...
To add a custom domain, navigate to the [Domain Setup](https://dashboard.mintlify.com/settings/deployment/custom-domain) page in your dashboard. Enter your domain (for example, `docs.yourcompany.com`) and follow the provided instructions to configure DNS settings with your domain provider.
...
<Info>
  The **Name** field should match your chosen subdomain. For example, use `docs` for `docs.yourcompany.com` or `help` for `help.yourcompany.com`.
</Info>
