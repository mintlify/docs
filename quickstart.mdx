...
<Accordion icon="code-branch" title="Monorepo Setup">
  If you want your docs to live alongside your code as a monorepo setup, follow these steps:
...
<AccordionGroup>
  <Accordion icon="rectangle-terminal" title="Editing locally (recommended for developers)">
    ...
    2. Clone your docs repository using `git clone <your-repo>`. If you haven't set it up yet, now would be a good time to do so with these [SSH keys](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent)
  ...
  <Accordion icon="palette" title="Customizing to your brand">
    ...
    Easily customize colors, logos, and buttons among other configurations in your `mint.json` file. Start with these basic configurations:
  ...
  <Accordion icon="rocket" title="Pushing changes">
    ...
    Once ready, commit and push your changes to update your docs site. Here's a [guide](https://docs.github.com/en/get-started/using-git/pushing-commits-to-a-remote-repository#about-git-push) on how to do that. If the GitHub App is unable to successfully deploy your changes, you can manually update your docs through our [dashboard](https://dashboard.mintlify.com).
...
<Frame>
  ...
  <Accordion icon="code-branch" title="Generating API references">
    ...
    3. Include the generated endpoint MDX files in your `mint.json` under `navigation`.

    For a complete guide on using Mintlify with OpenAPI, check out [this guide](/api-playground/openapi/setup). [This guide](/api-playground/openapi/writing-openapi) explains how to configure your API authentication methods. For manual API reference definition, explore [our syntax](/api-playground/overview).
...
<Note>
  ...
  Interested? [Contact us](mailto:sales@mintlify.com) to learn more.
</Note>
...
support or want to give feedback? Join our [community](https://mintlify.com/community) or email us at [support@mintlify.com](mailto:support@mintlify.com).