...
If you're using your own repository, install the GitHub App through your [dashboard](https://dashboard.mintlify.com/settings/organization/github-app). The app needs access to your documentation repository and any additional repositories that you want to serve as context for the agent.

See [GitHub](/deploy/github) for full installation instructions and permissions details.
