...
Mintlify docs are rendered from MDX files and configurations defined in our [starter kit](https://github.com/mintlify/starter). We use GitHub to integrate your docs with your code and make source control effortless. Get started by onboarding through the [dashboard](https://dashboard.mintlify.com) or cloning our [starter kit](https://github.com/mintlify/starter).
...
Congratulations! You've set up your Mintlify docs, and they're looking amazing! Need support or want to give feedback? Join our [community](https://mintlify.com/community) or email us at [support@mintlify.com](mailto:support@mintlify.com).