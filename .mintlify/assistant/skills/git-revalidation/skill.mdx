...
description: "Use this skill when a user reports that Suggest Edits isn't showing on their docs, or GitHub-dependent features have stopped working after they changed their repository from private to public or vice versa. Also applies when the git connection appears stale or broken."
---
