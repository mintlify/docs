---
title: Overview
description: Leverage the external API to programmatically trigger an update when desired.
---
<Note>
  The external API is only available on the [startup plan](https://mintlify.com/pricing) and above. 

  CIf you are looking to document your own API's instead, check out the [API Documentation](/api-reference/api-playground) section. 
</Note>
