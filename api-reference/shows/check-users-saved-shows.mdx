...
description: "Check if one or more shows is saved in the current user's library"
api: "GET https://api.spotify.com/v1/me/shows/contains"
---

# Check User's Saved Shows

Check if one or more shows is saved in the current user's library
...
```bash
curl -X GET "https://api.spotify.com/v1/me/shows/contains" \
