...
description: "Get a list of the episodes saved in the current user's library"
api: "GET https://api.spotify.com/v1/me/episodes"
---
...
```bash
curl -X GET "https://api.spotify.com/v1/me/episodes" \
