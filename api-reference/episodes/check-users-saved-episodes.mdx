...
description: "Check if one or more episodes is saved in the current user's library"
api: "GET https://api.spotify.com/v1/me/episodes/contains"
---

# Check User's Saved Episodes

Check if one or more episodes is saved in the current user's library
...
```bash
curl -X GET "https://api.spotify.com/v1/me/episodes/contains" \
