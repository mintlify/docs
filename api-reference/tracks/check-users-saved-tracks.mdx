...
description: "Check if one or more tracks is saved in the current user's library"
api: "GET https://api.spotify.com/v1/me/tracks/contains"
---

# Check User's Saved Tracks

Check if one or more tracks is saved in the current user's library
...
```bash
curl -X GET "https://api.spotify.com/v1/me/tracks/contains" \
