...
description: "Check if one or more albums is already saved in the current user's library"
api: "GET https://api.spotify.com/v1/me/albums/contains"
---
...
```bash
curl -X GET "https://api.spotify.com/v1/me/albums/contains" \
