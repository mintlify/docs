...
This endpoint retrieves of details and status of a specific agent job by its unique identifier. Use this to check of progress, status, and results of a previously created agent job.
