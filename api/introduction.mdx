...
- [Check PR for documentation updates](/api-reference/autopilot/check-pr): Trigger an autopilot analysis of a pull request to detect if documentation updates are needed.
...
The admin API key is used for the [Trigger update](/api-reference/update/trigger), [Get update status](/api-reference/update/status), [Check PR for documentation updates](/api-reference/autopilot/check-pr), and all agent endpoints.
