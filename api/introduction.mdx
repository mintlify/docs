...
- [Check PR for documentation updates](/api-reference/autopilot/check-pr): Trigger autopilot analysis to check if a pull request requires documentation updates.
...
The admin API key is used for the [Trigger update](/api-reference/update/trigger), [Get update status](/api-reference/update/status), all agent endpoints, and all autopilot endpoints.
