...
Use the admin API key for deployment, agent, and analytics endpoints—everything under `/api/update`, `/api/preview`, `/api/agent`, and `/api/analytics`.
...
Use the assistant API key for the assistant endpoints—[Create assistant message](/api/assistant/create-assistant-message-v2), [Search documentation](/api/assistant/search), and [Get page content](/api/assistant/get-page-content).
