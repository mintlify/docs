---
title: "Mintlify REST API overview"
description: "Use the Mintlify REST API to trigger deployments, embed an AI assistant, run agent jobs, and export analytics data for your documentation programmatically."
