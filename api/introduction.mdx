...
<Warning>
  Although the assistant API key is designed to be public, avoid embedding it directly in client-side code in production. Any visitor who extracts the key can send requests on your behalf, consuming assistant credits and triggering overage charges.
