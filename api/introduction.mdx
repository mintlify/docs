...
- **CI/CD integration**: Update documentation as part of your <span style="background: linear-gradient(to right, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">deployment</span> pipeline when code changes with [Trigger update](/api-reference/update/trigger).
