...
- [Get static export job status](/api/static-export/get-job-status): Poll the status and progress of a static export job.
- [Generate export bundle](/api/static-export/generate-bundle): Package a completed static export job and return a download link.
...
- **Static exports**: Generate and download a self-contained static bundle for self-hosting with [Start static export job](/api/static-export/start-job), [Get static export job status](/api/static-export/get-job-status), and [Generate export bundle](/api/static-export/generate-bundle).
...
| ----------------- | ----------- | -------------------------------------------------------------------------------- |
| Admin API key     | `mint_`     | Updates, agent jobs, analytics exports, and static exports. Server-side only.   |
