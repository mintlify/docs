...
Store your admin API key as the `MINTLIFY_ADMIN_KEY` repository secret, and configure cluster credentials, for example, by using `azure/setup-helm` and your Kubernetes configuration file (`kubeconfig`), before the deploy step.
