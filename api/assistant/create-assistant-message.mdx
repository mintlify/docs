...
<Note>
  The v1 assistant API is compatible with **AI SDK v4**. If you use AI SDK v5 or later, use the [v2 endpoint](/api-reference/assistant/create-assistant-message-v2) instead.
</Note>
