---
title: Create assistant message (v2)
description: Generate a response from the assistant using the v2 endpoint, compatible with AI SDK v5.
openapi: /discovery-openapi.json POST /v2/assistant/{domain}/message
keywords: [ "assistant message", "embed", "chat", "integrate", "v2", "ai sdk v5" ]
---

## Integration with `useChat`

The `useChat` hook from Vercel's AI SDK is the recommended way to integrate the assistant API into your application. The v2 endpoint is compatible with AI SDK v5+.
