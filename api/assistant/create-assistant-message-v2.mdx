---
title: "Assistant message (AI SDK v5+)"
...
<Info>
  This endpoint is compatible with **AI SDK v5+**. If you use AI SDK v4, use the [assistant message (AI SDK v4)](/api/assistant/create-assistant-message) endpoint instead.
</Info>
