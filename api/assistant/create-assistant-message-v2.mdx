---
title: "Create Mintie assistant message"
description: "Send messages to Mintie assistant and receive streaming responses using AI SDK v5 or later with the useChat hook."
openapi: /discovery-openapi.json POST /v2/assistant/{domain}/message
keywords:
  [
    "Mintie assistant message",
    "embed",
    "chat",
    "integrate",
    "v2",
...
<Info>
  The Mintie assistant message v2 endpoint is compatible with **AI SDK v5+**. If you
  use AI SDK v4, use the [Mintie assistant message v1
