...
- The `threadId` query parameter that Mintlify appends to the support URL when the assistant deflects to your support platform using [link deflection](/assistant/configure#link-deflection).
