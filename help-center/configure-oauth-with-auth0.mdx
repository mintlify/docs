...
description: "Set up Auth0 as the OAuth 2.0 identity provider for a private Mintlify documentation site, including endpoint URLs, callback registration, and group-based access."
