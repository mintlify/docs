---
title: "Advertise an externally-hosted MCP server"
description: "Expose a self-hosted MCP server alongside the built-in search MCP server on your docs domain, since Mintlify's discovery endpoints only list servers it hosts."
