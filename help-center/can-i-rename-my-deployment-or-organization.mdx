...
Your organization's slug is the unique identifier that appears in your dashboard URL, `app.mintlify.com/<org>/<subdomain>`. The slug cannot be changed after the organization is created. To use a different slug, create a new organization, recreate your deployments in it, and delete the old organization from the [Danger zone](https://app.mintlify.com/settings/organization/danger-zone). Deleting an organization is irreversible and requires the [admin role](/dashboard/roles).
