...
description: "Change your deployment's name from the dashboard, and learn why subdomains and organization names require deleting and recreating instead of renaming."
...
- **Changeable**: your deployment's name, your docs site name in `docs.json`, and your custom domain.
