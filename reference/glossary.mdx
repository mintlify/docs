...
A domain, subdomain, or subpath that you connect to a Mintlify site instead of using its default `.mintlifysite.com` address. See [Custom domain](/customize/custom-domain).
