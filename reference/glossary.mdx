...
A browser API that lets sites register [Model Context Protocol](#model-context-protocol-mcp) tools directly on the page for WebMCP-capable browsers and in-browser agents to call, without a separate server connection. See [WebMCP](https://developer.chrome.com/docs/ai/webmcp) in the Chrome Developers documentation for more information.
