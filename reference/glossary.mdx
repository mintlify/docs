...
keywords: ["terms", "definitions", "terminology"]
---
...
A documentation site within a Mintlify organization. A project connects source content and a deployment branch to a live site. Projects were previously called deployments, and some APIs and tools still use that term, such as the `list_deployments` tool in the [Admin MCP server](#admin-mcp-server).
