...
Configuring the assistant, agent, and automations to run on your own LLM provider API key and model instead of Mintlify's defaults. Also called BYOK. Available on Enterprise plans. See [Bring your own model](/ai/bring-your-own-model).
