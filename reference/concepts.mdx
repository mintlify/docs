...
keywords: ["concepts", "how Mintlify works", "repository", "project", "deployment", "publishing", "AI"]
---
...
## Organizations, projects, and sites

An **organization** is the workspace for your team. It contains your members, organization-level settings, and one or more projects.

A **project** is a documentation site in your organization. It connects a repository, content directory, and deployment branch to a published site. An organization can have multiple projects for separate products or documentation properties.

A **live site** is the published output of a project. Mintlify provides a `.mintlify.site` URL by default. You can connect a [custom domain](/customize/custom-domain) for your site. Sites include your content, navigation, search, and any features you enable, such as the assistant or API playground.

<Note>
  Projects were previously called deployments. Some dashboard settings and APIs still use **deployment** to refer to a project.
</Note>
...
| [Admin MCP server](/ai/mintlify-mcp) | Agents | Reads and updates projects through authenticated tools | Yes |
