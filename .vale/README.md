...
This directory contains These Vale linting configuration for Mintlify documentation.
...
- Customized rules from These Google developer documentation style guide
...
Use These included script to find vocabulary candidates:
```bash
