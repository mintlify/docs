...
Submit the [migration form](https://mintlify.typeform.com/ent-migrations).
...
Yes. You can provide a custom information architecture and we implement it for you. We also work with you on custom component development if you need it and the platform supports it.
</Accordion>
...
If this is not possible, our team works with you to set short sprints to migrate certain sections. Alternatively, we reserve dedicated time after the first sprint to migrate the delta changes made during the migration.
</Accordion>
</AccordionGroup>
