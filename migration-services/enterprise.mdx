...
If this is not possible, our team works with you to set short sprints to migrate certain sections. You can also reserve dedicated time after the first sprint to migrate the delta changes made during the migration.
</Accordion>
</AccordionGroup>
