...
After your custom domain resolves, verify the launch before decommissioning your former site.

- Load the docs over HTTPS and confirm the certificate is valid.
- Spot-check pages from every top-level navigation section on desktop and mobile.
- Test a few known redirects from your former URLs and confirm they resolve to the correct new pages.
- If your site uses authentication, sign in with a test account and confirm gated pages load as expected.
- Confirm your analytics integrations are receiving pageviews.
- Monitor for 404s, redirect failures, and build failures for at least the first day.
