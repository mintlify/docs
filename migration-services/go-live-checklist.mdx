...
- **Enable add-ons.** Go to the [General](https://app.mintlify.com/settings/project/general) page in your dashboard. Enable relevant add-ons such as agent feedback, [CI checks](/deploy/ci), related topics, and more.
