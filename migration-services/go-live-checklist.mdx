...
- **Verify analytics tracking.** Load a page on your live site and confirm events appear in your provider's real-time or debug view. See the [analytics integration guide](/integrations/analytics/overview).

## Go live

- **Set your custom domain.** See the [custom domain guide](/customize/custom-domain).
- **Verify your custom domain.** Confirm both verification `TXT` records show as verified in your dashboard, DNS records resolve, and your site loads over HTTPS. See the [custom domain guide](/customize/custom-domain#configure-your-dns).
