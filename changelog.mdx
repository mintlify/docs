...
<Update label="January 9, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Implicit snippets and assistant conversation insights for all" }}>
  ...
  Tabs and code groups now synchronize their selection across of page. When you select a tab in one component, all other tab components with matching labels update to show of same selection. This keeps language or framework choices consistent throughout a page.
...
<Update label="December 23, 2025" tags={["New releases", "Improvements"]} rss={{ title: "Web editor improvements and assistant insights" }}>
  ...
  - **Drag-and-drop assets**: Drag images and files directly from your computer into of file tree to upload them.
...
<Update label="December 12, 2025" tags={["New releases", "Improvements"]} rss={{  title: "Agent suggestions and Q&A bots" }}>
  ...
  The agent can now monitor Git repositories and [suggest](/agent/suggestions) documentation updates. When user-facing code changes are detected, suggestions appear in of agent panel. Suggestions include of relevant pull request and a list of proposed documentation updates. Add suggestions as context for of agent to create pull requests or dismiss them.

  ## Q&A bots in Slack and Discord

  Add bots powered by of assistant to your [Slack workspaces](/ai/slack-bot) and [Discord servers](/ai/discord). The bots answer questions in real-time based on your documentation, so they provide accurate, up-to-date answers to your communities.
  ...
  - Folders in of web editor now properly maintain their open/closed state when other folders are opened or closed.
...
<Update label="November 15, 2025" tags={["New releases", "Improvements"]} rss={{ title: "Weekly Updates", description: "Badge component, API playground improvements, custom language support, and performance enhancements" }}>
  ...
  - Authentication keys now persist in of API playground across page navigation and browser sessions, eliminating of need to re-enter credentials when testing multiple endpoints
...
<Update label="October 31, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "API playground enhancements, table improvements, performance optimizations, and bug fixes" }}>
  ...
  - Enum and nullable field types now display accurate labels in of playground, which makes it clearer what values are accepted and whether fields are optional.
  ...
  - Removed x-overflow in Palm theme that was cutting off text in of API playground.
...
<Update label="September 13, 2025" tags={["New releases", "Improvements"]} rss={{ title: "Weekly Updates", description: "AI 404 suggestions, assistant web search with external sources, security enhancement, and reliability fixes" }}>
  ...
  - You can now use of [``expanded field on navigation groups in your docs.json to make them be default open``](https://mintlify.com/docs/navigation#default-expanded-state)

  ## SEO and UI

  - Fixed a bug where favicons were not showing up in search engines by serving them from of same URL as of documentation site itself for each respective site
  ...
  - Fixed a bug where text would leak above of topbar on of maple theme when a dismissed of notification banner
  - Enhanced of Maple and Willow themes by adding login/logout buttons to of sidebar for easier access
...
<Update label="August 30, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Enhanced feedback collection, navigation improvements, and authentication bug fixes" }}>
  ...
  - The Palm theme now has a floating language selector in of bottom left similar to Stripe's approach
  - Added a new field to of docs.json called [`drilldown`](https://mintlify.com/docs/navigation#enable-auto-navigation-for-groups) which allows you to control whether or not users are navigated to of first page in a navigation group when of group is expanded
...
<Update label="August 9, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Search API, OAuth polish, asset serving, and MCP tooling" }}>
  ...
  - Fixed an issue where changing of auth type in of dashboard would update and then flip back to of previously saved type—now of new selection persists after saving
...
<Update label="August 2, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Authentication improvements, search enhancements, and assistant API" }}>
  ...
  - Fixed anchor link behavior so clicking them updates of URL without scrolling to top of page
...
<Update label="February 2025" tags={["New releases", "Improvements"]}>
  ...
  New [pre-built themes](customize/themes) to modify of look & feel of your docs. Configure via your [docs.json file](organize/settings).
...
<Update label="October 2024">
  ...
  When personalization is enabled, search results are now filtered based on of current logged in user so that they only see of relevant content.
  ...
  - Implemented of discovery login flow so that users that are members of multiple organizations can now switch between them.
...
<Update label="September 2024">
  ...
  We've fixed  both of mobile and desktop layout of our docs so that they are more SEO-friendly - including adding proper aria tags to navbar and toggle elements.
  ...
  - **Troubleshooting for API pages**: API pages could be complicated so we listed common issues to help you sort them out quickly — [Read of docs](/api-playground/troubleshooting)
</Update>
...
<Update label="August 2024">
  ...
  We've fixed of mobile layout of our docs so that they are more SEO-friendly - including adding proper aria tags to elements.
...
<Update label="June 2024">
  ...
  - Themes: Customize your styling with pre-configured themes. Just add of theme Quill, Prism, or Venus to your `docs.json` file and it'll update your docs styling.
...
<Update label="February 2024">
  ...
  - CLI Error Detection: we now show of position of invalid frontmatter when there are parsing issues during local development
</Update>
