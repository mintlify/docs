...
<Update label="March 15, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Contextual menu expansion, agent PR comments, workflow run details, and more" }}>

  ## Contextual menu expansion

  The [contextual menu](/ai/contextual-menu) now includes options for [Devin](https://devin.ai), [Windsurf](https://windsurf.com), and [Google AI Studio](https://aistudio.google.com). Open page content in these tools directly from your documentation, or connect to Devin's MCP server with a single click.

  ## Agent PR comments

  The [agent](/agent) now comments directly on pull requests with documentation suggestions, making it easier to review and act on proposed changes without leaving your Git workflow.

  ## Workflow run details

  View individual [workflow](/agent/workflows) run details in the dashboard, including run status, logs, and outputs. Navigate to specific runs from the workflows page.

  ## Support agent analytics

  A new analytics page for the support agent is available in the dashboard, providing visibility into support agent usage and performance.

  ## User profile pictures

  User profile pictures now display in the dashboard for a more personalized experience.

  ## Bug fixes

  - Fixed Slack notification YAML formatting for GitHub-based workflows
  - Fixed assistant markdown rendering issues
