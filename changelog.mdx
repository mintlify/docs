...
<Update label="December 9, 2025" tags={["New releases"]} rss={{ title: "Preview widget", description: "Track changed files in preview deployments with an interactive widget" }}>
  ...
  - List of all changed files with status badges (added, modified, removed)
  - Search functionality to quickly find specific files
  - Direct navigation to changed pages
  - Metadata enrichment showing page titles and paths
