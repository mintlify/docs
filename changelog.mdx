...
<Update label="December 22, 2025" tags={["Improvements"]} rss={{ title: "Navigation and analytics improvements" }}>
  ## Navigation improvements

  - Updated sidebar titles across documentation for improved clarity and consistency.
  - Enhanced migration guide sidebar title for better discoverability.

  ## Analytics improvements

  - Updated analytics event names for assistant feedback to provide more accurate tracking.
  - Added new autopilot events for better monitoring of automated assistant interactions.
  - Improved analytics overview page with clearer explanations and better organization of event types.
