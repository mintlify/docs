...
<Update label="January 16, 2026" tags={["New releases", "Improvements"]} rss={{ title: "install.md, live preview in the web editor, and more" }}>
  ...
  Added branch search functionality for GitHub and GitLab integrations so that it is easier to find and switch between <Rainbow>deployment</Rainbow> branches in the Git settings of your dashboard.
...
<Update label="December 9, 2025" tags={["New releases"]} rss={{ title: "Preview widget", description: "Track changed files in preview deployments with an interactive widget" }}>
  ...
  Preview deployments now include an interactive widget that displays all changed files in the <Rainbow>deployment</Rainbow>. The widget appears as a floating button in the bottom-right corner and provides:
