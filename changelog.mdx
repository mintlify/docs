...
<Update label="August 31, 2026" tags={["New releases"]} rss={{ title:"Instant rollbacks" }}>

  ## Instant rollbacks

  - Roll back your live site to any of your last 10 successful builds from the [activity](https://app.mintlify.com/activity) page in your dashboard. A rollback swaps the build your site serves in seconds without reverting commits or waiting for a rebuild. Rollbacks and promotions are recorded in your [audit logs](/dashboard/audit-logs). Available to organization admins on Enterprise plans. See [Rollbacks](/deploy/rollbacks).
