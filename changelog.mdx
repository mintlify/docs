...
<Update label="September 25, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Desktop app, page narration, webhook-triggered automations, and more" }}>

  ## Desktop app

  - **Desktop app (beta):** Use your dashboard and editor in a native app for macOS, Windows, and Linux. Work in multiple tabs and windows, each with its own session. See [Desktop app](/desktop) for more information and to download the app.
  ...
  - **Agent panel:** The [editor agent](/editor/agent) panel has a new design, is faster in long chats, folds long messages, and lets you start typing from anywhere in the panel.
  ...
  - **Managing automations:** Editors can now delete automations and triggers link to their repositories and channels.
