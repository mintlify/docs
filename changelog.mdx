...
<Update label="May 13, 2026" tags={["Improvements"]} rss={{ title: "Assistant credit packages on the Hobby plan" }}>

  ## Assistant on the Hobby plan

  Hobby plan users can now enable the [assistant](/assistant) by purchasing a [credit package](/assistant/configure#enable-the-assistant-on-the-hobby-plan) directly, without upgrading to Pro. The assistant activates as soon as the purchase completes and remains available for as long as you have an active credit package. To stop the assistant, downgrade your credit package to the lowest tier to return to Hobby at the end of the current billing cycle.
