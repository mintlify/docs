...
<Update label="March 6, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Explore, assistant file uploads, related pages, and workflow improvements" }}>

  ## Explore

  Auto-generate documentation from any public GitHub repository with [Explore](https://mintlify.com/explore). Replace `github.com` with `mintlify.com` in any public repository URL to instantly preview generated documentation.

  Explore analyzes your codebase and creates documentation pages for APIs, configuration files, and project structure. Use it to quickly bootstrap documentation for new projects or preview what Mintlify can create from your existing code.

  ## Assistant file uploads

  Attach files to [assistant](/ai/assistant) messages to provide additional context. Drag and drop or paste images, PDFs, and code files directly into the chat.

  Supported file types include images (JPEG, PNG, GIF, WebP, SVG), documents (PDF), and code files across 25+ languages including TypeScript, Python, Go, and Rust.

  ## Related pages

  Pages now display related content suggestions to help users discover relevant documentation. Related pages appear at the bottom of each page based on content similarity.

  ## Improvements

  - Workflows now support up to 50 runs per day, increased from 20.
  - Contextual starter questions generate page-specific suggestions for the assistant.
  - Dashboard layout refreshed with improved navigation and sidebar.
  - Editor search bar redesigned with better UX.
  ...
  - Fixed cursor jumping when pasting in the editor.
