...
<Update label="March 19, 2026" tags={["Improvements"]} rss={{ title: "Enhanced auto-generate onboarding with external URLs, custom instructions, and multiple repositories" }}>

  ## Enhanced auto-generate onboarding

  The [auto-generate onboarding flow](https://mintlify.com/explore) now supports additional source options for generating documentation:

  - **Multiple repositories** — Add up to 5 additional public GitHub repositories alongside your primary repo to generate documentation that covers your entire project.
  - **External URLs** — Provide up to 5 external URLs for Mintlify to scrape and include as source material. Use this to incorporate content from existing documentation sites, wikis, or other web pages.
  - **Custom instructions** — Guide how your documentation is generated with free-form instructions. For example, specify which features to emphasize or which topics to exclude.
