...
<Update label="February 20, 2026" tags={["Improvements"]} rss={{ title: "Agent workflow reliability improvements" }}>

  ## Agent workflow improvements

  Improved reliability and scalability for [scheduled agent workflows](/agent/workflows). The agent now processes scheduled tasks more efficiently, preventing duplicate workflow runs and handling larger workloads.
