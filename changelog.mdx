...
<Update label="July 10, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Search filters, custom subpath hosting, editor comments and suggestions, and more" }}>
  ...
  - **Comments and suggestions:** Leave threaded comments on any text in the [editor](/editor), reply, resolve, and @mention teammates with email notifications. Suggestion mode lets reviewers propose edits for authors to accept or reject. Available to all customers.
  ...
  - Three-way merges no longer duplicate content inside text blocks, and visual-mode diffs no longer hang on large pages.
  ...
  - **Clarifying questions:** The [assistant](/assistant) can now ask a targeted clarifying question when a request is ambiguous, presented as selectable option cards in chat.
