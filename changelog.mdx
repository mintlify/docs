...
<Update label="February 3, 2026" tags={["Announcement"]} rss={{ title: "2025 Year in Review highlights" }}>

  ## 2025: A transformative year

  Mintlify evolved from a documentation platform into the infrastructure layer for how AI understands technical knowledge. Read the full [2025 Year in Review](https://www.mintlify.com/blog/2025-year-in-review) blog post.

  ### Key milestones

  - **Scaled to 8-figures ARR** from low 7-figures
  - **Grew from 12 to 40 people**, including first acquisition with Trieve
  - **Onboarded 10,000+ companies** including Coinbase, Microsoft, AT&T, PayPal, and Perplexity
  - **Processed 1M+ documentation updates**
  - **Powered 280M+ content views** worldwide
  - **AI usage grew 8x** year-over-year

  ### Documentation became intelligent

  - **1M+ monthly AI assistant queries** serving users directly within docs
  - **Self-updating docs** with the Mintlify Agent monitoring codebases and proposing updates automatically
  - **Content negotiation** serving markdown to AI systems and HTML to humans
  - **llms.txt standard** pioneered for AI documentation discovery
  - **MCP integration** making docs a tool AI agents can directly invoke

  ### Performance improvements

  - Every doc page now loads instantly with millisecond-level optimizations
  - 8 new themes launched for better brand matching
  - Complete editing experience overhaul
  - Entirely rebuilt API Playground
  - 6,000+ pull requests shipped
