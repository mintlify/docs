...
<Update label="April 3, 2026" tags={["New releases", "Improvements"]} rss={{ title: "get_page MCP tool, CLI authentication, password-protected previews, SAML group role mappings, and more" }}>
