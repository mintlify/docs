...
<Update label="July 16, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Page improvements, new analytics dashboard, and more" }}>
  ...
  - **Improved scrolling** everywhere**:** Code blocks, API playgrounds, tables, sidebar navigation, and the table of contents now share a smoother cross-platform scrolling experience with larger touch targets.
