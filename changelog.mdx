...
<Update label="May 1, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Revamped workflows and editor, agent score, new Mintlify MCP, and more" }}>
  ...
  - Approve pull requests directly from the editor's publish menu without leaving Mintlify. See [Approve a pull request](/editor/branching-and-publishing#approve-a-pull-request) for details.
