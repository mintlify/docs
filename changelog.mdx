...
<Update label="September 15 - September 19" tags={["New releases", "Improvements"]} rss={{ title: "Weekly Updates", description: "Coming soon" }}>

## Coming soon

Updates for this week will be added here.

</Update>

<Update label="September 8 - September 12" tags={["New releases", "Improvements"]} rss={{ title: "Weekly Updates", description: "External sources for AI assistant, fallback support email, Slack AI integration, and OpenAPI customization" }}>

## External sources for AI assistant

- **Major feature**: Enrich the assistant with more context by configuring external sources
- Add your pricing page, blogs, or integration partners' docs to help users get accurate answers directly in your docs
- This feature is currently in beta. For access, please contact <@U0819MX5KKN> or reach out to gtm@mintlify.com

## Fallback support email for assistant

- Our assistant is optimized to reduce hallucinations and lets users know when it can't find info in the docs
- When that happens, now you can [set a support email](https://www.mintlify.com/docs/guides/assistant#response-handling) to send users in the right direction

## Answer questions directly in Slack with AI

- Use an AI chatbot as your first line of defense in a Slack community
- The Mintlify Slack app pulls directly from your documentation so you can answer product questions instantly
- Works in DMs, @ mentions, or dedicated channels. [One click to install](https://www.mintlify.com/docs/ai/slack-app#slack-appan)

## Customize auto-generated OpenAPI pages

- The new [x-mint extension](https://www.mintlify.com/docs/api-playground/openapi-setup#x-mint-extension) gives more granular control over displaying your auto-generated API documentation
- You can override default metadata, add content, or change the URL of the endpoint

## Additional improvements

- Auto-updating CLI for improved development experience
- Faster page loads across all documentation sites
