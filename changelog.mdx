...
<Update label="August 28, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Referral program, custom component styles, and more" }}>
  ...
  - Refer a team to Mintlify from the [Referrals](https://app.mintlify.com/settings/organization/referrals) page in your dashboard. When someone you refer starts a Pro plan, both of your organizations receive 50,000 credits. You can earn referral credits for up to three referrals. Available on Pro and Enterprise plans.
