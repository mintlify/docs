...
<Update label="July 31, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Introducing the widget, updated analytics, and more" }}>
  ...
  - **User engagements:** A new User engagements section in [analytics](/optimize/analytics) shows total interactions, CTA click-through rates, and actions over time, so you can see which pages drive engagement.
