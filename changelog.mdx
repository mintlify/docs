...
<Update label="May 8, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Expanded MCP access, assistant credit packages, AsyncAPI nested groups, and more" }}>
  ...
  - The [editor](/editor/pages#navigate-files) can now open and edit Markdown and MDX files in your repository that aren't listed in `docs.json` navigation, such as `README.md` or `AGENTS.md`.
