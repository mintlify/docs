...
<Update label="February 2025" tags={["New releases", "Improvements"]}>
  ...
  To upgrade from `mint.json` to `docs.json`:
  ...
  2. Run any CLI command (such as `mint dev`) in your docs repository — the CLI automatically detects `mint.json` and creates a `docs.json` file
