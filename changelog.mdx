...
<Update label="June 20, 2025 2:31 test" rss={{ title: "TEST", description: "TESTTESTTEST" }}>
</Update>

<Update label="June 20, 2025" rss={{ title: "Subscribable changelogs", description: "Post product updates in your docs with a subscribable RSS feed" }}>
