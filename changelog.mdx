...
<Update label="May 8, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Expanded MCP access, assistant credit packages, AsyncAPI nested groups, and more" }}>
  ...
  - Highlight text in the [editor](/editor/pages#add-a-selection-to-the-agent) and click **Add to Assistant** in the floating toolbar to attach the selection to the agent panel and start a focused prompt.
