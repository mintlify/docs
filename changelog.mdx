...
<Update label="October 1 - October 2" tags={["Improvements"]} rss={{ title: "Recent Updates", description: "Documentation improvements, API updates, and continuous localization" }}>

## Documentation enhancements

- Added comprehensive "PDF Export" page documentation to help users understand export functionality
- Updated API discovery endpoint configuration to use admin API for improved security and functionality
- Enhanced Files component documentation with complete list of supported file extensions

## Localization improvements

- Continuous internationalization updates with automated translation improvements
- Enhanced language support across multiple documentation sections
- Improved localization workflow for better translation accuracy

## SEO and metadata updates

- Updated references to `metadata` field in SEO documentation for better clarity
- Improved metadata handling and configuration guidance
