...
<Update label="May 8, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Expanded MCP access, assistant credit packages, AsyncAPI nested groups, and more" }}>
  ...
  - The [Slack agent](/agent/slack) now reads files and images posted earlier in a thread, so screenshots shared before you mention `@mintlify` are included as context.
