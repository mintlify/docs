...
<Update label="September 27 - October 3" tags={["Bug fixes"]} rss={{ title: "Weekly Updates", description: "404 page improvements for multilingual sites" }}>

## Bug fixes and reliability

- Fixed 404 page link suggestions for multilingual documentation sites to only show links in the site's primary language instead of mixed languages
- Enhanced search filtering logic to use the first configured language as the default filter when multiple languages are available
