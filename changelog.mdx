...
<Update label="September 27 - October 3" tags={["New releases", "Improvements"]} rss={{ title: "Weekly Updates", description: "Slack bot integration for Writer Agent, language support expansion, UI improvements, and infrastructure enhancements" }}>

## Major releases

- **New feature**: Slack bot integration for Writer Agent - Connect Mintlify's Writer Agent with your Slack workspace for automated documentation notifications, direct message handling, and real-time updates when documentation tasks are completed. [Learn more](/integrations/support/slack)
