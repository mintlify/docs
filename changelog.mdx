...
<Update label="May 8, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Expanded MCP access, assistant credit packages, AsyncAPI nested groups, and more" }}>
  ...
  - The [editor](/editor/pages#navigate-files) file tree now opens unlisted Markdown files for editing and previews images and videos inline, so you can work with content that isn't referenced in `docs.json`.
