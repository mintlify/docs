...
<Update label="September 20 - September 26" tags={["New releases"]} rss={{ title: "Weekly Updates", description: "Slack bot integration for Writer Agent, direct messaging support, and enhanced notification system" }}>
