...
<Update label="April 13, 2026" tags={["Improvements"]} rss={{ title: "Default invite role changed to Editor" }}>

  ## Default invite role changed to Editor

  When you [invite a new member](/dashboard/roles#add-members-to-your-organization) to your organization, the role now defaults to **Editor** instead of **Admin**. This follows the principle of least privilege and reduces the risk of accidentally granting admin access. You can still change the role during the invite process.
