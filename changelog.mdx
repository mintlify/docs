...
<Update label="December 12, 2025" tags={["New releases", "Improvements"]} rss={{ title: "Q&A bots", description: "Multi-turn conversations, #ask-ai channel support, and improved UX for Discord bot" }}>
  ## Agent suggestions
