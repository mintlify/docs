...
<Update label="March 17, 2026" tags={["Improvements"]} rss={{ title: "Invite multiple team members at once" }}>

  ## Batch member invitations

  You can now [invite multiple members](/dashboard/roles#add-members-to-your-organization) to your organization at once. Enter email addresses separated by commas, spaces, or semicolons, or paste a list of emails. All invited members receive the role you select.
