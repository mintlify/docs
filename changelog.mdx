...
<Update label="August 7, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Private pages, faster live previews, deeper analytics, and more" }}>
  ...
  - **User journey analytics (beta):** [Analytics](/optimize/analytics) shows the routes visitors take through your site, actions they take, and their search and chat behavior.
