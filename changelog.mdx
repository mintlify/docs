...
<Update label="March 19, 2026" tags={["Improvements"]} rss={{ title: "AI-generated pull request details in the web editor and AsyncAPI enum display fix" }}>

  ## AI-generated pull request details

  When you [publish changes](/editor/publish) that create a pull request, the web editor now automatically generates a title and description based on your changes. You can edit the generated text before submitting or let the editor fill it in for you.

  ## Bug fixes

  - Fixed AsyncAPI enum parameters displaying as a type string instead of showing the enum type with available options
