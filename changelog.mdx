...
<Update label="February 27, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Comments and suggestions, Workflows, and editor improvements" }}>

  ## Comments and suggestions

  Collaborate directly in the [web editor](/editor/comments) with inline comments and suggestions. Highlight text to leave feedback, mention teammates, and track conversations—all without leaving the editing experience.

  ## Workflows

  Automate documentation tasks with [Workflows](/agent/workflows). Set up scheduled or event-triggered automations to keep your docs up to date.

  ## Luma theme

  New [Luma theme](/customize/themes) available for your documentation site.

  ## Improvements

  - Search filters now support filtering by language.
  - Table of contents now appears in the editor sidebar for easier navigation.
  - File renaming directly in the editor file tree.
  - Global variables support in API playground.
  - OpenAPI and AsyncAPI specs now included in [llms.txt](/ai/llmstxt).
  - Adobe Analytics integration support.
  - MCP now works with [partially authenticated docs](/ai/model-context-protocol).
