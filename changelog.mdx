...
<Update label="September 11, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Simplified credit pricing, OpenAPI Overlays, and more" }}>
  ...
  - **Editor agent integrations (Enterprise):** The editor agent can use connected third-party apps as read-only tools while researching and editing, and can hand you an authorization link to connect a new one from chat. See [Use connected integrations](/editor/agent#use-connected-integrations).
