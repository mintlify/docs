...
<Update label="April 24, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Preview Deployment API, Git onboarding redesign, web editor improvements, and more" }}>
  ...
  New templates are available for [`mint new --template`](/cli/install#available-templates) and during dashboard onboarding. Start a project from a `help-center`, `knowledge-base`, `product-guide`, or `empty` template in addition to the default `developer-docs` starter.
