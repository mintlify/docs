...
<Update label="March 13, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Workflow templates, Agent API v2, workflow CLI command, and more" }}>
  ...
  Create [workflows](/agent/workflows) files from the command line with `mintlify workflow`. Interactive prompts guide you through name, trigger, context, and instructions.

  ## Additional language support

  Documentation can now be localized in Hungarian (Magyar) and Catalan.
  ...
  - Workflows send Slack notifications with auto-merge status
  - Spellcheck enabled in the web editor
  - Dashboard layout improvements for mobile/responsive views
  ...
  - Fixed cron workflows created via dashboard not auto-triggering
