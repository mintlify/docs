...
<Update label="May 22, 2026" tags={["Improvements"]} rss={{ title:"Searchable hidden tabs and groups expose descendants to search, sitemaps, and AI" }}>
  ...
  - Search engine indexing — the `<meta name="robots" content="noindex">` tag is no longer emitted for opted-in pages
