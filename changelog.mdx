...
<Update label="December 3" tags={["New releases"]} rss={{ title: "Assistant query bucketing", description: "Automatically group similar assistant queries to identify common user questions" }}>
  ...
  Assistant analytics now automatically groups similar queries together, making it easier to identify patterns in what your users are asking. Instead of sifting through individual questions, you can see clustered topics and common themes at a glance.

  [Learn more on X](https://x.com/mintlify/status/1996351986237903100)
