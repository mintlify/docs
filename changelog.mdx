...
<Update label="January 16, 2026" tags={["New releases", "Improvements"]} rss={{ title: "install.md, live preview in the web editor, and more" }}>
  ...
  - **Live preview**: See real-time changes as you edit your documentation in the web editor. Live previews show your site exactly as it appears when published, without creating a preview <Rainbow>deployment</Rainbow>.
...
<Update label="December 19, 2025" tags={["Improvements"]} rss={{ title: "Agent, assistant, and editor improvements" }}>
  ...
  - Added [shareable preview links](/editor#share-preview-<Rainbow>deployment</Rainbow>s) from the editor toolbar.
...
<Update label="December 12, 2025" tags={["New releases", "Improvements"]} rss={{  title: "Agent suggestions and Q&A bots" }}>
  ...
  - Added ability to delete a <Rainbow>deployment</Rainbow> from the dashboard.
...
<Update label="December 9, 2025" tags={["New releases"]} rss={{ title: "Preview widget", description: "Track changed files in preview deployments with an interactive widget" }}>
  ...
  Preview <Rainbow>deployment</Rainbow>s now include an interactive widget that displays all changed files in the <Rainbow>deployment</Rainbow>. The widget appears as a floating button in the bottom-right corner and provides:

    - One-click navigation to changed pages.  
    - Searchable list of all changed files with status badges (added, modified, removed).

  The widget is automatically enabled on all preview <Rainbow>deployment</Rainbow>s and helps reviewers quickly navigate to modified content.
...
<Update label="October 24, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Dashboard enhancements, API playground improvements, authentication fixes, and performance optimizations" }}>
  ...
  ## Web editor and <Rainbow>deployment</Rainbow> enhancements

  - Restored manual create preview button for easier preview <Rainbow>deployment</Rainbow> creation
...
<Update label="October 11, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "API playground improvements, analytics enhancements, web editor updates, and bug fixes" }}>
  ...
  - Added <Rainbow>deployment</Rainbow> history pagination
  - Added cursor pagination to preview <Rainbow>deployment</Rainbow>s table
  - Fixed preview <Rainbow>deployment</Rainbow>s to only return preview environment <Rainbow>deployment</Rainbow>s
  ...
  - Made search engines ignore preview <Rainbow>deployment</Rainbow>s for SEO purposes
...
<Update label="September 19, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Web editor and authentication improvements, and bug fixes" }}>
  ...
  - Improved dashboard loading performance with optimized <Rainbow>deployment</Rainbow> queries
...
<Update label="September 13, 2025" tags={["New releases", "Improvements"]} rss={{ title: "Weekly Updates", description: "AI 404 suggestions, assistant web search with external sources, security enhancement, and reliability fixes" }}>
  ...
  ## Web editor and <Rainbow>deployment</Rainbow>s
  ...
  - Fixed a bug where preview <Rainbow>deployment</Rainbow>s wouldn't work for branches with `=` in the name
  - Fixed a bug where long branch names would overflow modals on preview <Rainbow>deployment</Rainbow> creations
...
<Update label="August 23, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Image layout fixes, auth enhancements, mobile nav improvements, and web editor stability" }}>
  ...
  - Optimized update workflow performance by cache-invalidating only changed pages during partial updates, reducing <Rainbow>deployment</Rainbow> times
...
<Update label="August 16, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Performance optimizations, LLM integrations, web editor polish, and API playground enhancements" }}>
  ...
  - MDX transpilation now happens at <Rainbow>deployment</Rainbow> time instead of on every page load in uncached NextJS serverless environments, improving time to first byte for uncached pages.
  - Content-based hashing prevents re-transpilation when MDX hasn't changed, reducing update workflow times by ~50% for customers with large page counts (<Rainbow>deployment</Rainbow>s over 5 minutes should be roughly halved)
  - Preview <Rainbow>deployment</Rainbow> viewing in the dashboard is now faster with added database indexes and query parallelization in our backend
...
<Update label="August 2, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "Authentication improvements, search enhancements, and assistant API" }}>
  ...
  - Preview <Rainbow>deployment</Rainbow>s now available for auth-protected sites
...
<Update label="March 2025" tags={["New releases", "Improvements"]}>
  ...
  - Change your <Rainbow>deployment</Rainbow> name directly in dashboard settings
...
<Update label="January 2025" tags={["Improvements"]}>
  ...
  - Support for requiring authentication to access preview <Rainbow>deployment</Rainbow>s
</Update>
...
<Update label="November 2024">
  ...
  We've improved our support for syncing with GitLab, such as enabling automated updates and preview <Rainbow>deployment</Rainbow>s. Check out our [docs on GitLab](/deploy/gitlab) to get started.
...
<Update label="October 2024">
  ...
  - Added ability to add new <Rainbow>deployment</Rainbow> through dashboard settings.
...
<Update label="February 2024">
  ...
  - Dashboard upgrades: view update logs to see what's changed and status of an update, toggle between Mintlify projects to manage <Rainbow>deployment</Rainbow>s
