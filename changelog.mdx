...
<Update label="May 8, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Expanded MCP access, assistant credit packages, AsyncAPI nested groups, and more" }}>
  ...
  - The [agent panel](/agent) composer now supports `@` mentions for plugins (Slack, Linear, Notion, GitHub) and pages, so you can reference connected integrations and specific docs directly in your prompt.
