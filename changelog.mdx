...
<Update label="March 26, 2026" tags={["Improvements"]} rss={{ title: "Automatic abuse filtering for feedback analytics" }}>

  ## Automatic abuse filtering for feedback

  [Feedback](/optimize/feedback) analytics now automatically detect and filter abusive submissions. Profanity, spam, hate speech, and other non-genuine feedback are excluded from metric counts and charts so your dashboard reflects only genuine user feedback. No configuration is required.
