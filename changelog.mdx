...
<Update label="April 24, 2026" tags={["New releases", "Improvements"]} rss={{ title: "AccordionGroup reordering, broken-links redirect checks, branch diff list, offline editing, and more" }}>
  ...
  ## Branch diff list in the editor

  The web editor now shows a list of changed files for the current branch. Review everything you've modified in one place before publishing or opening a pull request.
