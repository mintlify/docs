...
<Update label="February 20, 2026" tags={["Improvements"]} rss={{ title: "Agent workflow reliability improvements" }}>
  ...
  Improved reliability and scalability for [agent workflows](/agent/workflows). Scheduled workflows now handle high-volume execution more efficiently with better queue management and reduced duplicate runs.
