...
<Update label="April 10, 2026" tags={["New releases", "Improvements"]} rss={{ title: "CLI analytics, directory listings, multi-skill support, Slack bot improvements, and more" }}>
  ...
  The following new CLI commands are now available for better integration with coding agents.

  - `mint analytics`: View site analytics from the terminal.
  - `mint login`: Log in to your Mintlify account from the terminal.
TODO:
  ## Directory listings
