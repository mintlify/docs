...
<Update label="April 3, 2026" tags={["New releases", "Improvements"]} rss={{ title: "get_page MCP tool, password-protected previews, SAML group role mappings, and more" }}>
  ...
  - Fixed auto-generated response examples omitting optional properties that have required children. Response examples now include all properties regardless of their required status.
