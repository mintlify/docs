...
<Update label="August 5, 2026" tags={["New releases"]} rss={{ title:"Introducing Mintlify Index" }}>
  ...
  - **Access-controlled REST API:** Search ranked sources, assemble context within a token budget, and retrieve selected contents through separate [REST API endpoints](/api/search-index/introduction). Requires an Index API key.
