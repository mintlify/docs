...
<Update label="March 13, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Workflow templates and CLI command, Agent API v2, and more" }}>
  ...
  Track support agent performance with the new analytics dashboard. View total threads, active conversations, deflection and escalation rates, average confidence scores, and recent thread activity. Access the dashboard from the Support Agent configuration page when your Plain integration is configured.
