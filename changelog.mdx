...
<Update label="March 20, 2026" tags={["New releases"]} rss={{ title: "AI-powered documentation generation from private repositories" }}>

  ## Generate documentation from private repositories

  You can now auto-generate documentation from private GitHub repositories. During [onboarding](https://mintlify.com/start), choose the AI-powered setup option and add one or more GitHub repositories as sources, including private ones. When you add a private repository, authorize the Mintlify GitHub App to grant access. You can also add website URLs and a custom prompt to guide what gets generated.

  For public repositories, you can still replace `github.com` with `mintlify.com` in any repository URL to [auto-generate documentation](https://mintlify.com/explore) instantly.
