...
<Update label="August 21, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Editor branches, Slack-triggered automations, bulk member invites, and more" }}>
  ...
  - **Pull requests open as drafts by default:** The editor now opens new pull requests in draft state so you can share a preview URL without signaling that the change is ready to merge. Change this on the [editor settings](/editor/settings#create-draft-pull-requests-by-default) page.
