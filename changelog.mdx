...
<Update label="February 20, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Agent configuration files, headless mode, and editor search" }}>

  ## `assistant.md` and `agent.md` support

  Configure Agent behavior using `.mintlify/Assistant.md` or `.mintlify/AGENTS.md` files in your repository. This gives you version-controlled customization of how the Agent responds and behaves.

  ## Headless mode

  Bring your own frontend and still use the Mintlify content engine. Build custom documentation experiences while leveraging Mintlify's content management, search, and AI capabilities. See the [custom frontend guide](/guides/custom-frontend) for details.
