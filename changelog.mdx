...
- Fixed `deepObject` parameter handling

## Insights improvements

- Retitled analytics to insights
- Removed click-to-load requirement for insights
- Added category filters in assistant bar chart
- Added empty state for insights feedback (thumbs up/down)
- Fixed feedback page to respect date filters
- Improved insights data accuracy with server-side timestamps
- Added better error logging for insights
...
- Added structured logging for agent errors
- Upgraded agent to Claude Sonnet 4.5
- Added sample questions feature
...
- Removed comments in final Markdown
...
- Added list_pull_requests and list_commits tools for agent
