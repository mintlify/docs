...
<Update label="March 16, 2026" tags={["New releases", "Improvements"]} rss={{ title: "New contextual menu integrations, preview widget editing, and API playground anchor links" }}>
