...
<Update label="August 28, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Referral program, custom component styles, and more" }}>
  ...
  - Refer a team to Mintlify from the [Referrals](https://app.mintlify.com/settings/organization/referrals) page in your dashboard. When someone you refer starts a Pro plan, both of your organizations receive 50,000 credits. Your organization must be on a Pro plan when the referred organization signs up for its Pro plan and the credits are granted. You can refer as many teams as you like, but you earn credits for up to three referred organizations, up to $1,500 in credits total.
