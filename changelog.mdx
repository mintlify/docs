...
<Update label="March 13, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Workflow templates, Notion MCP OAuth, Hungarian language support, and editor improvements" }}>
