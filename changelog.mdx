...
<Update label="August 28, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"Referral program, custom component styles, and more" }}>
  ...
  - Refer a team to Mintlify from the [Referrals](https://app.mintlify.com/settings/organization/referrals) page in your dashboard. When an organization you refer upgrades to a Pro plan, both your organization and the referred organization receive 50,000 credits at that time. The referred organization receives its credits regardless of your plan. To receive your credits, your organization must be on a Pro plan when the referred organization upgrades to Pro and the credits are granted. You can refer as many teams as you like, but you earn credits for up to three referred organizations, up to $1,500 in credits total.
