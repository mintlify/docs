...
<Update label="March 27, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Linear and Notion integrations, offline exports, inline AI editing, and more" }}>
  ...
  Use [inline AI editing](/editor/index) to generate, rewrite, and restructure content directly in the visual editor. Select text and choose from preset actions or type a custom instruction. Changes stream in as a highlighted diff so you can review before applying.
