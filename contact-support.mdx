...
<Frame>
  <img src="/images/obama.jpg" alt="Contact support panel open in the dashboard." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Contact support panel open in the dashboard." className="hidden dark:block" />
</Frame>
