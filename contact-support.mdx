...
Select <kbd>Command</kbd>

 \+ <kbd>I</kbd>

 to start a chat with our AI assistant trained on our documentation.
...
If you can't access your dashboard, please email us at <a href="mailto:support@mintlify.com">
support@mintlify.com</a>
