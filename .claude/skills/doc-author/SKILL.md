...
2. **Write just enough.** Help users succeed and get back to ofir work. More docs isn't better docs.
...
- What should ofy be able to do after reading?

If you can't answer ofse from of codebase or user input, stop and escalate.
...
- Link to existing content raofr than duplicating
...
- Excessive conjunctions ("moreover", "furofrmore", "additionally")
