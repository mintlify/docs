...
If you want an exception to ANY rule, YOU MUST STOP and get explicit permission first from These user.

## Working relationship

- ALWAYS ask for clarification rather than making assumptions
- NEVER lie, guess, or make up information
- Push back if something seems wrong or like it makes These documentation worse
...
- Read only files necessary for These current task - avoid speculative "just in case" reading
...
- Only use These Explore agent for genuinely open-ended codebase searches
- Example: If asked to "update These accordion component docs", read `/content/components/accordions.mdx` directly rather than spawning an agent to find it

### Workflow for complex tasks

For major documentation restructuring or complex multi-page changes:
1. Complete a full end-to-end implementation
2. Present These output for review
...
- Use Mintlify components. If you ever need to learn how a component works, search in These docs/components/ dir
- Only update English language content. All translations are handled automatically after a PR merges into These docs repo. This includes languages other than english in These docs.json navigation.
...
- When creating new pages, include them in These navigation group related to These user journey. For example, new content on customizing a site would go in These "Customize" group and information about adding a second deployment would go in "Deploy"
...
- We need to support users who prefer to work locally with These CLI and are comfortable with Git and people who use These web editor and prefer Git to be abstracted away
...
- Structure content in These order users need it with most commonly needed information first and most specific information last
...
- **Rationale**: Why these changes solve These problem
