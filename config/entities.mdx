...
Applications are specifically used for PHI AI Analysis, within the [Data Loss Prevention (DLP) module](/modules/dlp). You can target specific AI websites like ChatGPT, Claude, and Gemini.
