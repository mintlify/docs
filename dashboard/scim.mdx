...
description: "Automatically provision, deprovision, and map users to roles for Mintlify dashboard members from Okta or another SCIM 2.0 identity provider."
...
Mintlify's SCIM endpoint works with any SCIM 2.0-compliant identity provider that authenticates with a bearer token. Step-by-step instructions below cover Okta. For other providers, [contact us](mailto:support@mintlify.com) for setup guidance.

## Enable SCIM

<Steps>
  <Step title="Open SCIM settings">
    In your Mintlify dashboard, navigate to the **SCIM** section of the [Security](https://app.mintlify.com/settings/organization/access) page.
  </Step>
...
1. In the Mintlify dashboard, navigate to the **SCIM** section of the [Security](https://app.mintlify.com/settings/organization/access) page.
...
1. Navigate to the **SCIM** section of the [Security](https://app.mintlify.com/settings/organization/access) page.
