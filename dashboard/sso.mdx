...
<Steps>
  <Step title="Configure Okta SSO in your Mintlify dashboard">
    1. In your Mintlify dashboard, navigate to the [Security](https://app.mintlify.com/settings/organization/access) page.
    2. Click **Configure**.
    3. Select **Okta SAML**.
...
To enable JIT provisioning, you must have SSO enabled. In your dashboard, navigate to the [Security](https://app.mintlify.com/settings/organization/access) page. Set up SSO, then enable JIT provisioning.
...
1. Navigate to the [Security](https://app.mintlify.com/settings/organization/access) page in your dashboard.
