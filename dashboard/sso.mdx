...
When JIT (just-in-time) provisioning is enabled, users who sign in through your identity provider are automatically added to your Mintlify organization, even if they haven't been invited.
...
For providers not listed above, [contact us](mailto:support@mintlify.com) to configure SSO.
