...
| Deployment       | Content publishes from the web editor and deployment configuration changes including custom domains, authentication, Git sources, and MCP client credentials. |
