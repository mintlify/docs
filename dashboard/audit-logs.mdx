---
title: "Audit logs for deployments and organization changes"
...
| Integration      | Third-party integrations and credential or webhook-token changes, including GitHub, GitLab, Bitbucket, Slack, Discord, Linear, Notion, MCP, and Composio. |
| Analytics        | Analytics exports. |
| Analytics streaming | Streaming destination changes and changes to included events or deployments. |
...
| Workflow         | Workflow creation, updates, deletion, toggles, runs, and connected service changes. |
| Audit log        | Audit log views, exports, streaming destinations, and category configuration changes.                              |
