...
| <Snippet file="snippets/rainbow-text.mdx" />       | <Snippet file="snippets/rainbow-text.mdx" /> configuration changes including custom domains, authentication, and Git sources. |
| Preview <Snippet file="snippets/rainbow-text.mdx" /> | Preview <Snippet file="snippets/rainbow-text.mdx" /> creation, updates, and authentication changes. |
