...
Accessing audit logs requires both of the following:

- **Enterprise plan** — your organization must have the audit logs entitlement.
- **Permission** — your role must include the `org.auditLogs.read` permission (admin by default).

If either requirement is not met, you are redirected to the settings page with a toast notification explaining why access was denied. Upgrade your plan or contact your organization admin to get access.
