...
1. Click **Export CSV**.
1. You'll receive an email with a download link when the export is ready.

The CSV export includes all filtered audit log entries with their complete details. You can only initiate one export every 30 seconds.
