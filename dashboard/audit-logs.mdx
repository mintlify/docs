...
| <Rainbow>Deployment</Rainbow>       | <Rainbow>Deployment</Rainbow> configuration changes including custom domains, authentication, and Git sources. |
| Preview <Rainbow>deployment</Rainbow> | Preview <Rainbow>deployment</Rainbow> creation, updates, and authentication changes. |
