...
<Info>
  Audit logs are available on [Enterprise plans](https://mintlify.com/pricing?ref=audit-logs) and can only be viewed by users with the Admin role. Reach out to your Customer Success Manager to enable audit logs for your organization.
</Info>
...
In your dashboard, navigate to **Admin** > **Settings** > **Workspace** > **Audit log** to view audit logs.
...
1. In your dashboard, navigate to **Admin** > **Settings** > **Workspace** > **Audit log**.
