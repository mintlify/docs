...
Viewing audit logs requires both of the following:

- **Enterprise plan**: Your organization must be on an [Enterprise plan](https://mintlify.com/pricing?ref=audit-logs).
- **Permission**: You must have the `org.auditLogs.read` permission in your organization.

If you don't meet these requirements, you are redirected to the settings page with a notification explaining why access was denied.
