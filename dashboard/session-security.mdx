...
For each setting, use the toggle to enable or disable it. Enter a value, choose a unit (minutes, hours, days, or weeks for maximum lifetime; minutes, hours, or days for idle timeout), and click **Save**. Disabling a setting and saving clears it so Mintlify's default takes over.
