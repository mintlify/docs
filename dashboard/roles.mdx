...
<Note>
  Inviting members is not available on the Hobby plan. To add teammates to your organization, [upgrade to a paid plan](https://mintlify.com/pricing) or start a Pro trial.
</Note>
