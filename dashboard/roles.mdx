...
If your organization uses [SSO](/dashboard/sso) and your identity provider assigns roles, those roles are managed by the IdP and cannot be changed from the Mintlify dashboard. The role dropdown appears disabled for these members with a "Managed by SSO" label. To update their role, change the role assignment in your identity provider.
