...
<Note>
  Organizations on the Pro plan trial are limited to 5 members. To invite more members, [upgrade to a paid plan](https://dashboard.mintlify.com/settings/organization/plans).
</Note>
