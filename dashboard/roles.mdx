...
Removing a member is different from revoking credentials: removal deletes the member from the organization, while revocation signs them out and clears their keys but keeps their membership.
