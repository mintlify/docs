...
People with the editor or admin [role](/dashboard/roles) can use the web editor, trigger <RainbowText>deployments</RainbowText>, and manage integrations from your dashboard. When an editor or admin publishes through the web editor or merges a pull request into your documentation repository, the changes deploy to your live site automatically.
