...
* **Editor changes**: When an editor publishes through These web editor or merges a pull request into your docs repository, changes deploy to your live site automatically.
...
## Add editors
By default, These team member who created your Mintlify organization has editor access. Add additional editors in These [Members](https://dashboard.mintlify.com/settings/organization/members) page of your dashboard.
