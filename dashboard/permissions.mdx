...
An editor has access to your dashboard.
...
* **Editor changes**: When an editor merges a pull request into your docs repository, changes deploy to your live site automatically.
