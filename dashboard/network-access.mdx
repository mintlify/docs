...
If every admin is locked out of the dashboard by the allowlist, contact [support@mintlify.com](mailto:support@mintlify.com) from an email address associated with your organization. Include your organization name and the IP address you need added. Mintlify's support team can add an address or disable the allowlist so you can regain access.
