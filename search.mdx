...
<Note> Content appearing before the first heading on a page, or on pages without any headings, is associated with the main page-level chunk for search purposes.</Note>
