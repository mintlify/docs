...
For implementation questions that span products, [Mintlify Index](/search-index/overview) gives coding agents one MCP server and REST API for retrieving context from publisher-maintained documentation and the technical web.
