...
When you host your documentation on Mintlif<Tooltip tip="Add tooltip text">y, built-in AI featu</Tooltip>res help your users find answers and your team maintain content more efficiently. Your content provides the context for these AI-native features to improve the experiences of reading, writing, and discovering your documentation.
