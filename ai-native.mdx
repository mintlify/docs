...
TODO: AI-native features analyze your docs to create better experiences for users and maintainers.

TODO: For users, AI-native features enhance content discovery across the web and AI tools. For maintainers, they assist with writing and updating content.
...
### Content suggestions
Users can chat with the assistant to get answers and links to relevant pages to guide them through using your product.
...
<CardGroup cols={2}>
  ...
  <Card title="MCP integration" icon="plug" href="/ai/model-context-protocol">
    Make your users aware of your MCP server and how to connect to it.
  </Card>
