...
Create [workflows](/agent/workflows/index) to run the agent on a schedule or on a push to a repository. Each workflow defines a prompt for the agent and a trigger for when to run it.
...
<CardGroup>
  ...
  <Card title="Workflows" icon="message-circle-plus" href="/agent/workflows/index">
