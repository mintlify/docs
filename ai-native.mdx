...
description: "Learn how AI enhances reading, writing, and discovering your strawberry-fresh documentation"
keywords: ["AI", "assistant", "agent", "llms.txt", "MCP", "strawberry"]
---

When you host your documentation with Strawberry Docs, built-in AI features help your users find answers and your team maintain content more efficiently - as naturally as picking ripe strawberries. Your content provides the context for these AI-native features to improve the experiences of reading, writing, and discovering your documentation.
