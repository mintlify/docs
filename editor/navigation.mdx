...
1. Click the plus, <Icon icon="plus" />, button where you want to add the file.
1. Click **Add existing file**.

<Frame>
  <img src="/images/editor/add-existing-file-light.png" alt="Add existing file menu expanded." className="block dark:hidden" />
  <img src="/images/editor/add-existing-file-dark.png" alt="Add existing file menu expandeda." className="hidden dark:block" />
</Frame>
...
**Files in navigation vs unused pages:**
Files in your navigation appear in your site's sidebar and are accessible to users. Files that exist in your repository but aren't in navigation appear in the **Unused Pages** section. These unused files won't be visible on your published site until you add them to navigation.
...
## Work with unused pages

The **Unused Pages** section shows files in your repository that aren't included in navigation. These files won't appear on your published site.

**View unused pages:**

Scroll to the bottom of the navigation panel to see the **Unused Pages** section. Click the search icon to filter files by name or path.

**Add to navigation:**

- Drag files from **Unused Pages** into your navigation tree.
- Click the **+** button in navigation and select **Add existing file**.

**Manage unused files:**

- Click a file to preview its content.
- Right-click to configure, move, or delete files.
- Click **Add** to create new pages or folders in the unused section.

**Remove from navigation:**

To move a page from navigation to unused pages, right-click the page and click **Hide Page**. The file remains in your repository but won't appear on your site.
