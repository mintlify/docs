...
Right-click a **navigation element** (group, tab, anchor, etc.) to open its settings, convert it to a different element type, add a page inside it, add a group inside it, or delete it.
