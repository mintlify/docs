...
description: "Organize your documentation site structure with the visual navigation editor to create groups, reorder pages, and manage the sidebar layout."
keywords: ["editor", "navigation", "sidebar", "structure"]
---

Use the navigation sidebar to organize your documentation. Changes you make in the web editor's navigation tree update your site's navigation sidebar and sync to your repository when you publish.
