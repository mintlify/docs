...
description: "Reorder pages, build groups and tabs, and manage your documentation sidebar with drag-and-drop in the Mintlify editor — without editing docs.json by hand."
