...
After creating an element, drag-and-drop it to reorder or nest it within other elements. Right-click any element to access settings, duplicate it, or delete it.
