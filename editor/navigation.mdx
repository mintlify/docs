...
To ungroup pages wihin a group or other navigation element, right-click then click **Ungroup**. All pages within the ungrouped element move to the root level of your navigation.
