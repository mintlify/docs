...
Use the navigation sidebar to organize your documentation. The editor syncs your changes to your repository when you publish. You don't need to edit `docs.json` manually.

## Add navigation elements

Click **Add new** at the bottom of the navigation tree to add a new element at the root level. To nest an element inside another, click the <Icon icon="plus" /> plus button next to that element.
...
Right-click a **navigation element** to open its settings or convert it to a different element type. You can also duplicate it, add a page or group inside it, ungroup it, or delete it.
