...
When the parent is a folder in the file tree, the add menu also includes **Create a page** and **New folder** options. New pages are created as unlisted so they don't appear in the sidebar until you add them to navigation.
