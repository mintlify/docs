...
Every time you save changes to a feature branch, Mintlify builds a preview deployment — a temporary URL that renders your changes exactly as they'll look when published. Use it to review your work or collect feedback before merging.
...
Copy the preview URL and send it to reviewers. The preview updates automatically each time you save to the branch — no need to share again.
