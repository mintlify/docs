...
description: "Create, edit, and publish documentation directly in your browser with visual editing, live preview, Git sync, and team collaboration tools."
...
<Card title="Collaborate" icon="users" horizontal href="/editor/collaborate">
  Edit with teammates in real time, create branches for different projects, and propose changes with pull requests.
</Card>
