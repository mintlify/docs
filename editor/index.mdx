...
**Source mode** gives you direct access to the MDX, with line numbers. Use it for precise control over component properties and frontmatter. Type <kbd>&lt;</kbd> to autocomplete components, then their props and values, with a description and example for each. Press <kbd>Cmd</kbd> + <kbd>S</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>S</kbd> (Windows) to format the document. If a single change modifies more than 1,000 characters, the editor asks you to confirm it.
