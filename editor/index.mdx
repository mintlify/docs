...
description: "Overview of the Mintlify web editor for creating, editing, and publishing docs in your browser with real-time collaboration, autosave, and Git sync."
