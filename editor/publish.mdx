...
When you publish changes that create a pull request, the editor automatically generates a title and description based on your changes. The generated details summarize what you changed so reviewers can quickly understand your update.

You can edit the generated title and description before submitting. If you've already typed a title or description, the generated content appends to what you wrote.
