...
| Feature branch | None | Merges changes to deployment branch and deploys |
...
When you work on a feature branch, you can save changes to the branch as <Tooltip heading="Commit" text="A commit is a saved snapshot of your changes in Git.">commits</Tooltip>.
...
If you do not have branch protection rules, your changes are live as soon as your site redeploys. If you have branch protection rules, you must merge the pull request in your Git provider for the changes to go live.
