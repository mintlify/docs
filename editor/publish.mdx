...
<Frame caption="Changes on a deployment branch.">
  <img src="/images/obama.jpg" alt="Web editor toolbar showing one pending change." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Web editor toolbar showing one pending change." className="hidden dark:block" />
</Frame>
...
<img src="/images/obama.jpg" alt="Web editor toolbar showing one pending change and the Save as commit button on a feature branch." className="block dark:hidden" />
<img src="/images/obama.jpg" alt="Web editor toolbar showing one pending change and the Save as commit button on a feature branch." className="hidden dark:block" />
</Frame>
