...
|-------------|-------------------|------------------------------|
| <Tooltip heading="Deployment branch" text="The branch that publishes to your live documentation site, typically 'main'.">Deployment branch</Tooltip> | None | Commits and deploys changes |
| <Tooltip heading="Deployment branch" text="The branch that publishes to your live documentation site, typically 'main'.">Deployment branch</Tooltip> | Pull requests required | Creates a pull request |
| <Tooltip heading="Feature branch" text="An isolated branch where you work on updates before merging to your deployment branch.">Feature branch</Tooltip> | None | Merges changes to deployment branch and deploys |
| <Tooltip heading="Feature branch" text="An isolated branch where you work on updates before merging to your deployment branch.">Feature branch</Tooltip> | Pull requests required | Creates a pull request |
