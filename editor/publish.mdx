...
- If your selection would add a navigation error that your live site doesn't already have, such as a tab next to top-level groups, Mintlify refuses the publish. Nothing is committed and your changes stay pending. Fix the navigation errors or deselect the changes that cause them, then publish again.
