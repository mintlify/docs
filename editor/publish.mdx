...
### AI-generated pull request titles and descriptions

When you create a pull request from the editor, AI automatically generates a title and description based on your changes. The generated title summarizes your updates and the description provides context about what was changed, so reviewers can quickly understand your pull request without manually writing a summary.

You can edit the generated title and description before creating the pull request.

{/* TODO: Add video demonstrating AI-generated PR titles and descriptions */}
