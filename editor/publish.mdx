...
Click a file in the list to open a diff view showing what changed. Documentation files open in a visual diff, and other file types open in a source diff. Use this to review the full scope of changes on a branch before publishing.
