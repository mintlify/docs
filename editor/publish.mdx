...
When you publish changes, the editor automatically generates a commit message that summarizes your edits. You can customize the commit message before publishing.
