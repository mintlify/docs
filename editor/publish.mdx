...
|-------------|-------------------|------------------------------|
| <Tooltip headline="<RainbowText>Deployment</RainbowText> branch" tip="The branch that publishes to your live documentation site, typically 'main'."><RainbowText>Deployment</RainbowText> branch</Tooltip> | None | Commits and deploys changes |
