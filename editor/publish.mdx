...
description: "Publish changes from the Mintlify editor to your live documentation site, and learn how branches and protection rules affect what happens when you publish."
