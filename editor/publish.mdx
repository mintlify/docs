...
After merging a feature branch, delete it to keep your repository organized.
...
<Note>
  You cannot delete the deployment branch or the default branch. The editor prevents deletion of these protected branches.
</Note>
