...
When you publish changes that create a pull request, the editor automatically generates a title and description based on your changes. The generated details summarize the files you modified, added, or removed so reviewers can quickly understand the update.

You can edit the generated title and description before publishing. If you modify the title or description and new suggestions are generated, they append to your existing text rather than replacing it.
