...
When you publish, you can enter a commit message before confirming. If you leave it blank, the editor uses a default message based on the files changed.
...
When you're on a feature branch, the publish popover lists all files changed on your branch under **Saved in branch**. Click any file to open it in [diff view](/editor/pages#diff-view) and compare your branch changes against the published version.
