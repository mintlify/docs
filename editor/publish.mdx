...
When the editor creates a pull request, it automatically generates a title and description based on your changes. You can edit the generated title and description before submitting. If you make edits and the generated content updates, your edits are preserved and the new suggestions are appended.
