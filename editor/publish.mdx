...
description: "Publish changes from the Mintlify editor to your live docs site, and learn how branches, pull requests, and auto publish affect what you publish."
