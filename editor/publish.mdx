...
<Note>
  ...
  If there are no checkboxes next to pending changes, turn on [selective publishing](#publish-specific-changes).
</Note>
...
By default, publishing on your deployment branch commits every pending change together. Turn on [selective publishing](/editor/settings#selective-publishing) in the editor settings to choose which specific changes to include when you publish.

With selective publishing on, the **Publish** menu lists each pending change with a checkbox to select whether or not to include it when you publish.

- Selective publishing is only available while you work directly on your deployment branch and that branch has no branch protections. On feature branches or when your deployment branch requires pull requests, **Save in branch** and **Create pull request** still include every pending change.
...
- **Publish**: Commits and deploys your changes to your live site immediately. With [selective publishing](/editor/settings#selective-publishing) turned on, you choose which pending changes to include.
