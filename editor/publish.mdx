...
<Note>
  If there is no **Publish** button in your editor toolbar, your project has [auto publish](#auto-publish) turned on and your edits go live automatically.
...
If your project has [auto publish](/editor/settings#auto-publish) turned on, the editor commits to your deployment branch shortly after you stop typing. The branch selector and **Publish** button are hidden. There is no pending state and no review step.
