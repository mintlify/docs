...
If your team edits the deployment branch directly and wants changes to reach Git without a manual publish step, enable [main branch autocommits](/editor/settings#main-branch-autocommits). Edits on feature branches created from the editor autocommit regardless of that setting.
