...
Private pages and folders that a teammate has shared with you appear in the **Shared** section of the **Home** tab. To remove your own access to a page or folder shared with you, right-click it in the **Shared** section, then select **Leave**. Leaving removes the page or folder from your sidebar and clears it from your editor if you have it open. A workspace member with access can share it with you again. **Leave** isn't available for content shared with your entire organization.
