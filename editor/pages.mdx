...
When you duplicate the page you currently have open, the copy includes your unsaved edits. If the original is listed, the editor places the copy next to it in the file tree and navigation. Review the copy, update its settings, and publish it when you're ready.
