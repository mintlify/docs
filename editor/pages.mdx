...
To remove a page from navigation without deleting the file, right-click the page, click **Settings**, and toggle the **Hide** option. The file remains in your repository and you can unhide the page by toggling the setting again or by adding it to your `docs.json` navigation.