...
- **Reorder accordions**: Inside an `<AccordionGroup>`, hover over an accordion to reveal its drag handle and drag the accordion up or down to change its order within the group.
