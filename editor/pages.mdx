...
**Workspace** holds pages that aren't part of your Git repository or published site. Workspace pages save automatically and have no publish step.
...
**Site** holds your repository and the pages your visitors see.
...
The new page opens with your cursor in the title. The editor names the file after the first title you type. To add a page that already exists in your repository to your navigation, click the <Icon icon="plus" /> plus button and select **Add existing page**.

The same menus create navigation elements like groups, tabs, anchors, dropdowns, versions, languages, and products. For what each element does, see [Navigation](/organize/navigation).
...
Teamspace pages are shared with everyone in your organization without being published. Like private pages, they aren't committed to your repository. Access follows your [role](/dashboard/roles). Editors and admins can edit and manage Teamspace pages, and viewers can read them. Because everyone already has access, Teamspace pages can't be shared individually.
