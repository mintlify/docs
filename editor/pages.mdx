...
The drawer shows versions for the current page on the current branch. Click **Show more versions** to load older entries.

Older versions include a **Restore** action when you have permission to edit the page. Click **Restore**, then confirm to replace the current page content with that saved version. This overwrites unsaved changes.

Restore applies the selected snapshot to the current page in the active site, deployment, and branch. It doesn't create a new page or merely preview the saved content.
