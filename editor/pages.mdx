...
Each tab groups its content into sections. Home has **Recents**, **Starred**, **Personal**, and **Workspace**. Publishing has **Navigation** and **Hidden files**. Drag a section header to reorder sections in the current tab. Each tab saves its own order to your account. Click a section header to collapse or expand it, and the editor remembers that state on your next visit.
