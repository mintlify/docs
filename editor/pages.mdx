---
title: "Create and manage pages in the Mintlify web editor"
...
- **Duplicate**: Right-click a page or open the page-options menu in the top bar, then select **Duplicate**. The editor inserts the copy after the original and adds `(copy)` to its title.
