...
To delete a whole navigation section, such as a group, tab, dropdown, anchor, language, product, version, or menu item, open its options menu in the navigation tree and select **Move to trash**. Confirm to trash the section and every page nested inside it. An undo toast appears after the delete.
