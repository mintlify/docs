...
Switch between visual and source mode using the mode toggle in the toolbar below the top bar. To switch to visual mode, click the <Icon icon="eye" /> eye icon or press <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> (Windows). To switch to source mode, click the <Icon icon="code" /> code icon or press <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> (Windows).
