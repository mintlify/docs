...
The visual editor renders live previews of [reusable snippets](/create/reusable-snippets) and React components, showing exactly how they will appear when published.
