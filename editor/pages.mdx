...
The version history groups entries by date. Each entry shows the author and save time. The most recent entry is marked **Current**.
...
When version history is available for the page, you can also click the **Edited ... ago** label in the editor header to open the drawer. The label remains non-interactive for unsupported pages.

The drawer shows versions for the current page. Public page history is scoped to the current branch. Private page history is shared across branches. Click **Show more versions** to load older entries.
