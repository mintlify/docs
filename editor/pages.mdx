...
If many pages disappear at once after an editor session, or the editor is showing changes to pages you didn't touch, see [Recover from editor issues](/editor/recovery).
