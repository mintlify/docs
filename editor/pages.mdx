...
Restore applies the selected snapshot to the current live page in the current site, deployment, and branch. It doesn't create a new page or only preview the saved content.

Restore isn't available on blocked deploy branches or the **Latest** version. You can't compare versions from the drawer.
