...
- **Link to another page**: Right-click a page in the navigation tree and select **Copy link**, then paste the link into your content. The editor recognizes links to other pages in the same documentation and converts them into internal links automatically. Pasted links keep working even if you later move or rename the target page.
