...
- **Add embedded content**: Type <kbd>/youtube</kbd>, <kbd>/loom</kbd>, or <kbd>/vimeo</kbd> to embed videos, or <kbd>/embed</kbd> for custom HTML. See [Add media](/editor/media) for details.
