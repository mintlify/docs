...
description: "Create pages, edit content, review version history, and manage files and navigation in the Mintlify web editor with rich-text and source editing."
keywords: ["editor", "content", "pages", "files", "create", "edit", "version history", "task lists", "private pages"]
---
...
- **Insert media**: Press <kbd>/</kbd> and choose an image or video, or drag a file from your computer or the navigation tree onto the page. See [Media](/editor/media).
...
Older versions include a **Restore** action when you have permission to edit the page. If you restore an older version, you overwrite any unsaved changes. Viewers can review and compare saved versions of private pages. Editors and admins can restore them.
...
To upload images and video, set light and dark image variants, or embed YouTube, Loom, and Vimeo content, see [Media](/editor/media).
