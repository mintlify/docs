...
Switch to the **Files** view to browse files as they appear in your repository. Click the <Icon icon="folder-open" /> file icon or press <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>F</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>F</kbd> (Windows) to switch to the Files view.
