...
To reuse media that already lives in your project, drag an image or video file from the navigation tree onto the page. The editor embeds the asset inline rather than inserting a link to the file.
