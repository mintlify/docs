...
Type <kbd>/embed</kbd> and paste a YouTube, Loom, or Vimeo URL. The editor detects the provider and generates the iframe automatically. Searching the slash menu for `youtube`, `yt`, `loom`, or `vimeo` also surfaces the **Embed** command.
