...
The navigation tree also lists Markdown and MDX files that live in your repository but aren't part of your `docs.json` navigation, such as `README.md` or `AGENTS.md`. Click any of these files to open and edit them in the editor. Changes publish to the same path in your repository when you publish, even though the file doesn't appear in your published site's sidebar.
