...
Use AI to refine your content directly in the editor. Select text or place your cursor, then choose an AI action to transform your content.

### AI actions

- **Improve writing**: Enhance clarity, tone, and readability of your selected text.
- **Improve structure**: Reorganize content for better flow and hierarchy.
- **Fix grammar**: Correct grammatical errors and typos.
- **Ask AI**: Give a custom instruction to transform the selected text however you need.

### Use inline AI editing

1. Select text or place your cursor in the editor.
2. Choose an AI action from the toolbar.
3. Review the suggested changes and accept or discard them.

### AI syntax fixer

If the editor detects a parsing error in your MDX, it uses AI to suggest fixes automatically. This helps you resolve broken syntax with minimal changes to your content.
