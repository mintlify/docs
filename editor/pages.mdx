...
**Navigation** shows your sidebar structure as visitors see it. Select a page to open it.

**Files** shows the full file tree of your repository, including files that aren't in your navigation. Select any file to open it.

To switch between views, select the <Icon icon="folder-open" /> file icon or press <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>F</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>F</kbd> (Windows). Select the search icon or press <kbd>Cmd</kbd> + <kbd>K</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>K</kbd> (Windows) to search by filename or page content.

## Manage files and folders

Use the Files view to organize your content:

- **Create a folder**: Select the <Icon icon="folder-plus" /> new folder button at the top of the file tree, or right-click an existing folder and select **New folder**.
- **Rename a file or folder**: Right-click the item and select **Rename**.
- **Open unlisted files**: Select any file in the tree to open it, even if it isn't included in your navigation.
...
Switch between visual and source mode using the mode toggle in the toolbar below the top bar. Select the <Icon icon="eye" /> eye icon or press <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> (Windows) to switch to visual mode. Select the <Icon icon="code" /> code icon or press <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> (Windows) to switch to source mode.
...
- **Link to another page**: Right-click a page in the navigation tree, select **Copy link**, then paste the link into your content. The editor recognizes internal links to other pages and converts them.
...
To compare your current page against the last published version, select the <Icon icon="file-diff" /> **View diff** button in the toolbar, or press <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>D</kbd> (macOS) or <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>D</kbd> (Windows). In visual mode this shows a visual diff. In source mode it shows a text diff. Select **Exit diff** or press the shortcut again to return to editing.

You can also open a diff from the publish menu. Select **Publish**, then select any changed file in the list.
...
- **Layout**: Select from standard, wide, centered, or custom.
