...
To remove a page from navigation without deleting the file:

1. Right-click the page in your navigation.
1. Click **Hide Page**.

The page moves to the **Unused Pages** section and won't appear on your published site. The file remains in your repository and you can add it back to navigation later.

### Manage unused files

Files in the **Unused Pages** section can be:

- **Moved**: Drag files between folders or to the root level.
- **Configured**: Right-click and select **Configure** to edit page settings.
- **Deleted**: Right-click and select **Delete** to remove the file from your repository.
- **Created**: Click **Add** to create new pages or folders that aren't yet in navigation.
