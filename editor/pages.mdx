...
- **Add file trees**: Type <kbd>/tree</kbd> to insert an editable file tree. Add files and folders, rename them inline, drag and drop to reorder or nest items, and toggle whether folders are collapsible or open by default.
