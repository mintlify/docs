...
| Edit a page | Stage and commit changes |
...
| Publish on your deployment branch | Push changes directly, which triggers a deployment |
| Publish on a feature branch | Push changes and create a **pull request**, a proposal to merge your changes into the deployment branch |
