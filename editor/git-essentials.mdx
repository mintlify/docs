...
<AccordionGroup>
  ...
  <Accordion title="Pull request">
    ...
    When you publish changes on a feature branch, the web editor creates a pull request. Your team reviews and merges the pull request in your Git provider (GitHub, GitLab, or Bitbucket).
  </Accordion>
