...
Git lets you control and track changes to files. With Git, you can see what changed over time in files, who made the changes, when they made changes, and why. You can undo changes and go back to previous versions of files if you need to. All of these capabilities combine to make Git the version control system of choice for docs-as-code workflows where you manage documentation the same way you would any other codebase.
