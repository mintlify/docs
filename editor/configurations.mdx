...
description: "Edit page metadata, navigation elements, and media settings using the visual configuration sheets in the Mintlify web editor sidebar."
...
<Frame>
  <img
    ...
    alt="Configurations settings in the sidebar in light mode."
    className="block dark:hidden"
  />
  <img
    src="/images/editor/configurations-dark.png"
    alt="Configurations settings in the sidebar in dark mode."
