...
description: "Edit logos, colors, fonts, theme, and feature settings for your Mintlify docs site visually in the editor — no manual docs.json changes required."
