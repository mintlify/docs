...
description: "Edit Mintlify site branding, appearance, navigation, and feature settings visually from the Configurations panel without modifying docs.json by hand."
