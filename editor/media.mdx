...
Access the media manager from the **Assets** section at the bottom of the left panel in the editor.
...
The media manager displays all your assets in a gallery view. You can search, select, and manage your assets from this interface.

### Search assets

Use the search bar to quickly find assets by filename.
...
To configure an asset, right-click the asset and select **Configure**. You can rename the file and view its file size.
