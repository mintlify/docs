...
Type <kbd>/youtube</kbd> to embed a YouTube video, <kbd>/loom</kbd> to embed a Loom video, or <kbd>/vimeo</kbd> to embed a Vimeo video. Paste the video URL and the editor generates an iframe.
