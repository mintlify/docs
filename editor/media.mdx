...
<Frame>
  <img src="/images/obama.jpg" alt="Assets manager selected in the editor sidebar menu." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Assets manager selected in the editor sidebar menu." className="hidden dark:block" />
</Frame>
