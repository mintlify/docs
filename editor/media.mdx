...
Type <kbd>/image</kbd> to open the image menu, then upload a new image or select an existing one. Type <kbd>/video</kbd> to open the video menu, then upload a new video or select an existing one.
