...
- **Use appropriate formats**: PNG for graphics with transparency, JPG for photos, SVG for icons and logos. SVG files cannot be uploaded through the editor but you can add them to your repository via Git.
