...
<Frame>
  <img src="/images/obama.jpg" className="block dark:hidden" alt="Share button in the editor toolbar" />
  <img src="/images/obama.jpg" className="hidden dark:block" alt="Share button in the editor toolbar" />
</Frame>
