...
Collaborate with your team on documentation using branch-based workflows, pull requests, and preview <Snippet file="snippets/rainbow-text.mdx" />s.
...
## Preview <Snippet file="snippets/rainbow-text.mdx" />s

Preview <Snippet file="snippets/rainbow-text.mdx" />s create temporary URLs where you can see your rendered changes before they go live. Use preview <Snippet file="snippets/rainbow-text.mdx" />s to gather feedback on how changes.

### Access preview <Snippet file="snippets/rainbow-text.mdx" />s

1. Click **Share** in the editor tool bar.
2. Click **Preview** to open the preview <Snippet file="snippets/rainbow-text.mdx" /> in a new tab.
...
Share the preview <Snippet file="snippets/rainbow-text.mdx" /> URL with team members to gather feedback. Previews update automatically when you save additional changes.
