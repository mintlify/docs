...
React to a comment to acknowledge it without replying. Hover over a comment, click the **Add reaction** button, and choose one of six emojis. Click an existing reaction to add or remove yours. Hover over a reaction to see who reacted.
