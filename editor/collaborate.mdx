...
Collaborate with your team on documentation using branch-based workflows, pull requests, and preview <Rainbow>deployment</Rainbow>s.
...
## Preview <Rainbow>deployment</Rainbow>s

Preview <Rainbow>deployment</Rainbow>s create temporary URLs where you can see your rendered changes before they go live. Use preview <Rainbow>deployment</Rainbow>s to gather feedback on how changes.

### Access preview <Rainbow>deployment</Rainbow>s

1. Click **Share** in the editor tool bar.
2. Click **Preview** to open the preview <Rainbow>deployment</Rainbow> in a new tab.
...
Share the preview <Rainbow>deployment</Rainbow> URL with team members to gather feedback. Previews update automatically when you save additional changes.
