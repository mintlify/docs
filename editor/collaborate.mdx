...
description: "Leave comments, propose changes as suggestions, and edit pages alongside teammates in real time with the collaboration features in the Mintlify editor."
