...
To react to a comment, hover over it, select the <Icon icon="smile" /> **Add reaction** icon, and choose an emoji. Select the same emoji again to remove your reaction.
...
Mintlify emails you about comment and suggestion activity, including new comments, mentions, replies to threads you follow, thread resolutions, and accepted or rejected suggestions. To choose which events email you, go to the [Notifications](https://app.mintlify.com/settings/organization/notifications) page of your dashboard. Preferences apply only to your own account.
