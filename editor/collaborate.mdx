...
2. Click the comment icon (speech bubble) in the floating toolbar that appears.
...
The sidebar groups comments by date (Today, Yesterday, or the specific date) and shows all unresolved comment threads.
...
1. Open the comment thread in the sidebar or by clicking commented text.
2. Click the checkmark icon on the first comment in the thread.

Resolved threads are removed from the sidebar and the text highlighting is removed from the editor.
