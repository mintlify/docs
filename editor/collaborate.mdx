...
<Steps>
  <Step title="Create a pull request">
    Create a pull request from the editor when you're ready to publish your changes. See [Publish changes in the web editor](/editor/publish) for more information.
  </Step>
