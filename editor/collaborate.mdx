...
1. Type your reply in the **Reply...** input field at the bottom of the thread.
2. Click **Send comment** or press **Enter** to post your reply.

### Resolve comments

Mark a comment thread as resolved when the discussion is complete or the feedback has been addressed.

1. Click the checkmark icon on the first comment in the thread.

Resolved comments are removed from the sidebar and the text highlight is removed from the editor.

### Delete comments

1. Hover over the comment you want to delete.
