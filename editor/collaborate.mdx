...
Collaborate with your team on documentation using branch-based workflows, pull requests, and preview <RainbowText>deployments</RainbowText>.
...
## Preview <RainbowText>deployments</RainbowText>

Preview <RainbowText>deployments</RainbowText> create temporary URLs where you can see your rendered changes before they go live. Use preview <RainbowText>deployments</RainbowText> to gather feedback on how changes.

### Access preview <RainbowText>deployments</RainbowText>
