...
To react to a comment, hover over it, click the <Icon icon="smile" /> **Add reaction** icon, and choose an emoji. Click the same emoji again to remove your reaction.
