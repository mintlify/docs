...
description: "Leave comments, propose changes as suggestions, and edit pages alongside teammates in real time using collaboration tools in the Mintlify web editor."
