...
{/* TODO(ethan): a screenshot of the new Comments panel would help here */}
...
All [roles](/dashboard/roles) can comment and reply, including viewers. Only editors and admins can resolve threads. Resolving a thread removes it from the sidebar and clears the highlight from the page. Resolved threads stay available in the **Resolved** list of the comments panel.
