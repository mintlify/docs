...
Click the paperclip icon in the chat input to attach files from your repository. Attached files give the agent additional context without requiring you to paste content into your message.
...
To send highlighted content to the [assistant](/assistant), select text in the editor, then click **Add to Assistant** in the floating toolbar. The selected content is attached to a new Assistant conversation so you can ask questions or request changes without switching context.
