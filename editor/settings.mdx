---
title: "Editor settings for appearance, AI, and publishing"
description: "Configure appearance preferences, AI instructions, pull request defaults, and merge methods in the Mintlify web editor to manage editing and publishing."
...
You can configure these settings from the settings panel. To open it, click the <Icon icon="settings" /> settings icon in the editor toolbar. The settings page displays all four sections.
...
Enable **Show all files** to display dotfiles, code, PDFs, and other files that are hidden by default. Mintlify displays them in the navigation sidebar. You can also press <kbd>⌘⇧.</kbd> on macOS or <kbd>Ctrl+Shift+.</kbd> on other platforms to toggle this preference.

To configure an appearance preference:
