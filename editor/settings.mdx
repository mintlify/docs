...
- **Publishing**: Deployment-wide defaults for how the editor commits changes and opens pull requests. These apply to everyone who publishes. Changing them requires permission to update the deployment. If the controls are disabled for you, contact an admin.
...
Turn it off if you want editor pull requests to open ready for review immediately.
