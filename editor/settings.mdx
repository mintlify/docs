...
You can configure both from the settings panel. To open it, select the <Icon icon="settings" /> settings icon in the editor toolbar.
...
1. Select the <Icon icon="settings" /> settings icon in the editor toolbar.
...
Choose how the editor merges pull requests when you select **Merge and publish**:
