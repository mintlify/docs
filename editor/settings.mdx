...
description: "Configure personal AI instructions and team publishing settings in the Mintlify web editor, including pull request templates and merge methods."
