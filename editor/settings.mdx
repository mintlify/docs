...
Enable **Show all files** to display every file in the navigation sidebar, including files whose names begin with a period, code, and PDFs. You can also press <kbd>⌘⇧.</kbd> on macOS or <kbd>Ctrl+Shift+.</kbd> on other platforms to toggle this preference.
