...
To lock or unlock the deployment branch:

1. Click the <Icon icon="settings" /> settings icon in the editor toolbar.
2. Under **Publishing settings**, toggle **Lock deployment branch**.
3. Save your changes.

When the deployment branch is locked, opening it in the editor shows the content in read-only mode. Teammates need to switch to or create a feature branch before they can edit.
