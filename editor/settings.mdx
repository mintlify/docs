...
When this setting is on, pull requests created from the editor open as drafts, including the pull request that opens after the first commit on a new branch. Authors mark them ready for review when they finish editing. This setting is on by default.
