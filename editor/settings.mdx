...
description: "Configure AI instructions, commit and pull request guidance, and default publishing behavior for the Mintlify web editor."
...
Turn this on to have the editor open every new pull request in draft state. Drafts can't be merged until they are marked ready for review, which is useful when:
