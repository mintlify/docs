...
Use this setting when your team wants all editor changes to create pull requests from draft branches.
...
For guidance on when to reset the editor, how to restore lost pages from Git, and how to clear phantom file changes, see [Recover from editor issues](/editor/recovery).

## Related

- [Branching and publishing](/editor/branching-and-publishing)
- [Configurations](/editor/configurations)
- [Recover from editor issues](/editor/recovery)
