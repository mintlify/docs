---
title: "Suggest edits in the web editor"
sidebarTitle: "Suggestions"
description: "Propose text changes as suggestions that teammates can review, accept, or reject in the web editor without modifying the current page content."
