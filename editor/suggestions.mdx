---
title: "Suggest text changes in the Mintlify content editor"
...
When suggesting mode is active, the editor displays a **Suggesting** pill in the top bar. Use it to confirm that your edits will be saved as suggestions.
