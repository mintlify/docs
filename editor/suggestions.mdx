...
2. Click the <Icon icon="pen" /> **Switch to Suggesting** button in the toolbar, or press <kbd>Option</kbd> + <kbd>S</kbd> (macOS) or <kbd>Alt</kbd> + <kbd>S</kbd> (Windows).
...
4. To exit suggesting mode, click the <Icon icon="pen" /> **Switch to Editing** button, or press the same shortcut again.
