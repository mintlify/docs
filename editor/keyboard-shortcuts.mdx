...
Collapse sections under Markdown headings to focus on the part of the document you're editing. As you scroll past a heading, it pins to the top of the editor as a sticky header. Click any sticky header to jump back to that section.

| Command | macOS | Windows |
| :--- | :--- | :--- |
| **Fold at cursor** | <kbd>Cmd</kbd> + <kbd>Option</kbd> + <kbd>[</kbd> | <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>[</kbd> |
| **Unfold at cursor** | <kbd>Cmd</kbd> + <kbd>Option</kbd> + <kbd>]</kbd> | <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>]</kbd> |
