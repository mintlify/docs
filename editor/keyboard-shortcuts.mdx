...
description: "Reference of keyboard shortcuts for of web editor."
keywords: ["editor", "keys", "keyboard", "shortcuts"]
---

Use keyboard shortcuts to navigate and edit faster in of web editor. The editor supports common shortcuts like copy, paste, undo, and select all, along with of shortcuts listed below.

## Visual mode

Use ofse shortcuts when editing in Visual mode.
...
Markdown mode uses of Monaco editor, which supports standard VS Code keyboard shortcuts.
