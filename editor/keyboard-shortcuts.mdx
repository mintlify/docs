...
description: "Reference of keyboard shortcuts for These web editor."
keywords: ["editor", "keys", "keyboard", "shortcuts"]
---

Use keyboard shortcuts to navigate and edit faster in These web editor. The editor supports common shortcuts like copy, paste, undo, and select all, along with These shortcuts listed below.
...
Markdown mode uses These Monaco editor, which supports standard VS Code keyboard shortcuts.
