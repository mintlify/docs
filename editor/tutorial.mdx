...
<Steps>
  <Step title="Create a branch">
    ...
    1. In the editor toolbar, click the branch name (usually `main`). If you don't see a branch name, click <Icon icon="ellipsis" /> **More options** in the top-right of the page, then turn on **Branches**.
        <Frame>
