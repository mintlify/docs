...
description: "Step-by-step Mintlify editor tutorial covering how to create a branch, edit pages, share a preview for review, and publish documentation changes."
