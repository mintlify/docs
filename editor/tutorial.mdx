...
<Steps>
  <Step title="Create a branch">
    ...
    To discard a branch instead of publishing, hover over it in the branch menu and click **Delete branch**. See [Delete a branch](/guides/branches#delete-a-branch).
  </Step>
