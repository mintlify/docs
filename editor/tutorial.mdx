...
- A Mintlify project connected to a GitHub, GitLab, or Bitbucket repository. See [Connect a repository](/deploy/github) for setup.
- An account with editor access to the project. If you can't sign in, ask an admin to invite you from the [Members](https://app.mintlify.com/settings/organization/members) page.
- Permission to open pull requests in the connected repository through your Git provider.
