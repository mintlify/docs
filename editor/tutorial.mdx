...
<Steps>
  ...
  <Step title="Make your changes">
    ...
    **To edit a page**: Select it in the navigation sidebar to open it. Type directly in the editor to add content. Press <kbd>/</kbd> to insert components, images, or other content.
  ...
  <Step title="Publish your branch">
    ...
    1. Select **Save in branch** to save all changes on your branch.
