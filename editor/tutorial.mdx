...
<Steps>
  <Step title="Create a branch">
    ...
    1. In the editor toolbar, click the branch name (usually `main`, with a **Live** badge). If you don't see it, [show the branch selector](/editor/publish#show-the-branch-selector).
        {/* TODO: retake screenshot. Show the branch menu with Find a branch and New branch. */}
        <Frame>
  ...
  <Step title="Make your changes">
    ...
    **To create a page**: Click the <Icon icon="plus" /> plus button next to the navigation group where you want to add the page, then click **New page**. Type a title for the page. The editor names the file after the title.
    ...
    {/* TODO: retake screenshot. Menu now says New page, not Add a page. */}
    <Frame>
  ...
  <Step title="Publish your branch">
    ...
    1. Click **Publish** in the toolbar to open the publish menu.
        {/* TODO: retake screenshot. Show the feature-branch publish menu with Request review. */}
        <Frame>
  ...
  <Step title="Get your pull request approved">
    Share the pull request with your team. Reviewers can open the pull request in GitHub, GitLab, or Bitbucket to leave comments, request changes, or approve it.
