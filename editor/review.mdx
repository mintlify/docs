...
The pull request title comes from your branch title. The editor generates the description, listing the files you created, updated, moved, or deleted. To control how the editor writes descriptions, set [PR instructions](/editor/settings#pr-instructions).
