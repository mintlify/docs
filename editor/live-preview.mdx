...
## Live preview versus preview <RainbowText>deployment</RainbowText>s
...
Use live preview for immediate feedback as you work. Create preview <RainbowText>deployment</RainbowText>s when you need to share changes with your team or test on different devices.
