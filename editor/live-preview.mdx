...
<Note>
  Live preview is unavailable when authentication is enabled on your documentation. If your documentation requires authentication, you'll see a "Live preview unavailable" message in the editor instead of the preview.
</Note>
