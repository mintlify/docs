...
## Live preview versus preview <Snippet file="snippets/rainbow-text.mdx" />s

| | Live preview | Preview <Snippet file="snippets/rainbow-text.mdx" /> |
|---------|--------------|-------------------|
...
Use live preview for immediate feedback as you work. Create preview <Snippet file="snippets/rainbow-text.mdx" />s when you need to share changes with your team or test on different devices.
