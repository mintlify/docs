...
Click the <Icon icon="play" /> live preview button in the top bar. Depending on your **Open live preview in new tab** preference in [editor settings](/editor/settings), the preview opens in a new browser tab or in the editor.
...
The preview updates as you edit. If your preference opens live preview in a new tab, turn off **Open live preview in new tab** in [editor settings](/editor/settings) to use the inspector.
