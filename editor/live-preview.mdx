...
Editors can click **Ask agent** in the preview toolbar to open the [editor agent](/editor/agent) beside the live preview. Opening the agent closes the Site settings panel, and opening Site settings closes the agent. Viewer roles do not see the **Ask agent** button.
