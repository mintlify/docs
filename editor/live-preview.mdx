...
Live preview is unavailable when authentication is enabled on your documentation. The editor displays a "Live preview unavailable" message in place of the preview pane.

To preview authenticated documentation, use [preview deployments](/editor/preview-deployments) instead, which support authentication and can be shared with your team.
