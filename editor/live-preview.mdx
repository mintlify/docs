...
<Note>
  Live preview works on public sites and on sites that use [authentication](/deploy/authentication-setup), including password, OAuth, JWT, and Mintlify-managed access. When you open live preview for an authenticated site, you sign in through the dashboard and see every page you have access to as an editor, including pages behind group-based access controls.
</Note>
