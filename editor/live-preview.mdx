...
## Live preview versus preview <Rainbow>deployment</Rainbow>s

| | Live preview | Preview <Rainbow>deployment</Rainbow> |
|---------|--------------|-------------------|
...
Use live preview for immediate feedback as you work. Create preview <Rainbow>deployment</Rainbow>s when you need to share changes with your team or test on different devices.
