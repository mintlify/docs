...
<Note>
  Live preview is unavailable when authentication is enabled on your documentation. The editor displays a "Live preview unavailable" message when this limitation applies.
</Note>
