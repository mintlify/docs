...
If you set the live preview to open in a new tab, the preview site settings menu is unavailable. Disable **Open live preview in new tab** in [editor settings](/editor/settings#appearance) to use the site settings menu.
