...
You can open the agent from the private page editor. The agent button is hidden for viewer roles. Private navigation refreshes when the agent or another editor changes the private page tree.
