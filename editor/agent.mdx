...
The agent can view JPEG, PNG, GIF, and WebP images on your pages. This includes published images, images you uploaded on your current branch, and images on private pages you can open. Use it to describe images, write alt text, or check whether screenshots match the surrounding content.
