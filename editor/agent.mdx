...
- [Suggestions](/editor/suggestions) propose a specific replacement that you can accept or reject. The original text remains visible with a strikethrough until you decide, and the agent can include an explanation in the suggestion thread.
- [Comments](/editor/comments) leave feedback or a question anchored to specific text without changing the page.
...
The agent uses the page you currently have open unless you name another page. It can annotate rendered page text, including prose inside components, but not frontmatter, page metadata, configuration, or raw MDX component tags and attributes.
