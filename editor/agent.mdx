---
title: "Use the editor's AI agent to edit pages"
...
If you have access to private pages, the agent can read and edit them from the private pages root. Use this when you need to review or update content that should not appear in your public navigation.
...
You can also mention a private page by title in the composer. The agent resolves the mention to its UUID path and includes only pages you can access.
...
The move adds the page to public navigation and revokes its private-page access. You do not need to configure another filesystem or grant. The agent uses your existing private-page permissions automatically.
