...
If you install the [Mintlify Slack app](/agent/slack), the editor agent can read your Slack workspace for context while it researches or answers your questions. The editor agent has read-only access to your workspace. It cannot post messages, add reactions, or perform other actions in your workspace.
