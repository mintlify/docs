...
keywords: ["editor", "AI", "assistant", "agent", "chat", "comments", "suggestions", "code mode", "file upload", "analytics"]
---
...
<Info>
  Asking about your analytics requires a [Pro or Enterprise plan](https://mintlify.com/pricing?ref=agent-analytics).
</Info>

The agent can answer questions about your documentation's traffic, search, assistant, and feedback data, and return the results as a chart or ranked list directly in the chat. Use it to request specific breakdowns, compare page performance, or investigate changes in traffic.

Example prompts:

- `what are the top 25 user agents hitting my site?`
- `which pages do AI agents hit far more than humans?`
- `what are people searching for and finding nothing?`
