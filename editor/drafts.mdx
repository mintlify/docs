...
**Each draft tracks its own version history.** The editor commits your edits as you work, so a draft builds up a history of changes on its branch. It also keeps an open pull request that reflects the current state of the draft.
...
2. Select **Live site** to return to your deployment branch, or open the **Drafts** tab and select a draft.
