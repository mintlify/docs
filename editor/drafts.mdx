...
<Steps>
  ...
  <Step title="Publish">
    Click **Publish** to merge the draft into your deployment branch and deploy it. If review is required, **Publish** only becomes available after the pull request receives approval.
