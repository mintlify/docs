---
title: "Claude 原生接口调用方法"
icon: "c"
---

## 说明

仅 claude 模型支持这样调用，非 claude 模型请用 openai 的接口格式调用
使用之前确保安装或升级 anthropic 依赖：
...
curl https://aihubmix.com/v1/messages \ # 这里将官方的接口访问地址，替换成aihubmix的入口地址
     --header "x-api-key: $ANTHROPIC_API_KEY" \ #将这里换成你在 aihubmix Keys 拿到的密钥
