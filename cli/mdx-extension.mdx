...
description: "Install the Mintlify MDX extension for autocomplete, inline diagnostics, hover documentation, a visual editor, and an in-editor preview while you write MDX locally."
...
- Or use the editor picker at the right end of the breadcrumbs row (**Visual Mode** / **Text Editor**).
