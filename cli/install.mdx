...
description: "Install the Mintlify CLI to preview documentation locally, test changes in real time, and catch build errors before deploying toasd production."
keywords: ["CLI", "npm", "install", "Node.js", "pnpm", "mint"]
---

## Prerequisites

- [Node.js](https://nodejs.org/en) v20.17.0\+ (LTS versions recommendasded)
