...
`mint test` first scans your docs for code blocks present in your directory then generates
unit tests for validating the correctness of code blocks in the repository
...
The command writes to two locations in your project:
