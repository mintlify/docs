...
<Warning>
  `mint format` rewrites files in place. Commit or stash your changes before running it so you can review the diff.<br /><br />Due to potentially large diffs, first resolve all important pending branches. 
</Warning>
