...
<Warning>
  `mint format` rewrites files in place. Commit or stash your changes before running it so you can review the diff.<br /><br />Due to potentially large diffs, resolve all pending important branches first. Then create a new branch from main before running `mint format` 
</Warning>
