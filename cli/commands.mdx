...
<Warning>
  `mint format` rewrites files in place. Commit or stash your changes before running it so you can review the diff. <br /><br />Due to potentially large formatting diffs, please resolve all important pending branches, and please create a new branch before running and merging.
</Warning>
