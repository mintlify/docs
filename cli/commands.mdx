...
Generate and run tests for the code samples in your documentation.
...
<Frame>
  <img
    ...
    alt="The mint test interactive interface with a steps sidebar and a page selection tree listing folders of pages with code block counts."
  />
</Frame>
