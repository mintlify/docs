...
| `--template` | Use a pre-defined template as a starting point. In interactive mode, the CLI prompts you to choose between starting from scratch or selecting a template. |
