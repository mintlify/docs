...
Valid template IDs: `developer-docs`, `help-center`, `knowledge-base`, `product-guide`, `empty`. See [Install the CLI](/cli/install#available-templates) for descriptions of each template.
