...
Run agent readiness checks against a deployed documentation site. The command evaluates how well your documentation is prepared for AI agents and displays the results.
...
| --- | --- |
| `<url>` | URL of the documentation site to check (required). |
| `--format` | Output format: `table` (default), `plain`, or `json`. |

```bash
# Run checks against a docs site
