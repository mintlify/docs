...
Display information about your current CLI session, including:

- **Version** — the installed CLI version
- **Email** — the email address of the authenticated user
- **Organization** — the organization linked to your account
- **Subdomain** — your documentation subdomain, if configured with `mint config set subdomain` or associated with your account
...
Requires authentication with `mint login`.
