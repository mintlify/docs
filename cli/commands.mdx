...
After a successful login, the CLI prompts you to select a default project. If your account has one project, it is set automatically. You can change the default project later with `mint config set subdomain <subdomain>`.
