...
Install the hosted Mintlify Index MCP server in your coding agents. The server provides a `context` tool for researching libraries, frameworks, SDKs, APIs, and CLI tools.
