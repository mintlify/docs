...
Run `mint score` to evaluate how well agents can navigate a documentation site. The command runs against your default subdomain, or pass a URL with `mint score <url>`. It displays an overall readiness score and individual check results.
