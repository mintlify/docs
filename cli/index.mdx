---
title: "Mintlify CLI"
description: "The Mintlify CLI lets you preview documentation locally, test changes in real time, analyze site performance, and run quality checks before deploying to production."
...
Run `mint score --url <url>` to evaluate how well a documentation site is prepared for AI agent consumption. The command displays an overall readiness score and individual check results.
