...
The CLI runs on your machine and connects to your Mintlify deployment when you need live data. It requires Node.js v20.17.0 or newer. See [Install the CLI](/cli/install) for setup steps.
