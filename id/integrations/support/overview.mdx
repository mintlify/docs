...
Anda dapat mengintegrasikan widget ke dalam dokumen Anda untuk dukungan pelanggan. Tambahkan bidang `integrations` ke dalam file `docs.json` Anda dengan ID aplikasi Anda masing-masing.
