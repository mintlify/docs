...
Select **Images and Media** from the sidebar to open the media manager.

#### View modes

The media manager offers two ways to browse your assets:

- **Tree view**: Navigate your assets in a hierarchical folder structure. This view is ideal for organizing files and understanding your asset directory structure.
- **Gallery view**: Browse assets as visual thumbnails grouped by folder. This view is ideal for quickly finding specific images or videos.

Use the view toggle button in the toolbar to switch between tree and gallery views.

#### Preview assets

Select any image or video file to preview it in the preview panel. The preview panel displays:

- Full-size preview of images and videos
- File metadata including dimensions and file size
- File path for easy reference

#### Configure assets

Access the configuration sheet to view and manage asset metadata:

1. Select the settings icon next to an asset or folder
2. Choose **Configure** from the menu

The configuration sheet displays:

- **For files**: File name, path, size, type, and dimensions
- **For folders**: Folder name, path, and file count

You can copy file or folder paths directly from the configuration sheet using the copy button.
