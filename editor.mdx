...
- **Deployment branch without branch protection**: Publishing merges changes and immediately updates your live site.
- **Deployment branch with branch protection requiring pull requests**: Publishing creates a pull request for review before merging.
- **Other branches without branch protection**: Publishing merges changes into your deployment branch and immediately updates your live site.
- **Other branches with branch protection requiring pull requests**: Publishing creates a pull request for review before merging.
