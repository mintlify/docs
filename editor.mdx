...
The visual editor includes a dedicated Images and Media view for managing your documentation assets. Access it by selecting **Images and Media** from the sidebar.
...
- **Gallery view**: Browse assets as thumbnails grouped by folder. Use the horizontal scroll controls to navigate through assets in each folder.
...
Access the configuration sheet for any asset by selecting the settings icon from the file's context menu. The configuration sheet displays:
...
- **Copy path**: Quickly copy the file or folder path to your clipboard

Use the search bar to filter assets by name in both tree and gallery views.
