...
Access the web editor from your [dashboard](https://dashboard.mintlify.com/editor) to manage your documentation directly in your browser.
...
<Steps>
  ...
  <Step title="Edit your content">
    Make changes in the web editor. Press <kbd>/</kbd> to open the component menu.
  </Step>
...
The web editor has two modes to accommodate different editing preferences and needs: visual mode and Markdown mode.
...
Use the media manager to upload and organize images and other media files for your documentation.

### Open the media manager

Click the **Media** icon in the sidebar to open the media manager.

### Upload files

Upload files to the root directory or to a specific folder:

- **Root directory**: Click the **Upload** button in the media manager toolbar.
- **Specific folder**: Click the **+** icon on a folder, then select **Upload a file**.

You can upload multiple files at once. Uploaded files are automatically committed to your repository.

### Create folders

Organize your media files into folders:

- **Root folder**: Click the **New folder** button in the media manager toolbar.
- **Subfolder**: Click the **+** icon on a folder, then select **New folder**.

Enter a name for the folder and press <kbd>Enter</kbd> to create it.

### Copy file paths

To use an image in your documentation, copy its path from the media manager:

1. Click the settings icon on the file you want to use.
2. Select **Copy path** from the menu.
3. Paste the path into your documentation using Markdown or HTML image syntax.
...
<Frame>
  <img
    ...
    alt="File extension menu in the web editor."
  />
  ...
  <img
    ...
    className="hidden dark:block"
    style={{ width:"auto",height:"400px" }}
    alt="File extension menu in the web editor in dark mode."
  />
</Frame>
...
<Frame>
  <img
    ...
    className="block dark:hidden"
    alt="Rename page in the web editor."
  />

  <img
    src="/images/editor/rename-dark.png"
    className="hidden dark:block"
    alt="Rename page in the web editor in dark mode."
  />
</Frame>
...
<Frame>
  <img
    ...
    className="block dark:hidden"
    alt="Delete page in the web editor."
  />

  <img
    src="/images/editor/delete-page-dark.png"
    className="hidden dark:block"
    alt="Delete page in the web editor in dark mode."
  />
</Frame>
...
<Tip>
  To sign commits with your GitHub account, you must authorize your GitHub account on the [My profile](https://dashboard.mintlify.com/settings/account) page of your dashboard. If you don't authorize your GitHub account, the Mintlify GitHub App signs commits made in the web editor.
</Tip>
