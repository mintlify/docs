...
The Images and Media view provides a centralized location to browse, preview, and manage all image and video assets in your documentation.

To access the Images and Media Manager, select **Images and Media** from the sidebar navigation.

#### View modes

The media manager offers two ways to view your assets:

- **Tree view**: Browse assets organized by folder structure. This view is ideal for navigating large collections of assets and understanding how they're organized in your repository.
- **Gallery view**: Preview assets as thumbnails grouped by folder. This view is ideal for quickly identifying specific images or videos visually.

Switch between views using the view toggle button in the toolbar.

#### Preview assets

Select any image or video to preview it in the right panel. The preview shows:

- Full-size image or video playback
- File metadata including size and dimensions
- File path for easy reference

#### Configure assets

Access detailed information about any file or folder by selecting the settings icon from the asset's context menu. The configuration panel displays:

- **File name**: The name of the asset
- **File path**: The full path to the asset in your repository (click to copy)
- **File size**: The size of the asset in KB or MB
- **File type**: The file extension (e.g., PNG, JPG, MP4)
- **Dimensions**: Width and height in pixels for images and videos

For folders, the configuration panel shows:

- **Folder name**: The name of the folder
- **Folder path**: The full path to the folder (click to copy)
- **File count**: The total number of files in the folder and its subfolders
