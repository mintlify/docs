...
The Images and Media view provides a centralized interface for browsing, previewing, and managing your image and video assets. Access it by selecting **Images and Media** from the sidebar navigation.
...
- **Tree view**: Displays assets in a hierarchical folder structure, similar to the file explorer. This view is ideal for navigating organized asset directories.
- **Gallery view**: Shows asset thumbnails grouped by folder, making it easy to visually scan and identify images and videos.
...
Access the configuration sheet for any asset by clicking the settings icon in the asset's context menu. The configuration sheet displays:

- **File metadata**: View file name, path, size, type, and dimensions
- **Folder information**: For folders, see the total file count and folder path
- **Copy path**: Quickly copy the asset path to your clipboard for use in your documentation

<Note>
  The Images and Media Manager currently provides read-only access to your assets. File upload, deletion, and organization features are coming soon.
</Note>
