...
## We now ai generate commit messages

What this means is that the editor will have better looking messages when you make a commit.

Check it out!

## To check it out. Just make some quick edits in the editor

and then the message that will be commited will be magical as fuck boi
...
<Steps>
  ...
  <Step title="Edit your content">
    Make changes in the web editor. Press <kbd>/</kbd>
...
We now AI generate commits! What this means is that you can now
...
1. Click the **Preview** button to open the preview deployment in a new browser tab.
   ...
   <Frame>
     <img
       src="/images/editor/share-preview-light.png"
       alt="Share preview panel opened in the editor toolbar."
       className="block dark:hidden"
     />

     <img
       src="/images/editor/share-preview-dark.png"
       alt="Share preview panel opened in the editor toolbar."
       className="hidden dark:block"
     />
   </Frame>
