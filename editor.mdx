...
keywords: ["visual editor", "Web editor", "web editor"]
---
...
- **Web editor**: Make changes to your documentation using a what-you-see-is-what-you-get editor that shows how your content will look when published.
...
Visual mode provides a Web editor experience where changes that you make in the editor reflect how your published documentation will look. This mode is ideal for when you want to see how your changes will look in real-time.
