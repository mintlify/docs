...
Mintlify seamlessly integrates with the GitHub API, enabling smooth
synchronization between your docs and your GitHub repository. This integration
is made possible through the utilization of
...
We need read access to `email addresses` to associate GitHub accounts with
Mintlify accounts.
