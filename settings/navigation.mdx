...
mint.json, You don't need to include `.mdx` in page names. For sidebar styling options, see the [global settings page](https://mintlify.com/docs/settings/global#param-sidebar)
