...
To set up your documentation on a custom subdomain, you'll need to set your desired custom subdomain n your Mintlify settings and configure your DNS settings on your domain provider.
