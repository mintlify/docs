...
<Tip>
  Custom subdirectory is available under the [Enterprise
  Plan](https://mintlify.com/pricing). Please [contact the
  team](mailto:hi@mintlify.com) to enable this feature.
</Tip>
