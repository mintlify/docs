...
Every Mintlify site needs a `mint.json` file with the core configuration settings. Learn more about the [properties](#properties) or from an [example](#example)
...
<ResponseField name="analytics" type="Analytics">
  ...
  supported analytics [here](/analytics/supported-integrations).
</ResponseField>

<h2 id="example">Example mint.json</h2>
