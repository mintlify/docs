...
<ResponseField name="layout" type={'"topnav" | "sidenav" | "solidSidenav"'} default="topnav">
  The layout of the project. Setting it to `topnav` will feature the top bar as the primary navigation. Setting it to `sidenav` will feature the sidebar. The `solidSidenav` will have an active sidenav.
</ResponseField>
...
<ResponseField name="sidebar" type="Sidebar">
  Styling configurations for components of the sidebar
