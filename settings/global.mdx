    ...
    <ResponseField name="paramFields" type="ApiParamFields">
      ...
      <Expandable title="ApiParamFields">
        <ResponseField name="expanded" default="none" type='"all" | "topLevel" | "topLevelOneOfs" | "none"'>
          Changes the default expanded state of expandable options in the API playground.

          `"all"` defaults every expandable component to open.

          `"topLevel"` defaults every top-level expandable component to open.

          `"topLevelOneOfs"` defaults every top-level expandable component that has a `oneOf` type in the OpenAPI spec to open.

          `"none"` or leaving `expanded` undefined defaults every expandable component to closed.
        </ResponseField>
      </Expandable>
    </ResponseField>
