...
<Steps>
  <Step title="Get Project Information">
  ...
  <Step title="Set Up Webhook">
    ...
    5. Test the webhook using "Push events" - should return HTTP 200
  </Step>
</Steps>

<Note>
  Need help? Contact the Mintlify team [here](https://mintlify.com/enterprise).
</Note>