...
<Note>
  **HTTPS Cloning Required**: Your GitLab project must have HTTPS cloning enabled for Mintlify to access your repository. You can verify this in your project's **Settings** > **General** > **Visibility, project features, permissions** section.
</Note>
