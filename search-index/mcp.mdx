...
description: "Reference for the public Mintlify Index MCP server, including its context tool, parameters, output, and rate limits for AI tools in production."
