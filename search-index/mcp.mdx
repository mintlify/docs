...
description: "Reference for the public Mintlify Index MCP server, including its context tool, connection, parameters, output, search scope, and rate limits."
...
You do not need to authenticate to the public server. See [Connect](/search-index/connect) for setup instructions for supported coding agents.
