...
<CardGroup cols={2}>
  ...
  <Card title="French (fr-CA)" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/ca.png" className="w-6 h-6 my-0" />} horizontal>
