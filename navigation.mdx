...
The [navigation](settings#param-navigation) property in `docs.json` defines how your documentation is organized. Think of it as the blueprint for your documentation's menu structure.
