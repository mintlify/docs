...
Use the **Filter** menu to scope the dashboard to a single page or path. When you select a path, the analytics page displays data for every page in that path. For example, if you filter to `docs/authentication`, the analytics page displays data for every page in the `docs/authentication/*` path. The Assistant and Search views always show site-wide data.
