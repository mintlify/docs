...
description: "Use the Mintlify analytics dashboard to understand documentation traffic, assistant usage, searches, engagement, and feedback."
...
<Card title="Feedback" horizontal icon="square-dashed-text" href="/analytics/feedback">
  Review page ratings and written feedback, then track follow-up work.
</Card>
