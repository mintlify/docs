...
You can also ask the [editor agent](/editor/agent#ask-about-your-analytics) questions about this data directly in chat.
...
Use the **Filter** menu in the Traffic, User engagements, and Feedback views to scope the dashboard to a single page. Select a page to update every card on that view, or select **All pages** to return to site-wide data. The Assistant and Search views always show site-wide data.
