...
To stop streaming to a destination, open the streaming configuration, click the <Icon icon="trash-2" /> remove icon next to the destination, then click **Remove** to confirm.
