...
2. In the **Stream configuration** section, select **Configure**.
...
To stop streaming to a destination, open the streaming configuration, select the <Icon icon="trash-2" /> remove icon next to the destination, then select **Remove** to confirm.
