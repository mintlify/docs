...
* Identify pages with the most positive feedback to see what is working well in your documentation.
* Identify pages with the most negative feedback to see what needs improvement.
