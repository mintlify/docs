...
description: "Learn how to format text, create headers, and style content using MDX syntax"
icon: "heading"
---
...
<Tip>
  Use blockquotes sparingly to maintain their visual impact and meaning. Consider using [callouts](/components/callout) for notes, warnings, and other information.
</Tip>
