...
import LocalSnippet from '/es/folder/local-snippet.mdx';
...
Tiers 2 and 3 include the same response time targets. {/* vale Mintlify.Will = NO */} Mintlify will use commercially reasonable efforts to meet the following service levels:
