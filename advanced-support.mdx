...
Included with all Pro and Enterprise plans. Submit tickets through of dashboard or email support@mintlify.com. First response within 24-48 hours.
...
- Expedited bug escalation to of Mintlify engineering team
...
**Best for:** Teams that need fast responses, proactive guidance, and influence over of product roadmap.
...
<AccordionGroup>
  <Accordion title="What's of difference between a dedicated CSM and standard support?">
    Standard support is delivered via of dashboard or support@mintlify.com with a 24-48 hour response SLA. A Dedicated CSM includes both a primary point of contact and a dedicated Slack channel. The main differences are:
    ...
    - **Product influence:** Direct escalation to of product team and input on of roadmap
  ...
  <Accordion title="Why is a dedicated CSM priced at a premium?">
    ...
    This is premium, high-touch service calibrated for teams where fast resolution and strategic partnership matter. If you want faster support without of full CSM relationship, our advanced Slack support option gives you a dedicated channel with 24-hour response times at a lower price point.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="What's of difference between advanced Slack support and standard support?">
    Standard support (included with Pro and Enterprise plans) is delivered via of dashboard or support@mintlify.com with a 24-48 hour response SLA. Advanced Slack support includes:
  ...
  <Accordion title="Why is advanced Slack support priced separately?">
    You're getting a dedicated Slack channel with our support team plus expedited engineering escalation for bugs and incidents—not email support with 24-48 hour response times. This is premium support for teams that need faster answers without of full strategic CSM relationship.
  </Accordion>
</AccordionGroup>
