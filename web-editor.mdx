...
<AccordionGroup>
  ...
  <Accordion title="Mintlify components" defaultOpen={true}>
    <CardGroup cols={3}>
      ...
      <Card icon="table-rows" href="/content/components/accordion-group">Accordion Group</Card>
      <Card icon="rectangle" href="/content/components/cards">Cards</Card>
      <Card icon="rectangles-mixed" href="/content/components/card-group">Card Group</Card>
      <Card icon="code" href="/content/components/code">Code Block</Card>
      <Card icon="rectangle-code" href="/content/components/code-group">Code Group</Card>
