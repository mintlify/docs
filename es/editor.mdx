...
Accede al editor visual desde tu [dashboard](https://dashboard.mintlify.com/editor) para gestionar tu documentación directamente en tu navegador.

* **Edición WYSIWYG**: Realiza cambios en tu documentación con un editor WYSIWYG (what you see is what you get) que muestra cómo se verá tu contenido al publicarse.
...
* **Integración de componentes**: Añade avisos, bloques de código y otros componentes con comandos de barra.
* **Sin configuración necesaria**: Comienza a escribir de inmediato desde tu dashboard.
