...
<img
  ...
  alt="Interfaz del Editor web de Mintlify en modo claro"
/>

<img
  className="hidden dark:block my-0 pointer-events-none"
  src="/images/editor/editor-dark.png"
  alt="Interfaz del Editor web de Mintlify en modo oscuro"
/>
...
<Frame>
  <img 
    ...
    alt="Iconos de alternancia de modo resaltados en el Editor web de Mintlify" 
...
<Frame>
  <img 
    ...
    alt="Modo de edición visual en el Editor web de Mintlify" 
    className="block dark:hidden"
  />
  <img 
...
<Frame>
  <img 
    ...
    alt="Modo Markdown en el Editor web de Mintlify" 
    className="block dark:hidden"
  />
  <img 
...
1. Presiona <kbd>Enter</kbd> para crear el archivo.
...
1. Actualiza la propiedad `navigation` para obtener la estructura de navegación que deseas. Consulta [Navigation](/es/navigation) para más información.
...
1. Selecciona **Publish Pull Request** en la esquina superior derecha del editor.
1. Agrega un título y una descripción para tu pull request. Un buen título y una buena descripción ayudan a los revisores a entender los cambios que realizaste.
1. Selecciona **Publish Pull Request**.
...
1. **Haz cambios adicionales**: Después de la revisión, realiza los cambios en el Editor web. Al guardar, se actualizará el pull request.
1. **Fusiona cuando esté listo**: Cuando el pull request esté listo, fusiónalo para desplegar los cambios en tu sitio de documentación en producción.
