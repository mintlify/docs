...
description: "Crea páginas de referencia de API manualmente con archivos MDX cuando necesitas control total sobre el diseño, para APIs pequeñas, prototipos o documentación personalizada."
