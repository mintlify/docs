...
Para empezar a crear páginas para tus websockets, asegúrate de contar con un documento de esquema de AsyncAPI válido en formato JSON o YAML que cumpla con la [especificación de AsyncAPI](https://www.asyncapi.com/docs/reference/specification/v3.0.0). Tu esquema debe ajustarse a AsyncAPI 3.0 o superior.
...
Si quieres tener más control sobre cómo ordenas tus canales o si solo necesitas hacer referencia a un canal en particular, puedes crear un archivo MDX con el campo `asyncapi` en el frontmatter.
