...
<Note>
  La Guía OpenAPI de Swagger es para OpenAPI v3.0, pero casi toda la información es aplicable a v3.1. Para más información sobre las diferencias entre v3.0 y v3.1, consulta [el post del blog de OpenAPI](https://www.openapis.org/blog/2021/02/16/migrating-from-openapi-3-0-to-3-1-0).
</Note>
...
Las descripciones de la API y el API Playground agregarán campos de autenticación basados en las configuraciones de seguridad en tu documento OpenAPI.

Si diferentes endpoints dentro de tu API requieren diferentes métodos de autenticación, puedes [anular el campo de seguridad](https://swagger.io/docs/specification/authentication/#:~:text=you%20can%20apply%20them%20to%20the%20whole%20API%20or%20individual%20operations%20by%20adding%20the%20security%20section%20on%20the%20root%20level%20or%20operation%20level%2C%20respectively.) para una operación específica.
