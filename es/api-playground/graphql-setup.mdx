...
description: "Genera páginas de referencia para tu API de GraphQL desde un archivo de esquema, con tipos enlazados y ejemplos de consultas, mutaciones y respuestas."
