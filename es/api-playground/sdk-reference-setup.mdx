...
<Note>
  ...
  - Una pestaña con `sdk` puede incluir `groups`, pero no otras estructuras de navegación, como `pages`, `versions` o `languages`, y tampoco puede incluir una propiedad `openapi`, `asyncapi` o `graphql`.
