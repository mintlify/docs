...
description: "Resuelve problemas comunes en la configuración de páginas de API."
---

Si tus páginas de API no se visualizan correctamente, verifica estos problemas de configuración habituales:
