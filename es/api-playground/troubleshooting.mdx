...
<AccordionGroup>
  <Accordion title="All of my OpenAPI pages are completely blank">
    ...
    2. Cambia a la pestaña "Validar texto"
    ...
    podrías encontrar este problema. Puedes convertir tu documento en [editor.swagger.io](https://editor.swagger.io/) (bajo Editar > Convertir a OpenAPI 3):
  ...
  <Accordion title="One of my OpenAPI pages is completely blank">
    Esto generalmente es causado por un error de escritura en un`openapi` campo en los metadatos de la página. Asegúrate que el método HTTP y la ruta coincidan exactamente con el método HTTP y la ruta en el documento OpenAPI.
