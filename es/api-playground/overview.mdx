...
<Frame>
  <img src="/images/obama.jpg" alt="Playground de API para el endpoint Trigger an update." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Playground de API para el endpoint Trigger an update." className="hidden dark:block" />
</Frame>
