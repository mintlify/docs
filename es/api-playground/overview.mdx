...
<ResponseField name="url" type="&quot;full&quot;">
    El modo de visualización de las URL base en los encabezados de endpoint. Cuando se establece en `full`, la URL base completa se muestra para cada página de endpoint. Por defecto, solo se muestra la ruta relativa del endpoint.
</ResponseField>
...
<ResponseField name="examples" type="object">
  ...
  <Expandable title="examples" defaultOpen="True">
    <ResponseField name="languages" type="array of string">
      ...
      <Accordion title="Todos los lenguajes admitidos">
        | Nombre visible | Key | Alias |
        | --- | --- | --- |
