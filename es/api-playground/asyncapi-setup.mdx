...
description: "Configura documentación WebSocket en tiempo real con archivos de especificación AsyncAPI para generar páginas de referencia interactivas de canales y mensajes."
