...
description: "Configura documentación WebSocket en tiempo real con archivos AsyncAPI para generar páginas de referencia interactivas de canales y mensajes."
