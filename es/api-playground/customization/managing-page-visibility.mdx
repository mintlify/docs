...
La extensión `x-hidden` crea una página para un endpoint, pero la oculta de la navigation. La página solo es accesible si se navega directamente a su URL.

Algunos casos de uso comunes de `x-hidden` son:
