...
Puedes referenciar varias especificaciones de OpenAPI para crear páginas para tu API. Organiza secciones para cada especificación en tu navegación o referencia endpoints específicos de diferentes especificaciones.
...
Genera secciones de API dedicadas agregando un campo `openapi` a un elemento de navegación y sin añadir otras páginas. Se incluirán todos los endpoints de la especificación:
...
Para organizar varias especificaciones de OpenAPI en secciones separadas de tu documentación, asigna cada especificación a un grupo distinto en tu jerarquía de navegación. Cada grupo puede hacer referencia a su propia especificación de OpenAPI.
...
<Note>
  El campo `directory` es opcional y determina dónde se almacenan las páginas de API generadas en tu repositorio de documentación. Si no se especifica, se usará por defecto el directorio `api-reference` de tu repositorio.
</Note>
...
Haz referencia a endpoints específicos sin establecer una especificación de OpenAPI predeterminada, incluyendo la ruta del archivo. Puedes referenciar endpoints de varias especificaciones de OpenAPI en la misma sección de la documentación.
...
* Combinar endpoints de varias especificaciones de OpenAPI dentro de la misma sección de navegación.
* Incluir solo endpoints específicos de distintas especificaciones en lugar de todos.
* Integrar endpoints de la API junto con otros tipos de páginas de documentación.
