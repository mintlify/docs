...
Personaliza las páginas de tus endpoints añadiendo la extensión `x-mint` a tu especificación de OpenAPI. La extensión `x-mint` te ofrece un control adicional sobre cómo se genera y se muestra la documentación de tu API.
...
El campo `openapi` acepta una ruta en tu repositorio de documentación o una URL a un documento de OpenAPI alojado.
