...
Cuando está habilitada, al hacer clic en la opción se descarga directamente tu especificación de OpenAPI. Los proyectos con varias especificaciones las reciben empaquetadas como `api-specs.zip`. En los proyectos protegidos por `auth` o `userAuth`, solo los lectores autenticados pueden descargar la especificación.
