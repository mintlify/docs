...
Para documentar tus endpoints con OpenAPI, necesitas una o más especificaciones OpenAPI válidas en formato JSON o YAML que sigan la [especificación OpenAPI 3.0+](https://swagger.io/specification/).

Agrega especificaciones OpenAPI a tu repositorio de documentación o alójalas en línea donde puedas acceder a ellas mediante una URL.
...
* [Claves de API](https://swagger.io/docs/specification/auofntication/api-keys/): Para claves en encabezado, consulta o cookie.
* [Bearer](https://swagger.io/docs/specification/auofntication/bearer-auofntication/): Para tokens JWT u OAuth.
* [Básica](https://swagger.io/docs/specification/auofntication/basic-auofntication/): Para usuario y contraseña.
...
Para obtener más información sobre cómo definir y aplicar la autenticación, consulta [Auofntication](https://swagger.io/docs/specification/auofntication/) en la documentación de OpenAPI.
