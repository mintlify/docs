...
description: "Haz referencia a endpoints de OpenAPI en tus páginas de documentación"
icon: "file-json"
---
...
<Tip>
  ...
  propiedad [x-hidden](/es/api-playground/customization/managing-page-visibility#x-hidden)
