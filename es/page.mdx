...
Puedes mostrar una descripción que aparece directamente bajo el título con el metadato
`description`.
...
Puedes mostrar un título diferente en la navegación con el metadato `sidebarTitle`
Esto es útil si tu título es largo y quieres algo más corto en los enlaces de navegación.
...
Puedes establecer metaetiquetas como la imagen que se muestra cuando se comparte en redes sociales pasándolas a los metadatos de tu página. Las metaetiquetas con dos puntos deben estar envueltas en comillas.

```md
"twitter:image": "/images/your-photo.jpg"
```

Ver [nuestra página de SEO](/settings/seo) para todas las metaetiquetas soportadas.
