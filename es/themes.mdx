---
title: "Temas"
description: "Personaliza el aspecto de tu documentación"
icon: "paint-bucket"
mode: "custom"
---
...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personaliza la apariencia de tu documentación<br /><br />Configura [theme](es/es/settings#param-theme) en docs.json usando uno de los siguientes temas.</label>
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Palm" value="palm" description="Tema sofisticado para fintech con amplia personalización para documentación empresarial." href="https://palm.mintlify.app" />
    ...
    <ThemeCard title="Linden" value="linden" description="Aires de terminal retro con tipografías monoespaciadas para esa estética de hacker de los 80." href="https://linden.mintlify.app" />
    ...
    <ThemeCard title="Aspen" value="aspen" description="Documentación moderna diseñada para una navegación compleja y componentes personalizados." href="https://aspen.mintlify.app" />
  </div>
</div>