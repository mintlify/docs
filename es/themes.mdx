...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personaliza la apariencia de tu documentación<br /><br />Configura [theme](settings#param-theme) en docs.json usando uno de los siguientes temas.</label>
...
<ThemeCard title="Linden" value="linden" description="Estética de terminal retro con tipografías monoespaciadas para un estilo hacker de los 80." href="https://linden.mintlify.app" />
