...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Palm" value="palm" description="Tema fintech sofisticado con personalización profunda para documentación empresarial." href="https://palm.mintlify.app" />
    ...
    <ThemeCard title="Linden" value="linden" description="Vibras de terminal retro con fuentes monoespaciadas para esa estética hacker de los 80." href="https://linden.mintlify.app" />
