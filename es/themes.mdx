...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="Tema de documentación clásico con diseños comprobados y una navegación familiar." href="https://mint.mintlify.app" />
    ...
    <ThemeCard title="Palm" value="palm" description="Tema fintech sofisticado con personalización avanzada para documentación empresarial." href="https://palm.mintlify.app" />
    ...
    <ThemeCard title="Linden" value="linden" description="Aires de terminal retro con tipografías monoespaciadas para esa estética hacker de los 80." href="https://linden.mintlify.app" />
