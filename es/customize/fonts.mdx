...
Configura una fuente personalizada para todo tu sitio o de forma independiente para los encabezados y el cuerpo del texto. Usa Google Fonts, archivos de fuentes locales o fuentes alojadas externamente. La fuente predeterminada varía según el tema.

Las fuentes se gestionan mediante la [propiedad fonts](/es/organize/settings#param-fonts) en tu `docs.json`.
