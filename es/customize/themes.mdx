...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Aspen" value="aspen" description="Documentación moderna creada para navegación compleja y componentes personalizados." href="https://aspen.mintlify.app" />
  </div>
</div>
