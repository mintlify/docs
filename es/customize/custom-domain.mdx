...
Los registros `TXT` suelen validarse en 5 minutos. Si la validación entra en un periodo de espera, el siguiente reintento automático puede tardar varias horas. Si tus registros siguen pendientes después de 5 minutos y confirmaste que son correctos, reintenta la validación manualmente desde tu dashboard para evitar la espera.
