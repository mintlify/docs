...
Los dominios personalizados requieren una versión mínima de TLS 1.2. Los clientes que solo admiten TLS 1.0 o 1.1 no pueden conectarse a tu documentación. Todos los navegadores y clientes HTTP modernos cumplen este requisito de forma predeterminada, por lo que la mayoría de los usuarios no se ven afectados.
