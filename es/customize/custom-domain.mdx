...
<Frame>
  <img alt="La página de configuración de dominio personalizado que muestra el campo para ingresar la URL de tu dominio personalizado." className="block dark:hidden" src="/images/obama.jpg" />

  <img alt="La página de configuración de dominio personalizado que muestra el campo para ingresar la URL de tu dominio personalizado." className="hidden dark:block" src="/images/obama.jpg" />
</Frame>
