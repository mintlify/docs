...
Carga scripts de terceros desde URLs externas en cada página de tu sitio de documentación. Es útil para agregar análisis, widgets de chat, gestores de consentimiento u otros servicios que proporcionan un script alojado.

Puedes gestionar los scripts externos desde el [panel de control](https://dashboard.mintlify.com) en **Settings > Add-ons > Custom scripts**. Para cada script, proporciona una URL HTTPS y elige una estrategia de carga:
