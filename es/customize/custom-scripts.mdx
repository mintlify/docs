...
<AccordionGroup>
  ...
  <Accordion title="Selectores">
    ...
    **Atributos de datos**
    ...
    Usa `data-active-deepest` para apuntar a la sección activa más específica en la tabla de contenidos. Cuando te desplazas a un `h3` dentro de un `h2`, ambos elementos del índice tienen `data-active`, pero solo el elemento `h3` tiene `data-active-deepest`.
