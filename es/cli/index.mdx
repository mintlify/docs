...
La CLI se ejecuta en tu máquina y se conecta a tu despliegue de Mintlify cuando necesitas datos en vivo. Requiere Node.js v20.17.0 o posterior. Consulta [Instalar la CLI](/es/cli/install) para conocer los pasos de configuración.
