---
title: "Mintlify CLI"
description: "Usa la CLI de Mintlify para previsualizar la documentación localmente, probar cambios en tiempo real y ejecutar controles de accesibilidad, enlaces y validación antes de desplegar."
