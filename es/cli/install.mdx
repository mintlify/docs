...
| `--template` | Crear el proyecto a partir de una plantilla predefinida. |
| `--force` | Sobrescribir el directorio actual sin solicitar confirmación. |

En modo interactivo, la CLI pregunta si deseas empezar desde cero o usar una plantilla. Para omitir el aviso, pasa el flag `--template` directamente:
