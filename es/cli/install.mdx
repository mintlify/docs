...
| `--template` | Usar una plantilla predefinida como punto de partida en lugar de la plantilla por defecto. |
| `--force` | Sobrescribir el directorio actual sin solicitar confirmación. |

En modo interactivo, la CLI te solicita elegir entre empezar desde cero o seleccionar entre las plantillas disponibles.
