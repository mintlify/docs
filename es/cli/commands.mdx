...
| --- | --- | --- |
| `subdomain` | Subdominio predeterminado de la documentación. | `mint dev`, `mint automations`, `mint analytics`, `mint add-domain`, `mint score` |
...
<Frame>
  <img
    ...
    alt="La interfaz interactiva de mint test con una barra lateral de pasos y un árbol de selección de páginas que muestra carpetas de páginas con el recuento de bloques de código."
  />
</Frame>
