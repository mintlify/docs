...
Muestra la versión del CLI, la cuenta, la organización y el subdominio asociados a tu sesión actual.
...
| `--agent` | Salida en JSON. Equivalente a `--format json`. También se activa automáticamente cuando la variable de entorno `CLAUDECODE` es `1`. |
