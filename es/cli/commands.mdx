...
Crea un nuevo proyecto de documentación a partir de la plantilla inicial de Mintlify o una plantilla predefinida.
...
| `--template` | Usar una plantilla predefinida como punto de partida. En modo interactivo, la CLI te solicita elegir entre empezar desde cero o seleccionar una plantilla. |
