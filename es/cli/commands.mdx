...
| `responseLatency` | El sitio responde dentro del umbral de latencia (2 segundos). |
...
Crea un nuevo proyecto de documentación a partir de la plantilla inicial de Mintlify o de una plantilla predefinida.
