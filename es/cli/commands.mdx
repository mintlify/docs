...
Ejecuta el comando desde tu directorio de documentación. Analiza tus páginas en busca de bloques de código delimitados, verifica qué páginas contienen ejemplos que se pueden probar, pide a un agente de codificación que genere pruebas para cada página, ejecuta las pruebas generadas e informa qué páginas pasan o fallan.
...
En terminales interactivas, el comando abre una interfaz guiada donde seleccionas un agente de codificación y las páginas a probar, observas el progreso en vivo y revisas los resultados, incluidas vistas previas de los archivos de prueba generados. Si una ejecución anterior se interrumpió, puedes reanudarla, y las ejecuciones anteriores se guardan para que puedas volver a consultar sus informes.

En entornos no interactivos, como CI, el comando ejecuta Claude sobre páginas seleccionadas automáticamente, imprime un resumen de las páginas que pasaron y fallaron, y termina con el código `0` si todas las pruebas pasan o `1` en caso contrario.
