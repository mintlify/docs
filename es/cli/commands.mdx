...
| `--template` | Crear el proyecto a partir de una plantilla en lugar de empezar desde cero. En modo interactivo, la CLI muestra las plantillas disponibles para elegir. |
