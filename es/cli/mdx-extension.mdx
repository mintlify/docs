...
description: "Instala la extensión Mintlify MDX y obtén autocompletado, diagnósticos en línea y previsualización en el editor mientras escribes MDX localmente."
