...
description: "Instala la extensión Mintlify MDX en VS Code o Cursor para obtener autocompletado, diagnósticos en línea y una previsualización en vivo al escribir MDX."
