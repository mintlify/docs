...
description: "Configura Auth0 como proveedor de identidad OAuth 2.0 para un sitio privado de Mintlify: endpoints, URL de callback y control de acceso por grupos."
