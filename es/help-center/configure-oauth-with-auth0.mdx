...
description: "Configura Auth0 como proveedor de identidad OAuth 2.0 para docs privadas de Mintlify: URLs de endpoints, registro del callback y acceso por grupos."
