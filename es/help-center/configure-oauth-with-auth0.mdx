...
description: "Configura Auth0 como proveedor de identidad OAuth 2.0 para documentación privada de Mintlify: URLs de endpoints, callback y acceso por grupos."
...
En tu panel de Mintlify, ve a la página de configuración de [Access](https://app.mintlify.com/settings/project/authentication), define la visibilidad del sitio como **Private** y elige **Custom** → **OAuth**. Rellena los campos con los siguientes valores de Auth0. Reemplaza `YOUR_AUTH0_DOMAIN` con el dominio de tu tenant.
