...
3. Haz clic en el enlace, inicia sesión en el servicio de terceros y aprueba los permisos solicitados. Después de autorizar, tu navegador muestra una página de confirmación indicando que la conexión se ha completado.
...
Mintlify mantiene sincronizado el estado de tus servicios conectados con Composio. Una conexión se marca automáticamente como desconectada cuando:

- El proveedor externo caduca o revoca las credenciales.
- Eliminas la conexión desde el panel de Composio.
- El proveedor marca la conexión como inactiva.

Si una conexión ya no está activa, la próxima vez que le pidas al agente que use ese servicio, te responderá con un nuevo enlace de autorización. Haz clic en el enlace, vuelve a autorizar el servicio y el agente continuará desde donde lo dejaste.
