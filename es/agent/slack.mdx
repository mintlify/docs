...
- Continuar las conversaciones en hilos para iterar sobre los cambios. El agente reutiliza los archivos e imágenes compartidos previamente en el hilo como contexto para solicitudes de seguimiento, así que no tienes que volver a subirlos.
...
- **Con archivos adjuntos**: Sube imágenes, diagramas, archivos de código u otros documentos junto con tu mensaje. El agente los procesa automáticamente y los incluye en tu documentación. En un hilo, el agente también tiene acceso a las imágenes y archivos compartidos en mensajes anteriores, por lo que puedes hacer referencia a ellos en solicitudes de seguimiento sin tener que volver a subirlos.
