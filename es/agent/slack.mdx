...
<Tip>
  Si instalas la aplicación de Slack, pero cierras el dashboard antes de terminar la conexión, el agente te envía un mensaje directo en Slack con un botón **Connect to Mintlify**. Haz clic en el botón para volver al dashboard y terminar de vincular tu espacio de trabajo. El aviso solo se envía a la persona que instaló la aplicación y se envía una sola vez por espacio de trabajo.
</Tip>
