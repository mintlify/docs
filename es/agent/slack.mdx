...
### Conexión con un clic desde el DM de bienvenida

Cuando instalas la app de Slack de Mintlify por primera vez, el agente te envía un mensaje directo de bienvenida. Si tu organización tiene el agente habilitado, el mensaje incluye botones **Connect** de un solo clic para las integraciones más comunes:
...
1. Abre el mensaje directo del agente en Slack.
2. Haz clic en el botón **Connect** del servicio que quieras añadir.
3. En el modal, haz clic en el enlace de autorización, inicia sesión en el servicio de terceros y aprueba los permisos solicitados.
...
Los botones solo aparecen para los servicios que aún no has conectado. Cuando una conexión está activa, su botón deja de mostrarse en los mensajes posteriores.

### Pedirle al agente que conecte cualquier servicio

Para servicios que no estén en la lista de un clic, pídele al agente que configure la integración:
