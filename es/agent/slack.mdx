...
<div id="disconnect-your-slack-workspace">
  ## Desconectar tu espacio de trabajo de Slack
</div>
...
1. Abre el panel del agente en tu dashboard.
2. Haz clic en el botón **Settings**.
3. En la sección de integración con Slack, haz clic en **Disconnect**.
4. Confirma la eliminación cuando se te solicite.

Desconectar elimina la app de Mintlify de tu espacio de trabajo de Slack y desvincula todas las cuentas de usuario conectadas.
