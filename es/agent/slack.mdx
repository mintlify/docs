...
El agente puede leer el código fuente de cualquier repositorio conectado a tu proyecto de Mintlify, incluso si no es tu repositorio de documentación. Esto le permite construir un contexto más profundo para guiar las actualizaciones de la documentación.

- Para GitHub, el agente puede clonar cualquier repositorio donde esté instalada la aplicación de GitHub de Mintlify.
- Para GitLab, el agente puede clonar cualquier proyecto al que tenga acceso la cuenta de GitLab conectada.
...
<Note>
  En deployments conectados a GitLab, el agente permanece vinculado al deployment con el que iniciaste el hilo. Usa un nuevo hilo para cambiar de deployment en lugar de cambiarlo a mitad de la conversación.
</Note>
