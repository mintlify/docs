...
- **Con archivos adjuntos**: Sube imágenes, diagramas, archivos de código u otros documentos junto con tu mensaje. El agente los procesa automáticamente y los incluye en tu documentación. El agente también recoge los archivos e imágenes publicados anteriormente en el mismo hilo desde su última respuesta, de modo que puedes compartir una captura de pantalla primero y luego mencionar `@mintlify` en un mensaje posterior para actuar sobre ella.
