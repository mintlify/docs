...
description: "Añade el agente de Mintlify a Slack para crear actualizaciones de documentación a partir de conversaciones, capturar el conocimiento del equipo y mantener la documentación sincronizada."
