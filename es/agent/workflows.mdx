...
<Note>
Las notificaciones de Slack requieren la aplicación de Slack de Mintlify en el espacio de trabajo de Slack de tu organización. Instala la aplicación de Slack desde tu [dashboard](https://dashboard.mintlify.com/products/agent).
</Note>
