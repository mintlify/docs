...
3. Elige una plantilla de flujo de trabajo para comenzar con configuraciones predefinidas, o selecciona **Custom workflow** para crear uno desde cero.
4. Configura el nombre del flujo de trabajo, el tipo de disparador y la programación.
5. Escribe el prompt del agente con instrucciones sobre qué actualizar.
6. En **Settings**, opcionalmente activa **Additional context repos**, **Auto-merge** o **Slack notifications**.
7. Haz clic en **Create workflow**.
