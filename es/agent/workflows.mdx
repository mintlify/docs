...
<Info>
  Los flujos de trabajo están en beta. Las funciones, la disponibilidad y los precios de los flujos de trabajo están sujetos a cambios.
</Info>
...
Los planes Hobby están limitados a 100 ejecuciones de flujo de trabajo por mes en todos los flujos de trabajo. Las ejecuciones no fallidas dentro de una ventana de 30 días cuentan para este límite. [Actualiza tu plan](https://mintlify.com/pricing) para eliminar el límite mensual.
...
Puedes ejecutar flujos de trabajo basados en cron bajo demanda sin esperar a la siguiente hora programada. Las ejecuciones activadas manualmente cuentan para los límites diario y mensual de ejecuciones.
