...
Modifica o elimina los flujos de trabajo desde la página [Workflows](https://dashboard.mintlify.com/products/workflows) de tu dashboard.
...
**Disparador:** Push a `your-org/your-product` (branch `main`)
...
**Disparador:** Push a `your-org/your-docs` (branch `main`)
