...
<Info>
  Los flujos de trabajo están en beta. Actualmente son gratuitos para todos los planes durante el período beta. Se aplican límites de uso.
</Info>
...
Puedes tener hasta 10 flujos de trabajo activos. Cada flujo de trabajo puede ejecutarse hasta 50 veces al día. Las ejecuciones que fallan no cuentan para este límite.
...
4. En GitHub, revisa y fusiona la solicitud de extracción que agrega el archivo de flujo de trabajo a tu repositorio.
...
El agente se ejecuta en un sandbox aislado con acceso a internet restringido. Al escribir prompts, solo haz referencia a herramientas disponibles para el agente.
...
El agente no puede instalar paquetes ni herramientas adicionales durante la ejecución. Los registros de paquetes y otros servicios externos no son accesibles desde el sandbox.

Los prompts que instruyen al agente a ejecutar herramientas no disponibles pueden producir resultados inesperados o fallar.
