...
<div id="monitor-workflow-runs">
  ## Supervisar ejecuciones de flujos de trabajo
</div>

La página [Flujos de trabajo](https://dashboard.mintlify.com/products/workflows) del dashboard tiene dos pestañas: **Historial de ejecuciones** y **Flujos de trabajo**.

<div id="run-history">
  ### Historial de ejecuciones
</div>

La pestaña **Historial de ejecuciones** es la vista predeterminada. Muestra una lista consolidada de ejecuciones de todos tus flujos de trabajo con las siguientes columnas:

- **Tiempo**: cuándo comenzó y se completó la ejecución.
- **Flujo de trabajo**: nombre del flujo de trabajo y el evento desencadenante, como una solicitud de extracción fusionada.
- **Estado**: el estado actual de la ejecución. Los estados posibles son:
  - **En cola**: la ejecución está esperando para comenzar.
  - **En ejecución**: la ejecución está en progreso.
  - **Revisión necesaria**: la ejecución se completó y abrió una solicitud de extracción que necesita revisión.
  - **PR fusionado**: la solicitud de extracción de la ejecución fue fusionada.
  - **PR cerrado**: la solicitud de extracción de la ejecución fue cerrada sin fusionar.
  - **No se requiere acción**: la ejecución se completó sin abrir una solicitud de extracción.
  - **Fallido**: la ejecución encontró un error.
- **Resumen**: una descripción de lo que hizo la ejecución, con botones de acción para ver la solicitud de extracción, abrir los cambios en el editor o cerrar la solicitud de extracción.

Por defecto, el historial de ejecuciones muestra solo las ejecuciones con solicitudes de extracción abiertas para que puedas enfocarte en los elementos que requieren acción. Activa **Mostrar todas las ejecuciones** para ver todas las ejecuciones históricas, incluyendo solicitudes de extracción fusionadas y cerradas.

Usa el menú desplegable de filtro de flujo de trabajo para mostrar las ejecuciones de un flujo de trabajo específico.

<div id="workflows-tab">
  ### Pestaña flujos de trabajo
</div>

La pestaña **Flujos de trabajo** lista tus flujos de trabajo activos. Haz clic en un flujo de trabajo para ver o editar su configuración.
...
1. Activa **Notify on completion** para habilitar las notificaciones de Slack.
2. Busca y selecciona los canales a los que deseas notificar.
