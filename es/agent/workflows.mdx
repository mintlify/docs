...
Cada flujo de trabajo debe definir un único tipo de disparador.
...
- **Repositorio**: El repositorio en formato `owner/repo`.
...
Usa repositorios de contexto para conceder al agente acceso de lectura a repositorios adicionales cuando se ejecuta el flujo de trabajo. Esto es útil cuando tu prompt requiere revisar código o contenido fuera de tu repositorio de documentación. Puedes especificar hasta cinco repositorios de contexto por flujo de trabajo.
...
Edita o elimina los flujos de trabajo desde la página de [Workflows](https://dashboard.mintlify.com/products/workflows) en tu dashboard.
...
- **Disparador**: En push a `your-org/your-product` (rama main)
- **Contexto**: `your-org/your-docs`
- **Combinación automática**: Desactivada
...
- **Disparador**: En push a `your-org/your-docs` (rama main)
- **Combinación automática**: Desactivada
...
- **Disparador**: Cron `0 9 * * 3` (miércoles a las 9:00 AM UTC)
...
- **Disparador**: Cron `0 9 * * 1` (lunes a las 9:00 AM UTC)
- **Combinación automática**: Desactivada
...
- **Disparador**: Cron `0 9 * * 1` (lunes a las 9:00 AM UTC)
- **Contexto**: `your-org/your-product`
- **Combinación automática**: Desactivada
