...
1. Abre la página [Automations](https://dashboard.mintlify.com/products/automations).
...
Edita, elimina, deshabilita o activa flujos de trabajo desde la página [Automations](https://dashboard.mintlify.com/products/automations) en tu dashboard.
...
1. Ve a la página [Automations](https://dashboard.mintlify.com/products/automations) en tu dashboard.
