...
3. Configura el disparador, el prompt y otras opciones, luego haz clic en **Create workflow**.
4. En GitHub, revisa y fusiona la solicitud de extracción que añade el archivo de flujo de trabajo a tu repositorio.
