...
Simplemente agrega`<AccordionGroup>`alrededor de tus`<Accordion>`componentes existentes.
...
<AccordionGroup>
  ...
  <Accordion title="FAQ with Icon" icon="alien-8bit">
    Consulta la[documentación de Acordeón](/content/components/accordions)para todas las propiedades soportadas.
  </Accordion>
