    ...
    * Capacidad para crear un endpoint de API accesible mediante tokens de acceso de OAuth (opcional, para habilitar funciones de personalización).
    ...
    <Steps>
      ...
      <Step title="Crea tu endpoint de información de usuario (opcional).">
        ...
        * Devuelva datos de usuario en el formato `User`. Consulta [User data format](/es/es/authentication-personalization/personalization-setup#user-data-format) para obtener más información.
    ...
    * Un servicio de backend que pueda crear URL de redirección.
    ...
    <Steps>
      ...
      <Step title="Integra la autenticación de Mintlify en tu flujo de inicio de sesión.">
        ...
        * Crea un JWT que contenga la información del usuario autenticado en el formato `User`. Consulta [User data format](/es/es/authentication-personalization/personalization-setup#user-data-format) para más información.
