...
keywords: ["cómo funciona Mintlify"]
---
...
<div id="organizations-projects-and-sites">
  ## Organizaciones, proyectos y sitios
</div>

Una **organización** es el espacio de trabajo para tu equipo. Contiene a tus miembros, la configuración a nivel de organización y uno o más proyectos.

Un **proyecto** es un sitio de documentación en tu organización. Conecta un repositorio, un directorio de contenido y una rama de despliegue con un sitio publicado. Una organización puede tener varios proyectos para productos o propiedades de documentación distintos.

Un **sitio en vivo** es el resultado publicado de un proyecto. Mintlify proporciona una URL `.mintlify.site` de forma predeterminada. Puedes conectar un [dominio personalizado](/es/customize/custom-domain) para tu sitio. Los sitios incluyen tu contenido, navegación, búsqueda y cualquier función que habilites, como el asistente o el playground de la API.

<Note>
  Los proyectos antes se llamaban despliegues. Algunas APIs y herramientas todavía usan **despliegue** para referirse a un proyecto.
</Note>
...
| [Servidor MCP de administración](/es/ai/mintlify-mcp) | Agentes | Lee y actualiza proyectos mediante herramientas autenticadas | Sí |
