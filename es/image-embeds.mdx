...
<Info>
  Mintlify admite archivos de hasta 5 MB. Para usar archivos más grandes, considera un servicio de almacenamiento como Cloudinary e incrústalos en tu documentación usando la URL.
</Info>
...
<Warning>
  Ya que Mintlify necesita adherirse a la sintaxis JSX, los atributos de doble palabra deberán escribirse en camelCase: autoPlay, playsInline.
</Warning>
