...
<img
  ...
  alt="Fotografía de un paisaje pintoresco con flores moradas en primer plano, montañas al fondo y un cielo azul con nubes dispersas."
/>
</Frame>
...
```mdx
![Alt text describing the image](/es/path/to/image.png)
```
