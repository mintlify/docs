...
Agrega imágenes para aportar contexto visual, ejemplos o decoración a tu documentación.
...
<Tip>
  Incluye siempre texto alternativo descriptivo para mejorar la accesibilidad y el SEO (Search Engine Optimization). El texto alternativo debe describir claramente lo que muestra la imagen.
</Tip>
...
Para tener más control sobre la visualización de imágenes, usa etiquetas `<img>` en HTML:
...
Para deshabilitar el zoom predeterminado al hacer clic en las imágenes, agrega la propiedad `noZoom`:
...
<Note>
  Las imágenes dentro de etiquetas de enlace muestran automáticamente un cursor de puntero para indicar que son clicables.
</Note>
...
<Tip>
  Incluye siempre texto alternativo dentro de los elementos de vídeo para los navegadores que no admiten la reproducción de vídeo.
</Tip>
