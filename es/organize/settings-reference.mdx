...
Modo de navegación heredado por todos los grupos descendientes. Establece en `"tree"` para mostrar un árbol de navegación en las páginas raíz de los grupos con las páginas secundarias y los grupos anidados. Se puede sobrescribir a nivel de grupo, pestaña o ancla. Por defecto `"auto"`.
