...
Establece el modo de navegación predeterminado para todos los grupos. Cuando se establece en `"tree"`, los grupos con una página `root` muestran un árbol de navegación en la página raíz. Heredado por todos los grupos descendientes a menos que se anule.

**Tipo:** `"auto"` | `"tree"` — por defecto `"auto"`
