...
**Tipo:** array of `"assistant"` | `"copy"` | `"view"` | `"download-spec"` | `"chatgpt"` | `"claude"` | `"perplexity"` | `"grok"` | `"aistudio"` | `"devin"` | `"windsurf"` | `"mcp"` | `"add-mcp"` | `"cursor"` | `"vscode"` | `"devin-mcp"` | object

Usa `"download-spec"` para agregar una opción de Descarga que obtenga la especificación de OpenAPI del deployment. Si hay varias especificaciones configuradas, se incluyen en `api-specs.zip` en el navegador.
