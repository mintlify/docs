...
Diseño de directorio para páginas raíz de grupo. Cuando se establece en `"accordion"` o `"card"`, los grupos con una página `root` muestran un listado de directorio de sus páginas secundarias. Establece en `"none"` para deshabilitar. Se hereda recursivamente a través de la jerarquía de navegación; los descendientes pueden sobreescribirlo.

**Tipo:** `"none"` | `"accordion"` | `"card"`
**Predeterminado:** `"none"`
