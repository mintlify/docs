...
| `integrations.customScripts` | array of object | No | Scripts de terceros personalizados a cargar. Máximo 20. |
| `integrations.customScripts[].src` | string (HTTPS uri) | Sí | URL HTTPS del script. No debe terminar en `.svg`, `.exe` o `.zip`. |
