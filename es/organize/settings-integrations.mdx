...
<ResponseField name="integrations.segment" type="object">
  ...
  <Expandable title="integrations.segment">
    ...
    <ResponseField name="cdnUrl" type="string">
      URL de CDN personalizada para cargar el script de Segment, para usar con la [función de dominio personalizado de Segment](https://segment.com/docs/connections/sources/custom-domains/). Debe ser una URL HTTPS sin parámetros de consulta ni fragmentos.
    </ResponseField>
  </Expandable>
</ResponseField>
