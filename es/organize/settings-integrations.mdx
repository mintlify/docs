...
<ResponseField name="integrations.customScripts" type="array of objects">
  Carga scripts externos en tu sitio de documentación. Cada script debe usar una URL HTTPS. Máximo 20 scripts.
  ...
  <Expandable title="integrations.customScripts item">
    ...
    <ResponseField name="strategy" type="string">
      La estrategia de carga del script. `afterInteractive` o `lazyOnload`. Predeterminado: `afterInteractive`.
    </ResponseField>
  </Expandable>
</ResponseField>
