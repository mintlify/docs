...
<ResponseField name="integrations.segment" type="object">
  ...
  <Expandable title="integrations.segment">
    ...
    <ResponseField name="cdnUrl" type="string">
      Una URL de CDN personalizada para cargar el script de Segment. Debe ser una URL HTTPS sin parámetros de consulta ni fragmentos. El valor predeterminado es `https://cdn.segment.com`.
    </ResponseField>
  </Expandable>
</ResponseField>
