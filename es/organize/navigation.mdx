...
Puedes usar cualquier combinación de anclajes, pestañas y menús desplegables. Los componentes pueden anidarse entre sí de forma intercambiable para crear la estructura de navegación que desees.
...
<CodeGroup>
  ...
  ```json Pestañas con anclaje externo
  {
    "navigation": {
      "global": {
        "anchors": [
