...
<ResponseField name="logo" type="string or object">
  ...
  <Expandable title="Logo">
    ...
    <ResponseField name="href" type="string (uri)">
      La URL a la que redirigir al hacer clic en el logo. Si no se proporciona, el logo enlaza a tu página de inicio. Ejemplo: `https://mintlify.com`
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="styling" type="object">
  ...
  <Expandable title="Estilo">
    ...
    <ResponseField name="sidebar" type="object">
      Configuración de estilo de la barra lateral.

      <Expandable title="Sidebar">
        <ResponseField name="items" type="&#x22;container&#x22; | &#x22;card&#x22; | &#x22;border&#x22; | &#x22;undecorated&#x22;">
          Estilo visual para los elementos de navegación de la barra lateral. Elige `container` para elementos agrupados con un fondo sutil, `card` para elementos con estilo de tarjeta elevada, `border` para elementos con un borde sutil, o `undecorated` para un estilo minimalista. El valor predeterminado varía según el tema.
        </ResponseField>
      </Expandable>
    </ResponseField>
    <ResponseField name="topbar" type="object">
      Configuración de estilo de la barra superior.

      <Expandable title="Topbar">
        <ResponseField name="style" type="&#x22;gradient&#x22; | &#x22;default&#x22;">
          Estilo visual para la barra de navegación. Elige `gradient` para un efecto de fondo degradado o `default` para un estilo estándar. El valor predeterminado es `default`.
        </ResponseField>
      </Expandable>
    </ResponseField>
