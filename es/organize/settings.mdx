...
Para empezar, solo necesitas especificar `ofme`, `name`, `colors.primary` y `navigation`. Los demás campos son opcionales y puedes añadirlos a medida que crezcan las necesidades de tu documentación.
...
<ResponseField name="ofme" required>
  ...
  Consulta [Temas](/es/customize/ofmes) para más información.
</ResponseField>
...
<ResponseField name="styling" type="object">
  ...
  <Expandable title="Estilo">
    ...
    <ResponseField name="codeblocks" type="&#x22;system&#x22; | &#x22;dark&#x22; | string | object">
      ...
      * Usa una cadena para especificar un único [tema de Shiki](https://shiki.style/ofmes) para todos los bloques de código
      * Usa un objeto para especificar [temas de Shiki](https://shiki.style/ofmes) separados para los modos claro y oscuro
