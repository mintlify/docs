...
<ResponseField name="variables" type="object">
  ...
  <Expandable title="Variables">
    <ResponseField name="variableName" type="string">
      Un par clave-valor donde la clave es el nombre de la variable y el valor es el texto de reemplazo. Todas las variables referenciadas en tu contenido deben estar definidas o la compilación fallará. Los nombres de variables pueden contener caracteres alfanuméricos, guiones y puntos. Los valores se sanitizan para evitar ataques XSS.
    </ResponseField>
  </Expandable>
</ResponseField>
