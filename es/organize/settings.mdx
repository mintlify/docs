...
<Steps>
  ...
  <Step title="Crear tu archivo docs.json">
    ...
    Este comando crea automáticamente un archivo `docs.json` a partir de tu `mint.json` existente. Revisa el archivo generado para asegurarte de que toda la configuración sea correcta.
  </Step>
