    ...
    <ResponseField name="links" type="array of object">
      ...
      <Expandable title="Links">
        <ResponseField name="type" type="&#x22;github&#x22; | &#x22;discord&#x22;">
          Tipo de enlace opcional. Omítelo para un enlace de texto estándar. Configúralo como `github` para enlazar a un repositorio de GitHub y mostrar el número de estrellas del repositorio. Configúralo como `discord` para enlazar a un servidor de Discord y mostrar el número de usuarios en línea en el servidor.
        </ResponseField>

        <ResponseField name="label" type="string">
          Texto del enlace. Obligatorio cuando `type` no está establecido. Opcional para los tipos `github` y `discord`. Cuando se omite, la etiqueta se completa automáticamente a partir de los datos de la API (nombre del repositorio para GitHub y nombre del servidor para Discord).
        </ResponseField>
