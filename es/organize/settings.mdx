...
<ResponseField name="variables" type="object">
  Variables globales para usar en toda tu documentación. Las variables se reemplazan en tiempo de compilación usando la sintaxis `{{variableName}}`.

  <Expandable title="Variables">
    <ResponseField name="variableName" type="string">
      Un par clave-valor donde la clave es el nombre de la variable y el valor es el texto de reemplazo. Todas las variables referenciadas en tu contenido deben estar definidas o la compilación falla. Los nombres de variables pueden contener caracteres alfanuméricos, guiones y puntos. Los valores se sanitizan para evitar ataques XSS.
    </ResponseField>
  </Expandable>
</ResponseField>
  ...
  <Expandable title="Navigation">
    <ResponseField name="global" type="object">
      ...
      <Expandable title="Global">
        ...
        <ResponseField name="ancla" type="array of object">
    ...
    <ResponseField name="versión" type="array of object">
      ...
      <Expandable title="Versions">
        <ResponseField name="default" type="boolean">
          Establece en `true` para que esta versión sea la predeterminada. Si se omite o es `false`, la primera versión del array será la predeterminada.
        </ResponseField>
