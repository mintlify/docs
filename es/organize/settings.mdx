...
<ResponseField name="variables" type="object">
  Variables globales para usar en toda tu documentación. Las variables usan la sintaxis `{{variableName}}` y se reemplazan en tiempo de compilación.
  ...
  Haz referencia a las variables en tu contenido MDX:
  ...
  Los nombres de variables pueden contener caracteres alfanuméricos, guiones y puntos. Los valores se sanitizan para evitar ataques XSS. Las variables no definidas permanecen como texto literal.
</ResponseField>
