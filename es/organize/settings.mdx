...
<ResponseField name="background" type="object">
  ...
  <Expandable title="Background">
    ...
    <ResponseField name="decoration" type="&#x22;gradient&#x22; | &#x22;grid&#x22; | &#x22;windows&#x22;">
      Estilo de decoración de fondo. Opciones:
      - `gradient`: Un gradiente radial sutil usando tu color primario.
      - `grid`: Un gradiente radial con un patrón de cuadrícula superpuesto.
      - `windows`: Un gradiente radial con un patrón geométrico de ventanas superpuesto.
    </ResponseField>
