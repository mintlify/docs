    ...
    <ResponseField name="links" type="array of object">
      ...
      <Expandable title="Links">
        <ResponseField name="type" type="&#x22;github&#x22; | &#x22;discord&#x22;">
          Tipo de enlace opcional. Omite este campo para un enlace de texto estándar. Establécelo como `github` para enlazar a un repositorio de GitHub y mostrar el recuento de estrellas del repositorio. Establécelo como `discord` para enlazar a un servidor de Discord y mostrar el número de usuarios en línea en el servidor.
        </ResponseField>

        <ResponseField name="label" type="string">
          Texto para el enlace. Obligatorio cuando `type` no está establecido. Opcional para los tipos `github` y `discord`. Cuando se omite, la etiqueta se completa automáticamente a partir de los datos de la API (nombre del repositorio para GitHub y nombre del servidor para Discord).
        </ResponseField>
    ...
    <ResponseField name="primary" type="object">
      ...
      <Expandable title="Primary">
        <ResponseField name="type" type="&#x22;button&#x22; | &#x22;github&#x22; | &#x22;discord&#x22;" required>
          Estilo del botón. Elige `button` para un botón estándar con etiqueta, `github` para un enlace a un repositorio de GitHub con recuento de estrellas en tiempo real o `discord` para una invitación a un servidor de Discord con recuento de usuarios en línea en tiempo real.
        </ResponseField>
