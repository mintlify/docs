...
<ResponseField name="styling" type="object">
  ...
  <Expandable title="Styling">
    <ResponseField name="eyebrows" type="&#x22;section&#x22; | &#x22;breadcrumbs&#x22;">
      Estilo del encabezado superior de la página. Elige `section` para mostrar el nombre de la sección o `breadcrumbs` para mostrar la ruta completa de navegación. El valor predeterminado es `section`.
    </ResponseField>
    ...
    <ResponseField name="codeblocks" type="&#x22;system&#x22; | &#x22;dark&#x22; | string | object">
      ...
      * `"system"`: Hace coincidir el modo actual del sitio (claro u oscuro)
...
<ResponseField name="icons" type="object">
  ...
  <Expandable title="Icons">
    <ResponseField name="library" type="&#x22;fontawesome&#x22; | &#x22;lucide&#x22;" required>
      ...
      <Note>
        Puedes especificar una URL de un icono alojado externamente, la ruta a un archivo de icono en tu proyecto o código SVG compatible con JSX para cualquier icono individual, independientemente de la configuración de la biblioteca.
      </Note>
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="fonts" type="object">
  ...
  <Expandable title="Fonts">
    ...
    <ResponseField name="source" type="string (uri)">
      URL de la fuente, por ejemplo: https://mintlify-assets.b-cdn.net/fonts/Hubot-Sans.woff2. [Google Fonts](https://fonts.google.com) se carga automáticamente cuando especificas un nombre de `family` de Google Fonts, por lo que no se necesita URL de source.
    </ResponseField>
...
<ResponseField name="appearance" type="object">
  ...
  <Expandable title="Appearance">
    <ResponseField name="default" type="&#x22;system&#x22; | &#x22;light&#x22; | &#x22;dark&#x22;">
      Modo de tema predeterminado. Elige `system` para que coincida con la configuración del SO de los usuarios, o `light` o `dark` para forzar un modo específico. El valor predeterminado es `system`.
    </ResponseField>

    <ResponseField name="strict" type="boolean">
      Si se debe ocultar el control de cambio de modo claro/oscuro. El valor predeterminado es `true`.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="navigation" type="object" required>
  ...
  <Expandable title="Navegación">
    <ResponseField name="global" type="object">
      ...
      <Expandable title="Global">
        <ResponseField name="idiomas" type="array of object">
          Configuración del selector de idioma para sitios con varias localizaciones.
          ...
          <Expandable title="Idiomas">
            ...
            <ResponseField name="href" type="string (uri)" required>
              Ruta válida o enlace externo a esta versión en este idioma de tu documentación.
            </ResponseField>
          </Expandable>
        </ResponseField>
        ...
        <ResponseField name="pestañas" type="array of object">
          ...
          <Expandable title="Tabs">
            ...
            <ResponseField name="hidden" type="boolean">
              Indica si se debe ocultar esta Tab de forma predeterminada.
            </ResponseField>
        ...
        <ResponseField name="anclas" type="array of object">
          Enlaces anclados que aparecen de forma destacada en la barra lateral de navegación.
    ...
    <ResponseField name="pestañas" type="array of object">
      Pestañas de navigation de nivel superior [tabs](es/navigation#tabs).
    </ResponseField>
    ...
    <ResponseField name="desplegables" type="array of object">
      [Desplegables](es/navigation#dropdowns) para agrupar contenido relacionado.
    </ResponseField>

    <ResponseField name="productos" type="array of object">
      Selector de producto para sitios con varios [products](es/navigation#products).
    </ResponseField>
