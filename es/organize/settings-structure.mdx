  ...
  <Expandable title="navigation.global">
    ...
    <ResponseField name="languages" type="array of object">
      ...
      <Expandable title="languages">
        <ResponseField name="language" type='"ar" | "ca" | "cn" | "cs" | "da" | "de" | "en" | "es" | "fi" | "fr" | "fr-CA" | "he" | "hi" | "hu" | "id" | "it" | "ja" | "jp" | "ko" | "lv" | "nl" | "no" | "pl" | "pt" | "pt-BR" | "ro" | "ru" | "sv" | "tr" | "uk" | "uz" | "vi" | "zh" | "zh-Hans" | "zh-Hant"' required>
