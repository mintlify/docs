  ...
  <Expandable title="navigation.global">
    <ResponseField name="tabs" type="array of object">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, ruta o enlace de anclaje para el destino de la pestaña. Admite URLs absolutas, rutas relativas que comienzan con `/` y enlaces hash que comienzan con `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="anchors" type="array of object">
      ...
      <Expandable title="anchors">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, ruta o enlace de anclaje para el destino del ancla. Admite URLs absolutas, rutas relativas que comienzan con `/` y enlaces hash que comienzan con `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="dropdowns" type="array of object">
      ...
      <Expandable title="dropdowns">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, ruta o enlace de anclaje para el destino del desplegable. Admite URLs absolutas, rutas relativas que comienzan con `/` y enlaces hash que comienzan con `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="languages" type="array of object">
      ...
      <Expandable title="languages">
        ...
        <ResponseField name="href" type="string (uri)" required>
          Una ruta válida, enlace externo o enlace de anclaje a esta versión de tu documentación. Admite URLs absolutas, rutas relativas que comienzan con `/` y enlaces hash que comienzan con `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="versions" type="array of object">
      ...
      <Expandable title="versions">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, ruta o enlace de anclaje a esta versión de tu documentación. Admite URLs absolutas, rutas relativas que comienzan con `/` y enlaces hash que comienzan con `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
