...
<ResponseField name="navigation.mode" type='"auto" | "tree"'>
  Modo de navegación heredado por todos los grupos descendientes. Establece en `"tree"` para mostrar un [árbol de navegación](/es/organize/navigation#tree-navigation) en las páginas raíz de los grupos. Por defecto `"auto"`. Se puede sobrescribir en grupos, tabs o anchors individuales.
</ResponseField>
