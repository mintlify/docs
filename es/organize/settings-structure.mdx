...
<ResponseField name="navbar.links" type="array of object">
  ...
  <Expandable title="navbar.links">
    ...
    <ResponseField name="href" type="string (uri)" required>
      Destino del enlace. Acepta una URL absoluta o una ruta relativa que empiece por `/`, como `/quickstart`. Para `github`, debe ser una URL de repositorio de GitHub. Para `discord`, debe ser una URL de invitación de Discord.
    </ResponseField>
    <IconsOptional />
  </Expandable>
</ResponseField>
...
<ResponseField name="navbar.primary" type="object">
  ...
  <Expandable title="navbar.primary">
    ...
    <ResponseField name="href" type="string (uri)" required>
      Destino del botón. Acepta una URL absoluta o una ruta relativa que empiece por `/`, como `/contact`. Para `github`, debe ser una URL de repositorio de GitHub. Para `discord`, debe ser una URL de invitación de Discord.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="contextual.options" type="array" required>
  ...
  - `"download-spec"`—Descarga las especificaciones de OpenAPI del proyecto (un solo archivo, o comprimidas en zip si hay varias)
