    ...
    <ResponseField name="tabs" type="array of object">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="searchable" type="boolean">
          Cuando `hidden` es `true`, establece `searchable: true` para mantener las páginas descendientes en la búsqueda, el sitemap, `llms.txt` y el assistant de IA. Consulta [Páginas ocultas](/es/organize/hidden-pages#keep-hidden-pages-discoverable-with-searchable).
        </ResponseField>
