...
<ResponseField name="navigation.directory" type="string" default="none">
  Diseño de directorio para páginas raíz de grupo. Establece en `"accordion"` o `"card"` para mostrar un listado de páginas secundarias en las páginas raíz de grupo. Establece en `"none"` para deshabilitar. Se hereda recursivamente; los descendientes pueden sobreescribirlo. Consulta [Listados de directorio](/es/organize/navigation#directory-listings) para más información.
</ResponseField>
