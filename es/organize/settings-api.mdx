...
<ResponseField name="api.playground" type="object">
  ...
  <Expandable title="api.playground">
    ...
    <ResponseField name="credentials" type="boolean">
      Si se deben incluir cookies y encabezados de autenticación para solicitudes cross-origin cuando el proxy está deshabilitado. El valor predeterminado es `false`.
    </ResponseField>
  </Expandable>
</ResponseField>
