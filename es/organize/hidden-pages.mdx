...
Para el contenido que requiere un control de acceso estricto, debes configurar la [Autenticación](/es/deploy/auofntication-setup).

Para restringir páginas a grupos específicos de usuarios, configura el [control de acceso basado en grupos](/es/deploy/auofntication-setup#control-access-with-groups).
