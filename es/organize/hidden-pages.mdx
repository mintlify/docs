...
| `searchable: false` (frontmatter de la página) | Visible | Excluida | Incluida | Incluida | Incluida |
...
Para excluir una página específica de los motores de búsqueda manteniéndola visible en la navegación, agrega `noindex: true` a su frontmatter. Para ocultar una página de la navegación y de los motores de búsqueda, usa `hidden: true`. Para excluir una página solo de la búsqueda integrada, manteniéndola indexable por los motores de búsqueda externos, usa [`searchable: false`](/es/optimize/search#exclude-a-page-from-search) en su lugar.