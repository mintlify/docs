...
<ResponseField name="searchable" type="boolean">
  Establécelo en `false` para excluir la página de los resultados de búsqueda del sitio de documentación y del contexto del asistente de IA, manteniéndola indexable por motores de búsqueda externos y listada en el sitemap. La página sigue visible en la navegación. Consulta [Excluir una página de la búsqueda](/es/optimize/search#exclude-a-page-from-search) para más detalles.
</ResponseField>
