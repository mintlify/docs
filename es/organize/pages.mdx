...
Muestra una marca de tiempo «Última modificación el [fecha]» en todas las páginas activando `metadata.timestamp` en tu [configuración global](/es/organize/settings#metadata).
