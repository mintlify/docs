...
<ResponseField name="noindex" type="boolean">
  Establécelo en `true` para excluir la página de la búsqueda del sitio, los sitemaps, la indexación en motores de búsqueda y el contexto del asistente de IA. La página sigue visible en la navegación. Consulta [Deshabilitar la indexación](/es/optimize/seo#disable-indexing) para más detalles. Todas las páginas con `hidden: true` en su frontmatter reciben `noindex: true` automáticamente.
</ResponseField>
