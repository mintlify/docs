...
Para usar el modo Asistente, debes habilitar el [asistente](/es/assistant) en tu proyecto. Si no habilitas el asistente, el modo de página del asistente muestra un campo de búsqueda deshabilitado.
...
2. En proyectos respaldados por GitHub o GitLab, la fecha del último commit de Git que modificó el archivo de origen de la página.
