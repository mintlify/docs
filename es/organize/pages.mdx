...
<ResponseField name="searchable" type="boolean">
  Establécelo en `false` para excluir la página de los resultados de búsqueda del sitio de documentación y del contexto del asistente de IA. La página sigue indexable por los motores de búsqueda externos, listada en el sitemap y visible en la navegación. Consulta [Excluir una página de la búsqueda](/es/optimize/search#exclude-a-page-from-search) para más detalles.
</ResponseField>
