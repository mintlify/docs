...
<ResponseField name="groups" type="string[]">
  Restringe la página a usuarios de grupos específicos. Los usuarios deben pertenecer a al menos uno de los grupos indicados para acceder a la página. Se debe configurar la [autenticación](/es/deploy/authentication-setup). Consulta [Controlar el acceso con grupos](/es/deploy/authentication-setup#control-access-with-groups) para más información.
</ResponseField>
