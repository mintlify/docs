...
description: "Resuelve errores 500 y la lentitud de la navegación causados por Cloudflare al bloquear recursos de Mintlify"
---

Si tu sitio de documentación muestra errores 500 tras unos segundos o experimenta lentitud en la navegación, es posible que el firewall de Cloudflare esté bloqueando las solicitudes a los recursos de Mintlify.
