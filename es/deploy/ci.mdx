...
Al igual que el [verificador de enlaces de la CLI](/es/create/broken-links#broken-links) en tu máquina local, la comprobación de CI de enlaces rotos busca automáticamente en el contenido de tu documentación enlaces internos que no funcionan.
