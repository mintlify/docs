...
Configura las comprobaciones de CI habilitadas para una implementación desde la página de [General](https://app.mintlify.com/settings/project/general) de tu dashboard. Activa las comprobaciones que quieras ejecutar.
