...
Configura las comprobaciones de CI habilitadas para un proyecto desde la página de [General](https://app.mintlify.com/settings/project/general) de tu dashboard. Activa las comprobaciones que quieras ejecutar.
...
Si tienes un archivo `.vale.ini` en el directorio raíz de contenido de tu proyecto, la verificación de Vale CI usa ese archivo de configuración y cualquier archivo de configuración en el `StylesPath` que especifiques.
