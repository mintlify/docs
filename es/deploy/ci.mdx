...
<Warning>
  No coloques `{/* vale off */}` ni comentarios de expresión MDX similares como hijos directos de un componente JSX entre elementos hermanos. Por ejemplo, entre dos elementos `<Step>` dentro de un componente `<Steps>`.
