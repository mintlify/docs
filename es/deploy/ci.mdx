...
Configura las comprobaciones de CI habilitadas para una implementación desde la página de [Add-ons](https://app.mintlify.com/products/addons) de tu dashboard. Activa las comprobaciones que quieras ejecutar.
