...
description: "Automatiza la detección de enlaces rotos, el linting y la validación gramatical en CI/CD."
---
...
Usa las verificaciones de CI para aplicar linting a tu documentación, detectar errores y mostrar advertencias antes de la implementación. Las verificaciones de CI de Mintlify se ejecutan en solicitudes de extracción contra una rama de implementación configurada.
