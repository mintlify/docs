...
description: "Agrega comprobaciones de enlaces rotos, linting y gramática al proceso de actualización"
---
...
Usa las verificaciones de CI para revisar tu documentación en busca de errores y mostrar advertencias antes de la implementación. Las verificaciones de CI de Mintlify se ejecutan en solicitudes de extracción contra una rama de implementación configurada.
