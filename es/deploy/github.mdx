---
title: "GitHub"
description: "Conecta tu repositorio de GitHub a Mintlify para despliegues automatizados, compilaciones de vista previa de pull requests y sincronización continua de la documentación."
...
<Tip>
  **¿Necesitas la Aplicación de GitHub?**
  ...
  Consulta tu repositorio en la página [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) de tu dashboard.
</Tip>
...
<AccordionGroup>
  <Accordion title="Clonar con un clic (recomendado)">
    ...
    5. Opcionalmente, instala la Aplicación de GitHub de Mintlify para despliegues automáticos.
  </Accordion>
...
Instala la Aplicación de GitHub de Mintlify desde tu [dashboard](https://app.mintlify.com/settings/organization/github-app).
...
Cambia la organización, el repositorio o la branch desde la que se compila tu documentación en la sección [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) de tu dashboard.
...
<AccordionGroup>
  <Accordion title="Verificar la instalación de la Aplicación de GitHub">
    ...
    1. Ve a la [configuración de la Aplicación de GitHub](https://app.mintlify.com/settings/organization/github-app) en tu dashboard.
  ...
  <Accordion title="Comprobar la rama de implementación">
    ...
    1. Ve a [Git Settings](https://app.mintlify.com/settings/deployment/git-settings)
...
<Steps>
  ...
  <Step title="Reinstala la aplicación de Mintlify.">
    1. En tu Dashboard de Mintlify, ve a [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) e instala la Aplicación de GitHub.
    2. Autoriza tu cuenta en la sección [My Profile](https://app.mintlify.com/settings/account) de tu dashboard.
  </Step>
</Steps>
