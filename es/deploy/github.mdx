...
Instala la Aplicación de GitHub de Mintlify en la página [Git settings](https://app.mintlify.com/settings/deployment/git-settings) de tu dashboard. Cuando GitHub te pregunte a qué repositorios quieres dar acceso, elige **Only select repositories** y selecciona tu repositorio de documentación.
...
<AccordionGroup>
  <Accordion title="Verificar la instalación de la Aplicación de GitHub">
    ...
    1. Ve a la página [Git settings](https://app.mintlify.com/settings/deployment/git-settings) de tu dashboard.
