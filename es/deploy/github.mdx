...
Como la aplicación solo ve los repositorios en los que está instalada, no puede compilar implementaciones de vista previa para pull requests abiertas desde un fork. Consulta [Pull requests desde forks](/es/deploy/preview-deployments#fork-pull-requests) para conocer la solución alternativa.
