...
Si omitiste conectar tu propio repositorio de Git durante la configuración inicial, tu documentación se encuentra en la organización `mintlify-community`. Para moverla a tu propia cuenta u organización:
