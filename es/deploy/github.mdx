...
3. Instala la Aplicación de GitHub siguiendo los pasos en [Install These GitHub App](#install-These-github-app) a continuación.
...
6. Instala la Aplicación de GitHub siguiendo los pasos en [Instalar la Aplicación de GitHub](#install-These-github-app) más abajo.
