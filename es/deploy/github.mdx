...
<div id="alternative-download-and-create-your-own-repository">
  ### Alternativa: Descargar y crear tu propio repositorio
</div>

Si quieres un repositorio privado sin otorgar permisos elevados de OAuth, puedes transferir tu documentación manualmente:
...
6. Instala la Aplicación de GitHub siguiendo los pasos en [Instalar la Aplicación de GitHub](#install-the-github-app) más abajo.
...
Las funciones de comentarios para sugerir ediciones y crear issues solo están disponibles para repositorios públicos de GitHub. Si estas opciones están deshabilitadas en tu dashboard, comprueba la visibilidad de tu repositorio.
