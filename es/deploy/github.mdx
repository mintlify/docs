---
title: "GitHub"
description: "Conecta tu repositorio de GitHub a Mintlify para despliegues automatizados, vistas previas de pull requests y sincronización continua de la documentación."
...
Las funciones de comentarios de sugerencias de edición y de creación de issues solo están disponibles para repositorios públicos de GitHub. Si estas opciones no están disponibles en tu dashboard, verifica la visibilidad de tu repositorio.
