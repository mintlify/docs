...
<Tip>
  **¿Necesitas la Aplicación de GitHub?**
  ...
  Consulta tu repositorio en la página [Git Settings](https://app.mintlify.com/settings/project/git-settings) de tu dashboard.
</Tip>
...
Cambia la organización, el repositorio o la branch desde la que se compila tu documentación en la sección [Git Settings](https://app.mintlify.com/settings/project/git-settings) de tu dashboard.
...
<AccordionGroup>
  ...
  <Accordion title="Comprobar la rama de implementación">
    ...
    1. Ve a [Git Settings](https://app.mintlify.com/settings/project/git-settings)
...
<Steps>
  ...
  <Step title="Reinstala la aplicación de Mintlify.">
    1. En tu Dashboard de Mintlify, ve a [Git Settings](https://app.mintlify.com/settings/project/git-settings) e instala la Aplicación de GitHub.
