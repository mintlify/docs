...
<Note>
  Las configuraciones de proxy inverso solo son compatibles con los [planes Custom](https://mintlify.com/pricing?ref=reverse-proxy).
</Note>

Para servir tu documentación a través de un proxy inverso personalizado, debes configurar reglas de enrutamiento, políticas de caché y el reenvío de encabezados.
