...
description: "Configura la autenticación de usuarios en tu sitio para controlar el acceso a páginas y referencias de API. Haz que las páginas sean privadas para tu organización de Mintlify, o utiliza autenticación por contraseña, OAuth o JWT."
