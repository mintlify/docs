...
| [Mapa del sitio](/es/optimize/seo#sitemaps-and-robotstxt-files) | Compatibilidad completa | Disponible tras autenticación, pero excluye las páginas en groups                                                | De acceso público. Los visitantes anónimos solo ven las páginas públicas. Los usuarios autenticados también ven las páginas sin grupo. |
| [robots.txt](/es/optimize/seo#sitemaps-and-robotstxt-files)     | Compatibilidad completa | Disponible tras autenticación                                                                                    | De acceso público cuando existen páginas públicas                                                                |