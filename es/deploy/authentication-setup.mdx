...
description: "Configura la autenticación de usuarios para controlar el acceso a páginas y API con contraseña, OAuth, JWT o acceso privado gestionado por Mintlify."
