  ...
  <Tab title="JWT">
    ...
    * Un servicio de backend que pueda crear URL de redirección.
    ...
    <div id="offer-multiple-login-urls">
      ### Ofrecer varias URL de inicio de sesión
    </div>
    ...
    Varias URL de inicio de sesión solo se aplican a la autenticación JWT de todo el sitio. La [personalización](/es/create/personalization) JWT acepta un único `loginUrl`.
