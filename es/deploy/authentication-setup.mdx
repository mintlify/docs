...
description: "Configura la autenticación de usuarios con OAuth, JWT, contraseña o enlaces compartidos para controlar el acceso a páginas y referencias de API."
