...
Mintlify admite `sourceRef` dentro de `anchors`, `tabs`, `groups`, `pages`, `products` y los arreglos bajo `navigation.global`. Otras estructuras de navegación, incluidas las entradas de `menu` dentro de una pestaña, no aceptan `sourceRef`.
