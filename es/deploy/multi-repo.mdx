...
Puedes eliminar una fuente de repositorio desde la [página de configuración de Git](https://app.mintlify.com/settings/project/git-settings) en tu panel. Cuando solo queda una fuente de repositorio, Mintlify elimina la ruta de URL de la fuente y trata el repositorio restante como la fuente raíz de la implementación.
