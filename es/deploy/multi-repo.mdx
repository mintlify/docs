...
<Steps>
  ...
  <Step title="Configurar la fuente del repositorio">
    ...
    Para fuentes de GitHub, la aplicación de GitHub de Mintlify debe tener acceso al repositorio. Para fuentes de GitLab, proporciona el ID del proyecto y un token de despliegue con el alcance `read_repository`. Para fuentes de Bitbucket, conecta tu cuenta de Bitbucket mediante OAuth y habilita el repositorio. Consulta [Bitbucket](/es/deploy/bitbucket) para ver las instrucciones de configuración.
