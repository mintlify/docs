...
Cuando abras [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) por primera vez, un asistente de configuración te guiará a través de la conexión de tu repositorio de GitLab.

<Steps>
  <Step title="Selecciona GitLab como tu proveedor">
    En la página [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings), selecciona **Connect to GitLab** y haz clic en **Continue**.
  </Step>
  <Step title="Descarga tu contenido">
    ...
    Si tu documentación está alojada por Mintlify, descárgala como un archivo zip.
  ...
  <Step title="Encuentra tu Project ID">
  ...
  <Step title="Conecta tu repositorio">
    ...
    - **GitLab instance URL**: Déjalo vacío para `gitlab.com`, o ingresa la URL de tu instancia autoalojada (por ejemplo, `https://gitlab.your-domain.com`). Tu instancia debe ser accesible públicamente para que Mintlify pueda conectarse.
    - **Project ID**: El ID de proyecto de la configuración de tu proyecto de GitLab.
...
Para modificar la configuración de tu conexión de GitLab después de la configuración inicial, ve a [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) y actualiza tu Project ID, token de acceso, rama o URL de instancia directamente.
