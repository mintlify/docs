...
Usamos tokens de acceso y webhooks para autenticar y sincronizar cambios entre GitLab y Mintlify. Esto funciona tanto con GitLab.com como con instancias de GitLab auto-hospedadas.
...
<Steps>
  ...
  <Step title="Set up the connection">
    ...
    2. Si usas una instancia de GitLab auto-hospedada, ingresa la URL de tu host de GitLab (por ejemplo, `https://gitlab.example.com`). La URL debe usar HTTPS.
    3. Completa cualquier otra configuración obligatoria.
    4. Haz clic en **Guardar cambios**.

    Mintlify valida tu access token y el acceso al repositorio cuando guardas, para que puedas confirmar que tu conexión funciona de inmediato.
    <Frame>
