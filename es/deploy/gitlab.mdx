...
<Steps>
  ...
  <Step title="Set up the connection">
    ...
    3. Si usas una instancia de GitLab autoalojada, activa el toggle **Set up as self-hosted** e ingresa la URL del host de tu instancia de GitLab (por ejemplo, `https://gitlab.your-domain.com`). Tu instancia debe ser accesible públicamente para que Mintlify pueda conectarse.
