...
<Steps>
  ...
  <Step title="Set up the connection">
    ...
    2. Selecciona tu rama de despliegue.
    3. Si tus docs no están en la raíz de tu repositorio, habilita **Set up as monorepo** e ingresa la ruta al directorio que contiene tu `docs.json`.
    4. Si usas una instancia de GitLab autoalojada, habilita **Set up as self-hosted** e ingresa la URL de tu host de GitLab (por ejemplo, `https://gitlab.example.com`).
