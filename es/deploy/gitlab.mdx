...
keywords: ["Integración con GitLab", "tokens de acceso", "vistas previas de merge request", "autohospedado", "instancia"]
---
...
<Steps>
  ...
  <Step title="Set up the connection">
    ...
    3. Si usas una instancia autohospedada de GitLab, activa el toggle **Set up as self-hosted** e ingresa la URL del host de tu instancia de GitLab (por ejemplo, `https://gitlab.tu-dominio.com`). Tu instancia debe ser accesible públicamente para que Mintlify pueda conectarse.
