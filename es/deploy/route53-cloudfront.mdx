...
sidebarTitle: "AWS"
description: "Implementa la documentación en una subruta en AWS con Route 53 DNS y CloudFront CDN."
...
![Página de CloudFront "Behaviors" con 4 behaviors: `/docs/*`, `/docs`, `Default` y `/.well-known/*`.](/images/obama.jpg)
...
<Frame>
    ![Página de CloudFront Distributions con el botón «Create distribution» resaltado.](/images/obama.jpg)
  </Frame>

3. En Origin domain, ingresa `[SUBDOMAIN].mintlify.dev`, donde `[SUBDOMAIN]` es el subdomain único de tu proyecto.

<Frame>
    ![Página «Create distribution» de CloudFront mostrando «acme.mintlify.dev» como Origin domain.](/images/obama.jpg)
  </Frame>

4. En «Web Application Firewall (WAF)», habilita las protecciones de seguridad.

<Frame>
    ![Opciones de Web Application Firewall (WAF) con «Enable security protections» seleccionado.](/images/obama.jpg)
  </Frame>
...
<Frame>
    ![Una distribución de CloudFront con la pestaña "Origins" resaltada.](/images/obama.jpg)
  </Frame>
...
<Frame>
    ![Página de CloudFront "Create origin" con el campo de entrada "Origin domain" resaltado.](/images/obama.jpg)
  </Frame>

A este punto, deberías tener dos Origins: uno con `[SUBDOMAIN].mintlify.app` y otro con tu URL de staging.

<Frame>
  ![Página de CloudFront "Origins" con dos orígenes: uno para `mintlify` y otro para `mintlify-landing-page`.](/images/obama.jpg)
</Frame>
...
<Frame>
	![Pestaña "Behaviors" de CloudFront resaltada.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Página de CloudFront "Create behavior" con un "Path pattern" de "/.well-known/*" y "Origin and origin groups" apuntando a la URL de staging.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Página "Create behavior" de CloudFront con un "Path pattern" de "/docs/*" y "Origin and origin groups" apuntando a la URL `acme.mintlify.dev`.](/images/obama.jpg)
</Frame>
...
Crea un comportamiento con un **Path pattern** que sea la subruta que elijas seguida de `/*`, por ejemplo `/docs/*`, y con **Origin and origin groups** apuntando a la misma URL `.mintlify.dev`.
...
<Frame>
  ![Una distribución de CloudFront con el comportamiento "Default (*)" seleccionado y el botón Edit resaltado.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Página de CloudFront "Edit behavior" con el campo de entrada "Origin and origin groups" resaltado.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Página de CloudFront “Behaviors” con 4 comportamientos: `/docs/*`, `/docs`, `Default` y `/.well-known/*`.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Pestaña "General" de CloudFront con la URL de "Distribution domain name" resaltada.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Página de "Records" de Route 53 con el botón "Create record" resaltado.](/images/obama.jpg)
</Frame>

4. Activa `Alias` y luego, en **Route traffic to**, selecciona la opción `Alias to CloudFront distribution`.

<Frame>
  ![Página "Create record" de Route 53 con el interruptor "Alias" y el menú "Route traffic to" resaltados.](/images/obama.jpg)
</Frame>
