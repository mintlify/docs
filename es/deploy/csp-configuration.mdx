...
description: "Configura los encabezados CSP para permitir los recursos de Mintlify manteniendo la seguridad en proxies inversos, reglas de firewall y redes que aplican políticas de seguridad estrictas."
...
<Note>
  Incluye solo los dominios de los servicios que usas. Elimina cualquier dominio de Analytics que no hayas configurado para tu documentación.
</Note>
