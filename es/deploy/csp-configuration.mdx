...
description: "Configura encabezados de Content Security Policy para permitir los recursos de Mintlify manteniendo la seguridad para proxies inversos y políticas de red estrictas."
