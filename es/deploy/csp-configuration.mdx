...
description: "Configura los encabezados CSP para permitir los recursos de Mintlify en proxies inversos, reglas de cortafuegos y redes que aplican políticas de seguridad estrictas."
