...
description: "Configura los encabezados CSP para permitir los recursos de Mintlify y mantener la seguridad en proxies inversos, cortafuegos y redes que aplican políticas estrictas."
