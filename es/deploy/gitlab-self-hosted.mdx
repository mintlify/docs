...
<div id="inbound-mintlify-to-your-gitlab-instance">
  ### Entrante: de Mintlify a tu instancia de GitLab
</div>

Mintlify se conecta a tu instancia de GitLab mediante HTTPS (puerto 443) para intercambiar tokens de OAuth, llamar a la API de GitLab, clonar repositorios y enviar commits. Estas conexiones se originan desde la dirección IP de salida estática de Mintlify: `54.242.90.151`.

Si un firewall o una lista de IP permitidas restringe el acceso a tu instancia de GitLab, permite HTTPS entrante (puerto 443) desde `54.242.90.151`.

<div id="outbound-your-gitlab-instance-to-mintlify">
