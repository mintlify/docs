...
- Una organización de Mintlify en el **plan Pro o superior**. Registrar credenciales OAuth e iniciar el flujo de autorización en planes Hobby o de prueba devuelve un error 403. Las organizaciones que ya tenían una instalación de GitLab autoalojado antes de este requisito siguen funcionando y pueden volver a autorizar con normalidad.
