...
<Update label="December 2024">
  ...
  Haga que los documentos sean privados configurando la autenticación mediante JWT, OAuth o una contraseña universal. Con esta privacidad, puede crear una base de conocimientos interna o evitar que los competidores vean sus documentos.
</Update>
...
<Update label="November 2024">
  ...
  Ahora puede localizar sus documentos, lo que funciona de manera similar al versionado. Agregue un `locale` a una versión y el contenido fijo en Mintlify como "¿Fue útil esta página?" también coincidirá con el idioma local.
...
<Update label="October 2024">
  ...
  Ahora puede resaltar líneas de código en sus documentos para enfatizar y llamar la atención sobre partes importantes agregando un comentario especial después del identificador del lenguaje. Use llaves `{}` y especifique números de línea o rangos separados por comas.
  ...
  Ahora puede personalizar los mensajes para el chat de IA. Por favor, contacte con [soporte](mailto:sales@mintlify.com) si desea personalizar los mensajes.
  ...
  * Se corrigió la aparición emergente del CSS personalizado en la documentación.
...
<Update label="September 2024">
  ...
  Añade una `img` propiedad a una tarjeta para mostrar una imagen en la parte superior de la tarjeta. Aprende más sobre esto [aquí](/content/components/cards#image-card).
  ...
  Hemos corregido el diseño móvil y de escritorio de nuestra documentación para que sea más amigable con el SEO - incluyendo la adición de etiquetas aria apropiadas a elementos de la barra de navegación y alternadores.
  ...
  * **Solución de problemas para páginas API**: Las páginas API pueden ser complicadas, así que hemos listado problemas comunes para ayudarte a resolverlos rápidamente —
    [Leer la documentación](/api-playground/troubleshooting)
</Update>
...
<Update label="August 2024">
  ...
  * Ahora mostramos
  ...
  Por defecto, las solicitudes de API playground son proxy a través de Mintlify. Ahora puedes usar
  `disableProxy` para deshabilitar este comportamiento y soportar tipos de solicitudes como cargas de archivos.

  * [Aprende más sobre configuraciones de API](/settings/global#api-configurations)

  ## Mejoras de SEO móvil

  Hemos corregido el diseño móvil de nuestra documentación para que sea más amigable con el SEO - incluyendo la adición de etiquetas aria apropiadas a los elementos.

  ## Formulario de Soporte

  Hemos añadido un formulario de soporte más detallado al panel de control de Mintlify. Ahora puedes enviar un formulario para contactarnos.
...
<Update label="June 2024">
  ...
  * Temas: Personaliza tu estilo con temas preconfigurados. Solo añade el tema Quill, Prism, o Venus a tu `mint.json` archivo y actualizará el estilo de tu documentación.
  * Búsqueda V2: consulta directamente descripciones y títulos de endpoints OpenAPI para llegar a páginas de Referencia API, elimina páginas ocultas de la búsqueda y disfruta de nuestra interfaz de búsqueda actualizada.
  * Ramificación del Editor Web: crea ramas en nuestro editor web sin necesidad de un IDE.
  * Personalización de Usuario: autentica usuarios con Sesión Compartida o JWT para que puedas mostrarles contenido personalizado, como prellenado de claves API o mostrar contenido específico para clientes.
  * Mejoras en la Automatización de OpenAPI: para auto-completar páginas de API Playground, puedes agregar un `openapi` campo a un objeto en los arrays de tabs o anchors en el mint.json.
</Update>
...
<Update label="May 2024">
  ...
  Actualiza programáticamente tu documentación.
</Update>
...
<Update label="April 2024">
  ...
  * Agregar videos o galerías de imágenes a pantalla completa
  * Incrustar elementos de demostración iFrame personalizados para agregar interactividad a tus documentos

  Consulta nuestra [documentación de Modo Personalizado](/page#custom-mode).
</Update>
...
<Update label="February 2024">
  ...
  * Mejoras en el Panel: ver registros de actualizaciones para ver qué ha cambiado y el estado de una actualización, alternar entre proyectos de Mintlify para gestionar despliegues
...
<Update label="January 2024">
  ...
  * Despliegues de Vista Previa: Cuando creas una solicitud de extracción, generaremos un enlace único que muestra una vista previa en vivo de cómo se verán tus documentos en producción. Puedes compartir este enlace con compañeros de equipo.
  * Snippets V2: Ahora soportamos componentes completamente reutilizables y variables para fragmentos.
  ...
  * Perspectivas del Chat IA: Segmenta el historial de chat por fecha y aumenta la cuota de Chat IA desde el panel, y ve con qué frecuencia aparece una consulta específica.
</Update>
