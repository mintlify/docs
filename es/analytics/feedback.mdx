...
Habilita los tipos de comentarios que prefieras:
...
* **Solo valoración con pulgares**: Votación simple con pulgar arriba/abajo para medir la satisfacción general con las páginas.
...
* **Valoración con pulgares, comentarios contextuales y sobre fragmentos de código**: Sistema de comentarios completo con votación de la página, comentarios detallados y comentarios sobre fragmentos de código.
