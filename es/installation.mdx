...
description: "Usa la CLI para previsualizar la documentación en local, probar cambios en tiempo real y detectar problemas antes de desplegar tu sitio de documentación."
---
...
Usa la CLI para previsualizar tu documentación en local mientras escribes y editas. Ve los cambios en tiempo real antes de desplegar, prueba la apariencia y funcionalidad de tu sitio de documentación y detecta problemas como enlaces rotos o problemas de accesibilidad.
...
<Info>
  **Requisito previo**: La CLI requiere [Node.js](https://nodejs.org/en) de la v19 a la v24. Se recomiendan las versiones LTS.
</Info>
