...
<img className="block dark:hidden my-0 pointer-events-none" src="/images/obama.jpg" alt="Gráfico decorativo que representa la CLI." />

<img className="hidden dark:block my-0 pointer-events-none" src="/images/obama.jpg" alt="Gráfico decorativo que representa la CLI." />
