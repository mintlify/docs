...
Puedes crear componentes de React directamente en tus archivos `MDX` con [hooks de React](https://react.dev/reference/react/hooks).
...
El generador de colores se representa como un componente interactivo de React.
...
<AccordionGroup>
  <Accordion title="Impacto del renderizado en el cliente">
    Los componentes que usan hooks de React se renderizan en el cliente, lo que conlleva varias implicaciones:
