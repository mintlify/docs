...
<Steps>
  <Step title="Configura Okta SSO en tu Dashboard de Mintlify">
    1. En tu Dashboard de Mintlify, navega a la página de [Single Sign-On](https://app.mintlify.com/settings/organization/sso).
...
<Steps>
  <Step title="Configurar Microsoft Entra SSO en el Dashboard de Mintlify">
    1. En el Dashboard de Mintlify, navega a la página de [Single Sign-On](https://app.mintlify.com/settings/organization/sso).
...
Para habilitar el aprovisionamiento JIT, debes tener SSO habilitado. Ve a la página de [Single Sign-On](https://app.mintlify.com/settings/organization/sso) en tu dashboard, configura el SSO y luego habilita el aprovisionamiento JIT.
