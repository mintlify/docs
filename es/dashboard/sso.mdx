...
2. Confirma que el SSO funcione de extremo a extremo.
...
<Steps>
  <Step title="Create an application">
    En Okta, en **Applications**, crea una nueva integración de aplicación con OIDC. Elige el tipo **Web Application**.
  </Step>
