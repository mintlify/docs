...
Para habilitar el aprovisionamiento JIT, debes tener SSO habilitado. Ve a la página [Security](https://app.mintlify.com/settings/organization/access) en tu dashboard, configura el SSO y luego habilita el aprovisionamiento JIT.
...
Puedes añadir hasta 25 dominios verificados por organización.

La sección **Verified domains** solo aparece cuando tu conexión SSO está activa. [Configura SSO](#configure-sso) antes de añadir dominios.

1. Ve a la página [Security](https://app.mintlify.com/settings/organization/access) en tu dashboard.
2. En la sección **SSO**, en **Verified domains**, introduce el dominio (por ejemplo, `example.com`) y haz clic en **Add**.
...
Para exigir que todos los miembros de tu organización inicien sesión a través de tu proveedor de identidad, activa **Require SSO**. Cuando **Require SSO** está activado, Mintlify rechaza los inicios de sesión con contraseña, enlace mágico y Google OAuth.
...
3. En la sección **SSO**, activa **Require SSO**.
...
1. Ve a la página [Security](https://app.mintlify.com/settings/organization/access) en tu dashboard.
2. En la sección **SSO**, en **Break-glass emails**, introduce la dirección de correo electrónico de un miembro que deba conservar el acceso sin SSO y haz clic en **Add**.
