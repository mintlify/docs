...
<div id="recover-from-a-lockout">
  ### Recuperarse de un bloqueo
</div>

Si todos los administradores quedan bloqueados fuera del dashboard debido a la lista de IP permitidas, ponte en contacto con [support@mintlify.com](mailto:support@mintlify.com) desde una dirección de correo electrónico asociada a tu organización. Incluye el nombre de tu organización y la dirección IP que necesitas añadir. El equipo de soporte de Mintlify puede añadir una dirección o desactivar la lista de IP permitidas para que puedas recuperar el acceso.
