...
description: "Restringe el acceso al dashboard de Mintlify a direcciones IP de confianza y controla durante cuánto tiempo permanecen válidas las sesiones del dashboard con tiempos de inactividad y duraciones máximas de sesión."
