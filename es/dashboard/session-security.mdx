...
description: "Configura los tiempos de espera de sesión del dashboard, la duración máxima de la sesión y una lista de IP permitidas para aplicar políticas más estrictas de autenticación y acceso a la red."
