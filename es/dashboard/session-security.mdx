...
Para revisar o cambiar las duraciones de sesión, ve a la sección **Policies** de la página [Security](https://app.mintlify.com/settings/organization/access) en tu dashboard.
...
Para configurar la lista de permitidas, ve a la sección **Policies** de la página [Security](https://app.mintlify.com/settings/organization/access) en tu dashboard.
