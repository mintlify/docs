...
description: "Aprovisiona, desaprovisiona y asigna roles automáticamente a los miembros del dashboard de Mintlify desde Okta u otro proveedor de identidad SCIM 2.0."
...
El endpoint SCIM de Mintlify funciona con cualquier proveedor de identidad compatible con SCIM 2.0 que se autentique mediante bearer token. Las instrucciones paso a paso que aparecen a continuación cubren Okta. Para otros proveedores, [contáctanos](mailto:support@mintlify.com) para obtener orientación sobre la configuración.
...
<Steps>
  <Step title="Abrir la configuración de SCIM">
    En tu Dashboard de Mintlify, navega a la sección **SCIM** de la página [Security](https://app.mintlify.com/settings/organization/access).
  </Step>
...
1. En el Dashboard de Mintlify, navega a la sección **SCIM** de la página [Security](https://app.mintlify.com/settings/organization/access).
...
1. Navega a la sección **SCIM** de la página [Security](https://app.mintlify.com/settings/organization/access).
