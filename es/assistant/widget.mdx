...
Usa `filter` para restringir lo que el asistente recupera cuando tu documentación está organizada por idioma o [versiones](/organize/navigation#versions). Omite un campo para buscar en todos sus valores.
...
`language` debe ser un [código de idioma admitido](/organize/settings-reference#navigation-global-languages), como `en`, `es`, `fr` o `zh-Hans`. `version` coincide con el nombre de la versión configurada en tu panel.
...
| Option     | Type             | Description                                                                                                                                                    |
| ---------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `language` | string or `null` | Restringe la recuperación a un [código de idioma admitido](/organize/settings-reference#navigation-global-languages), como `en`. Omítelo para buscar en todos los idiomas. |
