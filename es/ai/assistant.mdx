...
Estos métodos abren un panel de chat en el lado derecho de tu documentación. Los usuarios pueden hacer cualquier pregunta y el assistant buscará en tu documentación una respuesta. Si no se encuentra información relevante, el assistant indicará que no puede responder la pregunta.
