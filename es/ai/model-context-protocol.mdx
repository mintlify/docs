...
Después de que Mintlify procesa los archivos, determina qué páginas se indexarán para la búsqueda. De forma predeterminada, solo las páginas incluidas en la navigation de tu `docs.json` se indexan y se pueden buscar a través de tu servidor MCP.
...
---
title: "Página oculta"
description: "Esta página no está en la navegación, pero está disponible mediante búsqueda."
noindex: true
---
```
