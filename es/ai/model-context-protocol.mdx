...
<Tabs>
  <Tab title="Menú contextual">
    Agrega opciones en el [menú contextual](/es/es/ai/contextual-menu) para que tus usuarios se conecten a tu servidor MCP desde cualquier página de tu documentación.
