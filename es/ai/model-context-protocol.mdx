...
<Steps>
  ...
  <Step title="Agregar dominios personalizados">
    Para herramientas de IA que no están listadas como clientes predefinidos, agrega sus dominios de redirección en la sección **Custom Domains**. Ingresa el nombre de host del dominio de redirección (por ejemplo, `example.com`). Las herramientas de IA de tus usuarios no pueden completar la autenticación a menos que su dominio de redirección esté en esta lista.
