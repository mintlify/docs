...
En la documentación que requiere autenticación, tu servidor MCP solo indexa las páginas de [grupos de usuarios públicos](/es/deploy/authentication-setup#make-pages-public).
