...
Si tu documentación tiene autenticación parcial con páginas públicas y protegidas, dispones de dos endpoints de servidor MCP:

- `/mcp`: No requiere autenticación. Devuelve solo contenido público. Comparte este endpoint con los usuarios que necesitan acceso al contenido público.
- `/authed/mcp`: Siempre requiere autenticación. Devuelve contenido limitado a los permisos de cada usuario según sus [grupos de usuarios](/es/deploy/authentication-setup). Comparte este endpoint con los usuarios que necesitan acceso al contenido protegido.
