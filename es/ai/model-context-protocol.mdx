...
* Para la documentación con autenticación parcial, donde algunas páginas son públicas y otras están protegidas, debes habilitar tu servidor MCP antes de que esté disponible para los usuarios. Los usuarios no autenticados pueden buscar en el contenido público. Los usuarios que se autentican pueden buscar en todo el contenido al que tienen permiso de acceso según sus [grupos de usuarios](/es/deploy/authentication-setup).
