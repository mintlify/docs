...
<Frame>
  <img src="/images/obama.jpg" alt="Página del servidor MCP en el dashboard." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Página del servidor MCP en el dashboard." className="hidden dark:block" />
</Frame>
