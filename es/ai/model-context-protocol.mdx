...
Puedes ver y copiar la URL de tu servidor Search MCP en la [página del servidor MCP](https://dashboard.mintlify.com/products/mcp) de tu dashboard.
...
<Tabs>
  ...
  <Tab title="Codex">
    <Steps>
      <Step title="Obtén la URL de tu servidor MCP">
        Ve a tu [dashboard](https://app.mintlify.com/products/mcp) y encuentra la URL de tu servidor MCP.
      </Step>
