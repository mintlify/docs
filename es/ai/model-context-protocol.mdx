...
<Steps>
  ...
  <Step title="Agregar dominios de redirección">
    ...
    De forma predeterminada, los dominios de redirección utilizan HTTPS. Para permitir un protocolo personalizado, incluye el esquema URI completo en la entrada. Por ejemplo, una aplicación nativa que gestiona las devoluciones de llamada OAuth con un esquema de URL personalizado se puede permitir agregando `myapp://callback.example.com` como dominio de redirección.
  </Step>
</Steps>
