...
description: "Conecta tu documentación y los endpoints de tu API con herramientas de IA mediante un servidor MCP hospedado."
keywords: ["mcp"]
---
...
Si tienes un [plan Pro o Custom](https://mintlify.com/pricing?ref=mcp), puedes exponer endpoints de tu especificación OpenAPI como herramientas MCP.

Para exponer endpoints como herramientas MCP, usa el objeto `mcp` dentro de la extensión `x-mint` a nivel de archivo o de endpoint. Por ejemplo, el servidor MCP de Mintlify incluye herramientas para crear chats del assistant, obtener actualizaciones de estado y desencadenar actualizaciones.
