...
Cuando un servidor MCP está conectado a una herramienta de IA, el LLM puede decidir usar tu herramienta de búsqueda en la documentación durante la generación de la respuesta.
