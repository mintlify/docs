...
### Filtrado de endpoints de API con OpenAPI

Si tu documentación incluye una especificación OpenAPI, todas las operaciones de la API se exponen como herramientas MCP por defecto. Puedes controlar qué operaciones están disponibles y personalizar sus nombres y descripciones usando la extensión [`x-mint: mcp`](/api-playground/openapi-setup#mcp) en tu especificación OpenAPI.
