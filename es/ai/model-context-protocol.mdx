...
- `/mcp`: No requiere autenticación. Solo devuelve contenido público. Compártelo con los usuarios que necesiten acceso al contenido público.
- `/authed/mcp`: Siempre requiere autenticación. Devuelve contenido limitado a los permisos de cada usuario según sus [grupos de usuarios](/es/deploy/authentication-setup). Compártelo con los usuarios que necesiten acceso al contenido protegido.
