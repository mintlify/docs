...
Cuando una herramienta de IA tiene conectado tu servidor MCP de documentación, la herramienta de IA puede buscar directamente en tu documentación en lugar de realizar una búsqueda genérica en la web en respuesta al mensaje de un usuario. Tu servidor MCP proporciona acceso a todo el contenido indexado de tu sitio de documentación.
...
* Cada llamada a la herramienta ocurre durante el proceso de generación, por lo que el LLM busca información actualizada de tu documentación para generar su respuesta.
