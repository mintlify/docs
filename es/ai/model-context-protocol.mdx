...
<Steps>
  ...
  <Step title="Agregar dominios de redirección">
    ...
    Cuando agregas un nombre de host sin protocolo como `claude.ai`, se usa HTTPS por defecto. Para permitir un protocolo personalizado, incluye la URL completa con el protocolo, por ejemplo `custom-app://callback.example.com`. Esto es útil para herramientas de IA nativas o de escritorio que utilizan esquemas de URL personalizados para callbacks de OAuth.
