...
Tu servidor MCP proporciona la siguiente herramienta que los agentes pueden usar:
...
Los agentes invocan esta herramienta cuando el contexto de la conversación indica que buscar en tu documentación ayudaría a responder la pregunta del usuario.
