...
Mintlify genera automáticamente un servidor MCP para tu documentación y lo aloja en la ruta `/mcp` de la URL de tu documentación. Por ejemplo, el servidor MCP de Mintlify está disponible en `https://mintlify.com/docs/mcp`.
...
Para documentación que requiere autenticación, tu servidor MCP solo indexa las páginas en [grupos de usuarios públicos](/es/deploy/authentication-setup#make-pages-public).
