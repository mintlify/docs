...
<Steps>
  ...
  <Step title="Agregar dominios de redirección">
    ...
    De forma predeterminada, los dominios de redirección utilizan `https://`. Para permitir un esquema de protocolo personalizado (por ejemplo, un callback de aplicación nativa como `myapp://`), incluya el protocolo completo en la entrada del dominio (por ejemplo, `myapp://callback`). Los protocolos peligrosos como `javascript:`, `data:` y `file:` siempre están bloqueados.
