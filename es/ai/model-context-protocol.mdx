...
<Tip>
  ¿Quieres permitir que los agentes editen tu contenido en lugar de solo leerlo? Consulta el [servidor MCP de Mintlify](/es/ai/mintlify-mcp) para acceder a un servidor MCP autenticado que expone herramientas de branching, edición de páginas, navegación y `docs.json` a agentes de confianza.
</Tip>
