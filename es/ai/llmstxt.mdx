...
<Note>
  Si tu sitio requiere autenticación para acceder a tu documentación, tus archivos `llms.txt` y `llms-full.txt` no estarán disponibles para los LLM ni las herramientas de IA. Los LLM y las herramientas de IA solo pueden indexar contenido que sea públicamente accesible.
</Note>
