...
<Note>
  Si tu sitio requiere Autenticación para acceder a tu documentación, los archivos `llms.txt` y `llms-full.txt` no están disponibles para los LLM ni para las herramientas de IA. Los LLM y las herramientas de IA solo pueden indexar contenido públicamente accesible.
</Note>
