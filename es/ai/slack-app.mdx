...
La aplicación de Slack añade un bot a tu espacio de trabajo que puede buscar en tu documentación y responder a las preguntas de los usuarios. El bot responde a mensajes directos, @menciones y a cualquier pregunta en un canal específicamente llamado `#ask-ai`. El nombre del bot es `@yourprojectname-assistant`. Así, si el nombre de tu proyecto es Mintlify, el bot se llamará `@mintlify-assistant`.

La aplicación de Slack puede generar costos: ya sea consumiendo tus créditos del Asistente de IA o generando cargos por excedente.
