...
La aplicación de Slack agrega un bot a tu espacio de trabajo de Slack que puede buscar en tu documentación y responder las preguntas de los usuarios. El bot responde a mensajes directos, a menciones con @ y a cualquier pregunta en un canal específicamente llamado `#ask-ai`. El nombre del bot es `@yourprojectname-assistant`. Así, si el nombre de tu proyecto es Mintlify, el nombre del bot será `@mintlify-assistant`.

La aplicación de Slack puede generar costos: ya sea consumiendo tus créditos del Asistente de IA o incurriendo en cargos por exceso.
