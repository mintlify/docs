...
description: "Agrega un menú contextual a tu documentación con integraciones de IA con un clic para herramientas como ChatGPT, Claude, Perplexity y herramientas MCP."
keywords: ["Herramientas de IA", "ChatGPT", "Claude", "Perplexity", "MCP", "Grok", "Cursor", "vscode", "vs code"]
---
...
| **Preguntar a assistant**                          | `assistant`   | Abre el [assistant](/es/ai/assistant) con la página actual como contexto                 |
...
Por defecto, el menú contextual aparece en el encabezado de la página. Puedes configurarlo para que se muestre en la barra lateral del índice de contenidos utilizando la opción `display`.
...
| `toc` | Muestra las opciones en la barra lateral del índice de contenidos |
