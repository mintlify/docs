---
title: "Menú contextual: integraciones de IA y acciones de copia"
description: "Agrega un menú contextual con integraciones de IA en un clic para ChatGPT, Claude, Perplexity, Google AI Studio, Devin y herramientas MCP."
