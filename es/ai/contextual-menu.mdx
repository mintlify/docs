...
| **Descargar especificación de OpenAPI**            | `download-spec` | Descarga la especificación de OpenAPI del deployment. Si hay varias especificaciones configuradas, se incluyen en `api-specs.zip` |
