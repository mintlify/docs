...
1. En la tarjeta de Discord, haz clic en **Configure**. Se abrirá Discord.
   <Frame>
     <img src="/images/obama.jpg" alt="La sección Connected apps de la página del assistant." className="block dark:hidden" />
     <img src="/images/obama.jpg" alt="La sección Connected apps de la página del assistant." className="hidden dark:block" />
   </Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="El panel de configuración de Discord en modo claro." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="El panel de configuración de Discord en modo oscuro." className="hidden dark:block" />
</Frame>
