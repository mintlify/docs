...
<Note>
  `skill.md` está pensado para agentes y LLM de terceros (por ejemplo, ChatGPT, Claude o agentes personalizados conectados a través de [MCP](/es/ai/model-context-protocol)). El asistente de IA de Mintlify que se ejecuta dentro de tu sitio de documentación utiliza directamente el contenido de tu documentación y no depende de `skill.md`.
</Note>
