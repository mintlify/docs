...
- **No eres admin.** Cambiar este ajuste requiere el [rol de admin](/es/dashboard/roles) en tu proyecto. Los editores y visualizadores ven el interruptor deshabilitado con un banner de permisos.
