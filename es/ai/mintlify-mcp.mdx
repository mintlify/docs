...
<Note>
  El servidor Admin MCP permite que las herramientas de IA accedan a tu panel de Mintlify. Trátalo como un compañero de trabajo con acceso de escritura. Conéctalo solo desde herramientas de IA de confianza y revisa cada pull request antes de fusionarla.
</Note>
...
| **Endpoint** | `https://mcp.mintlify.com` | `/mcp` en el dominio de tu sitio | `https://index.mintlify.com/mcp` |
