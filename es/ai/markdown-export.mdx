...
Envía una solicitud con `Accept: text/markdown` o `Accept: text/plain` a cualquier URL de página para recibir la versión Markdown en lugar de HTML. Esto es útil para herramientas de IA e integraciones que obtienen contenido de documentación de forma programática.
