...
Habilita la personalización en la página [General](https://app.mintlify.com/settings/project/general) de tu dashboard. La personalización es mutuamente excluyente con la autenticación completa. La autenticación con JWT y OAuth incluye las funciones de personalización.

1. Ve a la página [General](https://app.mintlify.com/settings/project/general) de tu dashboard.
