...
description: "Muestra contenido personalizado según los datos de autenticación del usuario, los grupos y variables personalizadas para adaptar la documentación."
