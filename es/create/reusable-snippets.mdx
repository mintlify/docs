...
Cada archivo resuelve sus propias importaciones. Las importaciones declaradas en una página no se aplican al contenido de los snippets que la página importa, por lo que un snippet anidado que dependa de una importación a nivel de página puede renderizarse como contenido vacío.
