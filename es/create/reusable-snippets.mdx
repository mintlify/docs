...
También puedes referenciar variables de fragmento dentro de bloques de código. Usa la misma sintaxis `{variableName}` en el cuerpo de un bloque de código delimitado. Al renderizar la página, Mintlify reemplaza cada marcador con el valor de la propiedad correspondiente y deja sin cambios los marcadores que no coincidan.
