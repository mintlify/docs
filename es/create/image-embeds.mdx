...
<div id="resize-images">
  #### Cambiar el tamaño de las imágenes
</div>

Usa clases de [Tailwind CSS](/es/customize/custom-scripts#style-with-tailwind-css) para cambiar el tamaño de las imágenes. Cuando ninguna clase utilitaria cubra el tamaño que necesitas, usa un valor arbitrario como `w-[450px]`:
...
Evita la propiedad `style` para definir el tamaño. Puede provocar un cambio en el diseño al cargar la página.
