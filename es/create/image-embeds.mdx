...
Para convertir una imagen en un enlace clicable, envuélvela en una etiqueta de ancla y añade la propiedad `noZoom`:
...
<Note>
  Las imágenes dentro de etiquetas de anclaje muestran automáticamente un cursor de puntero para indicar que se puede hacer clic en ellas.
</Note>
