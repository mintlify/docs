...
description: "Publica actualizaciones del producto en tu documentación con un feed RSS al que los usuarios pueden suscribirse"
---

Crea un registro de cambios para tu documentación agregando [componentes de actualización](/es/components/update) a una página.
