...
<Frame>
  <img src="/images/obama.jpg" alt="Página de cambios con la tabla de contenidos mostrada en modo claro." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Página de cambios con la tabla de contenidos mostrada en modo oscuro." className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="Registro de cambios en modo claro con el filtro de etiqueta Peppermint seleccionado." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Registro de cambios en modo oscuro con el filtro de etiqueta Peppermint seleccionado." className="hidden dark:block" />
</Frame>
...
Las entradas del feed RSS contienen únicamente Markdown puro. Los componentes, el código y los elementos HTML se excluyen. Usa la propiedad `rss` para proporcionar descripciones de texto alternativas para los suscriptores del RSS cuando tus actualizaciones incluyan contenido que queda excluido.
...
<Frame>
  <img src="/images/obama.jpg" alt="Página de cambios en modo claro con el botón RSS habilitado." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Página de cambios en modo oscuro con el botón RSS habilitado." className="hidden dark:block" />
</Frame>
