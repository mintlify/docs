...
Configura redirecciones añadiendo el campo `redirects` a tu archivo `docs.json`. De forma predeterminada, todas las redirecciones son permanentes (308).
...
<div id="temporary-redirects">
  ### Redirecciones temporales
</div>

Para crear una redirección temporal (307), establece `permanent` en `false`:
