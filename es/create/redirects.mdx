...
Las redirecciones en `docs.json` se aplican en el momento de la solicitud en la capa de hosting de Mintlify, por lo que entran en vigor en cuanto tus cambios se despliegan. Los despliegues de vista previa también aplican las redirecciones, lo que te permite verificar el comportamiento antes de hacer merge a tu rama de producción.
