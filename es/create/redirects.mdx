---
title: "Redirecciones"
description: "Configura redirecciones de URL en docs.json para páginas de documentación movidas, renombradas o eliminadas con el fin de preservar el posicionamiento SEO y evitar enlaces rotos."
keywords: ["redirects"]
---
...
Para verificar también que los destinos de las redirecciones apuntan a páginas válidas, usa la bandera `--check-redirects`:
