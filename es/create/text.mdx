...
Ofrecemos compatibilidad con LaTeX para representar expresiones y ecuaciones matemáticas. Puedes anular la detección automática configurando `styles.latex` en `docs.json` en tus [ajustes](/es/organize/settings#param-latex).
...
- Usa texto descriptivo para los enlaces en lugar de «haz clic aquí» o «leer más»
- Usa rutas relativas desde la raíz para los enlaces internos
