...
<Tip>
  Para mostrar varios bloques de código juntos como un conjunto de pestañas (como hacen los ejemplos de esta página), envuélvelos en el componente [`CodeGroup`](/es/components/code-groups). El título de cada bloque de código se convierte en la etiqueta de su pestaña.
</Tip>
...
Mintlify usa [Shiki](https://shiki.style/) para el resaltado de sintaxis y admite todos los lenguajes disponibles. Consulta la lista completa de [lenguajes](https://shiki.style/languages) en la documentación de Shiki.
