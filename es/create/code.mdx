...
Especifica el lenguaje de programación para el resaltado de sintaxis y para habilitar opciones meta. Agrega cualquier opción meta, como icon, después del lenguaje.
...
Para crear diferencias, añade estos comentarios especiales al final de las líneas en tu bloque de código:
