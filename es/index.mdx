...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Inicio rápido" description="Despliega tu primer sitio de documentación en minutos con nuestra guía paso a paso" href="/es/es/quickstart" />

      <HeroCard filename="cli" title="Instalación de la CLI" description="Instala la CLI para previsualizar y desarrollar tu documentación de forma local" href="/es/es/installation" />

      <HeroCard filename="editor" title="Editor web" description="Haz actualizaciones rápidas y gestiona el contenido con nuestro editor basado en el navegador" href="/es/es/editor" />

      <HeroCard filename="components" title="Componentes" description="Crea documentación rica e interactiva con nuestros componentes listos para usar" href="/es/es/text" />
    </div>
  </div>
</div>