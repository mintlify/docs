---
title: "Introducción"
description: "Conoce la próxima generación de documentación. Nativa en IA, hermosa desde el primer momento y creada para desarrolladores."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Descubre la próxima generación de documentación. Nativa de IA, lista para usar desde el primer momento y creada para desarrolladores.
    </div>
