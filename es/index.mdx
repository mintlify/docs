  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard
        filename="editor"
        title="Editor web"
        description="Realiza actualizaciones rápidas y gestiona el contenido con nuestro editor en el navegador"
        href="/es/editor"
      />
      ...
      <HeroCard
        filename="components"
        title="Componentes"
        description="Crea documentación avanzada e interactiva con nuestros componentes listos para usar"
        href="/es/text"
      />
    </div>
  </div>
