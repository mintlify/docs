---
title: "Introducción"
description: "Descubre la próxima generación de documentación: nativa de IA, hermosa desde el primer momento y creada para desarrolladores."
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard filename="editor" title="Editor web" description="Haz actualizaciones rápidas y gestiona el contenido con nuestro editor basado en navegador" href="/es/editor" />
