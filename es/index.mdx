...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Conoce la próxima generación de documentación. Nativa de IA, hermosa desde el primer momento y creada para desarrolladores y equipos.
    </div>
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard filename="cli" title="Instalación de CLI" description="Instala el CLI para previsualizar y desarrollar tu documentación localmente" href="/es/installation" />

      <HeroCard filename="editor" title="Editor web" description="Realiza actualizaciones rápidas y gestiona contenido con nuestro editor basado en navegador" href="/es/editor" />

      <HeroCard filename="components" title="Componentes" description="Crea documentación rica e interactiva con nuestros componentes listos para usar" href="/text" />
    </div>
  </div>
</div>
