...
Crea [workflows](/es/agent/workflows) para ejecutar el agente de forma programada o ante un push en un repositorio. Cada workflow define un prompt para el agente y un disparador que determina cuándo ejecutarlo.
...
<CardGroup>
  ...
  <Card title="Workflows" icon="message-circle-plus" href="/es/agent/workflows">
    Obtén actualizaciones de documentación de forma automática según una programación o cuando ocurra un evento push.
  </Card>
