...
Crea [flujos de trabajo](/es/agent/workflows) para ejecutar el agente de forma programada o cuando se realice un push a un repositorio. Cada flujo de trabajo define un prompt para el agente y un disparador que indica cuándo ejecutarlo.
...
<CardGroup>
  ...
  <Card title="Workflows" icon="message-circle-plus" href="/es/agent/workflows">
    Obtén actualizaciones de la documentación automáticamente de forma programada o cuando ocurra un evento de push.
  </Card>
