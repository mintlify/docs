...
[Autopilot](/es/ai/autopilot) supervisa los repositorios conectados y sugiere de forma proactiva actualizaciones de la documentación cuando detecta cambios de cara al usuario.
...
<CardGroup cols={2}>
  ...
  <Card title="Autopilot" icon="plane-takeoff" href="/es/ai/autopilot">
