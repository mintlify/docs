...
Crea [flujos de trabajo](/es/workflows) para ejecutar el agente según una programación o cuando se haga un push a un repositorio. Cada flujo de trabajo define una indicación para el agente y un desencadenador que indica cuándo debe ejecutarse.
...
<CardGroup>
  ...
  <Card title="Workflows" icon="message-circle-plus" href="/es/workflows">
