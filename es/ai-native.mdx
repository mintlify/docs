...
Mintlify hospeda los archivos [`llms.txt`](/es/ai/llmstxt), [`llms-full.txt`](/es/ai/llmstxt#llms-full-txt) y [`skill.md`](/es/ai/skillmd) para tu documentación. Estos archivos ayudan a los LLMs a responder de forma eficiente a las consultas de los usuarios con información relevante y proporcionan una lista de capacidades que los agentes pueden usar. Como resultado, los usuarios tienen más éxito con tu producto.
