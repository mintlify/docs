...
Tu sitio se optimiza automáticamente para herramientas de IA y motores de búsqueda, lo que ayuda a los usuarios a descubrir tu documentación. Cada página está disponible como Markdown agregando `.md` al final de la URL o enviando el encabezado `Accept: text/markdown`, lo que permite a las herramientas de IA procesar tu contenido más rápido y consumir menos tokens. Usa el componente [visibility](/es/components/visibility) para adaptar el contenido a cada audiencia.
