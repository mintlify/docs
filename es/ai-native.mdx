...
Puedes configurar el agente para que supervise los repositorios conectados y [sugiera](/es/ai/suggestions) de forma proactiva actualizaciones de la documentación cuando detecte cambios visibles para el usuario.
...
<CardGroup cols={2}>
  ...
  <Card title="Suggestions" icon="message-circle-plus" href="/es/ai/suggestions">
