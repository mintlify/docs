...
<Tip>
  Si tu `robots.txt` personalizado bloquea agentes de usuario de IA como `GPTBot`, `ClaudeBot` o `PerplexityBot`, las herramientas de IA no pueden rastrear tu documentación ni citarla en las respuestas. Consulta [Permitir agentes de IA en robots.txt](/es/guides/geo#allow-ai-agents-in-robotstxt) para más detalles.
</Tip>
