...
Para ocultar todo tu despliegue de los motores de búsqueda manteniéndolo públicamente accesible, activa **Don't index project** en la página [General](https://app.mintlify.com/settings/project/general) de tu panel.
