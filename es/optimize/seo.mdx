...
A continuación encontrarás una lista completa de metaetiquetas que puedes añadir a tu `docs.json`. Estas metaetiquetas ayudan a mejorar el SEO de tu sitio, el alcance en redes sociales y la compatibilidad con los navegadores.

Puedes obtener una vista previa de cómo se mostrarán tus metaetiquetas en diferentes plataformas usando [metatags.io](https://metatags.io/).
...
También puedes especificar `noindex` para todas las páginas de tu documentación configurando el campo `metatags.robots` con `"noindex"` en tu `docs.json`:
