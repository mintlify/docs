---
title: Protocolo de Autenticación JWT
description: Use un flujo de inicio de sesión personalizado para autenticar usuarios
---

<Info>
  Esta es la documentación para el**Autenticación** Protocolo. Los pasos para configurar el[JWT**Personalización** Protocolo](/settings/authentication-personalization/personalization-setup/jwt) son ligeramente diferentes.
</Info>
...
<Steps>
  ...
  <Step title="Create a login flow">
    ...
    * Crear un JWT que contenga la información del usuario autenticado en el formato[Usuario](../sending-data) formato
