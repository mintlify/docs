...
<Info>
  Esta es la documentación para el**Autenticación** Handshake. Los pasos para configurar el[JWT**Personalización** Handshake](/settings/authentication-personalization/personalization-setup/jwt) son ligeramente diferentes.
</Info>
