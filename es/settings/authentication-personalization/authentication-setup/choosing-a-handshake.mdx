...
<Info>
  Esta es la documentación para **Autenticación** métodos de Handshake. La personalización ofrece un [conjunto diferente de métodos de Handshake](/settings/authentication-personalization/personalization-setup/choosing-a-handshake).
</Info>

Antes de que tus usuarios puedan acceder al contenido personalizado, deben estar autenticados. Mintlify admite cuatro métodos de Handshake de Autenticación:

1. **Contraseña**: Configura un conjunto de contraseñas globales para tu sitio de documentación.
...
<Tabs>
  ...
  <Tab title="OAuth 2.0">
    ...
    * Puede crear un nuevo endpoint de API al que se puede acceder con el token de acceso OAuth devuelto.
  </Tab>
...
<Tabs>
  <Tab title="Password">
    ...
    * Se pierden las funciones de personalización, ya que no hay forma de diferenciar usuarios con la misma contraseña
  </Tab>
