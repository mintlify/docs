...
Cuando escribes contenido, puedes usar la variable `user` para acceder a la información que has enviado a tus documentos. Aquí hay un ejemplo simple:
...
Esta función se vuelve aún más poderosa cuando se combina con datos personalizados sobre el usuario. Aquí hay un ejemplo del mundo real que nos permite dar instrucciones específicas sobre cómo acceder a la función Personalization basado en el plan existente del cliente:
