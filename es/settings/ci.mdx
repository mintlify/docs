...
Para comenzar, sigue los pasos en la página de [GitHub](/es/es/settings/github).
...
Al igual que el [verificador de enlaces de la CLI](/es/es/settings/broken-links#broken-links) en tu máquina local, comprobamos automáticamente si tu documentación tiene enlaces rotos.
