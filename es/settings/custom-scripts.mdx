...
El JavaScript personalizado te permite agregar código ejecutable de forma global. Es equivalente a añadir una etiqueta `<script>` con código JavaScript en cada página.
