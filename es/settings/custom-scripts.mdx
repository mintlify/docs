...
<Warning>
  Las referencias y el estilo de los elementos comunes pueden cambiar a medida que la plataforma evolucione. Utiliza estilos personalizados con precaución.
</Warning>
...
El JavaScript personalizado te permite añadir código ejecutable propio de forma global. Es equivalente a insertar una etiqueta `<script>` con código JavaScript en cada página.
