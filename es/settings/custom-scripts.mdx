...
Usa Tailwind CSS v3 para dar estilo a elementos HTML. Puedes controlar el layout, el espaciado, los colores y otras propiedades visuales. Algunas clases comunes son:
...
El JS personalizado te permite añadir código ejecutable propio de forma global. Es equivalente a insertar una etiqueta `<script>` con código JS en cada página.

<div id="adding-custom-javascript">
  ### Añadir JavaScript personalizado
</div>

Cualquier archivo `.js` dentro del directorio de contenido de tu documentación se incluirá en cada página de la documentación. Por ejemplo, puedes añadir el archivo `ga.js` siguiente para habilitar [Google Analytics](https://marketingplatform.google.com/about/analytics) en toda la documentación.
...
<Warning>
  Úsalo con cuidado para no introducir vulnerabilidades de seguridad.
</Warning>
