...
Cualquier archivo `.js` dentro del directorio de contenido de tu documentación se incluirá en todas las páginas. Por ejemplo, puedes añadir el archivo `ga.js` siguiente para habilitar [Analytics](https://marketingplatform.google.com/about/analytics) de Google en toda la documentación.
