...
Para configurar tu documentación en un dominio personalizado, necesitarás establecer tu dominio personalizado deseado en tu configuración de Mintlify y configurar los ajustes DNS en tu proveedor de dominio.
