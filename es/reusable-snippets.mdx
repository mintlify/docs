...
description: 'Fragmentos personalizados y reutilizables para mantener el contenido en sincronía'
icon: 'recycle'
---

Uno de los principios fundamentales del desarrollo de software es DRY (Don&#39;t Repeat Yourself), que también aplica a la documentación. Si te encuentras repitiendo el mismo contenido en varios lugares, crea un fragmento personalizado para mantenerlo en sincronía.
...
1. Opcionalmente, puedes añadir variables que se puedan completar mediante props al importar el snippet. En este ejemplo, nuestra variable es word.
...
1. Exporta un componente JSX desde tu archivo de fragmento. (Consulta [React components](/es/react-components) para obtener más información):
