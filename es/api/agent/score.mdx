...
openapi: /es/agent-score.openapi.json GET /agent/score
...
If you only need to check your own site interactively, run [`mint score`](/es/cli/commands#mint-score) instead.
