...
Si no existe una branch, el agente crea una. Si el agente edita los archivos correctamente, crea automáticamente una solicitud de extracción al finalizar el trabajo.
