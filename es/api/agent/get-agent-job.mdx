...
description: "Obsoleto. Obtén el estado y los detalles de un trabajo específico del agente, incluido el progreso, la información de la branch y los detalles de la solicitud de extracción."
