...
* [List preview deployments](/es/api/preview/list): Lista todos los despliegues de vista previa de un proyecto.
* [Get preview deployment status](/es/api/preview/status): Consulta el estado de construcción de un despliegue de vista previa.
* [Delete preview deployment](/es/api/preview/delete): Elimina un despliegue de vista previa.
...
* **Despliegues de vista previa**: Crea, monitorea y gestiona despliegues de vista previa de forma programática con [Create preview deployment](/es/api/preview/create), [Get preview deployment status](/es/api/preview/status), [List preview deployments](/es/api/preview/list) y [Delete preview deployment](/es/api/preview/delete).
...
Usa la clave de la API de administrador para autenticar solicitudes a [Trigger update](/es/api/update/trigger), [Get update status](/es/api/update/status), [Create preview deployment](/es/api/preview/create), [List preview deployments](/es/api/preview/list), [Get preview deployment status](/es/api/preview/status), [Delete preview deployment](/es/api/preview/delete), [Create agent job](/es/api/agent/v2/create-agent-job), [Get agent job](/es/api/agent/v2/get-agent-job), [Send follow-up message](/es/api/agent/v2/send-message), [Get user feedback](/es/api/analytics/feedback) y [Get assistant conversations](/es/api/analytics/assistant-conversations).
