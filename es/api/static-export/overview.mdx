...
<Steps>
  <Step title="Iniciar un trabajo de exportación estática">
    ...
    Para generar el paquete para una ruta base específica, como `/docs`, pasa `basePath` en el cuerpo de la solicitud. Los enlaces y las URL de los recursos del paquete llevan este prefijo. Si se omite, la exportación usa la ruta base configurada para tu implementación.
