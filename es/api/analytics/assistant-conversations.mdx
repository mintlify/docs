...
- **pageUrl**: URL completa de la página de documentación donde se inició la conversación, o `null` si no se capturó ninguna ruta de página. Usa este campo para atribuir conversaciones a una página específica.