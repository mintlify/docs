...
description: "Mintlify es una plataforma de documentación para desarrolladores e IA, con búsqueda inteligente, playgrounds de API interactivos y analíticas integradas."
...
**Tu sitio**, impulsado por Mintlify. Mintlify construye tu sitio a partir de tu repositorio y lo implementa en una URL `.mintlify.site` de forma predeterminada. Cuando estés listo, puedes asignar un dominio personalizado a tu sitio.
...
El **agent** ayuda a tu equipo a crear y mantener contenido generando actualizaciones a partir de automatizaciones programadas, solicitudes de extracción que se fusionan en tu repositorio de funcionalidades o hilos de Slack.
