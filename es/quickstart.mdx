...
¡Enhorabuena! Has desplegado correctamente tu sitio de documentación con Mintlify. Aquí tienes algunos próximos pasos para mejorar tu documentación:

<Card title="Configura la configuración global" icon="settings" href="es/organize/settings" horizontal>
  Configura el estilo a nivel de sitio, navigation, integrations y más con el archivo `docs.json`.
</Card>
