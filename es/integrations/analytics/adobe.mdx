...
description: "Rastrea el uso de la documentación con Adobe Analytics a través de Adobe Experience Platform Launch."
keywords: ["Adobe Analytics", "Adobe Launch", "Adobe Experience Platform", "site analytics"]
---

Agrega lo siguiente a tu archivo `docs.json` para enviar datos analíticos a Adobe Analytics.
