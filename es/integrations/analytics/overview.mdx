...
description: "Conecta plataformas de Analytics para medir la interacción de los usuarios y el uso de la documentación."
...
<Note>
  Las integraciones de Analytics solo requieren claves de API públicas, que son accesibles para cualquier persona que vea tu sitio de documentación. Tus claves de API privadas, que se emparejan con las claves públicas en los sistemas de los proveedores de Analytics, deben permanecer privadas. No incluyas claves de API privadas en tu `docs.json`.
</Note>
...
| `docs.autopilot.suggestion.no_suggestion` | Cuando el agente determina que no se necesita ninguna actualización de la documentación.                 |
