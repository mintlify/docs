...
Si necesitas verificar si un usuario ya ha dado su consentimiento para las cookies para cumplir con el RGPD, puedes especificar una key de almacenamiento local y su value en `cookies`:
...
Si se establecen estos valores, se comprobará el almacenamiento local para ver si el usuario ha dado su consentimiento para las cookies. Si no lo ha hecho, la telemetría se desactivará.
