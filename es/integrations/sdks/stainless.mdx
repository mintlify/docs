---
title: Stainless
description: Automatiza los fragmentos de ejemplo de tu SDK en el área de pruebas de la API
---

Si utilizas el soporte OpenAPI de Mintlify para la documentación de referencia de tu API, agrega lo siguiente a tu configuración de Stainless:
...
* `secrets.STAINLESS_API_KEY`: Tu clave API de Stainless.
