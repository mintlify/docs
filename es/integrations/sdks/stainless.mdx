...
<Steps>
  ...
  <Step title="Publica la URL de tu especificación de OpenAPI.">
    ...
    <img src="/images/stainless-public-OpenAPI-spec.png" alt="Página de publicación de Stainless con la URL de la especificación de OpenAPI resaltada con un recuadro verde." />
  </Step>
