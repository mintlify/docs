...
Los fragmentos de código autogenerados de los SDK de Speakeasy pueden integrarse directamente en la documentación de referencia de API de Mintlify. Estos fragmentos de uso del SDK se muestran en el [área de pruebas interactiva](/es/es/api-playground/overview) de los sitios de documentación creados con Mintlify.
...
* Un [repositorio de documentación de Mintlify](/es/es/quickstart#creating-the-repository).
