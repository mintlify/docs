...
<Frame>
  ![Captura de pantalla que muestra la entrada del registro de la especificación combinada con la función de copiar URL resaltada con un cuadrado rojo.](/images/speakeasy/copy-combined-spec-url.png)
</Frame>
