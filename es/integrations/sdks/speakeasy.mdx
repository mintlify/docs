...
<Frame>
  ![Un área de pruebas de la API de Mintlify con fragmentos de código de Speakeasy.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Captura de pantalla de la página Speakeasy API Registry. La pestaña API Registry está resaltada con un cuadrado rojo y el número 1, y la entrada de la API está resaltada con un cuadrado rojo y el número 2.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Captura de pantalla que muestra la entrada del registro de la especificación combinada con la función para copiar la URL resaltada con un cuadrado rojo.](/images/obama.jpg)
</Frame>
