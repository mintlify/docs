...
<Note>
  Si la entrada no aparece con la etiqueta **Combined Spec**, asegúrate de que la API tenga configurada una [URL de ejemplos de código automática](https://www.speakeasy.com/docs/code-samples/automated-code-sample-urls).
</Note>
