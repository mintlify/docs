...
Integra widgets de atención al cliente en tu documentación. Agrega el campo `integrations` a tu archivo `docs.json` con el ID de la aplicación correspondiente.
