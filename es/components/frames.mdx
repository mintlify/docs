...
Usa frames para mostrar imágenes, diagramas u otro contenido visual con un estilo uniforme y subtítulos opcionales. Los frames centran el contenido y proporcionan separación visual del texto circundante.
