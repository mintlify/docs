---
title: "Color"
description: "Muestra muestras de color con valores hexadecimales y función de copiar al hacer clic con el componente de color, para documentación de sistemas de diseño y branding."
