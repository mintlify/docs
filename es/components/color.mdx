---
title: "Color"
description: "Muestra muestras de color con valores hexadecimales y copia con un clic mediante el componente color, para sistemas de diseño y branding."
...
<ResponseField name="title" type="string">
  Etiqueta de la fila de colores. Admite [formato Markdown en línea](/es/help-center/format-component-titles-with-markdown) como `**bold**`, `*italic*`, `~~strikethrough~~` y `` `code` ``.
</ResponseField>
