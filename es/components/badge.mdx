---
title: "Insignia"
description: "Usa el componente de insignia para destacar indicadores de estado, etiquetas de versión o metadata en línea con colores personalizables y tooltips al pasar el cursor."
