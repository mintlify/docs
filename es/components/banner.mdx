...
Usa banners para mostrar anuncios, actualizaciones o notificaciones importantes en todo tu sitio de documentación. Los banners aparecen en la parte superior de cada página, admiten formato Markdown y se pueden descartar.
...
<ResponseField name="dismissible" type="boolean">
  Indica si los usuarios pueden descartar el banner. Cuando `true`, los usuarios pueden cerrar el banner y no volverá a aparecer durante su sesión. De forma predeterminada, es `false`.
</ResponseField>