...
Usa banners para mostrar anuncios, actualizaciones o notificaciones importantes en todo tu sitio de documentación. Los banners aparecen en la parte superior de cada página, admiten formato Markdown y puedes hacerlos descartables. Los banners usan el color definido por la propiedad `colors.dark` en tu `docs.json`.
