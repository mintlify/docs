...
<ResponseField name="dismissible" type="boolean">
  Indica si los usuarios pueden descartar el banner. Cuando es `true`, aparece un botón de cierre. Si un usuario descarta el banner, permanece oculto hasta que actualices su contenido. De manera predeterminada, es `false`.
</ResponseField>
