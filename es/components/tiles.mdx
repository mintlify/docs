...
<ResponseField name="title" type="string">
  El título que se muestra debajo de la vista previa de la tarjeta. Admite [formato Markdown en línea](/es/help-center/format-component-titles-with-markdown) como `**bold**`, `*italic*`, `~~strikethrough~~` y `` `code` ``.
</ResponseField>
