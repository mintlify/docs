...
<ResponseField name="title" type="string">
  El título que se muestra debajo de la vista previa de la tarjeta. Admite formato Markdown en línea, como `**bold**`, `_italic_` y `` `code` ``.
</ResponseField>
...
<ResponseField name="className" type="string">
  Clases CSS adicionales para aplicar a la tarjeta.
</ResponseField>
