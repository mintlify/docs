...
<Tile href="/es/components/accordions" title="Accordion" description="Dos variantes">
  <img src="/images/obama.jpg" alt="Vista previa del componente Accordion" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Vista previa del componente Accordion (modo oscuro)" className="hidden dark:block" />
</Tile>
