---
title: "Campos"
description: "Usa los componentes ParamField y ResponseField para documentar parámetros de solicitud y respuesta de la API con tipos, valores por defecto y validación."
...
<ParamField body="className" type="string">
  Clases CSS adicionales que se aplican al campo.
</ParamField>
