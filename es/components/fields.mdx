...
Usa campos para documentar los parámetros y las respuestas de tu API. Hay dos tipos de campos: campos de parámetros y campos de respuestas.
...
<ParamField body="query, path, body, or header" type="string">
  Indica si el parámetro es de tipo query, ruta, cuerpo o encabezado. Seguido del
