...
En dispositivos móviles, los componentes `<RequestExample>` y `<ResponseExample>` se muestran como bloques de código en estilo regular y se pueden omitir al desplazarse.
