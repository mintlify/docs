---
title: "Ejemplos"
description: "Muestra ejemplos de código en el panel lateral derecho en escritorio para mostrar muestras de solicitud y respuesta junto a la documentación de API."
