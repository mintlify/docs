---
title: "MDX"
description: "Usa el componente MDX de Mintlify para renderizar Markdown dentro de expresiones y condicionales JSX: encabezados, código y tablas se compilan normalmente."
