---
title: "MDX"
description: "Usa el componente MDX para renderizar Markdown dentro de expresiones y condicionales JSX: encabezados, bloques de código y tablas se compilan normalmente."
