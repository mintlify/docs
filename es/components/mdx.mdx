---
title: "MDX"
description: "Usa el componente MDX para renderizar Markdown en expresiones y condicionales JSX: encabezados, código y tablas se compilan como el resto de la página."
...
Los encabezados dentro de `<MDX>` aparecen en la tabla de contenido de la página junto con los demás encabezados de la página.

<Note>
  Cuando usas `<MDX>` en un condicional, los encabezados de todas las ramas aparecen en la tabla de contenido, incluidas las ramas que no se renderizan.
</Note>
