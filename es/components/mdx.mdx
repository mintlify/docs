---
title: "MDX"
description: "Usa el componente MDX para renderizar Markdown en expresiones y condicionales JSX: encabezados, bloques de código y tablas compilan como el resto de tu página."
...
<Note>
  Los encabezados dentro de `<MDX>` aparecen en la tabla de contenido de la página. Cuando usas `<MDX>` en un condicional, la tabla de contenido muestra los encabezados de todas las ramas, incluidas las que no se renderizan.
</Note>
