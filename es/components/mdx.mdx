...
<Note>
  Los encabezados dentro de `<MDX>` aparecen en la tabla de contenido de la página en el orden del documento. Esto incluye los encabezados de las ramas condicionales que no se renderizan.
</Note>
