---
title: "Columnas"
description: "Organiza tarjetas y otros componentes en una cuadrícula adaptable multicolumna con el componente columns y recuentos de columnas personalizables."
...
<ResponseField name="className" type="string">
  Clases CSS adicionales para aplicar al contenedor de columnas.
</ResponseField>
