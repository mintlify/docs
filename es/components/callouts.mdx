...
El componente genérico `Callout` admite iconos y colores personalizados. Los avisos con tipo (`Note`, `Warning`, `Info`, `Tip`, `Check`, `Danger`) usan iconos y colores predefinidos y aceptan solo `children` y `className`.
...
<ResponseField name="className" type="string">
  Clases CSS adicionales para aplicar al aviso. Aceptado por el componente genérico `Callout` y por los avisos con tipo.
</ResponseField>
