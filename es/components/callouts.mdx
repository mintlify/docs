...
El componente genérico `Callout` admite iconos y colores personalizados. Los avisos con tipo (`Note`, `Warning`, `Info`, `Tip`, `Check`, `Danger`) usan iconos y colores predefinidos y aceptan `children` y `className`.
...
<ResponseField name="className" type="string">
  Clases CSS adicionales que se aplican al aviso.
</ResponseField>
