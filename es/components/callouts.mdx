---
title: "Avisos"
description: "Usa componentes de aviso para destacar información importante, advertencias y consejos en tu documentación."
...
El componente genérico `Callout` admite iconos y colores personalizados. Los avisos con tipo (`Note`, `Warning`, `Info`, `Tip`, `Check`, `Danger`) usan iconos y colores predefinidos. Todos los tipos de avisos aceptan `className` para estilos personalizados.
...
<ResponseField name="className" type="string">
  Clases CSS adicionales que se aplican al aviso. Disponible en todos los tipos de avisos.
</ResponseField>
