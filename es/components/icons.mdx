---
title: "Iconos"
description: "Añade iconos de Font Awesome, Lucide, Tabler, emoji o fuentes personalizadas a tu documentación con el componente icono y opciones de tamaño y color."
...
Utiliza iconos de Font Awesome, Lucide, Tabler, emoji, SVG (Scalable Vector Graphics), URLs externas o archivos de tu proyecto para mejorar tu documentación.
...
<ResponseField name="color" type="string">
  El color del icon como código hexadecimal (por ejemplo, `#FF5733`). No se aplica a los iconos emoji.
</ResponseField>
...
<ResponseField name="className" type="string">
  Clases CSS adicionales para aplicar al icon.
</ResponseField>