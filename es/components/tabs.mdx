...
<ResponseField name="className" type="string">
  Clases CSS adicionales para aplicar al contenedor de pestañas.
</ResponseField>
...
<ResponseField name="title" type="string" required>
  El título de la pestaña. Los títulos cortos facilitan la navegación. Las pestañas con el mismo título sincronizan sus selecciones. Admite formato Markdown en línea, como `**bold**`, `_italic_` y `` `code` ``.
</ResponseField>
...
<ResponseField name="icon" type="string">
  Un icono de [Font Awesome](https://fontawesome.com/icons), [Lucide](https://lucide.dev/icons) o [Tabler](https://tabler.io/icons), un solo emoji, una URL a un icono o una ruta relativa a un icono.
</ResponseField>
...
<ResponseField name="className" type="string">
  Clases CSS adicionales para aplicar al panel de contenido de la pestaña. Las clases se aplican al panel que contiene el contenido de la pestaña, no a la etiqueta de la pestaña en la barra de pestañas.
</ResponseField>