...
Usa pestañas para organizar el contenido en varios paneles entre los que las personas pueden alternar. Puedes añadir cualquier número de pestañas e incluir otros componentes dentro de cada una.
...
<ResponseField name="title" type="string" required>
  El título de la Tab. Los títulos cortos facilitan la navegación.
</ResponseField>
