...
<Card title="Título de la tarjeta" icon="text-align-start" href="/es/zh/components/columns">
...
<Card title="Título de la tarjeta" icon="text-align-start" href="/es/components/columns">
  Así es como usas una tarjeta con un icono y un enlace. Al hacer clic en esta tarjeta
  accedes a la página de Columnas.
</Card>
```
