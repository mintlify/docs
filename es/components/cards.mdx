...
<Card title="Card title" icon="text" href="/es/es/components/columns">
...
<Card title="Link card" icon="link" href="/es/es/components/columns" arrow="true" cta="Haz clic aquí">
...
Usa el [componente Columns](/es/es/components/columns) para organizar varias tarjetas lado a lado.
