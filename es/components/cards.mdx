...
<ResponseField name="title" type="string">
  El título que se muestra en la tarjeta. Admite [formato Markdown en línea](/es/help-center/format-component-titles-with-markdown) como `**bold**`, `*italic*`, `~~strikethrough~~` y `` `code` ``.
</ResponseField>
