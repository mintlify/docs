...
Usa el componente View para crear contenido que cambia según la vista seleccionada en un menú desplegable multivista. Es especialmente útil para mostrar ejemplos de código o documentación específica para distintos lenguajes de programación o frameworks.
