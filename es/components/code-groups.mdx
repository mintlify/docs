...
Los grupos de código heredan el estilo global de tu archivo `docs.json`. Personaliza tu tema usando `styling.codeblocks`. Consulta [Settings](/es/organize/settings#param-styling) para ver las opciones de configuración.
