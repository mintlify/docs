...
Los grupos de código heredan el estilo global de tu archivo `docs.json`. Personaliza tu tema con `styling.codeblocks`. Consulta [Settings](/es/es/settings#styling) para ver las opciones de configuración.
