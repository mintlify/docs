...
description: "Usa el componente CodeGroup para mostrar varios ejemplos de código en una interfaz con pestañas y comparar implementaciones en distintos lenguajes."
...
<ResponseField name="className" type="string">
  Clases CSS adicionales para aplicar al contenedor del grupo de código.
</ResponseField>
