...
description: "Usa el componente CodeGroup para mostrar múltiples ejemplos de código en una interfaz con pestañas y permitir a los lectores comparar implementaciones en diferentes lenguajes."
