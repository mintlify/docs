...
description: "Usa grupos de código para mostrar múltiples ejemplos de código en una interfaz con pestañas y comparar implementaciones en diferentes lenguajes."
