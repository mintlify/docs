---
title: "Accordions"
description: "Usa el componente accordion para mostrar y ocultar secciones, organizar información relacionada y habilitar la revelación progresiva en tus docs."
...
<ResponseField name="title" type="string" required>
  Título en la vista previa del Accordion. Admite formato Markdown en línea, como `**bold**`, `_italic_` y `` `code` ``.
</ResponseField>
...
<ResponseField name="className" type="string">
  Clases CSS adicionales que se aplican al Accordion. También se aceptan en `AccordionGroup`.
</ResponseField>
