...
<ResponseField name="title" type="string" required>
  Título en la vista previa del Accordion. Admite [formato Markdown en línea](/es/help-center/format-component-titles-with-markdown) como `**bold**`, `*italic*`, `~~strikethrough~~` y `` `code` ``.
</ResponseField>
