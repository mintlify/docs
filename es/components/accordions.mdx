---
title: "Accordions"
description: "Usa Accordions para mostrar y ocultar secciones de contenido, organizar la información y activar la revelación progresiva en tu documentación."
...
<ResponseField name="id" type="string">
  Un ID personalizado para el accordion utilizado para enlaces ancla. Si se omite, utiliza por defecto el mismo valor que `title`.
</ResponseField>
