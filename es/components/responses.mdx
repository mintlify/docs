...
El componente `<ResponseField>` está diseñado para definir los valores de retorno de una API. Muchas docs también usan `<ResponseField>` en páginas cuando necesitas enumerar los tipos de algo.
