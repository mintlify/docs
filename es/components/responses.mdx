...
description: "Documenta los campos de respuesta de la API con información de tipo, descripciones e indicadores de obligatorio/opcional."
keywords: ["salida de la API", "valores de retorno", "estructura de la respuesta"]
---

El componente `<ResponseField>` está diseñado para definir los valores devueltos de una API. Muchos documentos también utilizan `<ResponseField>` en páginas cuando necesitas enumerar los tipos de algo.
