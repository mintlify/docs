...
El componente `<ResponseField>` está diseñado para definir los valores que devuelve una API. Muchos documentos también usan `<ResponseField>` en páginas cuando necesitas enumerar los tipos de algo.
