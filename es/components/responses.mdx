...
El componente `<ResponseField>` está diseñado para definir los valores de retorno de una API. Muchos documentos también utilizan `<ResponseField>` en páginas cuando necesitas enumerar los tipos de algo.
