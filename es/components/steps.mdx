...
<ResponseField name="title" type="string" required>
  El título es el texto principal del paso y aparece junto al indicador. Admite [formato Markdown en línea](/es/help-center/format-component-titles-with-markdown) como `**bold**`, `*italic*`, `~~strikethrough~~` y `` `code` ``.
</ResponseField>
