---
title: "Pasos"
description: "Crea procedimientos numerados paso a paso con el componente steps para guiar a los usuarios en tareas secuenciales, tutoriales y configuraciones."
...
<ResponseField name="className" type="string">
  Clases CSS adicionales que se aplican al contenedor de pasos.
</ResponseField>
...
<ResponseField name="title" type="string" required>
  El título es el texto principal del paso y aparece junto al indicador. Admite formato Markdown en línea, como `**bold**`, `_italic_` y `` `code` ``.
</ResponseField>
...
<ResponseField name="className" type="string">
  Clases CSS adicionales que se aplican al paso.
</ResponseField>