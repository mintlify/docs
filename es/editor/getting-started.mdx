...
* Aprende los conceptos fundamentales de [Git](/es/es/editor/git-concepts).
* Conoce las prácticas recomendadas para colaborar con [ramas](/es/es/editor/branches).
* Explora la [gestión de contenido](/es/es/editor/content-management) con el Editor web.
* Comprende las [opciones de publicación](/es/es/editor/publishing) para distintos escenarios.