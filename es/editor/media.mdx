...
<Frame>
  <img src="/images/obama.jpg" alt="Administrador de recursos seleccionado en el menú de la barra lateral del editor." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Administrador de recursos seleccionado en el menú de la barra lateral del editor." className="hidden dark:block" />
</Frame>
