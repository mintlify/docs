...
Escribe <kbd>/youtube</kbd> para incrustar un video de YouTube, <kbd>/loom</kbd> para incrustar un video de Loom o <kbd>/vimeo</kbd> para incrustar un video de Vimeo. Pega la URL del video y el editor generará un iframe.
