...
Para agregar un nuevo elemento de navegación, haz clic en el botón **Add new** en la parte inferior del árbol de navegación.
...
<Note>
  Algunos elementos no pueden anidarse dentro de otros elementos. Por ejemplo, las pestañas no pueden anidarse dentro de groups. El editor web impide que anides elementos inválidos.
</Note>
...
<Frame>
  ...
  <img src="/images/editor/add-existing-file-menu-dark.png" alt="Menú “Add existing file” desplegado." className="hidden dark:block" />
</Frame>

También puedes arrastrar archivos desde la sección **Unused pages** directamente a tu árbol de navegación.
...
Si los archivos no están en otro elemento de navigation, aparecen en la sección de **Páginas sin usar**. Las páginas sin usar están [ocultas](/es/organize/hidden-pages) de tu documentación publicada.
