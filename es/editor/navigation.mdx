...
Para desagrupar páginas dentro de un grupo u otro elemento de navegación, haz clic con el botón derecho y luego haz clic en **Ungroup**. Todas las páginas del elemento desagrupado se moverán al nivel raíz de tu navegación.
