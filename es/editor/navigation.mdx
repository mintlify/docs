...
Para desagrupar páginas dentro de un grupo u otro elemento de navegación, haz clic derecho y selecciona **Ungroup**. Todas las páginas dentro del elemento desagrupado se moverán al nivel raíz de tu navegación.
