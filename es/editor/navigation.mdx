...
<Frame>
  <img src="/images/obama.jpg" alt="Agregar nuevo elemento de navegación." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Agregar nuevo elemento de navegación." className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="Menú “Add existing file” desplegado." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Menú “Add existing file” desplegado." className="hidden dark:block" />
</Frame>
