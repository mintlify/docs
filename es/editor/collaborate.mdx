...
<Frame>
  <img src="/images/obama.jpg" className="block dark:hidden" alt="Botón «Share» en la barra de herramientas del editor" />

  <img src="/images/obama.jpg" className="hidden dark:block" alt="Botón «Share» en la barra de herramientas del editor" />
</Frame>
