...
<Steps>
  <Step title="Crear una solicitud de extracción">
    Crea una solicitud de extracción desde el editor cuando estés listo para publicar tus cambios. Consulta <a href="/es/editor/branching-and-publishing">Publicar cambios en el editor web</a> para obtener más información sobre el uso de solicitudes de extracción.
  </Step>
