...
description: "Comprenda los conceptos de control de versiones de Git que hay detrás del editor de Mintlify, incluyendo branches, commits, pull requests y flujos de trabajo de fusión."
