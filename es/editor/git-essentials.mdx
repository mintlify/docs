...
<AccordionGroup>
  ...
  <Accordion title="Pull request">
    ...
    Cuando publica cambios en una feature branch (o cuando su repositorio exige pull requests), el editor web crea una pull request. Su equipo revisa y fusiona la pull request en su proveedor de Git (GitHub, GitLab o Bitbucket).
  </Accordion>
