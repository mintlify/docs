...
1. En el menú de publicación, haga clic en la URL de vista previa. El formato de la URL es `organization-branch-name.mintlify.site`.
    <Frame>
...
Cualquiera de los dos accesos abre el editor en la branch de la automatización con las páginas modificadas preseleccionadas en el menú de publicación. Puedes revisar el diff y fusionar o solicitar cambios sin salir del editor.
