...
description: "Crea, edita y publica documentación en tu navegador con edición visual, vista previa en tiempo real y sincronización con Git."
...
* **Edición con IA**: Genera, reescribe y reestructura contenido usando IA sin salir del editor.
...
<Card title="Editar con IA" icon="sparkles" horizontal href="/es/editor/inline-ai">
  Genera, reescribe y reestructura contenido usando IA.
</Card>
