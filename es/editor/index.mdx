...
<Card title="Branching and publishing" icon="git-branch" horizontal href="/es/editor/branching-and-publishing">
...
<Card title="Configuraciones del sitio" icon="settings" horizontal href="/es/editor/configurations">
