...
<img className="block dark:hidden my-0 pointer-events-none" src="/images/obama.jpg" alt="Imagen decorativa en modo claro" />

<img className="hidden dark:block my-0 pointer-events-none" src="/images/obama.jpg" alt="Imagen decorativa en modo oscuro" />
