...
<div id="ai-generated-pull-request-details">
  ### Detalles de solicitud de extracción generados por IA
</div>

Cuando publicas cambios que crean una solicitud de extracción, el editor genera automáticamente un título y una descripción basados en tus cambios. Los detalles generados resumen lo que modificaste para que los revisores comprendan rápidamente tu actualización.

Puedes editar el título y la descripción generados antes de enviar. Si ya escribiste un título o una descripción, el contenido generado se añade a lo que escribiste.
