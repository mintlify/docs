...
<Frame caption="Cambios en una rama de implementación.">
  <img src="/images/obama.jpg" alt="Barra de herramientas del editor web que muestra un cambio pendiente." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Barra de herramientas del editor web que muestra un cambio pendiente." className="hidden dark:block" />
</Frame>
...
<img src="/images/obama.jpg" alt="Barra de herramientas del editor web que muestra un cambio pendiente y el botón Save as commit en una rama de funcionalidad." className="block dark:hidden" />
<img src="/images/obama.jpg" alt="Barra de herramientas del editor web que muestra un cambio pendiente y el botón Save as commit en una rama de funcionalidad." className="hidden dark:block" />
</Frame>
...
Haz clic en **Publish** en la barra de herramientas. Según tu flujo de trabajo, tus cambios se despliegan de inmediato o se crea una solicitud de extracción para que la fusiones en tu proveedor de Git. Si estás en una feature branch, guarda tus cambios antes de publicar.

El botón **Publish** se desactiva cuando no hay cambios pendientes o cuando ya hay una solicitud de extracción abierta para la branch actual.
