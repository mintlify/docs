...
<Note>
  Tu sitio de documentación en producción se actualiza después de que Mintlify construye y despliega tus cambios publicados. Esto normalmente tarda entre 30 segundos y unos minutos. Consulta el estado del despliegue de tus cambios en tu [panel de control](https://dashboard.mintlify.com).
</Note>
...
- Tú y otra persona del equipo editan las mismas líneas de un archivo en branches diferentes.
