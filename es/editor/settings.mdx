---
title: "Configuración del editor para apariencia, publicación y chat"
description: "Configura la apariencia del editor, las pautas para commits y pull requests, los pull requests en borrador, el método de fusión predeterminado y las instrucciones del chat de IA del editor web de Mintlify."
keywords: ["editor", "configuración", "apariencia", "navegación", "vista previa", "ai", "chat", "instrucciones", "publicación", "pull request", "commit", "borrador", "fusión"]
---

El editor web tiene dos capas de configuración:

- **Tu configuración** se aplica solo a ti y controla la apariencia del editor y cómo el chat de IA te ayuda con tus ediciones.
...
Las preferencias de apariencia están asociadas a tu cuenta de usuario, por lo que cada compañero de equipo mantiene las suyas.

<div id="default-sidebar-view">
  ### Vista predeterminada de la barra lateral
</div>

Elige qué muestra la barra lateral del editor cuando lo abres:

- **File explorer**: Un árbol plano con todos los archivos de tu repositorio. Usa esta vista cuando quieras editar archivos que no son de contenido, como snippets, imágenes o archivos de configuración.
- **Navigation**: La estructura de navegación definida en `docs.json`. Usa esta vista cuando quieras reorganizar páginas, grupos, pestañas, anchors o menús.

Puedes alternar entre vistas en cualquier momento usando el conmutador en la parte superior de la barra lateral, o presiona <kbd>Shift</kbd> + <kbd>Ctrl/Cmd</kbd> + <kbd>F</kbd>.

<div id="full-width-editor">
  ### Editor a ancho completo
</div>

Activa esta opción para expandir el área de edición y que ocupe todo el espacio horizontal disponible. Úsala cuando quieras más espacio para tablas, bloques de código o diagramas anchos. Déjala desactivada para mantener el ancho del contenido cercano a cómo se renderizan las páginas en el sitio publicado.

<div id="open-live-preview-in-a-new-tab">
  ### Abrir la vista previa en vivo en una pestaña nueva
</div>

Activa esta opción para que el botón <Icon icon="play" /> de vista previa en vivo se abra en una pestaña del navegador independiente en lugar de en un panel dentro del editor. Usa una pestaña nueva cuando quieras mantener la vista previa visible en un segundo monitor o mientras cambias entre páginas del editor. Consulta [Vista previa en vivo](/es/editor/live-preview) para más detalles.

<div id="ai-chat-instructions">
  ## Instrucciones del chat de IA
</div>

Las instrucciones del chat de IA son pautas persistentes que el editor envía a la IA junto con tu solicitud. Úsalas para capturar reglas de estilo y tono que no quieres repetir cada vez, como la voz, la terminología o las convenciones de formato.
