...
description: "Configura las instrucciones de IA, los valores predeterminados de pull requests, los borradores y el método de fusión para controlar cómo el editor web de Mintlify publica los cambios."
