...
description: "Configura las instrucciones de IA, las pautas para pull requests, los pull requests en borrador y el método de fusión predeterminado del editor web de Mintlify."
