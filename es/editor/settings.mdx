...
description: "Configura las instrucciones de IA, los valores predeterminados de los pull requests, el comportamiento de los borradores y el método de fusión predeterminado para controlar cómo el editor web de Mintlify publica los cambios."
