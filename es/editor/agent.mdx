...
En el compositor, escriba `@` para buscar y mencionar una página privada por su título. El agente resuelve la mención a la ruta basada en UUID y la lista solo incluye páginas a las que tiene acceso.
...
cp /home/daytona/private/private-page-<source-uuid>.mdx \
  "/home/daytona/private/Copy of Secret"
ls /home/daytona/private
