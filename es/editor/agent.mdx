...
Puede abrir el agente desde el editor de páginas privadas. El botón del agente está oculto para los roles de viewer. La navegación privada se actualiza cuando el agente u otro editor cambia el árbol de páginas privadas.
