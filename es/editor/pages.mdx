---
title: "Crea y edita páginas en el editor web de Mintlify fácilmente"
description: "Crea páginas, edita contenido, sube imágenes y vídeos y administra archivos en el editor web de Mintlify con edición enriquecida y búsqueda global."
...
- **Duplicar**: Haga clic con el botón derecho en una página o abra el menú de opciones de página en la barra superior y, a continuación, seleccione **Duplicate**. El editor inserta la copia después de la original y añade `(copy)` a su título.
