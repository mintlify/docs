...
El panel muestra las versiones de la página actual en la rama actual. Haga clic en **Show more versions** para cargar entradas anteriores.

Las versiones anteriores incluyen la acción **Restore** cuando tiene permiso para editar la página. Haga clic en **Restore** y confirme para reemplazar el contenido actual de la página con esa versión guardada. Esta acción sobrescribe los cambios sin guardar.

Restore aplica la instantánea seleccionada a la página activa del sitio y la implementación actuales, en la rama actual. No crea una página nueva ni se limita a previsualizar el contenido guardado.
