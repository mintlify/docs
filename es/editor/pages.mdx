...
Duplique una página cuando quiera reutilizar su estructura y contenido como punto de partida. La copia conserva el cuerpo de la página, el título, la descripción y el icono. Su título termina en `(copy)` para que pueda identificarla y cambiarle el nombre.

Para duplicar una página, use cualquiera de estos métodos:

- Abra la página, haga clic en **More options** en la barra superior y seleccione **Duplicate**.
- En la vista **Navigation** o **Files**, haga clic con el botón derecho en la página y seleccione **Duplicate**.

Si duplica la página que tiene abierta, la copia incluye sus cambios sin guardar. Cuando la original aparece en la navegación, el editor coloca la copia junto a ella en el árbol de archivos y la navegación. Revise la copia, actualice sus ajustes y publíquela cuando esté lista.

<Note>
  Necesita acceso de edición y una rama que permita cambios. La duplicación está disponible para páginas Markdown y MDX, sin configuración adicional.
</Note>
