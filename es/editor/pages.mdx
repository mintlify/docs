...
## Eliminar una sección de la navegación

</div>

Para eliminar toda una sección de la navegación, como un group, tab, dropdown, anchor, language, product, version o menu item, abra su menú de opciones en el árbol de navegación y seleccione **Move to trash**. Confirme para mover a la papelera la sección y todas las páginas anidadas dentro de ella. Aparece un aviso de deshacer después de eliminarla.
