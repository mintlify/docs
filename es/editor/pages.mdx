...
Mover una página del workspace actualiza su ruta de archivo y su posición en la navegación. Mover una página privada la reubica dentro de su sección **Personal**. Los editors y admins pueden mover páginas del workspace. Puede mover las páginas privadas de las que es propietario.
