...
Mint registra una nueva entrada cuando el editor guarda contenido diferente de la última versión registrada. Guardar contenido sin cambios no crea una entrada duplicada. Una página guardada también puede estar vacía. Cada entrada muestra el autor y el tiempo relativo de guardado. La entrada más reciente se marca como **Latest**.
...
Restore aplica la instantánea seleccionada a la página actual. En las páginas públicas, escribe en el sitio, la implementación y la rama activos. En las páginas privadas, actualiza el contenido privado compartido en lugar de una copia específica de una rama. No crea una página nueva ni se limita a previsualizar el contenido guardado.
...
Restore no está disponible en ramas de despliegue bloqueadas ni en la versión **Latest**.
