...
Escriba <kbd>/image</kbd> o <kbd>/video</kbd> para subir un archivo o elegir uno que ya esté en su repositorio. También puede arrastrar archivos desde su equipo hasta la página. Para reutilizar un archivo multimedia, elija un archivo existente en el selector de <kbd>/image</kbd> o <kbd>/video</kbd>, o active [Show all files](/es/editor/settings#appearance) y arrastre una imagen o un vídeo desde la barra lateral hasta una página.
