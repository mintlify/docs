...
Restore aplica la instantánea seleccionada a la página activa actual del sitio, la implementación y la rama actuales. No crea una página nueva ni se limita a previsualizar el contenido guardado.
