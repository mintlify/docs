...
El historial de versiones agrupa las entradas por fecha. Cada entrada muestra el autor y la hora de guardado. La entrada más reciente se marca como **Current**.
...
Cuando el historial de versiones está disponible para la página, también puede hacer clic en la etiqueta **Edited ... ago** del encabezado del editor para abrir el panel lateral. La etiqueta sigue sin ser interactiva en las páginas no compatibles.

El panel muestra las versiones de la página actual. El historial de las páginas públicas se limita a la rama actual. El historial de las páginas privadas se comparte entre ramas. Haga clic en **Show more versions** para cargar entradas anteriores.
