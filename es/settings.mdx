...
El archivo `docs.json` te permite convertir una colección de archivos Markdown en un sitio de documentación navegable y personalizado. Este archivo de configuración obligatorio controla el estilo, la navigation, integraciones y más. Piénsalo como el plano de tu documentación.
...
Para una mejor experiencia de edición, incluye la referencia del esquema en la parte superior de tu archivo `docs.json`. Esto habilita el autocompletado, la validación y las descripciones emergentes útiles en la mayoría de los editores de código:
...
<ResponseField name="colors" type="object" required>
  ...
  <Expandable title="Colors">
    <ResponseField name="primary" type="string matching ^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" required>
      El color principal de tu documentación. Generalmente se usa para destacar en el modo claro, con algunas variaciones según el tema.

      Debe ser un código hex que comience con `#`.
    </ResponseField>

    <ResponseField name="light" type="string matching ^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$">
      El color usado para destacar en el modo oscuro.

      Debe ser un código hex que comience con `#`.
    </ResponseField>

    <ResponseField name="dark" type="string matching ^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$">
      El color usado para botones y estados de hover tanto en modo claro como oscuro, con algunas variaciones según el tema.
...
<ResponseField name="logo" type="string or object">
  ...
  <Expandable title="Logo">
    ...
    <ResponseField name="href" type="string (uri)">
      La URL a la que redirigir al hacer clic en el logotipo. Si no se proporciona, el logotipo enlazará con tu página de inicio. Ejemplo: `https://mintlify.com`
    </ResponseField>
  </Expandable>
</ResponseField>
  ...
  <Expandable title="Styling">
    ...
    <ResponseField name="codeblocks" type="&#x22;system&#x22; | &#x22;dark&#x22; | object">
      ...
      **Configuración de tema personalizada:**
      Usa un objeto para especificar [temas de Shiki](https://shiki.style/themes). Elige un solo tema para ambos modos o temas separados para claro y oscuro.

      <Expandable title="codeblocks">
        <ResponseField name="theme" type="string">
          Un solo nombre de tema de Shiki para usar en los modos claro y oscuro.
...
<ResponseField name="icons" type="object">
  Ajustes de la biblioteca de iconos.
...
<ResponseField name="fonts" type="object">
  ...
  <Expandable title="Fonts">
    ...
    <ResponseField name="weight" type="number">
      Peso de la fuente, por ejemplo, 400 o 700. Las fuentes variables permiten pesos precisos como 550.
    </ResponseField>

    <ResponseField name="source" type="string (uri)">
      URL del origen de la fuente, por ejemplo, https://mintlify-assets.b-cdn.net/fonts/Hubot-Sans.woff2. [Google Fonts](https://fonts.google.com) se carga automáticamente cuando especificas un nombre de `family` de Google Fonts, por lo que no necesitas una URL de source.
    </ResponseField>
    ...
    <ResponseField name="body" type="object">
      Sobrescribe la configuración tipográfica específicamente para el texto del cuerpo.
...
<ResponseField name="navbar" type="object">
  Elementos de la barra de navegación hacia enlaces externos.
...
<ResponseField name="navigation" type="object" required>
  ...
  <Expandable title="Navegación">
      ...
      <Expandable title="Global">
        ...
        <ResponseField name="versiones" type="array of object">
          ...
          <Expandable title="Versions">
            ...
            <ResponseField name="hidden" type="boolean">
              Indica si esta opción de versión se oculta de forma predeterminada.
            </ResponseField>
        ...
        <ResponseField name="anclas" type="array of object">
          Enlaces anclados que aparecen de forma destacada en la navigation de la barra lateral.
    ...
    <ResponseField name="páginas" type="array of string or object">
      Páginas individuales [pages](es/navigation#pages) que componen tu documentación.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="redirects" type="array of object">
  ...
  <Expandable title="Redirects">
    ...
    <ResponseField name="permanent" type="boolean">
      Indica si se usa una redirección permanente (301). El valor predeterminado es `true`.
    </ResponseField>
  </Expandable>
</ResponseField>
  ...
  <Expandable title="Contextual">
    <ResponseField name="options" type="array of &#x22;copy&#x22; | &#x22;view&#x22; | &#x22;chatgpt&#x22; | &#x22;claude&#x22; | &#x22;perplexity&#x22; | &#x22;mcp&#x22; | &#x22;cursor&#x22; | &#x22;vscode&#x22;" required>
      ...
      * `vscode`: Instala tu servidor MCP alojado en VSCode.
      ...
      <Note>
        El menú contextual solo está disponible en las implementaciones de vista previa y de producción.
      </Note>
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="api" type="object">
  ...
  <Expandable title="Api">
    <ResponseField name="openapi" type="string or array or object">
      Archivos de especificación OpenAPI para generar la documentación de la API. Puede ser una sola URL/ruta o una matriz de URL/rutas.
    ...
    <ResponseField name="asyncapi" type="string or array or object">
      Archivos de especificación AsyncAPI para generar la documentación de la API. Puede ser una sola URL/ruta o una matriz de URL/rutas.
    ...
    <ResponseField name="params" type="object">
      ...
      <Expandable title="Params">
        <ResponseField name="expanded" type="&#x22;all&#x22; | &#x22;closed&#x22;">
          Si expandir todos los parámetros de forma predeterminada. El valor predeterminado es `closed`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="playground" type="object">
      ...
      <Expandable title="Playground">
        ...
        <ResponseField name="proxy" type="boolean">
          Si reenviar las solicitudes de la API a través de un servidor proxy. El valor predeterminado es `true`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="examples" type="object">
      ...
      <Expandable title="Examples">
        ...
        <ResponseField name="defaults" type="&#x22;required&#x22; | &#x22;all&#x22;">
          Si mostrar los parámetros opcionales en los ejemplos de la API. El valor predeterminado es `all`.
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<ResponseField name="seo" type="object">
  ...
  <Expandable title="Seo">
    <ResponseField name="metatags" type="object">
      Metatags añadidos a cada página. Debe ser un par key-value válido. Consulta la [referencia de metatags comunes](/es/settings/seo#common-meta-tags-reference) para ver las opciones.
    </ResponseField>

    <ResponseField name="indexing" type="&#x22;navigable&#x22; | &#x22;all&#x22;">
      Especifica qué páginas deben indexar los motores de búsqueda. Elige `navigable` para indexar solo las páginas que estén en la navigation de tu `docs.json` o elige `all` para indexar todas las páginas. De forma predeterminada: `navigable`.
    </ResponseField>
  </Expandable>
</ResponseField>
    ...
    <ResponseField name="404" type="object">
      ...
      <Expandable title="404">
        <ResponseField name="redirect" type="boolean">
          Indica si se debe redirigir automáticamente a la página principal cuando no se encuentra una página.
        </ResponseField>
...
<Steps>
  <Step title="Instalar o actualizar la CLI">
