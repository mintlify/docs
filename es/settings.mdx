...
<ResponseField name="colors" type="object" required>
  Los colores que se usan en tu documentación. Se aplican de forma diferente según el tema. Si solo defines un color primario, se utilizará para todos los elementos de color.

  <Expandable title="Colors">
    <ResponseField name="primary" type="string matching ^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" required>
      El color primario de tu documentación. Por lo general se usa para énfasis en modo claro, con alguna variación según el tema.
    ...
    <ResponseField name="dark" type="string matching ^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$">
      El color utilizado para botones y estados de hover en modo claro y oscuro, con alguna variación según el tema.
...
<ResponseField name="favicon" type="string or object">
  Ruta a tu archivo de favicon, incluyendo la extensión. Se redimensiona automáticamente a los tamaños adecuados.
  Puede ser un único archivo o archivos separados para modos claro y oscuro. Ejemplo: `/favicon.png`
...
<ResponseField name="thumbnails" type="object">
  Personalización de las miniaturas para redes sociales y vistas previas de páginas.

  <Expandable title="Thumbnails">
    <ResponseField name="appearance" type="&#x22;light&#x22; | &#x22;dark&#x22;">
      El tema visual de tus miniaturas. Si no se especifica, usarán el esquema de color de tu sitio definido en el campo `colors`.
    </ResponseField>
...
<ResponseField name="icons" type="object">
  ...
  <Expandable title="Icons">
    <ResponseField name="library" type="&#x22;fontawesome&#x22; | &#x22;lucide&#x22;" required>
      Biblioteca de iconos para utilizar en toda tu documentación. De forma predeterminada es `fontawesome`.
...
<ResponseField name="fonts" type="object">
  ...
  <Expandable title="Fonts">
    ...
    <ResponseField name="source" type="string (uri)">
      URL de origen de la fuente, como https://mintlify-assets.b-cdn.net/fonts/Hubot-Sans.woff2. [Google Fonts](https://fonts.google.com) se carga automáticamente cuando especificas un nombre de `family` de Google Fonts, por lo que no se necesita URL de origen.
    </ResponseField>
...
<ResponseField name="appearance" type="object">
  ...
  <Expandable title="Appearance">
    <ResponseField name="default" type="&#x22;system&#x22; | &#x22;light&#x22; | &#x22;dark&#x22;">
      Modo de tema predeterminado. Elige `system` para ajustarlo a la configuración del sistema operativo del usuario, o `light` o `dark` para forzar un modo específico. El valor predeterminado es `system`.
    </ResponseField>

    <ResponseField name="strict" type="boolean">
      Si se debe ocultar el conmutador de modo claro/oscuro. El valor predeterminado es `true`.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="Integraciones" type="object">
  ...
  <Expandable title="Integraciones">
    ...
    <ResponseField name="Front (integración Frontchat)" type="object">
