...
Para empezar, solo necesitas especificar `theme`, `name`, `colors.primary` y `navigation`. Los demás campos son opcionales y puedes agregarlos conforme crezcan las necesidades de tu documentación.

Para una mejor experiencia de edición, incluye la referencia del esquema en la parte superior de tu archivo `docs.json`. Esto habilita el autocompletado, la validación y las ayudas emergentes en la mayoría de los editores de código:
...
<ResponseField name="colors" type="object" required>
  Los colores que se usan en tu documentación. Los colores se aplican de forma diferente según el tema. Si solo indicas un color primario, se usará para todos los elementos de color.

  <Expandable title="Colors">
    <ResponseField name="primary" type="string matching ^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" required>
      El color primario de tu documentación. Generalmente se usa para resaltar en modo claro, con alguna variación según el tema.
    ...
    <ResponseField name="dark" type="string matching ^#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$">
      El color utilizado para botones y estados hover en modos claro y oscuro, con alguna variación según el tema.
...
<ResponseField name="logo" type="string or object">
  Tu logotipo para modos claro y oscuro.
  ...
  <Expandable title="Fonts">
    ...
    <ResponseField name="heading" type="object">
      ...
      <Expandable title="Heading">
        ...
        <ResponseField name="weight" type="number">
          Peso tipográfico, como 400, 700. Las fuentes variables admiten pesos precisos como 550.
        </ResponseField>
      ...
      <Expandable title="Global">
        ...
        <ResponseField name="versiones" type="array of object">
          ...
          <Expandable title="Versions">
            ...
            <ResponseField name="default" type="boolean">
              Indica si es la versión predeterminada.
            </ResponseField>
...
<ResponseField name="banner" type="object">
  Banner del sitio completo mostrado en la parte superior de las páginas.
...
<ResponseField name="api" type="object">
  ...
  <Expandable title="Api">
    <ResponseField name="openapi" type="string or array or object">
      Archivos de especificación de OpenAPI para generar documentación de la API. Puede ser una única URL/ruta o una matriz de URL/rutas.
    ...
    <ResponseField name="asyncapi" type="string or array or object">
      Archivos de especificación de AsyncAPI para generar documentación de la API. Puede ser una única URL/ruta o una matriz de URL/rutas.
    ...
    <ResponseField name="playground" type="object">
      ...
      <Expandable title="Playground">
        ...
        <ResponseField name="proxy" type="boolean">
          Si pasar las solicitudes de la API por un servidor proxy. El valor predeterminado es `true`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="examples" type="object">
      ...
      <Expandable title="Examples">
        ...
        <ResponseField name="defaults" type="&#x22;required&#x22; | &#x22;all&#x22;">
          Si mostrar parámetros opcionales en los ejemplos de la API. El valor predeterminado es `all`.
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<ResponseField name="seo" type="object">
  ...
  <Expandable title="Seo">
    <ResponseField name="metatags" type="object">
      Metatags añadidos a cada página. Deben ser pares clave-valor válidos. Consulta la [referencia de metatags comunes](/es/settings/seo#common-meta-tags-reference) para ver las opciones.
    </ResponseField>

    <ResponseField name="indexing" type="&#x22;navigable&#x22; | &#x22;all&#x22;">
      Especifica qué páginas deben indexar los motores de búsqueda. Elige `navigable` para indexar solo las páginas que están en la navegación de tu `docs.json`, o elige `all` para indexar todas las páginas. De manera predeterminada es `navigable`.
    </ResponseField>
  </Expandable>
</ResponseField>
  ...
  <Expandable title="Integraciones">
    ...
    <ResponseField name="koala" type="object">
      ...
      <Expandable title="Koala">
        <ResponseField name="publicApiKey" type="string" required>
          Tu clave pública de la API de Koala.
...
<Tabs>
  ...
  <Tab title="Ejemplo interactivo de API">
...
Si tu proyecto de documentación utiliza el archivo en desuso `mint.json`, sigue estos pasos para actualizar a `docs.json`.
...
<Steps>
  ...
  <Step title="Eliminar tu archivo mint.json">
    Después de verificar que tu `docs.json` esté configurado correctamente, puedes eliminar de forma segura tu archivo `mint.json` anterior.
  </Step>
</Steps>