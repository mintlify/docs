...
<Frame>
	![Página de creación de la política de solicitud de origen de CloudFront que reenvía las cabeceras `Origin` y `CloudFront-Viewer-Address`](/images/cloudfront/origin-request-policy.png)
</Frame>
...
<Frame>
  ![Una distribución de CloudFront con el comportamiento "Default (*)" seleccionado y el botón Edit enfatizado.](/images/cloudfront/default-behavior-1.png)
</Frame>
