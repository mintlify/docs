...
- **Mensaje de Slack**: se ejecuta cuando un compañero de equipo publica un mensaje de nivel superior en uno de los canales de Slack seleccionados. Está disponible para automatizaciones personalizadas. Requiere la [aplicación de Slack de Mintlify](/es/agent/slack). Selecciona uno o más canales para escuchar. El activador ignora las respuestas en hilos, las ediciones y los mensajes de bots o de la propia aplicación de Mintlify. El agente lee cada mensaje nuevo y decide si debe actuar.
