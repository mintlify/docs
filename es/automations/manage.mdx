...
1. Abre la página [Automatizaciones](https://app.mintlify.com/products/automations) en tu dashboard.
2. Haz clic en el botón de configuración <Icon icon="settings" /> junto a la automatización personalizada que quieres eliminar.
3. Haz clic en **Delete** en la parte inferior del panel de configuración y confirma.
...
También puedes seleccionar **View runs** en la tarjeta de una automatización para abrir el historial de ejecuciones filtrado por esa automatización. Un punto rojo en el botón indica que la automatización tiene ejecuciones pendientes de revisión.
