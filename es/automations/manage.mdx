...
Elige el modo en la sección **After automation runs** de la página de configuración de la automatización. Selecciona **Update and merge changes** para fusionar los cambios automáticamente. Selecciona **Modify and wait for review** para requerir una revisión antes de que los cambios se publiquen.
