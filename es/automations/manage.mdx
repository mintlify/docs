...
Para automatizaciones personalizadas y la automatización **Update from code changes**, puedes habilitar las [integraciones](/es/automations/integrations) conectadas para que el agente pueda obtener contexto desde herramientas como Slack, Notion o Linear cuando se ejecuta la automatización.

Para habilitar integraciones en una automatización, abre su configuración y selecciona las integraciones que quieres que el agente use en la sección **Available integrations**. Solo aparecen en la lista las integraciones ya conectadas para tu organización. Conecta las integraciones en la página [Integraciones](https://app.mintlify.com/settings/organization/integrations) en la configuración de tu dashboard. Consulta [Integraciones](/es/automations/integrations) para más información.
