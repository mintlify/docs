...
1. Ve a la página [Automatizaciones](https://app.mintlify.com/products/automations?tab=runs) en tu dashboard.
...
- **Review needed**: El agente finalizó la ejecución, pero los cambios deben ser revisados y fusionados por alguien de tu equipo.
