...
4. Selecciona un alcance de ejecución y haz clic en **Run now** para confirmar.

Cada ejecución manual cubre uno de tres alcances:

- **Since a date**: Cubre el contenido que cambió entre la fecha que elijas y ahora. De forma predeterminada, es la última ejecución de la automatización.
- **Everything**: Se ejecuta en todo tu sitio. Suele tardar más y consumir bastantes más créditos que una ejecución dirigida.
