...
Eliminar una automatización la quita de tu proyecto junto con su configuración y su historial de ejecuciones. Desactiva una automatización en lugar de eliminarla si es posible que quieras reactivarla más adelante.

1. Abre la página [Automatizaciones](https://app.mintlify.com/products/automations) en tu dashboard.
2. Haz clic en el botón de configuración <Icon icon="settings" /> junto a la automatización que quieres eliminar.
3. Desplázate hasta la parte inferior del modal de configuración y haz clic en **Delete automation**.
4. Confirma la eliminación cuando se te solicite.

También puedes eliminar automatizaciones desde la terminal con [`mint workflow`](/es/cli/commands#mint-workflow).
