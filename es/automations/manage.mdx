...
Solo puedes eliminar [automatizaciones personalizadas](/es/automations/create). Para detener una automatización predefinida, desactívala en su lugar. Eliminar una automatización es permanente y elimina su configuración y su historial de ejecuciones.

1. Abre la página [Automatizaciones](https://app.mintlify.com/products/automations) en tu dashboard.
2. Haz clic en el botón de configuración <Icon icon="settings" /> junto a la automatización.
...
- **Failed**: El agente no pudo completar la ejecución. Las ejecuciones fallidas no cuentan para tu límite diario de ejecuciones. Para reintentar, [ejecuta la automatización manualmente](#run-an-automation-manually) o espera a su próximo activador programado.
