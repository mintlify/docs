...
<Tip>
  También puedes crear, listar y eliminar automatizaciones desde la terminal con [`mint workflow`](/es/cli/commands#mint-workflow). La CLI es útil para scripts y CI; el dashboard es la forma más sencilla de configurar y supervisar las ejecuciones de automatizaciones.
</Tip>
