...
description: "Crea una automatización de Mintlify que se ejecute según un calendario, un push a un repositorio o un evento de integración. Añade repositorios de contexto y un prompt de agente personalizado."
