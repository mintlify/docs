...
Ejecuta manualmente una automatización antes de depender de un calendario o un evento para detectar problemas con antelación. Las ejecuciones manuales utilizan la configuración actual de la automatización y aparecen en el historial de ejecuciones junto con las ejecuciones programadas. Consulta [Ejecutar una automatización manualmente](/es/automations/manage#run-an-automation-manually) para conocer los pasos.

Abre la ejecución en la página [Automatizaciones](https://app.mintlify.com/products/automations?tab=runs) para revisar el prompt, los archivos que el agente leyó o modificó, y cualquier pull request que haya abierto. Si el resultado no es el que esperabas, edita las instrucciones y vuelve a ejecutarla.
