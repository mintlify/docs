...
Prueba una automatización nueva con una ejecución manual antes de confiar en su activador. Las ejecuciones manuales usan la configuración actual de la automatización y aparecen en el historial de ejecuciones junto a las ejecuciones programadas. Consulta [Ejecutar una automatización manualmente](/es/automations/manage#run-an-automation-manually) para conocer los pasos y requisitos, que incluyen un activador de calendario para la mayoría de las automatizaciones.
