...
description: "Crea una automatización personalizada de Mintlify con un activador programado o por push, repositorios de contexto y un prompt para el agente que automatice tareas recurrentes de documentación."
