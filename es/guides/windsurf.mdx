---
title: "Windsurf"
description: "Configura Windsurf Cascade con workspace rules y memorias para redactar documentación de Mintlify que siga tu guía de estilo y los estándares de MDX."
...
Conecta el servidor MCP de Mintlify a Windsurf para que Cascade pueda buscar en la documentación de Mintlify mientras escribes. Cuando conectas el servidor MCP, Cascade busca en la documentación más reciente de Mintlify para obtener contexto, de modo que no tengas que salir de tu IDE para consultar la documentación.
