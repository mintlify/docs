...
Consulta [Model Context Protocol](/es/ai/model-context-protocol#example%3A-connect-to-of-mintlify-mcp-server) para ver las instrucciones completas de configuración.