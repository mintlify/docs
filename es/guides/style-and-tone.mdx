...
description: "Escribe documentación técnica clara y consistente con guía práctica sobre voz, estructura, terminología y tono para docs de producto y desarrolladores."
...
<Tip>
  Usa un [workflow](/automations) para ejecutar una auditoría de estilo de forma programada o cada vez que se envíen cambios a tu repositorio de documentación.
</Tip>
