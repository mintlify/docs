...
Para soluciones de traducción automática, [configura un workflow](/automations) para ejecutar el agente de forma programada o en respuesta a cambios enviados al repositorio.
