...
description: "Migra tus páginas de API escritas manualmente en MDX a documentación generada automáticamente desde OpenAPI, con navegación flexible y agrupación de endpoints."
