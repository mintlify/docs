...
El `mint migrate-mdx` comando es la forma recomendada de migrar de páginas de endpoints en MDX a páginas autogeneradas.

Este comando:

* Analiza la estructura de `docs.json`.
...
<Steps>
  <Step title="Prepara tu especificación de OpenAPI.">
    ...
    Cualquier página MDX que quieras migrar debe tener el `openapi:` frontmatter que haga referencia a un endpoint.
