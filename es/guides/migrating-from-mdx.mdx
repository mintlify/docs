---
title: "Migración de páginas de API en MDX a la navigation de OpenAPI"
sidebarTitle: "Migración desde MDX"
description: "Actualiza páginas individuales de endpoints en MDX a la generación automática con OpenAPI y una navigation flexible"
---
