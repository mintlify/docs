...
<Steps>
  <Step title="Crear una aplicación web Regular en Auth0">
    ...
    <Frame>![Creating a new application in Auth0](/es/images/guides/auth0/auth0-create-application.png)</Frame>
  </Step>
  <Step title="Obtener la información del cliente">
    ...
    <Frame>![Auth0 client settings page](/es/images/guides/auth0/auth0clientsettings.png)</Frame>
  ...
  <Step title="Configurar el cliente de Mintlify">
    ...
    <Frame>![Mintlify OAuth client settings](/es/images/guides/auth0/mintlifyoauthclientsettings.png)</Frame>
  ...
  <Step title="Configurar la Callback URL">
    ...
    <Frame>![Mintlify redirect URL](/es/images/guides/auth0/mintlifyredirecturl.png)</Frame>
    ...
    <Frame>![Auth0 redirect URL configuration](/es/images/guides/auth0/auth0redirecturl.png)</Frame>
