...
* Tu domain, que aparece al final de la URL de tu dashboard. Por ejemplo, si la URL de tu dashboard es `https://app.mintlify.com/org-name/domain-name`, tu domain es `domain-name`
* Una [assistant API key](https://app.mintlify.com/settings/organization/api-keys)
...
1. Ve a la página de [API keys](https://app.mintlify.com/settings/organization/api-keys) en tu dashboard.
