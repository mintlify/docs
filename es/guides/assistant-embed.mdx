...
description: "Crea e incorpora un asistente de documentación dentro de tu aplicación que responda preguntas con información citada de tu sitio de Mintlify."
...
- `X-Thread-Key`: Una clave secreta para el hilo (solo se devuelve una vez, cuando creas el hilo)
...
<Warning>
  Debes almacenar el encabezado `X-Thread-Key` inmediatamente. El servidor solo lo devuelve cuando creas un nuevo hilo. No puedes recuperarlo más tarde.
</Warning>
