...
Para servir tu documentación mediante un proxy inverso personalizado, debes configurar reglas de enrutamiento, políticas de caché y reenvío de encabezados.
...
Proxy estos paths a tu subdomain de Mintlify con las políticas de caché especificadas:
...
**Síntomas**: La documentación se carga, pero las funciones no operan. Las llamadas a la API fallan.
