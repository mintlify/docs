...
Encamina (proxy) estas rutas a tu subdomain de Mintlify con las políticas de caché indicadas:
...
- Configura el encabezado `Origin` como `<your-subdomain>.mintlify.app`

<div id="performance-issues">
  ### Problemas de rendimiento
</div>

**Síntomas**: Carga lenta de páginas y cambios en el diseño.

**Causa**: Configuración de caché incorrecta.

**Solución**: Habilita el caché solo para las rutas `/mintlify-assets/_next/static/*`.