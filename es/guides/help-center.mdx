...
El assistant responde a las preguntas de los clientes utilizando tu contenido de soporte. Configúralo desde tu [dashboard](https://app.mintlify.com/products/assistant/settings).
