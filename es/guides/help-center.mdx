...
description: "Crea un centro de ayuda de autoservicio en Mintlify que guíe a los clientes hacia respuestas, reduzca tickets de soporte y escale con tu equipo."
...
Esto crea un nuevo proyecto preconfigurado para un centro de ayuda, que incluye la estructura de navegación, páginas de ejemplo y listados de directorios. Consulta el [ejemplo en vivo](https://help-center-starter.mintlify.site/) o revisa el [código fuente de la plantilla](https://github.com/mintlify/templates/tree/main/help-center-starter).
...
* Un domain para alojar tu centro de soporte: un [dominio personalizado](/es/customize/custom-domain) o tu URL `.mintlify.site` predeterminada
