...
description: "Identifica la audiencia de tu documentación, comprende sus objetivos y niveles de habilidad, y estructura el contenido para ayudarles a completar tareas de forma efectiva."
keywords: ["investigación de usuarios", "perfiles de audiencia", "comentarios de usuarios", "público objetivo"]
---

<Tip>
  Esta página explica cómo identificar a tu audiencia, realizar investigación con usuarios y escribir pensando en sus necesidades.
</Tip>
