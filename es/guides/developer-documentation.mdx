...
El assistant ayuda a los desarrolladores a encontrar respuestas y comprender ejemplos de código. Configúralo desde tu [dashboard](https://app.mintlify.com/products/assistant/settings).
...
<Steps>
  <Step title="Connect your repository">
    Vincula tu repositorio de GitHub en el [dashboard](https://app.mintlify.com). Esto habilita implementaciones automáticas cuando haces push de cambios.
  </Step>
