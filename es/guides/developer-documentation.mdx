...
description: "Crea documentación para desarrolladores que ayude a integrar tus APIs, SDKs y herramientas, con guías de inicio rápido, referencias y tutoriales."
...
* **Sincronización con Git**: Mantén la documentación sincronizada con tu base de código usando [GitHub](/es/deploy/github), [GitLab](/es/deploy/gitlab) o [Bitbucket Cloud](/es/deploy/bitbucket).
...
<Steps>
  <Step title="Mantén actualizada la referencia de la API">
    Actualiza tu especificación de OpenAPI cada vez que publiques cambios. Si generas tu especificación a partir del código, automatiza esto en tu proceso de lanzamiento.
  </Step>
