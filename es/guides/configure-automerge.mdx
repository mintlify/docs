...
description: "Configura flujos de trabajo de GitHub para fusionar automáticamente pull requests de Mintlify habilitando squash merge y otorgando a la aplicación GitHub de Mintlify el bypass de las reglas de rama."
