...
description: "Configura flujos de trabajo para fusionar automáticamente pull requests añadiendo el bot de Mintlify a la lista de exclusión de reglas de tu repositorio."
