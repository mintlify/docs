...
<Steps>
  ...
  <Step title="Regístrate en Mintlify">
    Si no tienes una cuenta de Mintlify, regístrate en [dashboard.mintlify.com/signup](https://app.mintlify.com/signup).
  </Step>
  ...
  <Step title="Configura las variables de entorno">
    ...
    Genera una clave de API del assistant en la página [API keys](https://app.mintlify.com/settings/organization/api-keys) de tu dashboard. Esta clave de API del assistant empieza por `mint_dsc_`.
  </Step>
