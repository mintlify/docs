...
description: "Usa el modo headless de Mintlify junto con la integración de Astro para renderizar tu documentación con un frontend completamente personalizado mientras utilizas la infraestructura de contenido y de IA de Mintlify."
...
Con un frontend personalizado en modo headless, puedes seguir usando componentes de Mintlify sin importarlos y seguirás contando con la infraestructura de publicación, búsqueda e IA.

Esta guía te guía paso a paso para configurar un proyecto headless de Mintlify con la plantilla inicial y ponerlo a funcionar en local.
