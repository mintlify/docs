...
<Steps>
  ...
  <Step title="Instala la aplicación de GitHub">
    En la página de [Git settings](https://app.mintlify.com/settings/project/git-settings) de tu Dashboard de Mintlify, instala la [Mintlify GitHub app](/es/deploy/github). Si ya tienes instalada la aplicación, desinstálala y vuelve a instalarla para poder conectar tu nuevo repositorio.
  </Step>

  <Step title="Conecta tu repositorio">
    1. En la página de [Git settings](https://app.mintlify.com/settings/project/git-settings), selecciona el repositorio que creaste a partir de la plantilla inicial.
