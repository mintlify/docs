...
description: "Crea un frontend de documentación headless con Astro usando Mintlify para la gestión de contenido, búsqueda impulsada por IA y funciones de asistente."
