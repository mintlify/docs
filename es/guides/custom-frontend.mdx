...
description: "Crea un frontend personalizado de documentación headless con Astro mientras usas Mintlify para la gestión de contenido y las funciones de IA."
...
Este enfoque headless es útil cuando necesitas control total sobre el diseño, la estructura o el comportamiento de tu documentación. Por ejemplo, para que coincida con un sistema de diseño existente o para incrustar la documentación en un sitio más grande.

La integración `@mintlify/astro` lee tu configuración de `docs.json` y el contenido MDX en tiempo de compilación, y luego procesa todo en un formato que Astro puede renderizar. Usa tu propio diseño, componentes y estilos sobre esta base.

Con un frontend personalizado headless, puedes seguir usando componentes de Mintlify sin importarlos y contar con la infraestructura de publicación, búsqueda e IA.
