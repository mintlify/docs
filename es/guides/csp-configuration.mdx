...
- `default-src`: Valor de reserva para otras directivas cuando no se especifica explícitamente

<div id="domain-whitelist">
  ## Lista de dominios permitidos
</div>

| Domain | Propósito | Directiva CSP | Obligatorio |
|:-------|:--------|:--------------|:-------|
...
| `d1ctpt7j8wusba.cloudfront.net` | Archivos de versión y de lanzamiento de Mint | `connect-src` | Obligatorio |
...
<Note>
  Incluye solo los domain de los servicios que usas. Elimina cualquier domain de Analytics que no hayas configurado para tu documentación.
</Note>
