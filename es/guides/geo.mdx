...
El `robots.txt` generado automáticamente por Mintlify permite todos los rastreadores por defecto. Si usas un [archivo robots.txt personalizado](/es/optimize/seo#custom-sitemaps-and-robotstxt-files), asegúrate de que no bloquee a los agentes de IA. Los agentes de usuario de IA más comunes incluyen:
