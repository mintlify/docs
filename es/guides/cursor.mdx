...
sidebarTitle: "Cursor"
description: "Configura Cursor con reglas de proyecto para redactar documentación de Mintlify que siga tu guía de estilo, el uso de componentes y las convenciones de MDX."
...
* Las **reglas de proyecto** residen en el repositorio de tu documentación, por lo que todo tu equipo las comparte.
...
Marca de tiempo con formato ISO 8601 de la creación del usuario.
</ResponseField>
