...
<CardGroup cols={2}>
  <Card title="Descripción general de Analytics" icon="chart-line" href="/es/insights/overview">
    Consulta Analytics y realiza un seguimiento del rendimiento de tu documentación.
  </Card>

  <Card title="Comentarios" icon="message-square" href="/es/insights/feedback">
