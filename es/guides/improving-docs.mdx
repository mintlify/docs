...
description: "Utiliza datos de analítica, feedback de usuarios y métricas de contenido para identificar carencias y mejorar la calidad y cobertura de tus páginas de documentación."
...
Usa Analytics para identificar patrones:
...
* **Comentarios de usuarios**: Usa [feedback](/es/optimize/feedback) para captar la opinión de los usuarios mediante calificaciones y comentarios abiertos, lo que te ayudará a entender qué funciona y dónde encuentran dificultades.
...
* **Onboarding y adopción de usuarios**: Supervisa qué tan bien la documentación ayuda a los nuevos usuarios a ponerse al día, contribuyendo a una adopción del producto más rápida.
...
<div id="put-analytics-into-action">
  ## Convierte Analytics en acciones
</div>
...
<CardGroup cols={2}>
  <Card title="Descripción general de Analytics" icon="chart-line" href="/es/optimize/analytics">
    Consulta Analytics y realiza un seguimiento del rendimiento de tu documentación.
  </Card>
