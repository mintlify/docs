...
description: "Usa analíticas, comentarios de usuarios y auditorías de contenido para detectar lagunas y mejorar las páginas que más importan a tu audiencia."
...
<Tip>
  Usa [automatizaciones](/es/automations) para automatizar mejoras recurrentes, como abrir un pull request con correcciones sugeridas para páginas marcadas por puntuaciones de comentarios bajas.
</Tip>
...
Mensualmente para páginas de alto tráfico y tendencias generales de satisfacción. Trimestralmente para una auditoría de contenido más profunda que analice patrones de navegación, consultas de búsqueda sin resultados y páginas sin actualizaciones recientes. La revisión en tiempo real no es necesaria a menos que acabes de lanzar un cambio importante.
</Accordion>
