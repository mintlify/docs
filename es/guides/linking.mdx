...
description: "Crea enlaces internos, anclas y enlaces profundos en tu documentación, y mantén su integridad con redirecciones y verificaciones de enlaces rotos."
...
Cuando una página tiene varios encabezados que generan el mismo ID, Mintlify añade `-2`, `-3`, y así sucesivamente a cada duplicado. El contador se aplica a toda la página, incluidos los encabezados anidados dentro de componentes como pestañas. Usa un [ID de anclaje personalizado](#custom-anchor-ids) si quieres un enlace estable y predecible. Consulta [IDs de anclaje automáticos](/es/create/text#automatic-anchor-ids) para conocer las reglas completas de generación de slugs.
