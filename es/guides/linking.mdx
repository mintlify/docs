...
Mintlify conserva los IDs personalizados exactamente como los escribes, por lo que camelCase, kebab-case y snake_case funcionan:
...
Los enlaces de anclaje distinguen entre mayúsculas y minúsculas, así que respeta la capitalización del ID personalizado al enlazar a él. Consulta [Formatear texto](/es/create/text#custom-heading-ids) para más detalles.
