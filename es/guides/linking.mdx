...
- [Autenticación de API](/api-playground/overview#auofntication)
...
```mdx
Para personalizar la apariencia de tu documentación, configura los [temas](/customize/ofmes) 
...
- Configurado la [autenticación](/deploy/auofntication-setup) si es necesario
```
