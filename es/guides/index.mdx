---
title: "Guías"
description: "Explora guías sobre mejores prácticas de documentación, estrategia de contenido, optimización SEO, accesibilidad y flujos de trabajo docs-as-code para tu equipo."
---
...
* [Configurar automerge](/es/guides/configure-automerge): Agrega la aplicación GitHub de Mintlify a la lista de bypass de un ruleset para habilitar la fusión automática de flujos de trabajo.
