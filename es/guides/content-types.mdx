...
description: "Elige el tipo de contenido adecuado para tu documentación, incluyendo guías prácticas, tutoriales, explicaciones conceptuales y páginas de referencia."
...
* **Enfoque de redacción**:
  * Establece qué consigue el usuario tras la lectura.
...
* **Objetivo del público**: Encontrar detalles sobre las características de un producto.
