...
Mintlify incluye workflows predefinidos para las tareas más comunes de mantenimiento de contenido. Activa cualquiera de ellos desde la página [Automations](https://app.mintlify.com/products/automations?tab=workflows) de tu panel.
...
1. Abre la pestaña **Runs** en la página [Automations](https://app.mintlify.com/products/automations) para ver el historial de ejecuciones recientes y su estado.
