...
<AccordionGroup>
  <Accordion title="Rama" id="branch">
  ...
  <Accordion title="Clonar" id="clone">
  ...
  <Accordion title="Confirmación" id="commit">
  ...
  <Accordion title="Conflicto" id="conflict">
  ...
  <Accordion title="Rama de implementación" id="deployment-branch">
  ...
  <Accordion title="Merge" id="merge">
  ...
  <Accordion title="Pull request" id="pull-request">
  ...
  <Accordion title="Remoto" id="remote">
  ...
  <Accordion title="Repositorio" id="repository">
  ...
  <Accordion title="Stage" id="stage">
...
El editor web se conecta a tu repositorio de Git a través de la [Aplicación de GitHub](/es/deploy/github), la [integración con GitLab](/es/deploy/gitlab) o la [integración con Bitbucket Cloud](/es/deploy/bitbucket) y automatiza operaciones comunes de Git.
...
Crea una rama, realiza y guarda cambios en ella y, luego, fusiona la rama en tu rama de implementación mediante una solicitud de extracción. Para obtener instrucciones paso a paso en el editor web y en la línea de comandos, consulta [Trabajar con ramas](/es/guides/branches). Para saber cómo cambian las acciones de publicación disponibles según tus protecciones de ramas, consulta [Publicar tus cambios](/es/editor/publish).
