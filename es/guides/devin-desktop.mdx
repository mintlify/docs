---
title: "Escribe documentación con Devin Desktop"
sidebarTitle: "Devin Desktop"
description: "Configura la IA Cascade de Devin Desktop con workspace rules para redactar documentación de Mintlify que siga tu guía de estilo y los estándares de MDX."
keywords: ["Devin Desktop", "Windsurf", "Cascade", "workspace rules", "documentación con IA", "documentación de Devin"]
---

Convierte Devin Desktop en un experto en documentación que comprenda tu guía de estilo, tus componentes y el contexto de tu proyecto mediante workspace rules y memories.

<Info>
  Cognition adquirió Windsurf y lo rebautizó como [Devin Desktop](https://devin.ai/desktop). El asistente de IA Cascade y el sistema de workspace rules permanecen sin cambios.
</Info>

<div id="use-devin-desktop-with-mintlify">
  ## Usa Devin Desktop con Mintlify
</div>

Puedes ajustar el asistente de IA Cascade de Devin Desktop para redactar documentación conforme a tus estándares utilizando componentes de Mintlify. Las reglas del espacio de trabajo y las memorias proporcionan contexto persistente sobre tu proyecto, lo que garantiza sugerencias más consistentes de Cascade.

* **Reglas del espacio de trabajo**: residen en tu repositorio de documentación, por lo que todo tu equipo las comparte.
...
Crea reglas del espacio de trabajo en el directorio `.devin/rules` de tu repositorio de documentación. Devin Desktop sigue admitiendo las reglas de `.windsurf/rules` por retrocompatibilidad. Consulta [Memories & Rules](https://docs.devin.ai/desktop/cascade/memories) en la documentación de Devin Desktop para obtener más información.
...
Guarda tu regla como un archivo `.md` en el directorio `.devin/rules` de tu repositorio de documentación.
...
Una vez que tengas tus reglas configuradas, puedes usar Cascade para asistir en diversas tareas de documentación. Consulta [Cascade](https://docs.devin.ai/desktop/cascade/cascade) en la documentación de Devin Desktop para obtener más información.
...
Conecta el servidor MCP de Mintlify a Devin Desktop para darle a Cascade acceso a buscar en la documentación de Mintlify mientras te ayuda a escribir. Cuando conectas el servidor MCP, Cascade busca en la documentación más reciente de Mintlify para obtener contexto, de modo que no tengas que salir de tu IDE para consultar la documentación.

Agrega el servidor MCP a `~/.codeium/windsurf/mcp_config.json`:
...
Consulta [Model Context Protocol](https://docs.devin.ai/desktop/cascade/mcp) en la documentación de Devin Desktop y [Model Context Protocol](/es/ai/model-context-protocol) en la documentación de Mintlify para obtener más detalles.
