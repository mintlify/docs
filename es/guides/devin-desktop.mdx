...
<Info>
  Windsurf fue adquirido por Cognition y rebautizado como [Devin Desktop](https://devin.ai/desktop). El asistente de IA Cascade y el sistema de workspace rules permanecen sin cambios.
</Info>
...
Crea reglas del espacio de trabajo en el directorio `.devin/rules` de tu repositorio de documentación. Las reglas de `.windsurf/rules` siguen siendo compatibles por retrocompatibilidad. Consulta [Memories & Rules](https://docs.devin.ai/desktop/cascade/memories) en la documentación de Devin Desktop para obtener más información.
