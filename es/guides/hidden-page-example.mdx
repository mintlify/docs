...
Consulta [Páginas ocultas](/es/es/guides/hidden-pages) para más información.
...
<Note>
  De forma predeterminada, las páginas ocultas son de acceso público, pero no se pueden descubrir mediante la navegación. Si deseas restringir el acceso a una página oculta, debes configurar la [autenticación](/es/es/authentication-personalization/authentication-setup).
</Note>
