...
Puedes entrenar Claude Code para que comprenda tus estándares y flujos de trabajo de documentación añadiendo un archivo `CLAUDE.md` a tu proyecto y perfeccionándolo con el tiempo.
