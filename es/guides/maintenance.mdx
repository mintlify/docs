...
description: "Mantén tu documentación precisa y al día con calendarios de revisión, modelos de responsabilidad, comprobaciones automatizadas y gestión del ciclo de vida."
...
<Tip>
  Usa [automatizaciones](/es/automations) para ejecutar verificaciones de mantenimiento automatizadas de forma programada: marcando contenido obsoleto, verificando metadatos faltantes o detectando páginas con puntuaciones de retroalimentación consistentemente bajas.
</Tip>
