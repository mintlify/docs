...
sidebarTitle: "Codex"
description: "Configura la CLI de OpenAI Codex con instrucciones de proyecto y MCP para redactar documentación de Mintlify según tu guía de estilo."
...
Agrega el servidor MCP a tu configuración global de Codex en `~/.codex/config.toml`:
