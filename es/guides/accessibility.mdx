---
title: "Accesibilidad"
description: "Crea documentación que el mayor número posible de personas pueda usar cumpliendo con WCAG."
---

Cuando creas documentación accesible, priorizas un diseño de contenido que haga tu documentación utilizable por el mayor número posible de personas, sin importar cómo accedan o interactúen con ella.

La documentación accesible mejora la experiencia de usuario para todos. Tu contenido es más claro, mejor estructurado y más fácil de navegar.

Esta guía ofrece algunas prácticas recomendadas para crear documentación accesible, pero no es exhaustiva. Debes considerar la accesibilidad como un proceso continuo. Las tecnologías y los estándares cambian con el tiempo, lo que aporta nuevas oportunidades para mejorar la documentación.
