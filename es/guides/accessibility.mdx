---
title: "Accesibilidad"
description: "Crea documentación que pueda usar la mayor cantidad posible de personas cumpliendo con WCAG."
...
```mdx
<!-- Bueno -->
![Captura de pantalla del dashboard que muestra tres proyectos activos y dos invitaciones pendientes](/images/obama.jpg)

<!-- No es útil -->
![Captura de pantalla del dashboard](/images/obama.jpg)
```
...
```mdx
![Descripción de la imagen](/images/obama.jpg)
```
