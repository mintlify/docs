...
* **Integraciones con Slack**: Añade el [agent](/es/agent/slack) a Slack para hacer preguntas y capturar conocimiento a partir de las conversaciones.
...
Añade el agente a tu espacio de trabajo de [Slack](/es/agent/slack) para que tu equipo pueda hacer preguntas y actualizar contenido sin salir de Slack. Añade el bot `@mintlify` a un canal para usarlo de forma colaborativa, o envíale un mensaje directo para usarlo en privado.
