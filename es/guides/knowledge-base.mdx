...
Si tu equipo utiliza Slack, puedes añadir la [aplicación de Slack](/es/ai/slack-app) a tu espacio de trabajo. Esto permite que tu equipo realice búsquedas en tu base de conocimientos sin salir de Slack.
