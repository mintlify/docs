...
description: "Copia y adapta plantillas MDX listas para usar: guías prácticas, tutoriales, explicaciones de conceptos y referencias de API en tu documentación."
