...
<Tip>
  Usa un [flujo de trabajo](/es/agent/workflows) para ejecutar una auditoría SEO semanal que revise metadata faltante o débil y abra un pull request con mejoras.
</Tip>
