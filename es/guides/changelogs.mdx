...
<Frame>
  <img 
    ...
    alt="Registro de cambios con tabla de contenido mostrada en modo claro." 
    className="block dark:hidden" 
  />
  <img 
    src="/images/changelog-toc-dark.png" 
    alt="Registro de cambios con tabla de contenido mostrada en modo oscuro." 
...
<Frame>
  <img 
    ...
    alt="Registro de cambios en modo claro con el filtro de la etiqueta Peppermint seleccionado." 
    className="block dark:hidden" 
  />
  <img 
    src="/images/changelog-filters-dark.png" 
    alt="Registro de cambios en modo oscuro con el filtro de la etiqueta Peppermint seleccionado." 
    className="hidden dark:block" 
  />
</Frame>
...
<Frame>
  <img 
    ...
    alt="Página de registro de cambios en modo claro con el botón del feed RSS habilitado." 
    className="block dark:hidden" 
  />
  <img 
    src="/images/changelog-rss-button-dark.png" 
    alt="Página de registro de cambios en modo oscuro con el botón del feed RSS habilitado." 
    className="hidden dark:block" 
  />
</Frame>
