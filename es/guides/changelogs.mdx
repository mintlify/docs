...
Crea un registro de cambios para tu documentación añadiendo [componentes de actualización](/es/es/components/update) a una página.

Consulta el [registro de cambios de Mintlify](/es/es/changelog) como ejemplo: en cada actualización puedes incluir enlaces, imágenes, texto y demostraciones de tus nuevas funciones.
