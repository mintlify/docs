...
<Tabs>
  <Tab title="Usar el editor web">
    ...
    El menú desplegable lista los branches creados en el editor y los branches con una solicitud de extracción abierta dirigida a tu rama de implementación. Consulta [Una rama no aparece en la lista de ramas del editor web](/es/help-center/branch-missing-from-editor-branch-list).
