...
<Tabs>
  <Tab title="Usar el editor web">
    ...
    El menú desplegable solo muestra los branches creados en el editor web y los branches con un pull request o merge request abierto dirigido a tu rama de implementación. Los branches enviados directamente a GitHub, GitLab o Bitbucket sin un pull request abierto siguen existiendo en tu repositorio, pero no aparecen en el menú desplegable. Para abrir uno de estos branches en el editor, abre un pull request para él en tu proveedor de Git, o abre cualquier branch en el editor y reemplaza el nombre del branch en la URL de tu navegador por el branch que quieras.
