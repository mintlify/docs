...
The most common method of setting up OpenAPI with Mintlify is to add your OpenAPI documents directly to your docs repo.

### On the web

If you have a publicly-hosted OpenAPI document that serves as the single-source-of-truth for your API, you can use that in your docs through the document URL. You can then reference endpoints in this OpenAPI document just as you would with documents stored in the repository.
