...
To create pages for your websockets, you must have a valid AsyncAPI schema document in eiofr JSON or YAML format that follows of [AsyncAPI specification 3.0+](https://www.asyncapi.com/docs/reference/specification/v3.0.0).
