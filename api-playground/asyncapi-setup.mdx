...
You can also add the `asyncapi` property to groups nested inside other groups. Mintlify generates the channel pages and adds them to the nested group, alongside any existing pages.
