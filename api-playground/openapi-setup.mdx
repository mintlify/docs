...
Configure how individual endpoints appear in your [MCP server](/ai/model-context-protocol) by adding `x-mint: mcp` to any operation. This allows you to customize the name and description used by AI tools when they search your API documentation.
      ...
      "get": {
        ...
        "x-mint": {
          "mcp": {
            "enabled": true,
            "name": "search_users",
            "description": "Search for users by name, email, or ID. Use this to find specific users or list all users with pagination."
          }
        }
      }
    }
...
<ResponseField name="enabled" type="boolean">
  Whether to include this endpoint in the MCP server. Defaults to `true`.
</ResponseField>

<ResponseField name="name" type="string">
  The name of the tool as it appears to AI applications. Defaults to the operation's `operationId`.
</ResponseField>

<ResponseField name="description" type="string">
  A description of when and how to use this endpoint. AI tools use this to determine when to call the endpoint.
</ResponseField>

<Tip>
  You can also use the standalone `x-mcp` extension instead of `x-mint.mcp`. If both are present, `x-mint.mcp` takes precedence.
</Tip>
