...
You can reference multiple OpenAPI specifications to create pages for your API endpoints. Each specification file generates its own set of endpoints.

Add one or more OpenAPI specifications to your documentation repository and reference them in the navigation element of your `docs.json`.
