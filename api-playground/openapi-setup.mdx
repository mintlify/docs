...
You can create API endpoint pages from a single or multiple OpenAPI specifications.
...
This approach is useful when you need individual endpoints from different specifications or only want to include select endpoints.
