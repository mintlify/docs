...
You do not need to configure anything to display callbacks. If your OpenAPI specification defines `callbacks` on an operation, they appear automatically on the generated endpoint page.
...
Example callback definition on an operation:
