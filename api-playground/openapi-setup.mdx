...
The method and path must exactly match your OpenAPI spec. If you have multiple OpenAPI specifications, include the path in your reference. External OpenAPI URLs can be referenced in `docs.json`.
