...
Every parameter in the API playground has a clickable anchor link. Hover over a parameter name to reveal the link icon, then select it to copy a direct URL to that parameter.
