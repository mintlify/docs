...
If you're using OpenAPI, setup will look a bit different. Check out our guide [here](/api-playground/openapi).
...
<CodeGroup>
  ...
  ```
  ```json Multiple
  "openapi": ["/openapi1.json", "/openapi2.json", "/openapi3.json"]
  ```
</CodeGroup>
