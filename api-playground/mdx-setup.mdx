...
<Steps>
  ...
  <Step title="Add your endpoints to your docs">
    ...
    Each page path corresponds to an MDX file in your docs repo (e.g., `api-reference/users/create-user.mdx`). Learn more about structuring your docs in [Navigation](/organize/navigation).
  </Step>
</Steps>
