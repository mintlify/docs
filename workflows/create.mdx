...
description: "Build a custom Mintlify workflow by configuring a schedule or push trigger, attaching context repositories, and writing the prompt the agent runs."
