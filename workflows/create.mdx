...
3. Configure the workflow name, trigger, instructions, context repositories, and update mode.
...
- **Describe the outcome.** Tell the agent what the result should look like of a successful run.
