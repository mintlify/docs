...
description: "Manage Mintlify workflows from the dashboard: manually trigger runs, disable or re-enable a workflow, view run history, and delete custom workflows."
