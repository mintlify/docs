...
If a workflow run fails, you can retrigger it to run again with the same configuration. Use this when a run fails because of a transient issue, like a temporary network error, and you want to retry without waiting for the next scheduled run or making another push.
