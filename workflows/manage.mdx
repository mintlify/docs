...
If your project runs out of Mintlify credits while a workflow is running, the run fails on the credit check and every active workflow on the project is automatically disabled. Mintlify also emails everyone in your organization to let them know workflows have been paused.

To bring workflows back online, top up or upgrade your credits, then re-enable each workflow from the [Workflows](https://dashboard.mintlify.com/products/workflows?tab=workflows) page. Workflows that were disabled because of credit exhaustion are not re-enabled automatically when your credits refill.
