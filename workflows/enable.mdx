...
<Steps>
  <Step>
    <Frame>
      ![Screenshot 2026 05 19 At 3 40 12 PM](/images/Screenshot-2026-05-19-at-3.40.12-PM.png "Screenshot 2026 05 19 At 3 40 12 PM")
    </Frame>
  </Step>
  <Step>
  </Step>
...
2. Click the toggle beside a workflow to enable it.
   ...
   <Frame>
     <img
       alt="The configuration options for the codebase updates workflow."
       className="block dark:hidden"
       src="/images/workflows/workflow-settings-light.png"
     />
     <img
       alt="The configuration options for the codebase updates workflow."
       className="hidden dark:block"
       src="/images/workflows/workflow-settings-dark.png"
     />
   </Frame>
