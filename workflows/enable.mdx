...
Context repositories are supported on the changelog workflow. Use them when the agent needs information that lives outside your documentation repository, such as a product codebase that drives release notes.
