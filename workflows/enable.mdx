...
description: "Enable Mintlify built-in workflows for your project: connect GitHub or GitLab, choose triggers, add context repositories, and set automerge or schedules."
