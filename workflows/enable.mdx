...
To change settings for an active workflow, click the <Icon icon="gear" /> settings button beside it. Use the toggle at the top of the settings panel to enable or disable the workflow.
