...
description: "Enable Mintlify workflows on a project, configure cron schedules and push triggers, connect context repositories, and turn on automerge for the agent."
