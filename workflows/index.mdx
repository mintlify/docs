...
description: "Automate documentation maintenance tasks with the Mintlify agent on a schedule or in response to repository pushes for GitHub and GitLab projects."
