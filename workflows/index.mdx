---
title: "Overview"
description: "Run the Mintlify agent automatically with workflows. Schedule recurring jobs with cron or trigger runs on pushes and merges to GitHub or GitLab repos."
