...
Workflow runs consume Mintlify credits. When your organization runs out of credits:

- The in-progress run fails.
- Every active workflow on the deployment is automatically disabled.
- Every member of the organization receives an email notification.

Re-enable workflows from the [Workflows](https://app.mintlify.com/products/workflows?tab=workflows) page after you top up credits or upgrade your plan.
