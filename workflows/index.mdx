...
<CardGroup cols={2}>
  <Card title="Enable workflows" icon="toggle-right" href="/workflows/enable">
  ...
  <Card title="Manage workflows" icon="settings" href="/workflows/manage">
    Disable, delete, and view the run history for your workflows.
  </Card>
</CardGroup>
