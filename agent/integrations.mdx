...
description: "Connect third-party apps so the agent can pull live context from Slack, Notion, Linear, Jira, and other tools when answering questions and updating docs."
