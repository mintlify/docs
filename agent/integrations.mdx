...
- **Shared integrations** are connected once for your entire organization. Anyone on the team can prompt the agent to use them. Slack, Notion, Linear, Jira, Salesforce, Intercom, and Plain are shared.
...
Admins and editors can connect shared integrations on behalf of the organization. Each teammate connects personal integrations individually: connecting Google Calendar enables it only for your own prompts, not for anyone else in your organization.
