...
description: "Connect third-party apps so the agent can pull live context from Slack, Notion, Linear, Jira, Confluence, and other tools when answering questions and updating content."
