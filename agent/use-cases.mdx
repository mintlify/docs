...
## Trigger updates from Linear issues

Mention the agent in a Linear issue comment to create documentation updates based on the issue context. This is useful when your team tracks feature work in Linear and wants to keep docs in sync.

For example: `@mintlify Document this new API endpoint based on the details in this issue`.

## Trigger updates from Jira issues

Mention the agent in a Jira issue comment to create documentation updates based on the issue context. This is useful when your team tracks feature work in Jira and wants to keep docs in sync.
