...
Use the agent endpoints to [create jobs](/api-reference/agent/v2/create-agent-job), [get a specific job](/api-reference/agent/v2/get-agent-job), and [send a message](/api-reference/agent/v2/send-message).
