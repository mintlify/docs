...
Attach a screenshot to your message and ask the agent about its contents. The agent reads the image and uses it as context, whether or not you want the image itself added to your docs.

For example: `@mintlify Does this error message match what we document in the troubleshooting guide?` with a screenshot of the error attached.
