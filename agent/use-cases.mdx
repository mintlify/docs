...
Attach files or images directly to your message when prompting the agent. The agent processes the attachment and includes it in the documentation.

You can attach files in the agent panel chat in your dashboard or in Slack:

- **Dashboard**: Open the agent panel, then add files using the attachment button in the chat input or by pasting them directly into the message field.
- **Slack**: Upload files to your message in the same way that you would share any other Slack attachment.

Supported file types:
- **Images**: JPEG, PNG, GIF, WebP, SVG
- **Documents**: PDF
- **Code and text files**: JavaScript, TypeScript, Python, HTML, CSS, Markdown, MDX, JSON, YAML, XML, SQL, CSV, plain text, shell scripts, and other common code formats
