...
Use the agent endpoints to [create jobs](/api/agent/v2/create-agent-job), [get a specific job](/api/agent/v2/get-agent-job), and [get all jobs](/api/agent/v2/get-agent-job).
