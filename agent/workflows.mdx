...
2. Click **View workflows** to see your workflow list.
3. Click on the workflow you want to run to open its edit page.
4. Click the <Icon icon="play" /> button to trigger the workflow.
...
1. Go to the [Workflows](https://dashboard.mintlify.com/products/workflows) page in your dashboard.
2. Click **View workflows** to see your workflow list.
3. Click on the workflow you want to disable or enable.
4. Toggle the **Active** switch at the bottom of the form.
