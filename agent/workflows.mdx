...
For GitHub repositories, you must have the Mintlify GitHub App installed on every repository listed as a context repository or push trigger. Add new repositories on the [GitHub app](https://dashboard.mintlify.com/settings/organization/github-app) page of your Mintlify dashboard.
...
The following examples show effective prompts for common workflow use cases. Create these workflows from the [dashboard](https://dashboard.mintlify.com/products/workflows) with the appropriate trigger and context configuration.
...
**Trigger:** On push to your product repository. **Context:** Your docs repository.
...
**Trigger:** On push to your docs repository.
...
**Trigger:** Cron schedule (e.g., weekly). **Context:** Your product repository. **Slack notifications:** Enabled.
