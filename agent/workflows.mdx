...
For GitHub repositories, you must have the Mintlify GitHub App installed on every repository listed in the context or trigger fields. Add new repositories on the [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) page of your Mintlify dashboard.

For GitLab repositories, you must connect your GitLab account on the [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) page in your Mintlify dashboard. Then add the repositories you want to use with workflows. You must have at least the Maintainer role on each project to connect GitLab OAuth.
...
<Note>
  ...
  For GitLab repositories, automerge uses the GitLab OAuth connection configured on the [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) page of your Mintlify dashboard. You must have at least the Maintainer role on each project to connect GitLab OAuth.
</Note>
...
To use GitLab repositories in a workflow, connect each project through the GitLab OAuth integration on the [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) page of your dashboard. You must connect every repository the workflow touches, including your documentation repository and any trigger or context repositories.
