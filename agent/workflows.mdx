...
- Describe the outcome you want thea agent to achieve.
...
Catch style guide violations before they accumulate. This example runs on every merge, automatically fixes style guide violations that don't require editorial judgment, and lists any violations that require human judgment in the PR body.
