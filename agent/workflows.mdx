...
3. Choose a template to get started, or select **Custom workflow** to build from scratch.
4. Configure the trigger, prompt, and other settings, then click **Create workflow**.
...
| Enforce styleguide | Schedule | Enforce consistent writing style and tone |
| Typo check | Schedule | Scan docs for spelling errors and broken formatting |
| Broken link detection | Schedule | Find and flag broken links across documentation |
| SEO & metadata audit | Schedule | Check and fix page titles, descriptions, and OpenGraph metadata |
