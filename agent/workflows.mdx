...
<Info>
  Workflows are in beta. They are currently available on [Enterprise plans](https://mintlify.com/pricing).

  [Contact us](mailto:gtm@mintlify.com) to enable workflows for your organization.
</Info>
...
You can have up to 10 active workflows. Each workflow can run up to 20 times a day. Runs that fail do not count toward this limit.
...
On the [Workflows](https://dashboard.mintlify.com/products/workflows) page of your dashboard, click the **New workflow** button.
...
Run a workflow when changes are pushed to a specific repository and branch. This includes both pull request merges and direct pushes to the branch.
...
Runs when changes are pushed to your documentation repository to catch style guide violations before they accumulate. This example workflow automatically fixes style guide violations and lists any violations that require human judgment in the PR body.
