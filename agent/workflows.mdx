...
You can also trigger a scheduled workflow manually from the workflow detail page in your dashboard. Click **Trigger manually** to start a run immediately without waiting for the next scheduled time.
