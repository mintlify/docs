...
### Create a workflow with the CLI

Run `mint workflow` to create a new workflow interactively. The CLI prompts you for the workflow name, trigger type, context repositories, automerge setting, and agent instructions, then creates the workflow file in `.mintlify/workflows/`.
