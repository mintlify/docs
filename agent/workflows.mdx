...
- **Public GitHub repositories**: Any public repository on GitHub.com. Public context repositories don't require the Mintlify GitHub App to be installed. Enter the repository as `owner/repo` or paste a full GitHub URL. Mintlify validates that the repository is public before adding it.
