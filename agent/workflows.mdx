...
Workflows created in the dashboard are stored in Mintlify and don't require a workflow file in your repository. You can edit or delete these workflows directly from the dashboard.
...
You can view, edit, and delete workflows from the [Workflows](https://dashboard.mintlify.com/products/workflows) page.

Workflows created in the dashboard can be edited or deleted directly. Workflows created from a file in your repository can only be modified by updating the workflow file in your repository. To delete a git-sourced workflow, remove or rename the file in your repository.
