...
Workflow capacity depends on your Mintlify plan.

| Plan | Maximum workflows | Monthly run limit |
|------|-------------------|-------------------|
| Hobby | 20 | 5,000 |
| Pro | 20 | Unlimited |
| Growth | 20 | Unlimited |
...
The maximum workflows count is the number of distinct workflow configurations you can have at one time across your organization. Disable or delete workflows you no longer need to free up capacity.

The monthly run limit applies to total successful workflow runs across all workflows in your organization, including manually triggered runs. Failed runs do not count toward this limit.
