...
You can add two types of context repositories:

- **Connected repos**: Repositories in your organization that are connected through the Mintlify GitHub App or GitLab OAuth. Use connected repos for private source code, internal tooling, or other repositories your team owns.
