...
To use GitLab repositories in a workflow, connect each project through the GitLab OAuth integration on the [Git settings](https://dashboard.mintlify.com/settings/deployment/git-settings) page. You must connect every repository the workflow touches, including your documentation repository and any trigger or context repositories.
