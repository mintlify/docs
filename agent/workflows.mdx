...
2. Click **New workflow** and select a template.
...
5. Set up Slack notifications. If Slack is not connected, you can install the Slack app directly from this step. You can also skip this and set it up later.
...
<Note>
Slack notifications require the Mintlify Slack app on your organization. You can install the Slack app directly from the workflow creation or editing page, or from your [dashboard settings](https://dashboard.mintlify.com/products/agent).
</Note>
...
2. Search for and select the channels you want to notify. You can add up to 10 channels.
3. Save your workflow.

If Slack is not yet connected, the dashboard prompts you to install the Mintlify Slack app. Clicking **Install slack app** opens the Slack authorization flow in a new tab. Once authorized, the page updates automatically and you can select channels without leaving the workflow page.
