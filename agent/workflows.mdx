...
Prompt the agent to begin a project, then check out the branch it creates and finish the task in your local environment. The agent can help you get started, then you can take over to complete the task.
