...
For GitLab repositories, connect your projects through [GitLab OAuth](https://dashboard.mintlify.com/settings/organization/gitlab-oauth) in your dashboard settings. Alternatively, you can use the [GitLab integration](/deploy/gitlab) with an access token and webhook.
