...
3. Choose a workflow template or select **Custom workflow** to start from scratch.
4. Configure the trigger, repositories, and implementation method for your workflow.
5. Review or customize the agent prompt, then click **Create workflow**.
...
Templates provide pre-configured prompts for common documentation tasks. Each template includes a default trigger type and agent instructions that you can customize.

| Template | Trigger | Description |
|----------|---------|-------------|
| Changelog | Schedule | Generate changelog entries from merged PRs and commit messages. |
| API docs sync | PR merges | Update API reference docs when OpenAPI spec or source code changes. |
| Draft feature docs | PR merges | Draft documentation for new features when code ships. |
| Translations | PR merges | Translate documentation into other languages when content changes. |
| Enforce styleguide | Schedule | Check for consistent writing style and tone across docs. |
| Typo check | Schedule | Scan docs for spelling errors and broken formatting. |
| Broken link detection | Schedule | Find and fix broken internal links. |
| SEO & metadata audit | Schedule | Check and fix page titles, descriptions, and metadata. |
| Custom workflow | You decide | Build a workflow from scratch with your own configuration. |

<Tip>
Templates are a starting point. Customize the prompt to match your documentation structure and style guide after selecting a template.
</Tip>
