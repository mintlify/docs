...
- Node.js and Bun
- Built-in search over your deployment's indexed documentation

The agent can search your existing documentation to find relevant pages and sections before making edits. This helps the agent understand what content already exists and where to make changes.
