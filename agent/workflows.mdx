...
Send Slack messages when a workflow opens a pull request for review and when one merges. Notifications include a link to the pull request and a summary of the changes.
...
#### Global notifications for all workflows

Configure a default set of Slack channels to receive notifications from every workflow. This is useful when you want a single team channel to track all workflow activity.

1. Open the [Workflows](https://dashboard.mintlify.com/products/workflows) page in your dashboard.
2. Click **Notifications** in the top-right of the Workflows tab.
3. If you haven't connected Slack, click **Connect Slack**.
4. Search for and select the channels you want to notify.
5. Click **Save changes**.

Selected channels apply to every workflow in the organization. To stop sending global notifications, remove all channels and save.
