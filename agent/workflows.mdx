...
You can configure Slack notifications when creating or editing a workflow in the dashboard. Select the channels you want to notify from the dropdown menu.

For additional notification options like direct messages to users, configure the `notify` field in your workflow file:
