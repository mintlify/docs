...
Run a workflow when changes push to a specific repository or branch. This includes both pull request merges (or merge request merges for GitLab) and direct pushes to the branch. Push triggers work with both GitHub and GitLab repositories.
