...
For GitLab repositories, you must connect your GitLab account via OAuth in your organization's [GitLab settings](https://dashboard.mintlify.com/settings/organization/gitlab-oauth) and add the repositories you want to use. The user who connects GitLab OAuth must have at least the Maintainer role on each project.
...
<Note>
  ...
  For GitLab repositories, automerge uses the GitLab OAuth connection configured in your organization's [GitLab settings](https://dashboard.mintlify.com/settings/organization/gitlab-oauth). The user who connected GitLab OAuth must have at least the Maintainer role on the project to merge merge requests.
</Note>
