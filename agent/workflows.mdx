...
<Info>
  Workflows are in beta. They're currently free for [Pro and Enterprise plans](https://mintlify.com/pricing) during the beta period. Workflow features and pricing are subject to change.
</Info>
...
Pro plans include up to two active workflows. Enterprise plans include up to 10 active workflows. Each workflow can run up to 50 times a day. Runs that fail do not count toward this limit.
