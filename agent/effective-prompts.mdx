...
description: "Write clear, specific prompts to get better results from the documentation agent, with examples of effective instructions and common patterns."
