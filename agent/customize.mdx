...
<Note>
  `AGENTS.md` applies to the asynchronous agent that opens pull requests. The editor's [built-in agent](/editor/agent) does not read `AGENTS.md`. To give the editor agent persistent guidance, configure [AI instructions](/editor/settings#ai-instructions) in editor settings instead.
</Note>
...
<Note>
  The editor's [built-in agent](/editor/agent) does not read `AGENTS.md`. To give the editor agent persistent guidance, configure [AI instructions](/editor/settings#ai-instructions) in editor settings instead.
</Note>
