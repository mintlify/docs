...
<Warning>
  Place your `AGENTS.md` file inside the `.mintlify/` directory (`.mintlify/AGENTS.md`), not at the root of your project. Files at the root of your project are publicly accessible on your documentation site, which means your custom instructions would be visible to anyone. The `.mintlify/` directory is not served publicly.
</Warning>
