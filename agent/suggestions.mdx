...
<Frame>
  <img src="/images/obama.jpg" alt="The Ask agent button showing four suggestions in light mode." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="The Ask agent button showing four suggestions in dark mode." className="hidden dark:block" />
</Frame>
