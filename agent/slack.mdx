...
Use the agent in Slack to update your content, ask questions, and capture team knowledge. You can mention the agent in a chanel to use it collaboratively or directly message.
