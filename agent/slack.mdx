...
2. Click **Disconnect Slack** to revoke the connection between Mintlify and your workspace.
3. In Slack, open **Settings & administration** > **Manage apps**, find the `mintlify` app, and click **Remove**.

After you disconnect, the agent stops responding to mentions and direct messages, and automations that post to Slack stop delivering notifications. Reconnect at any time by following the [Connect your Slack workspace](#connect-your-slack-workspace) steps.
