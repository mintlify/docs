...
Your preferred project is personal to your Slack account and does not affect
other team members. You can switch to a different project at any time during a
conversation by clicking **Switch** next to the project name on the agent's status
message in the thread. The agent retains your conversation history so you can
continue where you left off with the new project.

You can also share a link to a pull request in any connected project. The agent switches to that project automatically and continues the PR.
</Tip>
