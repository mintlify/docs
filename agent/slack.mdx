...
description: "Install the Mintlify agent in Slack to ask questions about your docs, create content updates from team conversations, and capture knowledge in pull requests."
