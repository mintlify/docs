...
<Note>
  The agent supports both GitHub and GitLab as Git providers. You must configure both through Mintlify, not Composio. Use the [GitHub app](/deploy/github) or [GitLab integration](/deploy/gitlab) to control which repositories the agent can access.
</Note>
