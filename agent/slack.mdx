...
While the agent works on your request, it provides live feedback directly in Slack:
...
- **Questions**: If the agent needs more information, it presents options you can select directly in Slack. You can also reply in the thread with a custom answer.
