...
Use the agent in Slack to update your content, ask questions, and capture team knowledge. Mention the agent in a channel to use it collaboratively, or send it a direct message to use it privately. Agent conversations in Slack are free and don't count toward your organization's [credit balance](/credits).
