...
If you share a link to a pull request in any connected project, the agent switches to that project automatically and continues working on the branch that the pull request targets.
</Tip>
