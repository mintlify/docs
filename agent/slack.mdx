...
description: "Add the Mintlify agent to Slack to ask questions, create content updates from conversations, and capture team knowledge."
...
Use the agent in Slack to update your content, ask questions, and capture team knowledge. You can mention the agent in a channel to use it collaboratively or directly message it.
