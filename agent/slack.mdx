...
<Tip>
  The Slack app and third-party integrations work together. Install the Slack app to talk with the agent and give it access to permitted Slack content. Then connect [integrations](/automations/integrations) so the agent can also use context from apps like Notion, Jira, Linear, or Google Drive.
</Tip>
...
- "Compare this Linear issue with the launch plan in my Google Drive."
