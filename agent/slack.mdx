...
1. Open the agent panel in your dashboard.
2. Click the **Settings** button.
3. In the Slack integration section, click **Disconnect**.
4. Confirm the removal when prompted.

Disconnecting removes the Mintlify app from your Slack workspace and unlinks all connected user accounts.
