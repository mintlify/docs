...
<Note>
  When you first enable the agent, teammates in your Mintlify organization whose email matches a Slack account in your workspace receive an introductory direct message from the agent. New members invited to your Mintlify organization also receive a direct message once they have a matching Slack account. For organizations with more than 50 members, this introduction is limited to Slack workspace admins and owners.
</Note>
