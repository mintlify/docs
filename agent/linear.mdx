...
description: "Connect the Mintlify agent to Linear to automatically draft documentation updates from issues, comments, and project activity in your workspace."
