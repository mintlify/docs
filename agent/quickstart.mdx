...
<Frame>
  <img src="/images/obama.jpg" alt="Views in the agent panel: new chat, suggestions, history, and settings." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Views in the agent panel: new chat, suggestions, history, and settings." className="hidden dark:block" />
</Frame>
