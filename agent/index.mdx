...
<Info>
  The agent is available on [Pro plans and above](https://mintlify.com/pricing?ref=agent) for anyone with access to your dashboard. Trial users also have access to the agent during their trial period.
</Info>
