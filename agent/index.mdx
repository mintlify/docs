...
The agent can only access repositories that you connect through the Mintlify GitHub App. Configure which repositories the agent can access in the [GitHub App settings](https://github.com/apps/mintlify/installations/new), or in [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) for GitLab.
