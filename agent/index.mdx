...
Contact Mintlify to enable static agent egress for your deployment. Once enabled, the static address applies to Git operations from the agent and automations, including cloning, fetching, and pushing connected repositories.
