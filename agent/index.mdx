...
The agent is an AI tool that creates pull requests with proposed changes to your documentation based on your prompts.
...
<Card title="Connect integrations" icon="plug" horizontal href="/agent/integrations">
...
<Card title="Automate with workflows" icon="refresh-cw" horizontal href="/workflows/index">
