...
description: "Use the Mintlify agent to draft, edit, and maintain documentation through pull requests triggered from Slack, GitHub PRs, the dashboard, or API calls."
