...
Trigger documentation updates from Jira issues.
</Card>
<Card title="Connect Linear" horizontal icon="square-kanban" href="/agent/linear">
Trigger documentation updates from Linear issues.
</Card>
<Card title="Connect GitHub PRs" horizontal icon="github" href="/agent/github-pr">
Trigger documentation updates from pull request comments.
</Card>
