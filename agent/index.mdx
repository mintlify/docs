...
In the editor's agent panel, you can interact with each message:

- **Copy**: Copy a message to your clipboard to reuse the content. Assistant messages preserve code block formatting when you paste them into the editor.
...
Copy and feedback buttons appear on each message after the response finishes streaming.
