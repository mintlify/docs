---
title: "What is Mintie bot?"
description: "Automate documentation updates with Mintie bot. Create updates from Slack messages, PRs, or API calls."
keywords: ["automation", "automate", "AI", "autoupdate", "maintenance"]
---

<Info>
  Mintie bot is available on [Enterprise plans](https://mintlify.com/pricing?ref=agent) for anyone with access to your dashboard.
</Info>

Mintie bot is an AI tool that creates pull requests with proposed changes to your documentation based on your prompts. When you send a request, Mintie bot:
...
All changes go through pull requests. Mintie bot never commits directly to your main branch.

## What you can do with Mintie bot
...
By default, Mintie bot opens pull requests attributed to the Mintlify bot. To attribute pull requests to you, connect your GitHub account on the [My profile](https://dashboard.mintlify.com/settings/account) page of the dashboard.

## Connect repositories as context

Mintie bot can only access repositories that you connect through the Mintlify GitHub App. Configure which repositories Mintie bot can access in the Mintie bot panel **Settings** or in the [GitHub App settings](https://github.com/apps/mintlify/installations/new).

## Next steps

<Card title="Connect Slack" horizontal icon="slack" href="/agent/slack">
Add Mintie bot to your Slack workspace.
</Card>
<Card title="Customize behavior" horizontal icon="wrench" href="/agent/customize">
Configure Mintie bot with an `AGENTS.md` file.
</Card>
