...
description: "Automate documentation updates with the agent. Create updates from Slack messages, Linear issues, PRs, or API calls."
...
- Write new content based on your prompts, pull requests, Slack threads, Linear issues, or file attachments.
...
- Capture knowledge from Slack conversations, Linear issues, and pull requests before it gets lost.
