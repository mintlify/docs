...
description: "Automate documentation updates with the agent. Create updates from Slack messages, Linear issues, Jira issues, PRs, or API calls."
...
- Write new content based on your prompts, pull requests, Slack threads, Linear issues, Jira issues, or file attachments.
...
- Capture knowledge from Slack conversations, Linear issues, Jira issues, and pull requests before it gets lost.
...
<Card title="Connect Linear" horizontal icon="square-kanban" href="/agent/linear">
Add the agent to your Linear workspace.
</Card>
<Card title="Connect Jira" horizontal icon="ticket" href="/agent/jira">
Add the agent to your Jira workspace.
</Card>
