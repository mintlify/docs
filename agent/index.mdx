...
## Choose the model behind the agent

On Enterprise plans, you can supply your own LLM provider API key and choose the model that powers the agent and automations. See [Bring your own model](/ai/bring-your-own-model).
