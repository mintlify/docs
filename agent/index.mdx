...
description: "Automate documentation updates with the Mintlify agent. Trigger pull requests from Slack, GitHub, the dashboard, or the API for AI-driven edits."
