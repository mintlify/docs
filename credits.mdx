...
If you exhaust your monthly credits and overages are disabled, credit-powered features pause for the rest of the billing cycle. The assistant, editor and Slack agents, and automations stop responding to new requests. To resume, wait for credits to refresh at the start of the next month, upgrade to a higher tier, or enable overages.
