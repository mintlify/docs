...
When you change a page's published narratable content, the next listener generates an updated recording for another 50 credits. Failed generations cost nothing. If multiple readers start narration before Mintlify finishes and caches the first generation, each request may generate audio and consume 50 credits.
