...
The agent uses credits for each run you invoke. Conversations with the agent in Slack are free and never consume credits. The agent in the web editor is also free.
