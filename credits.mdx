...
Credit costs vary by task, so base your estimate on your own activity. Use the assistant, agent, and automations as you normally would, then open the [Usage](https://app.mintlify.com/settings/organization/usage) page to see what each feature consumed.

The **Activity log** section lists the credits consumed by each event. Multiply the cost of a typical event by your expected monthly volume to project what your organization needs. After a month of real usage, review the totals and adjust your add-on.
