...
The price is the same regardless of how much content the agent reads, how many passes it takes, or how long the action runs. Conversations with the agent in the editor or Slack do not consume credits.
