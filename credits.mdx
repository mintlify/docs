...
The free Starter plan does not include AI features and has no credit purchase path. To use the assistant, editor or Slack agents, or automations, upgrade to Pro.
