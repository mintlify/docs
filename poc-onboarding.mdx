...
| Identity or IT administrator | Configures DNS for a custom domain and connects your identity provider, if you test [authentication](/deploy/authentication-setup). | 1 to 2 hours |
