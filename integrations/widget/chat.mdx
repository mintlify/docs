...
Integrate the Mintlify widget into your products to offer users quick access to AI-powered chat with your docs content.

![widget](https://mintlify-assets.b-cdn.net/widget/hero.webp)

## Getting started

First you'll need to get an API key by visiting [the Mintlify dashboard](https://dashboard.mintlify.com/chat/widget-auth) and generating a new API key.
...
To use the widget in React and Next.js apps, please check out the React component from the `@mintlify/widget-react` package on [NPM](https://www.npmjs.com/package/@mintlify/widget-react). Here is a basic example of how to use the component in your React application:
