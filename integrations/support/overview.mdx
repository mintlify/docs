...
description: "Add customer support tools to your documentation"
---
...
## Setting Up Customer Support Tools

Want to help your users get support directly from your documentation? You can add support chat widgets to your docs pages. Here's how to do it:

1. Open your `mint.json` file
2. Add the `integrations` section as shown below
3. Insert your unique ID from your support tool
...
Need a different support tool? Let us know what you're looking for by joining [our community](https://join.slack.com/t/mintlify-users/shared_invite/zt-1xfzz6x35-f4o4WCYfpvLhSj3O7WAOMA).