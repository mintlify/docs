...
<CardGroup>
  <Card
    title="Plain"
    href="/integrations/support/plain"
    icon={<svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>}
    horizontal
  >
  </Card>
  <Card
...
The [Plain](/integrations/support/plain) integration works differently — it connects your Plain workspace to Mintlify through the dashboard so an AI agent can automatically resolve support threads using your documentation.
