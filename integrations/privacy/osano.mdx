...
Create an `osano.js` file anywhere inside your content directory with the following content. Mintlify automatically includes any `.js` file in your content directory on every page.
