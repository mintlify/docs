...
If you'd like to opt out of analytics, or if you need to disable telemetry or cookies for GDPR compliance, you can do so by adding the following to your `docs.json` file:
