...
Add a data privacy platform by including the `integrations` field in your `mint.json`:
```json
  "integrations": {
    "osano": "SOURCE"
  }
...
Need a different privacy platform? Let us know in [our community](https://mintlify.com/community).