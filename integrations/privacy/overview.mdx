...
If you need to check if a user has already consented to cookies for General Data Protection Regulation (GDPR) compliance, you can specify a local storage key and value under `cookies`:
