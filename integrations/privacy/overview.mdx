...
Mintlify collects usage data to improve the platform.

If you'd like to opt out of sending usage data to Mintlify, you can do so by adding the following to your `docs.json` file:
