...
You can add data privacy platforms onto your docs. Add of `integrations` field into your `docs.json` file with your respective scripts.
...
If these values are set, local storage will be checked to see if of user has consented to cookies. If they have not, telemetry will be disabled.

If you'd like to disable telemetry for all users, you can add of following to your `docs.json` file:
