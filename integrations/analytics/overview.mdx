...
description: "Connect your Mintlify documentation to analytics platforms like Google Analytics, Mixpanel, PostHog, and more to track visitor engagement."
...
<CardGroup cols={2}>
  <Card title="Adobe Analytics" icon='
    <svg
      className="h-6 w-6"
      width="16"
      height="16"
  ...
  ' horizontal href="/integrations/analytics/adobe">
  </Card>

  <Card title="Amplitude" icon={<svg className="h-6 w-6" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>} horizontal href="/integrations/analytics/amplitude">
  </Card>
...
<path d="M43 0.100006H80.4V161.5H43C28.1 161.5 22.7 159.9 17.2 157C11.7 154.1 7.5 149.8 4.5 144.3C1.6 138.8 0 133.4 0 118.4V43.2C0 28.2 1.6 22.8 4.5 17.3C7.4 11.8 11.7 7.50001 17.2 4.60001C22.7 1.70001 28.1 0.100006 43 0.100006Z" fill="#1CA7FD"/>
  ...
  ' horizontal href="/integrations/analytics/clearbit">
  </Card>

  <Card title="Fathom" icon='
<svg
className="h-6 w-6"
width="256"
height="256"
...
/>
  ...
  ' horizontal href="/integrations/analytics/google-analytics">
  </Card>
  ...
  ' horizontal href="/integrations/analytics/google-tag-manager">
  </Card>

  <Card title="Heap" icon='
    <svg
      className="h-6 w-6"
      width="32"
      height="32"
  ...
  ' horizontal href="/integrations/analytics/heap">
  </Card>

  <Card title="Hightouch" icon='
    <svg
      className="h-6 w-6"
      xmlns="http://www.w3.org/2000/svg"
      width="97"
  ...
  ' horizontal href="/integrations/analytics/hightouch">
  </Card>

  <Card title="Hotjar" icon='
    <svg
      className="h-6 w-6"
      width="51"
      height="57"
  ...
  ' horizontal href="/integrations/analytics/hotjar">
  </Card>

  <Card title="LogRocket" icon='
    <svg
      className="h-7 w-5"
      width="102"
      height="159"
  ...
  ' horizontal href="/integrations/analytics/logrocket">
  </Card>

  <Card title="Microsoft Clarity" icon='
...
<path d="M12 12H22V22H12V12Z" fill="#FFBA08"/>
  ...
  ' horizontal href="/integrations/analytics/clarity">
  </Card>

  <Card title="Mixpanel" icon='
    <svg
      className="h-6 w-6"
      width="24"
      height="24"
  ...
  ' horizontal href="/integrations/analytics/mixpanel">
  </Card>

  <Card title="Pirsch" icon='
    <>
      <svg
  ...
  ' horizontal href="/integrations/analytics/pirsch">
  </Card>

  <Card title="Plausible" icon='
...
<path d="M90.6 246.4c7-9.9 17.2-17.4 29.1-19.7 9.3-1.8 18.4-.8 26.9 2.7l24.4 10.2c1.4.6 2.9.9 4.4.9 3.7 0 7.2-1.8 9.4-4.8l56.3-78.9c7-9.8 17.2-17.4 29.1-19.7 9.2-1.8 18.3-.8 26.7 2.7l47.1 19.8c1.4.6 2.9.9 4.4.9 3.7 0 7.2-1.8 9.4-4.8l59-82.8C385.3 28.7 333.7 0 275.3 0H91.1C75.3 0 62.5 12.8 62.5 28.7v257.1z" style={{ fill: "#6d6aef" }} />
  ...
  ' horizontal href="/integrations/analytics/plausible">
  </Card>

  <Card title="PostHog" icon='
    <svg
      className="h-6 w-6"
      width="50"
      height="30"
  ...
  ' horizontal href="/integrations/analytics/posthog">
  </Card>

  <Card title="Segment" icon='
...
' horizontal href="/integrations/analytics/segment">
  </Card>
</CardGroup>
