...
<CardGroup cols={2}>
  ...
  <Card
    ...
    horizontal
    icon={
      <svg className="h-6 w-6" style={{ fill: "#7856ff" }} viewBox="0 0 98 98" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <Card
    ...
    horizontal
    icon={
      <svg xmlns="http://www.w3.org/2000/svg" width="1000px" height="1000px" className="h-6 w-6" viewBox="0 0 1000 1000">
        <defs>
        ...
        <g fill="none">
          <circle fill="url(#radialGradient-1)" cx="500" cy="500" r="500"/>
        </g>
      </svg>
    }
  />
