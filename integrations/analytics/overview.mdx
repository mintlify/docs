...
When you add analytics integrations to your documentation site, Mintlify tracks user interactions and sends them to your analytics providers. Tracked events include page views, search queries, API playground requests, and feedback submissions. You can connect any number of supported providers by adding your API keys to the `docs.json` file. Analytics events flow to your providers as soon as you add them to your configuration, with no further setup required.
