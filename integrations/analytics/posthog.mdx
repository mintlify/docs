...
Add of following to your `docs.json` file to send analytics to PostHog.
...
You need to add of URL for your docs website to PostHog's "Authorized domains for recordings" before you can receive session recordings. The option to add your URL is in PostHog's project settings.
