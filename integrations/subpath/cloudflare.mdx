...
If you have trouble setting up custom subdirectory, [contact our support team](mailto:sales@mintlify.com) and we'll walk you through upgrading your hosting with us.
...
Once completing the Cloudflare setup, the Mintlify team will setup the subdirectory settings in your deployment. Reach out over [email](mailto:sales@mintlify.com).
