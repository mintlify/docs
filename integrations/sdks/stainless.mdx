...
To integrate Stainless with Mintlify's OpenAPI support:
...
3. Set up the GitHub Action to push the Stainless-enhanced OpenAPI spec to your docs repo:

```yaml
name: Upload OpenAPI spec to Stainless and Mintlify docs
...
- `API_TOKEN_GITHUB`: GitHub [Personal Access Token](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens) with push access to your docs repo