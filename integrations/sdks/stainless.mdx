...
# Add Stainless to Your Docs

1. Add this to your Stainless config if you use Mintlify's OpenAPI support:
...
2. Set up [OpenAPI](/api-playground/openapi/setup#in-the-repo) in your Mintlify docs.
