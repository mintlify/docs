...
2. Set up your [OpenAPI configuration](/api-playground/openapi/setup#in-the-repo) in Mintlify.

3. Create a GitHub Action to sync your OpenAPI spec between Stainless and your docs:
