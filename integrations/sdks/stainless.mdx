...
2. Configure the [OpenAPI setup](/api-playground/openapi/setup#in-the-repo) in your docs.

3. Set up a GitHub Action to push your Stainless-enhanced OpenAPI spec:
