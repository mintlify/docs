...
User queries are matched against the contents of your documentation for both semantic & full-text matches, which are then provided as context to a LLM.

You can choose the specific Large Language Model (LLM) used for generating answers from a list of supported models within your Mintlify dashboard. This allows you to select the model that best fits your needs for performance, cost, or response style.
