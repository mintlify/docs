---
title: "Search boost"
description: "Boost in-product search ranking for specific Mintlify pages or navigation groups by setting a numeric multiplier in page frontmatter or docs.json."
