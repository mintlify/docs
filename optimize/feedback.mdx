...
You can enable email collection so users can optionally provide their email address when submitting feedback. To enable this:

1. Go to the [Add-ons](https://dashboard.mintlify.com/products/addons) page in your dashboard.
2. Enable the **Collect email** toggle under the feedback settings.

When enabled, the email input field appears when a user selects **Other** as their feedback category. This allows users to share contact information for follow-up.
