---
title: "Collect page feedback from users and AI agents"
description: "Enable feedback widgets, page ratings, contextual notes, code snippet reactions, and agent feedback to find and fix documentation gaps."
