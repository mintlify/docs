...
The feedback tab provides two views to help you analyze user satisfaction:

- **All feedback**: Displays a chronological list of all feedback submissions, including thumbs ratings, contextual feedback, and code snippet feedback.
- **Feedback by page**: Aggregates thumbs up and thumbs down votes by page, showing which pages are most liked by viewers and which need improvement.

Use the toggle at the top of the feedback tab to switch between views.
