...
- **Pending**: Feedback awaits review.
- **In Progress**: You validated the feedback and you are working on it.
- **Resolved**: You resolved the feedback.
- **Dismissed**: You dismissed the feedback as not actionable, irrelevant, or inaccurate.
