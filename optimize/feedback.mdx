...
Use the type filter to view specific kinds of feedback. You can filter by **Contextual** to see page-level feedback or **Thumbs** to see thumbs up/down votes. By default, all feedback types are displayed together.
