...
- **Agent feedback** <span style={{verticalAlign: "middle", fontSize: "0.75rem", padding: "0.125rem 0.375rem", borderRadius: "9999px", backgroundColor: "var(--background-strong)", color: "var(--foreground-intermediate)"}}>Beta</span>: When enabled, AI agents that visit your docs can submit structured feedback about content quality, accuracy, and completeness. This helps you identify areas for improvement based on how AI systems interpret your documentation. Agent feedback is off by default.
