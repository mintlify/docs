---
title: "Collect user feedback on documentation pages"
description: "Monitor reader satisfaction with built-in thumbs up and down reactions, page ratings, and comments to identify documentation pages that need improvement."
