...
Mintlify automatically detects and filters abusive feedback such as spam, profanity, hate speech, and other non-constructive content. Flagged feedback is excluded from your analytics metrics by default, ensuring that your feedback data accurately reflects genuine user sentiment.

Abuse detection uses a combination of keyword matching and AI classification to identify abusive content. Constructive negative feedback, bug reports, and feature requests are not affected by abuse filtering.
