...
<Info>
  To collect and view feedback, you must enable feedback from the [Add-ons](https://app.mintlify.com/products/addons) page in your dashboard.
</Info>
...
2. Toggle on the feedback types you want to collect.
3. Save your changes.

After you enable feedback, the corresponding widgets appear on your published site and submissions start flowing into the feedback tab.

## How readers submit feedback

Readers submit feedback directly on your published site:

- **Thumbs rating**: Thumbs up and thumbs down buttons appear at the bottom of each page.
- **Contextual feedback**: Readers open the contextual menu on a page to leave free-form comments.
- **Code snippet feedback**: Readers hover over a code block to react to or comment on the snippet.
- **Edit suggestions and raise issues**: Links from the page open a pre-filled pull request or issue in your GitHub repository.

Submissions appear in the [feedback dashboard](https://app.mintlify.com/products/analytics/v2/feedback) as soon as they're received.

## Feedback types

<Note>
  Contextual and code snippet feedback require an [Enterprise plan](https://www.mintlify.com/pricing?ref=feedback).
</Note>
