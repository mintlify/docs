...
If you're using a custom domain, set the `canonical` meta tag to ensure search engines index your preferred domain. This is critical for SEO when your documentation is accessible from multiple URLs.
...
<Note>
  The canonical URL tells search engines which version of your documentation is the primary one, preventing duplicate content issues.
</Note>
