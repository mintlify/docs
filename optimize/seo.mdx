...
To hide your entire project from search engines while keeping it publicly accessible, enable **Don't index project** on the [General](https://app.mintlify.com/settings/project/general) page of your dashboard.
