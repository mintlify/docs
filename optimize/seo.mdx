...
- `twitter:title` - Twitter title, falls back to `og:title`, then `title`
- `description` - Page description
- `og:description` - Open Graph description, falls back to `description`
- `twitter:description` - Twitter description, falls back to `og:description`, then `description`
...
"twitter:title": "Custom title for Twitter/X"
"twitter:description": "Custom description for Twitter/X"
...
If you only set `og:description`, it is also used as the Twitter description unless you explicitly set `twitter:description`. Similarly, `twitter:title` falls back to `og:title` if not set.
