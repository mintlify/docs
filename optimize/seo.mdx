...
### Prevent your .mintlify.app subdomain from being indexed

If you've set up a custom domain and want to prevent your `[subdomain].mintlify.app` domain from being indexed by search engines, add a canonical URL pointing to your custom domain. This tells search engines to only index your custom domain instead of the .mintlify.app subdomain.

```json
"seo": {
    "metatags": {
        "canonical": "https://your-custom-domain.com"
    }
}
```

This ensures that even if search engines discover your mintlify.app subdomain, they'll treat your custom domain as the authoritative source and won't index the mintlify.app version.
