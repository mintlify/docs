...
This is particularly useful if you want to prevent your `[subdomain].mintlify.app` domain from being indexed by search engines. Setting a canonical URL pointing to your custom domain tells search engines to only index your custom domain instead of the `.mintlify.app` subdomain.
