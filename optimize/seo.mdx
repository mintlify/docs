...
Disable indexing when you want to keep a deployment online for internal review, staging, or limited sharing. Use it when you do not want the site to appear in public search results or to be used by AI tools as training or retrieval data.
