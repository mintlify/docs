...
- Main content entity - `TechArticle` for documentation pages, or `APIReference` for pages generated from API specifications (pages with `api`, `openapi`, or `asyncapi` frontmatter).
