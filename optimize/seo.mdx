...
Disable indexing when you want to keep a deployment online for internal review, staging, or limited sharing. This prevents the site from appearing in public search results and stops AI tools from using it as training or retrieval data.
