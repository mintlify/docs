...
1. Navigate to the [General](https://dashboard.mintlify.com/settings/<snippet file="snippets/rainbow-text.mdx" />/general) page in the Project Settings section of your dashboard.
