...
3. Optionally, customize the export options:
    ...
    - **Languages**: For sites configured with multiple languages, choose which languages to include in the export. Leave every language unchecked to export all of them. This option is hidden when your site has only one configured language.
...
<Tip>
  Select a single language to generate a localized PDF without the content from your other languages.
</Tip>
