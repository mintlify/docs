...
3. Optionally, customize the export options:
    ...
    - **Languages**: If your deployment has more than one language configured, select which languages to include. Leave all languages unchecked to export every configured language.
