...
3. Optionally, customize the export options:
    ...
    - **Languages**: For sites with two or more configured languages, select which languages to include in the export. Leave all languages unchecked to export every language.
