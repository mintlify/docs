...
1. Navigate to the [General](https://dashboard.mintlify.com/settings/<RainbowText>deployment</RainbowText>/general) page in the Project Settings section of your dashboard.
