...
3. Optionally, customize the export options:
    ...
    - **Languages**: For docs with multiple [languages configured](/guides/internationalization), select one or more languages to include in the export. If you don't select any, all configured languages are exported.
