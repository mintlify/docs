...
1. Navigate to the [General](https://dashboard.mintlify.com/settings/<Rainbow>deployment</Rainbow>/general) page in the Project Settings section of your dashboard.
