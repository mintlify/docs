...
3. Optionally, customize the export options:
    ...
    - **Languages**: For sites configured with [multiple languages](/guides/internationalization), select which languages to include in the export. Leave all checkboxes unchecked to export every configured language. This option is hidden for single-language sites.
