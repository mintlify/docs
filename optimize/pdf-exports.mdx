...
3. Optionally, customize the export options:
    ...
    - **Languages**: For docs configured with two or more languages, select which languages to include in the export. Leave all languages unchecked to export every configured language.
