---
title: "Analytics for traffic, AI agents, search, and feedback"
description: "Track traffic, AI agent usage, search trends, assistant activity, and user feedback in the Mintlify analytics dashboard to improve documentation."
...
The Agent section helps you understand how AI agents access your documentation. It shows agent and human views over time and ranks pages or agents by the selected metric.

Use Agent analytics when you want to:

- **Monitor AI traffic**: Track changes in agent traffic after you publish or update content.
- **Find pages agents use most**: Select **Agent views** in **Rankings** to identify the pages that AI tools access frequently.
- **Identify active agents**: Select **Agent visitors** in **Rankings** to see which agents access your documentation most often.
- **Compare traffic sources**: Use the **Rankings** selector to compare **Human views**, **Agent views**, **Referrals**, and **Agent visitors**.

The Agent section is available when your deployment has Advanced Analytics access. To view it, open [Analytics](https://app.mintlify.com/analytics) and select **Agent**. Use the date range selector to change the reporting period.
