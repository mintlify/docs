...
The user flow section shows the paths visitors take through your documentation after they enter from a selected page. Use it to understand which pages visitors view next and where they leave your site.
...
Each interaction column shows up to six named pages ranked by arrivals and combines remaining pages into the **Other (N pages)** bucket. This preserves onward sessions, so drop-off reflects visitors who do not continue. The bucket appears at the bottom of its column. The final interaction column does not show drop-off because those sessions have no onward page in the displayed flow.
