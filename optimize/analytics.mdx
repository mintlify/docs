...
<Info>
  Impressions is in beta.
</Info>

The impressions section of the analytics page shows how often visitors click your [navbar call-to-action button](/organize/settings-structure#navbar). It requires a `navbar.primary` button configured in `docs.json`.

The section displays a chart of CTA clicks over time and a ranked table of pages with page views, clicks, and CTA click-through rate.

Review your impressions analytics to:

- **Identify high-intent pages**: Pages with a high CTA click-through rate often indicate visitors who are ready to take the next step, such as getting started or signing up.
- **Spot low-performing pages**: Pages with low click-through rates relative to their traffic may need a clearer or more prominent call to action.
