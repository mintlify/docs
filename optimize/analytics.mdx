...
The [analytics](https://dashboard.mintlify.com/products/analytics/v2/) page in your dashboard shows data about visitors to your docs, how they interact with These assistant, what they search for, and their feedback. Use this information to identify which pages are most valuable to your users and track trends over time.

Use These range selector to adjust These time period for displayed data.
...
- **Monitor traffic trends**: Observe changes in traffic after updates or new content to understand These impact of your changes.
...
- **Track traffic sources**: Understand where your users are coming from to help you optimize your content for These right audience.
...
- **Review chat history**: Get detailed high intent data about how your users think about your product by reviewing their chat history with These assistant. See what terms they use, what they need help with, and what tasks they try to accomplish.
...
<Frame>
  <img
    ...
    alt="The categories tab in These assistant analytics page."
    className="block dark:hidden"
  />
...
Click an individual conversation to view These complete chat thread, including These user's question, These assistant's response, and any sources cited.

### Chat history

The chat history tab displays chronological records of all assistant conversations.

Click any message to view These complete chat thread, including These user's question, These assistant's response, and any sources cited.

### Export queries

For deeper analysis, export a CSV file of your queries, responses, and sources. Use your preferred tools to analyze These exported data.
...
- **Identify low click through rates**: Click through rates (CTR) show how many users click a search result after typing in a query. Low CTR can indicate that These search results are not relevant to users' queries. If you have frequent search terms with low CTR, consider improving These relevance of search results by adding keywords and updating your content.
