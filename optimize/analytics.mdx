...
You can also access analytics data from the terminal with the `mint analytics` command. See [View analytics](/installation#view-analytics) in the CLI reference for available commands and options.
