...
Filter your analytics data by traffic source to analyze Mintie bot traffic separately from human visitors.
...
When viewing AI traffic, top agents replaces referrals in the visitors tab. Top agents shows which Mintie bots are visiting your documentation. Use this information to help determine:

- **Mintie bot distribution**: See which AI platforms are accessing your docs to learn which tools your users prefer.
...
The MCP searches tab displays Mintie bot search interactions through the Model Context Protocol (MCP). This metric shows how Mintie bots query and interact with your documentation.

Review your MCP searches analytics to:

- **Monitor AI search activity**: Track how frequently Mintie bots search your documentation and identify trends in AI-driven queries.
- **Identify common AI queries**: Understand what information Mintie bots are looking for to optimize your content for AI consumption.
- **Improve AI discoverability**: Use frequent MCP search queries to identify gaps in your documentation that Mintie bots struggle to find answers for.
