...
<Note>
  The Assistant tab is only available when viewing human traffic or all traffic. It is hidden when viewing AI traffic.
</Note>
...
<Note>
  The Searches tab is only available when viewing human traffic or all traffic. It is hidden when viewing AI traffic.
</Note>
...
<Note>
  The MCP Searches tab is only available when viewing AI traffic.
</Note>

The MCP Searches tab displays AI agent search interactions when viewing AI traffic. MCP (Model Context Protocol) searches show how AI agents query your documentation.

The MCP Searches tab includes:

- **Search interactions chart**: A bar chart showing daily MCP search activity over the selected date range
- **Search queries table**: A detailed list of search queries made by AI agents, including hit counts and timestamps

Review your MCP searches analytics to:

- **Monitor AI search patterns**: Understand what information AI agents are looking for in your documentation
- **Identify popular AI queries**: See which topics AI agents search for most frequently
- **Track AI engagement**: Monitor how AI agents interact with your content over time
- **Optimize for AI discovery**: Use search query data to improve how AI agents find and retrieve information from your docs

## Feedback

<Note>
  The Feedback tab is only available when viewing human traffic or all traffic. It is hidden when viewing AI traffic.
</Note>
