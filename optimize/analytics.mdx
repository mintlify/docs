...
Named pages appear in order of traffic. When many pages are grouped together, the **Other (N pages)** bucket appears at the bottom of its column. The final interaction column does not show drop-off because those sessions have no onward page in the displayed flow.
