...
You can also access analytics data from the terminal using `mint analytics`. See the [CLI reference](/installation#view-analytics) for available commands and options.
