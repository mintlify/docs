...
The exported CSV also includes a `queryCategory` column that matches the topic groupings shown on the categories tab. Use this column to filter or pivot exported data by topic.
