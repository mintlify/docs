---
title: "Analytics dashboard for documentation traffic"
description: "Track page views, search trends, assistant conversations, and user feedback in the Mintlify analytics dashboard to measure and improve your docs."
...
- **Identify popular pages**: Use highly ranked pages to understand what content is most important to your users so that you can make sure it is up to date and comprehensive.
