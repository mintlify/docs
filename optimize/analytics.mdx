...
The **Rankings** card in the Traffic section compares **Human views**, **Agent views**, **Referrals**, and **Agent visitors**. Select a metric to rank pages by human or agent views, review referral sources, or identify which agents access your documentation most often.
