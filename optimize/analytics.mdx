...
- **Identify low click-through rates**: Click-through rates (CTR) show how many users select a search result after typing in a query. Low CTR can indicate that the search results are not relevant to users' queries. If you have frequent search terms with low CTR, improve the relevance of search results by adding keywords and updating your content.
