...
Choose which of your organization's deployments send events. Each deployment is listed by subdomain, and selecting **All deployments** streams events from every current and future deployment.
...
No events stream until at least one category and at least one deployment are selected.
