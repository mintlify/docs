...
Filter your analytics data by traffic source to analyze AI agent traffic separately from human visitors. The traffic source filter offers three options:

- **All Traffic**: View combined analytics for both AI agents and human visitors
- **AI**: View analytics exclusively for AI agent traffic (Claude, ChatGPT, Perplexity, etc.)
- **Human**: View analytics exclusively for human visitor traffic

<Note>
When viewing AI traffic, certain metrics (Assistant, Searches, Feedback) are hidden as they only apply to human traffic. The MCP Searches metric is only available when viewing AI traffic.
</Note>
...
When viewing AI traffic, the referrals table is replaced with a Top Agents table that shows which AI agents are visiting your documentation. This helps you understand:

- **AI agent distribution**: See which AI platforms (Claude, ChatGPT, Perplexity, etc.) are accessing your docs
