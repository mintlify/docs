...
Navigate to the [Search](https://app.mintlify.com/settings/deployment/search) settings page in your dashboard. In the "Results" section, set **Results per query** to your desired value.

<Frame>
  <img
    alt="The Search settings page in the dashboard with Results per query set to 6."
...
Enable or disable result snippets on the [Search](https://app.mintlify.com/settings/deployment/search) settings page in your dashboard. The setting is off by default.
