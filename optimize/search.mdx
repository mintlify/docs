...
Navigate to the [General](https://app.mintlify.com/settings/project/general) settings page in your dashboard. In the "Search" section, set **Results per query** to your desired value.
...
Enable or disable result snippets on the [General](https://app.mintlify.com/settings/project/general) settings page in your dashboard. The setting is off by default.
...
Enable or disable search filters on the [General](https://app.mintlify.com/settings/project/general) settings page in your dashboard.
