...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  <label className="eyebrow h-5 text-primary dark:text-primary-light text-sm font-semibold">Conceitos Fundamentais</label>
  <h1 className="mt-1 mb-2 text-2xl sm:text-3xl text-gray-900 tracking-tight dark:text-gray-200 font-semibold">Temas</h1>
  <label className="text-lg prose prose-gray dark:prose-invert">Personalize a aparência da sua documentação<br /><br />Configure [theme](settings#param-theme) no docs.json usando um dos seguintes temas.</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="Tema de documentação clássico com layouts testados pelo tempo e navegação familiar." href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="Estética moderna e limpa, perfeita para produtos de IA e SaaS." href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="Tema fintech sofisticado com personalização profunda para documentação empresarial." href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="Essenciais simplificados para documentação sem distrações." href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="Vibração de terminal retrô com fontes monoespaçadas para aquela estética hacker dos anos 80." href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="Organização baseada em cartões encontra design minimalista para navegação intuitiva." href="https://almond.mintlify.app" />
  </div>
</div>
