...
Você precisará gerar uma nova propriedade<Tooltip tip="Google Analytics 4">GA4</Tooltip>para usar com o Mintlify. Os dados coletados irão para o mesmo projeto que seus outros dados do Google Analytics.

Se você estiver usando a versão antiga do Google Analytics, Universal Analytics, você ainda poderá gerar uma <Tooltip tip="Google Analytics 4">GA4</Tooltip> propriedade. <Tooltip tip="Google Analytics 4">GA4</Tooltip> os dados são um pouco diferentes dos dados do UA, mas ainda são coletados no mesmo projeto.
