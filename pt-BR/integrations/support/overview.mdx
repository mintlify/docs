...
Você pode integrar widgets em seus documentos para suporte ao cliente. Adicione o campo `integrations` no seu arquivo `docs.json` com o ID do seu respectivo aplicativo.
...
Se você gostaria de solicitar uma integração de suporte ao cliente, por favor, nos informe em [nossa comunidade](https://join.slack.com/t/mintlify-users/shared_invite/zt-1xfzz6x35-f4o4WCYfpvLhSj3O7WAOMA).
