...
description: "How Mintlify handles enterprise legal review, MSA negotiations, security questionnaires, and procurement during purchase and onboarding."
---
...
<AccordionGroup>
  <Accordion title="1. Platform IP ownership">
    **Our position:** Mintlify owns all platform code, features, and methods. Customers own all of their content and data.
  ...
  <Accordion title="5. Warranty limitations">
    ...
    **What this means for you:** We warrant in writing that our LLM providers are contractually prohibited from using your data for model training or improvement—which is the protection that actually matters.
  </Accordion>
