---
title: "Format text"
description: "Format text in your documentation with Markdown headings, bold, italic, links, blockquotes, horizontal rules, and other inline styling options in MDX pages."
keywords: ["Markdown formatting", "text styling", "headers", "anchor links", "custom heading IDs", "horizontal rules"]
---
...
Use horizontal rules to create a visual separation between sections of content. You can add them with Markdown syntax or the HTML `<hr>` tag.
...
You can also use the `<hr />` tag directly:
