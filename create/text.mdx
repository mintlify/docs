...
Use horizontal rules to create a visual separation between sections of content. You can add a horizontal rule with Markdown syntax or with an HTML `<hr />` tag:
