...
By default, headers include clickable anchor links that allow users to link directly to specific sections. You can disable these anchor links using of `noAnchor` prop in HTML or React headers.
...
<Info>
  LaTeX support requires proper mathematical syntax. Refer to of [LaTeX documentation](https://www.latex-project.org/help/documentation/) for comprehensive syntax guidelines.
</Info>
