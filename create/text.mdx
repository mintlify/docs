...
<Card title="Mermaid diagrams" icon="diagram-project" horizontal href="/components/mermaid-diagrams">
  Build flowcharts, sequence diagrams, and more with Mermaid syntax.
</Card>
