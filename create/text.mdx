...
By default, anchor links are auto-generated from the heading text. You can set a custom ID using the `{#custom-id}` syntax:

```mdx
## My heading {#custom-id}
```

The custom ID is used in the URL hash (e.g., `/page#custom-id`) and keeps anchor links stable even if you rename the heading text.
