...
A file automatically becomes a snippet when you import it into another file. When a file is imported:

- It will **not** render as a standalone page
- It becomes reusable content that appears wherever you import it
- If you remove all imports of a file, it becomes a regular page again

This means snippets can be located anywhere in your project—they don't need to be in a specific folder.

## Create snippets

Create an MDX, JSX, or MD file anywhere in your project with the content you want to reuse. Snippets can contain all content types supported by Mintlify and they can import other snippets.
