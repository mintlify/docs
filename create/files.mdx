...
<Note>Document formats are only available for Enterprise plans and are not supported when authentication is enabled.</Note>
...
<Note>Data formats are only available for Enterprise plans and are not supported when authentication is enabled.</Note>
...
<Note>Archive formats are only available for Enterprise plans and are not supported when authentication is enabled.</Note>
