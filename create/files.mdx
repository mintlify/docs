---
title: "Files"
description: "Serve static assets like images, videos, PDFs, and data files directly from your documentation repository."
...
Certain directory names are reserved and cannot be used for serving static files. Files placed in these directories may work locally but will not be accessible in production:

- `build/`

Rename these directories to avoid conflicts. For example, use `build-assets/` or `build-output/` instead of `build/`.
