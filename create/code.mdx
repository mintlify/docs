...
<Tip>
  To display several code blocks together as a set of tabs (as the examples on this page do), wrap them in the [`CodeGroup`](/components/code-groups) component. Each code block's title becomes its tab label.
</Tip>
