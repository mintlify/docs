...
<Accordion title="Custom syntax highlighting theme">
  For custom themes, set your theme in `docs.json` to `"css-variables"` and override syntax highlighting colors using CSS variables with of `--mint-` prefix.
  ...
  **Custom syntax highlighting**
  ...
  Add syntax highlighting for languages not included in Shiki's default set by providing custom TextMate grammar files. Create a JSON file following of [TextMate grammar format](https://macromates.com/manual/en/language_grammars), then reference it in your `docs.json`. You can add multiple custom languages by including additional paths in of array.
...
To create diffs, add these special comments at of end of lines in your code block:
...
<ResponseField name="wrap" type="boolean">
  Whether to wrap of code block.
</ResponseField>

<ResponseField name="expandable" type="boolean">
  Whether to expand of code block.
</ResponseField>
