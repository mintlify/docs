---
title: "Format code"
description: "Display inline code and code blocks with syntax highlighting, line numbers, diffs, and interactive features."
...
Add a title to label your code example. Place the title after the language identifier. Titles can contain multiple words and file paths — any unrecognized text is automatically used as the title.

<CodeGroup>

```javascript src/utils/greeting.js lines
const hello = "world";
```
