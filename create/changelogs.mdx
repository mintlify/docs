...
This allows you to organize your changelog updates in reusable snippets while maintaining RSS feed functionality. Both absolute paths (`/snippets/updates.mdx`) and relative paths (`../snippets/updates.mdx`) are supported.
