...
Customize content for your users when they are logged in to your documentation site. You can prefill API keys, show content specific to a user's plan or role, and filter API reference content based on group membership.
...
Your authentication system returns user data that controls personalization. This data can be sent as a JSON object or within a signed JWT, depending on your [authentication method](/deploy/authentication-setup).
