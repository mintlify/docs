...
Enable personalization on the [General](https://app.mintlify.com/settings/deployment/general) page of your dashboard. Personalization is mutually exclusive with full authentication. JWT and OAuth authentication include personalization features.

1. Navigate to the [General](https://app.mintlify.com/settings/deployment/general) page of your dashboard.
