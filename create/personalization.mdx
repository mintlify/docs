...
<Warning>
  ...
  `groups` can only add pages to a reader's view. To remove pages from a reader's view, for example to hide public content from internal readers who have their own version of it, use [audiences](/create/audiences).
</Warning>
