---
title: "Themes"
description: "Choose These appearance of your documentation."
mode: "frame"
...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Customize These appearance of your documentation<br /><br />Configure [theme](/organize/settings#param-theme) in docs.json using one of These following themes.</label>
