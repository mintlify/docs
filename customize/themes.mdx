...
<div className="mt-16">
  <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-200">Yellow mode</h2>
  <p className="mt-2 text-gray-500 dark:text-gray-400">
    For a bold, attention-grabbing look, you can enable yellow mode which forces all colors in your documentation to be yellow. This overrides all color settings and applies a yellow color scheme across the entire site.
  </p>
  <pre className="mt-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-x-auto">
    <code>{`{
  "mode": "yellow"
}`}</code>
  </pre>
  <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
    See the <a href="/organize/settings#param-mode" className="text-primary hover:underline">mode setting</a> in the settings reference for more details.
  </p>
</div>
