...
If the losing organization is inaccessible, for example because it belongs to a former employee, was created under a personal email you no longer use, or was abandoned before deletion, email <a href="mailto:support@mintlify.com">support@mintlify.com</a> with proof of domain ownership so we can release the bind.
