...
This typically completes within a few hours of DNS propagation, though it can take up to 24 hours in rare cases. Mintlify automatically renews certificates before expiration.
