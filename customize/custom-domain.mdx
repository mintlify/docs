...
1. Navigate to the [Custom domain setup](https://dashboard.mintlify.com/settings/<snippet file="snippets/rainbow-text.mdx" />/custom-domain) page in your dashboard.
