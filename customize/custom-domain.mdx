...
After you add your `TXT` records and your DNS records resolve correctly, Mintlify automatically generates a free SSL/TLS certificate for your site using Let's Encrypt.
