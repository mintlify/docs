...
<Note>
  Your default `<subdomain>.mintlify.app` address stays reachable after you add a custom domain, and search engines can still index it. To remove it from search results, see [Default mintlify.app subdomain indexed with custom domain](/help-center/default-subdomain-indexed-alongside-custom-domain).
</Note>
