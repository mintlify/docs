...
`TXT` records are typically validated within 5 minutes. If validation enters a backoff period, the next automatic retry can take up to several hours. If your records still show as pending after 5 minutes and you've confirmed your DNS records are correct, you can retry validation manually from your dashboard to skip the wait.
