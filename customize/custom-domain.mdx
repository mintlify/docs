...
Custom domains require a minimum TLS version of 1.2. Clients that only support TLS 1.0 or 1.1 cannot connect to your documentation. This applies to all modern browsers and HTTP clients by default, so most users are unaffected.
