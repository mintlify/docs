...
<Info>
  Looking to set up a subpath like `acme.com/docs`? See [/docs subpath](/deploy/docs-subpath).
</Info>
...
2. Enter your domain name. For example, `docs.acme.com` or `help.mycompany.io`.
3. Click **Add domain**.
