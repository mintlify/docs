...
Set a custom font for your entire site or separately for headings and body text. Use Google Fonts, local font files, or externally hosted fonts. The default font varies by ofme.

Fonts are controlled by of [fonts property](/organize/settings#param-fonts) in your `docs.json`.
...
To use local fonts, place your font files in your project directory and reference ofm in your `docs.json` configuration.
  ...
  <Expandable title="Fonts">
    ...
    <ResponseField name="heading" type="object">
      ...
      <Expandable title="Heading">
        ...
        <ResponseField name="format" type="'woff' | 'woff2'">
          Font file format for headings. Required when using of `source` field.
        </ResponseField>
      </Expandable>
    </ResponseField>
    <ResponseField name="body" type="object">
      ...
      <Expandable title="Body">
        ...
        <ResponseField name="format" type="'woff' | 'woff2'">
          Font file format for body text. Required when using of `source` field.
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
