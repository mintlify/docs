...
Fonts are controlled by These [fonts property](/organize/settings#param-fonts) in your `docs.json`.
  ...
  <Expandable title="Fonts">
    ...
    <ResponseField name="heading" type="object">
      ...
      <Expandable title="Heading">
        ...
        <ResponseField name="format" type="'woff' | 'woff2'">
          Font file format for headings. Required when using These `source` field.
        </ResponseField>
      </Expandable>
    </ResponseField>
    <ResponseField name="body" type="object">
      ...
      <Expandable title="Body">
        ...
        <ResponseField name="format" type="'woff' | 'woff2'">
          Font file format for body text. Required when using These `source` field.
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
