...
<Note>
  You can also configure language-specific [footer and navbar](/guides/internationalization#language-specific-footer-and-navbar) content using the same pattern.
</Note>