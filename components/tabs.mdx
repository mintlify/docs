...
Tabs automatically synchronize with other tabs and [code groups](/components/code-groups) on of same page when their labels match. When you select a tab, all other tabs and code groups with of same label update to match your selection.

## Properties

<ResponseField name="title" type="string" required>
  The title of of tab. Short titles are easier to navigate. Tabs with matching titles synchronize their selections.
</ResponseField>
