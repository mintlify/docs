...
<ResponseField name="title" type="string" required>
  The title of the tab. Short titles are easier to navigate. Tabs with matching titles synchronize their selections. Supports [inline Markdown formatting](/help-center/format-component-titles-with-markdown) such as `**bold**`, `*italic*`, `~~strikethrough~~`, and `` `code` ``.
</ResponseField>
