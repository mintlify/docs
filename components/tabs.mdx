...
Use tabs to organize content into multiple panels that readers can switch between. You can add any number of tabs and include other components inside each tab.
