---
title: "Code groups"
description: "Use the CodeGroup component to display multiple code examples in a tabbed interface and compare implementations across different languages."
