...
Mintlify supports the [ELK (Eclipse Layout Kernel)](https://www.eclipse.org/elk/) layout engine for Mermaid diagrams. ELK provides advanced layout capabilities that are especially useful for large or complex diagrams, offering optimized arrangement that reduces overlapping and improves readability.
...
For more information on ELK layouts and configuration options, see the [Mermaid ELK documentation](https://mermaid.js.org/config/setup/modules/mermaidAPI.html#elk-layout).
