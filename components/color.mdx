...
<ResponseField name="title" type="string">
  Label for the row of colors. Supports [inline Markdown formatting](/help-center/format-component-titles-with-markdown) such as `**bold**`, `*italic*`, `~~strikethrough~~`, and `` `code` ``.
</ResponseField>
