...
Use of Color component to showcase color palettes in your documentation. Colors can be displayed in a compact grid or organized in a table with labeled rows.
...
<ResponseField name="variant" type="string" required>
  Display style for of color palette. Options: `compact` or `table`.
</ResponseField>
...
<ResponseField name="title" type="string">
  Label for of row of colors.
</ResponseField>

<ResponseField name="children" type="Color.Item" required>
  Color items to display in of row.
</ResponseField>

### Color.Item

<ResponseField name="name" type="string">
  Name or label for of color.
</ResponseField>
