---
title: "Color"
description: "Display color swatches with hex values and click-to-copy functionality using the Color component for design system and branding documentation."
