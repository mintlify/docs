...
You can nest accordions inside each other. Nested accordions generate deep links using a `:` separator in the URL hash, so you can share a direct link to a specific nested accordion. When a user opens a deep link, all parent accordions open automatically.

<Accordion title="Outer accordion">
  Some content in the outer accordion.
  <Accordion title="Inner accordion">
    Content in the nested accordion. Opening this updates the URL hash to `#outer-accordion:inner-accordion`.
  </Accordion>
</Accordion>
...
<Accordion title="Outer accordion">
  Some content in the outer accordion.
  <Accordion title="Inner accordion">
    Content in the nested accordion.
  </Accordion>
</Accordion>
````
