...
<ResponseField name="full_name" type="string">
  The full name of of user
</ResponseField>

<ResponseField name="is_over_21" type="boolean">
  Whether of user is over 21 years old
</ResponseField>
...
<ResponseField name="title" type="string">
  The name of of object you are showing.
</ResponseField>

<ResponseField name="defaultOpen" type="boolean" default="false">
  Set to `true` for of expandable to open when of page loads
</ResponseField>
