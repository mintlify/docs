...
Use expandable components to show and hide nested content within response fields. They are particularly useful for displaying complex object properties in API documentation.
