...
<ResponseField name="lazy" type="boolean" default="false">
  When `true`, defers rendering of children until the expandable is first opened. Useful for improving page load performance when expandables contain heavy content.
</ResponseField>
