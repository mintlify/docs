...
<ResponseField name="title" type="string">
  The title displayed on the card. Supports [inline Markdown formatting](/help-center/format-component-titles-with-markdown) such as `**bold**`, `*italic*`, `~~strikethrough~~`, and `` `code` ``.
</ResponseField>
