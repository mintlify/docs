---
title: "Cards"
description: "Use Card and CardGroup components to create visual containers with icons, images, and links that highlight key points and organize navigation."
