---
title: "Cards"
description: "Use the Card and CardGroup components in Mintlify to display links, icons, images, and grouped content as visual containers that organize navigation."
