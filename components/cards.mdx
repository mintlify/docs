---
title: "Cards"
description: "Add card components in MDX to create clickable visual tiles with titles, icons, images, and links — useful for landing pages and quickstart layouts."
