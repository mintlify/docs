---
title: "Cards"
description: "Use card components to create visual containers with icons, images, and links that highlight key points and organize navigation."
...
Add a `type` property to style cards as `info`, `warning`, `note`, `tip`, `check`, or `danger`. Typed cards automatically apply matching colors and icons to highlight the card's purpose.

<Card title="Info card" type="info">
  This is an example of an info card.
</Card>
...
<Card title="Tip card" type="tip">
  This is an example of a tip card.
</Card>

<Card title="Check card" type="check">
  This is an example of a check card.
</Card>
...
<Card title="Danger card" type="danger">
  This is an example of a danger card.
</Card>
...
<ResponseField name="type" type="string">
  Style the card as a typed variant. Supported values are `info`, `warning`, `note`, `tip`, `check`, and `danger`. Typed cards apply preset colors and icons.
</ResponseField>
