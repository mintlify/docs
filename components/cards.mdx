---
title: "Cards"
description: "Use Card and CardGroup components to highlight key points, create navigation links, and organize content with icons and customizable layouts."
