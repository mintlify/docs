...
Use the `Column` component to wrap non-card content in individual columns. This is useful when you want to display arbitrary content side by side, not just cards.
