...
<ResponseField name="title" type="string" required>
  The title is the primary text for the step and shows up next to the indicator. Supports [inline Markdown formatting](/help-center/format-component-titles-with-markdown) such as `**bold**`, `*italic*`, `~~strikethrough~~`, and `` `code` ``.
</ResponseField>
