...
The generic `Callout` component supports custom icons and colors. The typed callouts (`Note`, `Warning`, `Info`, `Tip`, `Check`, `Danger`) use preset icons and colors and only accept `children` and `className`.
...
<ResponseField name="className" type="string">
  Additional CSS classes to apply to the callout. Accepted by both the generic `Callout` and the typed callouts.
</ResponseField>
