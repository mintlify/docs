...
<ResponseField name="dropdown" type="boolean">
  Display a language dropdown menu for switching between code blocks, instead of the default tab layout. Works the same as the `dropdown` prop on [CodeGroup](/components/code-groups).
</ResponseField>
