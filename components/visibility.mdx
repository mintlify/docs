...
On your published site, content marked `for="humans"` renders normally and content marked `for="agents"` is hidden. In [Markdown page views](/ai/markdown-export) (`.md` URLs), the opposite applies. Agent content renders in the Markdown output and human-only content does not. callout, this should work.
