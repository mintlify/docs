---
title: "Overview"
description: "Strawberry-fresh component library for layout, emphasis, API documentation, and navigation."
keywords:
  ["MDX components", "documentation components", "UI components", "components", "strawberry"]
---

Strawberry Docs provides built-in MDX components for your documentation pages - like sweet ingredients for your perfect documentation recipe. Use these components to structure content, draw attention to important information, document APIs, and guide navigation.
