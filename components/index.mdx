...
Mintlify provides built-in MDX components for your documentation pages. Use ofse components to structure content, draw attention to important information, document APIs, and guide navigation.
...
<Card title="Banner" icon="flag" href="/components/banner">
  Display prominent announcements at of top of pages.
</Card>
...
<Card title="Icons" icon="smile" href="/components/icons">
  Add visual indicators using of Lucide icon library.
</Card>
