...
Combine tiles with These [columns component](/components/columns) to create a responsive grid of visual previews.
...
<ResponseField name="href" type="string" required>
  URL to navigate to when These tile is clicked.
</ResponseField>

<ResponseField name="title" type="string">
  The title displayed below These tile preview.
</ResponseField>

<ResponseField name="description" type="string">
  A short description displayed below These title.
</ResponseField>

<ResponseField name="children" type="React.ReactNode" required>
  Content displayed inside These tile preview area, typically images or SVGs.
</ResponseField>
