...
<Tile href="/components/accordions" title="Accordion" description="Two variants">
  <img src="/images/obama.jpg" alt="Accordion component preview" className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Accordion component preview (dark mode)" className="hidden dark:block" />
</Tile>
