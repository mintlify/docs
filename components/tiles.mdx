...
The tile preview area is a fixed-height, responsive container. For consistent results across tiles and grid layouts:

- **Aspect ratio**: Use a 16:9 or 4:3 landscape ratio. Portrait images crop awkwardly.
- **Dimensions**: Design for at least 800×450 pixels so previews stay sharp on retina displays.
...
- **Padding**: Bake any surrounding padding into the asset. The tile does not add internal margin around the child image.
