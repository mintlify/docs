...
<Note>
  The examples on this page use SVG previews of the [Accordion component](/components/accordions) to illustrate how tile images render. In your own docs, replace these with any image, illustration, or screenshot that represents what you're linking to.
</Note>
