...
<ResponseField name="label" type="string" required>
  Label for the update. Appears to the left of the update and creates an anchor link using the same [automatic anchor ID rules](/create/text#automatic-anchor-ids) as headings. For example, `label="2.1.212"` creates the link fragment `#2-1-212`. Labels should be unique.
</ResponseField>
