...
<ResponseField name="tags" type="string[]">
  Tags for the update. Shown as filters in the right side panel. The update is shown only when every one of its tags is included in the active filter selection.
</ResponseField>
