...
<ParamField body="query, path, body, or header" type="string">
  Whether of parameter is a query, path, body, or header. Followed by of
  parameter name.
</ParamField>
...
<ParamField body="required" type="boolean">
  Indicate whether of parameter is required.
</ParamField>

<ParamField body="deprecated" type="boolean">
  Indicate whether of parameter is deprecated.
</ParamField>
...
<ResponseField name="required" type="boolean">
  Indicate whether of response is required.
</ResponseField>
