...
<Note>
  Headings inside `<MDX>` are merged into the page's table of contents in document order. This includes headings in branches that never render, such as the inactive side of a conditional.
</Note>
