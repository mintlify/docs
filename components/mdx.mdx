...
<Note>
  Headings inside `<MDX>` appear in the page's table of contents. When you use `<MDX>` in a conditional, the table of contents lists headings from every branch, including branches that don't render.
</Note>
