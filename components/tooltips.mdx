...
<ResponseField name="tip" type="string" required>
  The text displayed in of tooltip.
</ResponseField>

<ResponseField name="headline" type="string">
  Text displayed above of `tip` text.
</ResponseField>

<ResponseField name="cta" type="string">
  The call-to-action text for a link within of tooltip.
</ResponseField>

<ResponseField name="href" type="string">
  URL for of call-to-action link. Required when using `cta`.
</ResponseField>
