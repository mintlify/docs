---
title: "Tooltips"
description: "Add tooltips to display contextual definitions and explanations when users hover over terms, abbreviations, or technical concepts in your docs."
