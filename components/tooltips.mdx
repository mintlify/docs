...
Use tooltips to provide additional context or definitions when a user hovers over a string of text. Tooltips can include optional call-to-action links. When applied to plain text, a dotted underline is automatically rendered to indicate the tooltip is available.
