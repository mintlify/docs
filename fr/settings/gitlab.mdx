...
<Note>
  **Clonage HTTPS requis** : Votre projet GitLab doit avoir le clonage HTTPS activé pour que Mintlify puisse accéder à votre dépôt. Vous pouvez le vérifier dans **Settings** > **General** > **Visibility, project features, permissions** de votre projet.
</Note>
