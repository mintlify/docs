...
Ajoutez des fichiers CSS à votre référentiel, et les noms de classes qu’ils définissent seront appliqués et disponibles dans tous vos fichiers `MDX`.
...
<Tip>
  Utilisez Inspecter l’élément pour trouver les références des éléments que vous souhaitez personnaliser.
</Tip>
...
<Warning>
  Les références et la mise en forme des éléments courants sont susceptibles de changer à mesure que la plateforme évolue. Utilisez les styles personnalisés avec prudence.
</Warning>
...
Tout fichier `.js` présent dans le répertoire content de votre documentation sera inclus dans chaque page. Par exemple, vous pouvez ajouter le fichier `ga.js` suivant pour activer [Google Analytics](https://marketingplatform.google.com/about/analytics) sur l’ensemble de la documentation.
