...
<AccordionGroup>
  <Accordion title="Impact du rendu côté client">
    Les composants basés sur des hooks React sont rendus côté client, ce qui entraîne plusieurs implications :

    * **SEO** : Les moteurs de recherche peuvent ne pas indexer entièrement le contenu dynamique.
    * **Chargement initial** : Les visiteurs peuvent percevoir un flash de contenu en cours de chargement avant que les composants ne se rendent.
