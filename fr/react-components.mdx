...
Les [composants React](https://react.dev) offrent un moyen puissant de créer des éléments interactifs et réutilisables dans votre documentation.
...
```mdx /snippets/color-generator.jsx [dépliable]
