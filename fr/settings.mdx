...
<ResponseField name="navigation" type="object" required>
  ...
  <Expandable title="Navigation">
    ...
    <ResponseField name="versions" type="array of object">
      Sélecteur de version pour les sites avec plusieurs [versions](fr/navigation#versions).
    </ResponseField>

    <ResponseField name="tabs" type="array of object">
      [Onglets](fr/navigation#tabs) de navigation de premier niveau.
    </ResponseField>
    ...
    <ResponseField name="pages" type="array of string or object">
      [Pages](fr/navigation#pages) individuelles qui composent votre documentation.
    </ResponseField>
  </Expandable>
</ResponseField>
