---
title: "Thèmes"
description: "Personnalisez l’apparence de votre documentation"
icon: "paint-bucket"
mode: "custom"
---
...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personnalisez l’apparence de votre documentation<br /><br />Configurez [theme](fr/settings#param-theme) dans docs.json avec l’un des thèmes suivants.</label>
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Maple" value="maple" description="Esthétique moderne et épurée, parfaite pour les produits IA et SaaS." href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="Thème fintech sophistiqué avec des options de personnalisation poussées pour la documentation d’entreprise." href="https://palm.mintlify.app" />
    ...
    <ThemeCard title="Linden" value="linden" description="Ambiance terminal rétro avec polices monospace pour une esthétique de hacker des années 80." href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="Organisation par cartes associée à un design minimaliste pour une navigation intuitive." href="https://almond.mintlify.app" />

    <ThemeCard title="Aspen" value="aspen" description="Documentation moderne pensée pour une navigation complexe et des composants personnalisés." href="https://aspen.mintlify.app" />
  </div>
</div>
