...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personnalisez l’apparence de votre documentation<br /><br />Configurez [theme](fr/settings#param-theme) dans docs.json en utilisant l’un des thèmes suivants.</label>
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Linden" value="linden" description="Ambiance terminal rétro avec polices monospace pour une esthétique hacker des années 80." href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="Organisation en cartes alliée à un design minimaliste pour une navigation intuitive." href="https://almond.mintlify.app" />
