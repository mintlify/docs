...
description: "Créez une automatisation Mintlify personnalisée avec un déclencheur de calendrier ou de push, des dépôts de contexte et un prompt d'agent pour automatiser les tâches de documentation récurrentes."
