...
Testez une nouvelle automatisation avec une exécution manuelle avant de vous fier à son déclencheur. Les exécutions manuelles utilisent la configuration actuelle de l'automatisation et apparaissent dans l'historique des exécutions aux côtés des exécutions planifiées. Consultez [Exécuter une automatisation manuellement](/fr/automations/manage#run-an-automation-manually) pour connaître les étapes et les prérequis, qui incluent un déclencheur planifié pour la plupart des automatisations.
