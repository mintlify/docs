...
description: "Créez une automatisation Mintlify qui s'exécute selon un calendrier, un push sur un dépôt ou un événement d'intégration. Ajoutez des dépôts de contexte et un prompt d'agent personnalisé."
