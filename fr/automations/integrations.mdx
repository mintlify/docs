...
Pour les fournisseurs à clé API comme Plain et Pylon, générez une nouvelle clé API dans l'application source et collez-la dans la configuration de l'intégration. Si les automatisations ne peuvent toujours pas accéder aux données après la reconnexion, vérifiez que l'utilisateur autorisant a l'autorisation de consulter le contenu concerné dans l'application source.
