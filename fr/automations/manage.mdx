...
2. Cliquez sur le bouton bascule à côté d'une automatisation pour l'activer.
    <Frame>
      <img src="/images/workflows/automations-dashboard-light.png" alt="Le dashboard des automatisations." className="block dark:hidden" />
      <img src="/images/workflows/automations-dashboard-dark.png" alt="Le dashboard des automatisations." className="hidden dark:block" />
    </Frame>
...
Chaque dépôt prend en charge jusqu'à 20 chemins et 20 auteurs exclus. Changer le dépôt d'une carte efface ses filtres. Les dépôts sources GitLab ne prennent pas en charge les filtres par dépôt et continuent d'utiliser un sélecteur de dépôt unique.
...
Le bouton **Preview** n'apparaît que lorsqu'un preview deployment est lié à l'exécution. Les preview deployments expirent après une période d'inactivité ; une fois expirés, le bouton est désactivé.
