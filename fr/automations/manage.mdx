...
4. Sélectionnez une portée d'exécution, puis cliquez sur **Run now** pour confirmer. Rien ne s'exécute tant que vous n'avez pas confirmé.
...
- **Everything** : S'exécute sur l'ensemble de votre site. Cela prend généralement plus de temps et consomme nettement plus de votre utilisation qu'une exécution ciblée.
