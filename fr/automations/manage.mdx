...
<Tip>
  Vous pouvez également créer, lister et supprimer des automatisations depuis le terminal avec [`mint workflow`](/fr/cli/commands#mint-workflow). La CLI est utile pour les scripts et la CI ; le dashboard est le moyen le plus simple de configurer et de surveiller les exécutions d'automatisations.
</Tip>
