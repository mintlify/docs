...
Vous pouvez agir sur les résultats directement depuis la liste. Pour les exécutions en attente de relecture, cliquez sur **Accept** pour fusionner les modifications ou sur **Preview** pour ouvrir le [preview deployment](/fr/deploy/preview-deployments) de la branche de l'exécution. Pour ouvrir la branche de l'exécution dans l'éditeur, cliquez sur **View changes** ou ouvrez le menu <Icon icon="ellipsis" /> puis cliquez sur **Open in editor**. Pour les résultats en échec, cliquez sur **Re-trigger** pour relancer l'exécution.
...
1. Ouvrez la page [Automations](https://app.mintlify.com/products/automations) dans votre dashboard.
2. Dans l'onglet **Runs**, cliquez sur **View changes** sur l'exécution, ou ouvrez le menu d'actions <Icon icon="ellipsis" /> et cliquez sur **Open in editor**. Ces deux options ne sont disponibles que tant que la pull request de l'exécution reste ouverte.
