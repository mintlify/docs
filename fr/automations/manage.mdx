...
3. Sélectionnez un ou plusieurs canaux auxquels envoyer des notifications.
...
1. Accédez à la page [Automations](https://app.mintlify.com/products/automations?tab=runs) dans votre dashboard.
...
- **Review needed** : l'agent a terminé l'exécution, mais les modifications doivent être relues et fusionnées par un membre de votre équipe.
