...
Vous pouvez ajouter jusqu'à 10 dépôts de contexte par automatisation. Pour chaque dépôt GitHub, installez la GitHub App Mintlify. Ajoutez des dépôts dans la section **GitHub app** de la page [Git settings](https://app.mintlify.com/settings/project/git-settings).
