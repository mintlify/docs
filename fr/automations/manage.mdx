...
1. Ouvrez la page [Automations](https://app.mintlify.com/products/automations) dans votre dashboard.
2. Cliquez sur le bouton <Icon icon="settings" /> de paramètres à côté de l'automatisation personnalisée que vous souhaitez supprimer.
3. Cliquez sur **Delete** en bas du panneau des paramètres et confirmez.
...
Vous pouvez aussi sélectionner **View runs** sur la carte d'une automatisation pour ouvrir l'historique des exécutions filtré sur cette automatisation. Un point rouge sur le bouton indique que l'automatisation a des exécutions en attente de relecture.
