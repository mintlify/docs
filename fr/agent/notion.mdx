...
description: "Connectez Notion à l'agent Mintlify pour qu'il puisse référencer les pages et bases de données de votre espace de travail comme contexte lors de la création de mises à jour de documentation."
