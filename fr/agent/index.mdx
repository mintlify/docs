...
description: "Automatisez les mises à jour de documentation avec l'agent Mintlify. Déclenchez des modifications depuis des messages Slack, des pull requests, des issues Linear ou des appels d'API."
