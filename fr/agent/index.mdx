...
<div id="review-agent-responses">
  ## Examiner les réponses de l'agent
</div>

Pendant que l'agent travaille dans le panneau d'agent de l'éditeur, vous pouvez interagir avec chaque message :

* **Copier** : copiez un message dans votre presse-papiers pour réutiliser le contenu. Les messages de l'assistant préservent la mise en forme des blocs de code lors du collage dans l'éditeur.
* **Retour** : évaluez les réponses de l'assistant avec un pouce levé ou un pouce baissé pour aider à améliorer la qualité de l'agent.
* **Horodatage** : survolez un message pour voir à quel moment il a été envoyé.

Les actions de retour et de copie sont disponibles sur les messages terminés. Les boutons apparaissent une fois la réponse entièrement diffusée.
