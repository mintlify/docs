...
Dans le panneau d'agent de l'éditeur, vous pouvez interagir avec chaque message :

* **Copier** : copiez un message dans votre presse-papiers pour en réutiliser le contenu. Les messages de l'assistant préservent la mise en forme des blocs de code lorsque vous les collez dans l'éditeur.
...
Les boutons de copie et de retour apparaissent sur chaque message une fois la réponse entièrement diffusée.
