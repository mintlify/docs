...
* Mettre à jour la documentation existante avec de nouvelles fonctionnalités ou des évolutions d’API.
* Traiter et intégrer des images, des schémas et d’autres fichiers directement depuis Slack.
...
* Traiter les retours de revue de code et maintenir la qualité de la documentation.
...
* **Lire des fichiers et des images** : traiter les pièces jointes des messages Slack pour inclure des schémas, extraits de code et autres éléments de contenu dans votre documentation.
* **Traiter les retours de revue de code** : lire les commentaires de pull request (demande de fusion) et les résoudre.
* **Accéder à l’ensemble du système de fichiers** : naviguer et coordonner efficacement les modifications dans plusieurs fichiers et répertoires.
