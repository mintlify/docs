...
Par défaut, l'agent ouvre des pull requests (demandes de fusion) attribuées au bot Mintlify. Pour que les pull requests vous soient attribuées, connectez votre compte GitHub sur la page [My profile](https://dashboard.mintlify.com/settings/account) du Dashboard.

<div id="connect-repositories-as-context">
  ## Connectez des référentiels comme contexte
</div>

L'agent ne peut accéder qu'aux référentiels que vous connectez via l'application GitHub Mintlify. Configurez les référentiels auxquels l'agent peut accéder dans les **Paramètres** du panneau de l'agent ou dans les [paramètres de l'application GitHub](https://github.com/apps/mintlify/installations/new).
