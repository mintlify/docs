...
Pour permettre à un agent externe de modifier directement votre contenu via des appels d'outils MCP, connectez-le au [serveur MCP Mintlify](/fr/ai/mintlify-mcp).
