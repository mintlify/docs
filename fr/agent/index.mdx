...
Par défaut, l'agent ouvre des pull requests (demandes de fusion) attribuées au bot Mintlify. Pour que les pull requests (demandes de fusion) vous soient attribuées, connectez votre compte GitHub sur la page [Mon profil](https://dashboard.mintlify.com/settings/account) du Dashboard.

<div id="connect-repositories-as-context">
  ## Connectez des référentiels comme contexte
</div>

L'agent ne peut accéder qu'aux référentiels que vous connectez via la Mintlify GitHub App. Configurez les référentiels auxquels l'agent peut accéder dans les **Settings** du panneau de l'agent ou dans les [paramètres de la GitHub App](https://github.com/apps/mintlify/installations/new).
