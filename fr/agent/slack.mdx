...
Demandez à l'agent de créer, configurer ou exécuter des [automatisations](/fr/automations). L'agent peut effectuer les mêmes actions que vous sur la page [Automations](https://app.mintlify.com/products/automations) de votre dashboard.
...
- « Exécute maintenant l'automatisation qui examine les conversations de l'assistant. »
