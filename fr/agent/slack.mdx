...
2. Dans la section "Agent settings", cliquez sur **Install Slack app**.
  <Frame>
    <img src="/images/agent/install-apps-light.png" alt="La section des paramètres d'application avec les boutons d'installation de Slack et Linear." className="block dark:hidden" />
    <img src="/images/agent/install-apps-dark.png" alt="La section des paramètres d'application avec les boutons d'installation de Slack et Linear." className="hidden dark:block" />
  </Frame>
