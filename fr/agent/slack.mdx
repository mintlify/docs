...
### Connexion en un clic depuis le DM de bienvenue

Lorsque vous installez pour la première fois l'application Slack Mintlify, l'agent vous envoie un message direct de bienvenue. Si votre organisation a l'agent activé, le message inclut des boutons **Connect** en un clic pour les intégrations les plus courantes :
...
1. Ouvrez le message direct de l'agent dans Slack.
2. Cliquez sur le bouton **Connect** pour le service que vous souhaitez ajouter.
3. Dans la fenêtre modale, cliquez sur le lien d'autorisation, connectez-vous au service tiers et approuvez les autorisations demandées.
...
Les boutons n'apparaissent que pour les services que vous n'avez pas encore connectés. Une fois la connexion active, le bouton correspondant ne s'affiche plus dans les messages suivants.

### Demander à l'agent de connecter n'importe quel service

Pour les services qui ne figurent pas dans la liste en un clic, demandez à l'agent de configurer l'intégration :
