...
description: "Installez l'agent Mintlify dans Slack pour poser des questions sur votre produit, créer des mises à jour de contenu à partir des conversations d'équipe et capturer les connaissances dans des pull requests."
