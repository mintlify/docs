...
les autres membres de l'équipe. Vous pouvez passer à un autre déploiement à tout moment pendant une
conversation en cliquant sur le bouton **Switch deployment** dans le message de statut de l'agent
dans le fil. L'agent conserve votre historique de conversation afin que vous puissiez
reprendre là où vous en étiez avec le nouveau déploiement.
</Tip>
...
- Poursuivre les conversations dans des fils pour affiner les modifications ou poser des questions de suivi.
...
Lorsque l'agent apporte des modifications à votre documentation, il fournit un retour en direct dans le fil Slack.
...
- **Soyez précis** : Indiquez exactement à l'agent ce que vous voulez savoir ou ce que vous souhaitez modifier et où.
