...
description: "Ajoutez l'agent Mintlify à Slack pour poser des questions sur vos docs, créer des mises à jour depuis les conversations et capturer le savoir de l'équipe."
