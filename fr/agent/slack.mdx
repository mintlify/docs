...
description: "Installez l'agent Mintlify dans Slack pour poser des questions, transformer les conversations d'équipe en mises à jour de contenu et capturer les connaissances dans des pull requests."
