...
- **Avec des pièces jointes** : Téléversez des images, des diagrammes, des fichiers de code ou d'autres documents avec votre message. L'agent les traite automatiquement et les inclut dans votre documentation. L'agent prend également en compte les fichiers et images publiés plus tôt dans le même fil depuis sa dernière réponse : vous pouvez donc partager une capture d'écran, puis mentionner `@mintlify` dans un message suivant pour qu'il agisse dessus.
