...
<div id="disconnect-your-slack-workspace">
  ## Déconnectez votre espace de travail Slack
</div>
...
1. Ouvrez le panneau de l'agent dans votre Dashboard.
2. Cliquez sur le bouton **Settings**.
3. Dans la section d'intégration à Slack, cliquez sur **Disconnect**.
4. Confirmez la suppression lorsque vous y êtes invité.

La déconnexion supprime l'application Mintlify de votre espace de travail Slack et dissocie tous les comptes utilisateurs connectés.
