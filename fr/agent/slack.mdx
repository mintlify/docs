...
<Tip>
  Si vous installez l'application Slack mais fermez le Dashboard avant de terminer la connexion, l'agent vous envoie un message direct dans Slack avec un bouton **Connect to Mintlify**. Cliquez sur ce bouton pour revenir au Dashboard et terminer la liaison de votre espace de travail. L'invite n'est envoyée qu'à la personne qui a installé l'application, et une seule fois par espace de travail.
</Tip>
