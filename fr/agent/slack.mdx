...
<Note>
  L'agent Slack n'est pas disponible pour les déploiements [Bitbucket Cloud](/fr/deploy/bitbucket).
...
Vous pouvez également partager un lien vers une pull request dans n'importe quel déploiement connecté. L'agent bascule automatiquement vers ce déploiement et poursuit la PR.
</Tip>
