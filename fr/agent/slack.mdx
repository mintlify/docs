...
La connexion est définie au niveau de votre organisation, vous n'avez donc besoin de configurer chaque intégration qu'une seule fois. Pour supprimer ou réautoriser une intégration ultérieurement, utilisez la section **Agent settings** de la page [Agent](https://dashboard.mintlify.com/products/agent).
