...
- Poursuivre les conversations dans des fils pour affiner les modifications. L'agent réutilise les fichiers et images partagés plus tôt dans le fil comme contexte pour les demandes de suivi, ce qui évite de les téléverser à nouveau.
...
- **Avec des pièces jointes** : Téléversez des images, des diagrammes, des fichiers de code ou d'autres documents avec votre message. L'agent les traite automatiquement et les inclut dans votre documentation. Dans un fil, l'agent a également accès aux images et fichiers partagés dans les messages précédents, vous pouvez donc y faire référence dans des demandes de suivi sans les téléverser à nouveau.
