...
description: "Ajoutez l'agent Mintlify à Slack pour poser des questions, créer des mises à jour de contenu depuis les conversations et capturer les savoirs d'équipe."
