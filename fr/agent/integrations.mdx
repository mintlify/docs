...
Le contenu qui est apparu dans les réponses passées de l'agent ou dans des pull requests reste en place (transcriptions de chat, pages publiées, historique de PR). Éditez ou supprimez directement les pages et les conversations si vous souhaitez également que ce contenu soit retiré.
