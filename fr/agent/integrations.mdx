...
- **Les intégrations partagées** sont connectées une seule fois pour toute votre organisation. N'importe quel membre de l'équipe peut demander à l'agent de les utiliser. Slack, Notion, Linear, Jira, Salesforce, Intercom et Plain sont partagées.
