...
### Désactivation automatique lorsque les crédits sont épuisés

Si une exécution de workflow échoue parce que votre organisation est à court de crédits Mintlify, Mintlify désactive automatiquement tous les workflows actifs du projet afin d'éviter de nouvelles exécutions en échec. Tous les membres de votre organisation reçoivent un e-mail les informant que les workflows ont été mis en pause, avec un lien vers la page de facturation.

Pour reprendre l'automatisation :

1. Ajoutez des crédits ou mettez à jour votre forfait depuis la page [Billing](https://dashboard.mintlify.com/settings/organization/plans) de votre dashboard.
2. Ouvrez la page [Workflows](https://dashboard.mintlify.com/products/workflows?tab=workflows) et réactivez chaque workflow que vous souhaitez exécuter.

Réactiver un workflow efface l'état de désactivation lié à la facturation. Les workflows planifiés recalculent leur prochaine exécution à partir du moment où vous les réactivez.
