...
Pour les référentiels GitLab, connectez vos projets via [GitLab OAuth](https://dashboard.mintlify.com/settings/organization/gitlab-oauth) dans les paramètres de votre dashboard. Vous pouvez également utiliser l’[intégration GitLab](/fr/deploy/gitlab) avec un jeton d’accès et un webhook.
