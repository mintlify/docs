...
1. Ouvrez la page [Automations](https://dashboard.mintlify.com/products/automations).
...
Modifiez, supprimez, désactivez ou déclenchez des workflows depuis la page [Automations](https://dashboard.mintlify.com/products/automations) de votre dashboard.
...
1. Accédez à la page [Automations](https://dashboard.mintlify.com/products/automations) dans votre dashboard.
