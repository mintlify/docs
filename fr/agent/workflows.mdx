...
Pour les référentiels GitHub, vous devez avoir installé la GitHub App Mintlify sur chaque dépôt répertorié comme référentiel de contexte ou déclencheur de push. Ajoutez de nouveaux dépôts sur la page [GitHub app](https://dashboard.mintlify.com/settings/organization/github-app) de votre dashboard Mintlify.
...
**Déclencheur :** push vers `your-org/your-docs` (branche `main`)
...
**Déclencheur :** cron `"0 9 * * 3"` (chaque mercredi à 9 h 00 UTC)
...
**Déclencheur :** cron `"0 9 * * 1"` (chaque lundi à 9 h 00 UTC)
