...
3. Choisissez un modèle de workflow pour commencer avec des paramètres pré-remplis, ou sélectionnez **Custom workflow** pour en créer un de zéro.
4. Configurez le nom du workflow, le type de déclencheur et la planification.
5. Rédigez le prompt de l'agent avec les instructions sur ce qu'il doit mettre à jour.
6. Dans **Settings**, activez optionnellement **Additional context repos**, **Auto-merge** ou **Slack notifications**.
7. Cliquez sur **Create workflow**.
