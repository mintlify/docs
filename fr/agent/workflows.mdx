...
<Info>
  Les workflows sont en bêta. Les fonctionnalités, la disponibilité et la tarification des workflows sont susceptibles d'être modifiées.
</Info>
...
Les offres Hobby sont limitées à 100 exécutions de workflow par mois pour l’ensemble des workflows. Les exécutions non échouées dans une fenêtre glissante de 30 jours sont comptabilisées dans cette limite. [Mettez à niveau votre offre](https://mintlify.com/pricing) pour supprimer le plafond mensuel.
...
Vous pouvez exécuter les workflows basés sur cron à la demande sans attendre la prochaine heure planifiée. Les exécutions déclenchées manuellement sont comptabilisées dans les limites quotidienne et mensuelle d'exécutions.
