...
<Note>
  Les notifications Slack nécessitent une installation de Slack dans votre organisation. Connectez Slack sur la page [intégration Slack](https://dashboard.mintlify.com/settings/organization/integrations/slack) de votre Dashboard.
</Note>
