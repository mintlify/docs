...
5. Facultatif : activez les notifications Slack pour la fin du workflow.
...
<Note>
Les notifications Slack nécessitent l'application Slack de Mintlify dans l'espace de travail Slack de votre organisation. Installez l'application Slack depuis votre [dashboard](https://dashboard.mintlify.com/products/agent).
</Note>
