...
description: "Personnalisez le comportement de l'agent avec un fichier de configuration `AGENTS.md` pour contrôler la façon dont il gère les tâches de documentation et suit vos conventions."
