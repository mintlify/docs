...
<Warning>
  Placez votre fichier `AGENTS.md` dans le répertoire `.mintlify/` (`.mintlify/AGENTS.md`), et non à la racine de votre projet. Les fichiers à la racine de votre projet sont accessibles publiquement sur votre site de documentation, ce qui signifie que vos instructions personnalisées seraient visibles par tous. Le répertoire `.mintlify/` n’est pas servi publiquement.
</Warning>
