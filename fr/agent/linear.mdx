...
description: "Connectez l'agent Mintlify à Linear pour créer des mises à jour de documentation à partir d'issues, de commentaires et d'activités de projet."
