...
description: "Connectez l'agent Mintlify à Linear pour qu'il puisse rédiger des mises à jour de documentation à partir des issues, commentaires et activités de projet."
