...
description: "Mintlify est une plateforme de documentation conçue pour les développeurs et l’IA, avec une recherche intelligente, des playgrounds d’API interactifs et des analytiques intégrées."
