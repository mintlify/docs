...
- **pageUrl** : URL complète de la page de documentation où la conversation a démarré, ou `null` si aucun chemin de page n'a été capturé. Utilisez ce champ pour attribuer les conversations à une page spécifique.