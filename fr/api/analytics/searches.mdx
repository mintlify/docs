...
description: "Exportez les termes de recherche paginés avec le taux de clics, le chemin du résultat le plus cliqué et le total des recherches sur la période choisie."
