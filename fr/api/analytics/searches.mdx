...
description: "Exportez les données de recherche dans la documentation, classées par fréquence, pour voir les termes les plus recherchés par les utilisateurs."
