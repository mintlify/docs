...
Si la branche n’existe pas, l’agent en crée une. Si l’agent modifie des fichiers avec succès, il crée automatiquement une pull request (demande de fusion) à la fin de la tâche.
