...
description: "Endpoint v1 obsolète pour envoyer un message à l'assistant IA Mintlify. À utiliser avec AI SDK v4 uniquement; passez à v2 pour les SDK plus récents."
