---
title: "Créer un message assistant (v1)"
description: "Obsolète. Envoyez des messages à l'assistant IA via AI SDK v4. Utilisez l'endpoint v2 pour AI SDK v5 ou ultérieur."
