---
title: "Créer un message assistant"
description: "Envoyez des messages à l'assistant IA et recevez des réponses en streaming via AI SDK v5 ou ultérieur avec le hook useChat."
