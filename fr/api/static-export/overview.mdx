...
<Info>
  L'exportation statique est en bêta privée et nécessite un accord entreprise. Contactez [sales@mintlify.com](mailto:sales@mintlify.com) pour demander l'accès.
</Info>
...
<Steps>
  <Step title="Démarrer une tâche d'exportation statique">
    ...
    Un projet ne peut avoir qu'une seule tâche active à la fois. Si une tâche est déjà `queued` ou `running` pour le projet, l'endpoint retourne `409`. L'endpoint est limité à 10 démarrages de tâche par organisation et par heure.
  </Step>
