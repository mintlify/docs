...
description: "Générez des pages de référence pour votre API GraphQL depuis un fichier de schéma, avec types liés et exemples de requêtes, mutations et réponses."
