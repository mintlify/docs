...
description: "Décrivez des API avec des schémas flexibles via oneOf, anyOf et allOf pour les propriétés optionnelles, le polymorphisme et les formats multiples."
