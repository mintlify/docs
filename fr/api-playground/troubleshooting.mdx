---
title: "Dépannage"
description: "Résolvez les problèmes courants liés à la configuration des pages d’API."
keywords: ["dépannage d’API", "OpenAPI invalide", "problèmes de configuration"]
---

Si vos pages d’API ne s’affichent pas correctement, passez en revue ces problèmes de configuration courants :
