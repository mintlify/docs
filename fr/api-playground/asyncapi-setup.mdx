...
description: "Configurez une documentation WebSocket en temps réel avec des fichiers de spécification AsyncAPI pour générer des pages de référence interactives de canaux et de messages."
