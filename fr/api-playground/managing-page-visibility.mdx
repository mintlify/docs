...
Vous pouvez décider quelles opérations OpenAPI sont publiées en tant que pages de documentation et contrôler leur visibilité dans la navigation. C’est utile pour des endpoints internes, des opérations obsolètes, des fonctionnalités bêta, ou des endpoints qui doivent rester accessibles via une URL directe sans être visibles dans la navigation du site.
