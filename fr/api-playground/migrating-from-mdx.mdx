...
<Steps>
  <Step title="Préparez votre spécification OpenAPI.">
    ...
    Pour tout endpoint dont vous souhaitez personnaliser les métadonnées ou le contenu, ajoutez l’extension `x-mint` à cet endpoint. Voir [extension x-mint](/fr/api-playground/openapi-setup#x-mint-extension) pour plus de détails.
