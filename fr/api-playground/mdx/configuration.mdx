...
<Steps>
  <Step title="Configurer votre API">
    ...
    Retrouvez la liste complète des configurations d’API dans [Paramètres](/fr/fr/settings#api-configurations).
  </Step>
  ...
  <Step title="Ajouter vos endpoints à votre documentation">
    Ajoutez vos pages d’endpoint à la barre latérale en ajoutant les chemins dans le champ `navigation` de votre `docs.json`. En savoir plus sur la structuration de votre documentation dans [Navigation](/fr/fr/navigation).
  </Step>
</Steps>
