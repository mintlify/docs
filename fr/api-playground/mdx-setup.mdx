...
description: "Créez manuellement des pages de référence d'API avec des fichiers MDX pour les petites API, les prototypes ou les besoins de documentation personnalisés."
