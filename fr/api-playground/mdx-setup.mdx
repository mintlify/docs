...
description: "Créez manuellement des pages de référence d'API avec des fichiers MDX quand vous avez besoin d'un contrôle total sur la mise en page, pour de petites APIs, des prototypes ou de la documentation personnalisée."
