...
description: "Créez manuellement des pages de référence d'API avec des fichiers MDX pour de petites API, des prototypes ou des besoins de documentation personnalisés."
