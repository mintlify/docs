...
<ResponseField name="url" type="&quot;full&quot;">
    Le mode d'affichage des URL de base dans les en-têtes des endpoints. Lorsqu'il est défini sur `full`, l'URL de base complète s'affiche pour chaque page d'endpoint. Par défaut, seul le chemin relatif de l'endpoint s'affiche.
</ResponseField>
...
* [Extension x-mint](/fr/api-playground/openapi-setup#customize-your-endpoint-pages) pour en savoir plus sur la personnalisation de vos pages d’endpoint.
