...
<Frame>
  <img src="/images/obama.jpg" alt="Playground API pour l’endpoint « Déclencher une mise à jour »." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Playground API pour l’endpoint « Déclencher une mise à jour »." className="hidden dark:block" />
</Frame>
