...
Personnalisez les pages de vos endpoints en ajoutant l’extension `x-mint` à votre spécification OpenAPI. L’extension `x-mint` vous offre un contrôle accru sur la manière dont votre documentation d’API est générée et affichée.
