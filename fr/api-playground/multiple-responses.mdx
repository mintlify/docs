...
description: "Documentez plusieurs variations de réponses pour des points de terminaison d’API, y compris les cas de succès et d’erreur, avec des codes d’état et des exemples de payload."
