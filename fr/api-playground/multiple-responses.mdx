...
description: "Documentez plusieurs variations de réponses pour vos endpoints d'API, succès et erreurs inclus, avec codes d'état et exemples de payload détaillés."
