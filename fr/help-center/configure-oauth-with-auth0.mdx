...
description: "Configurez Auth0 comme fournisseur d'identité OAuth 2.0 pour un site de documentation Mintlify privé : URL d'endpoints, callback et accès par groupes."
