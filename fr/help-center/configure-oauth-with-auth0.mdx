...
description: "Configurez Auth0 comme fournisseur OAuth 2.0 pour une documentation Mintlify privée : URL des endpoints, callback et contrôle d'accès par groupes."
