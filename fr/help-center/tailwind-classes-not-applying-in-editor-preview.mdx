...
description: "L'aperçu en direct de l'éditeur web ignore le build qui génère le CSS des classes Tailwind. Vérifiez le style avec mint dev ou un déploiement de prévisualisation."
