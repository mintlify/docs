---
title: "Les classes Tailwind ne s'appliquent pas dans l'aperçu"
description: "L'aperçu en direct de l'éditeur ignore le build qui génère le CSS de Tailwind. Vérifiez le style avec mint dev ou un déploiement de prévisualisation."
