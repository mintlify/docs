...
<ResponseField name="integrations.segment" type="object">
  ...
  <Expandable title="integrations.segment">
    ...
    <ResponseField name="cdnUrl" type="string">
      Une URL de CDN personnalisée pour charger le script Segment. Doit être une URL HTTPS sans paramètres de requête ni fragments. La valeur par défaut est `https://cdn.segment.com`.
    </ResponseField>
  </Expandable>
</ResponseField>
