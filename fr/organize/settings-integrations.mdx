---
title: "Intégrations"
description: "Connectez plateformes d’analyse, widgets de chat et services tiers à votre site de documentation Mintlify via la configuration des intégrations docs.json."
...
<ResponseField name="integrations.segment" type="object">
  ...
  <Expandable title="integrations.segment">
    ...
    <ResponseField name="cdnUrl" type="string">
      URL de CDN personnalisée pour charger le script Segment, à utiliser avec la [fonctionnalité de domaine personnalisé de Segment](https://segment.com/docs/connections/sources/custom-domains/). Doit être une URL HTTPS sans paramètres de requête ni fragments.
    </ResponseField>
  </Expandable>
</ResponseField>
