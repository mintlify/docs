...
<ResponseField name="integrations.customScripts" type="array of objects">
  Chargez des scripts externes sur votre site de documentation. Chaque script doit utiliser une URL HTTPS. Maximum 20 scripts.
  ...
  <Expandable title="integrations.customScripts item">
    ...
    <ResponseField name="strategy" type="string">
      La stratégie de chargement du script. `afterInteractive` ou `lazyOnload`. Par défaut : `afterInteractive`.
    </ResponseField>
  </Expandable>
</ResponseField>
