...
<ResponseField name="integrations.commonRoom" type="object">
  Intégration d'intelligence visiteur Common Room.

  <Expandable title="integrations.commonRoom">
    <ResponseField name="siteId" type="string (uuid)" required>
      Votre identifiant de site Common Room. Doit être un UUID valide.
    </ResponseField>
  </Expandable>
</ResponseField>
