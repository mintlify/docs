...
<ResponseField name="groups" type="string[]">
  Restreindre la page aux utilisateurs appartenant à des groupes spécifiques. Les utilisateurs doivent appartenir à au moins un des groupes listés pour accéder à la page. L'[authentification](/fr/deploy/authentication-setup) doit être configurée. Voir [Contrôler l'accès avec les groupes](/fr/deploy/authentication-setup#control-access-with-groups) pour plus d'informations.
</ResponseField>
