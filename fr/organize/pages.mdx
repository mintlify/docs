---
title: "Pages"
description: "Configurez les métadonnées de page, les titres, les descriptions, les icônes et les modes de mise en page avec des propriétés YAML frontmatter en haut de votre documentation MDX."
