...
Le mode personnalisé propose une mise en page minimaliste qui supprime tous les éléments, à l’exception de la barre de navigation supérieure. C’est une toile blanche pour créer des pages de destination ou d’autres mises en page uniques lorsque vous souhaitez limiter les éléments de navigation. Le mode personnalisé est disponible pour tous les thèmes.
