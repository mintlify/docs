...
Affichez la mention « Dernière modification le [date] » sur toutes les pages en activant `metadata.timestamp` dans vos [paramètres globaux](/fr/organize/settings#metadata).
