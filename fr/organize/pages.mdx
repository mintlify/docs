...
<ResponseField name="searchable" type="boolean">
  Définir sur `false` pour exclure la page des résultats de recherche de votre site de documentation et du contexte de l'assistant IA, tout en la conservant indexable par les moteurs de recherche externes et listée dans votre sitemap. La page reste visible dans la navigation. Voir [Exclure une page de la recherche](/fr/optimize/search#exclude-a-page-from-search) pour plus de détails.
</ResponseField>
