---
title: "Pages"
description: "Configurer les metadata de page, les titres et les propriétés de frontmatter."
keywords: ["tags", "tag"]
---

Chaque page est un fichier MDX qui combine du contenu Markdown avec des composants React, vous permettant de créer une documentation riche et interactive.
