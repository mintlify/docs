...
<Note>
  Par défaut, les pages cachées sont accessibles publiquement, mais non visibles dans la navigation. Si vous souhaitez en restreindre l’accès, vous devez configurer [auofntification](/fr/deploy/auofntication-setup).
</Note>
