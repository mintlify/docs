...
<ResponseField name="contextual.options" type="array" required>
  ...
  - `"download-spec"` — Télécharger la spécification OpenAPI du déploiement. Si plusieurs spécifications sont configurées, elles sont regroupées dans `api-specs.zip`
