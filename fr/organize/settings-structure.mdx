...
<ResponseField name="navbar.links" type="array of object">
  ...
  <Expandable title="navbar.links">
    ...
    <ResponseField name="href" type="string (uri)" required>
      Destination du lien. Accepte une URL absolue ou un chemin relatif commençant par `/`, comme `/quickstart`. Pour `github`, doit être une URL de dépôt GitHub. Pour `discord`, doit être une URL d'invitation Discord.
    </ResponseField>
    <IconsOptional />
  </Expandable>
</ResponseField>
...
<ResponseField name="navbar.primary" type="object">
  ...
  <Expandable title="navbar.primary">
    ...
    <ResponseField name="href" type="string (uri)" required>
      Destination du bouton. Accepte une URL absolue ou un chemin relatif commençant par `/`, comme `/contact`. Pour `github`, doit être une URL de dépôt GitHub. Pour `discord`, doit être une URL d'invitation Discord.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="contextual.options" type="array" required>
  ...
  - `"download-spec"`—Télécharger les spécifications OpenAPI du projet (un seul fichier, ou compressées en zip s'il y en a plusieurs)
