    ...
    <ResponseField name="tabs" type="array of object">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="searchable" type="boolean">
          Lorsque `hidden` est `true`, définissez `searchable: true` pour conserver les pages descendantes dans la recherche, le sitemap, `llms.txt` et l’Assistant IA. Voir [Pages masquées](/fr/organize/hidden-pages#keep-hidden-pages-discoverable-with-searchable).
        </ResponseField>
