...
description: "Configurez la barre de navigation, la navigation, le pied de page, la bannière, le menu contextuel, les redirections et d'autres paramètres structurels dans votre fichier `docs.json`."
  ...
  <Expandable title="navigation.global">
    <ResponseField name="tabs" type="array of object">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, chemin ou lien d'ancrage de destination de l'onglet. Prend en charge les URL absolues, les chemins relatifs commençant par `/` et les liens de hachage commençant par `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="anchors" type="array of object">
      ...
      <Expandable title="anchors">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, chemin ou lien d'ancrage de destination de l'ancre. Prend en charge les URL absolues, les chemins relatifs commençant par `/` et les liens de hachage commençant par `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="dropdowns" type="array of object">
      ...
      <Expandable title="dropdowns">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, chemin ou lien d'ancrage de destination du menu déroulant. Prend en charge les URL absolues, les chemins relatifs commençant par `/` et les liens de hachage commençant par `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="languages" type="array of object">
      ...
      <Expandable title="languages">
        ...
        <ResponseField name="href" type="string (uri)" required>
          Un chemin, un lien externe ou un lien d'ancrage valide vers cette version linguistique de votre documentation. Prend en charge les URL absolues, les chemins relatifs commençant par `/` et les liens de hachage commençant par `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="versions" type="array of object">
      ...
      <Expandable title="versions">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, chemin ou lien d'ancrage vers cette version de votre documentation. Prend en charge les URL absolues, les chemins relatifs commençant par `/` et les liens de hachage commençant par `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
