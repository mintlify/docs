...
<ResponseField name="navigation.mode" type='"auto" | "tree"'>
  Mode de navigation hérité par tous les groupes. Définissez sur `"tree"` pour afficher une [arborescence de navigation](/fr/organize/navigation#navigation-arborescente) sur les pages racines des groupes. Par défaut `"auto"`. Peut être remplacé sur les groupes, onglets ou ancres individuels.
</ResponseField>
