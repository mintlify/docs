...
| `searchable: false` (frontmatter de la page) | Visible | Exclue | Incluse | Incluse | Exclue |
...
Au niveau du frontmatter d'une page, `searchable` n'accepte que `false`. Utilisez-le pour conserver une page indexable par les moteurs de recherche externes tout en l'excluant de la recherche intégrée au produit et du contexte de l'assistant IA. Consultez [Exclure une page de la recherche](/fr/optimize/search#exclude-a-page-from-search) pour un exemple.
