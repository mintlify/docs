...
description: "Excluez des fichiers et répertoires spécifiques de votre documentation publiée à l'aide d'un fichier .mintignore avec des patterns glob, similaire à la syntaxe .gitignore."
