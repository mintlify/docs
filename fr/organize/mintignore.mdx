...
Le fichier `.mintignore` vous permet d&#39;exclure des fichiers et des répertoires spécifiques dans votre référentiel de documentation d&#39;être traités et publiés sur votre site de documentation.
