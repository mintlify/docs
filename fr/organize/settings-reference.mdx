...
Mode de navigation hérité par tous les groupes descendants. Définissez sur `"tree"` pour afficher une arborescence de navigation sur les pages racine des groupes. Par défaut `"auto"`. Peut être remplacé sur des groupes, tabs ou anchors individuels.
