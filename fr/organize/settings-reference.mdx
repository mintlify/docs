...
Mode de navigation hérité par tous les groupes descendants. Définissez sur `"tree"` pour afficher une arborescence de navigation sur les pages racines des groupes montrant les pages enfants et les groupes imbriqués. Peut être remplacé au niveau du groupe, de l'onglet ou de l'ancre. Par défaut `"auto"`.
