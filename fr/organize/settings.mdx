...
<ResponseField name="API" type="object">
  ...
  <Expandable title="API">
    ...
    <ResponseField name="bac à sable" type="object">
      ...
      <Expandable title="Playground">
        <ResponseField name="display" type="&#x22;interactive&#x22; | &#x22;simple&#x22; | &#x22;none&#x22; | &#x22;auth&#x22;">
          Mode d’affichage du bac à sable d’API. La valeur par défaut est `interactive`. Utilisez `auth` pour afficher le bac à sable uniquement aux utilisateurs authentifiés.
        </ResponseField>
    ...
    <ResponseField name="URL" type="&#x22;full&#x22;">
      Le mode d&#39;affichage de l&#39;URL de base dans l&#39;en-tête du point de terminaison. Définissez sur `full` pour toujours afficher l&#39;URL de base complète sur chaque page de point de terminaison. Par défaut, l&#39;URL de base n&#39;est affichée que lorsqu&#39;il y a plusieurs URL de base à sélectionner.
    </ResponseField>
    ...
    <ResponseField name="exemples" type="object">
      ...
      <Expandable title="Examples">
        <ResponseField name="languages" type="array of string">
          Langues d'exemple pour les extraits d'API générés automatiquement. Consultez [langues prises en charge](/fr/api-playground/overview#all-supported-languages) pour la liste complète des langues et alias disponibles.
        </ResponseField>
        ...
        <ResponseField name="autogenerate" type="boolean">
          Indique s’il faut générer des exemples de code pour les points de terminaison (endpoints) à partir des spécifications d’API. La valeur par défaut est `true`. Lorsqu’il est défini sur `false`, seuls les exemples de code écrits manuellement (à partir de `x-codeSamples` dans les spécifications OpenAPI ou des composants `<RequestExample>` dans MDX) apparaissent dans le bac à sable d’API.
        </ResponseField>
      </Expandable>
    </ResponseField>

    <ResponseField name="spécification" type="object">
      Paramètres pour la spécification OpenAPI.

      <Expandable title="Spécification">
    ...
    <ResponseField name="mdx" type="object">
      ...
      <Expandable title="Mdx">
        ...
        <ResponseField name="server" type="string or array">
          URL de base préfixée aux chemins relatifs dans les champs `api` du frontmatter au niveau de la page. Non utilisée lorsque le frontmatter contient une URL complète.
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
