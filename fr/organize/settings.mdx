...
<ResponseField name="integrations" type="object">
  ...
  <Expandable title="Intégrations">
    <ResponseField name="Amplitude" type="object">
      Intégration à Amplitude.

      <Expandable title="Amplitude">
        <ResponseField name="apiKey" type="string" required>
          Votre key d’API Amplitude.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="Interphone" type="object">
    ...
    <ResponseField name="Pirsch" type="object">
      Intégration d’Analytics Pirsch.
    ...
    <ResponseField name="télémétrie" type="object">
      ...
      <Expandable title="Télémétrie">
        <ResponseField name="enabled" type="boolean">
          ...
          <Note>
            Lorsque défini sur `false`, les fonctionnalités de retour d’expérience sont également désactivées et n’apparaissent pas sur vos pages de documentation.
          </Note>
        </ResponseField>
      </Expandable>
    </ResponseField>
