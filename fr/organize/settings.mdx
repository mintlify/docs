...
description: "Configurez les paramètres globaux du site dans docs.json."
keywords: ["docs.json","settings","customization","configuration","logo"]
---

import IconsOptional from "/snippets/fr/icons-optional.mdx";

Le fichier `docs.json` vous permet de transformer une collection de fichiers Markdown en un site de documentation navigable et personnalisé. Ce fichier de configuration obligatoire contrôle le style, la navigation, les intégrations, et bien plus encore. Considérez-le comme le plan directeur de votre documentation.
