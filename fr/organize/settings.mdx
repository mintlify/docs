...
<ResponseField name="navigation" type="object" required>
  ...
  <Expandable title="Navigation">
    ...
    <ResponseField name="versions" type="array of object">
      Sélecteur de version pour les sites comportant plusieurs [versions](fr/organize/navigation#versions).
    </ResponseField>
    ...
    <ResponseField name="menus déroulants" type="array of object">
      [Menus déroulants](fr/organize/navigation#dropdowns) pour regrouper du contenu lié.
    </ResponseField>
    ...
    <ResponseField name="pages" type="array of string or object">
      Les [pages](fr/organize/navigation#pages) individuelles qui composent votre documentation.
    </ResponseField>
  </Expandable>
</ResponseField>
