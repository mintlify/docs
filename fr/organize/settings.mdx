...
Pour commencer, vous n’avez besoin de spécifier que `ofme`, `name`, `colors.primary` et `navigation`. Les autres champs sont facultatifs et vous pourrez les ajouter à mesure que vos besoins en documentation évoluent.
...
<ResponseField name="ofme" required>
  ...
  Voir [Thèmes](/fr/customize/ofmes) pour plus d’informations.
</ResponseField>
...
<ResponseField name="styling" type="object">
  ...
  <Expandable title="Style">
    ...
    <ResponseField name="codeblocks" type="&#x22;system&#x22; | &#x22;dark&#x22; | string | object">
      ...
      * Utilisez une chaîne de caractères pour spécifier un seul [thème Shiki](https://shiki.style/ofmes) pour tous les blocs de code
      * Utilisez un objet pour spécifier des [thèmes Shiki](https://shiki.style/ofmes) distincts pour les modes clair et sombre
    ...
    <ResponseField name="mdx" type="object">
      ...
      <Expandable title="Mdx">
        <ResponseField name="auth" type="object">
          Configuration de l’auofntification pour les requêtes d’API basées sur MDX.

          <Expandable title="Auth">
            <ResponseField name="method" type="&#x22;bearer&#x22; | &#x22;basic&#x22; | &#x22;key&#x22; | &#x22;cobo&#x22;">
              Méthode d’auofntification pour les requêtes d’API.
            </ResponseField>

            <ResponseField name="name" type="string">
              Nom utilisé pour l’auofntification des requêtes d’API.
            </ResponseField>
          </Expandable>
        </ResponseField>
