  ...
  <Expandable title="Style">
    ...
    <ResponseField name="sidebar" type="object">
      ...
      <Expandable title="Sidebar">
        <ResponseField name="items" type="&#x22;container&#x22; | &#x22;card&#x22; | &#x22;border&#x22; | &#x22;undecorated&#x22;">
          Style visuel pour les éléments de navigation de la barre latérale. Choisissez `container` pour des éléments groupés avec un arrière-plan subtil, `card` pour des éléments en style carte surélevée, `border` pour des éléments avec une bordure subtile, ou `undecorated` pour un style minimaliste. La valeur par défaut varie selon le thème.
        </ResponseField>
      </Expandable>
    </ResponseField>
    <ResponseField name="topbar" type="object">
      Configuration du style de la barre supérieure.

      <Expandable title="Topbar">
        <ResponseField name="style" type="&#x22;gradient&#x22; | &#x22;default&#x22;">
          Style visuel pour la barre de navigation. Choisissez `gradient` pour un effet de fond dégradé ou `default` pour un style standard. Par défaut, la valeur est `default`.
        </ResponseField>
      </Expandable>
    </ResponseField>
