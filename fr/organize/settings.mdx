  ...
  <Expandable title="Barre de navigation">
    ...
    <ResponseField name="primary" type="object">
      ...
      <Expandable title="Principal">
        ...
        <ResponseField name="href" type="string (uri)" required>
          Destination du bouton. Doit être une URL externe valide. Si `type` est `github`, il doit s&#39;agir de l&#39;URL d&#39;un référentiel GitHub. Si `type` est `discord`, il doit s&#39;agir d&#39;une URL d&#39;invitation Discord.
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
