...
<Steps>
  ...
  <Step title="Créer votre fichier docs.json">
    ...
    Cette commande crée automatiquement un fichier `docs.json` à partir de votre `mint.json` existant. Vérifiez le fichier généré pour vous assurer que tous les paramètres sont corrects.
  </Step>
