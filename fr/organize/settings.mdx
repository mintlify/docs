...
<ResponseField name="navigation" type="object" required>
  ...
  <Expandable title="Navigation">
    ...
    <ResponseField name="Onglets" type="array of object">
      Onglets de navigation de premier niveau [tabs](fr/organize/navigation#tabs).
    </ResponseField>
    ...
    <ResponseField name="pages" type="array of string or object">
      Des [pages](fr/organize/navigation#pages) individuelles qui constituent votre documentation.
    </ResponseField>
  </Expandable>
</ResponseField>
