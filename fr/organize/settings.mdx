...
<ResponseField name="navigation" type="object" required>
  ...
  <Expandable title="Navigation">
    <ResponseField name="global" type="object">
      ...
      <Expandable title="Global">
        ...
        <ResponseField name="ancres" type="array of object">
          Liens d’ancrage affichés en évidence dans la navigation de la barre latérale.
    ...
    <ResponseField name="Onglets" type="array of object">
      Onglets de navigation de niveau supérieur [Onglets](fr/navigation#tabs).
    </ResponseField>

    <ResponseField name="ancres" type="array of object">
      Ancres dans la barre latérale : [anchors](fr/navigation#anchors).
    </ResponseField>
