    ...
    <ResponseField name="links" type="array of object">
      ...
      <Expandable title="Links">
        <ResponseField name="type" type="&#x22;github&#x22; | &#x22;discord&#x22;">
          Type de lien facultatif. Omettez-le pour un lien texte standard. Définissez `github` pour créer un lien vers un référentiel GitHub et afficher le nombre d&#39;étoiles du référentiel. Définissez `discord` pour créer un lien vers un serveur Discord et afficher le nombre d&#39;utilisateurs en ligne sur le serveur.
        </ResponseField>

        <ResponseField name="label" type="string">
          Texte du lien. Requis lorsque `type` n&#39;est pas défini. Facultatif pour les types `github` et `discord`. S&#39;il est omis, le libellé est automatiquement renseigné à partir des données de l&#39;API (nom du référentiel pour GitHub et nom du serveur pour Discord).
        </ResponseField>

        <ResponseField name="href" type="string (uri)" required>
          Destination du lien. Doit être une URL externe valide. Pour le type `github`, doit être une URL de référentiel GitHub. Pour le type `discord`, doit être une URL d&#39;invitation Discord.
        </ResponseField>
    ...
    <ResponseField name="primary" type="object">
      ...
      <Expandable title="Primary">
        <ResponseField name="type" type="&#x22;button&#x22; | &#x22;github&#x22; | &#x22;discord&#x22;" required>
          Style du bouton. Choisissez `button` pour un bouton standard avec un libellé, `github` pour un lien vers un référentiel GitHub avec le nombre d&#39;étoiles en temps réel, ou `discord` pour une invitation vers un serveur Discord avec le nombre d&#39;utilisateurs en ligne en temps réel.
        </ResponseField>

        <ResponseField name="label" type="string">
          Texte du bouton. Requis lorsque `type` vaut `button`. Facultatif pour les types `github` et `discord` — s&#39;il est omis, le libellé est automatiquement renseigné à partir des données de l&#39;API (nom du référentiel pour GitHub, nom du serveur pour Discord).
        </ResponseField>

        <ResponseField name="href" type="string (uri)" required>
          Destination du bouton. Doit être une URL externe. Si `type` vaut `github`, doit être une URL de référentiel GitHub. Si `type` vaut `discord`, doit être une URL d&#39;invitation Discord.
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
