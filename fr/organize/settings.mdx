    ...
    <ResponseField name="spec" type="object">
      ...
      <Expandable title="Spec">
        <ResponseField name="download" type="boolean">
          Indique s'il faut afficher un bouton de téléchargement pour la spécification OpenAPI sur les pages de référence de l'API. La valeur par défaut est `false`.
        </ResponseField>
      </Expandable>
    </ResponseField>
