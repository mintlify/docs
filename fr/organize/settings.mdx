...
<ResponseField name="background" type="object">
  ...
  <Expandable title="Arrière-plan">
    ...
    <ResponseField name="decoration" type="&#x22;gradient&#x22; | &#x22;grid&#x22; | &#x22;windows&#x22;">
      Style de décoration d'arrière-plan. Options :
      - `gradient` : Un dégradé radial subtil utilisant votre couleur primaire.
      - `grid` : Un dégradé radial avec un motif de grille superposé.
      - `windows` : Un dégradé radial avec un motif géométrique de fenêtres superposé.
    </ResponseField>
