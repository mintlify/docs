...
<ResponseField name="banner" type="object">
  ...
  <Expandable title="Banner">
    ...
    <ResponseField name="dismissible" type="boolean">
      Indique si les utilisateurs peuvent fermer la bannière. La valeur par défaut est `false`.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="snippets" type="array of strings">
  Spécifiez des dossiers supplémentaires contenant des snippets réutilisables à l’aide de [motifs glob](https://code.visualstudio.com/docs/editor/glob-patterns). Tous les fichiers situés dans des dossiers correspondant à ces motifs sont des snippets, en plus du dossier `/snippets/` par défaut.

  ```json Exemple de configuration des snippets
  {
...
<ResponseField name="Intégrations" type="object">
  ...
  <Expandable title="Integrations">
    ...
    <ResponseField name="tas" type="object">
    ...
    <ResponseField name="posthog" type="object">
      ...
      <Expandable title="Posthog">
        ...
        <ResponseField name="sessionRecording" type="boolean" default="true">
          Activer ou désactiver l’enregistrement de session.
        </ResponseField>
      </Expandable>
    </ResponseField>
