...
<ResponseField name="styling" type="object">
  ...
  <Expandable title="Styling">
    ...
    <ResponseField name="codeblocks" type="&#x22;system&#x22; | &#x22;dark&#x22; | string | object">
      Configuration du thème des code blocks. La valeur par défaut est `"system"`.

      **Configuration simple :**

      * `"system"` : fait correspondre le mode actuel du site (clair ou sombre)
...
<ResponseField name="fonts" type="object">
  ...
  <Expandable title="Fonts">
    ...
    <ResponseField name="source" type="string (uri)">
      URL de la source de votre police, par exemple https://mintlify-assets.b-cdn.net/fonts/Hubot-Sans.woff2. [Google Fonts](https://fonts.google.com) sont chargées automatiquement lorsque vous spécifiez un nom de `family` Google Fonts, aucune URL source n’est donc nécessaire.
    </ResponseField>
...
<ResponseField name="appearance" type="object">
  ...
  <Expandable title="Appearance">
    <ResponseField name="default" type="&#x22;system&#x22; | &#x22;light&#x22; | &#x22;dark&#x22;">
      Mode de thème par défaut. Choisissez `system` pour s’aligner sur les réglages du système d’exploitation des utilisateurs, ou `light`/`dark` pour imposer un mode spécifique. La valeur par défaut est `system`.
    </ResponseField>

    <ResponseField name="strict" type="boolean">
      Indique s’il faut masquer l’interrupteur de mode clair/sombre. La valeur par défaut est `true`.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="navigation" type="object" required>
  ...
  <Expandable title="Navigation">
    ...
    <ResponseField name="produits" type="array of object">
      Sélecteur de produits pour les sites avec plusieurs [produits](fr/navigation#products).
    </ResponseField>
