...
<ResponseField name="variables" type="object">
  Variables globales à utiliser dans toute votre documentation. Les variables utilisent la syntaxe `{{variableName}}` et sont remplacées lors du build.
  ...
  Utilisez les variables dans votre contenu MDX :
  ...
  Les noms de variables peuvent contenir des caractères alphanumériques, des tirets et des points. Les valeurs sont nettoyées afin de prévenir les attaques XSS. Les variables non définies restent du texte littéral.
</ResponseField>
