...
Ajoutez une icône à votre bloc de code avec la propriété `icon`. Consultez [Icônes](/fr/fr/components/icons) pour connaître toutes les options disponibles.
