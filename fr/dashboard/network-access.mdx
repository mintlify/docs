...
<div id="recover-from-a-lockout">
  ### Récupérer l'accès après un verrouillage
</div>

Si tous les administrateurs sont verrouillés hors du dashboard par la liste d'autorisation, contactez [support@mintlify.com](mailto:support@mintlify.com) depuis une adresse e-mail associée à votre organisation. Indiquez le nom de votre organisation et l'adresse IP à ajouter. L'équipe de support de Mintlify peut ajouter une adresse ou désactiver la liste d'autorisation pour vous permettre de retrouver l'accès.
