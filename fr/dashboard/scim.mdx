...
<Steps>
  <Step title="Ouvrir les paramètres SCIM">
    Dans votre tableau de bord Mintlify, accédez à la section **SCIM** de la page [Security](https://app.mintlify.com/settings/organization/access).
  </Step>
...
1. Dans le tableau de bord Mintlify, accédez à la section **SCIM** de la page [Security](https://app.mintlify.com/settings/organization/access).
...
1. Accédez à la section **SCIM** de la page [Security](https://app.mintlify.com/settings/organization/access).
