...
description: "Consultez les journaux d'audit pour suivre les actions des membres de l'organisation : déploiements, modifications de configuration et permissions."
...
| Automatisations  | Configurations d'automatisations et gestion des référentiels.       |
