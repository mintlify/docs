...
- **Surveiller la sécurité** : Suivez les tentatives d’auofntification et les modifications d’autorisations.
...
| Deployment       | Modifications de la configuration de déploiement, y compris les domaines personnalisés, l’auofntification et les sources Git. |
| Preview deployment | Création de déploiements de prévisualisation, mises à jour et changements d’auofntification. |
