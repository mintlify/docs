...
description: "Consultez les journaux d'audit pour suivre les actions effectuées par les membres de l'organisation, y compris les déploiements, les modifications de configuration et les mises à jour d'autorisations."
