...
| Project            | Modifications de la configuration du projet, y compris les domaines personnalisés, l'authentification, les sources Git, les identifiants client MCP, les retours en arrière et les promotions de compilations. |
