...
| Deployment         | Publications de contenu depuis l'éditeur web et modifications de la configuration de déploiement, y compris les domaines personnalisés, l'authentification, les sources Git et les identifiants client MCP. |
