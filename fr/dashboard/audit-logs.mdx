...
<Info>
  Les journaux d’audit sont disponibles avec les [Custom plans](https://mintlify.com/pricing?ref=audit-logs).
</Info>
...
| Suggestions      | Configurations de suggestions et gestion des référentiels.         |
