...
- **Plan Enterprise** : votre organisation doit disposer d'un [plan Enterprise](https://mintlify.com/pricing?ref=audit-logs).
- **Permission** : vous devez avoir la permission `org.auditLogs.read` dans votre organisation.

Si vous ne remplissez pas ces conditions, vous êtes redirigé vers la page des paramètres avec une notification expliquant pourquoi l'accès a été refusé.
