...
description: "Consultez les journaux d'audit pour suivre les actions de l'organisation : déploiements, modifications de configuration et mises à jour d'autorisations."
