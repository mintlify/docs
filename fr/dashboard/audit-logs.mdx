...
keywords: ["surveillance", "suivi des activités", "sécurité", "conformité", "SIEM"]
---
...
| Deployment         | Modifications de la configuration de déploiement, y compris les domaines personnalisés, l'authentification, les sources Git, les identifiants client MCP, les retours en arrière et les promotions de compilations. |
