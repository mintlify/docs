---
title: "Journaux d’audit des changements de votre organisation"
...
| Integration        | Intégrations tierces et modifications des identifiants ou des jetons de webhook, notamment pour GitHub, GitLab, Bitbucket, Slack, Discord, Linear, Notion, MCP et Composio. |
| Analytics          | Exports d'analytique.                                                                                                 |
| Analytics streaming | Modifications des destinations de diffusion et des événements ou déploiements inclus.                               |
...
| Workflow           | Création, mises à jour, suppression, activation ou désactivation, exécutions et changements de services connectés des workflows. |
| Audit log          | Consultations, exportations, destinations de diffusion et modifications de la configuration des catégories des journaux d'audit. |
