...
description: "Consultez les journaux d'audit pour suivre les actions effectuées par les membres de l'organisation, y compris les déploiements, les changements de configuration et les mises à jour de permissions."
...
| Integration      | Installations et suppressions de GitHub, Slack, Discord, Linear et Notion. |
