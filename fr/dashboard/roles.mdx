...
<Info>
  Le contrôle d'accès basé sur les rôles (RBAC) est disponible avec les [offres Pro et Enterprise](https://mintlify.com/pricing?ref=rbac).
</Info>
...
| Effectuer des retours en arrière et promouvoir des déploiements |   ❌    |   ✅    |       ✅       |
...
| Modifier le [paramètre de publication des agents](/fr/ai/mintlify-mcp#publishing) |   ❌    |   ❌    |       ✅       |
...
Vous pouvez inviter autant de membres que vous le souhaitez dans votre organisation. Les éditeurs et administrateurs peuvent inviter des éditeurs et des lecteurs. Seuls les administrateurs peuvent inviter d'autres administrateurs.
