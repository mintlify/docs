...
Les éditeurs et les administrateurs peuvent utiliser l'éditeur en ligne, déclencher des déploiements et gérer les intégrations depuis votre Dashboard. Lorsqu'un éditeur ou un administrateur publie via l'éditeur en ligne ou fusionne une pull request dans votre référentiel de documentation, les modifications sont automatiquement déployées sur votre site en production.
