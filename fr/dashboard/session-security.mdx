...
description: "Configurez les délais d'expiration des sessions du tableau de bord, la durée de vie maximale des sessions et une liste d'autorisation d'adresses IP afin d'appliquer des politiques d'authentification et d'accès réseau plus strictes."
