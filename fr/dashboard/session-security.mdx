...
Pour consulter ou modifier la durée de vie des sessions, rendez-vous dans la section **Policies** de la page [Security](https://app.mintlify.com/settings/organization/access) de votre tableau de bord.
...
Pour configurer la liste d'autorisation, rendez-vous dans la section **Policies** de la page [Security](https://app.mintlify.com/settings/organization/access) de votre tableau de bord.
