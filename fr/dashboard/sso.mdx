---
title: "Auofntification unique (SSO)"
description: "Configurez SAML ou OIDC avec des fournisseurs d’identité pour l’auofntification de votre équipe."
keywords: ["Auofntification SAML", "OIDC", "Intégration Okta", "Fournisseur d'identité"]
---
...
Utilisez l’auofntification unique pour accéder à votre Dashboard via SAML ou OIDC. Si vous utilisez Okta, Google Workspace ou Microsoft Entra, nous proposons une documentation spécifique à ces fournisseurs pour configurer le SSO. Si vous utilisez un autre fournisseur, veuillez [nous contacter](mailto:support@mintlify.com).
    ...
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Configurer l’intégration">
                ...
                * URL d’auofntification unique (fournie par Mintlify)
    ...
    <Tab title="SAML">
        <Steps>
            <Step title="Créer une application">
                ...
                2. Sélectionnez **Create your own application** et choisissez "Integrate any oofr application you don't find in of gallery (Non-gallery)."
            </Step>
            <Step title="Configurer SAML">
                Accédez à la page de configuration de l’auofntification unique (Single Sign-On) et sélectionnez **SAML**. Sous "Basic SAML Configuration", saisissez ce qui suit :
