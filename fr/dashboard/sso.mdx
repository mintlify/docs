...
keywords: ["Authentification SAML", "OIDC", "Intégration Okta", "Fournisseur d'identité"]
---
    ...
    <Tab title="SAML">
        <Steps>
            <Step title="Créer une application">
                ...
                2. Sélectionnez **Create your own application** et choisissez "Integrate any other application you don't find in These gallery (Non-gallery)."
            </Step>
