...
<Steps>
  <Step title="Configurer le SSO Okta dans votre dashboard Mintlify">
    1. Dans votre dashboard Mintlify, accédez à la page [Security](https://app.mintlify.com/settings/organization/access).
...
Pour activer le provisionnement JIT, vous devez avoir activé le SSO. Accédez à la page [Security](https://app.mintlify.com/settings/organization/access) de votre dashboard, configurez le SSO, puis activez le provisionnement JIT.
...
Vous pouvez ajouter jusqu'à 25 domaines vérifiés par organisation.

La section **Verified domains** n'apparaît que lorsque votre connexion SSO est active. [Configurez le SSO](#configure-sso) avant d'ajouter des domaines.

1. Accédez à la page [Security](https://app.mintlify.com/settings/organization/access) de votre dashboard.
2. Dans la section **SSO**, sous **Verified domains**, saisissez le domaine (par exemple, `example.com`) et cliquez sur **Add**.
...
Pour exiger que toutes les personnes de votre organisation se connectent via votre fournisseur d'identité, activez **Require SSO**. Lorsque **Require SSO** est activé, Mintlify rejette les connexions par mot de passe, lien magique et Google OAuth.
...
3. Dans la section **SSO**, activez **Require SSO**.
...
1. Accédez à la page [Security](https://app.mintlify.com/settings/organization/access) de votre dashboard.
2. Dans la section **SSO**, sous **Break-glass emails**, saisissez l'adresse e-mail d'un membre qui doit conserver un accès hors SSO et cliquez sur **Add**.
