...
<Note>
  Si votre site nécessite une authentification pour accéder à votre documentation, vos fichiers `llms.txt` et `llms-full.txt` ne sont pas accessibles aux LLM et aux outils d’IA. Les LLM et les outils d’IA ne peuvent indexer que le contenu disponible publiquement.
</Note>
