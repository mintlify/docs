...
Pour la documentation nécessitant une authentification, votre serveur MCP indexe uniquement les pages des [groupes d&#39;utilisateurs publics](/fr/deploy/authentication-setup#make-pages-public).
