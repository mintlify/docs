...
<Note>
  Les serveurs MCP sont disponibles pour la documentation publique et la documentation utilisant [l'authentification partielle](/fr/deploy/authentication-setup#make-pages-public). Votre serveur MCP recherche uniquement les pages publiques. La documentation nécessitant une authentification pour toutes les pages ne peut pas générer de serveur MCP.
</Note>
