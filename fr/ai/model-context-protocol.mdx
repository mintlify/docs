...
<Frame>
  <img src="/images/obama.jpg" alt="Page du serveur MCP dans le Dashboard." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Page du serveur MCP dans le Dashboard." className="hidden dark:block" />
</Frame>
