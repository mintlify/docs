...
<Tabs>
  <Tab title="Menu contextuel">
    Ajoutez des options dans le [menu contextuel](/fr/fr/ai/contextual-menu) pour permettre à vos utilisateurs de se connecter à votre serveur MCP depuis n’importe quelle page de votre documentation.
