...
Votre serveur MCP fournit un outil que les agents peuvent utiliser :
...
Les agents déterminent quand utiliser l'outil en fonction du contexte de la conversation.
