...
Mintlify génère automatiquement un serveur MCP pour votre documentation et l'héberge au chemin `/mcp` de l'URL de votre documentation. Par exemple, le serveur MCP de Mintlify est disponible à l'adresse `https://mintlify.com/docs/mcp`.
...
Pour la documentation qui requiert une authentification, votre serveur MCP n'indexe que les pages des [groupes d'utilisateurs publics](/fr/deploy/authentication-setup#make-pages-public).
