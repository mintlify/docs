...
Après avoir traité les fichiers, Mintlify détermine quelles pages indexer pour la recherche. Par défaut, seules les pages incluses dans la navigation de votre `docs.json` sont indexées et consultables via votre serveur MCP.
...
---
title: "Page cachée"
description: "Cette page ne figure pas dans la navigation, mais reste accessible via la recherche."
noindex: true
---
```
