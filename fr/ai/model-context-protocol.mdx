...
description: "Connectez votre documentation et vos endpoints d'API à des outils d'IA comme Claude et Cursor avec un serveur Model Context Protocol (MCP) hébergé."
...
| Par site de documentation (domain) | 10 000 requêtes par heure | Limite le nombre total de recherches effectuées par tous les utilisateurs de votre serveur MCP.            |
