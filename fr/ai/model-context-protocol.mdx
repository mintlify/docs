...
Votre serveur MCP fournit l'outil suivant que les agents peuvent utiliser :
...
Les agents appellent cet outil lorsque le contexte de la conversation indique qu'une recherche dans votre documentation aiderait à répondre à la question de l'utilisateur.
