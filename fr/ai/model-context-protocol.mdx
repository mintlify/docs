...
* Pour la documentation avec authentification partielle, où certaines pages sont publiques et d’autres sont protégées, vous devez activer votre serveur MCP avant qu’il soit accessible aux utilisateurs. Les utilisateurs non authentifiés peuvent rechercher dans le contenu public. Les utilisateurs qui s’authentifient peuvent rechercher dans tout le contenu auquel ils ont l’autorisation d’accéder en fonction de leurs [groupes d’utilisateurs](/fr/deploy/authentication-setup).
