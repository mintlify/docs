...
Lorsqu'un serveur MCP est connecté à un outil d'IA, le LLM peut décider d'utiliser votre outil de recherche dans la documentation pendant la génération de la réponse.
...
Connectez-vous au serveur MCP de Mintlify pour rechercher dans notre documentation. Vous obtiendrez ainsi des réponses plus précises sur l’utilisation de Mintlify dans votre environnement local, et vous verrez comment aider vos utilisateurs à se connecter à votre serveur MCP.
