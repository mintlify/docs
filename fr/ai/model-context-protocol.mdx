...
<Steps>
  ...
  <Step title="Ajouter des domaines de redirection">
    ...
    Par défaut, les domaines de redirection utilisent HTTPS. Pour autoriser un protocole personnalisé, incluez le schéma URI complet dans l'entrée. Par exemple, une application native qui gère les rappels OAuth avec un schéma d'URL personnalisé peut être autorisée en ajoutant `myapp://callback.example.com` comme domaine de redirection.
  </Step>
</Steps>
