...
Les applications d'IA déterminent quand appliquer ces filtres en fonction du contexte de la requête de l'utilisateur. Par exemple, si un utilisateur pose une question sur une version spécifique de la documentation ou dans une langue spécifique, l'application d'IA peut appliquer automatiquement les filtres appropriés pour fournir des résultats plus pertinents.
