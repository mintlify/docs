...
Mintlify active automatiquement votre serveur MCP hébergé lorsque votre site a l'[authentification](/fr/deploy/authentication-setup) configurée. Pour permettre aux outils d'IA de terminer l'authentification, ajoutez leurs domaines de redirection dans votre Dashboard.
