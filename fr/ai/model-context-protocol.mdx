...
<Tip>
  Vous souhaitez plutôt permettre aux agents de modifier votre contenu au lieu de simplement le lire ? Consultez le [serveur MCP Mintlify](/fr/ai/mintlify-mcp) pour découvrir un serveur MCP authentifié qui expose des outils de branching, d'édition de pages, de navigation et de `docs.json` aux agents de confiance.
</Tip>
