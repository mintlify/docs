...
Votre serveur MCP fournit un outil de recherche que les agents peuvent utiliser :
...
Les agents appellent l'outil de recherche en fonction du contexte de la conversation pour récupérer le contenu de la documentation pertinent pour la demande de l'utilisateur.
