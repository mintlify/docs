...
### Filtrage des endpoints d'API avec OpenAPI

Si votre documentation inclut une spécification OpenAPI, toutes les opérations d'API sont exposées comme outils MCP par défaut. Vous pouvez contrôler quelles opérations sont disponibles et personnaliser leurs noms et descriptions en utilisant l'extension [`x-mint: mcp`](/api-playground/openapi-setup#mcp) dans votre spécification OpenAPI.
