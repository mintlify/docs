...
| **Télécharger la spécification OpenAPI**  | `download-spec` | Télécharge la spécification OpenAPI du déploiement. Si plusieurs spécifications sont configurées, elles sont regroupées dans `api-specs.zip` |
