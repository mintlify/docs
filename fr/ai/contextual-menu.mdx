...
description: "Ajoutez un menu contextuel à votre documentation avec des intégrations d'IA en un clic pour ChatGPT, Claude, Perplexity, Cursor, MCP et plus encore."
keywords: ["Outils d'IA", "ChatGPT", "Claude", "Perplexity", "MCP", "Grok", "Cursor", "vscode", "vs code", "Google AI Studio", "aistudio", "Devin", "Windsurf", "Devin Desktop", "pdf"]
---
