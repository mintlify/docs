...
| **Télécharger la spécification d'API**    | `download-spec` | Télécharge la spécification OpenAPI de votre projet. S'il y a plusieurs spécifications, les télécharge dans une archive zip. N'apparaît que sur les pages de référence d'API. |
