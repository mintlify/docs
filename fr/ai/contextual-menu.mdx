---
title: "Menu contextuel : intégrations d'IA et actions de copie"
description: "Ajoutez un menu contextuel avec des intégrations d'IA en un clic pour ChatGPT, Claude, Perplexity, Google AI Studio, Devin et les outils MCP."
