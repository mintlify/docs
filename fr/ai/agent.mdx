---
title: "Agent"
description: "Automatisez les mises à jour de la documentation avec l’agent. Créez des pull requests à partir de messages Slack, de PR ou d’appels API."
---
...
L’agent crée des pull requests avec des modifications proposées à votre documentation, en fonction de vos consignes. Lorsque vous envoyez une requête à l’agent, il s’appuie sur votre documentation, les dépôts connectés et les messages Slack pour générer du contenu conforme aux meilleures pratiques de rédaction technique et au schéma Mintlify. Accédez à l’agent dans votre espace de travail Slack ou intégrez‑le à des applications personnalisées via l’API.

Utilisez l’agent pour :

* Rédiger de nouveaux contenus à partir de vos consignes, de liens vers des pull requests ou de fils Slack
