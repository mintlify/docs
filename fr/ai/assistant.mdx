...
* **Bouton Assistant** à côté de la barre de recherche
  ...
  />
* **URL** avec `?assistant=open` ajouté ouvre l’Assistant au chargement de la page. Par exemple, [https://mintlify.com/docs?assistant=open](https://mintlify.com/docs?assistant=open).
