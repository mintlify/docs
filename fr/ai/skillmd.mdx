...
<Note>
  `skill.md` est destiné aux agents et LLM tiers (par exemple, ChatGPT, Claude ou des agents personnalisés connectés via [MCP](/fr/ai/model-context-protocol)). L'assistant IA de Mintlify qui s'exécute à l'intérieur de votre site de documentation utilise directement le contenu de votre documentation et ne dépend pas de `skill.md`.
</Note>
