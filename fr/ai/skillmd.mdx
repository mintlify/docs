---
title: "skill.md"
description: "Préparez votre documentation pour les agents grâce aux fichiers skill.md générés automatiquement qui décrivent les capacités de votre produit pour les agents d'IA."
