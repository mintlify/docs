---
title: "skill.md"
description: "Rendez votre documentation exploitable par des agents grâce à des fichiers skill.md générés automatiquement qui décrivent les capacités de votre produit pour les agents d’IA."
