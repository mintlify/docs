...
<div id="skills-discovery-endpoints">
  ## Points de terminaison de découverte des skills
</div>

Mintlify héberge un répertoire de skills à `/.well-known/skills/` que les agents peuvent utiliser pour découvrir et récupérer vos fichiers de skills de manière programmatique.
