...
Le mode code gère les opérations au niveau du déploiement qui n'ont pas d'outil dédié, comme la gestion des workflows, des paramètres de déploiement, des membres, de la facturation, des intégrations et des analyses. Les outils du mode code ne nécessitent pas de `checkout`.
