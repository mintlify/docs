...
- **`read`**: Récupère le MDX complet de n'importe quelle page sur la branche de session. Transmettez un chemin de page comme `/quickstart`, ou l'ID de page d'une URL de l'éditeur (le segment après `~/`), pour qu'un outil d'IA puisse ouvrir une page directement depuis un lien de l'éditeur.
