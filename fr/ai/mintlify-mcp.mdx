...
- **Vous n'êtes pas admin.** La modification de ce paramètre requiert le [rôle admin](/fr/dashboard/roles) sur votre projet. Les éditeurs et les lecteurs voient le bouton désactivé avec une bannière de permission.
