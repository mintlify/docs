...
description: "Créez un workflow Mintlify personnalisé avec un trigger planifié ou de type push, des dépôts de contexte et un prompt pour l'agent afin d'automatiser les tâches récurrentes de documentation."
...
3. Configurez le nom du workflow, le trigger, les instructions, les dépôts de contexte et le mode de mise à jour.
