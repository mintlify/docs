...
Vous pouvez vérifier la présence de liens cassés dans votre documentation à l’aide de l’interface en ligne de commande (CLI) : [/installation](/fr/installation)
...
> Voici le premier paragraphe d’un bloc de citation multilignes.
>
> Voici le deuxième paragraphe, séparé par une ligne vide précédée de `>`.

<Tip>
  Utilisez les blocs de citation avec parcimonie pour préserver leur impact visuel et leur pertinence. Envisagez d’utiliser des [encadrés](/fr/components/callouts) pour les notes, les avertissements et autres informations.
</Tip>
