...
Configurez l'assistant et gérez la facturation sur la page [Assistant](https://dashboard.mintlify.com/products/assistant) de votre tableau de bord.
...
Si vous souhaitez interdire les dépassements, désactivez-les dans la section **Billing Controls** de l'[onglet Facturation](https://dashboard.mintlify.com/products/assistant?tab=billing) de la page de l'assistant dans votre tableau de bord.
