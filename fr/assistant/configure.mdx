...
Les packages de crédits déterminent votre allocation mensuelle de messages et la tarification.

Consultez et modifiez votre package actuel sur la page [Utilisation](https://dashboard.mintlify.com/settings/organization/usage) de votre tableau de bord.

Dans la section **Credit packages**, sélectionnez votre package préféré dans le menu déroulant.
