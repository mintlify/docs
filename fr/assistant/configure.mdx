...
<Note>
  Si votre organisation utilise un plan de crédits personnalisé ou dispose de crédits illimités, la section **Spending Controls** affiche votre plan sous la forme `Custom — N credits` ou `Unlimited credits`, et le menu déroulant des paliers est désactivé. Contactez votre gestionnaire de compte pour changer de plan.
</Note>
