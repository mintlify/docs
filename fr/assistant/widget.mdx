...
La seule option de navigateur requise est l'ID public du widget. Gérez l'état d'activation, les origines autorisées, les pièces jointes, la protection contre les bots et le [formulaire de contact de déflexion](/fr/assistant/configure#set-deflection-emails) dans votre tableau de bord. Définissez les questions d'introduction spécifiques à l'intégration et une adresse e-mail d'assistance dans la configuration du navigateur.
