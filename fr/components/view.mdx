---
title: "Vue"
description: "Utilisez le composant view pour créer des panneaux de contenu commutables pour différents langages de programmation, frameworks ou variantes de configuration."
...
<ResponseField name="icon" type="string">
  Une icône [Font Awesome](https://fontawesome.com/icons), [Lucide](https://lucide.dev/icons) ou [Tabler](https://tabler.io/icons), un seul emoji, une URL d’icône ou un chemin relatif vers une icône.
</ResponseField>
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer au conteneur de la vue.
</ResponseField>
