---
title: "Vue"
description: "Créez du contenu multi-vues pour différents langages de programmation ou frameworks."
---

Utilisez le composant View pour créer du contenu qui s’adapte à la vue sélectionnée dans un menu déroulant multi-vues. C’est particulièrement utile pour afficher des exemples de code ou une documentation propres à différents langages de programmation ou frameworks.
