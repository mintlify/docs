...
Utilisez des badges pour afficher des indicateurs d’état, des labels ou des metadata. Placez les badges dans le corps du texte ou comme éléments autonomes.
