---
title: "Badge"
description: "Utilisez le composant badge pour mettre en avant des indicateurs de statut, des libellés de version ou des métadonnées en ligne, avec des couleurs personnalisables et des info-bulles au survol."
