---
title: "Onglets"
description: "Utilisez des onglets pour organiser le contenu en panneaux commutables afin d'afficher différentes options, versions ou exemples de langages."
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer au bouton de l'onglet.
</ResponseField>
