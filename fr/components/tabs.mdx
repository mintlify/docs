...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer au panneau de contenu de l’onglet. Les classes s’appliquent au panneau qui contient le contenu de l’onglet, et non au libellé de l’onglet dans la barre d’onglets.
</ResponseField>