...
<ResponseField name="title" type="string" required>
  Le titre de l'onglet. Des titres courts facilitent la navigation. Les onglets dont les titres correspondent synchronisent leurs sélections. Prend en charge la [mise en forme Markdown en ligne](/fr/help-center/format-component-titles-with-markdown), comme `**bold**`, `*italic*`, `~~strikethrough~~` et `` `code` ``.
</ResponseField>
