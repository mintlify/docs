---
title: "Onglets"
description: "Utilisez des onglets pour organiser le contenu en panneaux interchangeables pour afficher différentes options, versions ou exemples de langage."
