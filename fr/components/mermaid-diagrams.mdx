...
<Card title="Graphiques" icon="chart-line" horizontal href="/fr/components/graphs">
  Créez des graphiques interactifs et des visualisations de données avec le composant Graph.
</Card>
