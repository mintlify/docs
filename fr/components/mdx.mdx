---
title: "MDX"
description: "Utilisez le composant MDX pour afficher du Markdown dans les expressions et conditions JSX : titres, blocs de code et tableaux compilent comme votre page."
...
<Note>
  Les titres à l'intérieur de `<MDX>` apparaissent dans la table des matières de la page. Lorsque vous utilisez `<MDX>` dans une condition, la table des matières liste les titres de toutes les branches, y compris celles qui ne sont pas rendues.
</Note>
