---
title: "MDX"
description: "Utilisez le composant MDX de Mintlify pour afficher du Markdown dans des expressions JSX : titres, blocs de code et tableaux se compilent normalement."
