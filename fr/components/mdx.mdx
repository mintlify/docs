---
title: "MDX"
description: "Utilisez le composant MDX pour afficher du Markdown dans des expressions et conditions JSX : titres, blocs de code et tableaux se compilent comme votre page."
...
Les titres à l'intérieur de `<MDX>` apparaissent dans la table des matières de la page, avec les autres titres de la page.

<Note>
  Lorsque vous utilisez `<MDX>` dans une condition, les titres de chaque branche apparaissent dans la table des matières, y compris ceux des branches qui ne sont pas affichées.
</Note>
