---
title: "MDX"
description: "Utilisez le composant MDX pour afficher du Markdown dans des expressions JSX : titres, blocs de code et tableaux se compilent comme le reste de la page."
