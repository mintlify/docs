---
title: "Couleur"
description: "Affichez des nuanciers avec des valeurs hexadécimales et la possibilité de copier en un clic grâce au composant couleur, pour la documentation des systèmes de design et du branding."
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer au conteneur de couleurs.
</ResponseField>
