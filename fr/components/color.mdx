...
<ResponseField name="title" type="string">
  Libellé de la ligne de couleurs. Prend en charge la [mise en forme Markdown en ligne](/fr/help-center/format-component-titles-with-markdown), comme `**bold**`, `*italic*`, `~~strikethrough~~` et `` `code` ``.
</ResponseField>
