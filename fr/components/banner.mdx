...
<ResponseField name="dismissible" type="boolean">
  Indique si les utilisateurs peuvent masquer la bannière. Lorsque `true`, un bouton de fermeture apparaît. Si un utilisateur masque la bannière, elle reste masquée jusqu'à ce que vous mettiez à jour son contenu. Valeur par défaut : `false`.
</ResponseField>
