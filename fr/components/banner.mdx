---
title: "Bannière"
description: "Ajoutez une bannière rétractable en haut de votre site de documentation pour afficher des annonces importantes, des notes de version ou des notifications."
