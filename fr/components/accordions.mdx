---
title: "Accordion"
description: "Utilisez des accordions pour afficher et masquer des sections de contenu, organiser l’information et permettre la divulgation progressive dans votre documentation."
...
<ResponseField name="id" type="string">
  Un ID personnalisé pour l'accordéon utilisé pour les liens d'ancrage. S'il est omis, la valeur par défaut est la même que `title`.
</ResponseField>
