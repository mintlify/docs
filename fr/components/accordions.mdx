---
title: "Accordion"
description: "Utilisez le composant accordion pour afficher et masquer des sections, organiser les informations connexes et activer la divulgation progressive."
...
<ResponseField name="title" type="string" required>
  Titre dans l’aperçu de l’Accordion. Prend en charge la mise en forme Markdown en ligne, comme `**bold**`, `_italic_` et `` `code` ``.
</ResponseField>
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer à l’Accordion. Également acceptée sur `AccordionGroup`.
</ResponseField>
