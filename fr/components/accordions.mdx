...
<ResponseField name="title" type="string" required>
  Titre dans l’aperçu de l’Accordion. Prend en charge la [mise en forme Markdown en ligne](/fr/help-center/format-component-titles-with-markdown), comme `**bold**`, `*italic*`, `~~strikethrough~~` et `` `code` ``.
</ResponseField>
