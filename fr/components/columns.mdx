---
title: "Colonnes"
description: "Organisez des cartes et d'autres composants dans une grille responsive avec le composant columns."
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer à la colonne individuelle.
</ResponseField>
