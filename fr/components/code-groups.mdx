...
Les groupes de code héritent des styles globaux de votre fichier `docs.json`. Personnalisez votre thème avec `styling.codeblocks`. Consultez [Settings](/fr/settings#styling) pour les options de configuration.
