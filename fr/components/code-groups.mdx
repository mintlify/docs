...
description: "Utilisez le composant CodeGroup pour afficher plusieurs exemples de code dans une interface à onglets et permettre aux lecteurs de comparer les implémentations entre différents langages."
