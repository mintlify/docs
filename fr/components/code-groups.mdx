...
description: "Utilisez les groupes de code pour afficher plusieurs exemples de code dans une interface à onglets et comparer les implémentations entre différents langages."
