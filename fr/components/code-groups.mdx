...
description: "Afficher plusieurs exemples de code dans une interface à onglets pour comparer les implémentations entre différents langages."
...
Les groupes de code héritent de la mise en forme globale de votre fichier `docs.json`. Personnalisez votre thème avec `styling.codeblocks`. Consultez [Paramètres](/fr/organize/settings#param-styling) pour les options de configuration.
