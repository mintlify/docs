---
title: "Arborescence"
description: "Utilisez le composant arbre pour afficher des structures hiérarchiques de fichiers et de dossiers avec des nœuds repliables et une mise en évidence de la syntaxe pour les noms de chemin."
