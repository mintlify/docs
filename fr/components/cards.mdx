...
<Card title="Titre de la carte" icon="text" href="/fr/fr/components/columns">
...
<Card title="Carte de lien" icon="link" href="/fr/fr/components/columns" arrow="true" cta="Cliquez ici">
...
Utilisez le [composant Columns](/fr/fr/components/columns) pour afficher plusieurs cartes côte à côte.
