...
<Tile href="/fr/components/accordions" title="Accordion" description="Deux variantes">
  <img src="/images/obama.jpg" alt="Aperçu du composant Accordion" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Aperçu du composant Accordion (mode sombre)" className="hidden dark:block" />
</Tile>
