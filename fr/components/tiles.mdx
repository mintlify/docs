...
<ResponseField name="title" type="string">
  Le titre affiché sous l'aperçu de la tuile. Prend en charge la [mise en forme Markdown en ligne](/fr/help-center/format-component-titles-with-markdown), comme `**bold**`, `*italic*`, `~~strikethrough~~` et `` `code` ``.
</ResponseField>
