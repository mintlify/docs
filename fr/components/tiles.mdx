...
<ResponseField name="title" type="string">
  Le titre affiché sous l'aperçu de la tuile. Prend en charge la mise en forme Markdown en ligne, comme `**bold**`, `_italic_` et `` `code` ``.
</ResponseField>
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer à la tuile.
</ResponseField>
