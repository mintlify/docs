...
Utilisez des icônes issues de Font Awesome, Lucide, de fichiers SVG (Scalable Vector Graphics), d’URL externes ou de fichiers de votre projet pour enrichir votre documentation.
