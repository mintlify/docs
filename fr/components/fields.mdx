---
title: "Champs"
description: "Utilisez les composants ParamField et ResponseField pour documenter les paramètres de requête et de réponse de l’API avec les types, les valeurs par défaut et les règles de validation."
