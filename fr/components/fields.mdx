---
title: "Champs"
description: "Utilisez les composants ParamField et ResponseField pour documenter les paramètres de requête et réponse d'API avec types, valeurs par défaut et validation."
...
<ParamField body="className" type="string">
  Classes CSS supplémentaires à appliquer au champ.
</ParamField>
