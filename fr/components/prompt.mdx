---
title: "Prompt"
description: "Affichez des prompts IA préconstruits avec boutons de copie en un clic et d'intégration Cursor pour que les utilisateurs les utilisent dans leurs outils IA."
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer à la carte de prompt.
</ResponseField>
