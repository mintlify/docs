...
Le composant générique `Callout` prend en charge les icônes et couleurs personnalisées. Les encarts typés (`Note`, `Warning`, `Info`, `Tip`, `Check`, `Danger`) utilisent des icônes et couleurs prédéfinies et acceptent `children` et `className`.
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer à l'encart.
</ResponseField>
