---
title: "Encarts"
description: "Ajoutez des composants d'encart info, note, tip, check, warning, danger ou personnalisés pour mettre en avant les informations clés de votre documentation."
...
Le composant générique `Callout` prend en charge les icônes et couleurs personnalisées. Les encarts typés (`Note`, `Warning`, `Info`, `Tip`, `Check`, `Danger`) utilisent des icônes et couleurs prédéfinies et n'acceptent que `children` et `className`.
...
<ResponseField name="className" type="string">
  Classes CSS supplémentaires à appliquer à l'encart. Acceptée à la fois par le composant générique `Callout` et par les encarts typés.
</ResponseField>
