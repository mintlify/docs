...
<Frame>
	![Onglet CloudFront "Behaviors" mis en évidence.](/images/cloudfront/behaviors.png)
</Frame>
...
<Frame>
	![Page CloudFront Create origin request policy qui transfère les en-têtes `Origin` et `CloudFront-Viewer-Address`](/images/cloudfront/origin-request-policy.png)
</Frame>
