...
Créez des comportements pour les chemins de vérification de domaine Vercel avec un **modèle de chemin** `/.well-known/*` et définissez **Origin and origin groups** sur l’URL de votre documentation.
