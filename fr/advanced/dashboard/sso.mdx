...
description: "Personnalisez la façon dont votre équipe se connecte à votre Dashboard d’administration"
---
...
<Tabs>
    ...
    <Tab title="OIDC">
        <Steps>
            ...
            <Step title="Configurer l’intégration">
                Sélectionnez le type d’octroi par code d’autorisation et saisissez l’URL de redirection fournie par Mintlify.
            </Step>
            <Step title="Envoyez-nous les informations de votre IdP">
    ...
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Configurer SAML">
                ...
                * Identifier (Entity ID) : l’Audience URI fournie par Mintlify.
            ...
            <Step title="Attribuer des utilisateurs">
                Accédez à "Users and groups" dans votre application Entra et ajoutez les utilisateurs qui doivent avoir accès à votre Dashboard.
            </Step>
        </Steps>
    </Tab>
</Tabs>