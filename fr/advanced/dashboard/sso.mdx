...
description: "Personnalisez la façon dont votre équipe se connecte à votre tableau de bord d'administration"
---
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Envoyez-nous les informations de votre IdP">
                Une fois l’application configurée, allez à l’onglet Sign-On et envoyez-nous l’URL des métadonnées.
    ...
    <Tab title="OIDC">
        <Steps>
            ...
            <Step title="Configurer l’intégration">
                Sélectionnez le flux « authorization code » et saisissez l’URI de redirection fourni par Mintlify.
            </Step>
            <Step title="Envoyez-nous les informations de votre IdP">
                Une fois l’application configurée, allez à l’onglet General et repérez le client ID et le client secret.
    ...
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Configurer SAML">
                Accédez à la page de configuration de l’authentification unique et sélectionnez **SAML**. Sous « Basic SAML Configuration », saisissez ce qui suit :
