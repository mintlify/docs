---
title: "Thèmes"
description: "Personnaliser l’apparence de votre documentation"
mode: "custom"
---
...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Linden" value="linden" description="Ambiance terminal rétro, polices à chasse fixe, pour une esthétique hacker des années 1980." href="https://linden.mintlify.app" />
