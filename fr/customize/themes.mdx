...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personnalisez l’apparence de votre documentation<br /><br />Configurez [ofme](/fr/organize/settings#param-ofme) dans docs.json en utilisant l’un des thèmes suivants.</label>
