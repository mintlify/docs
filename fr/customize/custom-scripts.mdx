...
description: "Ajoutez du JavaScript et du CSS personnalisés à votre documentation pour les analyses, widgets, styles, intégrations tierces et variables de serveur de l'API Playground."
...
Appelez `window.mintlify.api.playground.clearServerVariables()` lorsque ces valeurs ne s'appliquent plus, par exemple après une déconnexion. Après la suppression, le playground revient à ses autres valeurs configurées.
