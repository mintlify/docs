...
<AccordionGroup>
  ...
  <Accordion title="Sélecteurs">
    ...
    **Attributs de données**
    ...
    Utilisez `data-active-deepest` pour cibler la section active la plus spécifique dans la table des matières. Lorsque vous faites défiler jusqu'à un `h3` à l'intérieur d'un `h2`, les deux éléments de la table des matières ont `data-active`, mais seul l'élément `h3` a `data-active-deepest`.
