...
description: "Ajoutez du JavaScript et du CSS personnalisés pour adapter entièrement l’apparence et le comportement de votre documentation."
---

Utilisez le CSS pour mettre en forme les éléments HTML, ou ajoutez du CSS et du JavaScript personnalisés pour adapter entièrement l’apparence et le comportement de votre documentation.
