...
Les domaines personnalisés requièrent une version minimale de TLS 1.2. Les clients qui ne prennent en charge que TLS 1.0 ou 1.1 ne peuvent pas se connecter à votre documentation. Tous les navigateurs et clients HTTP modernes satisfont à cette exigence par défaut, donc la plupart des utilisateurs ne sont pas concernés.
