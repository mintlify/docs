...
<Frame>
  <img alt="La page de configuration du domaine personnalisé affichant le champ pour saisir l'URL de votre domaine personnalisé." className="block dark:hidden" src="/images/obama.jpg" />

  <img alt="La page de configuration du domaine personnalisé affichant le champ pour saisir l'URL de votre domaine personnalisé." className="hidden dark:block" src="/images/obama.jpg" />
</Frame>
