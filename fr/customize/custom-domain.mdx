...
2. Configurez les paramètres DNS auprès de votre fournisseur de nom de domaine.
3. Laissez le temps au DNS de se propager et aux certificats TLS d’être automatiquement provisionnés.

<Info>
  Vous cherchez à configurer un sous-chemin personnalisé comme `mintlify.com/docs` ? Consultez la documentation sur le [sous-chemin personnalisé](/fr/deploy/cloudflare).
</Info>
