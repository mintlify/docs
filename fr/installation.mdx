...
Utilisez la CLI pour prévisualiser localement votre documentation au fur et à mesure de l’écriture et de l’édition. Visualisez les modifications en temps réel avant le déploiement, testez l’apparence et le fonctionnement de votre site de documentation, et repérez des problèmes comme des liens brisés ou des défauts d’accessibilité.

La CLI propose également des utilitaires pour maintenir votre documentation, notamment des commandes pour renommer des fichiers, valider des spécifications OpenAPI et migrer du contenu entre formats.
...
<Info>
  **Prérequis** : la CLI nécessite [Node.js](https://nodejs.org/en) de la version v19 à v24. Les versions LTS sont recommandées.
</Info>
