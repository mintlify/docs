...
description: "Installez la CLI Mintlify pour prévisualiser la documentation en local, tester les modifications en temps réel et détecter les erreurs de build avant de déployer en production."
