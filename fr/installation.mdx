...
<img className="block dark:hidden my-0 pointer-events-none" src="/images/obama.jpg" alt="Graphique décoratif représentant la CLI." />

<img className="hidden dark:block my-0 pointer-events-none" src="/images/obama.jpg" alt="Graphique décoratif représentant la CLI." />
