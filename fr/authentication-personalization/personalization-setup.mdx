...
Voir la section [Format des données utilisateur](fr/#user-data-format) ci-dessous pour des exemples détaillés et des instructions de mise en œuvre.
  ...
  <Tab title="JWT">
    ...
    <Steps>
      ...
      <Step title="Intégrez la personnalisation Mintlify à votre flux de connexion.">
        ...
        - Créez un JWT contenant les informations de l’utilisateur connecté au format `User`. Consultez la section [User data format](fr/#user-data-format) ci-dessus pour plus d’informations.
  ...
  <Tab title="OAuth 2.0">
    ...
    <Steps>
      <Step title="Create user info API endpoint.">
        ...
        - Renvoie les données utilisateur au format `User`. Voir la section [User data format](fr/#user-data-format) ci-dessus pour plus d’informations.
  ...
  <Tab title="Shared session">
    ...
    <Steps>
      <Step title="Create user info API endpoint.">
        ...
        - renvoie les données utilisateur au format `User` (voir la section [Format des données utilisateur](fr/#user-data-format) ci-dessus) ;
