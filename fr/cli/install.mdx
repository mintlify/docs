...
| `--template` | Utiliser un modèle prédéfini comme point de départ au lieu du modèle par défaut. |
| `--force` | Écraser le répertoire actuel sans confirmation. |

En mode interactif, la CLI vous invite à choisir entre partir de zéro ou sélectionner parmi les modèles disponibles.
