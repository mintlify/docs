...
| --- | --- | --- |
| `subdomain` | Sous-domaine par défaut de la documentation. | `mint dev`, `mint automations`, `mint analytics`, `mint add-domain`, `mint score` |
...
<Frame>
  <img
    ...
    alt="L'interface interactive de mint test avec une barre latérale d'étapes et une arborescence de sélection de pages listant des dossiers de pages avec le nombre de blocs de code."
  />
</Frame>
