...
| `--template` | Utiliser un modèle prédéfini comme point de départ. En mode interactif, la CLI vous invite à choisir entre partir de zéro ou sélectionner un modèle. |
