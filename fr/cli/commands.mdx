...
Installez le serveur MCP Index hébergé de Mintlify dans vos agents de codage. Le serveur fournit un outil `context` pour rechercher des bibliothèques, frameworks, SDK, API et outils CLI.
