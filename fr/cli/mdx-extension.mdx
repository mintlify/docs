...
La prévisualisation dans l'éditeur s'affiche dans une iframe, donc la recherche du navigateur et les outils de développement ne peuvent pas y accéder. Sélectionnez le bouton **Open in browser** dans la barre d'outils de la prévisualisation, ou exécutez **Mintlify: Open preview in browser**, pour ouvrir la page dans votre navigateur.
