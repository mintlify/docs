...
description: "Installez l'extension Mintlify MDX pour obtenir l'autocomplétion, les diagnostics en ligne, la documentation au survol et un aperçu dans l'éditeur."
