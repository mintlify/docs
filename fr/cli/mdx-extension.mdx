...
description: "Installez l'extension Mintlify MDX pour l'autocomplétion, les diagnostics, la documentation au survol, un éditeur visuel et une prévisualisation."
keywords: ["Cursor", "MDX", "autocomplétion", "diagnostics", "IntelliSense", "prévisualisation", "éditeur", "mode visuel"]
---
...
| `text` (or `markdown`) | Champ de texte multi-ligne           |
