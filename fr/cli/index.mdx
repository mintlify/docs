---
title: "Mintlify CLI"
description: "Utilisez la CLI Mintlify pour prévisualiser la doc en local, tester les modifications en temps réel et effectuer des contrôles d'accessibilité, de liens et de validation avant déploiement."
