...
description: "Mettez en forme votre documentation avec des titres Markdown, du gras, de l'italique, des liens, des citations et d'autres styles en ligne en MDX."
...
Utilisez `##` (H2) à `######` (H6) pour les sections de contenu. H1 est réservé au titre de la page défini dans votre [frontmatter](/fr/organize/pages), n'ajoutez donc pas de titre de niveau supérieur `#` dans le corps de la page.
...
- Mintlify convertit les apostrophes droites en guillemets simples fermants (`’`) et les conserve dans l’ID.
- Mintlify convertit les points en tirets et supprime les parenthèses.
