...
Pour rendre une image cliquable, entourez-la d’une balise d’ancre et ajoutez la propriété `noZoom` :
...
<Note>
  Les images à l’intérieur des balises d’ancre affichent automatiquement un curseur en forme de pointeur pour indiquer qu’elles sont cliquables.
</Note>
