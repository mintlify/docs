...
Utilisez des classes [Tailwind CSS](/fr/customize/custom-scripts#style-with-tailwind-css) pour redimensionner les images. Lorsqu'aucune classe utilitaire ne couvre la taille dont vous avez besoin, utilisez une valeur arbitraire comme `w-[450px]` :
...
Évitez la prop `style` pour le dimensionnement. Elle peut provoquer un décalage de la mise en page au chargement de la page.
