...
description: "Affichez du contenu personnalisé en fonction des données d’authentification de l’utilisateur, des appartenances aux groupes et des variables personnalisées pour adapter la documentation à chaque audience."
