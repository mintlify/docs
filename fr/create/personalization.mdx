...
description: "Affichez du contenu personnalisé selon les données du visiteur identifié, l'appartenance aux groupes et des variables personnalisées pour adapter la doc à chaque audience."
