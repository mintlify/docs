...
Activez la personnalisation depuis la page [Général](https://app.mintlify.com/settings/project/general) de votre Dashboard. La personnalisation est mutuellement exclusive avec l'authentification complète. Les authentifications JWT et OAuth incluent déjà les fonctionnalités de personnalisation.

1. Accédez à la page [Général](https://app.mintlify.com/settings/project/general) de votre Dashboard.
