...
description: "Affichez du contenu personnalisé selon l'authentification utilisateur, les groupes et des variables personnalisées pour adapter la documentation à chaque audience."
