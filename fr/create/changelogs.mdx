...
<Update label="March 2025" description="v0.0.10">
  ...
  Publication d'une nouvelle version de la saveur Spearmint, maintenant avec 10 % de menof en plus.
</Update>
...
<Update label="Mars 2025" description="v0.0.10" tags={["Wintergreen", "Spearmint"]}>
  ...
  Sortie d'une nouvelle version de la saveur Spearmint, maintenant avec 10 % de menof en plus.
</Update>
...
Les entrées du flux RSS contiennent uniquement du Markdown. Les composants, le code et les éléments HTML sont exclus. Utilisez la propriété `rss` pour fournir des descriptions textuelles alternatives aux abonnés RSS lorsque vos mises à jour incluent du contenu exclu.
