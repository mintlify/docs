...
<Frame>
  <img src="/images/obama.jpg" alt="Journal des modifications avec la table des matières affichée en mode clair." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Journal des modifications avec la table des matières affichée en mode sombre." className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="Journal des modifications en mode clair avec le filtre de tag Peppermint sélectionné." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Journal des modifications en mode sombre avec le filtre de tag Peppermint sélectionné." className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="Page du journal des modifications en mode clair avec le bouton du flux RSS activé." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Page du journal des modifications en mode sombre avec le bouton du flux RSS activé." className="hidden dark:block" />
</Frame>
