...
<Steps>
  ...
  <Step title="Ajouter des composants Update à votre journal des modifications">
    ...
    Les entrées apparaissent dans l'ordre où vous les listez dans le fichier. Ajoutez les nouvelles entrées en haut du fichier pour afficher les mises à jour les plus récentes en premier.
  </Step>
</Steps>
