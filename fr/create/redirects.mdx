...
Configurez des redirections en ajoutant le champ `redirects` à votre fichier `docs.json`. Par défaut, toutes les redirections sont permanentes (308).
...
Pour créer une redirection temporaire (307), définissez `permanent` sur `false` :
