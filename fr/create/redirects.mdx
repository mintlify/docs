---
title: "Redirections"
description: "Configurez des redirections d'URL pour les pages déplacées, renommées ou supprimées afin de préserver le référencement SEO et d'éviter les liens brisés pour les visiteurs."
keywords: ["redirects"]
---
