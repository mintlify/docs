---
title: "Redirections"
description: "Configurez des redirections d'URL dans docs.json pour les pages déplacées, renommées ou supprimées afin de préserver le SEO et d'éviter les liens brisés."
keywords: ["redirects"]
boost: 3
---
