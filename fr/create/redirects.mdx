---
title: "Redirections"
description: "Configurez des redirections d'URL dans docs.json pour les pages de documentation déplacées, renommées ou supprimées afin de préserver le référencement SEO et d'éviter les liens brisés."
keywords: ["redirects"]
---
...
Pour vérifier également que les destinations des redirections pointent vers des pages valides, utilisez le drapeau `--check-redirects` :
