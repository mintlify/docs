...
description: "Créez des extraits réutilisables pour garantir la cohérence entre les pages."
---

L’un des principes fondamentaux du développement logiciel est DRY (Don’t Repeat Yourself), qui s’applique aussi à la documentation.
Si vous constatez que vous répétez le même contenu à plusieurs endroits, créez un extrait personnalisé pour garder votre contenu synchronisé.
