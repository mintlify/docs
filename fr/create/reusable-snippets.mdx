...
Chaque fichier résout ses propres imports. Les imports déclarés dans une page ne s'appliquent pas au contenu des snippets que la page importe : un snippet imbriqué qui dépend d'un import déclaré au niveau de la page peut donc s'afficher comme du contenu vide.
