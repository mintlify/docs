...
description: "Afficher le code en ligne et les code blocks avec coloration syntaxique, numéros de ligne, diffs et fonctionnalités interactives."
...
Ajoutez `[!code ++]` ou `[!code --]` dans un commentaire à la fin d'une ligne pour la marquer comme ajoutée ou supprimée. Utilisez la syntaxe de commentaires de votre langage :
...
Pour plusieurs lignes consécutives, ajoutez un deux-points et le nombre de lignes :
