...
description: "Afficher et styliser le code en ligne et les code blocks."
...
Mettez en évidence des lignes spécifiques dans vos blocs de code à l’aide de `highlight`, en indiquant les numéros de ligne ou les plages à surligner.
...
Utilisez le composant `<CodeBlock>` dans des composants React personnalisés pour rendre des code blocks par programmation, avec le même style et les mêmes fonctionnalités que les code blocks en Markdown.
...
<ResponseField name="icon" type="string">
  L’icône à afficher dans l’en-tête du bloc de code. Voir [Icônes](/fr/components/icons) pour les options disponibles.
</ResponseField>
...
<ResponseField name="focus" type="string">
  Les lignes sur lesquelles se concentrer. Fournissez un tableau de nombres sous forme de chaîne. Exemple : `"[1,3,4,5]"`.
</ResponseField>
