...
keywords: ["démarrage rapide", "déployer", "bien démarrer", "premiers pas"]
---

Après avoir terminé ce guide, vous aurez un site de documentation en ligne, prêt à être personnalisé et enrichi.

<Info>
  **Prérequis** : Avant de commencer, [créez un compte](https://mintlify.com/start) et terminez la procédure d’onboarding.
</Info>
