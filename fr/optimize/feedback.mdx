...
Lorsque cette option est activée, le champ e-mail apparaît lorsqu’un utilisateur sélectionne **Other** comme catégorie de feedback. Cela permet aux utilisateurs de partager leurs coordonnées pour un éventuel suivi.
