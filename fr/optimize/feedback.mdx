---
title: "Commentaires"
description: "Surveillez la satisfaction des utilisateurs avec des widgets de feedback intégrés, des évaluations de pages et des réactions pouce haut ou bas."
...
1. Accédez à la page [Add-ons](https://app.mintlify.com/products/addons) de votre dashboard.
2. Activez les types de commentaires que vous souhaitez collecter.
3. Enregistrez vos modifications.

Une fois les commentaires activés, les widgets correspondants apparaissent sur votre site publié et les soumissions commencent à alimenter l'onglet feedback.

<div id="how-readers-submit-feedback">
  ## Comment les lecteurs envoient des commentaires
</div>

Les lecteurs envoient des commentaires directement depuis votre site publié :

- **Évaluation par pouces** : Des boutons pouce levé et pouce baissé apparaissent en bas de chaque page.
- **Feedback contextuel** : Les lecteurs ouvrent le menu contextuel d'une page pour laisser des commentaires libres.
- **Feedback sur les extraits de code** : Les lecteurs survolent un bloc de code pour réagir ou commenter l'extrait.
- **Suggestions de modification et création d'issues** : Les liens depuis la page ouvrent une pull request ou une issue pré-remplie dans votre référentiel GitHub.

Les soumissions apparaissent dans le [dashboard de feedback](https://app.mintlify.com/products/analytics/v2/feedback) dès leur réception.
