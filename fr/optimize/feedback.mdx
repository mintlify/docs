...
Les utilisateurs peuvent optionnellement fournir leur adresse e-mail lorsqu'ils soumettent un commentaire. Le champ e-mail apparaît lorsqu'un utilisateur sélectionne **Autre** comme catégorie de commentaire, ce qui lui permet de partager ses coordonnées pour un suivi éventuel.

Les adresses e-mail soumises avec les commentaires sont visibles dans le [tableau de bord des commentaires](https://dashboard.mintlify.com/products/analytics/v2/feedback) aux côtés du contenu du commentaire.
