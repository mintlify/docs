...
Pour collecter et consulter les retours des utilisateurs humains, vous devez les activer depuis la page [Add-ons](https://app.mintlify.com/products/addons) de votre tableau de bord.
