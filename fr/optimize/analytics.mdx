...
La section **Traffic Overview** comprend une carte **Rankings**. Utilisez son sélecteur de métrique pour comparer **Human views**, **Agent views**, **Referrals** et **Agent visitors**.
