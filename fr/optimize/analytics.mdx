...
La carte de vue d'ensemble des interactions résume l'engagement pour la plage de temps sélectionnée. Elle affiche le nombre total d'interactions, le nombre moyen d'interactions par session et le taux de clic du CTA.
...
Utilisez ces indicateurs pour comprendre dans quelle mesure les visiteurs interagissent activement avec votre contenu et vos appels à l'action. La carte est mise à jour lorsque vous modifiez la plage de temps de l'analytique.
