...
La carte **Rankings** de la section **Traffic** compare **Human views**, **Agent views**, **Referrals** et **Agent visitors**. Sélectionnez un indicateur pour classer les pages selon les vues humaines ou d'agents, consulter les sources de référence ou identifier les agents qui accèdent le plus souvent à votre documentation.
