---
title: "Tableau de bord analytique Mintlify pour vos docs"
...
<div id="assistant-funnel">
  ### Entonnoir de conversations de l'assistant
</div>

Dans la section Impressions, utilisez le sélecteur d'entonnoir utilisateur pour basculer entre Recherche vers réponse et Conversation avec l'assistant. Recherche vers réponse est sélectionné par défaut. Sélectionnez Conversation avec l'assistant pour afficher les étapes de l'assistant.

L'entonnoir de conversations de l'assistant montre comment les sessions progressent du démarrage d'une conversation à l'interaction avec une réponse. Utilisez-le pour identifier les étapes auxquelles les utilisateurs cessent d'interagir avec l'assistant.

| Étape | Description |
| --- | --- |
| **Démarrée** | La session a enregistré une activité de l'assistant qui n'a pas été signalée comme spam. |
| **Répondue** | L'assistant a terminé au moins une réponse au cours de la session. |
| **Suivi** | L'assistant a terminé au moins deux réponses au cours de la session. |
| **Engagée** | La session a interagi avec une réponse en cliquant sur une source, en copiant une réponse, en cliquant sur un résultat de recherche web ou en envoyant un retour. |

Examinez les abandons entre les étapes pour déterminer si les utilisateurs reçoivent des réponses et continuent d'interagir avec celles-ci. L'entonnoir compte les sessions de la période sélectionnée, exclut les sessions signalées comme spam et exige une interaction après une réponse.

Aucune configuration de l'entonnoir n'est nécessaire. Ouvrez la page d'analytique, sélectionnez une période, puis consultez la section Impressions.
...
L'entonnoir de recherche montre comment les sessions progressent de l'ouverture de la recherche à une action après la consultation d'un résultat. Utilisez-le pour repérer les étapes où les utilisateurs cessent d'interagir.

| Étape | Description |
| --- | --- |
| **Ouverte** | La session a ouvert l'interface de recherche. |
| **Requête effectuée** | La session a envoyé une requête de recherche. |
| **Résultat cliqué** | La session a cliqué sur un résultat de recherche. |
| **Page consultée** | La session a consulté la page ouverte depuis un résultat de recherche. |
| **Action effectuée** | La session a effectué une action après la consultation, comme cliquer sur un CTA, utiliser un menu contextuel, copier un bloc de code, appeler un playground d'API ou envoyer un retour sur la page. |

Examinez les abandons entre les étapes pour déterminer si les utilisateurs ont du mal à trouver un résultat, à comprendre une page ou à poursuivre une action. L'entonnoir compte les sessions de la période sélectionnée et exige que l'action ait lieu après la consultation de la page.

Aucune configuration n'est nécessaire. Ouvrez la page [analytics](https://app.mintlify.com/analytics), sélectionnez une période, puis consultez la section Recherche. L'analytique nécessite un [plan Pro ou Enterprise](https://mintlify.com/pricing?ref=analytics).
...
En haut de la section consacrée aux engagements des utilisateurs, la carte **Vue d'ensemble** résume l'engagement pour la plage de temps sélectionnée. Elle affiche le nombre total d'interactions, le nombre moyen d'interactions par session et le taux de clic du CTA.

- **Total des interactions** : Le nombre de clics sur les CTA et d'actions au niveau des pages combinés.
- **Nombre moyen d'interactions par session** : Le nombre total d'interactions divisé par le nombre de sessions ayant enregistré une activité liée à un CTA, à une action ou à une vue de page.
- **Taux de clic du CTA** : Le nombre de clics sur les CTA divisé par le nombre de pages vues par des humains. Le taux ne peut pas dépasser 100 %.

Chaque indicateur comprend un badge de variation qui compare la période sélectionnée à la période précédente. Lorsque vous modifiez la plage de temps de l'analytique, les valeurs et les variations sont mises à jour. Le taux de clic du CTA est affiché en pourcentage.

Utilisez ces indicateurs pour comprendre dans quelle mesure les visiteurs interagissent activement avec votre contenu et vos appels à l'action.
