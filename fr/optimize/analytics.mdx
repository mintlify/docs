---
title: "Analytique du trafic, des agents et des recherches"
description: "Suivez le trafic, l’usage des agents, les tendances de recherche, l’utilisation de l’assistant et les retours dans le tableau de bord Mintlify."
...
La section **Agents** vous aide à comprendre comment les agents IA accèdent à votre documentation. Elle affiche les vues des agents et des humains au fil du temps et classe les pages ou les agents selon la métrique sélectionnée.

Utilisez les analyses des agents pour :

- **Surveiller le trafic IA** : suivez l'évolution du trafic des agents après la publication ou la mise à jour de contenu.
- **Trouver les pages les plus utilisées par les agents** : sélectionnez **Agent views** dans **Rankings** pour identifier les contenus auxquels les outils IA accèdent fréquemment.
- **Identifier les agents actifs** : sélectionnez **Agent visitors** dans **Rankings** pour voir quels agents accèdent le plus souvent à votre documentation.
- **Comparer les sources de trafic** : utilisez le sélecteur **Rankings** pour comparer **Human views**, **Agent views**, **Referrals** et **Agent visitors**.

La section **Agents** est disponible lorsque votre déploiement dispose d'un accès à Advanced Analytics. Pour l'afficher, ouvrez [Analytics](https://app.mintlify.com/analytics) et sélectionnez **Agent**. Utilisez le sélecteur de plage de dates pour modifier la période du rapport.
