...
Le graphique des parcours montre les chemins les plus fréquents suivis par les visiteurs après leur arrivée sur votre documentation. Utilisez-le pour voir quelles pages ils consultent ensuite et où ils abandonnent.

Sélectionnez un point d'entrée, puis survolez un nœud pour voir le nombre de visiteurs à cette étape. **Other** regroupe les pages moins fréquentes. Le graphique affiche jusqu'à trois interactions après le point d'entrée.

Utilisez ces parcours pour identifier les chemins fréquents, repérer les abandons et améliorer la navigation. Ils utilisent la plage de dates sélectionnée et nécessitent l'accès aux analyses, sans configuration supplémentaire.
