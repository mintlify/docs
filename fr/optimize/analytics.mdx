...
- **Trouver les pages les plus utilisées par les agents** : sélectionnez **Agent views** dans Classements pour identifier les contenus auxquels les outils IA accèdent fréquemment.
- **Identifier les agents actifs** : sélectionnez **Agent visitors** dans Classements pour voir quels agents accèdent le plus souvent à votre documentation.
- **Comparer les sources de trafic** : utilisez le sélecteur Classements pour comparer les vues humaines, les vues des agents, les recommandations et les visiteurs agents.

La section **Agents** est disponible lorsque votre déploiement dispose de l'accès à Advanced Analytics. Pour l'afficher, ouvrez [Analytics](https://app.mintlify.com/analytics) et sélectionnez **Agent**. Utilisez le sélecteur de plage de dates pour modifier la période du rapport.
