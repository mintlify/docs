...
Pour masquer l’intégralité de votre déploiement aux moteurs de recherche tout en le maintenant accessible publiquement, activez **Don't index project** sur la page [Général](https://app.mintlify.com/settings/project/general) de votre tableau de bord.
