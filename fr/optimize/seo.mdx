...
Pour masquer l’intégralité de votre déploiement aux moteurs de recherche tout en le maintenant accessible publiquement, activez **Don't index project** sur la page [Add-ons](https://app.mintlify.com/settings/deployment/addons) de votre tableau de bord.
