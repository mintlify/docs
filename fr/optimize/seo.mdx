...
Vous pouvez prévisualiser l’affichage de vos balises meta sur différentes plateformes à l’aide de [metatags.io](https://metatags.io/).
...
Pour empêcher l’indexation d’une page par les moteurs de recherche, incluez l’élément suivant dans le [frontmatter](fr/pages) de votre page :
