...
description: "Migrez une documentation Docusaurus vers Mintlify : pages MDX, barres latérales, versions, contenu localisé, ressources et composants personnalisés."
