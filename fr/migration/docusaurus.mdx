...
description: "Migrez une documentation Docusaurus 2 ou 3 vers Mintlify avec le scraper ou depuis le référentiel source, en préservant versions et contenu localisé."
