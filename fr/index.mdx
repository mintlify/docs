...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Découvrez la nouvelle génération de documentation. Nativement IA, élégante dès le départ et conçue pour les développeurs.
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Démarrage rapide" description="Déployez votre premier site de documentation en quelques minutes avec notre guide pas à pas" href="/fr/fr/quickstart" />

      <HeroCard filename="cli" title="Installation de la CLI" description="Installez la CLI pour prévisualiser et développer votre documentation en local" href="/fr/fr/installation" />

      <HeroCard filename="editor" title="Éditeur web" description="Faites des mises à jour rapides et gérez le contenu avec notre éditeur dans le navigateur" href="/fr/fr/editor" />

      <HeroCard filename="components" title="Composants" description="Créez une documentation riche et interactive avec nos composants prêts à l’emploi" href="/fr/fr/text" />
    </div>
  </div>
</div>