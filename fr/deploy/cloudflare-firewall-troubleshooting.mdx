...
Si votre site de documentation affiche des erreurs 500 après quelques secondes ou que la navigation devient lente, il est possible que le pare-feu de Cloudflare bloque les requêtes vers les ressources Mintlify.
