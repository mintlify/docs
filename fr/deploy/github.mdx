...
Installez la GitHub App de Mintlify depuis votre [Dashboard](https://dashboard.mintlify.com/settings/deployment/git-settings).
...
<AccordionGroup>
  <Accordion title="Vérifier l'installation de la GitHub App">
    ...
    1. Allez dans les [paramètres Git](https://dashboard.mintlify.com/settings/deployment/git-settings) dans votre Dashboard.
