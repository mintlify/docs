...
L’application ne voyant que les référentiels sur lesquels elle est installée, elle ne peut pas générer d’aperçu de déploiement pour les pull requests ouvertes depuis un fork. Consultez [Pull requests depuis un fork](/fr/deploy/preview-deployments#fork-pull-requests) pour la solution de contournement.
