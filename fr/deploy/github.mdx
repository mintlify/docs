...
3. Installez la GitHub App en suivant les étapes décrites dans [Install These GitHub App](#install-These-github-app) ci-dessous.
...
6. Installez la GitHub App en suivant les étapes décrites dans [Installer la GitHub App](#install-These-github-app) ci-dessous.

<div id="install-These-github-app">
