...
Si vous avez ignoré la connexion de votre propre référentiel Git pendant l’onboarding, votre documentation se trouve dans l’organisation `mintlify-community`. Pour la déplacer vers votre propre compte ou organisation :
