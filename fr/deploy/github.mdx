...
<AccordionGroup>
  <Accordion title="Clonage en un clic (recommandé)">
    ...
    3. Sélectionnez l'organisation GitHub dans laquelle vous souhaitez créer le référentiel.
  ...
  <Accordion title="Configuration manuelle">
    ...
    1. Téléchargez votre documentation au format fichier ZIP pour avoir une sauvegarde de vos fichiers.
    2. Sélectionnez **GitHub** comme fournisseur et choisissez **Continue setup**.
    3. Autorisez avec GitHub lorsque vous y êtes invité.
    4. Sélectionnez votre organisation, référentiel et branche.
    5. Spécifiez éventuellement un sous-répertoire si votre documentation n'est pas à la racine du référentiel.
    6. Enregistrez vos paramètres.

  </Accordion>
</AccordionGroup>

Après avoir terminé l'une ou l'autre option, installez la GitHub App en suivant les étapes décrites dans [Installer la GitHub App](#install-the-github-app).
