...
Installez la GitHub App de Mintlify depuis la page [Git settings](https://app.mintlify.com/settings/deployment/git-settings) de votre Dashboard. Lorsque GitHub vous demande à quels référentiels accorder l’accès, choisissez **Only select repositories** et sélectionnez votre référentiel de documentation.
...
<AccordionGroup>
  <Accordion title="Vérifier l'installation de la GitHub App">
    ...
    1. Accédez à la page [Git settings](https://app.mintlify.com/settings/deployment/git-settings) de votre Dashboard.
