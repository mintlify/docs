...
Comme le [vérificateur de liens de l’interface en ligne de commande (CLI)](/fr/cli/commands#mint-broken-links) sur votre machine locale, la vérification CI des liens cassés recherche automatiquement les liens internes cassés dans le contenu de votre documentation.
