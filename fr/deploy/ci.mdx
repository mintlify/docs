...
<Warning>
  Ne placez pas `{/* vale off */}` ou des commentaires d'expression MDX similaires comme enfants directs d'un composant JSX entre des éléments frères. Par exemple, entre deux éléments `<Step>` à l'intérieur d'un composant `<Steps>`.
