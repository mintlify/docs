...
Configurez les contrôles CI activés pour un déploiement en accédant à la page [Modules complémentaires](https://app.mintlify.com/products/addons) de votre Dashboard. Activez les contrôles que vous souhaitez exécuter.
