...
Mintlify prend en charge deux configurations de proxy inverse selon vos besoins en sous-chemin.

- **Héberger sur `/docs`** : utilisez `mintlify.dev` comme cible de proxy. Activez l’option **Host at `/docs`** sur la page [Custom domain setup](https://dashboard.mintlify.com/settings/deployment/custom-domain) de votre Dashboard. Il s’agit d’une configuration plus simple, avec un nombre de routes plus réduit.
- **Sous-chemin personnalisé** : utilisez `mintlify.app` comme cible de proxy. Cette approche prend en charge n’importe quel sous-chemin et nécessite des règles de routage supplémentaires.
...
| --------------------------------- | ------------------------------------ | ------------- |
| `/docs`                           | `<your-subdomain>.mintlify.dev/docs` | Pas de cache  |
| `/docs/*`                         | `<your-subdomain>.mintlify.dev/docs` | Pas de cache  |
| `/.well-known/vercel/*`           | `<your-subdomain>.mintlify.dev`      | Pas de cache  |
| `/.well-known/skills/*` (optional)| `<your-subdomain>.mintlify.dev/docs` | Pas de cache  |
| `/skill.md` (optional)            | `<your-subdomain>.mintlify.dev/docs` | Pas de cache  |

Les routes `/.well-known/skills/*` et `/skill.md` sont facultatives. Incluez-les uniquement si vous souhaitez diffuser les fichiers de compétences IA à des chemins à la racine comme `your-domain.com/skills.md` plutôt que dans le sous-chemin de votre documentation, comme `your-domain.com/docs/skills.md`.
...
**Symptômes** : Vous publiez des mises à jour de votre documentation, mais les modifications n'apparaissent pas sur votre site.
...
**Solution** : pour les configurations de sous-chemins personnalisés, activez la mise en cache uniquement pour les chemins `/mintlify-assets/_next/static/*`. La configuration du sous-chemin `/docs` gère automatiquement la mise en cache.