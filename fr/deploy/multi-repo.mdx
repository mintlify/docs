...
<Steps>
  ...
  <Step title="Configurer la source du référentiel">
    ...
    Pour les sources GitHub, l’application GitHub de Mintlify doit avoir accès au référentiel. Pour les sources GitLab, fournissez l’ID du projet et un jeton de déploiement avec la portée `read_repository`. Pour les sources Bitbucket, connectez votre compte Bitbucket via OAuth et activez le dépôt. Consultez [Bitbucket](/fr/deploy/bitbucket) pour les instructions de configuration.
