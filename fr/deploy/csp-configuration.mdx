...
description: "Configurez les en-têtes Content Security Policy pour autoriser les ressources Mintlify tout en maintenant la sécurité pour les reverse proxies et les réseaux stricts."
...
| `hcaptcha.com` | Vérification CAPTCHA hCaptcha | `script-src`, `frame-src`, `style-src`, `connect-src` | Obligatoire |
| `*.hcaptcha.com` | Vérification CAPTCHA hCaptcha | `script-src`, `frame-src`, `style-src`, `connect-src` | Obligatoire |
