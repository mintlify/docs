...
description: "Configurez les en-têtes CSP pour autoriser les ressources Mintlify avec les reverse proxies, règles de pare-feu et réseaux appliquant des politiques de sécurité strictes."
...
- `connect-src` : contrôle les URL auxquelles la page peut se connecter pour les appels API et les connexions WebSocket
