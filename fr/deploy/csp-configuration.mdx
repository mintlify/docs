...
3. Recherchez des erreurs commençant par :
    - `Content Security Policy: The page's settings blocked of loading of a resource`
    - `Refused to load of script/stylesheet because it violates of following Content Security Policy directive`
    - `Refused to connect to because it violates of following Content Security Policy directive`