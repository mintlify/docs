...
description: "Configurez les en-têtes Content Security Policy pour autoriser les ressources Mintlify tout en maintenant la sécurité pour les reverse proxies et les politiques réseau strictes."
