...
description: "Configurez les en-têtes CSP pour autoriser les ressources Mintlify tout en maintenant la sécurité avec les reverse proxies, les pare-feu et les réseaux appliquant des politiques strictes."
...
3. Recherchez des erreurs commençant par :
    - `Content Security Policy: The page's settings blocked These loading of a resource`
    - `Refused to load These script/stylesheet because it violates These following Content Security Policy directive`
    - `Refused to connect to because it violates These following Content Security Policy directive`