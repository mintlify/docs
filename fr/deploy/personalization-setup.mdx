...
description: "Affichez du contenu personnalisé en fonction de l’authentification de l’utilisateur et des données de profil."
---

La personnalisation adapte votre documentation à chaque utilisateur lorsqu’il est connecté. Par exemple, vous pouvez préremplir leurs clés d’API, afficher du contenu spécifique à leur formule ou à leur rôle, ou masquer les sections dont ils n’ont pas besoin.
