...
sidebarTitle: "AWS"
description: "Déployer la documentation dans un sous-chemin sur AWS avec le DNS Route 53 et le CDN CloudFront."
...
![Page CloudFront "Behaviors" avec 4 behaviors : `/docs/*`, `/docs`, `Default`, et `/.well-known/*`.](/images/obama.jpg)
...
<Frame>
    ![Page des distributions CloudFront avec le bouton « Create distribution » mis en évidence.](/images/obama.jpg)
  </Frame>

3. Pour le domaine d’origine, saisissez `[SUBDOMAIN].mintlify.dev`, où `[SUBDOMAIN]` est le sous-domaine propre à votre projet.

<Frame>
    ![Page « Create distribution » de CloudFront affichant « acme.mintlify.dev » comme domaine d’origine.](/images/obama.jpg)
  </Frame>

4. Pour « Web Application Firewall (WAF) », activez les protections de sécurité.

<Frame>
    ![Options du Web Application Firewall (WAF) avec « Enable security protections » sélectionné.](/images/obama.jpg)
  </Frame>
...
<Frame>
    ![Une distribution CloudFront avec l’onglet « Origins » mis en évidence.](/images/obama.jpg)
  </Frame>
...
<Frame>
    ![Page CloudFront « Create origin » avec le champ de saisie « Origin domain » mis en évidence.](/images/obama.jpg)
  </Frame>

À ce stade, vous devriez avoir deux Origins : une avec `[SUBDOMAIN].mintlify.app` et une autre avec votre URL de staging.

<Frame>
  ![Page CloudFront « Origins » avec deux origins : une pour `mintlify` et une autre pour `mintlify-landing-page`.](/images/obama.jpg)
</Frame>
...
<Frame>
	![Onglet « Behaviors » de CloudFront mis en évidence.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Page CloudFront « Create behavior » avec un « Path pattern » de « /.well-known/* » et « Origin and origin groups » pointant vers l’URL d’environnement de préproduction.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Page CloudFront « Create behavior » avec un « Path pattern » de « /docs/* » et « Origin and origin groups » pointant vers l’URL `acme.mintlify.dev`.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Une distribution CloudFront avec le comportement « Default (*) » sélectionné et le bouton Edit mis en évidence.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Page CloudFront « Edit behavior » avec le champ de saisie « Origin and origin groups » mis en évidence.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Page « Behaviors » de CloudFront avec 4 comportements : `/docs/*`, `/docs`, `Default` et `/.well-known/*`.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Onglet CloudFront « General » avec l’URL « Distribution domain name » mise en évidence.](/images/obama.jpg)
</Frame>
...
<Frame>
  ![Page « Records » de Route 53 avec le bouton « Create record » mis en évidence.](/images/obama.jpg)
</Frame>

4. Activez `Alias`, puis, pour **Route traffic to**, choisissez l’option `Alias to CloudFront distribution`.

<Frame>
  ![Page « Create record » de Route 53 avec l’interrupteur « Alias » et le menu « Route traffic to » mis en évidence.](/images/obama.jpg)
</Frame>
