...
Avant de créer l'enregistrement Route 53, ajoutez votre domaine à la distribution. Dans l'onglet « General » de votre distribution, ajoutez votre domaine (par exemple, `yoursite.com`) comme **Alternate domain name (CNAME)** et attachez un certificat AWS Certificate Manager (ACM) qui le couvre. Sans nom de domaine alternatif, CloudFront rejette les requêtes qui arrivent via votre domaine.
