...
description: "Exportez votre site de documentation sous forme d'archive zip autonome pour la consultation hors ligne, la distribution interne ou un environnement isolé."
keywords: ["export", "hors ligne", "zip", "site statique", "distribution", "mint export"]
---

<Info>
  Les exportations hors ligne nécessitent une [offre Enterprise](https://mintlify.com/pricing?ref=offline-export).
</Info>
...
L'archive exportée est un bundle statique, les fonctionnalités qui dépendent des services cloud de Mintlify ne sont donc pas disponibles hors ligne :

- **Pris en charge hors ligne** : Navigation entre les pages, images, exemples de code, diagrammes Mermaid et autres contenus pré-rendus.
- **Non pris en charge hors ligne** : Recherche en texte intégral, assistant IA, playground API interactif, analyse, widgets de retours et authentification.

Les destinataires qui ont besoin de ces fonctionnalités doivent accéder à votre site en production.
