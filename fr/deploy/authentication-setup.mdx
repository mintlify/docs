...
description: "Configurez l'authentification utilisateur pour contrôler l'accès aux pages et références d'API via mot de passe, OAuth, JWT ou accès privé géré par Mintlify."
