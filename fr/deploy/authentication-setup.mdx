...
<Tabs>
  ...
  <Tab title="Tableau de bord Mintlify">
    ...
    * Toutes les personnes qui doivent accéder à votre documentation doivent être membres de votre organisation Mintlify.
    ...
    ### Exemple du tableau de bord Mintlify
...
Certaines fonctionnalités se comportent différemment ou ne sont pas disponibles lorsque vous activez l’authentification. À l’exception de `llms.txt` et `llms-full.txt` sur les sites partiellement authentifiés, Mintlify ne prend pas en charge l’hébergement de fichiers publics arbitraires sur un site authentifié. Tous les autres fichiers hébergés, y compris `skill.md`, sont soumis aux mêmes exigences d’authentification que vos pages de documentation.
...
| :------------------------------------------------------- | :----------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------- |
| [llms.txt](/fr/ai/llmstxt)                                  | Prise en charge complète | Disponible derrière l’authentification, les outils d’IA peuvent donc ne pas avoir accès au fichier. Exclut les pages assignées à des groupes et omet les spécifications OpenAPI et AsyncAPI | Accessible publiquement, mais n’inclut que les pages publiques et omet les spécifications OpenAPI et AsyncAPI               |
| [llms-full.txt](/fr/ai/llmstxt#llms-fulltxt)                | Prise en charge complète | Non pris en charge                                                                                                                                                            | Accessible publiquement, mais n’inclut que les pages publiques                                                              |
