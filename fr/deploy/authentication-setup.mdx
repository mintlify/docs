...
| :------------------------------------------------------- | :----------------------- | :--------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- |
| [llms.txt and llms-full.txt](/fr/ai/llmstxt)                | Prise en charge complète | Disponible derrière l’authentification, la plupart des outils d’IA ne peuvent donc pas accéder aux fichiers. Impossible de les rendre publics. | Disponible derrière l’authentification, la plupart des outils d’IA ne peuvent donc pas accéder aux fichiers. Impossible de les rendre publics.        |
...
| [Search](/fr/ai/assistant)                                  | Prise en charge complète | Prise en charge complète, respecte les groupes d’utilisateurs                                        | Prise en charge complète, respecte les groupes d’utilisateurs                                               |
