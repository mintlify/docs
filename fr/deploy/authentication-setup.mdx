...
Certaines fonctionnalités se comportent différemment ou ne sont pas disponibles lorsque vous activez l’authentification. Mintlify ne prend pas en charge l’hébergement de fichiers publics arbitraires sur un site authentifié. À l'exception de `llms.txt` et `llms-full.txt` sur les sites partiellement authentifiés, les fichiers hébergés tels que `skill.md` sont soumis aux mêmes exigences d’authentification que vos pages de documentation.
...
| :------------------------------------------------------- | :----------------------- | :--------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- |
| [llms.txt and llms-full.txt](/fr/ai/llmstxt)                | Prise en charge complète | Non servi (renvoie `404`)                                                                            | Accessible publiquement, limité aux pages publiques uniquement                                              |
