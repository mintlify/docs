...
| [Sitemap](/fr/optimize/seo#sitemaps-and-robotstxt-files)    | Prise en charge complète | Disponible derrière l’authentification, mais exclut les pages dans des groupes                       | Accessible publiquement. Les visiteurs anonymes ne voient que les pages publiques. Les utilisateurs authentifiés voient également les pages non groupées. |
| [robots.txt](/fr/optimize/seo#sitemaps-and-robotstxt-files) | Prise en charge complète | Disponible derrière l’authentification                                                               | Accessible publiquement lorsqu’il existe des pages publiques                                                |