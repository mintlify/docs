...
Certaines fonctionnalités se comportent différemment ou ne sont pas disponibles lorsque vous activez l’authentification. Mintlify ne prend pas en charge l’hébergement de fichiers publics arbitraires sur un site authentifié. Tous les fichiers hébergés, y compris `skill.md`, sont soumis aux mêmes exigences d’authentification que vos pages de documentation.
...
| :------------------------------------------------------- | :----------------------- | :--------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- |
| [llms.txt](/fr/ai/llmstxt)                | Prise en charge complète | Disponible derrière l’authentification. Exclut les pages dans des groupes ainsi que les spécifications OpenAPI ou AsyncAPI | Accessible publiquement. Inclut uniquement les pages publiques et exclut les spécifications OpenAPI ou AsyncAPI |
| [llms-full.txt](/fr/ai/llmstxt#llms-full-txt) | Prise en charge complète | Non pris en charge | Accessible publiquement. Inclut uniquement le contenu des pages publiques |
