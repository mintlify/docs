---
title: "Vercel"
description: "Configurez les règles de réécriture Vercel pour diffuser votre documentation Mintlify sur un sous-chemin de votre domaine principal avec une configuration vercel.json pas à pas."
...
1. Accédez à la page [Custom domain setup](https://app.mintlify.com/settings/deployment/custom-domain) dans votre Dashboard.
