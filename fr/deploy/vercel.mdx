...
<Note>
  Les sous-chemins personnalisés nécessitent une offre Custom et une configuration manuelle. Contactez le [support Mintlify](mailto:support@mintlify.com) avec les détails du sous-chemin souhaité et de votre configuration d'hébergement.
</Note>
