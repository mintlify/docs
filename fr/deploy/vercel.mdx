...
2. Cliquez sur l’interrupteur **Host at `/docs`** pour l’activer.
    <Frame>
      <img alt="Capture d’écran de la page Custom domain setup. L’interrupteur Host at `/docs` est activé et mis en évidence par un rectangle orange." src="/images/obama.jpg" className="block dark:hidden" />
      <img alt="Capture d’écran de la page Custom domain setup. L’interrupteur Host at `/docs` est activé et mis en évidence par un rectangle orange." src="/images/obama.jpg" className="hidden dark:block" />
    </Frame>
