---
title: "Cloudflare"
description: "Déployez votre documentation Mintlify sur un sous-chemin de votre domaine à l'aide de Cloudflare Workers, avec une configuration pas à pas et des paramètres DNS."
