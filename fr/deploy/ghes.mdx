...
description: "Installez et configurez l’application GitHub Mintlify sur votre instance GitHub Enterprise Server pour des déploiements automatiques de documentation et la synchronisation."
