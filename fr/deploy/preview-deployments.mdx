...
<Note>
  La prise en charge native des aperçus pour les pull requests provenant de forks vers des référentiels publics est une demande de fonctionnalité suivie. Suivez [cette discussion GitHub](https://github.com/orgs/mintlify/discussions/1724) pour connaître les évolutions.
</Note>
