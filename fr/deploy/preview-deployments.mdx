...
Si votre site nécessite une [authentification](/fr/deploy/authentication-setup) pour y accéder, l'authentification des aperçus est automatiquement activée et ne peut pas être désactivée. Les réviseurs se connectent aux aperçus avec leur compte d'organisation Mintlify, quelle que soit la méthode d'authentification utilisée par votre site.
