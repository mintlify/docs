...
<div id="features-that-behave-differently-in-previews">
  ## Fonctionnalités qui se comportent différemment dans les prévisualisations
</div>

Certaines fonctionnalités sont limitées aux déploiements de production et n'apparaissent pas sur les prévisualisations de branche :

- **[Sujets associés](/fr/organize/related-pages)** : les suggestions automatiques comme les listes manuelles du frontmatter `related` sont ignorées dans les prévisualisations car aucun index de recherche n'est construit pour les déploiements de prévisualisation. Vérifiez la configuration en production après la fusion.
