...
- Une organisation Mintlify avec un **plan Pro ou supérieur**. L'enregistrement des identifiants OAuth et le démarrage du flux d'autorisation sur les plans Hobby ou d'essai renvoient une erreur 403. Les organisations qui disposaient déjà d'une installation GitLab auto-hébergé avant cette exigence continuent de fonctionner et peuvent réautoriser normalement.
