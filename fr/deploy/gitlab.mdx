...
<Steps>
  ...
  <Step title="Configurer la connexion">
    ...
    3. Si vous utilisez une instance GitLab auto-hébergée, activez le toggle **Set up as self-hosted** et saisissez l’URL de votre instance GitLab (par exemple, `https://gitlab.votre-domaine.com`). Votre instance doit être accessible publiquement pour que Mintlify puisse s’y connecter.
