...
Lorsque vous ouvrez [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) pour la première fois, un assistant de configuration vous guide pour connecter votre référentiel GitLab.

<Steps>
  <Step title="Sélectionner GitLab comme fournisseur">
    Sur la page [Git Settings](https://app.mintlify.com/settings/deployment/git-settings), sélectionnez **Connect to GitLab** et cliquez sur **Continue**.
  </Step>
...
Pour modifier les paramètres de votre connexion GitLab après la configuration initiale, accédez à [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) et mettez à jour votre ID de projet, jeton d'accès, branche ou URL d'instance directement.
...
<Steps>
  <Step title="Accéder aux paramètres Git">
    Accédez aux [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) dans votre Tableau de bord.
  </Step>
...
<Steps>
  ...
  <Step title="Récupérer le jeton du webhook">
    Dans votre Tableau de bord Mintlify, cliquez sur **Show webhook token**. Copiez le jeton du webhook.
    <Frame>
  ...
  <Step title="Coller le jeton du webhook">
    Dans GitLab, collez le jeton du webhook depuis votre Tableau de bord Mintlify dans le champ **Secret token**.
  </Step>
  ...
  <Step title="Vérifier le webhook">
    ...
    - **Secret token** : le jeton du webhook depuis votre Tableau de bord Mintlify
