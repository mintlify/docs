...
<Steps>
  ...
  <Step title="Télécharger votre contenu">
    <Tip>
      Si vous disposez déjà d'un référentiel GitLab avec votre documentation, vous pouvez ignorer le téléchargement et cliquer directement sur **Continue setup**.
    </Tip>
    
    Si votre documentation est hébergée par Mintlify, téléchargez-la au format zip.
