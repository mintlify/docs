...
Nous utilisons des jetons d’accès et des webhooks pour authentifier et synchroniser les changements entre GitLab et Mintlify. Cela fonctionne avec GitLab.com ainsi qu’avec les instances GitLab auto-hébergées.
...
<Steps>
  ...
  <Step title="Configurer la connexion">
    ...
    2. Si vous utilisez une instance GitLab auto-hébergée, saisissez l'URL de votre hôte GitLab (par exemple, `https://gitlab.example.com`). L'URL doit utiliser HTTPS.
    3. Renseignez les autres configurations requises.
    4. Cliquez sur **Enregistrer les modifications**.

    Mintlify valide votre jeton d'accès et l'accès au dépôt lors de l'enregistrement, afin que vous puissiez confirmer immédiatement que votre connexion fonctionne.
