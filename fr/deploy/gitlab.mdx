...
<Steps>
  ...
  <Step title="Configurer la connexion">
    ...
    2. Sélectionnez votre branche de déploiement.
    3. Si vos docs ne sont pas à la racine de votre référentiel, activez **Set up as monorepo** et saisissez le chemin vers le répertoire contenant votre `docs.json`.
    4. Si vous utilisez une instance GitLab auto-hébergée, activez **Set up as self-hosted** et saisissez l'URL de votre hôte GitLab (par exemple, `https://gitlab.example.com`).
