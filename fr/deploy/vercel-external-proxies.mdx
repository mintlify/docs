...
description: "Configurez des proxys inverses externes comme Cloudflare ou Nginx devant votre déploiement Vercel pour diffuser la documentation Mintlify sur un sous-chemin personnalisé."
