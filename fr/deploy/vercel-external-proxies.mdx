...
description: "Configurez des proxys inverses externes comme Cloudflare ou Nginx devant votre déploiement Vercel pour servir Mintlify sur un sous-chemin personnalisé."
