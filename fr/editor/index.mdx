...
<Card title="Branching and publishing" icon="git-branch" horizontal href="/fr/editor/branching-and-publishing">
...
<Card title="Configurations du site" icon="settings" horizontal href="/fr/editor/configurations">
