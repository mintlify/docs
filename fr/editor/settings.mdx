...
description: "Configurez les instructions d'IA, les valeurs par défaut des pull requests, les brouillons et la méthode de fusion pour contrôler la façon dont l'éditeur web Mintlify publie les modifications."
