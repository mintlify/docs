...
description: "Configurez les instructions d'IA, les consignes pour les pull requests, les pull requests en brouillon et la méthode de fusion par défaut de l'éditeur web Mintlify."
