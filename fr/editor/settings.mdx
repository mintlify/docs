...
description: "Configurez les instructions d'IA, les valeurs par défaut des pull requests, le comportement des brouillons et la méthode de fusion par défaut pour contrôler la façon dont l'éditeur web Mintlify publie les modifications."
