...
keywords: ["editor", "content", "pages", "files", "create", "edit", "version history", "media", "images", "video"]
---
...
Mint enregistre une nouvelle entrée lorsque l'éditeur enregistre un contenu différent de la dernière version enregistrée. L'enregistrement d'un contenu inchangé ne crée pas d'entrée en double. Une page enregistrée peut également être vide. Chaque entrée indique l'auteur et le temps relatif depuis l'enregistrement. L'entrée la plus récente porte la mention **Latest**.
...
Restore applique l'instantané sélectionné à la page actuelle. Pour les pages publiques, il écrit sur le site, le déploiement et la branche actifs. Pour les pages privées, il met à jour le contenu privé partagé au lieu d'une copie propre à une branche. Il ne crée pas de nouvelle page et ne sert pas uniquement à prévisualiser le contenu enregistré.
...
Restore n'est pas disponible sur les branches de déploiement bloquées ni sur la version **Latest**.
