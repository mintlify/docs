---
title: "Créer et modifier des pages dans l’éditeur Mintlify"
...
- **Dupliquer** : Faites un clic droit sur une page ou ouvrez le menu des options de page dans la barre supérieure, puis sélectionnez **Duplicate**. L'éditeur insère la copie après l'original et ajoute `(copy)` à son titre.
