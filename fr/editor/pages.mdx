...
L'historique des versions regroupe les entrées par date. Chaque entrée indique l'auteur et l'heure d'enregistrement. L'entrée la plus récente porte la mention **Current**.
...
Lorsque l'historique des versions est disponible pour la page, vous pouvez également cliquer sur le libellé **Edited ... ago** dans l'en-tête de l'éditeur pour ouvrir le panneau. Pour les pages non prises en charge, le libellé reste non interactif.

Le panneau affiche les versions de la page actuelle. L'historique des pages publiques est limité à la branche actuelle. L'historique des pages privées est partagé entre les branches. Cliquez sur **Show more versions** pour charger les entrées plus anciennes.
