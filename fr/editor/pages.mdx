...
Restore applique l'instantané sélectionné à la page active actuelle du site, du déploiement et de la branche actuels. Il ne crée pas de nouvelle page et ne sert pas uniquement à prévisualiser le contenu enregistré.
