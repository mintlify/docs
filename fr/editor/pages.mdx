...
Le panneau affiche les versions de la page actuelle sur la branche actuelle. Cliquez sur **Show more versions** pour charger les entrées plus anciennes.

Les versions antérieures incluent l'action **Restore** lorsque vous avez l'autorisation de modifier la page. Cliquez sur **Restore**, puis confirmez pour remplacer le contenu actuel de la page par cette version enregistrée. Cette action écrase les modifications non enregistrées.

Restore applique l'instantané sélectionné à la page active du site et du déploiement actuels, sur la branche actuelle. Il ne crée pas de nouvelle page et ne sert pas uniquement à prévisualiser le contenu enregistré.
