...
Utilisez l'historique des versions pour consulter les versions enregistrées de la page que vous modifiez. Mint enregistre une nouvelle entrée lorsque l'éditeur enregistre un contenu différent de la dernière version enregistrée. L'enregistrement d'un contenu inchangé ne crée pas d'entrée en double. Une page enregistrée peut également être vide. Chaque entrée indique l'auteur et le temps relatif depuis l'enregistrement. L'entrée la plus récente porte la mention **Latest**.
...
Le panneau affiche les versions de la page actuelle sur la branche actuelle. Cliquez sur **Show more versions** pour charger les entrées plus anciennes. Les versions antérieures incluent l'action **Restore** lorsque vous avez l'autorisation de modifier la page. Cliquez sur **Restore**, puis confirmez pour remplacer le contenu actuel de la page par cette version enregistrée. Cette action écrase les modifications non enregistrées. Restore n'est pas disponible sur les branches de déploiement bloquées ni sur la version **Latest**. Vous ne pouvez pas comparer les versions depuis le panneau.
