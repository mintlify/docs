...
<Note>
  L'aperçu en direct fonctionne sur les sites publics et sur les sites qui utilisent [l'authentification](/fr/deploy/authentication-setup), y compris par mot de passe, OAuth, JWT ou accès géré par Mintlify. Lorsque vous ouvrez l'aperçu en direct d'un site authentifié, vous vous connectez depuis le tableau de bord et voyez toutes les pages auxquelles vous avez accès en tant qu'éditeur, y compris les pages protégées par des contrôles d'accès basés sur des groupes.
</Note>
