...
Prévisualisez votre site pendant que vous le modifiez. Les aperçus en direct affichent les pages exactement telles qu'elles apparaissent une fois publiées, et se mettent à jour à mesure que vous modifiez le contenu, la navigation et la configuration. L'aperçu en direct est compatible avec les sites authentifiés.
