...
description: "Prévisualisez votre site de documentation en temps réel pendant l'édition, avec un rendu instantané des changements de contenu, navigation et configuration."
...
Utilisez l'aperçu en direct pour obtenir un retour immédiat pendant l'édition. Lorsque vous devez partager des modifications avec votre équipe ou tester sur un autre appareil, utilisez un [déploiement de prévisualisation](https://www.mintlify.com/docs/editor/branching-and-publishing#preview-your-changes).
