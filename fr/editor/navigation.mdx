...
<Frame>
  <img src="/images/obama.jpg" alt="Ajouter un nouvel élément de navigation." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Ajouter un nouvel élément de navigation." className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="Menu « Ajouter un fichier existant » développé." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Menu « Ajouter un fichier existant » développé." className="hidden dark:block" />
</Frame>
