...
Pour dissocier des pages d'un groupe ou d'un autre élément de navigation, faites un clic droit puis cliquez sur **Ungroup**. Toutes les pages de l'élément dissocié sont déplacées vers le niveau racine de votre navigation.
