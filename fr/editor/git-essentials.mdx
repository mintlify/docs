...
<AccordionGroup>
  ...
  <Accordion title="Pull request">
    ...
    Lorsque vous publiez des modifications sur une feature branch (ou lorsque votre référentiel exige des pull requests), l'éditeur web crée une pull request. Votre équipe examine et fusionne la pull request dans votre fournisseur Git (GitHub, GitLab ou Bitbucket).
  </Accordion>
