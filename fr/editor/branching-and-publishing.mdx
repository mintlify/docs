...
Cliquez sur le lien de la pull request pour l'ouvrir dans GitHub, GitLab ou Bitbucket.
...
L'action d'approbation n'est pas disponible pour les pull requests en brouillon ou les pull requests que vous avez déjà approuvées. Si vous utilisez GitLab ou Bitbucket, ouvrez la pull request dans votre fournisseur Git pour l'approuver.
...
Chacun de ces points d'entrée ouvre l'éditeur sur la branche de l'automatisation avec les pages modifiées présélectionnées dans le menu de publication. Vous pouvez examiner le diff et fusionner ou demander des modifications sans quitter l'éditeur.
...
Si votre organisation exige des pull requests, vous pouvez saisir un titre et une description au moment de publier. Si vous laissez l'un ou l'autre vide, l'éditeur utilise un message par défaut qui liste les fichiers que vous avez créés, mis à jour, déplacés ou supprimés.
