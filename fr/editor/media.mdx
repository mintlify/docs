...
Saisissez <kbd>/youtube</kbd> pour intégrer une vidéo YouTube ou <kbd>/loom</kbd> pour intégrer une vidéo Loom. Collez l'URL et l'éditeur génère automatiquement l'iframe.
