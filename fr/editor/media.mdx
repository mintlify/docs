...
Tapez <kbd>/youtube</kbd> pour intégrer une vidéo YouTube, <kbd>/loom</kbd> pour intégrer une vidéo Loom ou <kbd>/vimeo</kbd> pour intégrer une vidéo Vimeo. Collez l’URL de la vidéo, et l’éditeur génère une iframe.
