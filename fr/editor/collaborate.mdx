...
<Frame>
  <img src="/images/obama.jpg" className="block dark:hidden" alt="Bouton Share dans la barre d’outils de l’éditeur" />

  <img src="/images/obama.jpg" className="hidden dark:block" alt="Bouton Share dans la barre d’outils de l’éditeur" />
</Frame>
