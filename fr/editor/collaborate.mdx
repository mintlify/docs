...
<Steps>
  <Step title="Créer une pull request">
    Créez une pull request depuis l’éditeur lorsque vous êtes prêt à publier vos modifications. Consultez <a href="/fr/editor/branching-and-publishing">Publier des modifications dans l’éditeur web</a> pour plus d’informations sur l’utilisation des pull requests.
  </Step>
