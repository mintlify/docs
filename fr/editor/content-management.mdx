...
description: "Créer, modifier et organiser vos pages de documentation"
---
...
Appuyez sur <kbd>Command</kbd> + <kbd>P</kbd> (<kbd>Ctrl</kbd> + <kbd>P</kbd> sur Windows) pour rechercher des fichiers par leur nom.
...
<Steps>
  <Step title="Open docs.json">
    Repérez et ouvrez le fichier `docs.json` à la racine du projet via l’explorateur de fichiers.
  </Step>
  <Step title="Locate the navigation section">
    Accédez à l’emplacement dans le fichier `docs.json` où vous souhaitez ajouter votre nouvelle page.
  </Step>
  <Step title="Add your page">
    Ajoutez le nom de fichier de votre page (sans l’extension `.mdx`) dans le tableau `pages` du groupe approprié.
  </Step>
</Steps>
