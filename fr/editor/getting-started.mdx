...
* Apprenez les [concepts Git](/fr/fr/editor/git-concepts) fondamentaux.
* Découvrez les bonnes pratiques de collaboration avec les [branches](/fr/fr/editor/branches).
* Explorez la [gestion de contenu](/fr/fr/editor/content-management) avec l’Éditeur web.
* Familiarisez-vous avec les [options de publication](/fr/fr/editor/publishing) adaptées à différents scénarios.