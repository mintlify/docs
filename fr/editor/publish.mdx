...
<Note>
  Votre site de documentation en production est mis à jour après que Mintlify a compilé et déployé vos modifications publiées. Cela prend généralement entre 30 secondes et quelques minutes. Vérifiez l’état du déploiement de vos modifications sur votre [dashboard](https://app.mintlify.com).
</Note>
...
Signez vos commits avec votre compte GitHub en l’autorisant dans vos [paramètres de compte](https://app.mintlify.com/settings/account). Sans cette autorisation, la GitHub App de Mintlify signe les commits effectués dans l’éditeur web.
