...
<Note>
  Votre site de documentation en production est mis à jour après que Mintlify a construit et déployé vos modifications publiées. Cela prend généralement de 30 secondes à quelques minutes. Vérifiez l'état du déploiement de vos modifications sur votre [tableau de bord](https://dashboard.mintlify.com).
</Note>
...
Les conflits surviennent lorsque vous essayez de fusionner des branches comportant des modifications incompatibles sur les mêmes fichiers.
