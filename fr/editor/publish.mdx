...
<div id="ai-generated-pull-request-details">
  ### Détails de pull request générés par l’IA
</div>

Lorsque vous publiez des modifications qui créent une pull request, l’éditeur génère automatiquement un titre et une description basés sur vos modifications. Les détails générés résument ce que vous avez changé afin que les réviseurs puissent comprendre rapidement votre mise à jour.

Vous pouvez modifier le titre et la description générés avant de soumettre. Si vous avez déjà saisi un titre ou une description, le contenu généré est ajouté à ce que vous avez écrit.
