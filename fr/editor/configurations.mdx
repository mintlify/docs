...
description: "Modifiez l'identité de marque, l'apparence, la navigation et les paramètres de fonctionnalités du site depuis le panneau Configurations de l'éditeur web Mintlify, avec une synchronisation en temps réel entre les membres de l'équipe."
...
Le panneau est organisé en sections qui correspondent aux propriétés de premier niveau de votre [`docs.json`](/fr/organize/settings).
