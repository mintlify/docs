...
description: "Modifiez l'image de marque, les couleurs, l'apparence et les fonctionnalités de votre site depuis le panneau Configurations du site de l'éditeur web Mintlify."
keywords: ["éditeur", "configurations du site", "configurations", "paramètres"]
boost: 3
---

Configurez l'image de marque, l'apparence et les fonctionnalités de votre site de documentation à partir du panneau **Configurations du site** de l'éditeur web.

Ouvrez le panneau en sélectionnant **Configurations du site** dans la barre latérale de l'éditeur. Dans la vue réduite de la barre latérale, il apparaît sous **Config. du site**.

<Frame>
  <img src="/images/editor/configurations-light.png" alt="Menu Configurations du site dans l'éditeur." className="block dark:hidden" />

  <img src="/images/editor/configurations-dark.png" alt="Menu Configurations du site dans l'éditeur." className="hidden dark:block" />
</Frame>
