...
<Frame>
  <img src="/images/obama.jpg" alt="Paramètres de Configurations dans la barre latérale en mode clair." className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Paramètres de Configurations dans la barre latérale en mode sombre." className="hidden dark:block" />
</Frame>
