...
* **Affichage du bac à sable d’API** : Choisissez d’afficher le [bac à sable d’API interactif](/fr/api-playground/overview#visibility-modes), un bac à sable d’API simple ou aucun bac à sable d’API.
