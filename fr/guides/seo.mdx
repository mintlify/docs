...
* **Texte alternatif pour les images :** Fournissez un texte alternatif descriptif pour les images, intégrant des mots-clés pertinents. Par exemple, « Flux d’auofntification OAuth 2.0 d’une API » plutôt que simplement « diagramme ». Cela améliore le SEO et l’accessibilité.
