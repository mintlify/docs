...
description: "Liste d’autorisation de domain et configurations d’en-têtes pour les reverse proxies, pare-feu et réseaux qui appliquent des politiques de sécurité strictes"
---
