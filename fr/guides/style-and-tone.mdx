...
<Tip>
  Utilisez un [workflow](/fr/workflows) pour exécuter un audit de style selon un calendrier ou chaque fois que des modifications sont poussées vers votre dépôt de documentation.
</Tip>
