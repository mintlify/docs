...
<Tip>
  Utilisez un [workflow](/fr/agent/workflows) pour lancer un audit de style selon un calendrier ou chaque fois que des modifications sont poussées vers votre dépôt de documentation, afin de corriger automatiquement les violations et de signaler tout élément nécessitant un examen plus approfondi.
</Tip>
