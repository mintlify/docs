...
description: "Identifiez l'audience de votre documentation, comprenez ses objectifs et niveaux de compétence, et structurez le contenu pour l'aider à accomplir ses tâches efficacement."
keywords: ["user research", "audience personas", "user feedback", "target audience"]
---

<Tip>
  Cette page explique comment identifier votre audience, mener des recherches utilisateur et écrire en gardant leurs besoins à l’esprit.
</Tip>
