...
<Tabs>
  <Tab title="Utiliser l'éditeur web">
    ...
    La liste déroulante n’affiche que les branches créées dans l’éditeur web et les branches ayant une pull request ou une merge request ouverte ciblant votre branche de déploiement. Les branches poussées directement vers GitHub, GitLab ou Bitbucket sans pull request ouverte existent toujours dans votre référentiel, mais elles n’apparaissent pas dans la liste déroulante. Pour ouvrir l’une de ces branches dans l’éditeur, ouvrez une pull request pour cette branche chez votre fournisseur Git, ou ouvrez n’importe quelle branche dans l’éditeur et remplacez le nom de la branche dans l’URL de votre navigateur par celui de la branche souhaitée.
