...
description: "Utilisez les modes de page et les composants pour créer des pages d'accueil personnalisées, des pages marketing et d'autres mises en page non standard dans votre documentation Mintlify."
