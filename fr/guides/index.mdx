---
title: "Guides"
description: "Parcourez des guides sur les bonnes pratiques de documentation, la stratégie de contenu, l'optimisation SEO, l'accessibilité et les workflows docs-as-code pour votre équipe."
---
...
* [Configurer l'automerge](/fr/guides/configure-automerge) : ajoutez l'application GitHub Mintlify à la liste de contournement d'un ensemble de règles pour activer la fusion automatique des workflows.
...
* [Créer un centre d’assistance](/fr/guides/support-center) : Créez un centre d’assistance en libre-service qui aide vos clients à trouver des réponses, réduit le volume de tickets et améliore la satisfaction client.
