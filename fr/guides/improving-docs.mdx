...
description: "Utilisez analyses, retours utilisateurs et audits de contenu pour identifier les lacunes de la documentation et améliorer les pages clés."
...
<Tip>
  Utilisez les [automatisations](/fr/automations) pour automatiser les améliorations récurrentes — comme ouvrir une pull request avec des corrections suggérées pour les pages signalées par de faibles scores de retours.
</Tip>
...
Mensuellement pour les pages à fort trafic et les tendances générales de satisfaction. Trimestriellement pour un audit de contenu plus approfondi qui examine les schémas de navigation, les requêtes de recherche sans résultats et les pages sans mises à jour récentes. Un examen en temps réel n'est pas nécessaire, sauf si vous venez de déployer un changement majeur.
</Accordion>
