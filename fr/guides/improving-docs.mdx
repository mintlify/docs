...
<Tip>
  Utilisez les [workflows](/fr/workflows) pour automatiser les améliorations récurrentes — comme ouvrir une pull request avec des corrections suggérées pour les pages signalées par de faibles scores de retours.
</Tip>
