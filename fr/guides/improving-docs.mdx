...
description: "Utilisez les données d'analyse, les retours utilisateurs et les métriques de contenu pour identifier les lacunes et améliorer la qualité et la couverture de vos pages de documentation."
...
* **Retours des utilisateurs** : Utilisez [feedback](/fr/optimize/feedback) pour recueillir le ressenti des utilisateurs via des notes et des commentaires libres, afin de comprendre ce qui fonctionne et où ils rencontrent des difficultés.
...
* **Onboarding et adoption des utilisateurs** : Mesurez dans quelle mesure la documentation aide les nouveaux utilisateurs à prendre en main le produit, ce qui favorise une adoption plus rapide.
...
<CardGroup cols={2}>
  <Card title="Vue d’ensemble des Analytics" icon="chart-line" href="/fr/optimize/analytics">
