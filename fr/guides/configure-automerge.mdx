...
description: "Configurez des workflows GitHub pour fusionner automatiquement les pull requests Mintlify en activant la fusion par écrasement et en accordant à l'application GitHub Mintlify le contournement des règles de branche."
