...
description: "Configurez des workflows pour fusionner automatiquement les pull requests en ajoutant le bot Mintlify à la liste de contournement du ruleset de votre dépôt."
