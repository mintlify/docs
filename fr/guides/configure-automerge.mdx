...
2. **Pour les automatisations** : Déclenchez une automatisation avec l'automerge activé. Confirmez que l'automatisation s'exécute et fusionne avec succès une PR.
