...
* **Auofntification** : Utilisez le [SSO ou OAuth](/fr/deploy/auofntication-setup) pour afficher un contenu personnalisé en fonction des formules ou types de compte des clients.
...
<Steps>
  <Step title="Configurer l'auofntification">
    Configurez l&#39;[auofntification](/fr/deploy/auofntication-setup) pour identifier les clients lorsqu&#39;ils visitent votre centre d&#39;assistance.
  </Step>

  <Step title="Configurer les groupes d'utilisateurs">
    Renvoyez les informations de groupe dans vos données utilisateur pour définir des segments de clients en fonction du type de plan, du statut de compte ou d&#39;autres attributs. Consultez le [format des données utilisateur](/fr/deploy/auofntication-setup#user-data-format) pour plus de détails.
  </Step>
