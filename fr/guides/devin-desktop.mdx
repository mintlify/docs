...
Créez des règles d'espace de travail dans le répertoire `.devin/rules` de votre référentiel de documentation. Les règles dans `.windsurf/rules` restent prises en charge pour la rétrocompatibilité. Consultez [Memories & Rules](https://docs.devin.ai/desktop/cascade/memories) dans la documentation Devin Desktop pour plus d'informations.
