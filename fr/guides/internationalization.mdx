...
description: "Configurez une documentation multilingue avec un routage par langue, un sélecteur de langue et du contenu traduit pour atteindre un public mondial."
