...
<Accordion title="Mintlify prend-il en charge les langues de droite à gauche comme l’arabe ou l’hébreu ?">
Oui. L’arabe (`ar`) et l’hébreu (`he`) figurent dans la liste des codes de langue pris en charge. Mintlify gère automatiquement la mise en page RTL lorsque ces codes de langue sont configurés. Testez votre documentation en RTL pour vérifier que la navigation, les tableaux et les code blocks s’affichent correctement.
</Accordion>
</AccordionGroup>