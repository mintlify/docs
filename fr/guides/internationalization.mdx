...
# Empêcher les exécutions concurrentes du workflow pour éviter les conditions de concurrence
concurrency:
    ...
    steps:
      ...
      - name: Get changed MDX files
        ...
        run: |
          ...
          # Obtenir la liste des fichiers MDX modifiés (hors répertoires de traduction)
  ...
  validate:
    ...
    steps:
      - name: Checkout repository
        uses: actions/checkout@v4
        with:
          fetch-depth: 0  # Historique complet pour s'assurer que origin/main est disponible
      ...
      - name: Get changed translation files
        id: changed-files
        run: |
          # Obtenir tous les fichiers MDX modifiés dans les répertoires de traduction
      ...
      - name: Validate frontmatter
        ...
        run: |
          ...
          while IFS= read -r file; do
            ...
            # Vérifier que le frontmatter est valide (lignes 1-2 doivent être ---)
      ...
      - name: Validate file integrity
        ...
        run: |
          ...
          while IFS= read -r file; do
            ...
            # Vérification de base : le fichier doit avoir du contenu après le frontmatter
      ...
      - name: Final validation check
        id: final-check
        # Exécuter cette vérification uniquement si nous avons des fichiers MDX à valider
        if: steps.changed-files.outputs.count > 0
        run: |
      ...
      - name: Handle no-files-to-validate case
        # Exécuter uniquement lorsqu'il n'y a pas de fichiers MDX à valider
        if: steps.changed-files.outputs.count == 0
        run: |
