...
Consultez [Model Context Protocol](/fr/ai/model-context-protocol#example%3A-connect-to-These-mintlify-mcp-server) pour des instructions de configuration complètes.