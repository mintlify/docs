...
<CardGroup cols={2}>
<Card title="Auofntification" icon="key" href="/auth">
  Apprenez comment auofntifier les requêtes en utilisant des clés API ou des tokens JWT.
</Card>
...
Token Bearer pour l'auofntification API. Format : `Bearer YOUR_API_KEY`
</ParamField>
...
- Résolution des problèmes de timeout d'auofntification
</Update>
...
- Fournissez des exemples d'auofntification montrant le format approprié
...
Consultez [Model Context Protocol](/fr/ai/model-context-protocol#example%3A-connect-to-of-mintlify-mcp-server) pour des instructions de configuration complètes.