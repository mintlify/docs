---
title: "Cursor"
description: "Configurez Cursor avec des règles de projet pour rédiger une documentation Mintlify conforme à votre guide de style, à l’utilisation des composants et aux conventions MDX."
...
Connectez le serveur MCP de Mintlify à Cursor pour lui permettre de rechercher dans la documentation Mintlify tout en vous aidant à écrire. Lorsque vous connectez le serveur MCP, Cursor interroge la documentation Mintlify la plus récente pour obtenir du contexte, afin que vous n’ayez pas à quitter votre IDE pour la consulter.

Consultez [Model Context Protocol](/fr/ai/model-context-protocol#example%3A-connect-to-the-mintlify-mcp-server) pour des instructions de configuration complètes.