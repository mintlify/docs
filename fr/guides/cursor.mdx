---
title: "Cursor"
description: "Configurez Cursor comme votre assistant de rédaction"
icon: "box"
---
...
Les règles Cursor fournissent un context persistant sur votre documentation, garantissant des suggestions plus cohérentes qui respectent vos standards et votre style.

* **Les règles de projet** sont stockées dans votre référentiel de documentation et partagées avec votre équipe.
...
Créez des fichiers de règles dans le répertoire `.cursor/rules` de votre référentiel de documentation. Consultez la [documentation Cursor Rules](https://docs.cursor.com/context/rules) pour des instructions complètes de configuration.
...
* **Normes de rédaction** : mettez à jour les consignes linguistiques pour correspondre à votre guide de style.
* **Modèles de composants** : ajoutez des composants spécifiques au projet ou modifiez des exemples existants.
...
Ajoutez cette règle, avec les modifications nécessaires, en tant que fichier `.mdc` dans le répertoire `.cursor/rules` de votre dépôt de documentation.
...
- Commencez par les informations les plus importantes (structure pyramide inversée)
...
<Warning>
Informations critiques sur les problèmes potentiels, les changements cassants ou les actions destructrices
</Warning>
...
### Cartes et colonnes pour mettre l'accent sur les informations
...
- Ajout de la fonctionnalité d'importation en masse d'utilisateurs
