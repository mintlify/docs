...
sidebarTitle: "Cursor"
description: "Configurez Cursor avec des règles de projet pour rédiger une documentation Mintlify conforme à votre guide de style et aux conventions MDX."
...
* **Règles de projet** — elles se trouvent dans votre référentiel de documentation, donc toute votre équipe les partage.
