...
description: "Créez un frontend de documentation headless personnalisé avec Astro tout en utilisant Mintlify pour la gestion de contenu et les fonctionnalités d'IA."
