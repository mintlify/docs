...
Cette approche headless est utile lorsque vous avez besoin d'un contrôle total sur le design, la mise en page ou le comportement de votre documentation pour l'aligner sur un système de conception existant ou intégrer la documentation dans un site plus vaste.
