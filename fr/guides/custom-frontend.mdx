...
description: "Créez un frontend headless personnalisé pour votre documentation avec Astro, tout en utilisant Mintlify pour la gestion de contenu et les fonctionnalités d'IA."
...
Cette approche headless est utile lorsque vous avez besoin d&#39;un contrôle total sur le design, la mise en page ou le comportement de votre documentation. Par exemple, pour aligner celle-ci sur un système de conception existant ou intégrer la documentation dans un site plus vaste.

L&#39;intégration `@mintlify/astro` lit votre configuration `docs.json` et votre contenu MDX au moment de la compilation, puis transforme le tout dans un format qu&#39;Astro peut afficher. Utilisez vos propres mises en page, composants et styles par-dessus.

Avec un frontend headless personnalisé, vous pouvez toujours utiliser les composants Mintlify sans les importer et vous conservez l&#39;infrastructure de publication, de recherche et d&#39;IA.
