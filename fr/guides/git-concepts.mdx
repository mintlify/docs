...
description: "Apprenez les bases du contrôle de version Git pour les workflows docs-as-code : dépôts, branches, commits et collaboration via pull requests."
...
<AccordionGroup>
  <Accordion title="Branche" id="branch">
  ...
  <Accordion title="Clone" id="clone">
  ...
  <Accordion title="Commit" id="commit">
  ...
  <Accordion title="Conflit" id="conflict">
  ...
  <Accordion title="Branche de déploiement" id="deployment-branch">
  ...
  <Accordion title="Fusion" id="merge">
  ...
  <Accordion title="Remote" id="remote">
  ...
  <Accordion title="Référentiel" id="repository">
...
L’éditeur web se connecte à votre référentiel Git via la [GitHub App](/fr/deploy/github), l’[intégration GitLab](/fr/deploy/gitlab) ou l’[intégration Bitbucket Cloud](/fr/deploy/bitbucket) et automatise les opérations Git courantes.
...
* **Apportez des modifications** : l’éditeur suit vos modifications et les transforme en un commit lorsque vous enregistrez votre travail.
...
Créez une branche, apportez-y et enregistrez-y des modifications, puis fusionnez la branche dans votre branche de déploiement via une pull request. Pour des instructions pas à pas dans l’éditeur web et en ligne de commande, consultez [Travailler avec les branches](/fr/guides/branches). Pour savoir comment les actions de publication disponibles évoluent en fonction de vos protections de branche, consultez [Publier vos modifications](/fr/editor/publish).
