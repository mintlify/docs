...
* **Authentification intégrée** : Contrôlez l&#39;accès avec [SSO ou OAuth](/fr/deploy/authentication-setup), et utilisez la [personnalisation](/fr/deploy/personalization-setup) pour afficher un contenu différent à différents groupes.
...
L’Assistant est automatiquement activé pour les formules Pro et Custom. Il permet à votre équipe de poser des questions et d’obtenir des réponses accompagnées de sources citées issues de votre base de connaissances.
