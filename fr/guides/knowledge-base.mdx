...
Si votre équipe utilise Slack, vous pouvez ajouter l&#39;[application Slack](/fr/ai/slack-app) à votre espace de travail. Cela permet à votre équipe d&#39;interroger votre base de connaissances sans quitter Slack.
