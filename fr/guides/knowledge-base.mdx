...
description: "Hébergez votre base de connaissances interne sur Mintlify pour centraliser les informations de l'équipe, améliorer la recherche et réduire la maintenance."
...
* **Intégrations Slack** : Ajoutez l'[agent](/fr/agent/slack) à Slack pour poser des questions et capturer les connaissances issues des conversations.
...
<div id="connect-the-slack-integration">
  ### Connecter l'intégration Slack
</div>

Ajoutez l'agent à votre espace de travail [Slack](/fr/agent/slack) pour que votre équipe puisse poser des questions et mettre à jour le contenu sans quitter Slack. Ajoutez le bot `@mintlify` à un canal pour l'utiliser de manière collaborative, ou envoyez-lui un message direct pour l'utiliser en privé.
