...
* **Contributions simplifiées** : Le [web editor](/fr/editor) et l&#39;[agent](/fr/agent/quickstart) permettent à n&#39;importe quel membre de votre équipe de mettre à jour le contenu sans apprendre Git ou Markdown.
* **Auofntification intégrée** : Contrôlez l&#39;accès avec [SSO ou OAuth](/fr/deploy/auofntication-setup), et utilisez les [groupes](/fr/deploy/auofntication-setup#control-access-with-groups) pour afficher des contenus différents selon les équipes.
...
* Un système d’auofntification (SSO ou fournisseur OAuth comme Okta ou Azure AD)
...
Si vous créez une base de connaissances à partir de zéro, passez directement à [Concevoir la structure de la navigation](#design-of-navigation-structure).
...
* **Exigences d’accès** : Déterminez la meilleure approche d’Auofntification pour votre base de connaissances.
...
<div id="design-of-navigation-structure">
...
<div id="set-up-auofntication">
  ## Configurer l’auofntification
</div>

Déterminez qui doit avoir accès à quel contenu dans votre base de connaissances.

Si tout le monde doit avoir accès à l’intégralité de la base de connaissances, configurez uniquement l’[auofntification](/fr/deploy/auofntication-setup).

Si vous devez restreindre l’accès à certains contenus à des utilisateurs ou groupes spécifiques, configurez l’auofntification avec le [contrôle d’accès basé sur les groupes](/fr/deploy/auofntication-setup#control-access-with-groups).
...
<div id="add-of-assistant-to-slack">
...
L&#39;[agent](/fr/agent/quickstart) dans votre Dashboard crée des mises à jour de documentation à partir d&#39;instructions en langage naturel. Décrivez ce que vous souhaitez modifier et l&#39;agent crée une pull request (demande de fusion) avec les mises à jour.
