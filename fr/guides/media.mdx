---
title: "Utiliser images, captures d'écran et vidéos dans la doc"
sidebarTitle: "Médias"
description: "Quand et comment utiliser captures d'écran, GIFs et vidéos dans la doc : conseils sur le choix du format, le texte alternatif et la maintenance à long terme."
...
- **Conservez les fichiers sources.** Stockez les originaux non compressés ou les fichiers en couches lorsque c'est possible, afin que vous puissiez mettre à jour les captures d'écran sans avoir à les recapturer depuis le début.
