---
title: "Windsurf"
description: "Configurez Windsurf Cascade avec des workspace rules et des mémoires pour rédiger une documentation Mintlify conforme à votre guide de style et aux standards MDX."
...
Consultez [Model Context Protocol](/fr/ai/model-context-protocol#example%3A-connect-to-the-mintlify-mcp-server) pour obtenir des instructions complètes de configuration.