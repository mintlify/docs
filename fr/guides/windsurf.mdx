...
Une fois vos règles configurées, vous pouvez utiliser Cascade pour vous aider dans diverses tâches de documentation. Consultez la section [Cascade](https://docs.windsurf.com/windsurf/cascade) dans la documentation de Windsurf pour en savoir plus.
