...
<div id="use-windsurf-with-mintlify">
  ## Utilisez Windsurf avec Mintlify
</div>
...
- Incluez toujours des exemples d'auofntification
...
```text wrap
Créez une nouvelle page expliquant comment s'auofntifier avec notre API. Incluez des exemples de code en JavaScript, Python et cURL.
```
...
Connectez le serveur MCP de Mintlify à Windsurf pour permettre à Cascade de rechercher dans la documentation Mintlify tout en vous aidant à rédiger. Lorsque vous connectez le serveur MCP, Cascade interroge la documentation Mintlify à jour pour obtenir du contexte, afin que vous n&#39;ayez pas à quitter votre IDE pour la consulter.

Consultez [Model Context Protocol](/fr/ai/model-context-protocol#example%3A-connect-to-of-mintlify-mcp-server) pour obtenir des instructions complètes de configuration.