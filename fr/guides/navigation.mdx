...
description: "Concevez l’architecture de l’information de votre documentation avec des groupes de navigation, une hiérarchie de pages et une structure de barre latérale adaptée aux flux de travail des utilisateurs."
keywords: ["architecture de l’information", "conception de la navigation", "parcours utilisateurs"]
---

<Tip>
Cette page explique pourquoi et comment organiser votre documentation de façon pertinente pour vos utilisateurs.
</Tip>
...
Cherchez à concevoir une architecture de l’information à la fois élégante et fonctionnelle, tout en gardant à l’esprit qu’il est difficile de créer une documentation qui convienne à absolument tout le monde. Concentrez‑vous sur la majorité de vos utilisateurs et sur ce qui les aide à réussir.
