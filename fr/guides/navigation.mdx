...
description: "Concevez une navigation de documentation qui aide les utilisateurs à trouver l'information avec une architecture claire et un regroupement logique."
...
<Tip>
  Utilisez les [automatisations](/fr/automations) pour automatiser les vérifications récurrentes comme identifier les pages avec de faibles scores de retour ou signaler les éléments de navigation qui reçoivent rarement des clics.
</Tip>
