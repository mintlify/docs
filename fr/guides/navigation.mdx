...
<Tip>
  Utilisez les [workflows](/fr/workflows) pour automatiser les vérifications récurrentes comme identifier les pages avec de faibles scores de retour ou signaler les éléments de navigation qui reçoivent rarement des clics.
</Tip>
