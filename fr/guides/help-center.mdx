...
description: "Créez un centre d'aide en libre-service avec Mintlify qui aide les clients à trouver des réponses, réduit les tickets et évolue avec l'équipe."
...
* Domain pour héberger votre centre de support : un [domaine personnalisé](/fr/customize/custom-domain) ou votre URL par défaut en `.mintlify.site`
