---
title: "Claude Code"
description: "Configurez Claude Code pour vous aider à rédiger, relire et mettre à jour votre documentation"
icon: "asterisk"
---

Claude Code est un outil en ligne de commande agentique qui peut vous aider à gérer votre documentation. Il peut rédiger de nouveaux contenus, relire des pages existantes et garder la documentation à jour.
