...
Vous pouvez entraîner Claude Code à comprendre vos conventions et vos workflows de documentation en ajoutant un fichier `CLAUDE.md` à votre projet et en le peaufinant au fil du temps.
