...
sidebarTitle: "Liens"
description: "Créez des liens internes, des ancres et des liens profonds, et préservez l'intégrité avec des redirections et des vérifications de liens cassés."
...
Lorsqu'une page contient plusieurs titres qui génèrent le même ID, Mintlify ajoute `-2`, `-3`, et ainsi de suite à chaque doublon. Le compteur s'applique à toute la page, y compris aux titres imbriqués dans des composants comme les onglets. Utilisez un [ID d'ancrage personnalisé](#custom-anchor-ids) si vous souhaitez un lien stable et prévisible. Consultez [IDs d'ancrage automatiques](/fr/create/text#automatic-anchor-ids) pour les règles complètes de génération des slugs.
