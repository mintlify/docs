...
Mintlify conserve les IDs personnalisés exactement tels que vous les écrivez, donc camelCase, kebab-case et snake_case fonctionnent tous :
...
Les liens d'ancrage sont sensibles à la casse, alors respectez la casse de l'ID personnalisé lorsque vous y faites un lien. Consultez [Formater le texte](/fr/create/text#custom-heading-ids) pour plus de détails.
