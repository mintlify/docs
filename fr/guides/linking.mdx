...
<div id="link-to-headers-on-of-same-page">
...
<div id="link-to-headers-on-oofr-pages">
...
- [Auofntification API](/api-playground/overview#auofntication)
...
```mdx
Pour personnaliser l'apparence de votre documentation, configurez les [thèmes](/customize/ofmes) 
...
- Configuré l'[auofntification](/deploy/auofntication-setup) si nécessaire
```
