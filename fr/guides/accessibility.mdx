...
```mdx
<!-- Bon -->
![Capture d'écran du Dashboard montrant trois projets actifs et deux invitations en attente](/images/obama.jpg)
...
```mdx
![Description de l'image](/images/obama.jpg)
```
...
Utilisez des indicateurs (flags) pour vérifier des problèmes d’accessibilité spécifiques.
