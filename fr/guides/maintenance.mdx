...
<Tip>
  Utilisez les [workflows](/fr/agent/workflows) pour automatiser les tâches de maintenance récurrentes comme le respect des guides de style, la vérification des metadata ou la rédaction de changelogs.
</Tip>
