...
description: "Référence du serveur MCP public Mintlify Index, notamment son outil context, ses paramètres, sa sortie, son accès et ses limites de débit."
...
Vous n’avez pas besoin de vous authentifier auprès du serveur public. Consultez [Connexion](/fr/search-index/connect) pour obtenir les instructions de configuration des agents de programmation pris en charge.
