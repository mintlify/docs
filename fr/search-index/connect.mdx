...
Pour configurer manuellement un agent, suivez les étapes correspondant à votre agent. Utilisez le nom du serveur `mintlify-index` et l’URL `https://index.mintlify.com/mcp` dans chaque configuration.
...
<Tabs>
  ...
  <Tab title="VS Code" icon="code">
    Créez ou ouvrez `.vscode/mcp.json` dans votre projet et ajoutez le serveur :
  ...
  <Tab title="Codex" icon="terminal">
    Ajoutez le serveur à `~/.codex/config.toml` ou au fichier `./.codex/config.toml` du projet :
  ...
  <Tab title="OpenCode" icon="terminal">
    Ajoutez le serveur à `~/.config/opencode/opencode.json` ou au fichier `./opencode.json` du projet :
  ...
  <Tab title="Windsurf" icon="wind">
    Ajoutez le serveur à `~/.codeium/windsurf/mcp_config.json` :
  ...
  <Tab title="Zed" icon="code">
    Ajoutez le serveur à `~/.config/zed/settings.json` ou au fichier `./.zed/settings.json` du projet :
