...
Pour configurer manuellement un agent, ou vérifier les modifications effectuées par la CLI, suivez les étapes correspondant à votre agent.
...
<Tabs>
  ...
  <Tab title="VS Code" icon="code">
    Ajoutez le serveur suivant à `mcp.json` dans le dossier de votre profil utilisateur VS Code, ou à `.vscode/mcp.json` dans votre projet :
  ...
  <Tab title="Codex" icon="square-terminal">
    Ajoutez le serveur suivant à `~/.codex/config.toml`, ou à `.codex/config.toml` dans votre projet :
  ...
  <Tab title="OpenCode" icon="braces">
    Ajoutez le serveur suivant à `~/.config/opencode/opencode.json`, ou à `opencode.json` dans votre projet :
  ...
  <Tab title="Windsurf" icon="wind">
    Ajoutez le serveur suivant à `~/.codeium/windsurf/mcp_config.json`. Windsurf ne prend pas en charge la configuration MCP au niveau du projet.
  ...
  <Tab title="Zed" icon="zap">
    Ajoutez le serveur suivant à votre `settings.json` Zed, ou à `.zed/settings.json` dans votre projet :
