...
Intégrez des widgets d’assistance client à votre documentation. Ajoutez le champ `integrations` à votre fichier `docs.json` avec l’ID de l’application correspondant.
