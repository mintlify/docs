...
description: "Connectez-vous aux plateformes d’analytics pour suivre l’engagement des utilisateurs et l’usage de la documentation."
...
<Note>
  Les intégrations Analytics ne nécessitent que des clés API publiques, qui sont accessibles à toute personne consultant votre site de documentation. Vos clés API privées, qui sont associées aux clés publiques du côté des fournisseurs d’Analytics, doivent rester privées. N’incluez pas de clés API privées dans votre `docs.json`.
</Note>
