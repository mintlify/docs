...
- For the Claude model, we support the native `v1/messages` interface. Details are available here: [How to Use the Native Claude API](https://docs.aihubmix.com/en/api/Claude-Native).
