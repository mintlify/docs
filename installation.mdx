...
- `--disable-openapi`: Disable OpenAPI file generation and OpenAPI spec validation during validation
...
The CLI includes preview commands for features currently in development. Run any of these commands to signal your interest:
...
When you run a coming soon command, your interest is recorded through CLI telemetry. If telemetry is disabled, the CLI still displays the feature message but does not record a vote.
