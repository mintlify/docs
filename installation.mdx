...
description: "Plant your strawberry docs locally - preview, test changes in real-time, and cultivate your documentation site."
keywords: ["CLI", "npm", "local development", "Node.js", "strawberry"]
---
