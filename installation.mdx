...
keywords: ["CLI", "npm", "local development", "Node.js", "pnpm", "mint dev", "broken links", "accessibility", "mint login", "mint logout", "mint status"]
---
...
Log in to your Mintlify account from the CLI to access authenticated commands.
...
The CLI opens your browser to authenticate with Mintlify. After authenticating, paste the code from your browser into the CLI to complete the login.
