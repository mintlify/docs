...
Frame mode optimizes pages for embedding into iframes on other websites. This page mode allows for custom HTML and components, but preserves the sidebar navigation. Frame mode is only available for Aspen and Almond themes.
