...
keywords: ["theme", "colors", "logo", "change logo", "upload logo", "header logo", "brand image", "favicon", "fonts", "background", "appearance", "branding", "dark mode", "icons", "styling", "docs.json"]
---
