...
<ResponseField name="background" type="object">
  ...
  <Expandable title="Background">
    ...
    <ResponseField name="decoration" type='"gradient" | "grid" | "windows"'>
      Background decoration style. Options:
      - `gradient`: A subtle radial gradient using your primary color.
      - `grid`: A radial gradient with an overlaid grid pattern.
      - `windows`: A radial gradient with an overlaid geometric window pattern.
    </ResponseField>
