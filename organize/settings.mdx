...
<ResponseField name="contextual" type="object">
  ...
  <Expandable title="Contextual">
    <ResponseField name="options" type='array of "copy" | "view" | "chatgpt" | "claude" | "perplexity" | "mcp" | "cursor" | "vscode" | object' required>
      ...
      <Note>
        The contextual menu is only available on preview and production <span style={{backgroundImage: 'linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 'inherit'}}>deployments</span>.
      </Note>
    </ResponseField>
  </Expandable>
</ResponseField>
