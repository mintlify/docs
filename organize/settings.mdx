    ...
    <ResponseField name="examples" type="object">
      ...
      <Expandable title="Examples">
        <ResponseField name="languages" type="array of string">
          Example languages for the autogenerated API snippets. See [supported languages](/api-playground/overview#customize-your-playground) for the full list of available languages and aliases.
        </ResponseField>
