  ...
  <Expandable title="Errors">
    <ResponseField name="404" type="object">
      ...
      <Expandable title="404">
        ...
        <ResponseField name="disableSuggestedPages" type="boolean">
          Whether to disable suggested pages on the 404 error page. When set to `true`, the 404 page will not show recommended pages based on the URL. Defaults to `false`.
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
