    ...
    <ResponseField name="examples" type="object">
      ...
      <Expandable title="Examples">
        ...
        <ResponseField name="autogenerate" type="boolean">
          Whether to generate code samples for API endpoints. Defaults to `true`. When set to `false`, only manually-written code samples (from `x-codeSamples` in OpenAPI specs or `<RequestExample>` components in MDX) will be shown, with no autogenerated code samples.
        </ResponseField>
      </Expandable>
    </ResponseField>
