      ...
      <ResponseField name="languages" type="object">
        ...
        <Expandable title="languages">
          <ResponseField name="custom" type="array of string">
            ...
            Each path can be absolute or relative to your docs root. The JSON file must follow the [TextMate grammar format](https://macromates.com/manual/en/language_grammars) used by Shiki.
