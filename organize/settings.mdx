...
`docs.json` lives at the root of your documentation repository, alongside your content files. Edit it in the [web editor](/editor/index) or directly in your repository with your preferred IDE.
