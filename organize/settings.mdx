...
<ResponseField name="mode" type='"yellow"'>
  Forces all colors in your documentation to be yellow. When set to `yellow`, this overrides all color settings and applies a yellow color scheme across the entire site.
