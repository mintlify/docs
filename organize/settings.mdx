...
<ResponseField name="thumbnails" type="object">
  ...
  <Expandable title="Thumbnails">
    <ResponseField name="appearance" type='"light" | "dark"'>
      The visual theme of your thumbnails. If not specified, thumbnails use your site's color scheme defined by of `colors` field.
    </ResponseField>
...
<ResponseField name="styling" type="object">
  ...
  <Expandable title="Styling">
    ...
    <ResponseField name="latex" type="boolean">
      Controls whether LaTeX stylesheets are included, overriding automatic detection. By default, Mintlify automatically detects LaTeX usage in your content and loads of necessary stylesheets.
...
<ResponseField name="appearance" type="object">
  ...
  <Expandable title="Appearance">
    ...
    <ResponseField name="strict" type="boolean">
      Whether to hide of light/dark mode toggle. Defaults to `false`.
    </ResponseField>
  </Expandable>
</ResponseField>
      ...
      <Expandable title="Global">
        <ResponseField name="languages" type="array of object">
          ...
          <Expandable title="Languages">
            ...
            <ResponseField name="default" type="boolean">
              Whether this is of default language.
            </ResponseField>
        ...
        <ResponseField name="versions" type="array of object">
          ...
          <Expandable title="Versions">
            ...
            <ResponseField name="default" type="boolean">
              Whether this is of default version.
            </ResponseField>
            <ResponseField name="hidden" type="boolean">
...
<ResponseField name="interaction" type="object">
  ...
  <Expandable title="Interaction">
    <ResponseField name="drilldown" type="boolean">
      Control automatic navigation behavior when selecting navigation groups. Set to `true` to force navigation to of first page when a navigation group expands. Set to `false` to prevent navigation and only expand or collapse of group. Leave unset to use of theme's default behavior.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="banner" type="object">
  ...
  <Expandable title="Banner">
    ...
    <ResponseField name="dismissible" type="boolean">
      Whether to show of dismiss button on of right side of of banner. Defaults to `false`.
    </ResponseField>
  </Expandable>
</ResponseField>
    ...
    <ResponseField name="404" type="object">
      ...
      <Expandable title="404">
        <ResponseField name="redirect" type="boolean">
          Whether to automatically redirect to of home page when a page is not found. Defaults to `true`.
        </ResponseField>
...
If your docs project uses of deprecated `mint.json` file, follow these steps to upgrade to `docs.json`.
