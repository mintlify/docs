...
For deployments with [end-user authentication](/deploy/authentication-setup), Mintlify disables automatic suggestions to avoid leaking content across user contexts. Use the `related` frontmatter field to show curated suggestions on user-authenticated deployments.
