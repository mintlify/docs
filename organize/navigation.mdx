...
Use these common tag values to communicate the status of your documentation sections:

- `NEW`: Recently added features or documentation
- `BETA`: Features in beta testing or preview
- `UPDATED`: Recently updated content
- `DEPRECATED`: Features scheduled for removal
- `PREVIEW`: Early access features
- `ALPHA`: Experimental features in early development

Tags are case-sensitive and display exactly as you write them. Keep tags short (typically 3-10 characters) for the best visual appearance.

#### Tags with different navigation elements

Tags work consistently across all navigation elements. You can add tags to groups, tabs, anchors, dropdowns, and products.
  ...
  "navigation": {
    "anchors": [
      ...
      },
      {
        ...
        "pages": ["graphql/overview", "graphql/queries"]
      }
    ]
  }
}
...
When using nested groups, you can add tags to both parent and child groups. Each tag appears next to its respective group name.
...
- **Be consistent**: Use the same tag values across your documentation for similar statuses
- **Keep it brief**: Short tags (3-10 characters) work best visually
- **Use sparingly**: Too many tags reduce their effectiveness at drawing attention
- **Update regularly**: Remove tags like "NEW" once features are established
- **Match your workflow**: Align tag values with your product development stages
- **Consider color**: While tags inherit your theme colors, ensure they remain readable

#### Styling considerations

Tags automatically inherit styling from your documentation theme. The appearance adapts to your configured colors and works in both light and dark modes.

Tags display inline with navigation items and scale appropriately across different screen sizes. The tag styling is optimized for readability and doesn't require additional configuration.
