...
If you publish in multiple languages, you can redirect visitors from the root of your docs to the language that matches their browser's `Accept-Language` header.
...
Mintlify only redirects visits to the root of your docs. If a visitor selects a language with the language switcher, Mintlify remembers their choice and it takes precedence.
