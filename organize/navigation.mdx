...
In the `navigation` object, `languages` is an array where each entry is an object that requires a `language` field and can contain any other navigation fields, including language-specific configurations for banners, footers, and navbars.
...
Configure different footer content for each language. When set, the language-specific footer overrides the global footer configuration.
...
Configure different navbar links and primary buttons for each language. When set, the language-specific navbar overrides the global navbar configuration.
    ...
    "languages": [
      {
        ...
        "navbar": {
          "links": [
            { "label": "Community", "href": "https://mintlify.com/community" },
            { "label": "Blog", "href": "https://mintlify.com/blog" }
          ],
          "primary": {
            "type": "button",
      ...
      },
      {
        ...
        "navbar": {
          "links": [
            { "label": "Comunidad", "href": "https://mintlify.com/community" },
            { "label": "Blog", "href": "https://mintlify.com/blog" }
          ],
          "primary": {
            "type": "button",
...
Configure different banner content for each language. When set, the language-specific banner overrides the global banner configuration.
