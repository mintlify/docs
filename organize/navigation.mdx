...
Each language can also have its own [banner](/components/banner) configuration. Language-specific banners take priority over the global banner, allowing you to display localized announcements for each language.
