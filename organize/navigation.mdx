...
| [Products](#products) | You maintain documentation for multiple distinct products under one project, and each product has its own full site. | A platform with separate content for Payments, Identity, and Analytics. |
...
2. In the **Language routing** section, enable **Auto-route by language**.
