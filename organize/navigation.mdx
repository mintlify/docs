...
- `BETA`: Features in testing or early access
- `ALPHA`: Experimental features with limited availability
- `DEPRECATED`: Features scheduled for removal
- `PREVIEW`: Features available for preview or feedback
- `UPDATED`: Recently updated content
- `PRO`: Premium or paid features
...
Tags can be applied to groups within tabs, anchors, dropdowns, and products.
        ...
        "groups": [
          {
            ...
            "tag": "NEW",
            "pages": ["realtime/websockets", "realtime/sse"]
          }
        ]
      }
    ]
        ...
        "groups": [
          {
            ...
            "tag": "BETA",
            "pages": ["platform/edge/overview", "platform/edge/deploy"]
          }
        ]
      }
    ]
        ...
        "groups": [
          {
            "group": "New features",
            "tag": "NEW",
            "pages": ["v3/features/streaming", "v3/features/caching"]
          }
        ]
      }
    ]
...
**Be consistent**: Use the same tag labels throughout your documentation. Avoid mixing similar tags like "NEW" and "New" or "BETA" and "Beta".

**Keep tags short**: Tags should be concise, typically one word. Long tags can clutter the navigation and reduce readability.

**Update regularly**: Remove "NEW" tags after features are no longer new (typically after a few weeks or months). Update "BETA" tags to reflect current status.

**Use sparingly**: Too many tags reduce their effectiveness. Reserve tags for truly important status indicators.

**Consider your audience**: Choose tag labels that resonate with your users. "PRO" might work for a SaaS product, while "ENTERPRISE" might be better for B2B software.

**Document tag meanings**: If you use custom tags, explain what they mean in your documentation or changelog.
