...
The `href` field accepts external URLs, relative paths, and fragment links starting with `#`.
...
Global anchors support external URLs, relative paths to pages within your documentation, and fragment links starting with `#`.
