...
<CardGroup cols={2}>
  ...
  <Card title="Dutch (nl)" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/nl.png" className="w-6 h-6 my-0" />} horizontal />
  ...
  <Card title="Latvian (lv)" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/lv.png" className="w-6 h-6 my-0" />} horizontal />
  <Card title="Norwegian (no)" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/no.png" className="w-6 h-6 my-0" />} horizontal />
  ...
  <Card title="Swedish (sv)" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/sv.png" className="w-6 h-6 my-0" />} horizontal />
