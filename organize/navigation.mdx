...
Use consistent tag labels across your documentation to help users quickly identify content status:
...
<Note>
  Tags are case-sensitive and display exactly as you write them. Use uppercase for consistency with common conventions.
</Note>
      ...
      },
      {
        ...
        "pages": [
          "advanced/webhooks",
          {
            ...
            "tag": "BETA",
            "pages": ["advanced/websockets", "advanced/sse"]
          }
        ]
      }
    ]
...
Tags inherit your documentation's primary color scheme and automatically adapt to light and dark modes. The tag appearance is consistent across all themes and cannot be customized with CSS.

For maximum readability:
- Keep tag text short (typically 3-10 characters)
- Use all uppercase for visual consistency
- Avoid special characters or emojis in tag text
- Limit the number of tagged items to maintain visual hierarchy
