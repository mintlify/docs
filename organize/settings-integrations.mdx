...
<ResponseField name="integrations.customScripts" type="object[]">
  An array of external scripts to load on every page. Maximum of 20 scripts.
  ...
  <Expandable title="integrations.customScripts">
    ...
    <ResponseField name="strategy" type="enum">
      Controls when the script loads. One of `afterInteractive` (default) or `lazyOnload`.
    </ResponseField>
  </Expandable>
</ResponseField>
