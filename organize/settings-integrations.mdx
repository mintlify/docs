...
<ResponseField name="integrations.segment" type="object">
  ...
  <Expandable title="integrations.segment">
    ...
    <ResponseField name="cdnUrl" type="string">
      Custom CDN URL for loading the Segment script, for use with [Segment's custom domain feature](https://segment.com/docs/connections/sources/custom-domains/). Must be an HTTPS URL without query parameters or fragments.
    </ResponseField>
  </Expandable>
</ResponseField>
