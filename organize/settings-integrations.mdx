...
<ResponseField name="integrations.customScripts" type="array of objects">
  Load external scripts on your documentation site. Each script must use an HTTPS URL. Maximum 20 scripts.
  ...
  <Expandable title="integrations.customScripts item">
    ...
    <ResponseField name="strategy" type="string">
      The loading strategy for the script. One of `afterInteractive` or `lazyOnload`. Defaults to `afterInteractive`.
    </ResponseField>
  </Expandable>
</ResponseField>
