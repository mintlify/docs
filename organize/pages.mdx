...
<ResponseField name="searchable" type="boolean">
  Set to `false` to exclude the page from your documentation site's search results and the AI assistant context. The page stays indexable by external search engines, listed in your sitemap, and visible in navigation. See [Exclude a page from search](/optimize/search#exclude-a-page-from-search) for details.
</ResponseField>
