...
<ResponseField name="hideFooterPagination" type="boolean">
  Set to `true` to hide the previous/next page navigation at the bottom of the page. Use this for standalone pages where sequential navigation does not apply.
</ResponseField>
