...
<ResponseField name="relatedPages" type="string[] | false">
  A list of related page paths or URLs to display at the bottom of the page. Set to `false` to hide related topics on the page. See [Related topics](/optimize/related-topics) for details.
</ResponseField>
