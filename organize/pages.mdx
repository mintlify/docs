...
<ResponseField name="hideFooterPagination" type="boolean">
  Set to `true` to hide the previous and next page navigation at the bottom of the page. Use this for standalone pages like changelogs or landing pages where sequential navigation does not apply.
</ResponseField>
