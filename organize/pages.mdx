...
To set a specific date, use the `lastUpdatedDate` frontmatter field. This is useful when the Git commit history doesn't reflect when the content was updated. Use a date-only value or an ISO 8601 timestamp.
