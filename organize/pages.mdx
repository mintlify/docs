...
Each page is a Markdown file. You can use either `.mdx` or `.md` file types for your pages. MDX is recommended, as it combines Markdown with React components for rich, interactive documentation. Plain Markdown (`.md`) can expedite migration from other platforms, but switching to MDX enables more features.
