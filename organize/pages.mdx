...
<ResponseField name="related" type="array or boolean">
  A list of related pages to show in the **Related topics** section at the bottom of the page, or `false` to hide the section entirely. Overrides the deployment's automatic suggestions. Requires the [Related pages](/organize/related-pages) add-on to be enabled. See [Related pages](/organize/related-pages) for details.
</ResponseField>
