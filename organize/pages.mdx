...
<ResponseField name="relatedPages" type="string[] | false">
  Override the automatically generated [related pages](/optimize/related-pages) for this page. Set to `false` to hide related pages on this page entirely. Set to an array of internal paths or external URLs to manually specify related pages. You can optionally provide a custom title using the `Title: /path` syntax.
</ResponseField>
