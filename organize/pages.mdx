...
<ResponseField name="relatedPages" type="string[] | false">
  Control which [related pages](/optimize/related-pages) appear at the bottom of the page. Set to a list of page paths or external URLs to manually specify related pages, or set to `false` to disable related pages on the page.
</ResponseField>
