...
**Type:** array of object—each with: `group` (string, required), `root` (string), `directory` (`"none"` | `"accordion"` | `"card"`), `icon` (string), `iconType` (string), `expanded` (boolean), `pages` (array, required)
