...
| `integrations.customScripts` | array of object | No | Custom third-party scripts to load. Maximum 20. |
| `integrations.customScripts[].src` | string (HTTPS uri) | Yes | HTTPS URL of the script. Must not end in `.svg`, `.exe`, or `.zip`. |
