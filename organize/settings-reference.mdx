...
This page tracks the latest published `docs.json` schema. Reference it in your file with `"$schema": "https://mintlify.com/docs.json"` to get validation and autocomplete in your editor.
