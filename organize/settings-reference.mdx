...
Groups for organizing content into labeled sections. Each group can set `boost: true` to prioritize its pages in search results. See [Boost search ranking](/organize/navigation#boost-search-ranking).

**Type:** array of object

#### `navigation.pages`

Individual pages in your documentation. Page objects can set `boost: true` to prioritize the page in search results. See [Boost search ranking](/organize/navigation#boost-search-ranking).
