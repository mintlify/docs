...
| `integrations.customScripts` | array of object | No | External scripts to load on every page. |
...
| `integrations.customScripts[].src` | string (uri) | Yes | HTTPS URL of the script to load. |
