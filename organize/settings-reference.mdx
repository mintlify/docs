...
Configuration for the Markdown versions of pages served to AI agents. See [Markdown export](/ai/markdown-export).

**Type:** object

#### `markdown.schema`

Whether to include the full OpenAPI or AsyncAPI specification in the Markdown export of API reference pages. When `false`, the specification is omitted and replaced with a link to your `llms.txt` file.
