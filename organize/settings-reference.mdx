...
| `integrations.customScripts` | array of objects | No | External scripts to load. Max 20 items. Each object has `src` (required, HTTPS URL) and `strategy` (`"afterInteractive"` or `"lazyOnload"`). |
