...
### `theme` - <Badge color="green">required</Badge>
...
### `name` - <Badge color="green">required</Badge>
...
### `colors` - <Badge color="green">required</Badge>
...
### `navigation` - <Badge color="green">required</Badge>
...
#### `logo.light`
<Badge color="green">required</Badge> (when using object form)
...
#### `fonts.family`
<Badge color="green">required</Badge> (when using `fonts`)

Font family name. Google Fonts family names are loaded automatically.
...
Page eyebrow style shown above the page title.
...
<Badge color="green">required</Badge> (when using `thumbnails.fonts`)
...
#### `banner.content`
<Badge color="green">required</Badge> (when using `banner`)
...
Controls automatic navigation when a navigation group is selected. Set to `true` to navigate to the first page on expansion, `false` to only expand/collapse without navigating.
