...
| `integrations.customScripts[].src` | string (uri) | Yes | HTTPS URL of the script. |
| `integrations.customScripts[].strategy` | string | No | Load strategy: `beforeInteractive`, `afterInteractive`, or `lazyOnload`. |
