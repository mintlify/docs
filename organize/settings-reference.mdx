...
Use `"download-spec"` to add a Download option that fetches the deployment's OpenAPI spec. If multiple specs are configured, they're bundled into `api-specs.zip` in the browser.
