    ...
    <ResponseField name="tabs" type="array of object">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="searchable" type="boolean">
          When `hidden` is `true`, set `searchable: true` to keep descendant pages in search, the sitemap, `llms.txt`, and the AI assistant. See [Hidden pages](/organize/hidden-pages#keep-hidden-pages-discoverable-with-searchable).
        </ResponseField>
