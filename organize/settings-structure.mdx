    ...
    <ResponseField name="tabs" type="array of object">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="align" type='"start" | "end"'>
          Tab alignment in the navigation bar. Set to `"end"` to move the tab to the right side. Defaults to `"start"`.
        </ResponseField>
    ...
    <ResponseField name="dropdowns" type="array of object">
      ...
      <Expandable title="dropdowns">
        ...
        <ResponseField name="description" type="string">
          Description displayed below the dropdown name.
        </ResponseField>
        <ResponseField name="color" type="object">
          Custom colors for the dropdown.
    ...
    <ResponseField name="products" type="array of object">
      ...
      <Expandable title="products">
        ...
        <ResponseField name="name" type="string">
          Display name that overrides the `product` identifier in the UI.
        </ResponseField>
        <ResponseField name="description" type="string">
