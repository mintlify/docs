...
description: "Configure navbar, navigation, footer, banner, contextual menu, redirects, and other structural settings in your `docs.json` file."
  ...
  <Expandable title="navigation.global">
    <ResponseField name="tabs" type="array of object">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, path, or anchor link for the tab destination. Supports absolute URLs, relative paths starting with `/`, and hash links starting with `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="anchors" type="array of object">
      ...
      <Expandable title="anchors">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, path, or anchor link for the anchor destination. Supports absolute URLs, relative paths starting with `/`, and hash links starting with `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="dropdowns" type="array of object">
      ...
      <Expandable title="dropdowns">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, path, or anchor link for the dropdown destination. Supports absolute URLs, relative paths starting with `/`, and hash links starting with `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="languages" type="array of object">
      ...
      Language code in [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639-1) format.
        ...
        <ResponseField name="href" type="string (uri)" required>
          A valid path, external link, or anchor link to this language version of your documentation. Supports absolute URLs, relative paths starting with `/`, and hash links starting with `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="versions" type="array of object">
      ...
      <Expandable title="versions">
        ...
        <ResponseField name="href" type="string (uri)" required>
          URL, path, or anchor link to this version of your documentation. Supports absolute URLs, relative paths starting with `/`, and hash links starting with `#`.
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<ResponseField name="footer.links" type="array of object">
  Link columns displayed in the footer.
...
<ResponseField name="variables.[variableName]" type="string">
  ...
  - Variable names can contain alphanumeric characters, hyphens, and periods.
