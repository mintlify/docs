...
<ResponseField name="navbar.links" type="array of object">
  ...
  <Expandable title="navbar.links">
    ...
    <ResponseField name="href" type="string (uri)" required>
      Link destination. Accepts an absolute URL or a relative path that starts with `/`, such as `/quickstart`. For `github`, must be a GitHub repository URL. For `discord`, must be a Discord invite URL.
    </ResponseField>
    <IconsOptional />
  </Expandable>
</ResponseField>
...
<ResponseField name="navbar.primary" type="object">
  ...
  <Expandable title="navbar.primary">
    ...
    <ResponseField name="href" type="string (uri)" required>
      Button destination. Accepts an absolute URL or a relative path that starts with `/`, such as `/contact`. For `github`, must be a GitHub repository URL. For `discord`, must be a Discord invite URL.
    </ResponseField>
  </Expandable>
</ResponseField>
