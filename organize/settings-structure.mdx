...
<ResponseField name="navigation.directory" type='"none" | "accordion" | "card"'>
  Default [directory listing layout](/organize/navigation#directory-listings) for group root pages under this navigation node. Inherits recursively; any descendant can override. Defaults to `"none"`.
</ResponseField>
...
<ResponseField name="navigation.groups" type="array of object">
  ...
  <Expandable title="navigation.groups">
    ...
    <ResponseField name="root" type="string">
      Path to the group's [root page](/organize/navigation#root-page). Clicking the group title navigates to this page.
    </ResponseField>
    <ResponseField name="icon" type="string">
      Icon displayed next to the group name.
    </ResponseField>
    <ResponseField name="tag" type="string">
      Badge label displayed next to the group name.
    </ResponseField>
    <ResponseField name="expanded" type="boolean">
      Whether a nested group is expanded by default.
    </ResponseField>
    <ResponseField name="directory" type='"none" | "accordion" | "card"'>
      [Directory listing layout](/organize/navigation#directory-listings) for the group's root page. Inherits from the parent navigation node if not set.
    </ResponseField>
  </Expandable>
</ResponseField>
