  ...
  <Expandable title="navigation.global">
    ...
    <ResponseField name="languages" type="array of object">
      ...
      <Expandable title="languages">
        <ResponseField name="language" type='"ar" | "ca" | "cn" | "cs" | "de" | "en" | "es" | "fr" | "fr-CA" | "fr-ca" | "he" | "hi" | "hu" | "id" | "it" | "ja" | "ja-jp" | "jp" | "ko" | "lv" | "nl" | "no" | "pl" | "pt" | "pt-BR" | "ro" | "ru" | "sv" | "tr" | "uk" | "uz" | "vi" | "zh" | "zh-Hans" | "zh-Hant"' required>
