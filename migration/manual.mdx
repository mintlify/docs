...
description: "Manually migrate documentation from any platform to Mintlify: convert pages, build navigation and API references, and move assets and redirects."
