...
description: "Convert documentation from any source platform to Mintlify pages, navigation, components, API references, assets, and redirects with a manual migration."
