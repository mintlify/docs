...
description: "Manually convert documentation from any source platform to Mintlify, including pages, navigation, components, API references, assets, and redirects."
