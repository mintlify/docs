...
description: "Migrate a Fern site from Git, converting MDX content, docs.yml navigation, products, versions, assets, API references, and components to Mintlify."
