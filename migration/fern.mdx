...
Run the existing Fern build before changing the source. Record any environment variables, remote specifications, generated files, or private packages that it requires.
...
| `folder` | Explicit group or generated navigation from the folder |
...
| `hidden: true` | Page omitted from navigation and search, if it should remain reachable |
