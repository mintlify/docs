...
The `-p puppeteer` flag installs [Puppeteer](https://pptr.dev), which the scraper uses to render the site in a browser. Without Puppeteer, the scraper fetches pages without a browser and the generated navigation may be incomplete.
