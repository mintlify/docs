---
title: "Introduction"
description: "Welcome to Strawberry Docs - Sweet, fresh documentation that's AI-native, beautiful out-of-the-box, and built for developers."
mode: "frame"
keywords: ["overview", "platform", "getting started", "features", "strawberry"]
---
...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Sweet, fresh documentation that's ripe for the picking. AI-native, beautiful out-of-the-box, and built for developers and teams who appreciate the finer things.
    </div>
