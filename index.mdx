...
export const GetStartedCard = ({ href, title, description, children }) => (
  <a
    href={href}
  ...
  >
    <div className="pointer-events-none absolute inset-0 z-0 opacity-0 transition-opacity duration-300 ease-out motion-reduce:transition-none group-hover:opacity-100 group-focus-visible:opacity-100">
      <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-violet-400/70 from-0% via-sky-600/90 via-[73%] to-green-500/95 to-100% dark:from-indigo-950 dark:from-0% dark:via-sky-950 dark:via-[73%] dark:to-green-800 dark:to-100%" />
      <div
        aria-hidden="true"
