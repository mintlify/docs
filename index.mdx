...
description: "Mintlify is an AI-native documentation platform with beautiful defaults, interactive API playgrounds, smart search, and built-in analytics for developer docs."
mode: "frame"
