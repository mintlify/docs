...
export const GetStartedCard = ({ href, title, description, tone = "purple", children }) => (
  <a
    href={href}
    className="group relative flex flex-col overflow-hidden rounded-2xl bg-[#fafaf9] dark:bg-zinc-800/60 no-underline transition-transform motion-reduce:transition-none hover:scale-[1.02] motion-reduce:hover:scale-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-400 dark:focus-visible:outline-zinc-500"
  >
    <div className="pointer-events-none absolute inset-0 z-0 opacity-0 transition-opacity duration-300 ease-out motion-reduce:transition-none group-hover:opacity-100 group-focus-visible:opacity-100">
      {/* Solid hue layers: full class strings per tone so Tailwind JIT emits the utilities (dynamic class strings are often purged). */}
      {tone === "blue" ? (
    ...
    <div className="relative z-10 flex min-h-[272px] flex-col justify-between p-4">
      <div className="size-8 text-[#0c0a09] dark:text-zinc-300 transition-[color,filter] duration-300 ease-out group-hover:text-white group-hover:drop-shadow-[0_1px_2px_rgba(0,0,0,0.35)] group-focus-visible:text-white group-focus-visible:drop-shadow-[0_1px_2px_rgba(0,0,0,0.35)]">
        {children}
      </div>
      <div className="flex flex-col gap-[4px]">
        <p className="font-medium text-base leading-6 tracking-[-0.2px] text-[#0c0a09] dark:text-zinc-50 transition-[color,text-shadow] duration-300 ease-out group-hover:text-white group-hover:[text-shadow:0_1px_2px_rgba(0,0,0,0.35)] group-focus-visible:text-white group-focus-visible:[text-shadow:0_1px_2px_rgba(0,0,0,0.35)]">
          {title}
        </p>
        <p className="text-sm leading-5 tracking-[-0.1px] text-[#78716c] dark:text-zinc-400 transition-[color,text-shadow] duration-300 ease-out group-hover:text-white/95 group-hover:[text-shadow:0_1px_2px_rgba(0,0,0,0.35)] group-focus-visible:text-white/95 group-focus-visible:[text-shadow:0_1px_2px_rgba(0,0,0,0.35)]">
          {description}
        </p>
      </div>
    </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid sm:grid-cols-3 gap-5">
          <GetStartedCard
            ...
            tone="purple"
            title="Quickstart"
            description="Deploy your first documentation site with our step-by-step guide."
          >
          ...
          <GetStartedCard
            ...
            description="Install the CLI to preview and develop your content locally."
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="w-full h-full">
          ...
          <GetStartedCard
            ...
            tone="green"
            title="Web editor"
            description="Write, edit, and publish content in your browser."
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="w-full h-full">
              <path d="M12 20h9"/>
