...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-12 lg:py-32 lg:pb-16 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      AI-native documentation platform for developers
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Quickstart" description="Get your docs live in under 5 minutes" href="/quickstart" />
      ...
      <HeroCard
        filename="editor"
        title="Web editor"
        description="Edit content directly in your browser"
        href="/editor/index"
      />
