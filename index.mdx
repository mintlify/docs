...
export const HeroCard = ({ filename, title, description, href }) => (
  <a className="group cursor-pointer pb-6" href={href}>
    <img
    ...
    />
    <h3 className="mt-4 text-gray-900 dark:text-zinc-50 font-medium">{title}</h3>
...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-12 lg:py-32 lg:pb-16 max-w-3xl mx-auto">
    <h1 className="block text-4xl font-medium text-center text-gray-900 dark:text-zinc-50 tracking-tight">
      Documentation
    </h1>

    <div className="max-w-xl mx-auto px-4 mt-3 text-lg text-center text-gray-500 dark:text-zinc-500">
      AI-native documentation built for developers.
    </div>

    <div className="px-6 lg:px-0 mt-10 lg:mt-16 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Quickstart" description="Deploy your docs in minutes" href="/quickstart" />
      <HeroCard filename="cli" title="CLI installation" description="Preview and develop locally" href="/installation" />
      <HeroCard filename="editor" title="Web editor" description="Edit content in your browser" href="/editor/index" />
      <HeroCard filename="components" title="Components" description="Build interactive documentation" href="/components/accordions" />
    </div>
  </div>
</div>
