...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Meet the next generation of documentation. Mintlify is an AI-native documentation platform that looks beautiful out-of-the-box, requires minimal configuration, and is purpose-built for developers and teams who want to create world-class documentation experiences.
    </div>
