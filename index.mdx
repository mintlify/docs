...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Learn how to get started using the knowledge base. Meet the next generation of documentation. AI-native, beautiful out-of-the-box, and built for developers and teams.
    </div>

    <div className="max-w-xl mx-auto px-4 mt-2 text-sm text-center text-gray-400 dark:text-zinc-600">
      Maintained by Ryan Nguyen
    </div>
