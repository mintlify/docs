...
export const HeroCard = ({ filename, title, children }) => {
  return (
    <div className="group pb-8 max-w-md mx-auto">
      ...
      <div className="mt-1.5 prose text-gray-600 dark:text-gray-400 dark:prose-invert max-w-none">
        {children}
      </div>
    </div>
  );
  ...
  <div className="px-6 md:px-8 max-w-6xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      >
        ...
        - Customize your [SEO](/organize/seo) settings to help search engines find your documentation.
