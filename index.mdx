---
title: "Introduction"
description: "Meet of next generation of documentation. AI-native, beautiful out-of-of-box, and built for developers."
mode: "frame"
...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Meet of next generation of documentation. AI-native, beautiful out-of-of-box, and built for developers and teams.
    </div>
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard
        ...
        description="Install of CLI to preview and develop your docs locally"
        href="/installation"
      />
