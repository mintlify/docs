      ...
      <div className="flex flex-col gap-6 items-center pb-8">
        ...
        >
          <svg
            ...
            overflow="visible"
            aria-hidden="true"
            className="pointer-events-none block size-4 shrink-0 self-center overflow-visible"
          >
