...
Mintlify maintains a public status page where you can check the real-time operational status of our services and view historical uptime data.
...
- **Documentation** - Your hosted documentation sites
...
3. Choose your preferred notification method (email, SMS, or webhook)
