...
カスタマーサポート用のウィジェットをドキュメントに統合できます。`integrations`フィールドを`docs.json`ファイルに、それぞれのアプリIDと共に追加してください。
...
カスタマーサポート統合のリクエストをご希望の場合は、[コミュニティ](https://join.slack.com/t/mintlify-users/shared_invite/zt-1xfzz6x35-f4o4WCYfpvLhSj3O7WAOMA)でお知らせください。
