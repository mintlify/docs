...
description: "Create a Mintlify automation that runs on a schedule, repository push, or integration event, using context repositories and an agent prompt to customize it."
