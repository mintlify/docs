...
<Tip>
  You can also ask the [agent in Slack](/agent/slack#manage-automations) to create an automation for you by describing the trigger and instructions in natural language.
</Tip>
