...
keywords: ["integrations", "Slack agent", "Notion", "Linear", "Jira", "LaunchDarkly", "Confluence", "Salesforce", "Salesforce Service Cloud", "PostHog", "Intercom", "Google Drive", "OneDrive", "Gmail", "Outlook", "HubSpot", "Plain", "Pylon", "automation trigger", "context"]
---
...
Pylon is a shared, read-only integration for customer support. Use it to search support tickets and retrieve issue messages, account details, contact details, or user details. Connect Pylon from the [Integrations](https://app.mintlify.com/settings/organization/integrations) page. Then use it with the Slack agent or select it in an automation's **Tools** setting.
