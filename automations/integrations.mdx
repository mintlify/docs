...
<Info>
  Automations are available on plans that include AI Writer or AI Chat. Using integrations as automation tools or event triggers requires the Custom Integrations entitlement, currently included with Enterprise.
</Info>
