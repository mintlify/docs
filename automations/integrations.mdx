...
PostHog, Salesforce Service Cloud, and LaunchDarkly are shared integrations. Connect any of them from the [Integrations](https://app.mintlify.com/settings/organization/integrations) page, or select it in an automation's **Tools** field and complete the authorization flow.
