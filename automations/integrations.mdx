...
<Note>
  The [Mintlify Slack app](/agent/slack) is separate from the third-party integrations on this page. Installing the Slack app adds the agent to your workspace and gives it read access to Slack content. You do not connect Slack from the **Integrations** settings page or select it in an automation's **Tools** field. After you install the Slack app, you can select Slack as a custom automation trigger and the [editor agent](/editor/agent#read-your-slack-workspace) can read your workspace for context.
</Note>
