...
PostHog and Salesforce Service Cloud are shared integrations. Connect either one from the [Integrations](https://app.mintlify.com/settings/organization/integrations) page, or select it in an automation's **Tools** field and complete the authorization flow.
