...
Both integrations are shared. To configure either one, connect it from the [Integrations](https://app.mintlify.com/settings/organization/integrations) page. You can also select it in an automation's **Tools** field and complete the authorization flow. After connecting, the integration is available to the Slack agent and supported automations.
