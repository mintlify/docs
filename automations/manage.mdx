...
{/* TODO(ethan): add a screenshot of the redesigned configure page (light + dark) showing the Trigger, Scope, and Advanced options sections. Source: Slack thread from Sam Ding, #C0B6K3CR3N2, 2026-09-17. Suggested path: images/workflows/automation-configure-light.png / -dark.png */}
