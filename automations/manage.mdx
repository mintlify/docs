...
You can also select **View runs** on an automation's card to open the run history filtered to that automation. A red dot on the button indicates that the automation has runs awaiting review.
