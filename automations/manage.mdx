...
2. Select the toggle beside an automation to enable it.
    <Frame>
...
4. Select **Turn on automation**.

To change settings for an active automation, select the <Icon icon="settings" /> settings button beside it. Use the toggle in the modal header to enable or disable the automation without leaving the settings view.
...
2. Select **Turn on Slack notifications** on the [Automations](https://app.mintlify.com/products/automations) page of your dashboard.
    <Frame>
...
1. Open the [Automations](https://app.mintlify.com/products/automations) page in your dashboard.
2. Select the toggle beside an automation to disable it.
...
1. Open the [Automations](https://app.mintlify.com/products/automations) page in your dashboard.
2. Select the <Icon icon="play" /> run button beside the automation you want to start.
...
1. Open the [Automation Runs](https://app.mintlify.com/products/automations) page in your dashboard.
...
Select an individual run to see its prompt, the files it read or changed, and any pull request it opened.
...
1. Open the [Automations](https://app.mintlify.com/products/automations) page in your dashboard.
2. Select **View changes** beside the workflow run you want to continue working on in the editor.

The editor opens to the automation's branch with the agent panel already open. The agent panel shows each page the automation changed. Select any page to view changes made by the automation.
