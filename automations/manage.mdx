...
Choose the mode in the **After automation runs** section of the automation's configure page. Select **Update and merge changes** to merge changes automatically. Select **Modify and wait for review** to require a review before changes go live.
