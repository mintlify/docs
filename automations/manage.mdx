...
To receive an email when an automation run succeeds or fails, turn on automation run emails from the [Notifications](/dashboard/notifications) page of your dashboard. If a run fails, Mintlify pauses further failure emails for that automation until a run succeeds again.
