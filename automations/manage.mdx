...
The editor opens to the automation's branch with the agent panel already open. The agent panel shows each page the automation changed. Click any page to view the automation's changes.
