...
4. Select a run scope, then click **Run now** to confirm.

Each manual run covers one of three scopes:

- **Since a date**: Covers content changed between the date you pick and now. Defaults to the automation's last run.
- **Everything**: Runs on your entire site. This typically takes longer and uses significantly more credits than a targeted run.
