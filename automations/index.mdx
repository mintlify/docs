...
- **Slack channel message**: Runs when someone posts a new top-level message in a selected Slack channel. Available for custom automations. Requires the [Mintlify Slack app](/agent/slack) installed in your workspace.
