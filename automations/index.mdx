...
description: "Automate content maintenance with Mintlify automations. Run the agent on a schedule or in response to pushes to a repository or events in connected integrations."
keywords: ["automation", "automate", "cron", "agent", "automations"]
boost: 5
---

<Info>
  Automations require a [Pro or Enterprise plan](https://mintlify.com/pricing?ref=automations), a project connected to [GitHub](/deploy/github) or GitLab, and an admin role to configure them.
</Info>
