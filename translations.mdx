...
<AccordionGroup>
  ...
  Are you an AI backend engineer passionate about improving multilingual documentation? We're hiring talented engineers to work on the future of AI translations and documentation tools.

  <Card title="Careers at Mintlify" icon="briefcase" href="http://www.mintlify.com/careers">
    Join us in building the next generation of AI-powered documentation tools
  </Card>
</AccordionGroup>