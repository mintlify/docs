...
Use `filter` to restrict what the assistant retrieves when your organize your content by language or [versions](/organize/navigation#versions). Omit a field to search across every value for it.
