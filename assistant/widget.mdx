...
1. Navigate to your deployment's [Widget](https://app.mintlify.com/settings/project/widget) page.
2. Enable the widget.
...
<Info>
  Replace `YOUR_WIDGET_ID` in the generated code with the widget ID from the [Widget](https://app.mintlify.com/settings/project/widget) page of your dashboard.
</Info>
