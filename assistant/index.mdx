...
<Info>
  The assistant is available on the [Pro plan and above](https://mintlify.com/pricing?ref=assistant). Every Pro plan includes 10,000 credits per month shared across the assistant, agent, and automations. See [Manage billing](/assistant/configure#manage-billing) for more information about credit tiers and options.
</Info>
