...
<Card title="Configure the assistant" icon="settings" horizontal href="/assistant/configure">
  Enable the assistant, set a deflection email, restrict search domains, and manage billing.
</Card>

<Card title="Embed the widget" icon="code" horizontal href="/assistant/widget">
  Add the assistant widget to a site outside your Mintlify docs.
</Card>
