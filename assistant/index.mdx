...
<Info>
  The assistant is enabled by default. Hobby organizations receive 5,000 trial credits shared across the assistant, agents, and workflows. [Purchase the credit bundle](/credits#credit-bundle) to continue after the trial.
</Info>
