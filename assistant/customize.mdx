...
Keep instructions concise and focused. Because `Assistant.md` is included in every response, long or unfocused content can crowd out user context and dilute answers. For topic-specific guidance that should only load when relevant, use [skills](/assistant/skills) instead.
