...
description: "Give the AI assistant custom instructions using an Assistant.md configuration file to control its tone, persona, focus areas, and response behavior."
