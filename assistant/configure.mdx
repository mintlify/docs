...
Your organization shares credits across projects. By default, Mintlify disables overages. You can configure different overage limits for each project. If you disable overages for a project, the assistant becomes unavailable if you spend your organization's shared credit balance. The assistant remains unavailable until your credit balance resets.
