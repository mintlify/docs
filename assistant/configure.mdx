...
If you prefer to route users to your existing support channels instead, disable **Show contact form** in the Response Handling section. When the contact form is disabled, the assistant directs users to your support email address in plain text instead of showing the in-chat form. This setting is on by default.
