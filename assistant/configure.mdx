...
description: "Enable or disable the AI assistant, configure response handling, add starter questions, set up bot protection, and manage billing from the dashboard."
