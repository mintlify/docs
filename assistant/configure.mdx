...
When you enable deflection and the assistant detects a matching question, an in-chat contact form appears with the user's message ready to send to the appropriate team. If the user is signed in, the form pre-fills their email. Deflection turns on as soon as you save at least one address.
