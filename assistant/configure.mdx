...
Help your users begin conversations with the assistant by adding starter questions. Starter questions appear in the assistant chat panel as one-click prompts.

The assistant can generate page-specific questions based on the page a user is viewing, or you can add persistent questions that are available across all pages.

- **Contextual questions**: Enable contextual starter questions to have the assistant automatically suggest questions tailored to the page a user is viewing.
- **Persistent questions**: Add up to three questions that appear on every page. Click **Ask Assistant** to get recommended questions based on your documentation, or write your own.

Persistent and contextual questions can be enabled together. When both are enabled, the assistant prioritizes contextual questions on pages where they are available.
