...
On Enterprise plans, you can supply your own LLM provider API key and choose the model that answers assistant messages. Usage is metered at a reduced credit rate. See [Bring your own model](/ai/bring-your-own-model).
