...
- **Contextual starter questions**: The assistant generates suggestions from the content of the page a user is viewing. No manual input is required.
- **Persistent starter questions**: You add up to three questions that appear on every page. Click **Ask Assistant** for recommended questions based on your documentation, then edit them to match your voice.
