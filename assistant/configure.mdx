...
<Note>
  If your organization is on a custom credit plan or has unlimited credits, the **Spending Controls** section displays your plan as `Custom — N credits` or `Unlimited credits` and the tier dropdown is disabled. Contact your account manager to change your plan.
</Note>
