...
When you enable deflection and the assistant detects a matching question, an in-chat contact form appears with the user's message ready to send to the appropriate team. If the user has signed in, the form pre-fills their email. Deflection turns on as soon as you save at least one address.
...
Overages are off by default. With overages disabled, the assistant is unavailable once you reach your credit allowance and remains unavailable until your allowance resets.
