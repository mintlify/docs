...
Credit packages determine your monthly message allowance and pricing.

View and change your current package on the [Usage](https://dashboard.mintlify.com/settings/organization/usage) page of your dashboard.
