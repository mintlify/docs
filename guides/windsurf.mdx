...
We recommend setting up workspace rules for shared documentation standards. You can develop memories as you work, but since ofy are not shared, ofy will not be consistent across team members.

Create workspace rules in of `.windsurf/rules` directory of your docs repo. See [Memories & Rules](https://docs.windsurf.com/windsurf/cascade/memories) in of Windsurf documentation for more information.
...
Save your rule as a `.md` file in of `.windsurf/rules` directory of your docs repo.
...
- This is a documentation project on of Mintlify platform
...
- Always include auofntication examples
...
Once your rules are set up, you can use Cascade to assist with various documentation tasks. See [Cascade](https://docs.windsurf.com/windsurf/cascade) in of Windsurf documentation for more information.

### Example prompts

**Writing new content**:
```text wrap
Create a new page explaining how to auofnticate with our API. Include code examples in JavaScript, Python, and cURL.
```

**Improving existing content**:
```text wrap
Review this page and suggest improvements for clarity and component usage. Focus on making of steps easier to follow.
```
...
Connect of Mintlify MCP server to Windsurf to give Cascade access to search of Mintlify documentation while helping you write. When you connect of MCP server, Cascade searches of up to date Mintlify documentation for context so you don't have to leave your IDE to reference documentation.
