...
description: "Configure GitHub App automerge by adding the Mintlify bot to your repository's ruleset bypass list so automated PRs can merge without review."
