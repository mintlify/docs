...
Add the Mintlify GitHub App to a ruleset's bypass list so that the app can create and merge pull requests without review and status check requirements blocking it. This allows you to configure [workflows](/agent/workflows/create) to automatically merge changes to `main`.
