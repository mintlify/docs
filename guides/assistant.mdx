...
Configure usage alerts to receive email notifications when your assistant spending approaches your spend limit. This helps you monitor usage and avoid unexpected overages.

To set up usage alerts:

1. Navigate to the **Billing** tab in your [Assistant Configurations](https://dashboard.mintlify.com/mintlify/mintlify/products/assistant/settings/billing).
2. Toggle on **Usage Alerts**.
3. Use the slider to set the percentage threshold (e.g., 80%) at which you want to receive an alert.
4. The system automatically saves your alert settings when you finish adjusting the slider.

When your spending reaches the configured percentage of your spend limit, you'll receive an email notification. This gives you time to adjust your spend limit or monitor usage before reaching your maximum budget.
