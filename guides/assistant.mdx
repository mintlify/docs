...
<Columns cols={2}>
  ...
  * Break up long blocks of text into shorter paragraphs.
  ...
  >
    <ul>
      <li>Define specific terms and acronyms when first introduced.</li>
      <li>Provide sufficient conceptual content about features and procedures.</li>
      <li>Include examples and use cases.</li>
      <li>Cross-reference related topics.</li>
      <li>
...
<Columns cols={2}>
  ...
  />
  <Card title="Gemini 2.5 Pro (Preview)"
    horizontal
    icon={
      <svg
        xmlns="http://www.w3.org/2000/svg"
