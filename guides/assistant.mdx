...
The assistant is enabled by default for Pro and Custom plans. You can manage the assistant from your [dashboard](https://dashboard.mintlify.com/products/assistant/settings), including enabling or disabling it, configuring response handling, and setting spending limits.

### Enabling and disabling

From the [Assistant Configurations](https://dashboard.mintlify.com/products/assistant/settings) page in your dashboard, select the toggle to enable or disable the assistant.

<Frame>
  <img src="/images/assistant/assistant-status-light.png" alt="Assistant Status toggle in the Mintlify dashboard" className="block dark:hidden" />
  <img src="/images/assistant/assistant-status-dark.png" alt="Assistant Status toggle in the Mintlify dashboard" className="hidden dark:block" />
</Frame>
