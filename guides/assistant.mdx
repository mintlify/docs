...
- **Select the assistant button** next to the search bar.
  ...
  <Frame>
    <img src="/images/assistant/assistant-button-light.png" alt="Search bar and assistant button in light mode."/>
    <img src="/images/assistant/assistant-button-dark.png" alt="Search bar and assistant button in dark mode."/>
  </Frame>
