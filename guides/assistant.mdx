...
Configure how the assistant responds when it cannot answer questions and which sites it can search for additional information.

- **Assistant Deflection**: When enabled, the assistant directs users to your support team for questions it cannot answer.
- **Search Sites**: When enabled, the assistant can search specified external sites for additional information.
