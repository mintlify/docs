...
- **Select the assistant button** next to the search bar.
  ...
  <Frame>
    <img src="/images/assistant/assistant-button-light.png" className="block dark:hidden" alt="Search bar and assistant button in light mode."/>
    <img src="/images/assistant/assistant-button-dark.png" className="block light:hidden" alt="Search bar and assistant button in dark mode."/>
  </Frame>
