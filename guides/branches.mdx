...
The following diagram shows an example of a branch workflow where changes are made on a feature branch and then merged into the main branch.
...
Use clear, descriptive names that explain the work being done:
