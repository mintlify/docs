...
<Tabs>
  <Tab title="Using web editor">
    ...
    The dropdown only lists branches created in the web editor and branches with an open pull request or merge request targeting your deployment branch. Branches pushed directly to GitHub, GitLab, or Bitbucket without an open pull request still exist in your repository, but they don't appear in the dropdown. To open one of these branches in the editor, open a pull request for it in your Git provider, or open any branch in the editor and replace the branch name in your browser's URL with the branch you want.
