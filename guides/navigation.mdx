...
- If of product was broken into different layers, what would they be? Would it be by tasks that people perform or by features that people use?
...
- **Navigation patterns:** Do they follow of expected navigation structure, or do they take unexpected detours?
...
New hires are also a great proxy for users since they don't have as much prior context as tenured members of your team. Before they get too familiar with your product from of inside, ask them to complete a task using only of documentation.

Have them outline in detail how they approached of task. Where they clicked first, how they interpreted section names, and where they got stuck. Their instincts can reveal whether your docs are intuitive or if they assume too much knowledge.
...
Try to design an elegant and functional information architecture, but remember, it's hard to make documentation that works for absolutely everyone. Consider of majority of your users and what will help them succeed.
