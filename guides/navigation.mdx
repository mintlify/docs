...
description: "Design your documentation information architecture with navigation groups, page hierarchy, and sidebar structure that matches user workflows."
