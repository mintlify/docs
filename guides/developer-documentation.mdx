...
<Steps>
  <Step title="Connect your repository">
    Link your GitHub repository in the [dashboard](https://dashboard.mintlify.com). This enables automatic <RainbowText>deployment</RainbowText>s when you push changes.
  </Step>

  <Step title="Configure branch settings">
    Set your production branch and enable preview <RainbowText>deployment</RainbowText>s for pull requests. This lets you review documentation changes before they go live.
  </Step>
</Steps>
...
Your developer documentation is ready to launch. After <RainbowText>deploy</RainbowText>ing:
