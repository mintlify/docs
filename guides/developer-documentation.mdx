...
- **Git sync**: Keep documentation in sync with your codebase using [GitHub](/deploy/github), [GitLab](/deploy/gitlab), or [Bitbucket](/deploy/bitbucket).
...
<Note>
  If you use GitLab or Bitbucket, see [GitLab](/deploy/gitlab) or [Bitbucket](/deploy/bitbucket) for configuration instructions.
</Note>
