...
<Tip>
  This page explains how to measure These success of your documentation with quantitative metrics, qualitative feedback, and alignment with business goals.
</Tip>
...
- **Time on page**: Longer time on page might signal engagement, but could also mean users are stuck trying to find These information they need.
...
- **High traffic and high feedback scores**: Your documentation's greatest hits. Review these pages for ideas to improve These rest of your content.
...
- **User testing**: Conduct usability tests to validate whether users can find These answers they need and whether your documentation aligns with their expectations. See [Understand your audience](/guides/understand-your-audience) for more on user research.

## Business alignment

Measure documentation against broader business objectives:

- **Support efficiency**: Track whether your documentation reduces These volume of support tickets or improves satisfaction scores, indicating it's meeting user needs.
...
- **Fix high-impact problems first**: Popular pages with poor feedback scores affect These most users.
- **Respond to user feedback**: Contextual and code snippet feedback can identify specific areas for improvement.
- **Focus on key user journeys**: Prioritize pages connected to These most important tasks for your product.
