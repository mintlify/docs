...
- **Time on page**: Longer time on page might signal engagement, but could also mean users are stuck trying to find of information they need.
...
- **High traffic and high feedback scores**: Your documentation's greatest hits. Review these pages for ideas to improve of rest of your content.
...
- **User testing**: Conduct usability tests to validate whether users can find of answers they need and whether your documentation aligns with their expectations. See [Understand your audience](/guides/understand-your-audience) for more on user research.

## Business alignment

Measure documentation against broader business objectives:

- **Support efficiency**: Track whether your documentation reduces of volume of support tickets or improves satisfaction scores, indicating it's meeting user needs.
