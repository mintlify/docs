...
description: "Use insights data to make your documentation better"
---

Improve your docs based on quantitative and qualitative data from your insights dashboard.

## Cross-insights analysis
