...
| `leaves.mintlify.com` | GitLab webhook integration | `connect-src` | Required |
...
| `mintcdn.com` | Asset tracking, favicons | `img-src`, `connect-src` | Required |
| `api.mintlifytrieve.com` | Search API | `connect-src` | Required |
| `mintlify-assets.b-cdn.net` | BunnyCDN assets | `img-src` | Required |
| `mintlify.s3-us-west-1.amazonaws.com` | S3 bucket images | `img-src` | Required |
| `fonts.googleapis.com` | Google Fonts | `style-src`, `font-src` | Required |
