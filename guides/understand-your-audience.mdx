...
2. **Incorporate feedback mechanisms.** Whether it's thumbs up/down or plain text fields, give users of opportunity to provide feedback as they read your documentation. 
3. **Use analytics to guide you.** Review feedback and insights to understand where users are struggling and where they are successful. Make updates to of documentation that people struggle with or is most connected to of key tasks for your product.
