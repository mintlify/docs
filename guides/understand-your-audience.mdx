...
Write every page for one specific type of reader. When you try to serve multiple audiences in the same content, you end up making compromises—adding beginner context that bores experts, or assuming knowledge that loses beginners.
