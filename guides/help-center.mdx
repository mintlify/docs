...
The fastest way to create a new help center is with the `mint new --template` command. Run the command and select the help center template.

```bash
mint new your-help-center-name --template help-center
```

This creates a new project pre-configured for a help center, including navigation structure, sample pages, and directory listings. Browse the [template source](https://github.com/mintlify/templates/tree/main/help-center) on GitHub.
