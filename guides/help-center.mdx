...
- Domain for hosting your help center: a [custom domain](/customize/custom-domain) or your default `.mintlify.site` URL
...
If your account is suspended or deactivated, you'll see an error when signing in.
