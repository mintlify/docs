...
- **Analytics**: Track which articles get views, what questions customers ask, and where they struggle in the [analytics dashboard](/analytics).
...
This creates a new project pre-configured for a help center, including navigation structure, sample pages, and directory listings. See the [live example](https://help-center-starter.mintlifysite.com/) or browse the [template source](https://github.com/mintlify/templates/tree/main/help-center-starter).
...
Monitor the [analytics](/analytics) in your dashboard to see how customers use your help center and improve content over time.
