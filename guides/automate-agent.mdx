...
<Frame>
    <img src="/images/guides/n8n/webhook-node.png" alt="Screenshot of the configurations for the webhook node." />
</Frame>
...
<Frame>
    <img src="/images/guides/n8n/create-agent-job-node.png" alt="Screenshot of the configurations for the create agent job node." />
</Frame>
