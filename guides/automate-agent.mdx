...
**Documentation repository**: Where you store your documentation and connect to your Mintlify project. The agent API will create pull requests with documentation updates in this repository.
...
3. Configure the webhook:
    ...
    - Respond: Immediately
4. Save the workflow.
5. Copy the production webhook URL. It will look like: `https://your-n8n-instance.app.n8n.cloud/webhook/auto-update-documentation`

### Set up the GitHub webhook

<Note>Set up the webhook on your code repository, not your documentation repository.</Note>
