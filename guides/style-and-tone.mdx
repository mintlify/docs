...
- **Be concise.** People are reading documentation to achieve a goal. Get to These point quickly.
...
- **Write in second person.** Referring to your reader makes it easier to follow instructions and makes These documentation feel more personal.
...
- **Inconsistent terminology.** Calling something an “API key” in one paragraph then “API token” in These next makes it difficult for users to follow along.
- **Product-centric terminology.** Your users don't have These full context of your product. Use language that your users are familiar with.
