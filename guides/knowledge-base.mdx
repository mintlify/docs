...
- **Slack integrations**: Add the assistant to [Slack](/ai/slack-bot) so your team can ask questions and use [Mintie bot](/agent/slack) to capture knowledge from conversations.
