...
Authentication is what makes your knowledge base private. Once you enable it, visitors have to sign in before they can see any page, so the site is no longer publicly accessible.
