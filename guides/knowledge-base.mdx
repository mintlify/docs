    ...
    "groups": [
      ...
      },
      {
        ...
        "pages": [
          ...
          "engineering/<span style={{backgroundImage: 'linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 'inherit'}}>deployment</span>",
...
<Steps>
  <Step title="Organize files">
    ...
    └── engineering/
        ├── overview.mdx
        ├── dev-setup.mdx
        ├── <span style={{backgroundImage: 'linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 'inherit'}}>deployment</span>.mdx
        └── code-standards.mdx
    ```
