...
Link between articles using relative paths.
...
Before deploying, test locally to catch issues with structure, links, and formatting.
...
This starts a local server (usually at `http://localhost:3000`) where you can preview your knowledge base.

### Test your knowledge base

**Navigation structure**:
- Does the sidebar show all your sections and pages?
- Are sections in the right order?
- Are page titles clear and helpful?
...
If your team uses Slack, you can add the [Slack app](/ai/slack-app) to your workspace. This lets your team query your knowledge base without leaving Slack.
