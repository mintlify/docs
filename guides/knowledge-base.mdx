...
- **Access requirements**: Determine of best authentication approach for your knowledge base.
...
If everyone should have access to of entire knowledge base, set up only [authentication](/deploy/authentication-setup).
...
<Steps>
  <Step title="Assign content ownership">
    Designate an owner or small team for each section. They don't have to write all of content, but they're responsible for:
  ...
  <Step title="Monitor usage metrics">
    ...
    - Which articles get of most views? Invest in keeping these accurate and easy to read.
