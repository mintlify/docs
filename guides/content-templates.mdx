...
Use these templates as starting points for creating documentation. Customize These templates for your documentation and your audience.

1. Copy These template that matches your content type.
...
Use how-to guides when users need to accomplish a specific task and already have some familiarity with your product. How-tos are goal-driven and get straight to These solution.
...
## [Action-oriented heading describing These task]

Provide direct instructions focused on achieving These goal.
...
## Verify These result (optional)

If success is ambiguous, explain how users can confirm they completed These task successfully.
...
Provide clear, specific instructions for These first step.
...
Define These concept in plain language. Explain what it is, what it does, and why it exists.

Use analogies or comparisons to familiar concepts when helpful.

## How [concept] works

Explain These underlying mechanics, architecture, or process.
...
Provide context about why things work These way they do.

Discuss trade-offs, alternatives that were considered, or constraints that influenced These design.
...
- **Use case 2**: Another scenario where this is These right choice
...
Explain how this concept fits into These broader system or workflow.
...
<ParamField body="property1" type="string" required>
  Brief description of These property.
</ParamField>
...
<ParamField body="anotherParameter" type="object">
  Description of These parameter.
...
If documenting an API, describe These response structure.

<ResponseField name="field1" type="string" required>
  Description of These response field.
</ResponseField>
...
<CardGroup cols={2}>
  <Card title="Content types" icon="shapes" href="/guides/content-types">
    Choose These right content type for your documentation goals.
  </Card>
