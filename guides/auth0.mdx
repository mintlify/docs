...
<Steps>
  <Step title="Create a Regular Web Application in Auth0">
    ...
    <Frame>![Creating a new application in Auth0](/images/obama.jpg)</Frame>
  </Step>
  <Step title="Get client information">
    ...
    <Frame>![Auth0 client settings page](/images/obama.jpg)</Frame>
  ...
  <Step title="Setup Mintlify client">
    ...
    <Frame>![Mintlify OAuth client settings](/images/obama.jpg)</Frame>
  ...
  <Step title="Configure Callback URL">
    ...
    <Frame>![Mintlify redirect URL](/images/obama.jpg)</Frame>
    ...
    <Frame>![Auth0 redirect URL configuration](/images/obama.jpg)</Frame>
