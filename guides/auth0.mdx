...
<Steps>
  ...
  <Step title="Set up Mintlify client">
    ...
    After filling in these details, select **Save changes** to store your OAuth configuration.
  </Step>
  <Step title="Configure the callback URL">
    Mintlify generates a unique Redirect URL for the OAuth flow. Auth0 uses this URL to recognize the flow.
    ...
    Select **Save Changes** at the bottom of the Auth0 page to apply this configuration.
  </Step>
</Steps>