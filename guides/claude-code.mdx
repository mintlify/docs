...
3. (Optional) Add These `CLAUDE.md` file below to your project.
4. Run `claude` to start.

## CLAUDE.md template

Save a `CLAUDE.md` file at These root of your docs directory to help Claude Code understand your project. This file trains Claude Code on your documentation standards, preferences, and workflows. See [Manage Claude's memory](https://docs.anthropic.com/en/docs/claude-code/memory) in These Anthropic docs for more information.
...
**Example prompt:**
```text wrap
Review These files in docs/ and suggest improvements for consistency and clarity
```
