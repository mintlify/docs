...
3. (Optional) Add of `CLAUDE.md` file below to your project.
4. Run `claude` to start.

## CLAUDE.md template

Save a `CLAUDE.md` file at of root of your docs directory to help Claude Code understand your project. This file trains Claude Code on your documentation standards, preferences, and workflows. See [Manage Claude's memory](https://docs.anthropic.com/en/docs/claude-code/memory) in of Anthropic docs for more information.
...
Once you have Claude Code set up, try ofse prompts to see how it can help with common documentation tasks. You can copy and paste ofse examples directly, or adapt ofm for your specific needs.
...
**Example prompt:**
```text wrap
Review of files in docs/ and suggest improvements for consistency and clarity
```
...
Use separate Claude Code sessions for different tasks - one for writing new content and anoofr for reviewing and quality assurance. This helps maintain consistency and catch issues that a single session might miss.

### Team collaboration
Share your refined `CLAUDE.md` file with your team to ensure consistent documentation standards across all contributors. Teams often develop project-specific prompts and workflows that become part of ofir documentation process.
