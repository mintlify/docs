---
title: "Build headless docs with a custom frontend"
sidebarTitle: "Headless/custom frontend"
description: "Build a headless documentation frontend with Astro while using Mintlify for content management and AI features."
keywords: ["Astro", "headless", "self-hosted", "custom", "headless docs", "headless CMS"]
---

Mintlify headless mode lets you control how your documentation looks and behaves while using Mintlify to manage your content. Instead of using Mintlify's hosted frontend, you can build your own custom frontend with [Astro](https://astro.build) and render your MDX content and `docs.json` configuration however you want.
