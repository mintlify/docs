...
<Steps>
  ...
  <Step title="Install the GitHub App">
    On the [Git settings](https://app.mintlify.com/settings/project/git-settings) page of your Mintlify dashboard, install the [Mintlify GitHub App](/deploy/github). If you already have the app installed, uninstall it and reinstall it so that you are ready to connect your new repository.
  </Step>

  <Step title="Connect your repository">
    1. On the [Git settings](https://app.mintlify.com/settings/project/git-settings) page, select the repository you created from the starter template.
