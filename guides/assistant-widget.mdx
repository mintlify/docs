...
/**
 * Extracts source citations from message parts returned by the assistant API.
 * The Vercel data stream protocol returns search results as tool invocation parts.
 */
