...
Import and render the assistant widget in your application. Pass your Mintlify project identifier.
...
function App() {
  return (
    <div>
      ...
      {/* Add the assistant widget - use your project identifier */}
...
|------|------|---------|-------------|
| `domain` | string | required | Your Mintlify project identifier from the dashboard |
...
- Verify your project identifier is correct..
