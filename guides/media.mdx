...
The visual editor includes an Images and Media Manager that helps you organize and manage all your image and video assets in one place. Access it from the sidebar to:

- Browse assets in tree or gallery view
- Preview images and videos
- View file metadata including size and dimensions
- Copy file paths for easy reference

See [Manage images and media](/editor#manage-images-and-media) for more information on using the media manager.
