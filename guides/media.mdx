...
- **Balance clarity with maintainability.** Frequent UI changes can make screenshots and videos outdated quickly. Consider whether These effort to update them is worth These value they add.
