...
Use screenshots for tasks that are difficult to describe in words. Screenshots work especially well for UI-heavy workflows where users need to orient themselves visually, or where identifying the right interface element would be ambiguous without seeing it.
