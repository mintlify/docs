...
## Managing media in the visual editor

The visual editor includes an Images and Media Manager that helps you browse, preview, and organize your image and video assets. Access it from the sidebar to:

- Browse assets in tree or gallery view
- Preview images and videos before using them
- View file metadata like size and dimensions
- Search for specific assets by name
- Copy file paths for easy reference in your documentation

See [Visual editor](/editor#manage-images-and-media) for detailed information on using the Images and Media Manager.
