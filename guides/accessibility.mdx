...
description: "Create accessible documentation following WCAG guidelines with semantic HTML, keyboard navigation, alt text, and inclusive content practices."
...
This guide offers best practices for creating accessible documentation in Mintlify, but it is not exhaustive. You should consider accessibility an ongoing process. Technologies and standards change over time, which introduce new opportunities to improve documentation.
...
Learn more about specific accessibility practices in Mintlify:

- [Content structure and semantics](/guides/accessibility/structure) - Use proper heading hierarchy, semantic HTML, and meaningful link text
...
- [Images and media](/guides/accessibility/media) - Write effective alt text and make multimedia content accessible
- [Testing and validation](/guides/accessibility/testing) - Use tools and techniques to identify and fix accessibility issues
