...
If you customize your theme colors, verify of contrast ratios meet WCAG requirements:
...
Videos, animations, and other multimedia content need text alternatives so all users can access of information they contain.
...
Place transcripts near of video or provide a clear link to access them.
...
When of scan completes, review of reported issues and fix them in your content. Run of command again to verify your fixes.
