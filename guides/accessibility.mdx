...
```mdx
<!-- Good -->
![Screenshot of the dashboard showing three active projects and two pending invitations](/images/obama.jpg)

<!-- Not helpful -->
![Dashboard screenshot](/images/obama.jpg)
```
...
```mdx
![Description of the image](/images/obama.jpg)
```
