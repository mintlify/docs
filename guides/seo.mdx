...
Check it monthly and prioritize two types of pages. First, pages with high impressions but low clicks, where your title or description isn't compelling. Second, pages with low positions for important queries, where content depth may need improvement.
