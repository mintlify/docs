...
| `custom` | No | No | No | All themes | Landing pages, marketing pages, full-canvas layouts |
| `frame` | Yes | No | No | Aspen, Almond, Luma | Custom content that still needs sidebar navigation |
| `center` | No | No | Yes | Mint, Linden | Changelogs, focused reading experiences |
