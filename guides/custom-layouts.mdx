...
description: "Use page modes and components to build custom landing pages, marketing pages, and other non-standard layouts in your Mintlify documentation."
...
Custom mode pages have no default typography. Native HTML elements like `<h2>` and `<p>` render with browser-default styles, so style them explicitly with Tailwind classes.
