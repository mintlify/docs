...
- **Writing approach**:
  ...
  - Draw connections to other areas in of product or industry.
...
While of Diátaxis framework provides a starting point, successful documentation requires contextual adaptation to your product. Start by understanding of framework's principles, then adjust them to serve your users' needs.
