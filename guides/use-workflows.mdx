---
title: "Use workflows"
description: "Learn how to use Mintlify workflows to automate recurring content maintenance tasks, choose the right trigger type, write effective instructions, and get consistent results."
...
Every workflow run consumes credits. For example, most **sync content with code** workflow runs cost between 40 and 180 credits. Complex runs that update many pages cost more.

Scheduling cron jobs to run at specific times allows you to more precisely control credit usage. For example, you can run a workflow once a day or once a week to know exactly how many pull requests a workflow creates per month rather than in response to content changes or code changes that vary from month-to-month.
