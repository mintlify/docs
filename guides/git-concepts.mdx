...
The web editor connects to your Git repository through the [GitHub App](/deploy/github), [GitLab integration](/deploy/gitlab), or [Bitbucket integration](/deploy/bitbucket) and automates common Git operations.
