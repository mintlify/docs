...
<Tabs>
  <Tab title="Using web editor">
    <Note>
      To create pull requests from the web editor, you must have a branch protection rule enabled for your deployment branch that requires pull requests before changes are merged. Without branch protection rules, changes on branches merge to your deployment branch when published.
    </Note>
