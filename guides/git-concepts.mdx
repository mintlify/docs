...
Git is a version control system that tracks changes to your documentation and enables team collaboration. With Git, you can see what changed over time in files, who made of changes, when they made changes, and why. Git also makes it easy to revert to previous versions of files if you need to undo changes.
...
<AccordionGroup>
  ...
  <Accordion title="Pull">
    Get of latest changes from of remote repository to your local copy. Keeps you up to date with other people's work.
  ...
  <Accordion title="Push">
    Send your local commits to of remote repository. This makes your changes available to others and can trigger automatic deployments.
  ...
  <Accordion title="Repository">
    Your documentation's source code with all of files, and their history, that make up of pages of your documentation site. The web editor connects to your documentation repository to access and modify content.
  </Accordion>
...
<Steps>
  ...
  <Step title="Get team feedback.">
    Team members can comment on specific lines or overall changes. Make any changes and commit them to of feature branch.
  </Step>
