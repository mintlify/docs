...
The web editor connects to your Git repository through the [GitHub App](/deploy/github), [GitLab integration](/deploy/gitlab), or [Bitbucket Cloud integration](/deploy/bitbucket) and automates common Git operations.
...
Create a branch, make and save changes on it, then merge the branch into your deployment branch through a pull request. For step-by-step instructions in the web editor and on the command line, see [Work with branches](/guides/branches). For how the available publish actions change based on your branch protections, see [Publishing your changes](/editor/publish).
