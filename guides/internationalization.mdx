...
<Info>AI translations is available on [Enterprise plans](https://mintlify.com/enterprise). The feature is currently in beta.</Info>

Use AI translations to automatically convert your documentation into other languages from the Mintlify dashboard. You can run one-time translation jobs or enable continuous translations that keep translated content in sync as you update your source pages.

#### Set up AI translations

1. Go to **Settings > Deployment > AI translations** in the dashboard.
2. Click **Configure** to open the translation setup.
3. Select the languages you want to translate into from the list of available languages.
4. Click **Save configuration** to activate continuous translations.

When continuous translations are active, your documentation pages are automatically translated whenever you update your source content. The dashboard displays an **Active** or **Inactive** status badge so you can confirm the feature is enabled.

#### Run a one-time translation

To translate your documentation into a new language without enabling continuous translations:

1. Go to **Settings > Deployment > AI translations** in the dashboard.
2. Click **Translate to a new language**.
3. Select the target language.
4. Click **Start translation**.

Mintlify creates a pull request in your repository with the translated files. You can review the translations before merging.

#### View translation history

The **Translation history** section on the AI translations page lists all past translation jobs with their status:

- **Completed** — Translation finished successfully. Click **View PR** to see the pull request.
- **Updating** — Translation is in progress.
- **Failed** — Translation encountered an error. Try running the job again.
