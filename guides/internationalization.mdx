...
<Warning>
  Do not use the same page path in more than one locale. Duplicating paths across locales results in undefined behavior. Each page path should appear in only one language's navigation.
</Warning>
