{/* The prompt below is duplicated as a string in
    /snippets/setup-agent-prompt-text.mdx for the introduction page.
    EDIT BOTH FILES TOGETHER; .github/workflows/check-prompt-sync.yml fails the
    build if they drift. */}
