...
Pour utiliser des dépôts GitLab dans une automatisation, connectez chaque projet via la page de paramètres [OAuth GitLab](https://app.mintlify.com/settings/organization/gitlab-oauth). Connectez chaque dépôt que l'automatisation utilise — votre dépôt de documentation et tous les dépôts de déclenchement ou de contexte. Vous devez disposer au minimum du rôle Mainteneur sur chaque projet.
