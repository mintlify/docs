...
Mintlify muestra los repositorios en los que tu cuenta de Bitbucket tiene acceso de colaborador. Conecta los repositorios que la automatización usa para el contenido, los activadores de cambios de código o el contexto. Mintlify registra un webhook para cada repositorio conectado, de modo que los eventos del repositorio puedan activar automatizaciones. Mintlify verifica las firmas de los webhooks antes de procesar los eventos. Rechaza las solicitudes sin una firma válida e ignora los eventos de repositorios no reconocidos.
