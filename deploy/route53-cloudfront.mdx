...
All pages should be directing to your main landing page. If you append your chosen subpath, for example `/docs`, to the URL, you should see it going to your Mintlify documentation instance.
