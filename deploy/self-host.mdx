...
If your organization can't grant repository credentials to a third-party service, you can instead front your Git hosting with an internally owned proxy API, and fully air-gapped environments use [static export](/api/static-export/overview) with no Git connection at all.
