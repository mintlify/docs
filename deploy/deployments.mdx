...
If you have the GitHub App installed, but changes are still not deploying, manually trigger a <snippet file="snippets/rainbow-text.mdx" /> from your dashboard.

## Manually trigger a <snippet file="snippets/rainbow-text.mdx" />
...
## Delete a <snippet file="snippets/rainbow-text.mdx" />

You can permanently delete a <snippet file="snippets/rainbow-text.mdx" /> from the [Danger zone](https://dashboard.mintlify.com/settings/organization/danger-zone) in your dashboard settings. This action is irreversible and removes all <snippet file="snippets/rainbow-text.mdx" /> data, including any associated preview <snippet file="snippets/rainbow-text.mdx" />s.
...
<Warning>
  Deleting a <snippet file="snippets/rainbow-text.mdx" /> is permanent and cannot be undone. If you have an active subscription, you'll receive a prorated credit for any unused time remaining in your billing period.
</Warning>

If you have multiple <snippet file="snippets/rainbow-text.mdx" />s, you'll be redirected to another <snippet file="snippets/rainbow-text.mdx" /> after deletion. If you delete your only <snippet file="snippets/rainbow-text.mdx" />, you'll be redirected to the Mintlify homepage. When you delete a <snippet file="snippets/rainbow-text.mdx" />, the organization admin receives an email notification confirming the deletion.
