...
- Any preview deployments associated with the deployment are deleted
- If you have an active subscription, you'll receive a prorated credit for unused time
...
- **Delete deployment**: Removes a single deployment while keeping your organization and other deployments intact
- **Delete organization**: Removes your entire organization, all deployments, team members, and data
