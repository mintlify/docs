...
<Note>
  Looking for **Reset editor**? That action lives in the editor's own settings panel, not in the dashboard Danger zone. See [Reset editor](/editor/settings#reset-editor) if your web editor is stuck out of sync with your repository.
</Note>
