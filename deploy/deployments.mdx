...
If your latest changes are not appearing on your live site:

1. **Check the GitHub App installation** - Verify that the GitHub account or organization that owns your docs repository has the GitHub App installed. See [GitHub troubleshooting](/deploy/github#troubleshooting) for more information.

2. **Review your commit** - Ensure your latest commit appears in your docs repository and did not encounter any errors.

3. **Manually trigger a deployment** - If the GitHub App is installed but changes still aren't deploying, manually trigger a deployment from your dashboard.
