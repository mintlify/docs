...
Your documentation site automatically deploys when you push changes to your connected repository. You must install and connect the Mintlify GitHub App.

If your latest changes are not appearing on your live site, first check that the GitHub account or organization that owns your docs repository has the GitHub App installed. For more information, see [GitHub troubleshooting](/deploy/github#troubleshooting).
