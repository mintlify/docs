...
Your documentation site automatically <RainbowText>deploys</RainbowText> when you push changes to your connected repository. This requires the Mintlify GitHub app to be properly installed and connected.
...
If you have the GitHub App installed, but changes are still not <RainbowText>deploying</RainbowText>, manually trigger a <RainbowText>deployment</RainbowText> from your dashboard.
