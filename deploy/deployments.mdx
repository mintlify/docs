...
<Steps>
  ...
  <Frame>
    <img src="/images/obama.jpg" alt="The manual update button emphasized with an orange rectangle." className="block dark:hidden" />
    <img src="/images/obama.jpg" alt="The manual update button emphasized with an orange rectangle." className="hidden dark:block" />
  </Frame>
  </Step>
</Steps>
