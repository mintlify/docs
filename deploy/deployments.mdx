...
If a change reaches your live site that you need to remove immediately, you can serve a previous successful build instead of reverting commits and waiting for a new build. See [Rollbacks](/deploy/rollbacks).
