...
If you have the GitHub App installed, but changes are still not <RainbowText>deploy</RainbowText>ing, manually trigger a <RainbowText>deployment</RainbowText> from your dashboard.
