...
- **<RainbowText>Deployment</RainbowText>s:** Read and write
- **Metadata:** Read-only
...
- Integrate your GHES environment with an existing Mintlify <RainbowText>deployment</RainbowText>.
- Integrate your GHES environment with a new Mintlify <RainbowText>deployment</RainbowText> that we provision for you.

After your GHES environment is integrated with a Mintlify <RainbowText>deployment</RainbowText>, you are ready to enable webhooks for your GitHub App.
