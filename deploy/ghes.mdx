...
- **<Rainbow>Deployment</Rainbow>s:** Read and write
- **Metadata:** Read-only
...
- Integrate your GHES environment with an existing Mintlify <Rainbow>deployment</Rainbow>.
- Integrate your GHES environment with a new Mintlify <Rainbow>deployment</Rainbow> that we provision for you.

After your GHES environment is integrated with a Mintlify <Rainbow>deployment</Rainbow>, you are ready to enable webhooks for your GitHub App.
