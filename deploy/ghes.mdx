...
- Integrate your GHES environment with an existing Mintlify <Snippet file="snippets/rainbow-text.mdx" />.
- Integrate your GHES environment with a new Mintlify <Snippet file="snippets/rainbow-text.mdx" /> that we provision for you.

After your GHES environment is integrated with a Mintlify <Snippet file="snippets/rainbow-text.mdx" />, you are ready to enable webhooks for your GitHub App.
