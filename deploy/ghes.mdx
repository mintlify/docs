...
1. In the upper-right corner of any page on GitHub, select your profile picture.
2. Select **Your organizations**.
3. Select **Settings** next to the organization that you want to create the app for.
</Step>
...
1. From the app settings page, select **Install App** in the left sidebar.
