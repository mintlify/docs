...
### Proxies with Vercel <RainbowText>deployments</RainbowText>

If you use Cloudflare as a proxy with Vercel <RainbowText>deployments</RainbowText>, you must ensure proper configuration to avoid conflicts with Vercel's domain verification and SSL certificate provisioning.
