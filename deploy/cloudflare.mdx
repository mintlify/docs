...
### Proxies with Vercel <RainbowText>deployment</RainbowText>s

If you use Cloudflare as a proxy with Vercel <RainbowText>deployment</RainbowText>s, you must ensure proper configuration to avoid conflicts with Vercel's domain verification and SSL certificate provisioning.
...
<Warning>
  Make sure your main site is set up on a landing page before <RainbowText>deploy</RainbowText>ing this Worker, or visitors to your main site will see errors.
</Warning>
