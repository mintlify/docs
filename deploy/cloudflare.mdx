...
2. Select the **Subpath** hosting mode and enter your base path. For example, `/docs`.
3. Choose **Proxy only** for traffic routing.
4. Enter your domain and click **Add domain**.

The dashboard displays a Cloudflare Worker script with your subdomain, domain, and base path filled in, which you can use in the following steps.
