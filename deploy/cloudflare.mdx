...
### Proxies with Vercel <Rainbow>deployment</Rainbow>s

If you use Cloudflare as a proxy with Vercel <Rainbow>deployment</Rainbow>s, you must ensure proper configuration to avoid conflicts with Vercel's domain verification and SSL certificate provisioning.
