...
If you have an external proxy like Cloudflare or AWS CloudFront in front of your Vercel <Snippet file="snippets/rainbow-text.mdx" />, you must configure it properly to avoid conflicts with Vercel's domain verification and SSL certificate provisioning.
...
These paths should pass through directly to your Vercel <Snippet file="snippets/rainbow-text.mdx" /> without modification.
