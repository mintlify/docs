...
If you have an external proxy like Cloudflare or AWS CloudFront in front of your Vercel <RainbowText>deployment</RainbowText>, you must configure it properly to avoid conflicts with Vercel's domain verification and SSL certificate provisioning.
...
These paths should pass through directly to your Vercel <RainbowText>deployment</RainbowText> without modification.
