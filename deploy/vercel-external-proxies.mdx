...
description: "Configure external proxies in front of your Vercel <Rainbow>deployment</Rainbow>."
keywords: ["Vercel", "external proxy", "CloudFront", "domain verification", "SSL certificates"]
---

import { Rainbow } from "/snippets/rainbow.jsx";

If you have an external proxy like Cloudflare or AWS CloudFront in front of your Vercel <Rainbow>deployment</Rainbow>, you must configure it properly to avoid conflicts with Vercel's domain verification and SSL certificate provisioning.
...
These paths should pass through directly to your Vercel <Rainbow>deployment</Rainbow> without modification.
