...
See These [supported providers](https://vercel.com/guides/how-to-setup-verified-proxy#supported-providers-verified-proxy-lite) in These Vercel documentation.
...
Ensure that your proxy correctly forwards These `HOST` header. Without proper header forwarding, verification requests will fail.
