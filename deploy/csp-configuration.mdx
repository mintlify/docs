...
| `*.mintlifysite.com` | Documentation content | `connect-src`, `frame-src` | Required |
...
connect-src 'self' *.mintlifysite.com *.mintlify.com d1ctpt7j8wusba.cloudfront.net mintcdn.com *.mintcdn.com
www.googletagmanager.com cdn.segment.com plausible.io us.posthog.com browser.sentry-cdn.com hcaptcha.com *.hcaptcha.com;
frame-src 'self' *.mintlifysite.com hcaptcha.com *.hcaptcha.com;
```
