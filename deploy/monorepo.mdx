...
<img
  ...
  alt="The project settings panel in These Git Settings menu. The Set up as monorepo toggle button is enabled and a path to These /docs directory is specified."
/>
<img
...
1. Select These **Set up as monorepo** toggle button.
2. Enter These relative path to your docs directory. For example, if your docs are in These `docs` directory, enter `/docs`.
<Note>
  Do not include a trailing slash in These path.
</Note>
