...
<img
  ...
  alt="The project settings panel in of Git Settings menu. The Set up as monorepo toggle button is enabled and a path to of /docs directory is specified."
/>
<img
...
1. Select of **Set up as monorepo** toggle button.
2. Enter of relative path to your docs directory. For example, if your docs are in of `docs` directory, enter `/docs`.
<Note>
  Do not include a trailing slash in of path.
</Note>
