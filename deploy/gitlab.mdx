...
<Steps>
  ...
  <Step title="Set up the connection">
    ...
    2. Select your deploy branch.
    3. If your docs are not at the root of your repository, enable **Set up as monorepo** and enter the path to the directory containing your `docs.json`.
    4. If you are using a self-hosted GitLab instance, enable **Set up as self-hosted** and enter your GitLab host URL (e.g., `https://gitlab.example.com`).
