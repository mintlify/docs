...
<Steps>
  <Step title="Find your project ID">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="The General Settings page in the GitLab dashboard. The Project ID is highlighted." />
    </Frame>
  </Step>
  <Step title="Generate an access token">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="The Access tokens page in the GitLab dashboard. The settings to configure for Mintlify are highlighted." />
    </Frame>
  ...
  <Step title="Set up the connection">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="The GitLab configuration panel in the Git Settings page of the Mintlify dashboard." className="block dark:hidden" />
      <img src="/images/obama.jpg" alt="The GitLab configuration panel in the Git Settings page of the Mintlify dashboard." className="hidden dark:block" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  2. Click **Add new webhook**.
    <Frame>
      <img src="/images/obama.jpg" alt="Screenshot of the Webhooks page in the GitLab dashboard." />
    </Frame>
  </Step>
  ...
  <Step title="Get webtoken">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="Screenshot of the GitLab connection in the Mintlify dashboard." className="block dark:hidden" />
      <img src="/images/obama.jpg" alt="Screenshot of the GitLab connection in the Mintlify dashboard." className="hidden dark:block" />
    </Frame>
  </Step>
  ...
  <Step title="Verify the webhook">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="The Webhook page in the GitLab dashboard. The settings to configure for Mintlify are highlighted." />
    </Frame>
  </Step>
  <Step title="Test the webhook">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="Screenshot of the GitLab Webhooks page. The 'Push events' menu item is highlighted in the 'Test' menu." />
    </Frame>
