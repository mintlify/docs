...
<Tip>
  If you use [workflows](/agent/workflows), connect your GitLab account via OAuth on the [GitLab OAuth](https://dashboard.mintlify.com/settings/organization/gitlab-oauth) settings page. GitLab OAuth gives the agent access to pull, push, and create merge requests on your selected repositories.
</Tip>
