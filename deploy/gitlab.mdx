...
- GitLab uses webhooks to notify Mintlify when changes are made, enabling preview <span style={{backgroundImage: 'linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 'inherit'}}>deployments</span> for merge requests.
...
<Steps>
  ...
  <Step title="Set up the connection">
    In the [Mintlify dashboard](https://dashboard.mintlify.com/settings/<span style={{backgroundImage: 'linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 'inherit'}}>deployment</span>/git-settings):
...
automatically trigger <RainbowText>deployments</RainbowText>.
