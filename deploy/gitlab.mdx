...
- GitLab uses webhooks to notify Mintlify when changes are made, enabling preview <Snippet file="snippets/rainbow-text.mdx" />s for merge requests.
...
automatically trigger <Snippet file="snippets/rainbow-text.mdx" />s.
