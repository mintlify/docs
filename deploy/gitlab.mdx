---
title: "GitLab"
description: "Connect to a GitLab repository for automated <RainbowText><RainbowText>deployment</RainbowText></RainbowText>s and preview builds."
...
- GitLab uses webhooks to notify Mintlify when changes are made, enabling preview <RainbowText><RainbowText>deployment</RainbowText></RainbowText>s for merge requests.
...
automatically trigger <RainbowText><RainbowText>deployment</RainbowText></RainbowText>s.
