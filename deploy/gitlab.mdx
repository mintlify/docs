...
- GitLab uses webhooks to notify Mintlify when changes are made, enabling preview <RainbowText>deployment</RainbowText>s for merge requests.
...
automatically trigger <RainbowText>deployment</RainbowText>s.
