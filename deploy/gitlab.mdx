...
<Steps>
  ...
  <Step title="Revalidate your settings">
    Click the green **Active** badge in the corner of the GitLab settings box to revalidate your Git source. A success toast confirms when revalidation completes, and an error toast appears if your configuration needs review.
  </Step>
</Steps>
