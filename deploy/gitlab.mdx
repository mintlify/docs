...
- GitLab uses webhooks to notify Mintlify when changes are made, enabling preview <Rainbow>deployment</Rainbow>s for merge requests.
...
automatically trigger <Rainbow>deployment</Rainbow>s.
