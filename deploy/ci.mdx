---
title: "CI checks"
description: "Automate documentation quality checks in your CI/CD pipeline with broken link detection and Vale prose linting."
...
Configure the CI checks enabled for a deployment by navigating to the [General](https://app.mintlify.com/settings/deployment/general) page of your dashboard. Enable the checks that you want to run.
