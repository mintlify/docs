...
Configure the CI checks enabled for a deployment by navigating to the [General](https://app.mintlify.com/settings/project/general) page of your dashboard. Enable the checks that you want to run.
