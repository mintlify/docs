...
Configure the CI checks enabled for a deployment by navigating to the [Add-ons](https://app.mintlify.com/settings/deployment/addons) page of your dashboard. Enable the checks that you want to run.
