...
- A Mintlify organization on the **Pro plan or higher**. Registering OAuth credentials and starting the authorization flow on Hobby or trial plans return a 403 error. Organizations that already have a self-hosted GitLab installation from before this requirement keep working and can re-authorize as normal.
