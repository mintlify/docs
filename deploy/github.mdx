...
<Info>
  These features are intentionally restricted to public repositories to protect your source code and internal documentation structure. When a repository becomes private, these features are automatically disabled.
</Info>

If your repository is public but you still cannot enable these features, revalidate your Git settings:
