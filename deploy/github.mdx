...
<Steps>
  ...
  <Step title="Revalidate your settings">
    Select the green check mark in the corner of the Git settings box to revalidate your repository settings. This forces an update to your repository settings to reflect whether your repository is public or private.
