...
Install the Mintlify GitHub App on the [Git settings](https://app.mintlify.com/settings/deployment/git-settings) page of your dashboard. When GitHub asks which repositories to grant access to, choose **Only select repositories** and select your documentation repository.
...
<AccordionGroup>
  <Accordion title="Verify GitHub App installation">
    ...
    1. Navigate to the [Git settings](https://app.mintlify.com/settings/deployment/git-settings) page in your dashboard.
