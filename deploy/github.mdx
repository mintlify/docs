...
The wizard guides you through two paths:

<Tabs>
  <Tab title="One-click clone">
    Use the **Clone** option to copy your documentation directly into a new repository in your GitHub organization.

    1. Select **GitHub** as your provider and click **Continue**.
    2. Click **Clone** to authorize with GitHub.
    3. Select the GitHub organization where you want to create the repository.
    4. Optionally install the Mintlify GitHub App to enable automatic deployments.
  </Tab>
  <Tab title="Manual setup">
    Use **Continue setup** if you want to connect an existing repository or need more control over the configuration.

    1. Select **GitHub** as your provider and click **Continue**.
    2. Click **Download** to save your documentation as a zip file, then push the contents to your own repository.
    3. Click **Continue setup** and authorize with GitHub.
    4. Select your organization, repository, and branch. Optionally specify a subdirectory for monorepo setups.
  </Tab>
</Tabs>
