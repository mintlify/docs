...
6. Complete the setup for your provider:
   - **GitHub**: Install the GitHub App by following the steps in [Install the GitHub App](#install-the-github-app) below.
   - **GitLab**: Configure the connection by following the steps in [GitLab](/deploy/gitlab).
