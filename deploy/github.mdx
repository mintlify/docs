...
If you skipped connecting your own Git repository during onboarding, your documentation lives in a private repository owned by the Mintlify organization. To move it to your own account or organization, go to [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) in your dashboard. A setup wizard walks you through the process.

The wizard offers two paths:

<Tabs>
  <Tab title="One-click clone">
    Clone your documentation directly into your GitHub account or organization.

    <Steps>
      <Step title="Select GitHub as your provider">
        Choose **Connect to GitHub** and click **Continue**.
      </Step>
      <Step title="Clone your content">
        Click **Clone** to authorize with GitHub and clone your documentation into a new repository.
      </Step>
      <Step title="Select an organization">
        Choose which GitHub account or organization should own the new repository, then click **Confirm**.
      </Step>
      <Step title="Install the GitHub App">
        Install the Mintlify GitHub App to enable automatic deployments, or click **Skip** to install it later.
      </Step>
    </Steps>
  </Tab>
  <Tab title="Manual setup">
    Download your content as a zip file and create your own repository.
    ...
    <Steps>
      ...
      <Step title="Download your content">
        Click **Download** to save your documentation as a zip file. Extract the contents and push them to a new GitHub repository.
      </Step>
      <Step title="Connect your repository">
        Click **Continue setup**, then authorize with GitHub. Select your organization, repository, and branch to connect your new repository to Mintlify.
      </Step>
    </Steps>
  </Tab>
</Tabs>

After completing either path, the Git Settings page displays your connected repository configuration.
