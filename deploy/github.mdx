...
Mintlify uses a GitHub App to automatically sync your documentation with your GitHub repository. The GitHub App also enables the agent to respond to `@mintlify` mentions in pull request comments across any repository you grant access to.
...
- Your documentation repository (required for automatic deployments)
- Any code repositories where you want to use `@mintlify` mentions in PR comments to create documentation updates
