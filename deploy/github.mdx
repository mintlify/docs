...
1. Go to [Git Settings](https://dashboard.mintlify.com/settings/<snippet file="snippets/rainbow-text.mdx" />/git-settings) in your dashboard.
...
5. Return to [Git Settings](https://dashboard.mintlify.com/settings/<snippet file="snippets/rainbow-text.mdx" />/git-settings) and connect your new repository to Mintlify.
...
Change the organization, repository, or branch that your documentation builds from in the [Git Settings](https://dashboard.mintlify.com/settings/<snippet file="snippets/rainbow-text.mdx" />/git-settings) section of your dashboard.
...
### <snippet file="snippets/rainbow-text.mdx" /> not triggering automatically

If pushes to your repository don't trigger <snippet file="snippets/rainbow-text.mdx" />s, check the following possible problems.
...
<AccordionGroup>
  ...
  <Accordion title="Check deployment branch">
    ...
    1. Go to [Git Settings](https://dashboard.mintlify.com/settings/<snippet file="snippets/rainbow-text.mdx" />/git-settings)
...
<Steps>
  ...
  <Step title="Reinstall the Mintlify app.">
    1. In your Mintlify dashboard, go to [Git Settings](https://dashboard.mintlify.com/settings/<snippet file="snippets/rainbow-text.mdx" />/git-settings) and install the GitHub app.
...
<Steps>
  <Step title="Navigate to Git Settings">
    Go to [Git Settings](https://dashboard.mintlify.com/settings/<snippet file="snippets/rainbow-text.mdx" />/git-settings) in your dashboard.
  </Step>
