...
<AccordionGroup>
  ...
  <Accordion title="Manual setup">
    ...
    1. Select **GitHub** as your provider and choose **Continue setup**.
    2. Authorize with GitHub when prompted.
    3. Select your organization, repository, and branch.
    4. Optionally specify a subdirectory if your docs are not at the repository root.
    5. Save your settings.

    <Tip>
      You can also download your documentation as a zip file from the setup wizard if you want to push the files to your repository yourself.
    </Tip>
  </Accordion>
</AccordionGroup>

After completing either path, install the GitHub App by following the steps in [Install the GitHub App](#install-the-github-app) below.
