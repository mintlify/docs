...
<AccordionGroup>
  <Accordion title="Verify the GitHub App is installed">
    Check that the app is installed for the correct repository.
    1. Go to [GitHub App settings](https://dashboard.mintlify.com/settings/organization/github-app) in your dashboard.
    1. Check that your repository is listed in the active app installations.
  </Accordion>
  ...
  <Accordion title="Verify repository permissions">
    The GitHub App needs access to your repository.
    1. Visit your [GitHub app installations](https://github.com/apps/mintlify/installations/new)
    2. Verify that your repository is included in the selected repositories.
  </Accordion>
</AccordionGroup>
