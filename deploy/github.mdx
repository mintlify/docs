...
Mintlify uses a GitHub App to automatically sync your documentation with your GitHub repository. The GitHub App also enables the [agent](/ai/agent) to respond to `@mintlify` mentions in pull request comments across all your repositories.
...
- Any repositories where you want to use `@mintlify` mentions in pull request comments to create documentation updates
