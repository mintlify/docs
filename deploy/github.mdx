...
1. Select **GitHub** as your provider and continue.
2. Click **Clone** to authorize with GitHub.
3. Choose the organization or personal account where you want to create the repository.
4. Confirm the clone. Mintlify creates a new repository with your current documentation content.
5. Install the GitHub App when prompted, or skip and install it later.

### Manual setup

1. Select **GitHub** as your provider and continue.
2. Click **Download** to save your documentation as a zip file, then create a new repository and push the contents yourself.
3. Click **Continue setup** and authorize with GitHub.
4. Select the organization, repository, and branch for your documentation.
