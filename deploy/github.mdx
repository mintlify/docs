...
If you are using GitHub Enterprise Cloud, you need to configure additional settings to allow Mintlify to connect to your repositories:

1. **Allow apps from the public GitHub App directory**: Your organization must enable third-party applications from the public GitHub App directory. You can configure this in your organization's settings under **Settings** > **Third-party Access** > **GitHub Apps**.

2. **Whitelist Mintlify's IP address**: Add `54.242.90.151` to your organization's IP allow list. You can configure this in your organization's settings under **Settings** > **Security** > **IP allow list**.

<Warning>
Without these configurations, the Mintlify GitHub App will not be able to access your repositories or sync your documentation.
</Warning>
