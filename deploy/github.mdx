...
If you skipped connecting your own Git repository during onboarding, your documentation lives in the `mintlify-community` organization. To move it to your own account or organization:

1. Go to [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) in your dashboard.
2. Click **Clone to your account**.
3. Choose **Public** or **Private** visibility. Public repos allow anyone to view your documentation source and submit issues or suggestions. Private repositories restrict access to your team.
4. Select the destination account or organization.
5. Install the GitHub App when prompted.
