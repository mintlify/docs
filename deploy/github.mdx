...
Install the Mintlify GitHub App from the [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) page of your dashboard.
...
<AccordionGroup>
  <Accordion title="Verify GitHub App installation">
    ...
    1. Check that your repository is on the active app installations list in the GitHub app section.
  </Accordion>
