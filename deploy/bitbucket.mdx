...
<Steps>
  <Step title="Select Bitbucket as your provider">
    1. On the [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) page, select **Connect to Bitbucket**.
    2. Click **Continue**.
  </Step>
  ...
  <Step title="Authorize Bitbucket">
    ...
    2. Bitbucket opens a new page to authorize Mintlify to access your Bitbucket account. Authorize Mintlify to access the repository you want to connect.
...
1. Navigate to [Git Settings](https://app.mintlify.com/settings/deployment/git-settings) page of your Mintlify dashboard.
