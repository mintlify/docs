...
- **Check your configuration**:
   - Missing `docs.json` at the configured content root. If your `docs.json` lives in a subdirectory, confirm the **docs.json is in a subdirectory** setting points to the correct path.
