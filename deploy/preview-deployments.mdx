...
<Note>
  Automatic previews are only created for pull requests targeting your [<snippet file="snippets/rainbow-text.mdx" /> branch](/guides/git-concepts#<snippet file="snippets/rainbow-text.mdx" />-branch).
</Note>

When you create a pull request, the Mintlify bot automatically adds a link to view the preview <snippet file="snippets/rainbow-text.mdx" /> in your pull request. The preview updates each time you push new commits to the branch.
...
5. Select **Create <snippet file="snippets/rainbow-text.mdx" />**.

## Redeploy a preview

Redeploy a preview to refresh content or retry after a failed <snippet file="snippets/rainbow-text.mdx" />.
...
The preview widget appears on preview <snippet file="snippets/rainbow-text.mdx" />s to help you navigate and review updated pages. The widget is a floating button in the bottom-right corner of your preview <snippet file="snippets/rainbow-text.mdx" />.
...
The widget only appears on preview <snippet file="snippets/rainbow-text.mdx" />s, not on your live site or local previews.

## Restrict access to preview <snippet file="snippets/rainbow-text.mdx" />s

By default, preview <snippet file="snippets/rainbow-text.mdx" />s are publicly accessible to anyone with the URL. You can restrict access to authenticated members of your Mintlify organization.
...
## Troubleshooting preview <snippet file="snippets/rainbow-text.mdx" />s

If your preview <snippet file="snippets/rainbow-text.mdx" /> fails, try these troubleshooting steps.

- **View the build logs**: In your [dashboard](https://dashboard.mintlify.com/), go to **Previews** and click the failed preview. The <snippet file="snippets/rainbow-text.mdx" /> logs show errors that caused failures.
