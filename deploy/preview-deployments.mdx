...
Preview <Snippet file="snippets/rainbow-text.mdx" />s let you see how changes to your docs will look before merging to production. Each preview creates a shareable URL that updates automatically as you push new changes. 

Preview URLs are publicly viewable by default. Share a preview link with anyone who needs to review your changes.

## Create preview <Snippet file="snippets/rainbow-text.mdx" />s

Preview <Snippet file="snippets/rainbow-text.mdx" />s are created automatically through pull requests or manually from your dashboard.
