...
5. Optionally, enable **Password protection** and enter a password. Visitors must enter this password to view the preview.
...
Set a password on individual manual previews to restrict access. When enabled, visitors must enter the password before viewing the preview content. You can set a password when [creating a manual preview](#manual-previews).
