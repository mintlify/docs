...
When password protection is enabled, visitors must enter the password before they can view the preview content.
...
By default, preview deployments are publicly accessible to anyone with the URL. You can restrict access in two ways:

- **Organization authentication**: Restrict all previews to authenticated members of your Mintlify organization.
- **Password protection**: Set a password on individual manual previews when creating them.
