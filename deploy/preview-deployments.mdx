...
- **Status badges**: Each file displays a badge indicating whether it was added, modified, or removed
- **Search**: Filter the list of changed files by filename or page title
