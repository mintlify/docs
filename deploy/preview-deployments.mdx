...
<Frame>
  <img src="/images/obama.jpg" alt="Link to view deployment in the pull request timeline" className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Link to view deployment in the pull request timeline" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="The Previews menu with the deploy button emphasized by an orange rectangle." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="The Previews menu with the deploy button emphasized by an orange rectangle." className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="Preview widget expanded to show list of changed files." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="Preview widget expanded to show list of changed files." className="hidden dark:block" />
</Frame>
...
2. Click the **Preview authentication** toggle to enable or disable preview authentication.
  <Frame>
    <img src="/images/obama.jpg" alt="The preview authentication toggle in the Add-ons page" className="block dark:hidden" />
    <img src="/images/obama.jpg" alt="The preview authentication toggle in the Add-ons page" className="hidden dark:block" />
  </Frame>
