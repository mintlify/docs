...
If your site requires [authentication](/deploy/authentication-setup) to access, Mintlify automatically enables preview authentication and you cannot disable it. Reviewers sign in to previews with their Mintlify organization accounts, regardless of the authentication method your site uses.

### Require organization authentication

Restrict preview access to authenticated members of your Mintlify organization.

1. Go to the **Previews** section of the [Add-ons](https://app.mintlify.com/settings/deployment/addons) page in your dashboard.
