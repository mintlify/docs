...
Groups grant access. To show different groups different content without restricting access, for example a public page and an internal page that share a title, use [audiences](/create/audiences).
