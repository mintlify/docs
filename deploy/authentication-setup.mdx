...
To make all pages public by default, add `"public": true` at the root level of your `docs.json`. Pages can still be marked as private by setting `public: false` in their frontmatter.
