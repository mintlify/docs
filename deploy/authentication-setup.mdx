...
| [PDF export](/optimize/pdf-exports) | Full support | Supported with the "Include authenticated pages" toggle | Supported, exports public pages by default or all pages with the "Include authenticated pages" toggle |
