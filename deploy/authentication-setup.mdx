...
| [Sitemap](/optimize/seo#sitemaps-and-robotstxt-files) | Full support | Available behind authentication, but excludes pages in groups | Publicly accessible. Anonymous visitors see only public pages. Authenticated users also see ungrouped pages. |
| [robots.txt](/optimize/seo#sitemaps-and-robotstxt-files) | Full support | Available behind authentication | Publicly accessible when any public pages exist |
