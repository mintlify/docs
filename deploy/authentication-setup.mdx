...
<Steps>
  <Step title="Create a password.">
    ...
    After you enter a password, your site redeploys. When it finishes <snippet file="snippets/rainbow-text.mdx" />ing, anyone who visits your site must enter the password to access your content.
  </Step>
...
<Steps>
  <Step title="Enable Mintlify dashboard authentication.">
    ...
    After you enable Mintlify authentication, your site redeploys. When it finishes <snippet file="snippets/rainbow-text.mdx" />ing, anyone who visits your site must log in to your Mintlify organization to access your content.
  </Step>
...
<Steps>
  <Step title="Configure your OAuth settings.">
    ...
    After you configure your OAuth settings, your site redeploys. When it finishes <snippet file="snippets/rainbow-text.mdx" />ing, anyone who visits your site must log in to your OAuth provider to access your content.
  </Step>
...
<Steps>
  <Step title="Generate a private key.">
    ...
    After you generate a private key, your site redeploys. When it finishes <snippet file="snippets/rainbow-text.mdx" />ing, anyone who visits your site must log in to your JWT authentication system to access your content.
  </Step>
