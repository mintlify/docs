...
<Frame>
  <img src="/images/authentication-dashboard.png" alt="Authentication settings in Mintlify dashboard" />
</Frame>

Select the handshake method that you want to configure.

<Frame>
  <img src="/deploy/images/authentication-tab.png" alt="Authentication settings in Mintlify dashboard" />
</Frame>
