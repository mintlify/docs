...
| :------ | :---------- | :---------------------------------- | :-------------------------------- |
| [llms.txt and llms-full.txt](/ai/llmstxt) | Full support | Available behind authentication, but excludes pages in groups. AI tools may not be able to access the files | Available behind authentication, but excludes pages in groups. AI tools may not be able to access the files |
