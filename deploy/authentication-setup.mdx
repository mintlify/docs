...
| :--- | :--- | :--- | :---: | :---: | :---: |
| Password | Simple shared access with no per-user tracking | Pro or Enterprise | — | — | — |
| Private authentication | Internal docs for members of your Mintlify organization | All plans | — | — | — |
| OAuth 2.0 | Existing identity provider or SSO with per-user sessions | Enterprise | ✓ | ✓ | ✓ |
| JWT | Custom auth backend or embedded docs behind your own login | Enterprise | ✓ | ✓ | ✓ |
