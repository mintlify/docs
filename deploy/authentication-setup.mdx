...
In your dashboard, go to [Authentication](https://app.mintlify.com/products/authentication) and use the **Authentication method** dropdown to select how you want to protect your site:

* **Public site**: No authentication required.
* **Private site**: Restrict access to members of your Mintlify organization.
* **Password protection** (Enterprise): Share a single password with authorized users.
* **Custom authentication** (Enterprise): Connect your own identity provider with JWT or OAuth 2.0.

Each method shows a status badge (`No auth`, `Secured`, or `Configuration needed`) and an inline form for its configuration. Switching to **Public site** when authentication is configured prompts you to confirm before removing the existing settings.
...
<Steps>
  <Step title="Create a password.">
    ...
    2. From the **Authentication method** dropdown, select **Password protection**.
    3. Enter a secure password.
    4. Click **Save changes**.

    After you save your password, your site redeploys. When it finishes deploying, anyone who visits your site must enter the password to access your content.
  </Step>
...
<Steps>
  <Step title="Enable Mintlify dashboard authentication.">
    1. In your dashboard, go to [Authentication](https://app.mintlify.com/products/authentication).
    2. From the **Authentication method** dropdown, select **Private site**.
...
<Steps>
  <Step title="Configure your OAuth settings.">
    1. In your dashboard, go to [Authentication](https://app.mintlify.com/products/authentication).
    2. From the **Authentication method** dropdown, select **Custom authentication**.
    3. Select **OAuth** in the segmented control.
...
<Steps>
  <Step title="Generate a private key.">
    1. In your dashboard, go to [Authentication](https://app.mintlify.com/products/authentication).
    2. From the **Authentication method** dropdown, select **Custom authentication**.
    3. Select **JWT** in the segmented control.
