...
| :------ | :---------- | :---------------------------------- | :-------------------------------- |
| [llms.txt and llms-full.txt](/ai/llmstxt) | Full support | Available behind authentication, so AI tools may not be able to access the files. There is no way to make these files public on an authenticated site. | Available behind authentication, so AI tools may not be able to access the files. There is no way to make these files public on an authenticated site. |
