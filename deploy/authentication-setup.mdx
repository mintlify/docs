...
| :------ | :---------- | :---------------------------------- | :-------------------------------- |
| [llms.txt and llms-full.txt](/ai/llmstxt) | Full support | Available behind authentication, so most AI tools cannot access the files. Cannot be made public. | Available behind authentication, so most AI tools cannot access the files. Cannot be made public. |
