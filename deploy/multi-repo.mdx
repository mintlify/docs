...
<Steps>
  ...
  <Step title="Save changes">
    Select **Save changes**. Mintlify saves the configuration and queues a deployment of the combined site.
  </Step>
</Steps>
...
Keep each source's navigation scoped to that repository. For example, pages in the API repository should reference only files that live in the API repository. Pages in the SDK repository should reference only files that live in the SDK repository.
