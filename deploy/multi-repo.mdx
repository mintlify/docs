...
Mintlify supports `sourceRef` inside `anchors`, `tabs`, `groups`, `pages`, `products`, and arrays under `navigation.global`. Other navigation structures, including `menu` entries inside a tab, don't accept `sourceRef`.
