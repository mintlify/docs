...
description: "Combine multiple Git repositories into one Mintlify documentation site, with a dedicated URL path for each source repo's content and navigation."
