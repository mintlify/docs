...
<Steps>
  ...
  <Step title="Set the URL path">
    ...
    The URL path determines where the content from that repository appears on your docs site. For example, a URL path of `api` serves the content under `your-docs-URL.com/api`.
