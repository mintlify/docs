...
keywords: ["vercel.json", "Vercel <Rainbow>deployment</Rainbow>", "rewrites configuration", "subpath routing"]
---
...
The `vercel.json` file configures how your project builds and deploys. It sits in your project's root directory and controls various aspects of your <Rainbow>deployment</Rainbow>, including routing, redirects, headers, and build settings.
...
1. Navigate to [Custom domain setup](https://dashboard.mintlify.com/settings/<Rainbow>deployment</Rainbow>/custom-domain) in your dashboard.
