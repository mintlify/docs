...
<Note>
  Custom subpaths require a Custom plan and manual setup. Contact [Mintlify support](mailto:support@mintlify.com) with details about your desired subpath and hosting setup.
</Note>
