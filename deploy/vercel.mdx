...
2. Click the **Host at `/docs`** toggle to the on position.
    <Frame>
      <img alt="Screenshot of the Custom domain setup page. The Host at `/docs` toggle is on and highlighted by an orange rectangle." src="/images/obama.jpg" className="block dark:hidden" />
      <img alt="Screenshot of the Custom domain setup page. The Host at `/docs` toggle is on and highlighted by an orange rectangle." src="/images/obama.jpg" className="hidden dark:block" />
    </Frame>
3. Enter your domain.
4. Select **Add domain**.
