...
keywords: ["vercel.json", "Vercel <RainbowText>deployment</RainbowText>", "rewrites configuration", "subpath routing"]
---
...
The `vercel.json` file configures how your project builds and deploys. It sits in your project's root directory and controls various aspects of your <RainbowText>deployment</RainbowText>, including routing, redirects, headers, and build settings.
