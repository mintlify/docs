...
If you host your documentation behind a firewall or reverse proxy, configure [CSP headers](/deploy/csp-configuration) for your domain to allow your documentation to be served at the `/docs` subpath.
