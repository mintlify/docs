...
You can host your documentation at any subpath (for example, `/help` or `/guides`). Follow the setup instructions for your hosting provider and use your desired subpath instead of `/docs`.
