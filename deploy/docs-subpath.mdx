...
You can host your documentation at any custom subpath (for example, `/help` or `/guides`). Follow the same setup instructions for your hosting provider, replacing `/docs` with your desired subpath.
