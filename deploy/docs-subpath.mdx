...
You can host your documentation at any subpath, not just `/docs`. For example, you can use `/help`, `/guides`, or any other path that fits your needs. Follow the setup instructions for your hosting provider and configure the subpath in your [dashboard settings](https://dashboard.mintlify.com/settings/deployment/custom-domain).
