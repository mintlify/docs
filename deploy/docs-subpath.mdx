...
You can host your documentation at any custom subpath (for example, `/help` or `/guides`). Configure your `basePath` in your docs settings and set up your hosting provider to proxy requests to your Mintlify subdomain at the appropriate path.
