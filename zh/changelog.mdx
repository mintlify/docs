...
<div id="editor-and-collaboration">
  ...
  - **Branches v2 与版本历史：** 编辑器分支现在以草稿 pull request 为基础，并自动将更改保存到 Git。您可以重命名或删除分支、丢弃自动保存的更改，以及将待处理更改移动到新分支。分支菜单按最近活动排序、使用按用户区分的分支名称，并为自动生成的分支显示更简洁的 `Draft <date>` 名称。详情请参见 [Branching and publishing](/zh/editor/branching-and-publishing)。
...
<div id="editor-and-collaboration">
  ...
  - **更多协作方式：** 在整个页面上发起[评论线程](/zh/editor/comments)、提及自己以留下提醒，并使用键盘快捷键 <kbd>Option</kbd> + <kbd>C</kbd> 或 <kbd>Option</kbd> + <kbd>S</kbd> 对所选文本发表评论或提出修改建议。
...
<div id="editor-improvements">
  ...
  - **草稿：** 无需创建分支或使用任何 Git 命令，即可处理未发布的更改。有关更多信息，请参阅[草稿](/zh/editor/branching-and-publishing)。
