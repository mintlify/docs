...
<div id="agent-feedback">
  ...
  在部署设置中启用 [agent 反馈](/zh/optimize/feedback#agent-feedback)，允许 agent 提交关于你文档的结构化反馈。启用后，Search MCP 服务器会提供 `submit_feedback` 工具，已连接的 agent 可以使用该工具报告文档问题。该功能作为 beta 功能在仪表板的部署附加组件中提供。
