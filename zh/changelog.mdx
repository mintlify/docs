...
<Update label="2026年8月31日" tags={["新版本"]} rss={{ title:"即时回滚" }}>

<div id="instant-rollbacks">
  ## 即时回滚
</div>

  - 在控制台的[活动](https://app.mintlify.com/activity)页面，将你的在线站点恢复到最近 10 次成功构建中的任意一次。回滚会在几秒内切换站点所服务的构建，无需回退提交或等待重新构建。回滚和提升操作都会记录在你的[审计日志](/zh/dashboard/audit-logs)中。适用于 Enterprise 方案的组织管理员。详情请参见[回滚](/zh/deploy/rollbacks)。
