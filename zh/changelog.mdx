...
<div id="referral-program">
  ...
  - 在 dashboard 的 [Referrals](https://app.mintlify.com/settings/organization/referrals) 页面向 Mintlify 推荐团队。当你推荐的团队开通 Pro 计划时，双方组织都会获得 50,000 个积分。你最多可以通过三次推荐获得推荐积分。适用于 Pro 和 Enterprise 计划。
