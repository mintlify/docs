---
title: "产品更新"
description: "Mintlify 产品更新日志：按时间线记录最新的新功能、平台改进、错误修复与文档工具变更，涵盖编辑器与协作、automations 与集成、AI 助手、API playground 等各方面的发布内容，并支持 RSS 订阅，帮助你及时了解 Mintlify 平台的最新产品动态。"
rss: true
noindex: true
---
