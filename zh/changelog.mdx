...
<Update label="March 6, 2026" tags={["New releases", "Improvements"]} rss={{ title: "从公共 GitHub 仓库自动生成文档、AI 助手多模态支持及更多改进" }}>
  ...
  [默认 Vale 配置](/zh/deploy/ci#configuration)现在将 MDX 解析为 MD，以避免 JSX 相关的脆弱性问题。此前，Vale 会对 MDX 组件内的任何 JSX 返回误报错误。现在，Vale 将 MDX 解析为 MD，并通过 tokenIgnores 和 blockIgnores 来跳过 MDX 和 JSX 元素，从而避免这些错误。
