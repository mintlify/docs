---
title: "产品更新"
description: "及时了解最新的 Mintlify 产品更新、新功能、平台改进、错误修复和文档工具变更，查看每次发布带来的功能、集成、编辑器和部署体验变化。按发布日期浏览更新，并了解影响文档管理、搜索、AI 和协作工作流的改进，快速掌握产品变化和版本记录等信息。"
rss: true
noindex: true
---
...
<div id="mintlify-index">
  ...
  - **访问受控的 REST API：** 搜索排名靠前的来源，在 token 预算内组装上下文，并通过单独的 [REST API 端点](/zh/api/search-index/introduction) 检索选定内容。需要 Index API key。
...
<Update label="January 30, 2026" tags={["New releases", "Improvements"]} rss={{ title: "简化技能安装、焕新的 Analytics 页面、编辑器改进等" }}>
  ...
  改进了 [Analytics](/zh/optimize/analytics) 标签之间的导航，提供更具可操作性的洞察和更出色的数据可视化效果。
  ...
  * 稳定性改进
  ...
  AI 助手现在可以按参数来[筛选](/zh/ai/model-context-protocol#search-filtering-parameters) MCP (Model Context Protocol) 搜索结果。
...
<Update label="2025 年 4 月" tags={["New releases", "Improvements"]}>
  ...
  * 修复尝试取消选择时引用块会继续创建更多引用块的问题
  ...
  为文档带来交互能力。所有标准的 React hooks 在你的 MDX 文件中将自动可用。[了解更多。](/zh/customize/react-components)
</Update>
...
<Update label="2025年2月" tags={["New releases", "Improvements"]}>
  ...
  自动对文档进行 lint，查找失效链接、拼写和语法问题，或使用你自己的 Vale 配置来约束写作风格。详见我们的[文档](/zh/deploy/ci)。
  ...
  新增[预构建主题](/zh/customize/themes)，用于调整文档的外观与体验。可通过你的 [docs.json 文件](/zh/organize/settings) 进行配置。
  ...
  * [Dropdown 组件](/zh/organize/navigation#dropdowns)：除 Tabs 和锚点外，可使用下拉菜单组织导航。
...
<Update label="2024年8月">
  ...
  * [了解更多 API 配置](/zh/organize/settings#api-configurations)
...
<Update label="2024年4月">
  ...
  * 嵌入自定义 iFrame 演示元素，为你的文档增加交互性
  ...
  查看我们的[自定义模式文档](/zh/organize/pages#custom)。
</Update>
