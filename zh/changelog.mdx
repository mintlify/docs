...
<Update label="July 31, 2026" tags={["New releases","Improvements","Bug fixes"]} rss={{ title:"私密页面、Assistant Widget 分析、用户互动等" }}>
...
<div id="new-features">
  ...
  - **用户互动：** [analytics](/zh/optimize/analytics) 中新增的用户互动部分展示互动总数、CTA 点击率和一段时间内的操作，让您可以了解哪些页面能够带来互动。
