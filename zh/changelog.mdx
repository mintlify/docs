...
使用 [dashboard](https://app.mintlify.com/products/workflows) 中的预置模板更快地创建 [workflows](/workflows)。可选择的模板包括：changelog 生成、API 文档同步、功能文档草稿、断链检测、SEO 审计等。模板包含优化的 prompt 和触发器配置，帮助你快速上手。
...
<Update label="December 3, 2025" tags={["New releases"]} rss={{ title: "Assistant query bucketing", description: "Automatically group similar assistant queries to identify common user questions" }}>
  ...
  [Assistant insights](https://app.mintlify.com/products/assistant) 现在会自动将相似的查询聚合为问题类别，帮助你更轻松地识别用户常见的问题模式。
...
<Update label="October 31, 2025" tags={["Improvements"]} rss={{ title: "Weekly Updates", description: "API playground enhancements, table improvements, performance optimizations, and bug fixes" }}>
  ...
  * **Assistant 的入门问题上线了！你可以在仪表盘的 [Assistant --&gt; Settings](https://app.mintlify.com/mintlify/mintlify/products/assistant/settings) 中添加自定义问题**
