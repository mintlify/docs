...
使用 [dashboard](https://dashboard.mintlify.com/products/automations) 中的预置模板更快地创建 [workflows](/automations)。可选择的模板包括：changelog 生成、API 文档同步、功能文档草稿、断链检测、SEO 审计等。模板包含优化的 prompt 和触发器配置，帮助你快速上手。
