...
点击编辑器工具栏中的 **Ask agent**，或按 <kbd>Cmd</kbd> + <kbd>I</kbd>（macOS）或 <kbd>Ctrl</kbd> + <kbd>I</kbd>（Windows）。**Ask agent** 按钮也会显示在 dashboard 的设置页面上，因此在配置设置时智能体仍然可用。智能体可供 editors 和 admins 使用。[Viewers](/zh/dashboard/roles) 看不到 **Ask agent** 按钮。
