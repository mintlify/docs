...
点击编辑器工具栏中的 **Ask agent**，或按 <kbd>Cmd</kbd> + <kbd>I</kbd>（macOS）或 <kbd>Ctrl</kbd> + <kbd>I</kbd>（Windows）。智能体可供 editors 和 admins 使用。[Viewers](/zh/dashboard/roles) 看不到 **Ask agent** 按钮。
