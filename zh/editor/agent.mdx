...
在代理聊天框中输入 `@` 后，可以按标题提及私有页面。代理会将提及解析为对应的 UUID 文件路径，并且只会显示和包含你有权访问的页面。

要创建私有文件夹，请使用人类可读的标题作为路径的最后一段。重新列出私有页面后，新文件夹会显示为 `private-folder-<uuid>` 路径：

```bash
mkdir "/home/daytona/private/<folder-title>"
ls /home/daytona/private
# /home/daytona/private/private-folder-<uuid>
```
...
mv /home/daytona/private/private-folder-<source-uuid> \
  /home/daytona/private/private-folder-<target-uuid>/
```
...
cp /home/daytona/private/private-page-<uuid>.mdx \
  "/home/daytona/private/<new-page-title>"
ls /home/daytona/private
# /home/daytona/private/private-page-<new-uuid>.mdx
```
...
移动操作会将该页面添加到公共导航中，并撤销其私有页面访问权限。你无需配置其他文件系统或授权。代理会自动使用你现有的私有页面权限。
