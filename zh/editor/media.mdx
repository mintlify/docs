...
<Frame>
  <img src="/images/obama.jpg" alt="在编辑器侧边栏菜单中选中的资源管理器。" className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="在编辑器侧边栏菜单中选中的资源管理器。" className="hidden dark:block" />
</Frame>
