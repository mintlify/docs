...
你可以在设置面板中配置这些选项。打开编辑器工具栏中的 <Icon icon="settings" /> 设置图标，然后选择一个部分。
...
当你需要编辑点文件或其他隐藏文件时，启用 **Show hidden files**。Mintlify 会在导航侧边栏中显示这些文件。你也可以在 macOS 上按 <kbd>⌘⇧.</kbd>，或在其他平台上按 <kbd>Ctrl+Shift+.</kbd> 来切换此偏好设置。
