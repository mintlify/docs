...
点击工具栏中的 **Publish**。根据你的工作流，你的更改会立即部署，或者在你的 Git 提供商中为你创建一个拉取请求（PR；亦称“合并请求”/Merge Request），供你合并。如果你在一个功能 branch 上，请在发布前先保存更改。

当没有待处理的更改，或者当前 branch 已经有打开的拉取请求时，**Publish** 按钮会被禁用。
