...
<Frame caption="部署用分支上的更改。">
  <img src="/images/obama.jpg" alt="网页编辑器工具栏，显示一个待处理的更改。" className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="网页编辑器工具栏，显示一个待处理的更改。" className="hidden dark:block" />
</Frame>

当你在功能分支上工作时，可以将更改以<Tooltip headline="Commit" tip="提交是在 Git 中保存你更改快照的操作。">提交</Tooltip>的形式保存到该分支。

<Frame caption="功能分支上的更改。">
<img src="/images/obama.jpg" alt="网页编辑器工具栏，显示一个待处理的更改，以及功能分支上的 Save as commit 按钮。" className="block dark:hidden" />
<img src="/images/obama.jpg" alt="网页编辑器工具栏，显示一个待处理的更改，以及功能分支上的 Save as commit 按钮。" className="hidden dark:block" />
</Frame>
