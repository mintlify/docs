...
<Note>
  Mintlify 构建并部署你已发布的更改后，你的线上文档站点会更新。这通常需要 30 秒到几分钟。你可以在你的 [dashboard](https://app.mintlify.com) 上查看更改的部署状态。
</Note>
...
在你的 [账户设置](https://app.mintlify.com/settings/account) 中授权你的 GitHub 账号，即可用该账号对提交进行签名。若未完成授权，则由 Mintlify GitHub 应用为在网页编辑器中完成的提交进行签名。
