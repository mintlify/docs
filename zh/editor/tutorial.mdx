...
- 一个已连接到 GitHub、GitLab 或 Bitbucket 仓库的 Mintlify 项目。相关设置请参见[连接仓库](/zh/deploy/github)。
- 一个对项目具有编辑器访问权限的账户。如果你无法登录，请让管理员从[成员](https://app.mintlify.com/settings/organization/members)页面邀请你。
- 通过你的 Git 提供商在已连接的仓库中打开拉取请求的权限。
...
<Steps>
  ...
  <Step title="Get your pull request approved">
    将拉取请求分享给你的团队。审查者可以在 GitHub、GitLab 或 Bitbucket 中打开拉取请求，留下评论、请求更改或批准它。
