...
<img className="block dark:hidden my-0 pointer-events-none" src="/images/obama.jpg" alt="浅色模式下的装饰性图像" />

<img className="hidden dark:block my-0 pointer-events-none" src="/images/obama.jpg" alt="深色模式下的装饰性图像" />
