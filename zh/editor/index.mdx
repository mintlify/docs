...
title: "Web 编辑器概览"
sidebarTitle: "概览"
description: "直接在浏览器中创建、编辑和发布文档，支持可视化编辑、实时预览、Git 同步和团队协作工具。"
...
* **可视化与 Markdown 编辑**：可根据你的工作流在可视化和 Markdown 模式之间自由切换。
* **实时预览**：无需创建预览部署即可实时查看更改。
* **可分享的预览链接**：在编辑器中为团队创建预览链接。
* **拖放式导航**：以可视化方式组织站点结构，无需编辑配置文件。
* **Git 同步**：所有更改会自动与文档存储库保持同步。
* **团队协作**：多名团队成员可同时协作，并通过基于分支 (branch) 的工作流开展工作。
* **AI 编辑**：使用 AI 生成、改写和重组内容，无需离开编辑器。
...
<Card title="使用 AI 编辑" icon="sparkles" horizontal href="/zh/editor/inline-ai">
  使用 AI 生成、改写和重组内容。
</Card>
