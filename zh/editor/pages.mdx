...
在编辑内容时实时预览其发布后的效果。编辑器使用浏览器内置的拼写检查功能，在你输入时高亮显示拼写错误的单词。
...
* **添加嵌入内容**：输入 <kbd>/youtube</kbd> 或 <kbd>/loom</kbd> 来嵌入视频，或输入 <kbd>/embed</kbd> 来添加自定义 HTML。详情参见 [Add media](/zh/editor/media)。
