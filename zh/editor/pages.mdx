---
title: "Mintlify Web 编辑器页面完整使用指南：创建、编辑、复制页面并管理文档内容、文件与页面设置"
description: "使用 Mintlify Web 编辑器创建、编辑、复制和配置文档页面，管理 Markdown、MDX、图片、视频、组件、链接与文件，并在可视化模式和 Markdown 模式之间切换。了解如何组织内容、维护页面设置并协作更新文档。适用于需要持续维护和发布文档的团队。"
...
右键单击页面或打开顶部栏中的页面选项菜单，然后选择 **Duplicate**。编辑器会将副本插入原页面之后，并在其标题中添加 `(copy)`。
