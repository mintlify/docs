---
title: "导出 PDF"
description: "将整个文档站点导出为带有可导航目录的单个 PDF 文件，便于离线阅读、分享和打印。本文介绍优化方法和关键指标，帮助你提升文档质量、搜索效果和用户体验。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。请根据项目需求选择合适的配置方式。"
keywords: ["PDF", "离线文档"]
---
