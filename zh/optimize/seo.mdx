...
<Tip>
  如果你的自定义 `robots.txt` 阻止了 `GPTBot`、`ClaudeBot` 或 `PerplexityBot` 等 AI 用户代理，AI 工具将无法爬取你的文档，也无法在回答中引用它。详情请参阅[在 robots.txt 中允许 AI 代理](/zh/guides/geo#allow-ai-agents-in-robotstxt)。
</Tip>
