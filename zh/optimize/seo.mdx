---
title: "SEO（搜索引擎优化）"
description: "了解 Mintlify 自动处理的 SEO 最佳实践，包括元标签生成、站点地图与 robots.txt 文件、语义化 HTML 和移动端优化，并学习如何通过 docs.json 或页面 frontmatter 自定义 meta 标签、Open Graph 属性和规范 URL，提升文档在搜索引擎中的排名。"
