---
title: "流量、智能体和搜索分析"
description: "在 Mintlify 分析仪表板中跟踪网站流量、AI 智能体访问、搜索趋势、助手使用情况和用户反馈，以改进文档内容并评估效果。"
...
**智能体**部分可帮助您了解 AI 智能体如何访问您的文档。该部分显示智能体和人类访客随时间变化的浏览量，并根据所选指标对页面或智能体进行排名。

使用智能体分析可以：

- **监控 AI 流量**：跟踪发布或更新内容后智能体流量的变化。
- **查找智能体最常使用的页面**：在 **Rankings** 中选择 **Agent views**，找出 AI 工具经常访问的页面。
- **识别活跃的智能体**：在 **Rankings** 中选择 **Agent visitors**，查看最常访问您文档的智能体。
- **比较流量来源**：使用 **Rankings** 选择器比较 **Human views**、**Agent views**、**Referrals** 和 **Agent visitors**。

当您的部署拥有 Advanced Analytics 访问权限时，可以使用**智能体**部分。要查看该部分，请打开[分析](https://app.mintlify.com/analytics)并选择 **Agent**。使用日期范围选择器更改报告时间段。
