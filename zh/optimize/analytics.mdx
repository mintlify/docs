---
title: "流量、智能体和搜索分析"
description: "在 Mintlify 分析仪表板中跟踪流量、AI 智能体访问、搜索趋势、助手使用情况和用户反馈，以改进文档内容、发现热门页面并评估效果。使用 Traffic 的 Rankings 指标比较 Human views、Agent views、Referrals 和 Agent visitors。"
...
**Traffic** 部分包含 **Rankings** 卡片。使用其中的指标选择器比较 **Human views**、**Agent views**、**Referrals** 和 **Agent visitors**。
