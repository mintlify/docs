...
当至少存在一个 `skill.md` 文件时，skills 会默认启用。若要完全关闭项目中的 skills 功能，请联系[技术支持](mailto:support@mintlify.com)以禁用 assistant skills 功能。移除 `.mintlify/assistant/skills/` 目录并重新发布也会清空目录列表。
