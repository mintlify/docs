---
title: "使用 AI 助手"
description: "介绍使用 Mintlify AI 助手的各种方式：通过搜索栏按钮、页面底部横栏、键盘快捷键、选中文本、代码块、文件附件或 URL 查询参数打开聊天面板提问，并说明如何在登录 CLI 后于 mint dev 本地预览中测试助手的响应行为、Assistant.md 自定义指令与配置效果。"
