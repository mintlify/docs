---
title: "自定义 AI 助手行为"
description: "通过在文档中添加包含系统指令的 Assistant.md 文件来自定义 AI 助手，塑造其语气、角色定位、关注领域、回答格式与整体响应行为。本文说明 AI 助手的配置方式和使用场景，帮助你改善文档发现和用户支持。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
