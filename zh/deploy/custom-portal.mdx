---
title: "定制开发者门户"
description: "在自托管 Mintlify 之上部署完全定制的开发者门户，由 Mintlify 设计和构建，并通过版本化发布交付。本文说明部署流程、配置要点和故障处理方法，帮助你稳定发布并维护文档站点。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
