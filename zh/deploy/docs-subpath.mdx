---
title: "在子路径下托管文档"
description: "了解将 Mintlify 文档托管在 your-domain.com/docs 等主域名子路径下的多种方式：由 Mintlify 直接管理域名，或使用 Cloudflare Workers、Vercel 重写规则、AWS CloudFront 和 nginx 反向代理，并按托管服务商查看设置说明。"
