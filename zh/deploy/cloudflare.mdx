...
description: "使用 Cloudflare Workers 将 Mintlify 文档托管在 yoursite.com/docs 等子路径下。本指南介绍设置基础路径、创建并配置 Worker 脚本、添加路由与 DNS 记录的完整步骤，并说明如何排查 WAF 和 Bot Fight Mode 引起的 403 错误。"
