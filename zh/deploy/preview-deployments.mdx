---
title: "预览部署"
description: "介绍 Mintlify 的预览部署功能：每个拉取请求都会生成唯一且可共享的预览 URL，让审阅者在合并到生产环境前查看文档更改的实际效果，并随新提交自动更新。内容涵盖自动预览的触发条件、在控制台手动创建分支预览、fork 拉取请求的限制，以及限制访问权限的认证方法。"
...
1. 在控制台的 [附加组件](https://app.mintlify.com/settings/deployment/addons) 页面，进入 **Previews** 部分。
