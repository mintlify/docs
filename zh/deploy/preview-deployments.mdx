...
<Frame>
  <img src="/images/obama.jpg" alt="在拉取请求时间线中查看部署的链接" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="在拉取请求时间线中查看部署的链接" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="“预览”菜单中，部署按钮被橙色矩形高亮显示。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="“预览”菜单中，部署按钮被橙色矩形高亮显示。" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="展开的预览小部件，显示已更改文件列表。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="展开的预览小部件，显示已更改文件列表。" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="附加组件页面中的预览认证开关" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="附加组件页面中的预览认证开关" className="hidden dark:block" />
</Frame>
