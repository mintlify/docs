...
预览小组件会出现在预览部署中，帮助你导航并审查已更新的页面。该小组件以悬浮按钮的形式显示在预览部署页面的右下角。

<Frame>
  <img src="/images/previews/widget-light.png" alt="展开的预览小组件，显示已更改文件的列表。" className="block dark:hidden" />
  <img src="/images/previews/widget-dark.png" alt="展开的预览小组件，显示已更改文件的列表。" className="hidden dark:block" />
</Frame>

1. 点击该小组件，在预览中显示所有新增、修改或删除的文件。
1. 点击某个文件，在对应页面中查看更改内容。
1. 使用搜索栏筛选已更改文件列表。

该小组件只会出现在预览部署中，不会显示在你的线上站点或本地预览中。
