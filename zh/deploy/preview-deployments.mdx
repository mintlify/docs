...
1. 前往你的[控制台](https://app.mintlify.com/)。
2. 选择 **Previews**。
...
1. 在你的[控制台](https://app.mintlify.com/)中选择该预览。
2. 选择**重新部署**。
...
1. 在控制台的 [附加组件](https://app.mintlify.com/products/addons) 页面，进入 **Previews** 部分。
...
* **查看构建日志**：在你的[控制台](https://app.mintlify.com/)中进入 **Previews**，并点击失败的预览。部署日志会显示导致失败的错误。
* **检查配置**：
  * `docs.json` 语法无效
  * 在导航中引用的文件路径缺失或不正确
