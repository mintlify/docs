---
title: "预览部署"
description: "为拉取请求（PR；亦称“合并请求”/Merge Request）获取唯一的预览 URL，以便在合并前审阅更改。"
---
...
预览部署可让你在合并到生产环境之前，先查看文档更改后的实际呈现。每次预览都会生成一个可分享的 URL，并会在你推送新更改时自动更新。 

预览 URL 默认对公众可见。将预览链接分享给任何需要审阅你更改的人。
