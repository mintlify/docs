---
title: "离线导出"
description: "将文档站点导出为自包含的 zip 压缩包，用于离线查看、内部分发或隔离环境托管。本文说明部署流程、配置要点和故障处理方法，帮助你稳定发布并维护文档站点。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。请根据项目需求选择合适的配置方式。"
