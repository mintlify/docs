---
title: "反向代理"
description: "配置自定义反向代理以托管你的文档。"
---

<Note>
  反向代理配置仅适用于[自定义套餐](https://mintlify.com/pricing?ref=reverse-proxy)。
</Note>

要通过自定义反向代理托管文档，你需要配置路由规则、缓存策略和请求头转发。

实施反向代理时，请留意并监控可能出现的 domain 验证、SSL 证书签发、认证流程、性能表现以及 Analytics 跟踪等问题。
