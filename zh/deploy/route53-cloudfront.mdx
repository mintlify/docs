...
sidebarTitle: "AWS"
description: "使用 Route 53 DNS 与 CloudFront CDN 在 AWS 上部署文档。"
---

import Propagating from "/snippets/zh/custom-subpath-propagating.mdx";

要在自定义子路径（例如 `yoursite.com/docs`）下托管文档，并使用 AWS Route 53 和 CloudFront，你需要在 DNS（域名系统）服务商处进行配置，使其指向你的 CloudFront 发行版（distribution）。
