...
sidebarTitle: "AWS"
description: "讲解如何组合使用 AWS Route 53 DNS 与 CloudFront 分发，将 Mintlify 文档托管在自有域名的 /docs 等子路径下。内容涵盖创建 CloudFront 分配、按路径配置缓存行为与源请求策略、允许全部 HTTP 方法，以及 DNS 记录设置的完整步骤。"
