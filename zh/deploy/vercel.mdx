...
sidebarTitle: "Vercel"
description: "通过在 vercel.json 中配置 rewrites 重写规则，将主域名的请求代理到 Mintlify 文档所在的子路径。本指南提供分步配置演练，涵盖基础路径设置、rewrites 语法、代理请求头与 CloudFront 等外部代理场景，以及域名验证和 SSL 证书的常见问题排查。"
