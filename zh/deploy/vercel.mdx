...
2. 将 **Host at `/docs`** 开关切换到开启状态。
    <Frame>
      <img alt="Custom domain setup 页面截图。Host at `/docs` 开关已打开，并用橙色矩形高亮显示。" src="/images/obama.jpg" className="block dark:hidden" />
      <img alt="Custom domain setup 页面截图。Host at `/docs` 开关已打开，并用橙色矩形高亮显示。" src="/images/obama.jpg" className="hidden dark:block" />
    </Frame>
3. 输入你的域名。
4. 选择 **Add domain**。
