...
description: "排查通过 Cloudflare Workers 提供 Mintlify 文档时被拦截的请求并解决 Cloudflare WAF 规则冲突。本文说明部署流程、配置要点和故障处理方法，帮助你稳定发布并维护文档站点。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
