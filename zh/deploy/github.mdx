---
title: "GitHub"
description: "将你的 GitHub 仓库连接到 Mintlify，实现自动部署、拉取请求预览构建和持续文档同步。本文说明部署流程、配置要点和故障处理方法，帮助你稳定发布并维护文档站点。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
...
“编辑建议”和“提交问题”反馈功能仅适用于公开的 GitHub 存储库。如果这些选项在控制台中不可用，请检查你的存储库可见性。
