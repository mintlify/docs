...
<Tip>
  **你是否需要安装 GitHub 应用？**
  ...
  在控制台的 [Git Settings](https://app.mintlify.com/settings/project/git-settings) 页面查看你的存储库。
</Tip>
...
如果你在入门引导过程中跳过了连接自己的 Git 存储库，你的文档目前位于 Mintlify 组织拥有的私有存储库中。若要将其迁移到你自己的账号或组织，请前往控制台中的 [Git Settings](https://app.mintlify.com/settings/project/git-settings)。设置向导将引导你完成整个过程，提供两种选项：
...
在控制台的 [Git settings](https://app.mintlify.com/settings/project/git-settings) 页面安装 Mintlify GitHub 应用。当 GitHub 询问要授予哪些存储库的访问权限时，请选择 **Only select repositories**，然后选择你的文档存储库。
...
在控制台的 [Git Settings](https://app.mintlify.com/settings/project/git-settings) 部分，您可以更改用于构建文档的组织、存储库或 branch。
...
<AccordionGroup>
  <Accordion title="验证 GitHub 应用安装状态">
    ...
    1. 在控制台中前往 [Git settings](https://app.mintlify.com/settings/project/git-settings) 页面。
    1. 确认你的存储库出现在已启用的应用安装列表中。
  </Accordion>
  <Accordion title="检查部署用分支">
    确保你正在推送到正确的 branch。

    1. 前往 [Git 设置](https://app.mintlify.com/settings/project/git-settings)
...
<Steps>
  ...
  <Step title="重新安装 Mintlify 应用">
    1. 在你的 Mintlify 控制台中，前往 [Git Settings](https://app.mintlify.com/settings/project/git-settings) 并安装 GitHub 应用。
