...
<AccordionGroup>
  <Accordion title="一键克隆（推荐）">
    ...
    1. 选择 **GitHub** 作为提供商，然后选择 **Clone**。
    2. 在提示时授权 GitHub。
    3. 选择要创建存储库的 GitHub 组织。
    4. 确认克隆。Mintlify 会将你的文档文件复制到一个新的存储库中。
    5. 可选择安装 Mintlify GitHub 应用以启用自动部署。
  </Accordion>
  <Accordion title="手动设置">
    ...
    2. 选择 **GitHub** 作为提供商，然后选择 **Continue setup**。
    3. 在提示时授权 GitHub。
    4. 选择你的组织、存储库和分支。
...
通过你的[控制台](https://app.mintlify.com/settings/organization/github-app)安装 Mintlify GitHub 应用。
...
<AccordionGroup>
  <Accordion title="验证 GitHub 应用安装状态">
    ...
    1. 在控制台中前往 [GitHub 应用设置](https://app.mintlify.com/settings/organization/github-app)。
...
<Steps>
  <Step title="Navigate to Git Settings">
    前往控制台中的 [Git Settings](https://app.mintlify.com/settings/deployment/git-settings)。
  </Step>
