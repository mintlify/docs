...
<Steps>
  <Step title="查找项目 ID">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="GitLab 控制台的 General Settings 页面，Project ID 已高亮显示。" />
    </Frame>
  </Step>
  <Step title="生成访问令牌">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="GitLab 控制台的 Access tokens 页面，为 Mintlify 配置的设置已高亮显示。" />
    </Frame>
  ...
  <Step title="设置连接">
    ...
    3. 点击 **保存更改**。
    <Frame>
      <img src="/images/obama.jpg" alt="Mintlify 控制台 Git Settings 页面中的 GitLab 配置面板。" className="block dark:hidden" />
      <img src="/images/obama.jpg" alt="Mintlify 控制台 Git Settings 页面中的 GitLab 配置面板。" className="hidden dark:block" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  2. 点击 **Add new webhook**。
    <Frame>
      <img src="/images/obama.jpg" alt="GitLab 控制台中 Webhooks 页面截图。" />
    </Frame>
  </Step>
  ...
  <Step title="获取 webtoken">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="Mintlify 控制台中 GitLab 连接的截图。" className="block dark:hidden" />
      <img src="/images/obama.jpg" alt="Mintlify 控制台中 GitLab 连接的截图。" className="hidden dark:block" />
    </Frame>
  </Step>
  ...
  <Step title="验证 webhook">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="GitLab 控制台中的 Webhook 页面。为 Mintlify 配置的设置被高亮显示。" />
    </Frame>
  </Step>
  <Step title="测试 webhook">
    ...
    <Frame>
      <img src="/images/obama.jpg" alt="GitLab Webhooks 页面截图。“Test” 菜单中的 “Push events” 菜单项被高亮显示。" />
    </Frame>
