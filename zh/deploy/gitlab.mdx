---
title: "GitLab"
description: "了解如何使用访问令牌和 webhook 将 GitLab 仓库连接到 Mintlify，实现推送时自动部署文档并为合并请求生成预览部署。本文提供设置向导的分步说明，涵盖访问令牌创建、webhook 配置、部署分支选择以及连接和同步问题的常见排查方法，并说明自托管实例的注意事项。"
