---
title: "GitLab"
description: "讲解如何使用项目访问令牌和 webhook 将 GitLab 仓库连接到 Mintlify，实现文档自动部署与合并请求的预览部署。内容涵盖查找项目 ID、生成访问令牌并设置角色与作用域、配置部署分支，以及在 Mintlify 控制台完成 Git 设置向导的完整分步操作与配置说明。"
