---
title: "CI 检查"
description: "在 Pro 和 Enterprise 方案中为 GitHub 仓库启用 CI 检查，在部署前对文档进行 lint 并捕捉错误。本文介绍安装 GitHub 应用、在控制台附加组件页面开启检查，以及配置 Warning 或 Blocking 级别、失效链接检测和 Vale 等选项。"
