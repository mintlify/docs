...
<Frame>
    ![CloudFront Distributions 页面，突出显示“Create distribution”按钮。](/images/cloudfront/create-distribution.png)
  </Frame>
...
<Frame>
    ![一个 CloudFront 分发，已高亮显示 “Origins” 标签页。](/images/cloudfront/origins.png)
  </Frame>
...
<Frame>
    ![CloudFront 的 “Create origin” 页面，已高亮显示 “Origin domain” 输入框。](/images/cloudfront/default-origin.png)
  </Frame>

此时，你应当有两个 Origin：一个是 `[SUBDOMAIN].mintlify.app`，另一个是你的预发布 URL。

<Frame>
  ![CloudFront 的 “Origins” 页面包含两个 Origin：一个用于 `mintlify`，另一个用于 `mintlify-landing-page`。](/images/cloudfront/final-origins.png)
</Frame>
...
<Frame>
	![CloudFront 的 "Behaviors" 标签页（已高亮）。](/images/cloudfront/behaviors.png)
</Frame>
...
<Frame>
  ![CloudFront「Create behavior」页面，"Path pattern" 为 "/.well-known/*"，且 "Origin and origin groups" 指向预发布环境的 URL。](/images/cloudfront/well-known-policy.png)
</Frame>
...
<Frame>
  ![CloudFront “General” 标签页，已高亮显示 “Distribution domain name” 的 URL。](/images/cloudfront/preview-distribution.png)
</Frame>
