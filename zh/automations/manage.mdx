---
title: "管理自动化"
description: "介绍如何在 Mintlify 控制台管理自动化：启用、禁用、手动触发和删除自动化，配置仓库、计划与集成触发器、上下文仓库、更新模式和 automerge 选项，涵盖 GitHub 与 GitLab 的前置条件设置，也可通过 mint automations 命令在终端中创建、列出和删除自动化。"
