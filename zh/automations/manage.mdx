...
你可以直接在列表中对结果执行操作。对于等待审查的运行，点击 **Accept** 合并更改，或点击 **Preview** 打开该运行分支的 [preview deployment](/zh/deploy/preview-deployments)。对于失败的结果，点击 **Re-trigger** 重新开始运行。
...
要在编辑器中打开某次运行，请在该运行的 Slack 通知或通知邮件中点击 **View changes**。此选项仅在该运行的 pull request 仍然开启时可用。
