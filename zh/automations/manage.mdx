...
删除自动化是永久性的，会移除其配置和运行历史。预定义自动化无法删除；请改为将其禁用。

1. 在控制台中打开 [Automations](https://app.mintlify.com/products/automations) 页面。
2. 点击自定义自动化旁边的 <Icon icon="settings" /> 设置按钮。
3. 点击 **Delete**。

你也可以在终端中使用 [`mint automations delete`](/zh/cli/commands#mint-automations-delete) 删除自动化。
