---
title: "管理自动化"
description: "从 Mintlify 控制台管理自动化，启用、禁用、触发和删除任务，并配置 GitHub、GitLab 或 Bitbucket 仓库、计划、集成触发器和上下文仓库。了解如何编辑提示词、更新模式、目标语言、拉取请求和自动合并设置，持续监控运行结果并调整项目工作流。"
...
import BitbucketAutomationSetup from '/snippets/zh/bitbucket-automation-setup.mdx';
...
- 对于 Bitbucket：已连接的 Bitbucket 账户（请参见下方[Bitbucket 设置](#bitbucket-setup)）
