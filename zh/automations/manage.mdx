...
删除自动化会将其从你的项目中移除，同时删除其配置和运行历史。如果你之后可能重新启用该自动化，请改为禁用它。

1. 在控制台中打开 [Automations](https://app.mintlify.com/products/automations) 页面。
2. 点击你要删除的自动化旁边的 <Icon icon="settings" /> 设置按钮。
3. 滚动到设置弹窗底部，然后点击 **Delete automation**。
4. 出现提示时确认删除。

你也可以通过 [`mint workflow`](/zh/cli/commands#mint-workflow) 在终端中删除自动化。
