...
title: "自动化概览"
sidebarTitle: "概览"
description: "Mintlify 自动化概览：按计划、仓库推送或已连接集成的事件自动运行 agent 来维护文档内容，同时支持 GitHub 与 GitLab 仓库。本文介绍内容更新、代码变更、自定义计划与集成四种触发器类型，以及 pull request 分组、更新模式等所有自动化共享的核心概念。"
