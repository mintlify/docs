...
title: "自动化概览"
sidebarTitle: "概览"
description: "使用 Mintlify 自动化来自动维护内容。按计划运行 agent，或通过仓库变更和集成事件触发运行。"
keywords: ["automation", "automate", "cron", "agent", "automations"]
boost: 5
---

<Info>
  自动化需要 [Pro 或 Enterprise 方案](https://mintlify.com/pricing?ref=automations)，一个已连接到 [GitHub](/zh/deploy/github) 或 GitLab 的项目，以及管理员角色才能进行配置。
</Info>
