...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">自定义文档外观<br /><br />在 docs.json 中配置 [theme](zh/settings#param-theme)，并从以下主题中选择。</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，布局久经验证，导航直观熟悉。" href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="现代、干净的美学风格，完美适配 AI 和 SaaS 产品。" href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="精致的金融科技主题，为企业级文档提供深度自定义能力。" href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="回归核心要素，带来无干扰的阅读体验。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端质感与等宽字体，呈现 80 年代黑客美学。" href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="卡片式组织与极简设计结合，带来直观的导航体验。" href="https://almond.mintlify.app" />
