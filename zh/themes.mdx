...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，布局成熟、导航亲切易用。" href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="现代、简洁的美学风格，特别适合 AI 与 SaaS 产品。" href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="精致的金融科技风格，为企业级文档提供深度自定义能力。" href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="回归基础，打造专注且无干扰的文档体验。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端氛围，等宽字体呈现 80 年代黑客美学。" href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="卡片式信息组织结合极简设计，带来直观的导航体验。" href="https://almond.mintlify.app" />

    <ThemeCard title="Aspen" value="aspen" description="为复杂导航与自定义组件量身打造的现代文档主题。" href="https://aspen.mintlify.app" />
  </div>
</div>
