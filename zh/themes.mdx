...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，布局成熟可靠，导航直观熟悉。" href="https://mint.mintlify.app" />
    ...
    <ThemeCard title="Willow" value="willow" description="回归本质，带来专注无干扰的文档体验。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端氛围与等宽字体，呈现 80 年代的黑客美学。" href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="卡片式组织与极简设计相结合，带来直观易用的导航。" href="https://almond.mintlify.app" />
