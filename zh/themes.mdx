...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">自定义文档的外观<br /><br />在 docs.json 的 [theme](zh/zh/settings#param-theme) 中进行配置，选择以下任一主题。</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典的文档主题，布局成熟、导航直观，经受时间考验。" href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="现代而简洁的美学风格，完美适配 AI 与 SaaS 产品。" href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="精致的金融科技主题，面向企业文档提供深度定制能力。" href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="回归本质的极简风格，带来无干扰的阅读体验。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端氛围与等宽字体，呈现 80 年代黑客美学。" href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="卡片式组织结合极简设计，带来更直观的导航体验。" href="https://almond.mintlify.app" />
