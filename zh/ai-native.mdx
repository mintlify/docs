...
title: "AI 原生文档"
sidebarTitle: "AI 原生"
description: "了解 Mintlify 的 AI 原生功能如何通过助手、agent、MCP 服务器、llms.txt 和 skill.md 提升文档阅读、内容创作与信息发现体验，并帮助团队维护准确、可供 AI 使用的产品文档。本文还说明这些功能如何帮助用户查找答案、帮助团队编写内容，以及让编码代理获取可靠的产品上下文。"
...
Mintlify 会为你的文档托管 [`llms.txt`](/zh/ai/llmstxt)、[`llms-full.txt`](/zh/ai/llmstxt#llms-fulltxt) 和 [`skill.md`](/zh/ai/skillmd) 文件。这些文件帮助大语言模型在响应用户查询时高效返回相关信息，并为智能代理提供可用能力列表。因此，用户在使用你的产品时能取得更好的效果。
...
<CardGroup>
  ...
  <Card title="Automations" icon="message-circle-plus" href="/zh/automations/index">
