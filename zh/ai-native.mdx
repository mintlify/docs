...
title: "AI 原生文档"
sidebarTitle: "AI 原生"
description: "了解 AI 原生功能如何通过助手、agent 和 MCP 服务器提升文档的阅读、创作和发现体验。本文介绍 AI 原生文档的核心功能、使用场景和工作方式，帮助你改善文档阅读、创作和发现体验。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
