...
除了阅读单个页面，用户还可以在你的文档中与[AI 助手](/zh/ai/assistant)聊天，及时获得问题的答案和相关内容的链接。AI 助手会基于你的文档提供准确信息，帮助用户更好地了解你的产品。你也可以通过[API](/zh/api/assistant/create-assistant-message-v2)将 AI 助手嵌入自定义应用，扩展用户访问你文档的触达渠道。
