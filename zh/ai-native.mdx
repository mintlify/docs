...
title: "AI 原生文档"
sidebarTitle: "AI 原生"
description: "了解 Mintlify 的 AI 原生功能如何全面提升文档的阅读、写作与发现体验：AI 助手实时回答用户问题并提供来源链接，agent 与自动化帮助团队撰写和维护内容，llms.txt、Markdown 导出、上下文菜单与 MCP 服务器让 AI 工具更容易发现和引用你的文档。"
