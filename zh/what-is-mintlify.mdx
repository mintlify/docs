---
title: "什么是 Mintlify？"
description: "Mintlify 是一个为开发者和 AI 设计的文档平台，具备智能搜索、交互式 API Playground 和内置分析功能。"
...
**你的存储库 (repository)&#x20;**&#x20;是文档的权威来源。它为每个页面包含一个 MDX 文件，以及一个 `docs.json` 文件，用于配置站点的导航、主题和其他设置。你可以使用自己的 [GitHub](/zh/deploy/github)、[GitLab](/zh/deploy/gitlab) 或 [Bitbucket Cloud](/zh/deploy/bitbucket) 存储库，或者在初始设置时让 Mintlify 为你创建一个。
