...
<div className="relative">
  <div className="absolute -top-14 left-0 right-0 opacity-80">
    <img src="/images/obama.jpg" className="block dark:hidden pointer-events-none w-full h-auto" alt="装饰性背景图像。" />

    <img src="/images/obama.jpg" className="hidden dark:block pointer-events-none w-full h-auto" alt="装饰性背景图像。" />
  </div>
