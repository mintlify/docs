---
title: "Mintlify 文档简介"
description: "探索 Mintlify 新一代文档平台，了解 AI 原生功能、开箱即用的设计和面向开发者的体验，快速开始创建美观、智能的产品文档。本页介绍平台核心能力、适用场景和入门方向，帮助你选择合适的文档工作流并开始使用 Mintlify。适合首次了解 Mintlify 的开发者、技术写作者和产品团队查阅。"
mode: "frame"
