---
title: "简介"
description: "遇见新一代文档：AI 原生、开箱即用且优雅，为开发者而生。"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="relative z-10 px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      迎接新一代文档：原生 AI，开箱即用、颜值出众，为开发者与团队而生。
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="快速上手" description="按步骤指南操作，仅需数分钟即可部署你的首个文档站点" href="/zh/quickstart" />
      ...
      <HeroCard filename="components" title="组件" description="借助即用型组件构建丰富且交互性强的文档" href="/zh/text" />
    </div>
  </div>
</div>
