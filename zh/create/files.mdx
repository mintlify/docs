---
title: "文件"
description: "从文档仓库直接提供图片、视频、PDF 和数据文件等静态资产，通过站点域名的对应路径访问。本文列出所有方案支持的文件类型与 20 MB 大小限制，介绍推荐的文件结构和引用路径写法，并说明启用认证的站点不支持静态文件服务。例如仓库中的 /images/logo.png 可直接通过站点对应 URL 访问。"
