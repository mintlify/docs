---
title: "文档静态文件"
description: "从你的文档仓库提供图片、视频、PDF 和数据文件等静态资产，支持自动优化和 CDN 分发。本文介绍内容创建步骤和使用要点，帮助你高效编写并维护文档页面。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。请根据项目需求选择合适的配置方式。"
