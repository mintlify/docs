...
<Frame>
  <img src="/images/obama.jpg" alt="浅色模式下显示目录的更新日志。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="深色模式下显示目录的更新日志。" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="浅色模式下的更新日志，已选中 Peppermint 标签筛选器。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="深色模式下的更新日志，已选中 Peppermint 标签筛选器。" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="浅色模式下启用 RSS 订阅按钮的更新日志页面。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="深色模式下启用 RSS 订阅按钮的更新日志页面。" className="hidden dark:block" />
</Frame>
