...
在控制台的 [常规](https://app.mintlify.com/settings/project/general) 页面启用个性化。个性化与完整认证相互排斥。JWT 与 OAuth 认证已经包含个性化功能。

1. 前往控制台的 [常规](https://app.mintlify.com/settings/project/general) 页面。
