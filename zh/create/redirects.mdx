---
title: "重定向"
description: "在 docs.json 中配置 URL 重定向规则，为已移动、重命名或删除的页面保留 SEO 排名并避免失效链接。本文介绍重定向的写法、通配符与部分通配符匹配、避免无限重定向的注意事项、重定向生效时机，以及检查站点无效链接的 CLI 方法。无需修改页面内容即可安全调整站点结构。"
keywords: ["redirects"]
boost: 3
---
