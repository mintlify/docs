---
title: "重定向"
description: "在 docs.json 中配置 URL 重定向规则，为已移动、重命名或删除的文档页面保留 SEO 排名，并防止读者遇到失效链接。本文介绍内容创建步骤和使用要点，帮助你高效编写并维护文档页面。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
keywords: ["redirects"]
boost: 3
---
