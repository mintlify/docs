...
description: "帮助中心文章：为私有 Mintlify 文档站点将 Auth0 设置为 OAuth 2.0 身份提供方，提供授权、令牌、用户信息和登出端点等字段取值对照表，说明如何在 Auth0 中注册回调 Redirect URL，并介绍基于用户组的访问控制配置，适用于 Enterprise 方案。"
