...
description: "介绍如何将 Auth0 设置为私有 Mintlify 文档站点的 OAuth 2.0 身份提供方：将授权、令牌和用户信息端点映射到 Mintlify 的 OAuth 字段、注册回调 URL，并利用 Auth0 的用户组信息实现基于分组的访问控制，适用于 Enterprise 方案。"
