...
在 Mintlify 控制台中，进入 [Access](https://app.mintlify.com/settings/project/authentication) 设置页面，将站点可见性设置为 **Private**，然后选择 **Custom** → **OAuth**。使用以下 Auth0 的取值填写各字段。将 `YOUR_AUTH0_DOMAIN` 替换为你的租户域名。
