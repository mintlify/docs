---
title: "选项卡"
description: "使用 Tabs 选项卡组件将内容组织成可切换的面板，适合展示不同选项、平台版本或编程语言示例。本文介绍 Tabs 与 Tab 的 MDX 语法及属性配置，包括标题和图标等选项。选项卡可与代码块和其他组件嵌套使用，减少页面滚动并保持结构清晰。帮助读者按需查看与自己相关的内容版本。"
