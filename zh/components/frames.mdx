---
title: "Frames"
description: "使用 frame 组件为图片、视频和其他内容添加样式化边框、说明文字和视觉强调效果。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
