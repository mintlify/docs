---
title: "Frames"
description: "使用 Frame 组件为图片、视频和其他内容添加样式化边框与视觉强调效果。本文介绍添加说明文字、在图注中使用 Markdown 格式、嵌入视频的方法以及完整属性参考。Frame 会将内容居中展示，说明文字显示在下方，保持页面视觉一致。组件适用于截图、示意图和演示视频等媒体内容。"
