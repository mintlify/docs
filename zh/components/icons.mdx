---
title: "图标"
description: "使用图标组件将 Font Awesome、Lucide、Tabler、emoji 或自定义来源的图标添加到文档页面，支持尺寸和颜色选项。"
...
使用来自 Font Awesome、Lucide、Tabler、emoji、SVG、外部 URL 或项目文件的图标，丰富你的文档。
...
<ResponseField name="color" type="string">
  icon 的颜色，使用十六进制色值（例如 `#FF5733`）。不适用于 emoji 图标。
</ResponseField>
