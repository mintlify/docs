---
title: "徽章"
description: "使用徽章组件高亮显示状态指示器、版本标签或内联元数据，支持自定义颜色和悬停提示。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
