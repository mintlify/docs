---
title: "颜色"
description: "使用颜色组件展示带有十六进制值和点击复制功能的色板，适用于设计系统和品牌规范文档。"
keywords: ["color", "palette", "colors", "design system", "hex", "rgb", "rgba", "hsl", "oklch"]
boost: 3
---

在文档中使用 Color 组件来展示颜色调色板。以紧凑的网格形式显示颜色，或在带有标签行的表格中进行分组展示。
...
<ResponseField name="title" type="string">
  颜色行的标签。支持[内联 Markdown 格式](/zh/help-center/format-component-titles-with-markdown)，例如 `**bold**`、`*italic*`、`~~strikethrough~~` 和 `` `code` ``。
</ResponseField>
