---
title: "Update"
description: "使用 Update 组件以带日期的结构化时间轴格式展示产品更新、发行说明和更新日志条目。本文介绍 label、description 和 tags 等属性与使用说明，每个条目还会自动生成锚点和 RSS 源条目，适合构建可订阅的产品更新日志页面。组件支持嵌入截图、代码片段和变更列表。"
