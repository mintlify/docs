---
title: "标注框"
description: "使用 Note、Tip、Warning、Info、Check、Danger 等标注框组件在文档中突出显示重要信息。本文展示各类型标注框的效果与 MDX 语法，并介绍如何通过图标和颜色属性创建自定义标注框，让读者在浏览时快速捕捉警告、技巧与注意事项。合理选用类型能让提示语气更明确。"
