---
title: "标注框"
description: "添加 info、note、tip、check、warning、danger 和自定义标注框组件，在文档中突出显示重要信息。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
