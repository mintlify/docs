---
title: "字段"
description: "介绍 Mintlify 字段组件的用法：使用 ParamField 为 API 或 SDK 的 query、path、body 与 header 参数编写文档，使用 ResponseField 描述响应字段，支持类型、必填、默认值与废弃标记等属性，添加后可自动生成 API 操作台，附完整示例与属性参考。"
