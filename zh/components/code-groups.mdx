---
title: "代码分组"
description: "使用 CodeGroup 组件在带标签页的界面中展示多个代码块，方便读者比较不同编程语言的实现或同一任务的替代方案。本文介绍创建代码组的 MDX 语法、语言下拉菜单模式，以及语法高亮和代码块选项的配置，每个代码块需标注语言并提供标题。帮助读者在同一位置快速切换查看多种语言的示例。"
