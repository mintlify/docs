---
title: "示例"
description: "在桌面设备右侧边栏面板中展示代码示例，与 API 文档并排显示请求和响应样本。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
