---
title: "示例"
description: "介绍 Mintlify 的 RequestExample 与 ResponseExample 组件：在桌面端右侧边栏面板中固定展示请求和响应代码示例，形成双栏布局，让用户滚动阅读 API 文档时始终可以看到示例，并说明移动端降级为常规代码块的展示方式、常见用例与固定宽度的注意事项。"
