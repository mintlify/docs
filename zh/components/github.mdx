---
title: "GitHub"
description: "使用 GitHub 组件在文档中嵌入仓库卡片，实时显示仓库描述、star 数量和 fork 数量。本文介绍基础仓库卡片的用法、inset 与 flat 两种变体样式以及完整属性参考，卡片数据自动保持最新，帮助你在页面中推广和链接开源项目仓库。适合在文档中展示 SDK、示例项目或开源库。"
