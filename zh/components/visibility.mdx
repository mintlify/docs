---
title: "Visibility"
description: "使用 visibility 组件向网页界面上的人类用户和 Markdown 输出中的 AI 代理展示不同内容，实现条件渲染。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
