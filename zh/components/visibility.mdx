---
title: "Visibility"
description: "介绍 Mintlify 的 Visibility 组件：为浏览网页的人类读者和处理 Markdown 输出的 AI 代理分别显示不同内容，无需维护多个页面。页面通过示例演示 for=humans 与 for=agents 的条件渲染行为，以及在 .md 页面视图中的相反展示逻辑。"
