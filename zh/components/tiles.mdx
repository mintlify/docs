...
<Tile href="/zh/components/accordions" title="折叠面板" description="两种变体">
  <img src="/images/obama.jpg" alt="折叠面板组件预览" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="折叠面板组件预览（深色模式）" className="hidden dark:block" />
</Tile>
...
<Columns cols={3}>
  <Tile href="/zh/components/accordions" title="Accordion" description="两种样式">
    <img src="/images/obama.jpg" alt="Accordion 组件预览" className="block dark:hidden" />

    <img src="/images/obama.jpg" alt="Accordion 组件预览（深色模式）" className="hidden dark:block" />
  </Tile>
