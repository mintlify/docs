---
title: "概览"
description: "浏览 Mintlify 完整组件库，了解适用于 MDX 页面的各类组件：用折叠面板、选项卡和步骤组织内容，用标注框吸引注意力，展示 AI 提示，控制内容显示隐藏，为 API 编写文档，并通过卡片链接与图片、视频等元素为页面添加视觉上下文。每个组件页面都提供可复制的示例与属性说明。"
keywords:
