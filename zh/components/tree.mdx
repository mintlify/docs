---
title: "树"
description: "使用 Tree 树组件显示层级文件与文件夹结构，支持可折叠节点和路径名语法高亮。本文介绍 Markdown 列表语法、基础目录结构与嵌套文件夹的写法，以及突出显示当前路径、自定义高亮颜色和键盘导航等功能，适合展示项目目录或仓库布局。组件还提供 Tree.Folder 与 Tree.File 的属性参考。"
