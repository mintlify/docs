---
title: "折叠面板"
description: "使用折叠面板组件在文档中显示和隐藏内容区块、组织相关信息，并实现渐进式信息披露。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
