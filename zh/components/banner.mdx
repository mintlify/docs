---
title: "横幅"
description: "在文档站点每个页面顶部添加横幅，用于显示重要公告、发行说明或全站通知。本文介绍横幅的 docs.json 配置、可关闭选项、type 与 color 外观属性，以及针对多语言站点的语言特定横幅和回退行为，帮助你向所有访客传达产品更新与重要变更。横幅默认使用主题颜色，也可完全自定义背景。"
