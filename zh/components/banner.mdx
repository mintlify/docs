...
使用横幅在整个文档站点显示重要的公告、更新或通知。横幅会出现在每个页面顶部，支持 Markdown 格式，并可设置为可关闭。
...
<CodeGroup>
  ...
  "banner": {
    "content": "🚀 Version 2.0 is now live! 查看我们的[更新日志](/changelog)了解详情。",
    "dismissible": true 
  }
  ```
  ...
  "banner": {
    "content": "⚠️ 计划维护：API 将于 12 月 15 日 UTC 时间凌晨 2:00–4:00 暂停服务",
    "dismissible": false
  }
  ```
