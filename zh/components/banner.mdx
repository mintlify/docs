---
title: "横幅"
description: "介绍如何在 docs.json 中使用 banner 属性为 Mintlify 文档站点每个页面顶部添加横幅：展示重要公告、维护通知或发行说明，支持 Markdown 格式、warning 与 critical 外观类型、自定义浅色与深色背景颜色以及可关闭设置，附产品公告等多种配置示例。"
