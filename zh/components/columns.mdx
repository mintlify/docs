---
title: "列"
description: "使用 columns 组件将卡片和其他组件排列在响应式多列网格布局中，支持自定义列数。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
