---
title: "提示"
description: "使用 Prompt 组件在文档中展示预置的 AI 提示词，提供一键复制按钮和在 Cursor 中打开的集成入口。本文介绍该组件的使用场景、示例效果以及完整属性参考，适合引导读者用 AI 快速生成配置、代码或迁移方案等常见任务内容。让文档内容与读者的 AI 工作流衔接得更加顺畅自然。"
