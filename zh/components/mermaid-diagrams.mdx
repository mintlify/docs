---
title: "Mermaid"
description: "使用 Mermaid 语法在文档中创建流程图、序列图、甘特图等可视化图表并自动渲染。本文介绍 Mermaid 代码块的编写方式、ELK 布局支持、缩放平移等交互式控件以及相关属性配置，帮助你直观展示系统架构、流程和数据关系。支持的图表类型还包括类图、状态图、实体关系图和用户旅程图等。"
