---
title: "Mermaid"
description: "使用 Mermaid 语法在文档中创建流程图、序列图和其他可视化图表，并自动渲染。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
