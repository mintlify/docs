---
title: "工具提示"
description: "添加工具提示，在用户悬停在文档中的术语、缩写或技术概念上时显示上下文定义和解释。本文说明组件的使用方法、关键属性和注意事项，帮助你在 Mintlify 页面中快速应用并持续维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
