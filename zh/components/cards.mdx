---
title: "卡片"
description: "使用 Card 卡片组件以可视化容器展示链接、图标和分组内容。本文介绍基础卡片、水平布局、图片卡片、自定义 CTA 链接卡片和类型化卡片等样式变体，以及通过 Columns 分组卡片的方法和完整属性参考，卡片可跳转到内部页面或外部链接。帮助你构建首页导航、功能入口和相关链接区块。"
keywords: ["卡片", "可视化容器"]
boost: 3
---
