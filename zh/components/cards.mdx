...
<Card title="Card title" icon="text" href="/zh/zh/components/columns">
...
<Card title="Link card" icon="link" href="/zh/zh/components/columns" arrow="true" cta="Click here">
...
使用 [Columns 组件](/zh/zh/components/columns) 将多个卡片并排排列。
