...
<Frame>
  <img src="/images/obama.jpg" alt="Mintlify 控制台 Overview 页面。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="Mintlify 控制台 Overview 页面。" className="hidden dark:block" />
</Frame>
  ...
  <Tab title="网页编辑器">
    <Steps>
      ...
      <Step title="编辑页面">
        ...
        <Frame>
          <img src="/images/obama.jpg" alt="在网页编辑器中打开的 Introduction 页面，其中说明已编辑为 Hello world!。" className="block dark:hidden" />

          <img src="/images/obama.jpg" alt="在网页编辑器中打开的 Introduction 页面，其中说明已编辑为 Hello world!。" className="hidden dark:block" />
        </Frame>
      </Step>
