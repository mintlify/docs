...
<Tip>
  ...
  运行 `npx skills add https://mintlify.com/docs` 来添加 Mintlify [skill](/zh/ai/skillmd)。

  该 skill 会配置 AI 编码工具，使其理解 Mintlify 项目结构、组件以及文档最佳实践。在让 AI 工具更新文档之前添加该 skill，可以获得更好的效果。
</Tip>
