---
title: "快速入门"
description: "使用 Mintlify，在几分钟内部署文档站点，并通过网页编辑器或 Git 完成首次内容修改。学习如何连接 GitHub 存储库、配置自动部署、预览更改、发布页面，并继续自定义文档站点。了解如何使用 CLI 在本地编辑，也可以直接在浏览器中更新页面，并与团队分享已上线的网站。"
...
<Card title="从源代码仓库生成文档" icon="sparkles" horizontal href="/zh/generate-docs-from-source">
  使用现有 GitHub 仓库或网站作为 AI 生成文档的只读上下文。
</Card>
