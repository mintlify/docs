...
<Tip>
  ...
  复制下面的提示词，以添加 Mintlify [skill](/zh/ai/skillmd) 和 Mintlify Model Context Protocol（MCP）服务器（[MCP 服务器](/zh/ai/model-context-protocol)），在更新文档时获得更好的效果。
</Tip>
...
<Tip>
  如果你的代码或文档已经在一个公开的 GitHub 仓库中，可以[自动生成你的文档站点](https://mintlify.com/explore)。
...
完成初始设置后，你的文档站点会部署并可通过你的 `.mintlify.app` URL 访问。
