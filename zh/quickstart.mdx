...
<AccordionGroup>
  <Accordion title="可选：在初始设置中跳过连接 Git 提供商">
    ...
    这样你可以立即使用 Web 编辑器。如果你之后想使用自己的存储库，请前往仪表板中的 [Git 设置](https://dashboard.mintlify.com/settings/deployment/git-settings)，使用 Git 设置向导迁移你的内容。详情请参阅[克隆到你自己的存储库](/zh/deploy/github#clone-to-your-own-repository)。
  </Accordion>
</AccordionGroup>
