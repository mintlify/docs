---
title: "快速入门"
description: "使用 Mintlify，在几分钟内部署文档站点，并通过网页编辑器或 Git 完成首次内容修改。"
...
<Prompt
  description="安装 Mintlify skill，以获取 Mintlify 项目结构、组件和文档最佳实践的上下文信息：

npx skills add https://mintlify.com/docs

然后添加 Mintlify Model Context Protocol（MCP）服务器，以便访问文档搜索功能。按照 https://www.mintlify.com/docs/ai/model-context-protocol.md 上的安装说明进行设置。"
  actions={["copy", "cursor"]}
>
  ...
  然后添加 Mintlify MCP 服务器，以便访问文档搜索功能。按照 https://www.mintlify.com/docs/ai/model-context-protocol.md 上的安装说明进行设置。
</Prompt>
...
<Tip>
  如果你的代码或文档已经托管在公共 GitHub 存储库中，可以改为[自动生成你的文档站点](https://mintlify.com/explore)。

  只需将任何公共存储库 URL 中的 `github.com` 替换为 `mintlify.com`：
...
在 [控制台](https://app.mintlify.com/) 的 **Overview** 页面中可以找到准确的 URL。
...
<Tabs>
  <Tab title="CLI">
    <Steps>
      ...
      <Step title="推送你的更改">
        ...
        Mintlify 会自动部署你的更改。你可以在控制台的 [Overview](https://app.mintlify.com/) 页面查看部署状态。
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="网页编辑器">
    <Steps>
      <Step title="打开网页编辑器">
        在控制台中前往 [web editor](https://app.mintlify.com/editor)。
      </Step>
      ...
      <Step title="查看线上效果">
        在控制台的 [Overview](https://app.mintlify.com/) 页面中，你可以查看站点的部署状态。部署完成后，刷新你的文档站点即可看到最新的变更。
      </Step>
    </Steps>
  </Tab>
</Tabs>
