---
title: "llms.txt"
description: "自动生成 llms.txt 和 llms-full.txt 文件，使 ChatGPT 和 Claude 等 AI 工具能够索引并理解你的文档。本文介绍 AI 工具与 Mintlify 文档的集成方式和使用场景，帮助你配置 AI 工作流并维护内容。这些说明适合开发者和文档维护者查阅。"
