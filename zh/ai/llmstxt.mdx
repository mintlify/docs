---
title: "llms.txt"
description: "介绍 Mintlify 自动生成并托管的 llms.txt 和 llms-full.txt 文件：帮助 ChatGPT、Claude 等 AI 工具和大语言模型索引你的文档，讲解文件结构、HTTP 发现标头、/_llms 拆分索引、身份验证行为，以及如何在项目根目录用自定义文件覆盖自动生成版本。"
