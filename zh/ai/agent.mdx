...
在控制台中，你可以通过键盘快捷键 <kbd>⌘</kbd>+<kbd>I</kbd>（Mac）或 <kbd>Ctrl</kbd>+<kbd>I</kbd>（Windows/Linux），或者点击 **Ask agent** 按钮，直接打开助手面板。
...
<Frame>
  <img src="/images/agent/dashboard-light.png" alt="浅色模式下的助手面板。" className="block dark:hidden" style={{ maxHeight: '500px' }} />

  <img src="/images/agent/dashboard-dark.png" alt="深色模式下的助手面板。" className="hidden dark:block" style={{ maxHeight: '500px' }} />
</Frame>
