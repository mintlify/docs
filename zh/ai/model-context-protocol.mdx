...
你可以在控制台中的 [MCP 服务器页面](https://app.mintlify.com/products/mcp) 查看并复制你的 MCP 服务器 URL。
...
<Steps>
  <Step title="在你的控制台中启用 MCP 认证">
    1. 前往你的控制台中的 [MCP 服务器页面](https://app.mintlify.com/products/mcp)。
...
你可以在控制台中的 [MCP 服务器页面](https://app.mintlify.com/products/mcp) 管理你的客户端凭据。
  ...
  <Tab title="Claude">
    <Steps>
      <Step title="获取你的 MCP 服务器 URL。">
        前往[控制台](https://app.mintlify.com/products/mcp)，找到你的 MCP 服务器 URL。
      </Step>
