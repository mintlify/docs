...
| 每个文档站点的 Get page (domain) | 每小时 10,000 个请求 | 限制所有用户在你的 MCP 服务器上的 get page 工具调用总次数。 |
| 每个文档站点的认证 Search (domain) | 每小时 5,000 个请求 | 限制所有用户在你的 MCP 服务器上的认证搜索工具调用总次数。 |
| 每个文档站点的认证 Get page (domain) | 每小时 5,000 个请求 | 限制所有用户在你的 MCP 服务器上的认证 get page 工具调用总次数。 |
