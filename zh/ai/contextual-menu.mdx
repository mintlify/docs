---
title: "上下文菜单"
description: "为你的文档添加上下文菜单，一键集成 ChatGPT、Claude、Perplexity、Google AI Studio、Devin、Devin Desktop 和 MCP 工具。本文介绍 AI 工具与 Mintlify 文档的集成方式和使用场景，帮助你配置 AI 工作流并维护内容。"
