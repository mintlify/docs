...
上下文菜单可快速访问经 AI 优化的对象，并可直接对接主流 AI 工具。用户在任意页面打开上下文菜单时，可以将对象复制并作为 AI 工具的 context，或在 ChatGPT、Claude、Perplexity，或你自定义的工具中开启对话，并将你的文档预先加载为 context。
...
上下文菜单包含多项内置选项，你可以通过将其标识符添加到配置中来启用。
