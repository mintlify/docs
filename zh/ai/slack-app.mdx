---
title: "Slack app"
description: "在你的 Slack 工作区添加一个可搜索文档并解答问题的机器人"
icon: "slack"
---
...
Slack app 会在你的 Slack 工作区中添加一个名为 `@mintlify` 的机器人，它可以搜索你的文档并解答用户的问题。该机器人会响应私信、@提及，以及在名为 `#ask-ai` 的频道中提出的任何问题。
