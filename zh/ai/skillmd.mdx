---
title: "skill.md"
description: "通过自动生成的 skill.md 能力文件，让你的文档随时可供 AI 智能体使用，并向其描述产品可用的能力。本文介绍 AI 工具与 Mintlify 文档的集成方式和使用场景，帮助你配置 AI 工作流并维护内容。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
