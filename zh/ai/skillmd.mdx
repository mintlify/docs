...
<Note>
  如果你使用[反向代理](/zh/deploy/reverse-proxy)，请将其配置为将对
  `/skill.md`、`/.well-known/skills/*` 和 `/.well-known/agent-skills/*`
  路径的请求转发到你的 Mintlify 子域。
</Note>
...
<Tip>
  向你的用户讲解如何将 `skill.md` 文件与代理配合使用，以便他们在结合你的产品使用
  AI 工具时获得更好的效果。
</Tip>
