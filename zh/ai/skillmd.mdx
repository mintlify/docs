...
Mintlify 在 `/.well-known/skills/` 托管一个 skills 目录，代理可以使用它以编程方式发现和获取你的 skill 文件。
...
`GET /.well-known/skills/{name}/skill.md` 返回特定 skill 的 `skill.md` 文件，通过索引中的 slug 化名称来标识。
