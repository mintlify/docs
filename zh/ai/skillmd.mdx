...
<Note>
  如果你使用 [反向代理](/zh/deploy/reverse-proxy)，请将其配置为将 `/.well-known/skills/*` 和 `/.well-known/agent-skills/*` 路径的请求转发到你的 Mintlify 子域。
</Note>
...
| `description` | 来自你 `skill.md` frontmatter 的简要描述。 |
