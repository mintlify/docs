---
title: "skill.md"
description: "介绍 Mintlify 自动生成并托管的 skill.md 能力文件：向 AI 智能体描述你的产品可执行的操作、所需输入和约束条件，讲解文件结构、frontmatter 字段、自定义与多个 skill 文件、按用户组限制技能、skills 发现端点以及 A2A agent 卡片。"
