...
<Frame>
  <img src="/images/obama.jpg" alt="控制台中的 AI 助手状态开关。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="控制台中的 AI 助手状态开关。" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="控制台中的 AI 助手分流面板。助手分流已开启，且将 support@mintlify.com 设为分流邮箱。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="控制台中的 AI 助手分流面板。助手分流已开启，且将 support@mintlify.com 设为分流邮箱。" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="控制台中启用的 AI 助手搜索域名面板。AI 助手被配置为搜索 mintlify.com/pricing 这个域名。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="控制台中启用的 AI 助手搜索域名面板。AI 助手被配置为搜索 mintlify.com/pricing 这个域名。" className="hidden dark:block" />
</Frame>
...
通过添加示例问题，帮助用户借助 AI 助手开始对话。你可以添加常见问题，或与希望用户了解的主题相关的问题。点击 **Ask AI**，即可根据你的文档获取推荐问题。

<Frame>
  <img src="/images/obama.jpg" alt="控制台中的搜索建议面板，已启用示例问题，并填充了三个问题。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="控制台中的搜索建议面板，已启用示例问题，并填充了三个问题。" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="浅色模式下，高亮文本上方的 Add to assistant 按钮。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="深色模式下，高亮文本上方的 Add to assistant 按钮。" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="浅色模式下代码块中的 Ask AI 按钮。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="深色模式下代码块中的 Ask AI 按钮。" className="hidden dark:block" />
</Frame>
