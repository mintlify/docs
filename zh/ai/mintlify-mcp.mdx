...
description: "让 Claude、ChatGPT、Cursor 等 AI 工具获得 Mintlify 内容和控制台的写入权限，从而编辑页面、更新设置、管理导航、创建工作流、运行任务并提交拉取请求，同时通过分支和审阅流程安全协作。本文介绍连接方式、可用能力、访问范围以及使用管理员 MCP 时需要注意的安全事项。"
...
| **端点** | `https://mcp.mintlify.com` | 位于你的站点域名上的 `/mcp` | `https://index.mintlify.com/mcp` |
