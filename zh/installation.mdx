...
<img className="block dark:hidden my-0 pointer-events-none" src="/images/obama.jpg" alt="用于表示 CLI 的装饰性图形。" />

<img className="hidden dark:block my-0 pointer-events-none" src="/images/obama.jpg" alt="用于表示 CLI 的装饰性图形。" />
