---
title: "自定义脚本"
description: "为你的文档站点添加自定义 JavaScript 和 CSS 脚本，用于分析、小组件、样式覆盖和第三方集成。本文说明相关配置步骤、可选项和注意事项，帮助你自定义站点并保持品牌体验。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
