---
title: "自定义脚本"
description: "了解如何通过自定义 CSS 和 JavaScript 全面定制 Mintlify 文档站点的外观与行为：使用 Tailwind CSS 类设置元素样式，添加自动加载的 .css 与 .js 文件，实现样式覆盖、分析统计和第三方集成，并配置 API Playground 服务器变量。"
