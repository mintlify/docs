...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">自定义文档的外观<br /><br />在 docs.json 中配置 [theme](zh/settings#param-theme)，从以下主题中选择。</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典的文档主题，沿用久经考验的布局与熟悉的导航。" href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="现代、清爽的设计风格，非常适合 AI 与 SaaS 产品。" href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="精致的金融科技主题，提供深度可定制能力，适用于企业级文档。" href="https://palm.mintlify.app" />
    ...
    <ThemeCard title="Almond" value="almond" description="卡片式信息组织结合极简设计，导航直观易用。" href="https://almond.mintlify.app" />

    <ThemeCard title="Aspen" value="aspen" description="为复杂导航与自定义组件打造的现代化文档主题。" href="https://aspen.mintlify.app" />
  </div>
</div>
