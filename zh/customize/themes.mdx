...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Sequoia" value="sequoia" description="极简优雅的布局，专为大规模、以内容为核心的文档设计。" href="https://sequoia.mintlify.app" />

    <ThemeCard title="Luma" value="luma" description="干净、极简的设计，为精致的文档体验而生。" href="https://luma.mintlify.app" />
  </div>
</div>
