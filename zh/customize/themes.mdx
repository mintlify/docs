---
title: "主题"
description: "浏览 Mintlify 提供的全部文档主题，包括 Mint、Maple、Palm、Willow、Linden、Almond、Aspen 和 Sequoia，每个主题都附带预览图、风格说明及在线预览链接。在 docs.json 中配置 theme 属性即可切换主题，自定义文档站点的整体外观。"
mode: "frame"
