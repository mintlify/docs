...
1. 在控制台前往 [Custom domain setup](https://app.mintlify.com/settings/deployment/custom-domain) 页面。
...
1. 进入控制台中的[自定义域名设置](https://app.mintlify.com/settings/deployment/custom-domain)页面。
2. 找到处于待验证状态的自定义域名。
