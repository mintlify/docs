---
title: "自定义 404 页面"
description: "自定义文档站点 404 错误页面的标题、描述和外观，以匹配你的品牌风格并引导访客。本文说明相关配置步骤、可选项和注意事项，帮助你自定义站点并保持品牌体验。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。请根据项目需求选择合适的配置方式。"
