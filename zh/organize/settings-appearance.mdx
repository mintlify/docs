---
title: "外观与品牌"
description: "在 docs.json 中配置主题、颜色、logo、favicon、字体和背景。本文说明配置字段、使用场景和维护要点，帮助你组织内容并管理文档站点。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。请根据项目需求选择合适的配置方式。"
