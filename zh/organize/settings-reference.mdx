...
**支持的语言代码：** `ar`、`ca`、`cn`、`cs`、`de`、`en`、`es`、`fr`、`fr-CA`、`fr-ca`、`he`、`hi`、`hu`、`id`、`it`、`ja`、`ja-jp`、`jp`、`ko`、`lv`、`nl`、`no`、`pl`、`pt`、`pt-BR`、`ro`、`ru`、`sv`、`tr`、`uk`、`uz`、`vi`、`zh`、`zh-Hans`、`zh-Hant`
...
| `integrations.koala.publicApiKey` | string (最小 2) | 是 | Koala 公开 API key。 |
