  ...
  <Expandable title="navigation.global">
    <ResponseField name="tabs" type="object 数组">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="href" type="string (uri)" required>
          标签页目标的 URL、路径或锚点链接。支持绝对 URL、以 `/` 开头的相对路径和以 `#` 开头的哈希链接。
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="anchors" type="object 数组">
      ...
      <Expandable title="anchors">
        ...
        <ResponseField name="href" type="string (uri)" required>
          锚点目标的 URL、路径或锚点链接。支持绝对 URL、以 `/` 开头的相对路径和以 `#` 开头的哈希链接。
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="dropdowns" type="object 数组">
      ...
      <Expandable title="dropdowns">
        ...
        <ResponseField name="href" type="string (uri)" required>
          下拉菜单目标的 URL、路径或锚点链接。支持绝对 URL、以 `/` 开头的相对路径和以 `#` 开头的哈希链接。
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="languages" type="object 数组">
      ...
      <Expandable title="languages">
        ...
        <ResponseField name="href" type="string (uri)" required>
          指向文档此语言版本的有效路径、外部链接或锚点链接。支持绝对 URL、以 `/` 开头的相对路径和以 `#` 开头的哈希链接。
        </ResponseField>
      </Expandable>
    </ResponseField>
    ...
    <ResponseField name="versions" type="object 数组">
      ...
      <Expandable title="versions">
        ...
        <ResponseField name="href" type="string (uri)" required>
          指向文档此版本的 URL、路径或锚点链接。支持绝对 URL、以 `/` 开头的相对路径和以 `#` 开头的哈希链接。
        </ResponseField>
      </Expandable>
    </ResponseField>
