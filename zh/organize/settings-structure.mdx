    ...
    <ResponseField name="tabs" type="object 数组">
      ...
      <Expandable title="tabs">
        ...
        <ResponseField name="searchable" type="boolean">
          当 `hidden` 为 `true` 时，设置 `searchable: true` 可让下属页面继续出现在搜索、站点地图、`llms.txt` 以及 AI 助手中。请参阅[隐藏页面](/zh/organize/hidden-pages#keep-hidden-pages-discoverable-with-searchable)。
        </ResponseField>
