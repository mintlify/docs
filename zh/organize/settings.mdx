...
<ResponseField name="styling" type="object">
  ...
  <Expandable title="Styling">
    <ResponseField name="eyebrows" type="&#x22;section&#x22; | &#x22;breadcrumbs&#x22;">
      页面“眉头”样式。选择 `section` 显示所属章节名称，或选择 `breadcrumbs` 显示完整导航路径。默认值为 `section`。
    </ResponseField>
    ...
    <ResponseField name="codeblocks" type="&#x22;system&#x22; | &#x22;dark&#x22; | string | object">
      ...
      * 使用对象分别为 light 和 dark 模式指定 [Shiki 主题](https://shiki.style/themes)
      ...
      <ResponseField name="theme" type="string">
        在 light 和 dark 两种模式下通用的 Shiki 主题名称。
...
<ResponseField name="导航" type="object" required>
  ...
  <Expandable title="导航">
    ...
    <ResponseField name="版本" type="array of object">
      用于具有多个[版本](zh/organize/navigation#versions)的网站的版本切换器。
    </ResponseField>

    <ResponseField name="Tabs" type="array of object">
      顶层导航的 [选项卡](zh/organize/navigation#tabs)。
    </ResponseField>
    ...
    <ResponseField name="下拉菜单" type="array of object">
      用于将相关内容分组的[Dropdowns](zh/organize/navigation#dropdowns)。
    </ResponseField>

    <ResponseField name="产品" type="array of object">
      为包含多个[产品](zh/organize/navigation#products)的网站提供产品切换器。
    </ResponseField>

    <ResponseField name="groups" type="array of object">
      [groups](zh/organize/navigation#groups) 用于将内容组织到各个部分。
    </ResponseField>

    <ResponseField name="页面" type="array of string or object">
      构成你文档的各个[页面](zh/organize/navigation#pages)。
    </ResponseField>
  </Expandable>
</ResponseField>
