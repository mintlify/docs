    ...
    <ResponseField name="sidebar" type="object">
      ...
      <Expandable title="Sidebar">
        <ResponseField name="items" type="&#x22;container&#x22; | &#x22;card&#x22; | &#x22;border&#x22; | &#x22;undecorated&#x22;">
          侧边栏导航项的视觉样式。选择 `container` 显示带有微妙背景的分组项，`card` 显示悬浮卡片样式项，`border` 显示带有微妙边框的项，或 `undecorated` 显示极简样式。默认值因主题而异。
        </ResponseField>
      </Expandable>
    </ResponseField>
    <ResponseField name="topbar" type="object">
      ...
      <Expandable title="Topbar">
        <ResponseField name="style" type="&#x22;gradient&#x22; | &#x22;default&#x22;">
          导航栏的视觉样式。选择 `gradient` 应用渐变背景效果，或选择 `default` 使用标准样式。默认为 `default`。
        </ResponseField>
      </Expandable>
    </ResponseField>
