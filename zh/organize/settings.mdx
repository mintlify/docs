...
<ResponseField name="API" type="object">
  ...
  <Expandable title="API">
    ...
    <ResponseField name="操作台" type="object">
      ...
      <Expandable title="Playground">
        <ResponseField name="display" type="&#x22;interactive&#x22; | &#x22;simple&#x22; | &#x22;none&#x22; | &#x22;auth&#x22;">
          API 操作台的显示模式。默认为 `interactive`。使用 `auth` 时，仅对已通过身份验证的用户显示操作台。
        </ResponseField>
    ...
    <ResponseField name="url" type="&#x22;full&#x22;">
      端点头部中基础 URL 的显示模式。设置为 `full` 可在每个端点页面始终显示完整的基础 URL。默认情况下，仅当有多个基础 URL 可供选择时才会显示基础 URL。
    </ResponseField>
    ...
    <ResponseField name="示例" type="object">
      ...
      <Expandable title="Examples">
        <ResponseField name="languages" type="array of string">
          自动生成的 API 代码片段所使用的示例语言。参阅[支持的语言](/zh/api-playground/overview#all-supported-languages)获取完整的可用语言和别名列表。
        </ResponseField>
    ...
    <ResponseField name="规范" type="object">
      OpenAPI 规范的配置。

      <Expandable title="规范">
        <ResponseField name="download" type="boolean">
          是否在 API 参考页面上为 OpenAPI 规范显示下载按钮。默认为 `false`。
        </ResponseField>
      </Expandable>
    </ResponseField>
