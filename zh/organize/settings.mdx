...
<ResponseField name="导航" type="object" required>
  ...
  <Expandable title="导航">
    ...
    <ResponseField name="语言" type="array of object">
      适用于[多语言](zh/organize/navigation#languages)站点的语言切换器。
    </ResponseField>
    ...
    <ResponseField name="产品" type="array of object">
      适用于包含多个[产品](zh/organize/navigation#products)的网站的产品切换器。
    </ResponseField>

    <ResponseField name="groups" type="array of object">
      [groups](zh/organize/navigation#groups) 用于将内容组织成各个部分。
    </ResponseField>
