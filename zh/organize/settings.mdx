---
title: "全局设置"
description: "docs.json 是 Mintlify 文档站点的核心配置文件，控制导航结构、视觉品牌、集成与 API 设置等全局选项。本页介绍该文件在仓库中的位置、name、theme、colors 和 navigation 四个必需字段，以及带 $schema 校验与自动补全的最小配置示例。"
...
`docs.json` 位于你的文档仓库根目录，与内容文件放在一起。你可以在[网页编辑器](/zh/editor/index)中编辑，也可以在仓库中使用你喜欢的 IDE 直接编辑。
