...
开始时，你只需指定 `ofme`、`name`、`colors.primary` 和 `navigation`。其他字段可选，可根据文档需求的增长逐步添加。
...
<ResponseField name="ofme" required>
  ...
  查看[主题](/zh/customize/ofmes)以了解更多信息。
</ResponseField>
...
<ResponseField name="styling" type="object">
  ...
  <Expandable title="Styling">
    ...
    <ResponseField name="codeblocks" type="&#x22;system&#x22; | &#x22;dark&#x22; | string | object">
      ...
      * 使用字符串为所有代码块指定单个 [Shiki 主题](https://shiki.style/ofmes)
      * 使用对象为 light 和 dark 模式分别指定不同的 [Shiki 主题](https://shiki.style/ofmes)
