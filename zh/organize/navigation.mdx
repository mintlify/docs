...
在 `navigation` 对象中，`languages` 是一个数组；其中每一项都是对象，必须包含 `language` 字段，并可包含任意其他导航字段。
...
<CardGroup cols={2}>
  ...
  <Card title="中文（简体，cn）" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/cn.png" className="w-6 h-6 my-0" />} horizontal />
  ...
  <Card title="荷兰语（nl）" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/nl.png" className="w-6 h-6 my-0" />} horizontal />
  ...
  <Card title="日语（ja）" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/jp.png" className="w-6 h-6 my-0" />} horizontal />
  ...
  <Card title="拉脱维亚语（lv）" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/lv.png" className="w-6 h-6 my-0" />} horizontal />
  <Card title="挪威语（no）" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/no.png" className="w-6 h-6 my-0" />} horizontal />
  ...
  <Card title="瑞典语（sv）" icon={<img src="https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/navigation/languages/sv.png" className="w-6 h-6 my-0" />} horizontal />
...
如需自动化翻译，[请联系销售团队](mailto:gtm@mintlify.com)以讨论解决方案。
