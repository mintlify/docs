---
title: "集成"
description: "docs.json 中 integrations 字段的配置参考：将 Google Analytics、PostHog、Amplitude、Segment、Clarity 等分析平台以及聊天小部件和其他第三方服务连接到 Mintlify 文档站点，并附每项集成所需的 API key、测量 ID 等参数说明。"
