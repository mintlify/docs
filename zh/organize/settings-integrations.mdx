---
title: "文档集成配置"
description: "通过 docs.json 中的集成配置，将分析平台、聊天小部件和第三方服务连接到你的 Mintlify 文档站点。本文说明配置字段、使用场景和维护要点，帮助你组织内容并管理文档站点。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
