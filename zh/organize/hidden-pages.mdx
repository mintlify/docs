---
title: "隐藏页面"
description: "了解如何在 Mintlify 中创建隐藏页面：通过 frontmatter 设置 hidden: true 或从 docs.json 导航中移除页面，使其不出现在侧边栏但仍可通过直接 URL 访问，适合内部参考与 AI 上下文等场景，并了解隐藏与私密的区别以及配置认证的访问控制方法。"
