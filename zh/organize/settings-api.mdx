---
title: "API 设置"
description: "docs.json 中 api 字段的配置参考：设置 OpenAPI 与 AsyncAPI 规范文件的路径、URL 或搜索目录来生成 Mintlify API 参考页面，配置用于测试端点的交互式 API 演练场，并控制 SDK 代码示例的生成方式与身份验证设置，附各属性类型与 JSON 示例。"
