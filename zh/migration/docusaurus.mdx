...
description: "了解如何将 Docusaurus 2 或 3 文档站点迁移到 Mintlify：使用抓取工具转换公开站点并自动生成 docs.json 配置，或从源仓库迁移 MDX 页面、sidebars 导航、版本管理、本地化内容、静态资源与自定义 React 组件，本页还提供上线前的迁移检查清单。"
