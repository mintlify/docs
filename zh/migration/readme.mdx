---
title: "从 ReadMe 迁移"
description: "了解如何将 ReadMe 项目迁移到 Mintlify：使用抓取工具快速转换公开站点，或通过 ZIP 导出、GitHub 导出与 ReadMe API 获取私有内容和托管图片，本指南涵盖 guides、API 参考、recipes、自定义页面、多版本文档与静态资源的完整迁移步骤。"
