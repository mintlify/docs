---
title: "从 GitBook 迁移"
description: "将 GitBook 站点迁移到 Mintlify 的完整指南：通过 Git Sync 或导出获取 Markdown 内容，转换 sections、SUMMARY.md 导航、可复用内容与 variants，并迁移静态资源和 OpenAPI 文档，最后配置重定向并完成上线前检查清单。"
