---
title: "从 GitBook 迁移"
description: "了解将 GitBook 站点迁移到 Mintlify 的两种方式：使用 Git Sync 将每个 section 导出为 Markdown 源文件以获得最完整的迁移，或用抓取工具转换公开站点。本指南涵盖导航重建、可复用内容、variants 变体、静态资源与 OpenAPI 文档的迁移步骤。"
