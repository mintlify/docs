---
title: "文档创作指南"
description: "浏览文档最佳实践、内容策略、SEO 优化、可访问性和 docs-as-code 工作流程的实用指南。本文结合实践建议和操作步骤，帮助你在 Mintlify 项目中完成相关工作并持续维护文档。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
boost: 3
---
...
* [配置自动合并](/zh/guides/configure-automerge)：将 Mintlify GitHub 应用添加到规则集的绕过列表中，以为自动化启用自动合并。
* [使用自动化](/zh/guides/use-automations)：选择合适的自动化触发器、撰写有效的指令，并从自动化的内容维护中获得一致的结果。
* [Claude Code](/zh/guides/claude-code)、[Codex](/zh/guides/codex)、[Cursor](/zh/guides/cursor)、[Devin Desktop](/zh/guides/devin-desktop)：使用 AI 编程助手维护文档的指南。
...
* [创建自定义前端](/zh/guides/custom-frontend)：使用 Mintlify 的 Astro 集成，通过完全自定义的前端来渲染你的文档。
