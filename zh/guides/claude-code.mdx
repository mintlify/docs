---
title: "Claude Code"
description: "配置 Claude Code，用于撰写、审阅和更新你的文档。"
---

Claude Code 是一款具备自主代理能力的命令行工具，可帮助你维护文档。它可以撰写新内容、审阅现有页面，并让文档始终保持最新。

你可以在项目中添加一个 `CLAUDE.md` 文件，并随着时间不断完善，用以训练 Claude Code 理解你的文档规范和工作流程。
