---
title: "使用自动化"
description: "介绍如何使用 Mintlify 自动化自动执行周期性文档维护任务：根据内容更新、代码变更、自定义计划或集成事件选择合适的触发器，配置预定义或自定义自动化，并学习撰写能让 agent 产生一致结果的有效指令，让内容无需手动维护即可长期保持准确，并了解何时应改用一次性 agent 任务。"
