...
每次自动化运行都会消耗积分。消耗量取决于 agent 读取的内容量、更改的文件数量以及运行时长。更新许多页面的复杂运行会消耗更多积分。要了解自动化的实际消耗，请查看 [Usage](https://app.mintlify.com/settings/organization/usage) 页面上的 Activity log。有关积分定价的详细信息，请参见[积分](/zh/credits)。
...
2. 要查看某次运行的更多信息，请点击 <Icon icon="ellipsis" /> 操作菜单按钮并选择 **View run details**，以查看提示词、摘要、文件和 pull request。
