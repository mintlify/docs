---
title: "无障碍性"
description: "遵循 WCAG 标准，创建尽可能多的人都能使用的文档。"
---

当你创建无障碍文档时，你会优先进行内容设计，使尽可能多的用户无论通过何种方式访问和与文档交互，都能顺利使用。

无障碍文档会提升所有人的使用体验。你的内容会更清晰、结构更合理、导航更便捷。

本指南提供了一些用于创建无障碍文档的最佳实践，但并不全面。你应将无障碍性视为一个持续的过程。随着时间推移，技术和标准会不断演进，也会带来改进文档的新机会。
