---
title: "使用 branch"
description: "创建和管理文档 branch，以预览变更、与团队成员协作，并在发布到生产环境之前合并更新。本文结合实践建议和操作步骤，帮助你在 Mintlify 项目中完成相关工作并持续维护文档。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
