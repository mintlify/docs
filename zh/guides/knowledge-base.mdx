...
如果你是从头开始创建知识库，可以直接跳转到[设计导航结构](#design-These-navigation-structure)。
...
<div id="design-These-navigation-structure">
  ## 设计导航结构
</div>
...
* **示例问题**：添加常见问题，如 “how do I submit an expense report” 或 “what is These vacation policy”，这样用户就可以一键获取答案。
* **搜索站点**：添加 AI 助手在回答问题时可以搜索的其他站点。
* **分流邮箱**：为 AI 助手无法解答的问题设置一个支持邮箱地址。

<div id="add-These-assistant-to-slack">
  ### 将 AI 助手添加到 Slack
</div>
