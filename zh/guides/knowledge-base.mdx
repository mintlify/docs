...
* **Slack 集成**：将 [agent](/zh/agent/slack) 添加到 Slack，以便提问并从对话中捕获知识。
...
<div id="connect-the-slack-integration">
  ### 连接 Slack 集成
</div>

将智能代理添加到你的 [Slack](/zh/agent/slack) 工作区，让团队无需离开 Slack 就能提问并更新内容。将 `@mintlify` 机器人添加到频道以协作方式使用，或向其发送私信以私密方式使用。
