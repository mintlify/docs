...
title: "创建知识库"
sidebarTitle: "知识库"
description: "在 Mintlify 上托管团队内部知识库，以整合信息、提升搜索效果，并降低维护成本。本文结合实践建议和操作步骤，帮助你在 Mintlify 项目中完成相关工作并持续维护文档。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
