...
description: "构建并嵌入一个应用内文档助手，使用来自你的 Mintlify 文档站点的引用信息回答用户问题。"
...
* 你的 domain 名称，它位于控制台 URL 的末尾。例如，如果你的控制台 URL 是 `https://app.mintlify.com/org-name/domain-name`，你的 domain 名称就是 `domain-name`
* 一个 [AI 助手 API key](https://app.mintlify.com/settings/organization/api-keys)
...
1. 在控制台中前往 [API keys](https://app.mintlify.com/settings/organization/api-keys) 页面。
