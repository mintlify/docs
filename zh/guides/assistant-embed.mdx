...
description: "本教程带你使用 React 构建并嵌入应用内 AI 文档助手小部件：通过 Mintlify AI 助手 API 提供实时流式回复、Markdown 消息渲染和浮动聊天面板，让用户无需离开你的应用即可获得基于文档内容的产品帮助，附基于 Next.js 和 Vite 的完整示例仓库与配置步骤。"
