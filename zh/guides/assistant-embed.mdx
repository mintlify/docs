...
description: "构建并嵌入一个应用内文档助手，使用来自你的 Mintlify 文档站点的引用信息回答用户问题。本文结合实践建议和操作步骤，帮助你在 Mintlify 项目中完成相关工作并持续维护文档。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
