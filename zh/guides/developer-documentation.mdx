...
title: "创建开发者文档"
sidebarTitle: "开发者文档"
description: "介绍如何在 Mintlify 上创建开发者文档：从 OpenAPI 规范生成可交互测试的 API 参考、通过 GitHub 或 GitLab 同步保持文档与代码库一致、维护多版本文档，并涵盖审核与迁移现有内容、规划文档结构等帮助工程师集成 API 与 SDK 的实践。"
...
* **Git 同步**：使用 [GitHub](/zh/deploy/github)、[GitLab](/zh/deploy/gitlab) 或 [Bitbucket Cloud](/zh/deploy/bitbucket) 让文档与你的代码库保持同步。
...
<Steps>
  <Step title="保持 API 参考文档最新">
    每次发布变更时都要更新 OpenAPI 规范。如果你从代码生成规范，请在发布流程中将这一步自动化。
  </Step>
