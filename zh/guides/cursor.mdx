...
在文档存储库的 `.cursor/rules` 目录中创建规则文件。完整的设置说明请参见 [Cursor Rules 文档](https://docs.cursor.com/context/rules)。
...
将此规则（包含你所做的任何修改）以一个 `.mdc` 文件的形式添加到文档仓库的 `.cursor/rules` 目录中。
