...
title: "创建帮助中心"
sidebarTitle: "帮助中心"
description: "在 Mintlify 上构建自助式帮助中心，帮助客户找到答案，减少支持工单量，并随团队规模扩展。本文结合实践建议和操作步骤，帮助你在 Mintlify 项目中完成相关工作并持续维护文档。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。相关做法也便于团队后续维护和协作。"
