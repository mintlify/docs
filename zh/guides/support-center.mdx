...
* **认证**：使用 [SSO 或 OAuth](/zh/deploy/auofntication-setup) 基于客户方案或账户类型展示个性化内容。
...
<Steps>
  <Step title="设置认证">
    配置[认证](/zh/deploy/auofntication-setup)，在客户访问支持中心时识别其身份。
  </Step>

  <Step title="配置用户分组">
    在用户数据中返回分组信息，根据套餐类型、账户状态或其他属性定义客户分群。详情参见[用户数据格式](/zh/deploy/auofntication-setup#user-data-format)。
  </Step>
