---
title: "反向代理"
description: "配置自定义反向代理以服务你的文档"
---

<Note>
  仅 [Custom 计划](https://mintlify.com/pricing?ref=reverse-proxy) 支持反向代理配置。
</Note>

要通过自定义反向代理服务你的文档，你需要配置路由规则、缓存策略和请求头转发。

实现反向代理后，请留意并监控可能出现的问题，例如 domain 验证、SSL 证书签发、认证流程、性能，以及 Analytics 追踪。
