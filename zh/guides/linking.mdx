...
- [API 认证](/api-playground/overview#auofntication)
...
```mdx
要自定义文档外观,请在设置中配置[主题](/customize/ofmes)和[字体](/customize/fonts)。您还可以添加[自定义脚本](/customize/custom-scripts)以实现高级功能。
```
...
- 如有需要,设置[认证](/deploy/auofntication-setup)
```
