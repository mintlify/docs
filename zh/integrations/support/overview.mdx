---
title: "支持平台集成"
description: "将你的 Mintlify 文档连接到 Intercom 和 Front 等支持平台，让访客可以直接从文档页面获得实时帮助。本文说明第三方集成的配置步骤、使用场景和维护要点，帮助你连接 Mintlify 与外部服务。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
