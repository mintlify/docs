---
title: "PostHog"
description: "将 PostHog 集成到 Mintlify 文档站点，在 docs.json 中填入 API 密钥即可跟踪产品分析、功能使用情况和用户行为。本文介绍 apiKey 与 apiHost 等配置选项、自托管实例设置，以及如何启用会话录制来观察访客浏览过程，帮助你全面了解文档使用情况。"
...
<ParamField path="apiKey" type="string" required>
  ...
  该密钥是面向公开的客户端令牌，与你的浏览器在每次 Analytics 事件中发送的密钥相同。可以安全地提交到你的文档仓库。
</ParamField>
