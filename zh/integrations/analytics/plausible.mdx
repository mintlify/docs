---
title: "Plausible"
description: "在 docs.json 中添加站点 domain，即可将 Plausible Analytics 集成到 Mintlify 文档，实现轻量且尊重隐私的访客统计，无需 Cookie 或同意横幅。本文介绍标准配置与自托管 Plausible 实例的 server 选项，帮助你快速跟踪文档流量。"
