...
description: "使用 Google Analytics 跟踪访客行为和参与度。"
---

你需要生成一个新的<Tooltip tip="Google Analytics 4">GA4</Tooltip> 属性以在 Mintlify 中使用。收集的数据将归入与你其他 Google Analytics 数据相同的项目。

如果你使用的是旧版 Google Analytics（Universal Analytics），仍然可以生成 <Tooltip tip="Google Analytics 4">GA4</Tooltip> 属性。<Tooltip tip="Google Analytics 4">GA4</Tooltip> 数据与 UA 数据略有不同，但仍会汇总到同一项目中。
