...
description: "介绍如何将 Google Analytics 4 接入 Mintlify 文档：创建 GA4 资源和 Web 流以获取 Measurement ID，在 docs.json 的 ga4 配置中填入 measurementId，并用 Google Analytics Debugger 验证数据上报是否正常。"
