---
title: Stainless
description: 在 API 操作台中自动生成 SDK 示例代码片段
---
...
* 拥有一个 [Stainless](https://app.stainless.com) 帐户。
...
<Steps>
  ...
  <Step title="发布你的 OpenAPI 规范的 URL。">
    在你的 Stainless 项目中：

    1. 选择 **Release** 标签页。
    2. 选择 **Setup OpenAPI publishing**。
    3. 复制可公开访问的 OpenAPI 规范的 URL。

    <img src="/images/stainless-public-OpenAPI-spec.png" alt="Stainless 发布页面，其中 OpenAPI 规范的 URL 以绿色方框高亮显示。" />
  </Step>
