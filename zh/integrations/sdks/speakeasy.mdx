---
title: "Speakeasy"
description: "在 API 操作台中自动化生成 SDK 代码示例。"
---

由 Speakeasy SDK 自动生成的代码片段可直接集成到 Mintlify 的 API 参考文档中。SDK 用法示例会显示在由 Mintlify 提供支持的文档站点的[交互式操作台](/zh/api-playground/overview)中。
