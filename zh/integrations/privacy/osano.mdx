---
title: "Osano"
description: "介绍如何通过自定义 JavaScript 文件在 Mintlify 文档站点集成 Osano Cookie 同意管理器：创建加载 Osano 脚本 URL 的 osano.js 文件，并排查 Strict 严格合规模式下页面资源无法加载时的 Mintlify 域名允许列表设置。"
