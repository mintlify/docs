---
title: "Osano"
description: "通过在存储库中添加自定义 JavaScript 文件，将 Osano Cookie 同意管理器集成到 Mintlify 文档站点。本文介绍如何从 Osano 控制台复制脚本源、配置同意横幅，并满足 GDPR 等隐私法规的合规要求，管理访客的偏好设置。配置完成后横幅将自动展示给访客。"
