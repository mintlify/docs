---
title: "SEO（搜索引擎优化）"
description: "面向更佳搜索可见性的 SEO 最佳实践与 meta 标签配置"
icon: "search"
---
...
要为所有页面设置默认的元信息标签，请在你的 `docs.json` 中添加 `metatags` 字段。
...
要设置特定页面的 meta 标签，请将它们添加到该页面的 frontmatter 中。
