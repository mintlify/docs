...
* [按页面获取反馈](/zh/api/analytics/feedback-by-page)：获取特定页面的聚合反馈计数。
...
* **Analytics 导出**：使用 [Get user feedback](/zh/api/analytics/feedback)、[Get feedback by page](/zh/api/analytics/feedback-by-page) 和 [Get assistant conversations](/zh/api/analytics/assistant-conversations)，导出反馈和 AI 助手会话以进行外部分析。
...
使用管理员 API key 对发送到 [Trigger update](/zh/api/update/trigger)、[Get update status](/zh/api/update/status)、[Create agent job](/zh/api/agent/v2/create-agent-job)、[Get agent job](/zh/api/agent/v2/get-agent-job)、[Send follow-up message](/zh/api/agent/v2/send-message)、[Get user feedback](/zh/api/analytics/feedback)、[Get feedback by page](/zh/api/analytics/feedback-by-page) 和 [Get assistant conversations](/zh/api/analytics/assistant-conversations) 的请求进行身份验证。
...
使用 assistant API key 对发往 [Create assistant message](/zh/api/assistant/create-assistant-message-v2) 和 [Search documentation](/zh/api/assistant/search) 端点的请求进行认证。
