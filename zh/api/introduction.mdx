...
- [Send follow-up message](/zh/api/agent/v2/send-message)：向现有的代理任务发送后续消息。
- [Create assistant message](/zh/api/assistant/create-assistant-message-v2)：将基于您的文档训练的 AI 助手嵌入到任意您选择的应用中。
- [Search documentation](/zh/api/assistant/search)：搜索您的文档。
- [Get user feedback](/zh/api/analytics/feedback)：从您的文档中导出用户反馈。
- [Get assistant conversations](/zh/api/analytics/assistant-conversations)：导出 AI 助手的会话历史。
