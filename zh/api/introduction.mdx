...
* [Trigger preview deployment](/zh/api/preview/trigger)：为指定分支创建或重新构建预览部署。
...
* **预览部署**：在 CI/CD 流水线中使用 [Trigger preview deployment](/zh/api/preview/trigger) 以编程方式为分支创建预览部署。
