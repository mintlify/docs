...
在控制台的 [API keys 页面](https://dashboard.mintlify.com/settings/organization/api-keys)生成 API key。管理员和 Index API key 属于组织。你可以在同一组织内的多个项目中使用相同的 key。Assistant API key 属于创建它的项目。
