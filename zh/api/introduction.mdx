...
* [创建预览部署](/zh/api/preview/create)：从 Git 分支创建预览部署。
* [列出预览部署](/zh/api/preview/list)：列出项目的所有预览部署。
* [获取预览部署状态](/zh/api/preview/status)：检查预览部署的构建状态。
* [删除预览部署](/zh/api/preview/delete)：删除预览部署。
...
* **预览部署**：以编程方式创建、监控和管理分支的预览部署，使用 [Create preview deployment](/zh/api/preview/create)、[Get preview deployment status](/zh/api/preview/status)、[List preview deployments](/zh/api/preview/list) 和 [Delete preview deployment](/zh/api/preview/delete)。
...
使用管理员 API key 对发送到 [Trigger update](/zh/api/update/trigger)、[Get update status](/zh/api/update/status)、[Create preview deployment](/zh/api/preview/create)、[List preview deployments](/zh/api/preview/list)、[Get preview deployment status](/zh/api/preview/status)、[Delete preview deployment](/zh/api/preview/delete)、[Create agent job](/zh/api/agent/v2/create-agent-job)、[Get agent job](/zh/api/agent/v2/get-agent-job)、[Send follow-up message](/zh/api/agent/v2/send-message)、[Get user feedback](/zh/api/analytics/feedback) 和 [Get assistant conversations](/zh/api/analytics/assistant-conversations) 的请求进行身份验证。
