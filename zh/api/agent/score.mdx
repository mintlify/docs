...
openapi: /zh/agent-score.openapi.json GET /agent/score
...
If you only need to check your own site interactively, run [`mint score`](/zh/cli/commands#mint-score) instead.
...
```bash
curl "https://api.mintlify.com/agent/score?url=https://mintlify.com/docs"
```
