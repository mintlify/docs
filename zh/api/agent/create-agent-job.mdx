---
title: "创建 agent 任务 (v1)"
description: "已弃用。创建一个 agent 任务，用于自动更新文档，并自动创建 branch 和拉取请求。"
openapi: /zh/admin-openapi.json POST /v1/agent/{projectId}/job
keywords: [ "agent job", "create", "automation", "automate" ]
tag: "deprecated"
---

<Warning>此端点已弃用。请改用 [v2 创建 agent 任务](/zh/api/agent/v2/create-agent-job) 端点。</Warning>
