...
description: "使用 AI SDK v5 或更高版本搭配 useChat hook，向 AI 助手发送消息并接收流式响应。"
...
<Info>
  assistant 消息 v2 端点兼容 **AI SDK v5+**。如果你正在使用 AI SDK v4，请改用 [assistant 消息 v1 端点](/zh/api/assistant/create-assistant-message-v2)。
</Info>
