---
title: "创建助手消息 (v1)"
description: "已废弃。使用 AI SDK v4 向 AI 助手发送消息。如需使用 AI SDK v5 或更高版本，请使用 v2 端点。"
...
<Info>
  assistant message v1 端点与 **AI SDK v4** 兼容。若你使用 AI SDK v5 或更高版本，请改用 [assistant message v2 端点](/zh/api-reference/assistant/create-assistant-message-v2)。
</Info>
