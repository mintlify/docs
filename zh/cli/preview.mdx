---
title: "本地预览"
description: "介绍如何使用 mint dev 命令在本地运行 Mintlify 文档站点预览：更改会实时重载显示，支持自定义端口与 --no-open 选项，并可通过 mint login 登录以启用全文搜索和 AI 助手功能，让你在提交前于 localhost 检查每处更改的实际渲染效果与站点行为。"
