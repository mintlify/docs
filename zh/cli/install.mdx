---
title: "安装 CLI"
description: "安装 Mintlify CLI 并配置本地文档开发环境，使用 npm 或 pnpm 管理全局安装，创建新项目、更新 CLI、格式化 MDX 文件，以及在发布前排查权限和构建问题。本文还说明 Node.js 版本要求、主题与模板选项、常用命令、交互式设置方式，以及本地预览异常和客户端下载失败时的处理方法。"
