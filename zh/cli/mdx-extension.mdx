...
description: "介绍如何安装和使用 Mintlify MDX 扩展：为 VS Code、Cursor、Devin Desktop 等编辑器提供组件自动补全、内联诊断、悬停文档与编辑器内实时预览，自动检测未知组件、无效属性、缺失必需属性和未闭合标签，让你在本地编写 MDX 文档时更高效、更少出错。"
