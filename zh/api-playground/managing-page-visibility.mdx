---
title: "管理页面可见性"
description: "使用 x-hidden 和 x-excluded 扩展控制自动生成的 OpenAPI 端点页面在文档导航中的可见性：隐藏仅通过直接 URL 访问的页面，或将仅供内部使用的端点、已弃用操作和 Beta 功能从文档中彻底排除，并查看两种扩展在 OpenAPI 规范中的具体实现示例。"
