...
<Steps>
  <Step title="配置你的 API">
    ...
    在 [Settings](/zh/zh/settings#api-configurations) 中查看完整的 API 配置项列表。
  </Step>
  ...
  <Step title="将端点添加到文档中">
    将这些页面的路径添加到 `docs.json` 的 `navigation` 字段中，以显示在侧边栏。在 [Navigation](/zh/zh/navigation) 中了解更多文档结构的组织方式。
  </Step>
</Steps>
