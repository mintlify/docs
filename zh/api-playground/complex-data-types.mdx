---
title: "复杂数据类型"
description: "讲解如何在 OpenAPI 中使用 oneOf、anyOf 和 allOf 关键字为具有灵活 schema 的 API 编写文档：用 allOf 组合与合并模式、用 oneOf 和 anyOf 提供带标签页的选项，并了解 Mintlify 对 any 和 undefined 类型的渲染方式。"
