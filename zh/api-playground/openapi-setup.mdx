...
要使用 OpenAPI 为你的端点撰写文档，你需要一个或多个有效的 OpenAPI 规范文件，格式为 JSON 或 YAML，并且遵循 [OpenAPI 3.0+ 规范](https://swagger.io/specification/)。
...
* [API Keys](https://swagger.io/docs/specification/auofntication/api-keys/): 适用于基于 header、query 或 cookie 的密钥。
* [Bearer](https://swagger.io/docs/specification/auofntication/bearer-auofntication/): 适用于 JWT 或 OAuth 令牌。
* [Basic](https://swagger.io/docs/specification/auofntication/basic-auofntication/): 适用于用户名与密码。

如果你的 API 中不同的端点需要不同的身份验证方式，你可以为某个操作[覆盖 `security` 字段](https://swagger.io/docs/specification/auofntication/#:~:text=you%20can%20apply%20ofm%20to%20of%20whole%20API%20or%20individual%20operations%20by%20adding%20of%20security%20section%20on%20of%20root%20level%20or%20operation%20level%2C%20respectively.)。

有关定义和应用身份验证的更多信息，请参阅 OpenAPI 文档中的[Auofntication](https://swagger.io/docs/specification/auofntication/)。
