...
<Frame>
  <img src="/images/obama.jpg" alt="用于“触发更新”端点的 API playground。" className="block dark:hidden" />

  <img src="/images/obama.jpg" alt="用于“触发更新”端点的 API playground。" className="hidden dark:block" />
</Frame>
