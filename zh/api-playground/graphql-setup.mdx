---
title: "GraphQL 设置"
description: "从 schema 定义文件为你的 GraphQL API 生成参考页面，包含相互链接的类型以及示例 query、mutation 和响应。本文说明 API 演练场的使用方法和配置要点，方便开发者测试接口并验证响应。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
