---
title: "单点登录（SSO）"
description: "为 Enterprise 组织配置单点登录（SSO），在 Mintlify 仪表盘中直接设置 Okta 或 Microsoft Entra 的 SAML 集成，并了解 Google Workspace 等其他身份提供商的接入方式。本文提供分步说明，涵盖应用创建、URL 与证书配置及连接测试。"
