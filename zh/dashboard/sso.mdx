---
title: "单点登录（SSO）"
description: "使用 Okta、Azure AD 和 Google Workspace 等 SAML 或 OIDC 身份提供商设置单点登录，实现安全的团队身份验证。本文说明控制台中的配置步骤和权限影响，帮助团队安全管理文档项目。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
