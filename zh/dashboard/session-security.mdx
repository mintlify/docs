...
若要查看或更改会话生命周期，请前往仪表盘中 [Security](https://app.mintlify.com/settings/organization/access) 页面的 **Policies** 部分。
...
若要配置允许列表，请前往仪表盘中 [Security](https://app.mintlify.com/settings/organization/access) 页面的 **Policies** 部分。
