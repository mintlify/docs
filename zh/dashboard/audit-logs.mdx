...
前往控制台中的 [Audit log](https://app.mintlify.com/settings/organization/audit-logs) 页面以查看审计日志。
...
1. 在控制台中进入 [Audit log](https://app.mintlify.com/settings/organization/audit-logs) 页面。
