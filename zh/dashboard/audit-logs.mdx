---
title: "审计日志"
description: "通过审计日志追踪组织成员执行的操作，包括部署、配置更改和权限更新。本文介绍在 dashboard 中查看和筛选日志、将审计日志流式传输到 SIEM 等目标并选择事件类别，以及导出日志的方法，满足企业安全审查与合规监控的需求。每条日志都包含操作者、时间和事件详情，便于追溯变更来源。"
keywords: ["监控", "活动追踪", "安全", "合规", "SIEM"]
---
...
| Deployment       | 部署配置更改，包括自定义域名、认证、Git 源、MCP 客户端凭证、回滚和构建提升。 |
