---
title: "SCIM 预配"
description: "介绍如何在 Mintlify 控制台启用 SCIM 预配，从 Okta 等符合 SCIM 2.0 标准的身份提供商自动为组织成员进行预配和取消预配。内容涵盖生成 SCIM base URL 与 bearer token、配置身份提供商的分步操作，以及与 SSO 配合的用户访问管理方式。"
