...
sidebarTitle: "访问策略"
description: "将 Mintlify dashboard 的访问限制为受信任的 IP 地址，并通过空闲超时和最大会话有效期控制 dashboard 会话的有效时长。本文说明控制台中的配置步骤和权限影响，帮助团队安全管理文档项目。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
