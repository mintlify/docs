...
sidebarTitle: "访问策略"
description: "限制 Mintlify dashboard 的访问范围并控制会话有效时长。本文介绍如何配置 IP 允许列表，仅允许受信任的 IP 地址或 CIDR 范围访问 dashboard，以及设置空闲超时和最大会话有效期来要求成员重新验证身份，加强组织的安全防护。两项功能均在 dashboard 中配置。"
