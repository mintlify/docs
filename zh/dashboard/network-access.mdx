...
如果允许列表将所有管理员都锁定在 dashboard 之外，请使用与你组织关联的邮箱地址联系 [support@mintlify.com](mailto:support@mintlify.com)。请注明你的组织名称以及需要添加的 IP 地址。Mintlify 的支持团队可以添加该地址或禁用允许列表，以便你重新获得访问权限。
