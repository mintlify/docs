...
sidebarTitle: "MCP 参考"
description: "查看公开 Mintlify Index MCP 服务器的参考信息，包括 context 工具、请求参数、返回内容、连接方式、身份验证要求、支持的搜索范围和速率限制。本文适合需要了解工具行为、输入输出格式以及公共服务访问规则的开发者，便于将其接入 AI 工具并检索技术文档。"
...
公开服务器无需认证。有关受支持编码代理的设置说明，请参阅[连接](/zh/search-index/connect)。
