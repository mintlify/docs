...
sidebarTitle: "MCP 参考"
description: "Mintlify Index MCP 服务器的参考文档：介绍 index.mintlify.com 连接地址与无需认证的公开访问方式，详细说明 context 工具的 query、product、域名筛选与 tokenBudget 等参数、响应格式、速率限制，以及在编码代理中的使用示例。"
