...
sidebarTitle: "连接"
description: "了解如何将 Mintlify Index MCP 服务器连接到编码代理：运行 npx mint index 命令一步完成设置，或手动配置 Claude Code、Cursor、VS Code、Codex、OpenCode、Windsurf 和 Zed，让代理在编写代码时检索最新技术文档，无需 API key。"
