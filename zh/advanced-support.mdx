---
title: "高级支持"
description: "了解 Mintlify 高级支持选项：所有客户可通过控制台或 support 邮箱获得标准支持并在 24–48 小时内收到首次回复，Enterprise 方案可加购高级 Slack 支持频道或专属客户成功经理（CSM），获得更快的响应时间 SLA、缺陷优先升级、定期沟通与战略合作。"
