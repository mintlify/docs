...
- 自定义方案客户可以添加高级 Slack 支持（24 小时内响应）或专属 CSM（4 小时内响应 + 战略合作伙伴关系）

<div id="standard-support-included">
  ### 标准支持（已包含）
</div>

适用于所有 Pro 和 Custom 方案。通过控制台提交工单，或发送邮件至 support@mintlify.com。首次回复在 24–48 小时内。
...
<AccordionGroup>
  <Accordion title="高级 Slack 支持与标准支持有什么区别？">
    标准支持（包含在 Pro 和 Custom 套餐中）通过控制台或 support@mintlify.com 提供，响应 SLA 为 24–48 小时。高级 Slack 支持包括：
