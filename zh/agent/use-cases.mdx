...
使用 agent 的 API 端点来[创建任务](/zh/api-reference/agent/v2/create-agent-job)、[获取特定任务](/zh/api-reference/agent/v2/get-agent-job)以及[发送消息](/zh/api-reference/agent/v2/send-message)。
