...
在向智能体发送指令时，直接在消息中附加文件或图片。智能体会处理附件并将其加入到文档中。

你可以在控制台的智能体面板聊天中或 Slack 中附加文件：

- **控制台**：打开智能体面板，使用聊天输入框中的附件按钮添加文件，或直接将文件粘贴到消息输入框中。
- **Slack**：像分享其他 Slack 附件一样，将文件上传到你的消息中。

支持的文件类型：
- **图片**：JPEG、PNG、GIF、WebP、SVG
- **文档**：PDF
- **代码和文本文件**：JavaScript、TypeScript、Python、HTML、CSS、Markdown、MDX、JSON、YAML、XML、SQL、CSV、纯文本、Shell 脚本以及其他常见代码格式
