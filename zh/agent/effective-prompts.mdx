---
title: "编写高效提示词"
description: "编写清晰、具体的提示词以从 Mintlify agent 获得更好的结果，包含有效指令示例和常见模式的实用技巧。"
...
要找到你的 domain 名称，请查看你想更新的那组文档在控制台中的 URL。domain 名称是组织名称之后的最后一部分。比如，如果你的控制台 URL 是 `https://app.mintlify.com/org-name/domain-name`，那么你的 domain 名称就是 `domain-name`。
