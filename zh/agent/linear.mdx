...
2. 在 "Agent settings" 部分，点击 **Install Linear app**。
  <Frame>
    <img src="/images/agent/install-apps-light.png" alt="应用设置区域，包含 Slack 和 Linear 安装按钮。" className="block dark:hidden" />
    <img src="/images/agent/install-apps-dark.png" alt="应用设置区域，包含 Slack 和 Linear 安装按钮。" className="hidden dark:block" />
  </Frame>
