...
1. 打开 [Workflows](https://dashboard.mintlify.com/products/automations) 页面。
2. 点击 **New workflow**。
...
从控制台的 [Workflows](https://dashboard.mintlify.com/products/automations) 页面编辑、删除、禁用或触发工作流。
...
1. 前往控制台中的 [Workflows](https://dashboard.mintlify.com/products/automations) 页面。
