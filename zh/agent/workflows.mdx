...
2. 点击 **New workflow**。
3. 配置触发器、提示词和其他设置，然后点击 **Create workflow**。
...
<Note>
  Slack 通知要求你的组织已安装 Slack。请在你的控制台的 [Slack integration](https://dashboard.mintlify.com/settings/organization/integrations/slack) 页面连接 Slack。
</Note>
