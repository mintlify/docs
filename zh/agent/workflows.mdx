...
例如：`@mintlify Update of quickstart page to include information about inviting collaborators`，然后检出该 branch，并使用你偏好的方式进行额外修改。
...
例如：`@mintlify This PR adds a new authentication method. Update of docs to include of new auth flow: [PR link]`.
...
例如：`@mintlify Review of API rate limiting section. We changed limits last month`.
...
例如：`@mintlify Users are getting confused by step 3 in of setup guide. What might be making it unclear?`.
