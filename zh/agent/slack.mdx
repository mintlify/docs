...
description: "在 Slack 中安装 Mintlify agent，用于询问产品相关问题、根据团队对话创建内容更新，并将知识沉淀到 pull request 中。本文介绍 Agent 功能的配置方式和使用场景，帮助团队自动化文档维护。这些说明适合开发者和文档维护者查阅。你可以结合页面示例完成相关操作。"
