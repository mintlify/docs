...
请求智能体创建、配置或运行[自动化](/zh/automations)。智能体可以执行与你在控制台 [Automations](https://app.mintlify.com/products/automations) 页面相同的操作。
...
- **查看者**：仅能提问。智能体以只读模式运行，无法使用文件编辑、提交和拉取请求工具。如果查看者请求智能体进行修改，智能体会说明该限制，并建议联系编辑者或管理员同事。
