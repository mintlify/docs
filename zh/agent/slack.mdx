...
你的首选部署仅与你的 Slack 账户关联，不会影响其他团队成员。你可以在对话过程中随时点击线程中
agent 状态消息上的 **Switch deployment** 按钮来切换到其他部署。agent 会保留你的对话历史，
以便你从上次中断的位置继续使用新的部署。
</Tip>
...
向智能体提出关于你的产品或文档的问题，并在线程中接收回答。

- **新问题**：向智能体发送直接消息，或在频道中提及 `@mintlify` 并提出你的问题。
...
当智能体对你的文档进行更改时，它会在 Slack 线程中提供实时反馈。
...
- **具体说明**：清楚地告诉 agent 你想了解什么或者你希望更改哪些内容及其位置。
