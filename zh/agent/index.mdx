...
默认情况下，agent 创建的拉取请求会归属于 Mintlify 机器人。若要将拉取请求归属于你自己，请在控制台的 [My profile](https://dashboard.mintlify.com/settings/account) 页面连接你的 GitHub 账号。

<div id="connect-repositories-as-context">
  ## 连接仓库作为上下文
</div>

Agent 只能访问你通过 Mintlify GitHub 应用连接的仓库。在 agent 面板的 **Settings** 中或在 [GitHub 应用设置](https://github.com/apps/mintlify/installations/new) 中配置 agent 可以访问的仓库。
