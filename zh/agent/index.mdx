...
默认情况下，agent 会以 Mintlify 机器人的名义打开拉取请求（PR）。如需将拉取请求归属到你自己，请在控制台的[个人资料](https://dashboard.mintlify.com/settings/account)页面连接你的 GitHub 账户。

<div id="connect-repositories-as-context">
  ## 连接代码仓库作为上下文
</div>

agent 只能访问你通过 Mintlify GitHub 应用连接的仓库。你可以在 agent 面板的 **Settings** 中或在 [GitHub 应用设置](https://github.com/apps/mintlify/installations/new) 中配置 agent 可以访问的仓库。
