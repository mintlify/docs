...
默认情况下，agent 创建的拉取请求会归属于 Mintlify 机器人。若要将拉取请求归属到你自己，请在控制台的[我的资料](https://dashboard.mintlify.com/settings/account)页面连接你的 GitHub 账号。

<div id="connect-repositories-as-context">
  ## 连接代码仓库作为上下文
</div>

agent 只能访问你通过 Mintlify GitHub App 连接的代码仓库。你可以在 agent 面板的 **Settings** 中或 [GitHub App 设置](https://github.com/apps/mintlify/installations/new)中配置 agent 可以访问哪些仓库。
