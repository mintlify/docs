...
[Mermaid](https://mermaid.js.org/) lets you create visual diagrams using text and code. For example, the following code will render a Flowchart Mermaid diagram.
