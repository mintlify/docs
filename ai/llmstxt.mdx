...
- **Site description** as a blockquote below the title, sourced from the `description` field in your `docs.json`.
...
> A brief description of the site, sourced from docs.json.
