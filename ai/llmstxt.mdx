...
- **Site description** as a blockquote below the title. This comes from the `description` field in your `docs.json` configuration. If no description is set, this section is omitted.
