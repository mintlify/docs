...
Mintlify also injects a hidden directive into the rendered HTML of every documentation page that points AI agents to your `llms.txt` file. The directive is wrapped in a screen-reader-only blockquote so it does not affect your page's visible layout, but agents that parse the page DOM can read it to discover the documentation index. No configuration is required.

```html Example HTML directive
<blockquote class="sr-only" data-agent-docs-index>
  <h2>Documentation Index</h2>
  <p>
    Fetch the complete documentation index at:
    <a href="https://your-docs-domain.com/llms.txt">https://your-docs-domain.com/llms.txt</a>
  </p>
