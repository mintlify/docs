...
## Content negotiation for AI systems

Mintlify serves documentation in formats optimized for both humans and AI systems through content negotiation:

- **Markdown responses**: Documentation returns clean, structured markdown that AI systems can parse and use when requested with the `Accept: text/markdown` header.
- **Content negotiation**: Different formats are served based on who's requesting—human browsers receive HTML, while AI agents receive markdown.
- **One-click LLM copy**: Users can easily copy documentation into any AI context window for immediate use.
