...
- If every linked page is public, Mintlify serves your custom file to all visitors, including AI tools that can't authenticate.
...
If anonymous visitors see the generated file instead of your custom file, see [Fix a custom llms.txt that anonymous visitors can't see](/help-center/custom-llms-txt-shows-generated-index).
