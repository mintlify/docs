...
Pull requests are opened under your connected GitHub account. Connect your GitHub account in your [account settings](https://dashboard.mintlify.com/mintlify/mintlify/settings/account) to ensure PRs are attributed to you.
...
Connect your GitHub account in your [account settings](https://dashboard.mintlify.com/mintlify/mintlify/settings/account) to ensure pull requests created by the agent are opened under your GitHub user.
