...
### How the agent analyzes content

The agent uses a streaming agentic workflow with access to specialized tools:
...
This tool-based approach allows the agent to thoroughly investigate your documentation and code before making changes, ensuring accurate and contextually appropriate updates.
