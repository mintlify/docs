...
- **Chat**: Send prompts and receive responses with proposed documentation changes. When the agent makes changes, you can view the pull request or open the changes in the web editor directly from the chat.
...
On mobile devices, the agent opens in a full-screen modal instead of a side panel.
