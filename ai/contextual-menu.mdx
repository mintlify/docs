...
description: "Add a contextual menu to your docs with one-click AI integrations, MCP tools, and page actions like downloading PDFs."
...
The contextual menu provides quick access to AI-optimized content, page actions, and direct integrations with popular AI tools. When users click the contextual menu on any page, they can copy content as context for AI tools, open it in an AI conversation, or download the page as a PDF. Supported tools include ChatGPT, Claude, Perplexity, Google AI Studio, Grok, Devin, Windsurf, and any custom tool you configure.
