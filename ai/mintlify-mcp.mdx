...
The admin MCP is a hosted Mintlify service at `https://mcp.mintlify.com`. There is no self-hosted version—every client connects to the same endpoint and authenticates with your Mintlify account.
