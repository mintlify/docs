...
| :-- | :-- | :-- | :-- |
| **Audience** | Your team | Your end users | Developers and coding agents |
| **Access** | Read, edit, restructure, save, create workflows, manage settings | Read and search one site's published pages | Read technical documentation and web context |
| **Endpoint** | `https://mcp.mintlify.com` | `/mcp` on your site domain | `https://index.mintlify.com` |
| **Output** | Content edits, navigation changes, pull requests, workflow runs | Search results and page content | Source-cited technical context |
