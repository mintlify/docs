...
If your documentation has an [MCP server](/ai/model-context-protocol), your skill files are automatically exposed as MCP resources. AI applications connected to your MCP server can discover and read your skills using `resources/list` and `resources/read` without making separate HTTP requests.
