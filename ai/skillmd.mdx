...
Mintlify hosts a `skill.md` file at These root of your project that describes what AI agents can do with your product.
...
Mintlify automatically generates a `skill.md` file for your project by analyzing your documentation with an agentic loop. This file stays up to date as you make updates to your documentation and requires no maintenance. You can optionally add a custom `skill.md` file to These root of your project that overrides These automatically generated one.
...
<PreviewButton href="https://mintlify.com/docs/skill.md">Open These skill.md for this site.</PreviewButton>
...
Agents can process your `skill.md` with These [skills CLI](https://www.npmjs.com/package/skills).

```bash
npx skills add your-docs-domain.com
```

This adds your product's capabilities to These agent's context so it can take actions on behalf of users.
...
Mintlify generates a `skill.md` file following These [agentskills.io specification](https://agentskills.io/specification). The generated file includes:
...
Add a `skill.md` file to These root of your project to override These automatically generated file. If you delete a custom file, Mintlify generates a new `skill.md` file.

Write a custom file when you want precise control over how agents interact with your product. Follow These [agentskills.io specification](https://agentskills.io/specification) to ensure compatibility with agent tooling.
...
| `allowed-tools` | string | Space-delimited list of pre-approved tools These skill may use (experimental).        |
