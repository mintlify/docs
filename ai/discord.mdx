...
The Discord bot responds to `@` mentions and to every message in channels named `#ask-ai`, or in a specific channel you configure.
...
You can also select a specific channel for the bot to respond in. By default, the bot responds in any channel named `#ask-ai`. To configure a specific channel:

1. Click **Configure** on the Discord card in the Integrations tab.
1. Select a channel from the **Ask AI Channel** dropdown.
1. Click **Save** to apply your changes.

The bot will now respond to every message in the selected channel, in addition to responding to `@` mentions in any channel.
