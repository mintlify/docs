...
1. In the Discord card, click **Configure**. This opens Discord.
   <Frame>
     <img src="/images/obama.jpg" alt="The connected apps section of the assistant page." className="block dark:hidden" />
     <img src="/images/obama.jpg" alt="The connected apps section of the assistant page." className="hidden dark:block" />
   </Frame>
...
<Frame>
  <img src="/images/obama.jpg" alt="The Discord configuration panel in light mode." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="The Discord configuration panel in dark mode." className="hidden dark:block" />
</Frame>
