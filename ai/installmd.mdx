...
The `install.md` file provides task-oriented installation instructions for AI agents like Claude Code, Cursor, and ChatGPT. Unlike traditional documentation written for human readers, `install.md` presents installation steps as direct commands that AI agents execute autonomously.
