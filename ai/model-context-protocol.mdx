...
Popular MCP clients such as Claude, ChatGPT, Cursor, and Devin are always allowed to complete authentication against your MCP server. You do not need to add these clients to any allowPopular MCP clients such as Claude, ChatGPT, Cursor, and Devin are always allowed to complete authentication against your MCP server. You do not need to add these clients to any allowlist.
