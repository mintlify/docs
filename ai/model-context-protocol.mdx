...
<Steps>
  <Step title="Create a client credential">
    1. Navigate to the [MCP server page](https://dashboard.mintlify.com/products/mcp) in your dashboard.
    2. Open the **Admin MCP** tab.
    3. In the **Generate credentials** section, enter a label for the credential to identify its purpose, then select **Generate**.
...
You can manage your client credentials from the **Admin MCP** tab on the [MCP server page](https://dashboard.mintlify.com/products/mcp) in your dashboard.
