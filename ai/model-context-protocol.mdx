...
Client credentials authenticate against the `/authed/mcp` endpoint and return all content from public pages and authenticated pages that aren't scoped to specific groups.
