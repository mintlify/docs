...
Your MCP server provides a search tool that agents can use:
...
Agents call the search tool based on the context of the conversation to retrieve documentation content relevant to a user's request.
