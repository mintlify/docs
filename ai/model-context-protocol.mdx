...
## Customize MCP tools from OpenAPI

If you use an OpenAPI specification, you can control which endpoints are exposed as MCP tools and customize their names and descriptions using the `x-mint: mcp` extension. See [MCP](/api-playground/openapi-setup#mcp) in the OpenAPI setup guide for details.
