...
<Steps>
  ...
  <Step title="Publish your MCP server URL for your users.">
    ...
    1. Navigate to your Devin [MCP settings page](https://app.devin.ai/settings/mcp).
    2. Select **Add Server**.
    3. Add your MCP server name and URL.
    4. Select **Save**.
  </Step>
...
See the [Devin documentation](https://docs.devin.ai/work-with-devin/mcp-servers) for more details.
</Tab>
</Tabs>
...
<Steps>
  <Step title="Add the Mintlify MCP server to Devin">
    1. Navigate to your Devin [MCP settings page](https://app.devin.ai/settings/mcp).
    2. Select **Add Server**.
    3. Add the Mintlify MCP server:
      - Name: `Mintlify`
  ...
  <Step title="Use the MCP server">
    When working with Devin, ask questions about Mintlify documentation. Devin will search the MCP server for relevant information.
  </Step>
</Steps>
