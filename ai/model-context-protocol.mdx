...
<Steps>
  <Step title="Create a client credential">
    1. Navigate to the [MCP server page](https://dashboard.mintlify.com/products/mcp) in your dashboard.
    2. On the **Hosted MCP** tab, in the **Client credentials** section, select **Generate credentials**.
    3. Enter a label for the credential to identify its purpose, then select **Generate**.
...
You can manage your client credentials from the **Client credentials** section of the **Hosted MCP** tab on the [MCP server page](https://dashboard.mintlify.com/products/mcp) in your dashboard.
