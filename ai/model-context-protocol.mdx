...
<Steps>
  ...
  <Step title="Add redirect domains">
    ...
    Loopback addresses (`localhost`, `127.0.0.1`) and `api.gumloop.com` are always trusted and do not need to be added.
  </Step>
</Steps>
