...
Your MCP server provides the following tool that agents can use:
...
Agents call this tool when the context of the conversation indicates that searching your documentation would help answer a user's question.
