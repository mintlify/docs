...
<Tab title="Contextual menu">
  ...
  | **Connect to Devin** | `devin-mcp` | Installs your MCP server in Devin. |
</Tab>
<Tab title="Claude">
<Steps>
...
<Steps>
  ...
  <Step title="Publish your MCP server URL for your users.">
    Create a guide for your users that includes your MCP server URL and the steps to connect it to Devin.

    1. Go to the [MCP Marketplace](https://app.devin.ai/settings/mcp-marketplace) in Devin's settings.
    2. Select **Add Custom MCP**.
    3. Add your MCP server name and URL.
  </Step>
</Steps>

See the [Devin documentation](https://docs.devin.ai/work-with-devin/use-mcp-servers) for more details.
</Tab>
</Tabs>
...
<Tabs>
<Tab title="Contextual menu">
  At the top of this page, select the contextual menu and choose **Connect to Cursor**, **Connect to VS Code**, or **Connect to Devin** to connect the Mintlify MCP server to the tool of your choice.
</Tab>
<Tab title="Claude">
...
To connect the Mintlify MCP server to Devin:

<Steps>
  <Step title="Navigate to Devin's MCP settings">
    1. Go to the [MCP Marketplace](https://app.devin.ai/settings/mcp-marketplace) in Devin's settings.
    2. Select **Add Custom MCP**.
  </Step>
  <Step title="Configure the Mintlify MCP server">
    Add the Mintlify MCP server:
    - Name: `Mintlify`
    - URL: `https://mintlify.com/docs/mcp`
  </Step>
  <Step title="Test the connection">
    In Devin, ask a question about Mintlify to verify the MCP server is connected.
  </Step>
</Steps>
