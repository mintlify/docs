...
The MCP search tool supports optional filtering parameters that AI applications can use to narrow search results. The available parameters adapt dynamically based on your documentation.
