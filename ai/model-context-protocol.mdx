...
Your MCP server exposes three core components to AI applications:
...
- **Prompts**: Pre-defined templates that help users interact with your documentation.
...
3. The tools will have standardized access to your documentation with search, API endpoints, and prompts.
