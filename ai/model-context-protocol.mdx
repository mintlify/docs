...
description: "Connect AI tools like Claude, Cursor, and ChatGPT to your hosted Mintlify MCP server so they can search and retrieve content from your documentation."
