...
<Steps>
  ...
  <Step title="Add custom domains">
    For AI tools not listed as predefined clients, add their redirect domains in the **Custom Domains** section. Your users' AI tools cannot complete authentication unless their redirect domain is in this list.
