...
<Frame>
  <img src="/images/obama.jpg" alt="MCP server page in the dashboard." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="MCP server page in the dashboard." className="hidden dark:block" />
</Frame>
