...
Your MCP server exposes a search tool for AI applications to query your documentation. This is the only tool available through the hosted MCP server.
...
You can view your MCP server details on the [MCP Server page](https://dashboard.mintlify.com/products/mcp) in your dashboard.
