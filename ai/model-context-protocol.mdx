...
- **`scoreThreshold`**: Minimum relevance score between 0 and 1. Only results at or above this threshold are returned. Use this to filter out low-relevance matches.
