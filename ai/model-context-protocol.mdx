...
<Tip>
  To let trusted agents edit your content, use the [admin MCP server](/ai/mintlify-mcp). To give coding agents one retrieval source across product documentation and the technical web, use [Mintlify Index](/search-index/).
</Tip>
