...
1. Open Cursor settings: Use <kbd>Command</kbd> + <kbd>Shift</kbd> + <kbd>P</kbd> (<kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>P</kbd> on Windows) to open the command palette.
...
```
5. Test the connection: In Cursor's chat, you can ask "What tools do you have available?" to see your documentation search and any configured API endpoints
