...
description: "Use your own LLM provider API key with OpenRouter, Anthropic, or OpenAI-compatible providers to choose the model that powers Mintlify AI products."
