...
AI usage on a deployment with bring your own model enabled does not consume Mintlify [credits](/credits). Your provider bills you directly for inference, and those charges do not appear in your Mintlify usage. Set any spending limits with your providerAI usage on a deployment with bring your own model enabled does not consume Mintlify [credits](/credits). Your provider bills you directly for inference, and those charges do not appear in your Mintlify usage. Set any spending limits with your providerAI usage on a deployment with bring your own model enabled does not consume Mintlify [credits](/credits). Your provider bills you directly for inference, and those charges do not appear in your Mintlify usage. Set any spending limits with your provider.

Credits pool at the organization level. Other deployments in the same organization still draw from that shared balance at the standard rate for their AI usag. Other deployments in the same organization still draw from that shared balance at the standard rate for their AI usag. Other deployments in the same organization still draw from that shared balance at the standard rate for their AI usage.
