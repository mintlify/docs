...
<Info>
  Bring your own model requires an [Enterprise plan](https://mintlify.com/pricing?ref=bring-your-own-model). [Contact sales](https://www.mintlify.com/contact/sales) to inquire about adding it to your contract. The **AI model** section appears in your dashboard only when your contract includes it. The **AI model** section appears in your dashboard only when your contract includes it.
</Info>
...
4. Select a provider. For an OpenAI-compatible provider, enter a provider name and base URL. The base URL must use HTTPS and point to a publicly reachable host. The base URL must use HTTPS and point to a publicly reachable host.
5. Select a model.
