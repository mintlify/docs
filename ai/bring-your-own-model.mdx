...
description: "Supply your own OpenRouter, Anthropic, or OpenAI-compatible API key and choose the LLM that powers the Mintlify assistant, agent, and automations."
...
Credits pool at the organization level, so the reduced rate applies only to the AI usage on deployments that you use your own model. Other deployments draw from the same balance at the standard rate.
