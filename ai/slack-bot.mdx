...
You can change the bot's display name directly from the Mintlify dashboard or through Slack:

**From the Mintlify dashboard:**
1. Navigate to the [Integrations](https://dashboard.mintlify.com/products/assistant/settings/integrations) tab.
1. In the Slack card, click **Configure**.
1. Click **Edit in Slack** to open the Slack App Settings page.
