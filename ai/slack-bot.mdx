...
<Frame>
  <img src="/images/obama.jpg" alt="The Slack configuration panel in light mode." className="block dark:hidden" />
  <img src="/images/obama.jpg" alt="The Slack configuration panel in dark mode." className="hidden dark:block" />
</Frame>
