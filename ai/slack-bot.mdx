...
When you configure a custom channel, the bot will only respond to all messages in that specific channel. It will still respond to `@` mentions in any channel where it's added.
