...
Mintlify automatically generates Markdown versions of pages optimized for AI tools and external integrations. Markdown export is on by default and cannot be turned off. Protected pages still require authentication—see [Authentication](#authentication) below.
