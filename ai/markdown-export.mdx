...
Mintlify automatically generates Markdown versions of pages that are optimized for AI tools and external integrations. Documentation pages serve raw markdown when the `Accept: text/markdown` header is sent, enabling better AI agent consumption of content.
