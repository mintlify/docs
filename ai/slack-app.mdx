...
The Slack app adds a bot to your Slack workspace that searches your documentation to answer users' questions. The bot responds to direct messages, @mentions, and to any questions in a dedicated `#ask-ai` channel.
...
3. Complete prompts from Slack to add the app to your workspace.
