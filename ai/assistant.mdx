...
Help your users begin conversations with the assistant by adding starter questions. Add commonly asked questions or questions about topics that you want your users to know about. You can add up to 3 starter questions. Click **Ask AI** for recommended questions based on your documentation.
