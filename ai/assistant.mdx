...
The assistant saves your conversation history locally, allowing you to revisit and continue past conversations. Click the history icon in the chat panel header to view your previous conversations. Select any conversation to load it and continue where you left off.

To start a new conversation, click the plus icon in the chat panel header. Your conversation history is stored in your browser's local storage and persists across sessions.
