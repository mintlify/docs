...
## Assistant insights
Use assistant insights to understand how users interact with your documentation through two views: chat history and conversation grouping.
### Chat history
...
The conversation grouping tab uses LLMs to automatically categorize conversations by question topic and theme. Conversations are organized by the most common groupings, helping you quickly identify:
