...
Help your users begin conversations with the assistant by adding starter questions. Add commonly asked questions or questions about topics that you want your users to know about. You can add up to three starter questions. Click **Ask AI** for recommended questions based on your documentation.
...
Users can attach files to their assistant messages for additional context. The assistant can analyze images, documents, and code files to provide more relevant answers.

**Supported file types:**

- **Images**: JPEG, PNG, GIF, WebP, SVG
- **Documents**: PDF
- **Code files**: JavaScript, TypeScript, Python, JSON, HTML, CSS, Markdown, MDX, YAML, XML, SQL, Go, Rust, Ruby, Java, Kotlin, Swift, C, C++, C#, PHP, and more
