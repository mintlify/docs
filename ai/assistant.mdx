...
Manage the assistant from the [Assistant](https://dashboard.mintlify.com/products/assistant) page of your dashboard. The Assistant page has two tabs:

- **General**: Enable or disable the assistant, configure response handling, and add starter questions.
- **Billing**: Manage your message allowance, change tiers, and configure billing controls.

All settings are now accessible directly from the main Assistant page with tabs, rather than separate settings routes.
...
If you want to allow overages, enable them in the **Billing Controls** section of the [Assistant](https://dashboard.mintlify.com/products/assistant?tab=billing) page of your dashboard.
...
View detailed analytics and insights about your assistant usage on the [Insights page](https://dashboard.mintlify.com/products/insights/v2/assistant) in your dashboard. The main Assistant page shows high-level metrics including current monthly spend, total questions, answered properly, and not answered counts with month-over-month comparisons. For more detailed analytics, click **View more** on the insights card to navigate to the full insights page.
...
Review and export queries from the insights page to understand how people interact with your documentation and identify improvement opportunities. Some ways that analyzing queries can help you improve your documentation:
...
You can explore queries from the [insights page](https://dashboard.mintlify.com/products/insights/v2/assistant), and export a `CSV` file of your queries, responses, and sources to analyze with your preferred AI tool.
