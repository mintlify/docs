...
You can view assistant usage through your dashboard to understand user behavior and documentation effectiveness. The main Assistant page shows key metrics at a glance, while the Insights page provides detailed analytics. Export and analyze query data to help identify:
...
Manage the assistant from the [Assistant](https://dashboard.mintlify.com/products/assistant) page of your dashboard. The page has two tabs: **General** for assistant settings and configuration, and **Billing** for tier management and usage controls. Enable or disable the assistant, configure response handling, add starter questions, and manage your message allowance.
...
View and change your current tier on the [Assistant](https://dashboard.mintlify.com/products/assistant) page of your dashboard.
...
If you want to allow overages, enable them in the **Billing Controls** section of the [Assistant](https://dashboard.mintlify.com/products/assistant) page of your dashboard. Select the **Billing** tab to access billing controls.
...
The main [Assistant](https://dashboard.mintlify.com/products/assistant) page displays key metrics including current monthly spend, total questions, answered properly, and not answered. These metrics show month-over-month changes to help you track trends.

For detailed analytics and insights, navigate to the [Insights page](https://dashboard.mintlify.com/products/insights/v2/assistant) where you can:

- View categorized conversations automatically grouped by topic or theme.
- Explore complete chat history with chronological records of all assistant conversations.
- Analyze patterns in user needs and behavior.
- Identify content gaps where frequent queries receive insufficient answers.

## Export and analyze queries

Export queries from the Insights page to analyze with your preferred tools and identify improvement opportunities.
...
The categories view uses LLMs to automatically categorize conversations. Categories show a summary of the topic or theme, when a question was last asked about the category, and the number of questions about the category over time.
...
The chat history view displays chronological records of all assistant conversations. Click any message to view the complete chat thread, including the user's question, the assistant's response, and any sources cited.
