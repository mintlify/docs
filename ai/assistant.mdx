...
## Connect Discord and Slack

Connect your Discord servers and Slack workspaces to bring the assistant to your community channels. The assistant answers questions using your documentation, helping users get instant help where they already communicate.
...
The Integrations page displays connected apps and available integrations you can connect.
...
After authorization, Discord redirects you back to your dashboard. The integration appears in the Connected apps section.
...
All connected integrations appear in the Connected apps section at the top of the Integrations page. Each integration displays the platform name, connection status, and a **Configure** button to manage settings.

To disconnect an integration, click **Configure** and then **Disconnect** or **Remove**. Disconnecting immediately stops the assistant from responding in that platform's channels.
