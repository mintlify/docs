...
* **Supports multiple modalities** by allowing users to add text and images as context.
...
Drag and drop one or more images onto the assistant chat panel to add them as context.
