...
By default, the assistant allows overages. You can disable overages to avoid incurring additional costs for usage beyond your tier. If you reach your message allowance and have overages disabled, the assistant is unavailable until your message allowance resets. Each additional message incurs an overage charge, but occasional overages may be cheaper than upgrading to a higher tier depending on your usage.
