...
In the Bot Protection section, enable invisible captcha to protect your assistant from automated queries. The captcha is powered by hCaptcha and is invisible to nearly all visitors.

Toggle the captcha on or off from your dashboard. Changes take up to 10 minutes to propagate. The captcha is subject to [hCaptcha's privacy policy](https://www.hcaptcha.com/privacy).
