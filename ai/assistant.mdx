...
{/* TODO: Document image attachment once multimodal support ships. Users will be able to attach images as context alongside text, similar to how highlight text and code blocks work. Add a "Images" subsection here with a screenshot of the UI. */}
