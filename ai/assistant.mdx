...
Users can access the assistant in multiple ways:

- **Keyboard shortcut**: <kbd>Command</kbd> + <kbd>I</kbd> (<kbd>Ctrl</kbd> + <kbd>I</kbd> on Windows)
- **Assistant button** next to the search bar, when the sidebar or top bar placement is selected
  <img
  ...
  />
- **Assistant bar** at the bottom of the page, when the bottom of page placement is selected
  <img
