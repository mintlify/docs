...
<Info>
  The assistant is available on [Pro and Custom plans](https://mintlify.com/pricing?ref=assistant). Trial users can access the assistant during their 14-day trial period. When your trial ends, the assistant is automatically disabled unless you upgrade to a Pro or Custom plan.
</Info>

## Frequently asked questions

<AccordionGroup>
  <Accordion title="What plans include the assistant?">
    The assistant is available on Pro and Custom plans. Trial users can access the assistant during their 14-day trial period to test the feature before upgrading.
  </Accordion>

  <Accordion title="What happens when my trial ends?">
    When your 14-day trial ends, the assistant is automatically disabled unless you upgrade to a Pro or Custom plan. Your documentation site remains accessible, but users will no longer see the assistant interface.
  </Accordion>

  <Accordion title="How do I enable or disable the assistant?">
    You can enable or disable the assistant from your [dashboard](https://dashboard.mintlify.com/products/assistant/settings). Navigate to **Configuration** and toggle the assistant status. See the [Enable or disable the assistant](#enable-or-disable-the-assistant) section below for detailed instructions.
  </Accordion>

  <Accordion title="How do users access the assistant?">
    Users can access the assistant through multiple methods: clicking the assistant button in your docs, using the keyboard shortcut (Command/Ctrl + I), highlighting text and clicking "Add to assistant", clicking "Ask AI" in code blocks, or appending `?assistant=open` to any URL. See the [Use the assistant](#use-the-assistant) section for details.
  </Accordion>
</AccordionGroup>
...
You can enable or disable the assistant at any time from your dashboard. When disabled, the assistant interface is removed from your documentation site.

<Steps>
  <Step title="Navigate to assistant settings">
    Go to your [dashboard](https://dashboard.mintlify.com/products/assistant/settings) and click **Configuration** in the assistant toolbar.
  ...
  <Step title="Toggle assistant status">
  ...
  <Step title="Verify changes">
    Visit your documentation site to confirm the assistant is enabled or disabled as expected. Changes take effect immediately.
  </Step>
</Steps>
...
<Note>
  The **Ask AI** button in code blocks is only visible when the assistant is enabled on your documentation site. If you don't see this button, verify that the assistant is enabled in your [dashboard settings](https://dashboard.mintlify.com/products/assistant/settings).
</Note>
...
#### How to enable Ask AI in code blocks

The **Ask AI** button appears automatically in all code blocks when the assistant is enabled. To enable this feature:

<Steps>
  <Step title="Enable the assistant">
    Follow the instructions in the [Enable or disable the assistant](#enable-or-disable-the-assistant) section to enable the assistant for your documentation site.
  </Step>

  <Step title="Verify code block integration">
    Visit any page in your documentation that contains a code block. Hover over the code block to see the **Ask AI** button appear in the top-right corner.
  </Step>

  <Step title="Test the feature">
    Click the **Ask AI** button to open the assistant chat panel with the code block automatically added as context. You can now ask questions about the code.
  </Step>
</Steps>
