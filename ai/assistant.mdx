...
Sample questions appear as clickable suggestions when someone opens the assistant. Configure them from the **Sample questions** panel in your dashboard.

1. Navigate to **Assistant → Settings → Sample questions**.
2. Toggle **Sample questions** on so the suggestions display in the chat UI.
3. Enter a question (up to 100 characters) and select **Add suggestion**. You can store up to three suggestions at a time.
4. Select **Ask AI** to generate a suggestion automatically, then edit or save it.

Use the pencil icon to revise a saved question or the **×** icon to delete it. Suggestions remain saved even if you temporarily disable the feature.

<Frame>
  <img src="/images/assistant/search-suggestions-light.png" alt="Sample questions panel showing a list of three saved suggestions in light mode." className="block dark:hidden" />
  <img src="/images/assistant/search-suggestions-dark.png" alt="Sample questions panel showing a list of three saved suggestions in dark mode." className="hidden dark:block" />
</Frame>
