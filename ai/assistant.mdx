...
Manage the assistant from the [Assistant](https://dashboard.mintlify.com/products/assistant) page of your dashboard. The page has two tabs: **General** for configuration settings and **Billing** for tier management and spending controls. Enable or disable the assistant, configure response handling, add starter questions, and manage your message allowance.
...
If you want to allow overages, enable them in the **Billing Controls** section of the [Assistant](https://dashboard.mintlify.com/products/assistant?tab=billing) page of your dashboard. Select the **Billing** tab to access billing controls.
...
You can explore queries from the [Insights page](https://dashboard.mintlify.com/products/insights/v2/assistant), but to get more powerful insights we recommend exporting a `CSV` file of your queries, responses, and sources to analyze with your preferred AI tool.
...
View detailed analytics and insights about your assistant usage on the [Insights](https://dashboard.mintlify.com/products/insights/v2/assistant) page. The Assistant page in your dashboard shows a summary of key metrics including total questions, answered properly, and not answered. For more detailed analytics, including conversation categories and complete chat history, visit the Insights page.
