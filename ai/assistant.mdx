...
Manage the assistant from the [Assistant](https://dashboard.mintlify.com/products/assistant) page of your dashboard. Enable or disable the assistant, configure response handling, add starter questions, and manage your message allowance.
