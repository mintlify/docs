...
<Frame>
  <img src="/images/assistant/placement-light.png" alt="The assistant placement panel in the dashboard." className="block dark:hidden" />
  <img src="/images/assistant/placement-dark.png" alt="The assistant placement panel in the dashboard." className="hidden dark:block" />
</Frame>
