...
1. (Optional) Enable **Include query categories** to add query bucket categories to your export. This option is only available when using the postgres data source.
